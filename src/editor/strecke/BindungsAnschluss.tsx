// BindungsAnschluss (V2/B3)
// Inspector-Sektion „Daten" für Blöcke mit bindingRoute (Registry): EIN
// Knopf öffnet die geführte Bindungsstrecke, darunter der Kurzzustand.
// Ersetzt für diese Blöcke das Quellen-Select (DataSection) und die
// Einzel-Controls der Route-Props — die Vorlagen-Bibliothek selbst bleibt
// in der Steuerung. Kein `if type===`: alles kommt aus der Registry.

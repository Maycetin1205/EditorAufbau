...
export class Editor extends Subject<Editor> {
  ...
  // Hängt einen neuen Block SAMT seiner Beispieldaten-Kinder (defaultChildren)
  // in den angegebenen Container (Default: Wurzel, ans Ende). `index` =
  // Einfüge-Position innerhalb der Kinder (für Drop). Verweigert Typen, die
  // der Ziel-Container nicht erlaubt (canContain) — Rückgabe null.
  ...
  moveNode(id: string, newParentId: string, index: number): void {
    ...
    // Ziel-Container muss den Typ erlauben (z.B. Spalte nimmt nur Karten).

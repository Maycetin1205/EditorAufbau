// templateRules (U4)
// Musterkarten- und Schutzregeln: reine Funktionen über dem Baum,
// registry-getrieben (templateChild), kein `if type===`. Export (<template>)
// und Laufzeit (kanbanRuntime) nutzen DIESELBE Definition (treeQuery).

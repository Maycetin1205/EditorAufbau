...
`,Wr=[`text`,`number`,`textarea`,`select`,`date`,`time`,`checkbox`,`nachschlagen`];function Gr(e){return Wr.includes(e)?e:`text`}var Kr=[`text`,`number`,`textarea`,`select`,`nachschlagen`,`date`,`time`],qr={select:`ph-select`,date:`ph-nativ`,time:`ph-nativ`},Jr=4;function Yr(e){return e??Jr}function Xr(e,t,n){return Math.max(1,Math.floor((e-t)/n))}function Zr(e,t,n){let r=Xr(e,t,n),i=e-t;return i<n?{passen:r,zeilenHoehe:n}:{passen:r,zeilenHoehe:Math.floor(i/r*100)/100}}function Qr(e,t){return e===null?null:Math.max(0,e-t)}function $r({sichtbar:e,hatQuelle:t,proSeite:n,wunschSeite:r,platzhalterZeilen:i}){let a=t?Math.max(1,Math.ceil(e.length/n)):1,o=Math.min(Math.max(r,0),a-1);return t?{seiten:a,seite:o,zeilen:[...e.slice(o*n,(o+1)*n)]}:{seiten:a,seite:o,zeilen:Array.from({length:i},()=>null)}}function ei(e,t){let n=t.trim().toLowerCase();return e.find(e=>e.wert.trim().toLowerCase()===n)}var W=`text`,ti=`status`,ni=`bild`,ri=`bild`,ii=`unter`,ai=[{wert:W,name:`Text`,spur:`minmax(0, 1fr)`,klasse:``,zelle:e=>e},{wert:`zahl`,name:`Zahl`,spur:`90px`,klasse:`zahl`,zelle:e=>e},{wert:`datum`,name:`Datum`,spur:`100px`,klasse:`zahl`,zelle:e=>e},{wert:ti,name:`Status`,spur:`120px`,klasse:`status`,zelle:(e,t)=>{let n=ei(t,e);return n?y`<span class="chip v-${Vn(n.bedeutung)}">${n.name.trim()===``?e:n.name}</span>`:y`<span class="chip">${e}</span>`}},{wert:ni,name:`Bild + Name`,spur:`minmax(0, 1fr)`,klasse:`bild`,zusatzFelder:[{key:ri,label:`Bild`},{key:ii,label:`Unterzeile`}],hoehe:e=>(e[ri]??``)!==``||(e[ii]??``)!==``?44:32,zelle:(e,t,n)=>{let r=Xn(n[ri]??``),i=n[ii]??``;return y`<div class="bild-name">
      ...
      </div>`}}];function oi(e){return e.reduce((e,t)=>{let n=si(t.art);return Math.max(e,n.hoehe?.(t.felder??{})??32)},32)}function si(e){return ai.find(t=>t.wert===e)??ai[0]}var ci=ai.map(e=>({wert:e.wert,name:e.name,...e.zusatzFelder?{felder:e.zusatzFelder}:{}})),li=`felder`,ui={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},di=e=>(...t)=>({_$litDirective$:e,values:t}),fi=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},pi=`important`,mi=` !important`,hi=di(class extends fi{constructor(e){if(super(e),e.type!==ui.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(mi);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?pi:``):n[e]=r}}return b}}),gi=`Keine Datensätze.`;function _i(){return{attributeName:`leerText`,name:`Text ohne Datensätze`,description:`Steht in der Maske dort, wo sonst die Zeilen stehen — wenn die Datenquelle keine liefert. Leer lassen: dann steht dort gar nichts.`,kind:`text`,requiresDataSource:!0}}function vi(e,t=!1){return e.trim()===``?x:y`<div class="leer${t?` leer--tafel`:``}">
    ${Kn()}
    <span>${e}</span>
  </div>`}var yi=o`
  .leer {
...
`;function bi(e,t){if(!e.hasAttribute(`fuellt`))return null;let n=e.renderRoot.querySelector(`.koerper`),r=e.renderRoot.querySelector(`.kopf`);return!(n instanceof HTMLElement)||!(r instanceof HTMLElement)?null:Zr(n.clientHeight,r.offsetHeight,t)}function xi(e,t){if(typeof ResizeObserver>`u`)return null;let n=e.renderRoot.querySelector(`.koerper`);if(!n)return null;let r=new ResizeObserver(t);return r.observe(n),r}function Si(e){return{rohzeilen:e.map(e=>e.rohzeile),datenzeilen:e.map(e=>[...e.zellen]),zusatzzeilen:e.map(e=>(e.zusatz??[]).map(e=>({...e})))}}function Ci(e,t,n){return t===``||n===``?[...e]:e.filter(e=>$n(M(e,t))===n)}var wi=`Spalte {n}`;function Ti(e){return wi.replace(`{n}`,String(e+1))}function G(e){return{titel:Ti(e),feld:``,art:W}}function Ei(){return[0,1,2].map(e=>G(e))}function Di(e){return Array.isArray(e)?e.filter(e=>!!e&&typeof e==`object`).map(e=>({wert:typeof e.wert==`string`?e.wert:``,name:typeof e.name==`string`?e.name:``,bedeutung:typeof e.bedeutung==`string`?e.bedeutung:``})).filter(e=>e.wert.trim()!==``):[]}function Oi(e){if(!e||typeof e!=`object`||Array.isArray(e))return{};let t={};for(let[n,r]of Object.entries(e))typeof r==`string`&&r!==``&&(t[n]=r);return t}function ki(e,t){if(e&&typeof e==`object`){let n=e,r=Di(n.zuordnung),i=Oi(n.felder);return{titel:typeof n.titel==`string`?n.titel:Ti(t),feld:typeof n.feld==`string`?n.feld:``,art:typeof n.art==`string`?n.art:W,...r.length>0?{zuordnung:r}:{},...Object.keys(i).length>0?{felder:i}:{}}}return typeof e==`string`?{...G(t),titel:e}:G(t)}function Ai(e){let t;if(Array.isArray(e))t=e.map((e,t)=>ki(e,t));else if(typeof e==`number`&&Number.isFinite(e)||typeof e==`string`&&/^\d+$/.test(e)){let n=Math.max(1,Math.floor(Number(e)));t=[...Array(n).keys()].map(e=>G(e))}else t=Ei();return t.length>8&&(t=t.slice(0,8)),t.length<1&&(t=[G(0)]),t}function ji(e){try{return Ai(JSON.parse(e))}catch{return Ei()}}function Mi(e){return ji(e.getAttribute(`spalten`)??``)}function Ni(e,t,n){let r={};for(let i of si(e.art).zusatzFelder??[]){let a=e.felder?.[i.key]??``;a!==``&&(r[i.key]=n(t,a))}return r}function Pi(e){let t=()=>{e.datenzeilen=[],e.zusatzzeilen=[]},n=e.getAttribute(`source`)??``;if(n===``){t();return}let r=j(H().FF_DATA_SOURCES,n);if(!r){t();return}let i=Mi(e),{rows:a,gefiltert:o}=Lt(e,Ci(P(H().SEDATA,r.name,r.tableId),e.getAttribute(`tagfield`)??``,ir())),s=jt(I(e),a,e=>e)[0]??-1,c=Ar(e);e.datenGeliefert=!0,e.rohzeilen=a,e.auswahlIndex=s,e.durchAuswahlGefiltert=o,e.datenzeilen=a.map(e=>i.map(t=>t.feld===``?``:c(e,t.feld))),e.zusatzzeilen=a.map(e=>i.map(t=>Ni(t,e,c)))}var Fi=Tr({hydriere:Pi}),Ii=Fi.connect,Li=Fi.disconnect;function Ri(e){return e.trim().toLowerCase().split(/\s+/).filter(e=>e!==``)}function zi(e,t){let n=Ri(t);if(n.length===0)return!0;let r=e.join(` `).toLowerCase();return n.every(e=>r.includes(e))}function Bi(e,t){let n=[];return e.forEach((e,r)=>{zi(e,t)&&n.push(r)}),n}function Vi(e,t){return!e&&t.trim()!==``}function Hi(e,t,n){return e&&t&&n===0}function Ui(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}function Wi(e,t,n){return y`<div class="steuerung">
    <button
    ...
    <div class="seiten-nav">
  ...
  </div>`}var fa=`—`;function pa(e){return e.linealTakte===0?x:y`<div class="lineal" role="presentation" style=${hi(e.linealTakte===null?e.cols:{...e.cols,flex:`0 1 auto`,height:`calc(var(--zeilen-hoehe) * ${e.linealTakte})`})}>
      ...
      <div class="kopf" role="row" style=${hi(e.cols)}>
...
`,ga=`ff-zeile-aktiviert`,_a=`data-ff-roh`;function va(e,t){e.dispatchEvent(new CustomEvent(ga,{detail:t,bubbles:!0,composed:!0}))}function ya(e){let t=e?.activeElement;if(!(t instanceof HTMLElement))return;let n=t.closest(`.zeile`);if(!n)return;let r=n.getAttribute(_a);return r===null||r===``?null:Number(r)}function ba(e,t){e&&((t===null?null:e.querySelector(`.zeile[data-ff-roh="${t}"]`))??e.querySelector(`.zeile[data-ff-roh]`)??e.querySelector(`.koerper`))?.focus()}var K=class e extends O{constructor(...e){super(...e),this.spalten=Ei(),this.source=``,this.suche=`ja`,this.leerText=gi,this._suchtext=``,this.datenzeilen=[],this.zusatzzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this.datenGeliefert=!1,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._beobachter=null,this._taktGemessen=0,this._fokusZeile=null,this._fokusHolen=!1,this._besitz=`softengine`}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.listenBindung=Zi}static{this.defaultProps={width:`fill`,source:``,spalten:Ei(),suche:`ja`,tagField:``,leerText:gi}}static{this.customProperties=ua}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get besitz(){return this._besitz}set besitz(e){e!==this._besitz&&(this._besitz=e,this.setzeAbgeleitetesZurueck(),this.isConnected&&(e===`provided`?Li(this):Ii(this)),this.requestUpdate())}set bereitgestellteZeilen(e){let t=Si(e);this.rohzeilen=t.rohzeilen,this.datenzeilen=t.datenzeilen,this.zusatzzeilen=t.zusatzzeilen,this.datenGeliefert=!0,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._seite=0,this._mass=null,this._taktGemessen=0,this.requestUpdate()}setzeAbgeleitetesZurueck(){this.rohzeilen=[],this.datenzeilen=[],this.zusatzzeilen=[],this.datenGeliefert=!1,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._suchtext=``,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._taktGemessen=0,this._fokusZeile=null,this._fokusHolen=!1}fokussiereSuche(){let e=this.shadowRoot?.querySelector(`.suchzeile input`);return e?(e.focus(),!0):!1}get hatQuelle(){return this._besitz===`provided`||Vi(this.hasAttribute(`data-ff-editor`),this.source)}merkeZeilenFokus(){let e=ya(this.shadowRoot);this._fokusHolen=e!==void 0,this._fokusZeile=e??null}messeRumpf(){let e=this.zeilenHoehe;this._taktGemessen=e;let t=bi(this,e);t?.passen===this._mass?.passen&&t?.zeilenHoehe===this._mass?.zeilenHoehe||(this._mass=t,this.requestUpdate())}spaltenListe(){return Ai(this.spalten)}get zeilenHoehe(){return oi(this.spaltenListe())}aktiviereZeile(e,t){if(e===null||this.hasAttribute(`data-ff-editor`))return;let n=this.rohzeilen[e];n!==void 0&&(va(this,{rohzeile:n,rohIndex:e,ansichtIndex:t}),this.toggleAuswahl(n))}toggleAuswahl(e){let t=I(this);t!==``&&Mt(t,e)}setzeSuchtext(e){this.merkeZeilenFokus(),this._suchtext=e,this._seite=0,this.requestUpdate()}klickSortiere(e){this.editable||(this.merkeZeilenFokus(),this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.requestUpdate())}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}beobachte(){this._beobachter||(this._beobachter=xi(this,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}connectedCallback(){super.connectedCallback(),this._besitz===`softengine`&&Ii(this),this.beobachte()}firstUpdated(){this.beobachte()}updated(){this._taktGemessen!==this.zeilenHoehe&&this.messeRumpf(),this._fokusHolen&&(this._fokusHolen=!1,ba(this.shadowRoot,this._fokusZeile))}disconnectedCallback(){super.disconnectedCallback(),Yi(this),this._beobachter?.disconnect(),this._beobachter=null,Li(this)}static{this.styles=[O.styles,Wn,yi,ha]}render(){let t=this.spaltenListe(),n=e=>e.stopPropagation(),r=la({spalten:t,hatQuelle:this.hatQuelle,datenGeliefert:this.datenGeliefert,datenzeilen:this.datenzeilen,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,wunschSeite:this._seite,gemessen:this._mass});return y`<div class="tabelle" style=${hi({"--takt":`${r.takt}px`,"--zeilen-hoehe":`${r.zeilenHoehe}px`})}>
    ...
    </div>`}};D([T({converter:{fromAttribute:e=>e?ji(e):Ei(),toAttribute:e=>JSON.stringify(e)}})],K.prototype,`spalten`,void 0),D([T()],K.prototype,`source`,void 0),D([T()],K.prototype,`suche`,void 0),D([T()],K.prototype,`leerText`,void 0),D([T({attribute:!1})],K.prototype,`datenzeilen`,void 0),D([T({attribute:!1})],K.prototype,`zusatzzeilen`,void 0),D([T({attribute:!1})],K.prototype,`rohzeilen`,void 0),D([T({attribute:!1})],K.prototype,`auswahlIndex`,void 0),D([T({attribute:!1})],K.prototype,`durchAuswahlGefiltert`,void 0),D([T({attribute:!1})],K.prototype,`datenGeliefert`,void 0),O.defineAndRegister(K);function xa(e){return y`<div class="nachschlag">
    <input
      class="ctrl"
      type="text"
      .value=${e.wert}
  ...
  </div>`}function Sa(e,t,n){let r=[],i=t.trim()!==``&&t.trim()===n.trim(),a=new Set;for(let o of e){let e=M(o,t).trim(),s=M(o,n).trim();if(!(e===``&&s===``)){if(i){if(a.has(s))continue;a.add(s)}r.push({anzeige:e,wert:s,satz:o})}}return r}function Ca(e,t,n,r){return Sa(Lt(e,t).rows,n,r)}function wa(e){if(e.quelleId===``||e.anzeigeFeld===``||e.speicherFeld===``)return{ok:!1,grund:`unvollstaendig`};let t=j(H().FF_DATA_SOURCES,e.quelleId);if(!t)return{ok:!1,grund:`quelleFehlt`};let n=P(H().SEDATA,t.name,t.tableId);return{ok:!0,eintraege:Ca(e.el,n,e.anzeigeFeld,e.speicherFeld)}}function Ta(e,t){return t&&e.length===1?e[0]:null}function Ea(e,t){let{rows:n,gefiltert:r}=Lt(e,[t]);return!r||n.length>0}function Da(e,t,n){return e===``?t===``&&n===``?`nichts`:`leeren`:e===t?`nichts`:`zurueck`}var Oa=null,ka=null;function Aa(e){return e.shadowRoot?.querySelector(`.lupe`)??null}function ja(e=!0){let t=e?ka:null;ka=null,Oa?.remove(),Oa=null,t?.focus()}function Ma(e,t){let n=document.createElement(K.tagName);return n.besitz=`provided`,n.spalten=[{titel:e.anzeigeTitel===``?`Angezeigt`:e.anzeigeTitel,feld:``,art:W},{titel:e.speicherTitel===``?`Wert`:e.speicherTitel,feld:``,art:W}],n.suche=`ja`,n.leerText=`Diese Quelle hat keine Sätze.`,n.bereitgestellteZeilen=t.map(e=>({rohzeile:e.satz,zellen:[e.anzeige,e.wert]})),n.toggleAttribute(`fuellt`,!0),n.style.setProperty(`--se-r-lg`,`0px`),n}function Na(e){let t=wa(e);if(!t.ok){V(t.grund===`unvollstaendig`?`Nachschlagen ist an diesem Feld nicht vollstaendig eingestellt (Quelle, Angezeigt, Gespeichert).`:`Die Nachschlage-Quelle dieses Feldes ist in der Maske nicht vorhanden.`);return}let n=t.eintraege;ja(!1);let r=document.createElement(zt);r.setAttribute(`data-ff-nachschlagen`,``),r.viewport=!0,r.escapeSchliesst=!0,r.ohneModal=!0,r.inhaltFest=!0,r.titel=e.titel===``?`Nachschlagen`:e.titel,r.breite=520,r.hoehe=380,r.addEventListener(Bt,()=>ja()),r.addEventListener(`click`,e=>e.stopPropagation());let i=Ma(e,n);i.addEventListener(ga,t=>{let r=t.detail,i=n[r.rohIndex];i&&(ja(),e.onUebernehmen(i.anzeige,i.wert,i.satz))}),r.appendChild(i),ka=Aa(e.el),document.body.appendChild(r),Oa=r,Promise.all([r.updateComplete,i.updateComplete]).then(()=>{r.isConnected&&i.fokussiereSuche()})}var q=class extends O{constructor(...e){super(...e),this.fieldType=`text`,this.placeholder=`Feldname`,this.options=``,this.source=``,this.value=``,this.valueField=``,this.nachschlagQuelle=``,this.anzeigeFeld=``,this.anzeigeTitel=``,this.speicherFeld=``,this.speicherTitel=``,this.einzigerTreffer=`nein`,this.anzeige=``,this.getippt=null,this.satz=void 0,this.angehakt=!1,this.imSteuerelement=!1}static{this.blockType=`formfeld`}static{this.tagName=`ff-formfeld`}static{this.displayName=`Formularfeld`}static{this.category=`eingabe`}static{this.acceptsDataSource={wenn:{attributeName:`fieldType`,notEquals:`nachschlagen`}}}static{this.kannAuswahlFolgen=!0}static{this.satzWahl={quelleProp:`nachschlagQuelle`,wenn:{attributeName:`fieldType`,equals:`nachschlagen`}}}static{this.bindableSpots=[{prop:`value`,label:`Wert`,wenn:{attributeName:`fieldType`,keinesVon:[`checkbox`,`nachschlagen`]},vorschauProp:`placeholder`}]}static{this.actionValueSpots=[{prop:`value`,label:`Wert`}]}static{this.blockEvents=[{key:`onChange`,name:`Wert geändert`}]}static{this.defaultProps={width:240,fieldType:`text`,placeholder:`Feldname`,options:``,source:``,value:``,valueField:``,nachschlagQuelle:``,anzeigeFeld:``,anzeigeTitel:``,speicherFeld:``,speicherTitel:``,einzigerTreffer:`nein`}}static{this.raster={startW:6,startH:2,minW:2,minH:2}}static{this.customProperties=lr}static{this.styles=[O.styles,Ur]}onInput(e){let t=e.target;this.value=Gr(this.fieldType)===`date`?Fr(t.value):t.value}onChange(){this.dispatchEvent(new Event(`change`))}textTpl(e,t=!1){return y`<span
      class=${e}
      ?hidden=${t}
      data-ff-editable
    ...
    >${this.placeholder}</span>`}onTextClick(){this.hasAttribute(`data-ff-editor`)||this.setzeHaken(!this.angehakt)}setzeHaken(e){this.angehakt!==e&&(this.angehakt=e,this.dispatchEvent(new Event(`change`)))}controlTpl(e){switch(e){case`textarea`:return y`<textarea class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}></textarea>`;case`select`:{let e=this.options.split(`,`).map(e=>e.trim()).filter(e=>e!==``),t=this.value!==``&&!e.includes(this.value);return y`<select class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}>
        ...
        />`}}onLupe(){this.hasAttribute(`data-ff-editor`)||Na({el:this,quelleId:this.nachschlagQuelle,anzeigeFeld:this.anzeigeFeld,speicherFeld:this.speicherFeld,anzeigeTitel:this.anzeigeTitel,speicherTitel:this.speicherTitel,titel:this.placeholder,onUebernehmen:(e,t,n)=>{this.uebernimmSatz(e,t,n),this.dispatchEvent(new Event(`change`))}})}leereNachschlagen(){this.satz=void 0,this.anzeige=``,this.value=``,Pt(I(this))}uebernimmSatz(e,t,n){this.anzeige=e===``?t:e,this.value=t,this.satz=n,Nt(I(this),n)}onNachschlagVerlassen(){if(this.hasAttribute(`data-ff-editor`))return;let e=Da(this.getippt??this.anzeige,this.anzeige,this.value);this.getippt=null,e===`leeren`&&(this.leereNachschlagen(),this.dispatchEvent(new Event(`change`)))}pruefeEigenenWert(){Gr(this.fieldType)===`nachschlagen`&&(this.satz!==void 0&&!Ea(this,this.satz)&&this.leereNachschlagen(),this.uebernimmEinzigenTreffer())}uebernimmEinzigenTreffer(){if(this.einzigerTreffer!==`ja`)return;let e=wa({el:this,quelleId:this.nachschlagQuelle,anzeigeFeld:this.anzeigeFeld,speicherFeld:this.speicherFeld});if(!e.ok)return;let t=Ta(e.eintraege,this.satz===void 0);t&&this.uebernimmSatz(t.anzeige,t.wert,t.satz)}render(){let e=Gr(this.fieldType);if(e===`checkbox`)return y`<div class="feld">
        <div class="zeile">
          <input
            class="ctrl"
            type="checkbox"
    ...
    </div>`}connectedCallback(){super.connectedCallback(),Vr(this)}disconnectedCallback(){super.disconnectedCallback(),Hr(this)}};D([T()],q.prototype,`fieldType`,void 0),D([T()],q.prototype,`placeholder`,void 0),D([T()],q.prototype,`options`,void 0),D([T()],q.prototype,`source`,void 0),D([T()],q.prototype,`value`,void 0),D([T()],q.prototype,`valueField`,void 0),D([T()],q.prototype,`nachschlagQuelle`,void 0),D([T()],q.prototype,`anzeigeFeld`,void 0),D([T()],q.prototype,`anzeigeTitel`,void 0),D([T()],q.prototype,`speicherFeld`,void 0),D([T()],q.prototype,`speicherTitel`,void 0),D([T()],q.prototype,`einzigerTreffer`,void 0),D([E()],q.prototype,`anzeige`,void 0),D([E()],q.prototype,`getippt`,void 0),D([E()],q.prototype,`angehakt`,void 0),D([E()],q.prototype,`imSteuerelement`,void 0),O.defineAndRegister(q);function Pa(e,t,n,r){return{attributeName:e,name:t,description:n,kind:`select`,options:[{value:`nein`,label:`Nein`},{value:`ja`,label:`Ja`}],...r}}var Fa=o`
  ::slotted(:not([hat-reiter])) { margin-top: 24px; }
  slot { display: contents; }
`,Ia=`frei · hierher ziehen`,La=`ff-zimmer-inhalt`,J=class extends O{constructor(...e){super(...e),this.heading=`Neues Zimmer`,this.leerHinweis=``}static{this.blockType=`kanban-zimmer`}static{this.tagName=`ff-kanban-zimmer`}static{this.displayName=`Kanban-Zimmer`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[U.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban-spalte`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={heading:`Neues Zimmer`}}static{this.styles=[O.styles,yi,Fa,o`
      :host { display: block; }
    ...
    `]}onSlotChange(){this.dispatchEvent(new CustomEvent(La,{bubbles:!0,composed:!0}))}render(){return y`<div class="zimmer">
      <div
        class="kopf"
        data-ff-editable
    ...
    `]}constructor(){super(),this.variant=`info`,this.heading=`Neue Spalte`,this.leerHinweis=``,this._count=0,this.addEventListener(La,()=>this.zaehle())}zaehle(){this._count=Array.from(this.querySelectorAll(U.tagName)).filter(e=>!e.hasAttribute(`data-ff-editor-helper`)).length}render(){return y`<div class="col v-${Vn(this.variant)}">
      <div class="head">
        <span class="dot"></span>
        <span
          class="title"
    ...
    </div>`}};D([T()],Y.prototype,`variant`,void 0),D([T()],Y.prototype,`heading`,void 0),D([T({attribute:!1})],Y.prototype,`leerHinweis`,void 0),D([E()],Y.prototype,`_count`,void 0),O.defineAndRegister(Y);function Ra(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function za(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var Ba=new WeakMap,Va=Y.tagName,Ha=J.tagName,Ua=U.tagName;function Wa(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Va)}function Ga(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Ua)}function Ka(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Ha)}function qa(e){return[e,...Ka(e)]}function Ja(e,t){let n=e.getAttribute(`leertext`)??`Keine Datensätze.`,r=(e,t)=>{e.leerHinweis=t};for(let e of t){let t=Ka(e);for(let e of t)r(e,Ga(e).length===0?Ia:``);r(e,t.length===0&&Ga(e).length===0?n:``)}}function Ya(e){return qe().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function Xa(e,t){let n=Ka(e);if(n.length===0)return null;let r=e.getAttribute(`zimmerfield`)??``;if(r===``)return n[0];let i=n.map(e=>e.getAttribute(`heading`)??J.defaultProps.heading),a=Ra(M(t,r),i);return a>=0?n[a]:n[0]}function Za(e){Z?.board===e&&ro();let t=e.getAttribute(`source`)??``,n=e.getAttribute(`statusfield`)??``;if(t===``)return;let r=j(H().FF_DATA_SOURCES,t);if(!r)return;let i=Wa(e);if(i.length===0)return;let a=Ba.get(e);if(!a){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(Ua);t&&(a=t.cloneNode(!0),Ba.set(e,a))}if(!a)return;let o=Ci(P(H().SEDATA,r.name,r.tableId),e.getAttribute(`tagfield`)??``,ir()),s=i.map(e=>e.getAttribute(`heading`)??Y.defaultProps.heading),c=Ya(a.tagName),l=za(i.map(e=>e.getAttribute(`auffang`))),u=Ar(e);for(let e of i)for(let t of qa(e))Ga(t).forEach(e=>e.remove());for(let e of o){let t=a.cloneNode(!0),o=n===``?-1:Ra(M(e,n),s),d=o>=0?i[o]:l>=0?i[l]:i[0];(Xa(d,e)??d).appendChild(t);for(let n of c){let r=t.getAttribute(ur(n.prop))??``;r!==``&&(t[n.prop]=u(e,r))}let ee=r.indexField===``?``:M(e,r.indexField);X.set(t,{row:e,pindex:ee}),t.draggable=!0}Ja(e,i);let d=i.flatMap(e=>qa(e).flatMap(Ga)),ee=jt(I(e),d,e=>X.get(e)?.row);for(let e of ee)d[e].setAttribute(`data-ff-auswahl`,``)}var X=new WeakMap,Z=null,Qa=new WeakSet,$a=`data-ff-zieht`,eo=`data-ff-ziel`,to=null;function no(e){to!==e&&(to?.removeAttribute(eo),to=e,to?.setAttribute(eo,``))}function ro(){Z?.card.removeAttribute($a),Z=null,no(null)}function io(e,t,n){for(let r of t.composedPath())if(r instanceof HTMLElement&&r.tagName.toLowerCase()===n&&e.contains(r))return r;return null}function ao(e,t){return io(e,t,Va)}function oo(e,t,n){if(!Z||Z.board!==e)return;let r=X.get(Z.card);if(!r)return;let i=t.getAttribute(`heading`)??``,a=n?.getAttribute(`heading`)??``;In(e,`onCardDrop`,{PINDEX:r.pindex,VALUE:i,ZIMMER:a}).catch(Fn)}function so(e){Qa.has(e)||(Qa.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;if(!n)return;let r=X.get(n);r&&Mt(I(e),r.row),In(e,`onCardClick`,{PINDEX:r?.pindex??``}).catch(Fn)}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;n&&(Z={card:n,board:e},t.dataTransfer?.setData(`text/plain`,X.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`),setTimeout(()=>{Z?.card===n&&n.setAttribute($a,``)},0))}),e.addEventListener(`dragend`,ro),e.addEventListener(`dragover`,t=>{let n=ao(e,t);if(Z?.board!==e||!n){no(null);return}t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`),no(io(e,t,Ha)??n)}),e.addEventListener(`dragleave`,t=>{let n=t.relatedTarget;(!(n instanceof Node)||!e.contains(n))&&no(null)}),e.addEventListener(`drop`,t=>{let n=ao(e,t);n&&(t.preventDefault(),oo(e,n,io(e,t,Ha)),ro())}))}var co=Tr({hydriere:Za,verdrahte:so}),lo=co.connect,uo=co.disconnect,fo=Y.blockType,po=class extends O{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[fo]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:fo}}static{this.templateChild={type:U.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``,tagField:``,leerText:gi}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Optional: Feld der Datenquelle, dessen Inhalt bestimmt, in welche Spalte ein Eintrag kommt. Leer = alle Einträge in der Auffang-Spalte.`,kind:`field`},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt das Board nur Einträge des Tages, den der Tageswähler zeigt. Leer = alle Einträge.`,kind:`field`},_i()]}static{this.defaultChildren=[{type:fo,props:{heading:`Offen`,variant:`warning`},children:[{type:U.blockType}]},{type:fo,props:{heading:`In Arbeit`,variant:`info`}},{type:fo,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[O.styles,o`
    ...
    `]}render(){return y`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),lo(this)}disconnectedCallback(){super.disconnectedCallback(),uo(this)}};O.defineAndRegister(po);var mo={breite:56,breiteOffen:224},ho=`ff-seiten-wechsel`,go=[{wert:`sonne`,name:`Sonnengelb`},{wert:`salbei`,name:`Salbeigrün`},{wert:`himmel`,name:`Himmelblau`},{wert:`flieder`,name:`Flieder`},{wert:`koralle`,name:`Koralle`}],Q=class extends O{static{this.blockType=`navi-eintrag`}static{this.tagName=`ff-navi-eintrag`}static{this.displayName=`Navi-Eintrag`}static{this.category=`layout`}static{this.acceptsChildren=!1}static{this.showInPalette=!1}static{this.allowedParentTypes=[`navi`]}static{this.resizableWidth=!1}static{this.defaultProps={seite:``,seitename:``,ton:`sonne`}}static{this.customProperties=[{attributeName:`seite`,name:`Seite`,description:`Welche Seite dieser Maske der Eintrag zeigt.`,kind:`seite`,klarnameProp:`seitename`,nurImEditor:!0},{attributeName:`ton`,name:`Farbe`,description:`Farbe des Zeichens vor dem Namen.`,kind:`select`,options:go.map(e=>({value:e.wert,label:e.name}))}]}static{this.styles=[O.styles,o`
      :host {
        --ton: var(--se-amber);
        display: flex;
        align-items: center;
    ...
    `]}constructor(){super(),this.seite=``,this.seitename=``,this.ton=`sonne`,this.addEventListener(`click`,()=>this.melde())}melde(){let e={ansicht:this.seitename};this.dispatchEvent(new CustomEvent(ho,{detail:e,bubbles:!0,composed:!0}))}render(){return y`<span class="zeichen"></span>
      <span class="name">${this.seitename===``?`—`:this.seitename}</span>`}};D([T()],Q.prototype,`seite`,void 0),D([T()],Q.prototype,`seitename`,void 0),D([T({reflect:!0})],Q.prototype,`ton`,void 0),O.defineAndRegister(Q);var _o=`aktiv`;function vo(e){return Array.from(e.querySelectorAll(Q.tagName))}function yo(e,t){let n=vo(e),r=t??n.find(e=>e.hasAttribute(_o))??n[0];for(let e of n)e===r?e.setAttribute(_o,``):e.removeAttribute(_o)}function bo(e){let t=e.hasAttribute(`offen`);for(let n of vo(e))n.toggleAttribute(`breit`,t)}function xo(e){return e.getAttribute(`name`)??String(at.defaultProps.name)}function So(e,t){let n=e;for(;n&&n.parentElement!==t;)n=n.parentElement;return n}function Co(e,t){let n=e.ownerDocument,r=Array.from(n.querySelectorAll(at.tagName)),i=r[0]?.parentElement??null;if(!i)return;let a=So(e,i);if(!a)return;let o=r.find(e=>xo(e)===t)??null;for(let e of Array.from(i.children))e!==a&&((r.includes(e)?e===o:o===null)?e.removeAttribute(`hidden`):e.setAttribute(`hidden`,``))}var wo=new WeakMap,To=new WeakSet;function Eo(e){let t=t=>{let n=t.detail;n&&(yo(e,t.target instanceof Element?t.target:void 0),e.removeAttribute(`offen`),bo(e),!e.hasAttribute(`data-ff-editor`)&&Co(e,n.ansicht))};e.addEventListener(ho,t),wo.set(e,t)}function Do(e){let t=wo.get(e);t&&(e.removeEventListener(ho,t),wo.delete(e))}function Oo(e){if(yo(e),bo(e),e.hasAttribute(`data-ff-editor`)||To.has(e))return;let t=vo(e)[0];if(!t)return;To.add(e);let n=()=>Co(e,t.seitename);e.ownerDocument.readyState===`loading`?e.ownerDocument.addEventListener(`DOMContentLoaded`,n,{once:!0}):queueMicrotask(n)}var ko=Q.blockType,Ao=class extends O{static{this.blockType=`navi`}static{this.tagName=`ff-navi`}static{this.displayName=`Navi`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[ko]}static{this.addChildButton={label:`Eintrag`,childType:ko}}static{this.containerHint=!1}static{this.defaultProps={}}static{this.customProperties=[]}static{this.maskenRand=!0}static{this.allowedParentTypes=[it]}static{this.raster={startW:5,startH:24,minW:3,minH:3}}static{this.styles=[O.styles,o`
      :host {
        height: 100%;
        width: ${mo.breite}px;
    ...
    `]}connectedCallback(){super.connectedCallback(),Eo(this)}disconnectedCallback(){super.disconnectedCallback(),Do(this)}klappen(){this.toggleAttribute(`offen`),bo(this)}render(){return y`<div class="leiste">
        <div class="kopf">
          <button
            class="schalter"
            type="button"
        ...
        <div class="eintraege">
          <slot @slotchange=${()=>Oo(this)}></slot>
        </div>
      </div>`}};O.defineAndRegister(Ao);var jo=ur(`text`);function Mo(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(jo)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function No(e){let t=jr(e,jo);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function Po(e){Mo(e)&&(e.text=``)}var Fo=Tr({hydriere:No,verdrahte:Po}),Io=Fo.connect,Lo=Fo.disconnect,Ro=6,zo=96,Bo=14,Vo={duenn:`300`,normal:`400`,fett:`700`},Ho={links:`left`,mitte:`center`,rechts:`right`},Uo={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},Wo=`standard`;function Go(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(zo,Math.max(Ro,t)):Bo}function Ko(e){return typeof e==`string`&&e in Vo?e:`normal`}function qo(e){return typeof e==`string`&&e in Ho?e:`links`}function Jo(e){return typeof e==`string`&&e in Uo?e:Wo}var $=class extends O{constructor(...e){super(...e),this.groesse=Bo,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=Wo,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:Bo,gewicht:`normal`,ausrichtung:`links`,farbe:Wo,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:Ro,max:zo,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[O.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return y`<div
      class="text"
      style=${hi({fontSize:`${Go(this.groesse)}px`,fontWeight:Vo[Ko(this.gewicht)],textAlign:Ho[qo(this.ausrichtung)],color:Uo[Jo(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),Io(this)}disconnectedCallback(){super.disconnectedCallback(),Lo(this)}};D([T({type:Number})],$.prototype,`groesse`,void 0),D([T()],$.prototype,`gewicht`,void 0),D([T()],$.prototype,`ausrichtung`,void 0),D([T()],$.prototype,`farbe`,void 0),D([T()],$.prototype,`text`,void 0),D([T()],$.prototype,`source`,void 0),D([T()],$.prototype,`textField`,void 0),O.defineAndRegister($);var Yo=[`waagerecht`,`senkrecht`],Xo=`waagerecht`;function Zo(e){return Yo.includes(e)?e:Xo}var Qo=class extends O{constructor(...e){super(...e),this.richtung=Xo}static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`,richtung:Xo}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1,varianten:[{wenn:{attributeName:`richtung`,equals:`senkrecht`},startW:1,startH:6,breiteZiehbar:!1}]}}static{this.customProperties=[{attributeName:`richtung`,name:`Richtung`,description:`Waagerecht trennt oben von unten, senkrecht links von rechts.`,kind:`select`,options:[{value:`waagerecht`,label:`Waagerecht`},{value:`senkrecht`,label:`Senkrecht`}]}]}static{this.styles=[O.styles,o`
    ...
    `]}render(){return y`<div class="flaeche ${Zo(this.richtung)}"><div class="linie"></div></div>`}};D([T()],Qo.prototype,`richtung`,void 0),O.defineAndRegister(Qo),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;V(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();
...
`;function li(e,t,n,r){return{attributeName:e,name:t,description:n,kind:`select`,options:[{value:`nein`,label:`Nein`},{value:`ja`,label:`Ja`}],...r}}var Y=class extends j{constructor(...e){super(...e),this.variant=`info`,this.heading=`Neue Spalte`,this.leerHinweis=``,this._count=0}static{this.blockType=`kanban-spalte`}static{this.tagName=`ff-kanban-spalte`}static{this.displayName=`Kanban-Spalte`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[q.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={variant:`info`,heading:`Neue Spalte`,auffang:`nein`}}static{this.customProperties=[Bn(`variant`,`Bedeutung der Spalte — bestimmt ihre Farbwelt (Kopf, Fläche, Rahmen).`),li(`auffang`,`Auffangspalte`,`Einträge ohne passenden Spaltentitel landen hier. Ohne Auffangspalte landen sie in der ersten Spalte.`,{requiresDataSource:!0,exclusiveAmongSiblings:!0})]}static{this.styles=[j.styles,ci,o`
    ...
    `]}render(){return w`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),Ei(this)}disconnectedCallback(){super.disconnectedCallback(),Di(this)}};j.defineAndRegister(ki);var Ai={breite:56,breiteOffen:224},ji=`ff-seiten-wechsel`,Mi=[{wert:`sonne`,name:`Sonnengelb`},{wert:`salbei`,name:`Salbeigrün`},{wert:`himmel`,name:`Himmelblau`},{wert:`flieder`,name:`Flieder`},{wert:`koralle`,name:`Koralle`}],Ni=class extends j{static{this.blockType=`navi-eintrag`}static{this.tagName=`ff-navi-eintrag`}static{this.displayName=`Navi-Eintrag`}static{this.category=`layout`}static{this.acceptsChildren=!1}static{this.showInPalette=!1}static{this.allowedParentTypes=[`navi`]}static{this.resizableWidth=!1}static{this.defaultProps={seite:``,seitename:``,ton:`sonne`}}static{this.customProperties=[{attributeName:`seite`,name:`Seite`,description:`Welche Seite dieser Maske der Eintrag zeigt.`,kind:`seite`,klarnameProp:`seitename`,nurImEditor:!0},{attributeName:`ton`,name:`Farbe`,description:`Farbe des Zeichens vor dem Namen.`,kind:`select`,options:Mi.map(e=>({value:e.wert,label:e.name}))}]}static{this.styles=[j.styles,o`
      :host {
        --ton: var(--se-amber);
        display: flex;
        align-items: center;
    ...
    `]}constructor(){super(),this.seite=``,this.seitename=``,this.ton=`sonne`,this.addEventListener(`click`,()=>this.melde())}melde(){let e={ansicht:this.seitename};this.dispatchEvent(new CustomEvent(ji,{detail:e,bubbles:!0,composed:!0}))}render(){return w`<span class="zeichen"></span>
      <span class="name">${this.seitename===``?`—`:this.seitename}</span>`}};A([k()],Ni.prototype,`seite`,void 0),A([k()],Ni.prototype,`seitename`,void 0),A([k({reflect:!0})],Ni.prototype,`ton`,void 0),j.defineAndRegister(Ni);var Pi=`aktiv`;function Fi(e){return Array.from(e.querySelectorAll(Ni.tagName))}function Ii(e,t){let n=Fi(e),r=t??n.find(e=>e.hasAttribute(Pi))??n[0];for(let e of n)e===r?e.setAttribute(Pi,``):e.removeAttribute(Pi)}function Li(e){let t=e.hasAttribute(`offen`);for(let n of Fi(e))n.toggleAttribute(`breit`,t)}function Ri(e){return e.getAttribute(`name`)??String(Qe.defaultProps.name)}function zi(e,t){let n=e;for(;n&&n.parentElement!==t;)n=n.parentElement;return n}function Bi(e,t){let n=e.ownerDocument,r=Array.from(n.querySelectorAll(Qe.tagName)),i=r[0]?.parentElement??null;if(!i)return;let a=zi(e,i);if(!a)return;let o=r.find(e=>Ri(e)===t)??null;for(let e of Array.from(i.children))e!==a&&((r.includes(e)?e===o:o===null)?e.removeAttribute(`hidden`):e.setAttribute(`hidden`,``))}var Vi=new WeakMap,Hi=new WeakSet;function Ui(e){let t=t=>{let n=t.detail;n&&(Ii(e,t.target instanceof Element?t.target:void 0),e.removeAttribute(`offen`),Li(e),!e.hasAttribute(`data-ff-editor`)&&Bi(e,n.ansicht))};e.addEventListener(ji,t),Vi.set(e,t)}function Wi(e){let t=Vi.get(e);t&&(e.removeEventListener(ji,t),Vi.delete(e))}function Gi(e){if(Ii(e),Li(e),e.hasAttribute(`data-ff-editor`)||Hi.has(e))return;let t=Fi(e)[0];if(!t)return;Hi.add(e);let n=()=>Bi(e,t.seitename);e.ownerDocument.readyState===`loading`?e.ownerDocument.addEventListener(`DOMContentLoaded`,n,{once:!0}):queueMicrotask(n)}var Ki=Ni.blockType,qi=class extends j{static{this.blockType=`navi`}static{this.tagName=`ff-navi`}static{this.displayName=`Navi`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[Ki]}static{this.addChildButton={label:`Eintrag`,childType:Ki}}static{this.containerHint=!1}static{this.defaultProps={}}static{this.customProperties=[]}static{this.maskenRand=!0}static{this.raster={startW:5,startH:24,minW:3,minH:3}}static{this.styles=[j.styles,o`
      :host {
        height: 100%;
        width: ${Ai.breite}px;
        transition: width var(--se-move);
      }
      :host([offen]) { width: ${Ai.breiteOffen}px; }
      .leiste {
        box-sizing: border-box;
        height: 100%;
        width: 100%;
    ...
    `]}connectedCallback(){super.connectedCallback(),Ui(this)}disconnectedCallback(){super.disconnectedCallback(),Wi(this)}klappen(){this.toggleAttribute(`offen`),Li(this)}render(){return w`<div class="leiste">
        <div class="kopf">
          <button
            class="schalter"
            type="button"
        ...
        <div class="eintraege">
          <slot @slotchange=${()=>Gi(this)}></slot>
        </div>
      </div>`}};j.defineAndRegister(qi);var Ji={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Yi=e=>(...t)=>({_$litDirective$:e,values:t}),Xi=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},Zi=`important`,Qi=` !important`,$i=Yi(class extends Xi{constructor(e){if(super(e),e.type!==Ji.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(Qi);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?Zi:``):n[e]=r}}return T}}),ea=4;function ta(e){return e??ea}function na(e,t,n){return Math.max(1,Math.floor((e-t)/n))}function ra(e,t,n){let r=na(e,t,n),i=e-t;return i<n?{passen:r,zeilenHoehe:n}:{passen:r,zeilenHoehe:Math.floor(i/r*100)/100}}function ia(e,t){return e===null?null:Math.max(0,e-t)}function aa({sichtbar:e,hatQuelle:t,proSeite:n,wunschSeite:r,platzhalterZeilen:i}){let a=t?Math.max(1,Math.ceil(e.length/n)):1,o=Math.min(Math.max(r,0),a-1);return t?{seiten:a,seite:o,zeilen:[...e.slice(o*n,(o+1)*n)]}:{seiten:a,seite:o,zeilen:Array.from({length:i},()=>null)}}function oa(e,t){if(!e.hasAttribute(`fuellt`))return null;let n=e.renderRoot.querySelector(`.koerper`),r=e.renderRoot.querySelector(`.kopf`);return!(n instanceof HTMLElement)||!(r instanceof HTMLElement)?null:ra(n.clientHeight,r.offsetHeight,t)}function sa(e,t){if(typeof ResizeObserver>`u`)return null;let n=e.renderRoot.querySelector(`.koerper`);if(!n)return null;let r=new ResizeObserver(t);return r.observe(n),r}function ca(e,t){let n=t.trim().toLowerCase();return e.find(e=>e.wert.trim().toLowerCase()===n)}var la=`text`,ua=`status`,da=`bild`,fa=`bild`,pa=`unter`,ma=[{wert:la,name:`Text`,spur:`minmax(0, 1fr)`,klasse:``,zelle:e=>e},{wert:`zahl`,name:`Zahl`,spur:`90px`,klasse:`zahl`,zelle:e=>e},{wert:`datum`,name:`Datum`,spur:`100px`,klasse:`zahl`,zelle:e=>e},{wert:ua,name:`Status`,spur:`120px`,klasse:`status`,zelle:(e,t)=>{let n=ca(t,e);return n?w`<span class="chip v-${Rn(n.bedeutung)}">${n.name.trim()===``?e:n.name}</span>`:w`<span class="chip">${e}</span>`}},{wert:da,name:`Bild + Name`,spur:`minmax(0, 1fr)`,klasse:`bild`,zusatzFelder:[{key:fa,label:`Bild`},{key:pa,label:`Unterzeile`}],hoehe:e=>(e[fa]??``)!==``||(e[pa]??``)!==``?44:32,zelle:(e,t,n)=>{let r=qn(n[fa]??``),i=n[pa]??``;return w`<div class="bild-name">
        ${r===void 0?E:w`<span class="bild-zeichen">${r}</span>`}
        <div class="bild-text">
          <div class="bild-titel">${e}</div>
          ${i===``?E:w`<div class="bild-unter">${i}</div>`}
        </div>
      </div>`}}];function ha(e){return e.reduce((e,t)=>{let n=ga(t.art);return Math.max(e,n.hoehe?.(t.felder??{})??32)},32)}function ga(e){return ma.find(t=>t.wert===e)??ma[0]}var _a=ma.map(e=>({wert:e.wert,name:e.name,...e.zusatzFelder?{felder:e.zusatzFelder}:{}})),va=`felder`,ya=`Spalte {n}`;function ba(e){return ya.replace(`{n}`,String(e+1))}function xa(e){return{titel:ba(e),feld:``,art:la}}function Sa(){return[0,1,2].map(e=>xa(e))}function Ca(e){return Array.isArray(e)?e.filter(e=>!!e&&typeof e==`object`).map(e=>({wert:typeof e.wert==`string`?e.wert:``,name:typeof e.name==`string`?e.name:``,bedeutung:typeof e.bedeutung==`string`?e.bedeutung:``})).filter(e=>e.wert.trim()!==``):[]}function wa(e){if(!e||typeof e!=`object`||Array.isArray(e))return{};let t={};for(let[n,r]of Object.entries(e))typeof r==`string`&&r!==``&&(t[n]=r);return t}function Ta(e,t){if(e&&typeof e==`object`){let n=e,r=Ca(n.zuordnung),i=wa(n.felder);return{titel:typeof n.titel==`string`?n.titel:ba(t),feld:typeof n.feld==`string`?n.feld:``,art:typeof n.art==`string`?n.art:la,...r.length>0?{zuordnung:r}:{},...Object.keys(i).length>0?{felder:i}:{}}}return typeof e==`string`?{...xa(t),titel:e}:xa(t)}function Ea(e){let t;if(Array.isArray(e))t=e.map((e,t)=>Ta(e,t));else if(typeof e==`number`&&Number.isFinite(e)||typeof e==`string`&&/^\d+$/.test(e)){let n=Math.max(1,Math.floor(Number(e)));t=[...Array(n).keys()].map(e=>xa(e))}else t=Sa();return t.length>8&&(t=t.slice(0,8)),t.length<1&&(t=[xa(0)]),t}function Da(e){try{return Ea(JSON.parse(e))}catch{return Sa()}}function Oa(e){return Da(e.getAttribute(`spalten`)??``)}function ka(e,t,n){let r={};for(let i of ga(e.art).zusatzFelder??[]){let a=e.felder?.[i.key]??``;a!==``&&(r[i.key]=n(t,a))}return r}function Aa(e){let t=()=>{e.datenzeilen=[],e.zusatzzeilen=[]},n=e.getAttribute(`source`)??``;if(n===``){t();return}let r=P(W().FF_DATA_SOURCES,n);if(!r){t();return}let i=Oa(e),{rows:a,gefiltert:o}=kt(e,ui(L(W().SEDATA,r.name,r.tableId),e.getAttribute(`tagfield`)??``,tr())),s=Ct(z(e),a,e=>e)[0]??-1,c=Dr(e);e.datenGeliefert=!0,e.rohzeilen=a,e.auswahlIndex=s,e.durchAuswahlGefiltert=o,e.datenzeilen=a.map(e=>i.map(t=>t.feld===``?``:c(e,t.feld))),e.zusatzzeilen=a.map(e=>i.map(t=>ka(t,e,c)))}var ja=Sr({hydriere:Aa}),Ma=ja.connect,Na=ja.disconnect;function Pa(e,t,n){return w`<div class="steuerung">
    <button
    ...
    <button
      ...
      @pointerdown=${n}
      @click=${r=>{n(r);let i=e();i.length<8&&(i.push(xa(i.length)),t(i))}}
    >+</button>
  </div>`}function Fa(e,t){let n=e.currentTarget;if(!n)return;e.stopPropagation(),e.preventDefault();let r=Array.from(n.childNodes),i=n.textContent??``;n.setAttribute(`contenteditable`,`plaintext-only`),n.focus();let a=window.getSelection(),o=document.createRange();o.selectNodeContents(n),a?.removeAllRanges(),a?.addRange(o);let s=!1,c=e=>{if(s)return;s=!0,n.removeAttribute(`contenteditable`),n.removeEventListener(`blur`,l),n.removeEventListener(`keydown`,u);let a=(n.textContent??``).trim();e&&a&&a!==i.trim()?t(a):n.replaceChildren(...r)},l=()=>c(!0),u=e=>{e.key===`Enter`?(e.preventDefault(),n.blur()):e.key===`Escape`&&(e.preventDefault(),c(!1))};n.addEventListener(`blur`,l),n.addEventListener(`keydown`,u)}function Ia(e,t,n,r){Fa(e,e=>{let i=n();t>=i.length||(i[t]={...i[t],titel:e},r(i))})}var La=220,Ra=new WeakMap;function za(e){let t=Ra.get(e);t!==void 0&&(clearTimeout(t),Ra.delete(e))}function Ba(e,t,n,r){t.stopPropagation();let i=t.currentTarget.getBoundingClientRect();za(e),Ra.set(e,setTimeout(()=>{Ra.delete(e),e.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:n,index:r,top:i.bottom+4,left:i.left},bubbles:!0,composed:!0}))},La))}var Va={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:ya,eintragsWahl:{key:`art`,label:`Darstellung`,optionen:_a,standard:la,felderKey:va},eintragsZuordnung:{key:`zuordnung`,label:`Status-Zuordnung`,nurBeiWahl:ua,wertLabel:`Datenwert`,nameLabel:`Klarname`,bedeutungLabel:`Bedeutung`,bedeutungen:zn}},Ha=1,Ua=/^-?\d{1,3}(\.\d{3})*(,\d+)?$|^-?\d+(,\d+)?$|^-?\d+(\.\d+)?$/,Wa=/^(\d{1,2})\.(\d{1,2})\.(\d{2}|\d{4})$/,Ga=/^(\d{4})-(\d{2})-(\d{2})$/;function Ka(e){let t=e.trim();if(t===``||!Ua.test(t))return null;let n=t.includes(`,`)?t.replace(/\./g,``).replace(`,`,`.`):/^-?\d{1,3}(\.\d{3})+$/.test(t)?t.replace(/\./g,``):t,r=Number(n);return Number.isFinite(r)?r:null}function qa(e){let t=e.trim();if(t===``)return null;let n=Ga.exec(t);if(n){let[,e,t,r]=n;return Ja(Number(e),Number(t),Number(r))}let r=Wa.exec(t);if(r){let[,e,t,n]=r,i=Number(n);return Ja(n.length===2?i<=69?2e3+i:1900+i:i,Number(t),Number(e))}return null}function Ja(e,t,n){if(t<1||t>12||n<1||n>31)return null;let r=new Date(e,t-1,n);return r.getFullYear()!==e||r.getMonth()!==t-1||r.getDate()!==n?null:r.getTime()}function Ya(e){let t=0,n=0,r=0;for(let i of e)i.trim()!==``&&(t++,Ka(i)!==null&&n++,qa(i)!==null&&r++);return t===0?`text`:r===t?`datum`:n===t?`zahl`:`text`}var Xa=new Intl.Collator(`de`,{numeric:!0,sensitivity:`base`});function Za(e,t,n){if(t<0||e.length===0)return e.map((e,t)=>t);let r=n=>e[n][t]??``,i=Ya(e.map(e=>e[t]??``)),a=n?1:-1;return e.map((e,t)=>t).sort((e,t)=>{let n=r(e).trim(),o=r(t).trim();if(n===``&&o===``)return e-t;if(n===``)return Ha;if(o===``)return-1;let s=i===`zahl`?(Ka(n)??0)-(Ka(o)??0):i===`datum`?(qa(n)??0)-(qa(o)??0):Xa.compare(n,o);return s===0?e-t:s*a})}function Qa(e,t){let n=[];return e.forEach((e,r)=>{Hr(e,t)&&n.push(r)}),n}function $a(e,t){return!e&&t.trim()!==``}function eo(e,t,n){return e&&t&&n===0}function to(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}function no(e){let t=Qa(e.datenzeilen,e.suchtext);return e.sortSpalte<0?t:Za(t.map(t=>e.datenzeilen[t]),e.sortSpalte,e.sortAuf).map(e=>t[e])}function ro(e){let t={gridTemplateColumns:e.spalten.map(e=>ga(e.art).spur).join(` `)},n=ha(e.spalten),r=e.gemessen?.zeilenHoehe??n,i=$a(e.imEditor,e.source),a=eo(i,e.datenGeliefert,e.datenzeilen.length),o=no(e),{seiten:s,seite:c,zeilen:l}=aa({sichtbar:o,hatQuelle:i,proSeite:e.gemessen?.passen??10,wunschSeite:e.wunschSeite,platzhalterZeilen:ta(e.gemessen?.passen??null)});return{cols:t,takt:n,zeilenHoehe:r,hatQuelle:i,leer:a,gesamt:o.length,seiten:s,seite:c,zeilen:l,linealTakte:ia(e.gemessen?.passen??null,l.length)}}var io=[{attributeName:`suche`,name:`Suchzeile`,description:`Zeigt über der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,kind:`segment`,options:[{value:`ja`,label:`Ja`},{value:`nein`,label:`Nein`}],requiresDataSource:!0},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt die Tabelle nur Sätze des Tages, den der Tageswähler zeigt. Leer = alle Sätze.`,kind:`field`},oi()];function ao(e,t){return w`<div class="fusszeile">
    ...
    <div class="seiten-nav">
  ...
  </div>`}var oo=`—`;function so(e){return e.linealTakte===0?E:w`<div class="lineal" style=${$i(e.linealTakte===null?e.cols:{...e.cols,flex:`0 1 auto`,height:`calc(var(--zeilen-hoehe) * ${e.linealTakte})`})}>
      ...
      <div class="koerper">
      <div class="kopf" style=${$i(e.cols)}>
        ${e.spalten.map((n,r)=>w`<div
            class=${ga(n.art).klasse}
            data-ff-editable
        ...
        ${e.zeilen.map(n=>w`<div
          ...
          >
            ${``}
            ${e.spalten.map((t,r)=>{let i=ga(t.art),a=n===null?oo:e.datenzeilen[n]?.[r]??``,o=n===null?{}:e.zusatzzeilen[n]?.[r]??{};return w`<div class=${i.klasse}>${i.zelle(a,t.zuordnung??[],o)}</div>`})}
          </div>`)}
        ${so(e)}`}
      </div>
    `}var lo=o`
...
`,Q=class e extends j{constructor(...e){super(...e),this.spalten=Sa(),this.source=``,this.suche=`ja`,this.leerText=ai,this._suchtext=``,this.datenzeilen=[],this.zusatzzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this.datenGeliefert=!1,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._beobachter=null,this._taktGemessen=0}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.listenBindung=Va}static{this.defaultProps={width:`fill`,source:``,spalten:Sa(),suche:`ja`,tagField:``,leerText:ai}}static{this.customProperties=io}static{this.raster={startW:14,startH:8,minW:6,minH:4}}messeRumpf(){let e=this.zeilenHoehe;this._taktGemessen=e;let t=oa(this,e);t?.passen===this._mass?.passen&&t?.zeilenHoehe===this._mass?.zeilenHoehe||(this._mass=t,this.requestUpdate())}spaltenListe(){return Ea(this.spalten)}get zeilenHoehe(){return ha(this.spaltenListe())}klickZeile(e){if(e===null||this.hasAttribute(`data-ff-editor`))return;let t=z(this),n=this.rohzeilen[e];t===``||n===void 0||wt(t,n)}setzeSuchtext(e){this._suchtext=e,this._seite=0,this.requestUpdate()}klickSortiere(e){this.editable||(this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.requestUpdate())}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}beobachte(){this._beobachter||(this._beobachter=sa(this,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}connectedCallback(){super.connectedCallback(),Ma(this),this.beobachte()}firstUpdated(){this.beobachte()}updated(){this._taktGemessen!==this.zeilenHoehe&&this.messeRumpf()}disconnectedCallback(){super.disconnectedCallback(),za(this),this._beobachter?.disconnect(),this._beobachter=null,Na(this)}static{this.styles=[j.styles,Vn,ci,lo]}render(){let t=this.spaltenListe(),n=e=>e.stopPropagation(),r=ro({spalten:t,imEditor:this.hasAttribute(`data-ff-editor`),source:this.source,datenGeliefert:this.datenGeliefert,datenzeilen:this.datenzeilen,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,wunschSeite:this._seite,gemessen:this._mass});return w`<div class="tabelle" style=${$i({"--takt":`${r.takt}px`,"--zeilen-hoehe":`${r.zeilenHoehe}px`})}>
      ${Pa(()=>this.spaltenListe(),e=>this.aendere(e),n)}
      ${co({spalten:t,cols:r.cols,editable:this.editable,zeigeSuche:this.suche===`ja`,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,zeilen:r.zeilen,linealTakte:r.linealTakte,datenzeilen:this.datenzeilen,zusatzzeilen:this.zusatzzeilen,hatQuelle:r.hatQuelle,auswahlIndex:this.auswahlIndex,leer:r.leer,leerText:this.leerText},{setzeSuchtext:e=>this.setzeSuchtext(e),dblklickKopf:(e,t)=>{this.editable&&(za(this),Ia(e,t,()=>this.spaltenListe(),e=>this.aendere(e)))},klickKopf:(t,n)=>{this.editable&&Ba(this,t,e.listenBindung.prop,n),this.klickSortiere(n)},klickZeile:e=>this.klickZeile(e),stop:n})}
      ${``}
      ${r.leer?E:ao({hatQuelle:r.hatQuelle,sichtbar:r.gesamt,gesamt:this.datenzeilen.length,suchtAktiv:this._suchtext.trim()!==``,auswahlAktiv:this.durchAuswahlGefiltert,seite:r.seite,seiten:r.seiten},{blaettere:e=>{this._seite=e,this.requestUpdate()},stop:n})}
    </div>`}};A([k({converter:{fromAttribute:e=>e?Da(e):Sa(),toAttribute:e=>JSON.stringify(e)}})],Q.prototype,`spalten`,void 0),A([k()],Q.prototype,`source`,void 0),A([k()],Q.prototype,`suche`,void 0),A([k()],Q.prototype,`leerText`,void 0),A([k({attribute:!1})],Q.prototype,`datenzeilen`,void 0),A([k({attribute:!1})],Q.prototype,`zusatzzeilen`,void 0),A([k({attribute:!1})],Q.prototype,`rohzeilen`,void 0),A([k({attribute:!1})],Q.prototype,`auswahlIndex`,void 0),A([k({attribute:!1})],Q.prototype,`durchAuswahlGefiltert`,void 0),A([k({attribute:!1})],Q.prototype,`datenGeliefert`,void 0),j.defineAndRegister(Q);var uo=sr(`text`);function fo(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(uo)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function po(e){let t=Or(e,uo);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function mo(e){fo(e)&&(e.text=``)}var ho=Sr({hydriere:po,verdrahte:mo}),go=ho.connect,_o=ho.disconnect,vo=6,yo=96,bo=14,xo={duenn:`300`,normal:`400`,fett:`700`},So={links:`left`,mitte:`center`,rechts:`right`},Co={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},wo=`standard`;function To(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(yo,Math.max(vo,t)):bo}function Eo(e){return typeof e==`string`&&e in xo?e:`normal`}function Do(e){return typeof e==`string`&&e in So?e:`links`}function Oo(e){return typeof e==`string`&&e in Co?e:wo}var $=class extends j{constructor(...e){super(...e),this.groesse=bo,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=wo,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:bo,gewicht:`normal`,ausrichtung:`links`,farbe:wo,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:vo,max:yo,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[j.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return w`<div
      class="text"
      style=${$i({fontSize:`${To(this.groesse)}px`,fontWeight:xo[Eo(this.gewicht)],textAlign:So[Do(this.ausrichtung)],color:Co[Oo(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),go(this)}disconnectedCallback(){super.disconnectedCallback(),_o(this)}};A([k({type:Number})],$.prototype,`groesse`,void 0),A([k()],$.prototype,`gewicht`,void 0),A([k()],$.prototype,`ausrichtung`,void 0),A([k()],$.prototype,`farbe`,void 0),A([k()],$.prototype,`text`,void 0),A([k()],$.prototype,`source`,void 0),A([k()],$.prototype,`textField`,void 0),j.defineAndRegister($);var ko=[`waagerecht`,`senkrecht`],Ao=`waagerecht`;function jo(e){return ko.includes(e)?e:Ao}var Mo=class extends j{constructor(...e){super(...e),this.richtung=Ao}static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`,richtung:Ao}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1,varianten:[{wenn:{attributeName:`richtung`,equals:`senkrecht`},startW:1,startH:6,breiteZiehbar:!1}]}}static{this.customProperties=[{attributeName:`richtung`,name:`Richtung`,description:`Waagerecht trennt oben von unten, senkrecht links von rechts.`,kind:`select`,options:[{value:`waagerecht`,label:`Waagerecht`},{value:`senkrecht`,label:`Senkrecht`}]}]}static{this.styles=[j.styles,o`
    ...
    `]}render(){return w`<div class="zeile"><slot></slot></div>`}};j.defineAndRegister(No),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;U(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();
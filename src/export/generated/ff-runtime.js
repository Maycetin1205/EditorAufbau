...
\f\r]`,_=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,xe=/-->/g,Se=/>/g,v=RegExp(`>|${be}(?:([^\\s"'>=/]+)(${be}*=${be}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,`g`),Ce=/'/g,we=/"/g,Te=/^(?:script|style|textarea|title)$/i,Ee=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),y=Ee(1),De=Ee(2),b=Symbol.for(`lit-noChange`),x=Symbol.for(`lit-nothing`),Oe=new WeakMap,S=h.createTreeWalker(h,129);function ke(e,t){if(!ve(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return pe===void 0?t:pe.createHTML(t)}var Ae=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:t===3?`<math>`:``,o=_;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===_?c[1]===`!--`?o=xe:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=v):(Te.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=v):o=Se:o===v?c[0]===`>`?(o=i??_,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?v:c[3]===`"`?we:Ce):o===we||o===Ce?o=v:o===xe||o===Se?o=_:(o=v,i=void 0);let d=o===v&&e[t+1].startsWith(`/>`)?` `:``;a+=o===_?n+ge:l>=0?(r.push(s),n.slice(0,l)+me+n.slice(l)+m+d):n+m+(l===-2?t:d)}return[ke(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:t===3?`</math>`:``)),r]},je=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=Ae(t,n);if(this.el=e.createElement(l,r),S.currentNode=this.el.content,n===2||n===3){let e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;(i=S.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes())for(let e of i.getAttributeNames())if(e.endsWith(me)){let t=u[o++],n=i.getAttribute(e).split(m),r=/([.?@])?(.*)/.exec(t);c.push({type:1,index:a,name:r[2],strings:n,ctor:r[1]===`.`?Fe:r[1]===`?`?Ie:r[1]===`@`?Le:Pe}),i.removeAttribute(e)}else e.startsWith(m)&&(c.push({type:6,index:a}),i.removeAttribute(e));if(Te.test(i.tagName)){let e=i.textContent.split(m),t=e.length-1;if(t>0){i.textContent=fe?fe.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],_e()),S.nextNode(),c.push({type:2,index:++a});i.append(e[t],_e())}}}else if(i.nodeType===8)if(i.data===he)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(m,e+1))!==-1;)c.push({type:7,index:a}),e+=m.length-1}a++}}static createElement(e,t){let n=h.createElement(`template`);return n.innerHTML=e,n}};function C(e,t,n=e,r){if(t===b)return t;let i=r===void 0?n._$Cl:n._$Co?.[r],a=g(t)?void 0:t._$litDirective$;return i?.constructor!==a&&(i?._$AO?.(!1),a===void 0?i=void 0:(i=new a(e),i._$AT(e,n,r)),r===void 0?n._$Cl=i:(n._$Co??=[])[r]=i),i!==void 0&&(t=C(e,i._$AS(e,t.values),i,r)),t}var Me=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??h).importNode(t,!0);S.currentNode=r;let i=S.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new Ne(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new Re(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=S.nextNode(),a++)}return S.currentNode=h,r}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},Ne=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,r){this.type=2,this._$AH=x,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=C(this,e,t),g(e)?e===x||e==null||e===``?(this._$AH!==x&&this._$AR(),this._$AH=x):e!==this._$AH&&e!==b&&this._(e):e._$litType$===void 0?e.nodeType===void 0?ye(e)?this.k(e):this._(e):this.T(e):this.$(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==x&&g(this._$AH)?this._$AA.nextSibling.data=e:this.T(h.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=je.createElement(ke(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.p(t);else{let e=new Me(r,this),n=e.u(this.options);e.p(t),this.T(n),this._$AH=e}}_$AC(e){let t=Oe.get(e.strings);return t===void 0&&Oe.set(e.strings,t=new je(e)),t}k(t){ve(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.O(_e()),this.O(_e()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let t=de(e).nextSibling;de(e).remove(),e=t}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},Pe=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,r,i){this.type=1,this._$AH=x,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=x}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=C(this,e,t,0),a=!g(e)||e!==this._$AH&&e!==b,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=C(this,r[n+o],t,o),s===b&&(s=this._$AH[o]),a||=!g(s)||s!==this._$AH[o],s===x?e=x:e!==x&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===x?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},Fe=class extends Pe{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===x?void 0:e}},Ie=class extends Pe{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==x)}},Le=class extends Pe{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=C(this,e,t,0)??x)===b)return;let n=this._$AH,r=e===x&&n!==x||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==x&&(n===x||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Re=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){C(this,e)}},ze=ue.litHtmlPolyfillSupport;ze?.(je,Ne),(ue.litHtmlVersions??=[]).push(`3.3.3`);var Be=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new Ne(t.insertBefore(_e(),e),e,void 0,n??{})}return i._$AI(e),i},Ve=globalThis,w=class extends p{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Be(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return b}};w._$litElement$=!0,w.finalized=!0,Ve.litElementHydrateSupport?.({LitElement:w});var He=Ve.litElementPolyfillSupport;He?.({LitElement:w}),(Ve.litElementVersions??=[]).push(`4.2.2`);var Ue={attribute:!0,type:String,converter:se,reflect:!1,hasChanged:ce},We=(e=Ue,t,n)=>{let{kind:r,metadata:i}=n,a=globalThis.litPropertyMetadata.get(i);if(a===void 0&&globalThis.litPropertyMetadata.set(i,a=new Map),r===`setter`&&((e=Object.create(e)).wrapped=!0),a.set(n.name,e),r===`accessor`){let{name:r}=n;return{set(n){let i=t.get.call(this);t.set.call(this,n),this.requestUpdate(r,i,e,!0,n)},init(t){return t!==void 0&&this.C(r,void 0,e,t),t}}}if(r===`setter`){let{name:r}=n;return function(n){let i=this[r];t.call(this,n),this.requestUpdate(r,i,e,!0,n)}}throw Error(`Unsupported decorator location: `+r)};function T(e){return(t,n)=>typeof n==`object`?We(e,t,n):((e,t,n)=>{let r=t.hasOwnProperty(n);return t.constructor.createProperty(n,e),r?Object.getOwnPropertyDescriptor(t,n):void 0})(e,t,n)}function E(e){return T({...e,state:!0,attribute:!1})}var Ge=new Map;function Ke(e){Ge.has(e.type)&&console.warn(`Block-Typ "${e.type}" wird ueberschrieben.`),Ge.set(e.type,e)}function qe(){return Array.from(Ge.values())}var Je={width:`auto`};function Ye(e){return Object.entries(e).map(([e,t])=>`${e.replace(/[A-Z]/g,e=>`-`+e.toLowerCase())}:${t}`).join(`;`)}var Xe={spalten:24,spaltePx:40,zeilePx:12,gapPx:8},Ze={rasterX:0,rasterY:0,rasterW:Xe.spalten,rasterH:1};function Qe(){return{display:`grid`,gridTemplateColumns:`repeat(${Xe.spalten}, 1fr)`,gridAutoRows:`${Xe.zeilePx}px`,gap:`${Xe.gapPx}px`,alignContent:`start`}}function $e(){return Ye(Qe())}var et=`weitereQuellen`,tt={[et]:[]},nt=`folgtAuswahl`,rt={[nt]:[]};function D(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var O=class extends w{constructor(...e){super(...e),this.editable=!1}static{this.styles=o`
  ...
  `}static{this.customProperties=[]}get customProperties(){return this.constructor.customProperties}inlineEdit(e,t){if(!this.editable)return;let n=e.currentTarget;if(!n||n.hasAttribute(`data-ff-bound`))return;e.stopPropagation(),e.preventDefault();let r=n.textContent??``,i=Array.from(n.childNodes),a=i.map(e=>e.textContent??``);n.setAttribute(`contenteditable`,`plaintext-only`),n.focus();let o=window.getSelection(),s=document.createRange();s.selectNodeContents(n),o?.removeAllRanges(),o?.addRange(s);let c=!1,l=e=>{if(!c)if(c=!0,n.removeAttribute(`contenteditable`),n.removeEventListener(`blur`,u),n.removeEventListener(`keydown`,d),e){let e=(n.textContent??``).trim();e!==r&&this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:t,value:e},bubbles:!0,composed:!0}))}else n.replaceChildren(...i),i.forEach((e,t)=>{e.textContent!==a[t]&&(e.textContent=a[t])})},u=()=>l(!0),d=e=>{e.key===`Enter`?(e.preventDefault(),n.blur()):e.key===`Escape`&&(e.preventDefault(),l(!1))};n.addEventListener(`blur`,u),n.addEventListener(`keydown`,d)}static defineAndRegister(e){customElements.get(e.tagName)||customElements.define(e.tagName,e),Ke({type:e.blockType,tagName:e.tagName,displayName:e.displayName,category:e.category,defaultProps:{...Je,...Ze,...e.acceptsDataSource?tt:null,...e.kannAuswahlFolgen?rt:null,...e.defaultProps},customProperties:e.customProperties,acceptsChildren:e.acceptsChildren??!1,resizableWidth:e.resizableWidth??!0,resizableHeight:e.resizableHeight??!1,allowedChildTypes:e.allowedChildTypes,allowedParentTypes:e.allowedParentTypes,lockedWidth:e.lockedWidth,defaultChildren:e.defaultChildren,childDirection:e.childDirection,showInPalette:e.showInPalette,templateChild:e.templateChild,containerHint:e.containerHint,addChildButton:e.addChildButton,acceptsDataSource:e.acceptsDataSource,satzWahl:e.satzWahl,kannAuswahlFolgen:e.kannAuswahlFolgen,bindableSpots:e.bindableSpots,actionValueSpots:e.actionValueSpots,listenBindung:e.listenBindung,blockEvents:e.blockEvents,pageBlock:e.pageBlock,flaechenSeite:e.flaechenSeite,maskenRand:e.maskenRand,raster:e.raster})}};D([T({type:Boolean,reflect:!0,attribute:`data-editable`})],O.prototype,`editable`,void 0);var it=`root`,at=class extends O{static{this.blockType=`ansicht`}static{this.tagName=`ff-ansicht`}static{this.displayName=`Ansicht`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.showInPalette=!1}static{this.allowedParentTypes=[it]}static{this.pageBlock=!0}static{this.flaechenSeite=!0}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.defaultProps={name:`Ansicht`}}static{this.styles=[O.styles,o`
    ...
    </div>`}};D([T()],ot.prototype,`quelle`,void 0),O.defineAndRegister(ot);var st=`data-ff-block-id`,ct=[`fixed`,`context`,`data_field`,`block_value`,`gewaehlte_zeile`,`previous_result`,`step_result`,`se_variable`,`aus`];function lt(e){return!!e&&typeof e==`object`&&!Array.isArray(e)}function ut(e){return!lt(e)||typeof e.source!=`string`||!ct.includes(e.source)||typeof e.value!=`string`||e.dataSourceId!==void 0&&typeof e.dataSourceId!=`string`||e.blockId!==void 0&&typeof e.blockId!=`string`||e.ergebnisFeld!==void 0&&typeof e.ergebnisFeld!=`string`?null:{source:e.source,value:e.value,...typeof e.dataSourceId==`string`?{dataSourceId:e.dataSourceId}:{},...typeof e.blockId==`string`?{blockId:e.blockId}:{},...e.source===`step_result`&&typeof e.ergebnisFeld==`string`?{ergebnisFeld:e.ergebnisFeld}:{}}}function dt(e){if(!lt(e)||typeof e.type!=`string`||typeof e.resultKey!=`string`)return null;if(e.type===`START_TOOL`)return typeof e.toolNr!=`string`||!Array.isArray(e.toolParams)||e.toolParams.some(e=>typeof e!=`string`)?null:{type:`START_TOOL`,resultKey:e.resultKey,toolNr:e.toolNr,toolParams:[...e.toolParams]};if(e.type===`POPUP_OPEN`||e.type===`POPUP_CLOSE`){let t=typeof e.popupId==`string`?e.popupId:void 0,n=typeof e.popup==`string`?e.popup:void 0;return t===void 0&&n===void 0?null:{type:e.type,resultKey:e.resultKey,...t===void 0?{}:{popupId:t},...n===void 0?{}:{popup:n}}}if(e.type===`RELATION`){if(typeof e.relationId!=`string`||!Array.isArray(e.extraParams)||!Array.isArray(e.params)&&!lt(e.bindings))return null;let t=[];if(Array.isArray(e.params))for(let n of e.params){let e=ut(n);if(!e)return null;t.push(e)}let n=[];for(let t of e.extraParams){let e=ut(t);if(!e)return null;n.push(e)}return{type:`RELATION`,resultKey:e.resultKey,relationId:e.relationId,params:t,extraParams:n}}return null}function ft(e){if(!e)return{};let t;try{t=JSON.parse(e)}catch{return{}}if(!lt(t))return{};let n={};for(let[e,r]of Object.entries(t)){if(!Array.isArray(r)||r.length===0)continue;let t=[],i=!1;for(let e of r){let n=dt(e);if(!n){i=!0;break}t.push(n)}!i&&t.length>0&&(n[e]=t)}return n}Object.values({idb:{id:`idb`,name:`IDB-Tabelle`,tabellenId:``,felderEinzeln:!1,kennungLabel:`Kennung`,kennungBeispiel:`ID0001`,kopfsatzMoeglich:!1,kopfsatzStandard:``,relationLadenMoeglich:!1,varMoeglich:!1,bestellBlock:`sefileloop`,feldVorsatzMoeglich:!1,standardFelder:[]},adressstamm:{id:`adressstamm`,name:`Adressstamm`,tabellenId:`ADR`,felderEinzeln:!0,kennungLabel:``,kennungBeispiel:``,kopfsatzMoeglich:!1,kopfsatzStandard:``,relationLadenMoeglich:!1,varMoeglich:!0,bestellBlock:`sefileloop`,feldVorsatzMoeglich:!1,standardFelder:[]},artikelstamm:{id:`artikelstamm`,name:`Artikelstamm`,tabellenId:`ART`,felderEinzeln:!0,kennungLabel:``,kennungBeispiel:``,kopfsatzMoeglich:!1,kopfsatzStandard:``,relationLadenMoeglich:!1,varMoeglich:!1,bestellBlock:`sefileloop`,feldVorsatzMoeglich:!1,standardFelder:[]},beleg:{id:`beleg`,name:`Beleg`,tabellenId:`BEL`,felderEinzeln:!0,kennungLabel:``,kennungBeispiel:``,kopfsatzMoeglich:!1,kopfsatzStandard:``,relationLadenMoeglich:!1,varMoeglich:!0,bestellBlock:`sefileloop`,feldVorsatzMoeglich:!1,standardFelder:[{code:`0_11`,label:`Satzschlüssel`},{code:`2_1`,label:`Belegart`},{code:`3_8`,label:`Belegnummer`},{code:`11_8`,label:`Kundennummer`},{code:`19_10`,label:`Belegdatum`},{code:`393_12`,label:`Warenwert`},{code:`441_12`,label:`MwSt-Betrag`},{code:`453_12`,label:`Gesamtbetrag`},{code:`3440_60`,label:`Name`}]},belegposition:{id:`belegposition`,name:`Belegpositionen`,tabellenId:`POS`,felderEinzeln:!0,kennungLabel:``,kennungBeispiel:``,kopfsatzMoeglich:!0,kopfsatzStandard:`BEL_0_11`,relationLadenMoeglich:!0,varMoeglich:!0,bestellBlock:`sefileloop`,feldVorsatzMoeglich:!1,standardFelder:[{code:`2_1`,label:`Belegart`},{code:`3_8`,label:`Belegnummer`},{code:`11_6`,label:`Positionsnummer`},{code:`17_1`,label:`Zeilenart`},{code:`18_25`,label:`Artikelnummer`},{code:`45_60`,label:`Bezeichnung`},{code:`164_8`,label:`Menge`},{code:`246_9`,label:`Einzelpreis`},{code:`280_12`,label:`Gesamtpreis`},{code:`372_5`,label:`MwSt-Satz`},{code:`645_10`,label:`Satznummer`},{code:`689_5`,label:`Mengeneinheit`},{code:`1401_12`,label:`Rohertrag`},{code:`2558_1`,label:`Farbkennzeichen`},{code:`3164_12`,label:`Rabatt`}]},datei:{id:`datei`,name:`Andere Datei`,tabellenId:``,felderEinzeln:!0,kennungLabel:`Kennung`,kennungBeispiel:`SERPOS`,kopfsatzMoeglich:!0,kopfsatzStandard:``,relationLadenMoeglich:!1,varMoeglich:!1,bestellBlock:`sefileloop`,feldVorsatzMoeglich:!1,standardFelder:[]},erpabfrage:{id:`erpabfrage`,name:`ERP-Abfrage`,tabellenId:``,felderEinzeln:!0,kennungLabel:`Kennung`,kennungBeispiel:`LIEFERADRESSE.GET`,kopfsatzMoeglich:!1,kopfsatzStandard:``,relationLadenMoeglich:!1,varMoeglich:!1,bestellBlock:`erpapicall`,feldVorsatzMoeglich:!0,standardFelder:[]}}).map(e=>e.id);var k=/^\d+_\d+$/,pt=/^\d+$/;function mt(e){if(!e||typeof e!=`object`)return null;let t=e,n=e=>typeof e==`string`?e.trim():``,r=n(t.nr),i=n(t.geberQuelleId),a=n(t.belegartFeld),o=n(t.belegnummerFeld),s=n(t.jahrFeld),c=n(t.archivFeld),l=Array.isArray(t.endeFelder)?t.endeFelder.filter(e=>typeof e==`string`&&k.test(e)):[];return!pt.test(r)||i===``||!k.test(a)||!k.test(o)||s!==``&&!k.test(s)||c!==``&&!k.test(c)||l.length===0?null:{nr:r,geberQuelleId:i,belegartFeld:a,belegnummerFeld:o,jahrFeld:s,archivFeld:c,endeFelder:l}}var ht=new Map;function gt(e,t){e!==``&&ht.set(e,t)}function _t(e){return ht.get(e)}function A(e){return typeof e==`object`&&!!e}function j(e,t){if(!(!Array.isArray(e)||t===``))for(let n of e){if(!A(n)||n.id!==t||typeof n.name!=`string`||typeof n.tableId!=`string`)continue;let e,r=mt(n.ladeRelation);if(r&&A(n.ladeRelation)){let t=n.ladeRelation.zusatzFelder,i=Array.isArray(t)?t.filter(e=>typeof e==`string`&&k.test(e)):[];e={...r,zusatzFelder:i}}return{id:t,name:n.name,tableId:n.tableId,indexField:typeof n.indexField==`string`?n.indexField:``,...e?{ladeRelation:e}:{}}}}function vt(e){return e==null?``:String(e).trim()}function M(e,t){if(!A(e)||t===``)return``;let n=t.trim(),r=vt(e[n]);if(r!==``)return r;for(let t of Object.keys(e))if(t===n||t.startsWith(`${n}_`)||t.endsWith(`_${n}`)){let n=vt(e[t]);if(n!==``)return n}let i=/^(\d+)_(\d+)$/.exec(n);if(!i)return``;let a=e.SATZNEU??e.SATZ??e.satzneu??e.satz??e.RAW??e.raw,o=a==null?``:String(a);if(o===``)return``;let s=Number(i[1]),c=Number(i[2]);return c<=0?``:o.substring(s,s+c).trim()}function yt(e,t){return e.indexField===``?``:M(t,e.indexField)}function bt(e,t,n){if(!A(e)||t===``)return!1;let r=t.trim(),i=!1;for(let t of Object.keys(e))(t===r||t.startsWith(`${r}_`)||t.endsWith(`_${r}`))&&(e[t]=n,i=!0);let a=/^(\d+)_(\d+)$/.exec(r);if(a){let t=[`SATZNEU`,`SATZ`,`satzneu`,`satz`,`RAW`,`raw`].find(t=>typeof e[t]==`string`);if(t){let r=e[t],o=Number(a[1]),s=Number(a[2]);if(s>0){let a=n.length>s?n.slice(0,s):n.padEnd(s,` `),c=r.length<o?r.padEnd(o,` `):r;e[t]=c.slice(0,o)+a+c.slice(o+s),i=!0}}}return i}function N(e){if(!A(e))return Array.isArray(e)?e:[];let t=[e.Zeilen,e.zeilen,e.Saetze,e.saetze,e.Rows,e.rows,e.Daten,e.daten];for(let e of t){if(Array.isArray(e))return e;if(typeof e==`string`)try{let t=JSON.parse(e);if(Array.isArray(t))return t}catch{}}return[]}function P(e,t){return vt(e).toLowerCase()===t.trim().toLowerCase()}function F(e,t,n){if(!A(e)||!A(e.Daten))return[];let r=e.Daten,i=r.SEFileLoop;if(Array.isArray(i)){for(let e of i)if(A(e)&&(P(e.ALIAS,t)||P(e.alias,t))){let t=N(e);if(t.length>0)return t}}else if(A(i))for(let e of Object.keys(i)){let n=i[e];if(P(e,t)||A(n)&&(P(n.ALIAS,t)||P(n.alias,t))){let e=N(n);if(e.length>0)return e}}for(let e of[`ErpApiCall`,`ERPAPICALL`,`erpapicall`]){let n=r[e];if(A(n))for(let e of Object.keys(n)){if(!P(e,t))continue;let r=N(n[e]);if(r.length>0)return r}}let a=r.Tabellen;if(A(a)){let e=[t,t.toUpperCase(),t.toLowerCase(),n];for(let t of e)if(t!==``&&t in a){let e=N(a[t]);if(e.length>0)return e}for(let e of Object.keys(a))if(P(e,t)){let t=N(a[e]);if(t.length>0)return t}}return _t(t)??[]}function xt(e){let t=e;if(typeof t==`string`)try{t=JSON.parse(t)}catch{return}if(!A(t)||!A(t.Daten))return;let n=t.Daten;if(!(!n.SEFileLoop&&!n.Tabellen&&!n.ErpApiCall))return n}function St(e){let t=e;if(typeof t==`string`)try{t=JSON.parse(t)}catch{return}if(!(!A(t)||!A(t.MSG)))return t.MSG.DATA}function Ct(e,t,n){let r=e.getAttribute(t)??``;if(r===``)return[];try{let e=JSON.parse(r);if(!Array.isArray(e))return[];let t=[];for(let r of e){if(!r||typeof r!=`object`)continue;let e=r,i=e[n];if(typeof i!=`string`||i===``)continue;let a=[];for(let t of Array.isArray(e.keyPairs)?e.keyPairs:[]){if(!t||typeof t!=`object`)continue;let e=t;typeof e.fromField!=`string`||typeof e.toField!=`string`||e.fromField.trim()===``||e.toField.trim()===``||a.push({fromField:e.fromField,toField:e.toField})}a.length!==0&&t.push({id:i,keyPairs:a})}return t}catch{return[]}}function wt(e){if(e==null)return``;try{return JSON.stringify(e)??``}catch{return``}}var I=new Map,Tt=new Set,Et=new Set,Dt=0,Ot=!1,kt=!1;function At(){if(Ot){kt=!0;return}Ot=!0;try{do kt=!1,Tt.forEach(e=>e());while(kt)}finally{Ot=!1}}function jt(e){Tt.add(e)}function Mt(e){return I.get(e)?.zeile}function Nt(e){return I.get(e)?.merkmal??``}function Pt(e){return I.get(e)?.nummer??0}function L(e){return e.getAttribute(`data-ff-id`)??``}function Ft(e,t,n){if(e===``)return[];let r=Nt(e);if(r===``)return[];let i=[];return t.forEach((e,t)=>{wt(n(e))===r&&i.push(t)}),i.length===0&&Rt(e),i}function It(e,t){if(e===``)return;let n=wt(t);if(n===``)return;let r=I.get(e);r&&r.merkmal===n?I.delete(e):I.set(e,{zeile:t,merkmal:n,nummer:++Dt}),At()}function Lt(e,t){if(e===``)return;let n=wt(t);n!==``&&I.get(e)?.merkmal!==n&&(I.set(e,{zeile:t,merkmal:n,nummer:++Dt}),At())}function Rt(e){I.has(e)&&(I.delete(e),At())}function zt(e){Et.add(e)}var Bt=nt.toLowerCase();function Vt(e){return Ct(e,Bt,`geberId`).map(e=>({geberId:e.id,keyPairs:e.keyPairs}))}function Ht(e,t){let n=t,r=!1;for(let t of Vt(e)){let e=Mt(t.geberId);e!==void 0&&(r=!0,n=n.filter(n=>t.keyPairs.every(t=>{let r=M(e,t.fromField);return r!==``&&r===M(n,t.toField)})))}return{rows:n,gefiltert:r}}function Ut(e,t){if(Vt(e).length===0)return t[0];let{rows:n,gefiltert:r}=Ht(e,t);return r?n[0]:void 0}var Wt=`ff-dialog-rahmen`,Gt=`ff-dialog-schliessen`,Kt=`ff-dialog-groesse`;function qt(e,t){let n=Number(e);return Number.isFinite(n)&&n>0?n:t}var R=class extends w{constructor(...e){super(...e),this.titel=`Dialog`,this.breite=520,this.hoehe=380,this.viewport=!1,this.escapeSchliesst=!1,this.ohneModal=!1,this.inhaltFest=!1,this.ziehbar=!1,this.escapeRegistriert=!1,this.aufTaste=e=>{e.key===`Escape`&&(e.stopPropagation(),this.schliesse())}}static{this.styles=o`
    :host {
      position: absolute;
      inset: 0;
      display: block;
  ...
  `}aktualisiereEscape(){let e=this.isConnected&&this.escapeSchliesst;e!==this.escapeRegistriert&&(e?document.addEventListener(`keydown`,this.aufTaste,!0):document.removeEventListener(`keydown`,this.aufTaste,!0),this.escapeRegistriert=e)}ziehe(e,t){if(!this.ziehbar)return;e.preventDefault(),e.stopPropagation();let n=t===`breite`?qt(this.breite,520):qt(this.hoehe,380),r=t===`breite`?240:160,i=t===`breite`?e.clientX:e.clientY,a=Math.max(r,Math.round(n)),o=!1,s=(e,n)=>{this.dispatchEvent(new CustomEvent(Kt,{detail:{achse:t,wert:e,geste:n},bubbles:!0,composed:!0}))},c=e=>{let c=t===`breite`?e.clientX:e.clientY,l=Math.max(r,Math.round(n+(c-i)*2));l!==a&&(a=l,s(l,o?`laeuft`:`beginn`),o=!0)},l=()=>{window.removeEventListener(`pointermove`,c),window.removeEventListener(`pointerup`,l),window.removeEventListener(`pointercancel`,l),window.removeEventListener(`blur`,l),o&&s(a,`ende`)};window.addEventListener(`pointermove`,c),window.addEventListener(`pointerup`,l),window.addEventListener(`pointercancel`,l),window.addEventListener(`blur`,l)}aufStandard(e,t){this.ziehbar&&(e.stopPropagation(),this.dispatchEvent(new CustomEvent(Kt,{detail:{achse:t,wert:0,geste:`standard`},bubbles:!0,composed:!0})))}schliesse(){this.dispatchEvent(new CustomEvent(Gt,{bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this.aktualisiereEscape()}updated(e){e.has(`escapeSchliesst`)&&this.aktualisiereEscape()}disconnectedCallback(){this.escapeRegistriert&&=(document.removeEventListener(`keydown`,this.aufTaste,!0),!1),super.disconnectedCallback()}render(){let e=qt(this.breite,520),t=qt(this.hoehe,380);return y`
    ...
    `}};D([T()],R.prototype,`titel`,void 0),D([T({type:Number})],R.prototype,`breite`,void 0),D([T({type:Number})],R.prototype,`hoehe`,void 0),D([T({type:Boolean,reflect:!0})],R.prototype,`viewport`,void 0),D([T({type:Boolean,attribute:`escape-schliesst`})],R.prototype,`escapeSchliesst`,void 0),D([T({type:Boolean,attribute:`ohne-modal`})],R.prototype,`ohneModal`,void 0),D([T({type:Boolean,reflect:!0,attribute:`inhalt-fest`})],R.prototype,`inhaltFest`,void 0),D([T({type:Boolean,reflect:!0})],R.prototype,`ziehbar`,void 0),customElements.get(`ff-dialog-rahmen`)||customElements.define(Wt,R);var Jt=`input,select,textarea,button,a[href],[tabindex]:not([tabindex="-1"])`;function Yt(e){for(let t of Array.from(e.querySelectorAll(`*`))){if(t instanceof HTMLElement&&t.matches(Jt)&&!t.hasAttribute(`disabled`))return t;let e=t.shadowRoot?Yt(t.shadowRoot):null;if(e)return e}return null}var z=class extends O{constructor(...e){super(...e),this.name=`Popup`,this.breite=520,this.hoehe=380,this.offen=!1}static{this.blockType=`popup`}static{this.tagName=`ff-popup`}static{this.displayName=`Popup`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.showInPalette=!1}static{this.allowedParentTypes=[it]}static{this.pageBlock=!0}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.defaultProps={name:`Popup`,breite:520,hoehe:380}}static{this.styles=[O.styles,o`
    ...
    `]}onClose(){this.hasAttribute(`data-ff-editor`)||this.removeAttribute(`offen`)}updated(e){super.updated(e),!(!e.has(`offen`)||!this.offen)&&(this.hasAttribute(`data-ff-editor`)||this.updateComplete.then(()=>{!this.offen||!this.isConnected||(Yt(this)??(this.shadowRoot?Yt(this.shadowRoot):null))?.focus()}))}render(){return y`<ff-dialog-rahmen
        .breite=${this.breite}
        .hoehe=${this.hoehe}
        ohne-modal
        inhalt-fest
      ...
      </ff-dialog-rahmen>`}};D([T()],z.prototype,`name`,void 0),D([T()],z.prototype,`breite`,void 0),D([T()],z.prototype,`hoehe`,void 0),D([T({type:Boolean,reflect:!0})],z.prototype,`offen`,void 0),O.defineAndRegister(z);var Xt=[`GET_RELATION`,`PUT_RELATION`,`PUTADD_RELATION`];function Zt(e){return`${String(e.getDate()).padStart(2,`0`)}.${String(e.getMonth()+1).padStart(2,`0`)}.${e.getFullYear()}`}function Qt(e,t){return e.params.map(e=>e.replace(/\{([A-Za-z0-9_]+)\}/g,(e,n)=>String(t[n]??``)))}var $t=8e3,B=null,en=null;function tn(){let e=document.createElement(`div`);return e.setAttribute(`data-ff-meldung`,``),e.setAttribute(`role`,`alert`),e.style.cssText=[`position:fixed`,`top:0`,`left:0`,`right:0`,`z-index:2147483647`,`padding:7px 12px`,`background:var(--se-red-soft,#fbe7e6)`,`color:var(--se-red,#c0201a)`,`border-bottom:1px solid var(--se-red,#c0201a)`,`font:500 12px/1.4 system-ui,sans-serif`,`cursor:pointer`].join(`;`),e.title=`Klicken zum Schließen`,e.addEventListener(`click`,nn),e}function nn(){en&&=(clearTimeout(en),null),B?.remove(),B=null}function V(e){typeof document>`u`||!document.body||(B||(B=tn(),document.body.appendChild(B)),B.textContent=e,en&&clearTimeout(en),en=setTimeout(nn,$t))}function H(){return globalThis}function rn(){let e=H();return A(e.SEDATA)&&A(e.SEDATA.Daten)}function an(){let e=H();try{e.selib?.Json?.InitializeERPConnection?.()}catch{}try{typeof e.InitialisiereSchnittstelle==`function`&&e.InitialisiereSchnittstelle()}catch{}}function on(){let e=H();try{typeof e.ResetDataBasis==`function`&&e.ResetDataBasis()}catch{}try{typeof e.InitialisiereDatenBasis==`function`&&e.InitialisiereDatenBasis()}catch{}}var sn=new Set,cn=new Set;function ln(e){sn.add(e)}function un(e){return cn.add(e),()=>{cn.delete(e)}}function dn(){sn.forEach(e=>e())}function fn(){dn()}function pn(e){cn.forEach(t=>{try{t(e)}catch{}})}function mn(e){let t=xt(e);if(!t){pn(e);return}let n=H();A(n.SEDATA)||(n.SEDATA={}),n.SEDATA.Daten=t,on(),dn()}function hn(e=0){let t=H();if(typeof t.basisHTML_REGISTER==`function`){try{t.basisHTML_SetConsoleLog?.(!0,!0)}catch{}try{t.basisHTML_REGISTER(e=>{mn(e)},document.title,`1.0`)}catch(e){V(`SoftEngine-Anmeldung fehlgeschlagen: `+(e instanceof Error?e.message:String(e)))}return}e<400?setTimeout(()=>{hn(e+1)},25):V(`SoftEngine-Anschluss nicht gefunden — die Maske bleibt ohne Daten.`)}var gn=!1;function _n(){if(gn)return;gn=!0,an();let e=H();e.Erstellen=()=>{on(),dn()},e.initData=e.Erstellen,e.ReloadData=()=>{dn()},hn(),window.addEventListener(`message`,e=>{if(typeof H().basisHTML_REGISTER==`function`)return;let t=St(e.data);t!==void 0&&mn(t)},!0);let t=0,n=setInterval(()=>{t+=1,rn()?(clearInterval(n),on(),dn()):t>100&&(clearInterval(n),V(`Keine Daten von SoftEngine empfangen — die Maske zeigt nichts an.`))},300)}function vn(e){return e instanceof Error?e.message:String(e)}function yn(e,t){if(!(!Array.isArray(e)||t===``)){for(let n of e)if(!(!A(n)||n.id!==t)&&!(typeof n.verb!=`string`||!Xt.includes(n.verb))&&!(typeof n.nr!=`string`||n.nr===``)&&!(!Array.isArray(n.params)||n.params.some(e=>typeof e!=`string`)))return{id:t,verb:n.verb,nr:n.nr,params:n.params}}}var bn=[`RESULT`,`result`,`PINDEX`,`pindex`,`INDEX`,`index`,`0_10`,`KEY`,`key`,`ID`,`id`,`VALUE`,`value`];function xn(e){if(typeof e!=`string`)return e;try{return JSON.parse(e)}catch{return}}function Sn(e){if(typeof e==`string`){let t=e.trim();return t===``?void 0:t}if(typeof e==`number`||typeof e==`boolean`)return String(e)}function Cn(e,t){if(t>12)return;let n=Sn(e);if(n!==void 0)return n;if(Array.isArray(e)){for(let n of e){let e=Cn(n,t+1);if(e!==void 0)return e}return}if(A(e)){for(let n of bn){if(!(n in e))continue;let r=Cn(e[n],t+1);if(r!==void 0)return r}for(let n of Object.values(e)){let e=Cn(n,t+1);if(e!==void 0)return e}}}function wn(e){let t=xn(e);if(A(t)){for(let e of bn){if(!(e in t))continue;let n=Cn(t[e],0);if(n!==void 0)return n}for(let e of Object.values(t))if(Array.isArray(e))for(let t of e){let e=wn(t);if(e!==void 0)return e}else if(A(e)){let t=wn(e);if(t!==void 0)return t}}}var Tn=[`RESULT`,`result`];function En(e,t=0){if(t>12)return;let n=typeof e==`string`?xn(e):e;if(Array.isArray(n)){for(let e of n){let n=En(e,t+1);if(n!==void 0)return n}return}if(A(n)){for(let e of Tn){let t=n[e];if(typeof t==`string`)return t;if(typeof t==`number`||typeof t==`boolean`)return String(t)}for(let e of Object.values(n)){let n=En(e,t+1);if(n!==void 0)return n}}}function Dn(e,t,n=0){if(t.trim()===``||n>12)return``;let r=typeof e==`string`?xn(e):e;if(Array.isArray(r)){for(let e of r){let r=Dn(e,t,n+1);if(r!==``)return r}return``}if(!A(r))return``;let i=M(r,t);if(i!==``)return i;for(let e of Object.values(r)){let r=Dn(e,t,n+1);if(r!==``)return r}return``}function On(e){return A(e)?Object.keys(e).filter(e=>/^Message\d+$/.test(e)):[]}function kn(e,t,n=!1){if(!A(e))return;let r=On(e).filter(e=>!t.has(e)).sort((e,t)=>Number(t.slice(7))-Number(e.slice(7)));for(let t of r){let r=n?En(e[t]):wn(e[t]);if(r!==void 0)return{wert:r,roh:e[t]}}}var An=[],jn=!1,Mn=6e3,Nn=100;function Pn(){if(jn||An.length===0)return;jn=!0;let e=An.shift(),t=H(),n=new Set(On(t.SEDATA)),r=!1,i=(t,n)=>{r||(r=!0,o(),clearInterval(s),clearTimeout(c),jn=!1,e.resolve({wert:t,roh:n}),queueMicrotask(Pn))},a=e.optionen.satzAntwort===!0,o=un(e=>{let t=a?En(e):wn(e);t!==void 0&&i(t,e)}),s=setInterval(()=>{let e=kn(H().SEDATA,n,a);e!==void 0&&i(e.wert,e.roh)},Nn),c=setTimeout(()=>{e.optionen.still||V(`Daten laden: SoftEngine hat nicht geantwortet (Relation Nr. ${e.template.nr}).`),i(``,void 0)},Mn);if(typeof t.basisHTML_SND_MSG!=`function`){e.optionen.still||V(`Daten laden nicht möglich: keine Verbindung zu SoftEngine.`),i(``,void 0);return}try{t.basisHTML_SND_MSG(`GET_RELATION`,{NR:e.template.nr,PARAMS:e.params})}catch(t){e.optionen.still||V(`Daten laden fehlgeschlagen (Relation Nr. ${e.template.nr}): ${vn(t)}`),i(``,void 0)}}function Fn(e,t,n={}){_n();let r=H();if(e.verb!==`GET_RELATION`){if(typeof r.basisHTML_SND_MSG!=`function`)return V(`Speichern nicht möglich: keine Verbindung zu SoftEngine. Die Eingabe wurde NICHT übernommen.`),Promise.resolve({wert:``,roh:void 0});try{r.basisHTML_SND_MSG(e.verb,{NR:e.nr,PARAMS:[...t]})}catch(t){V(`Speichern fehlgeschlagen (Relation Nr. ${e.nr}): ${vn(t)}`)}return Promise.resolve({wert:``,roh:void 0})}return new Promise(r=>{An.push({template:e,params:[...t],resolve:r,optionen:n}),Pn()})}function In(e,t){if(!A(t))return``;let n=t.document;if(!n||typeof n.querySelectorAll!=`function`)return``;let r=Array.from(n.querySelectorAll(`[${st}]`)).find(t=>t.getAttribute(st)===e.blockId);if(!r)return``;let i=r[e.value];return i==null?``:String(i)}function Ln(e,t,n=H()){if(e.source===`aus`)return``;if(e.source===`fixed`)return e.value;if(e.source===`context`)return t.context[e.value]??``;if(e.source===`previous_result`)return t.previousResult;if(e.source===`step_result`){let n=Number(e.value);if(!Number.isInteger(n)||n<0)return``;let r=e.ergebnisFeld??``;return r===``?t.stepResults?.[n]??``:Dn(t.stepRohErgebnisse?.[n],r)}if(e.source===`block_value`)return In(e,n);if(e.source===`gewaehlte_zeile`){let n=t.gewaehlteZeile?.(e.blockId??``);return n===void 0?``:M(n,e.value)}if(!A(n))return``;if(e.source===`se_variable`){let t=n.SEDATA;if(!A(t)||!A(t.Daten)||!A(t.Daten.VARArrays))return``;let r=t.Daten.VARArrays[e.value];return r==null?``:String(r)}let r=j(n.FF_DATA_SOURCES,e.dataSourceId??``);if(!r)return``;let i=F(n.SEDATA,r.name,r.tableId),a=t.context.PINDEX??``,o=a!==``&&r.indexField!==``?i.find(e=>M(e,r.indexField)===a):i[0];return o?M(o,e.value):``}function Rn(e,t){let n=`0,START_TOOL,`+e;return t.length>0&&(n+=`,`+t.map(e=>encodeURIComponent(e)).join(`,`)),n}function zn(e,t){if(e.trim()===``)return;let n=H();try{if(typeof n.sendBWLinkIntern==`function`){n.sendBWLinkIntern(Rn(e,t));return}}catch{}try{if(typeof n.basisHTML_SND_MSG==`function`){let r={NR:e};t.length>0&&(r.PARAMS=[...t]),n.basisHTML_SND_MSG(`START_TOOL`,r)}}catch{}}function Bn(e,t,n){if(t.trim()===``)return;let r=Array.from(e.querySelectorAll(z.tagName)),i=r.filter(e=>(e.getAttribute(`name`)??z.defaultProps.name)===t);if(i.length===0){V(`Fenster „`+t+`“ gibt es in dieser Maske nicht.`);return}if(i.length>1){V(`Fenster „`+t+`“ gibt es mehrfach — keines ist gemeint.`);return}let a=i[0];if(!n){a.removeAttribute(`offen`);return}for(let e of r)e!==a&&e.removeAttribute(`offen`);a.setAttribute(`offen`,``)}var Vn=new WeakMap;function Hn(e){V(`Aktionskette fehlgeschlagen: `+(e instanceof Error?e.message:String(e)))}async function Un(e,t,n){if(e.hasAttribute(`data-ff-editor`))return;let r=ft(e.getAttribute(`data-ff-aktionen`))[t];if(!r||r.length===0)return;let i=Vn.get(e);if(i||(i=new Set,Vn.set(e,i)),!i.has(t)){i.add(t);try{let t={...n,NOW_DATE:Zt(new Date)},i=``,a=[],o=[],s=()=>{a.push(``),o.push(void 0)};for(let n of r){if(n.type===`START_TOOL`){zn(n.toolNr,Qt({params:n.toolParams},t)),s();continue}if(n.type===`POPUP_OPEN`||n.type===`POPUP_CLOSE`){Bn(e.ownerDocument??document,n.popup??``,n.type===`POPUP_OPEN`),s();continue}let r=yn(H().FF_RELATIONS,n.relationId);if(!r){s();continue}let c={context:t,previousResult:i,stepResults:a,stepRohErgebnisse:o,gewaehlteZeile:Mt},l=await Fn(r,[...n.params,...n.extraParams].map(e=>Ln(e,c))),u=l.wert;a.push(u),o.push(l.roh),r.verb===`GET_RELATION`&&(i=u),n.resultKey!==``&&(t[n.resultKey]=u)}}finally{i.delete(t)}}}var Wn=new WeakSet;function Gn(e,t){if(e.hasAttribute(`data-ff-editor`)||!e.hasAttribute(`data-ff-aktionen`)||Wn.has(e))return;Wn.add(e);let n=ft(e.getAttribute(`data-ff-aktionen`));Object.values(n).some(e=>e.some(e=>e.type===`RELATION`))&&_n(),e.addEventListener(`click`,()=>{Un(e,t,{}).catch(Hn)})}var Kn=class extends O{constructor(...e){super(...e),this.label=`Klick mich`}static{this.blockType=`button`}static{this.tagName=`ff-button`}static{this.displayName=`Schaltfläche`}static{this.category=`eingabe`}static{this.defaultProps={label:`Klick mich`}}static{this.resizableWidth=!1}static{this.blockEvents=[{key:`onClick`,name:`Klick`}]}static{this.raster={startW:4,startH:2,minW:2,minH:2}}static{this.customProperties=[]}static{this.styles=[O.styles,o`
      button {
        box-sizing: border-box;
        padding: 7px 16px;
        cursor: pointer;
...
`,U=class extends O{constructor(...e){super(...e),this.chipVariant=`info`,this.heading=``,this.heading2=``,this.time=``,this.date=``,this.avatar=``,this.meta=``,this.text=``,this.chipText=``,this.headingField=``,this.heading2Field=``,this.timeField=``,this.dateField=``,this.avatarField=``,this.metaField=``,this.textField=``,this.chipTextField=``}static{this.blockType=`card`}static{this.tagName=`ff-card`}static{this.displayName=`Karte`}static{this.category=`anzeige`}static{this.allowedParentTypes=[`kanban-spalte`,`kanban-zimmer`]}static{this.showInPalette=!1}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={chipVariant:`info`,heading:``,heading2:``,time:``,date:``,avatar:``,meta:``,text:``,chipText:``,headingField:``,heading2Field:``,timeField:``,dateField:``,avatarField:``,metaField:``,textField:``,chipTextField:``}}static{this.bindableSpots=[{prop:`time`,label:`Zeit`},{prop:`date`,label:`Datum`},{prop:`avatar`,label:`Avatar`},{prop:`heading`,label:`Titel`},{prop:`heading2`,label:`Titel 2`},{prop:`meta`,label:`Unterzeile`},{prop:`text`,label:`Textzeile`},{prop:`chipText`,label:`Chip`}]}static{this.customProperties=[Xn(`chipVariant`,`Bedeutung des Chips auf der Karte — bestimmt die Chip-Farbe.`)]}static{this.styles=[O.styles,Zn,ar]}stelle(e,t){return y`<span
    ...
    >${this[e]}</span>`}hatReiter(){return this.hasAttribute(`data-ff-editor`)||this.date.trim()!==``||this.time.trim()!==``}updated(e){super.updated(e),this.toggleAttribute(`hat-reiter`,this.hatReiter())}render(){let e=Jn(this.chipVariant),t=this.hasAttribute(`data-ff-editor`),n=e=>t||e.trim()!==``,r=this.hatReiter(),i=n(this.avatar)||n(this.heading)||n(this.meta),a=n(this.heading2)||n(this.chipText);return y`<div class="card v-${e}${r?``:` ohne-reiter`}">
      ...
      ${i?y`<div class="kopf">
            ${n(this.avatar)?y`<span
                ...
                >${this.avatar.trim()===``?x:ir(this.avatar)}</span>`:x}
            <div class="namen">
    ...
    `]}setzeTag(e){fr(e),this.tag=dr()}render(){return y`<div class="waehler">
      <div class="riegel">
    ...
    </div>`}connectedCallback(){super.connectedCallback(),this.tag=dr()||sr(new Date),!this.hasAttribute(`data-ff-editor`)&&(this.setzeTag(this.tag),this.tagAbmelden?.(),this.tagAbmelden=pr(()=>{this.tag=dr()}))}disconnectedCallback(){super.disconnectedCallback(),this.tagAbmelden?.(),this.tagAbmelden=null}};D([E()],mr.prototype,`tag`,void 0),O.defineAndRegister(mr);function hr(e,t,n,r){return{attributeName:e,name:t,description:n,kind:`segment`,options:[{value:`nein`,label:`Nein`},{value:`ja`,label:`Ja`}],...r}}var gr={attributeName:`fieldType`,equals:`nachschlagen`},_r=[{attributeName:`fieldType`,name:`Feldtyp`,description:`Welche Art Eingabe das Feld annimmt.`,kind:`select`,options:[{value:`text`,label:`Text`},{value:`number`,label:`Zahl`},{value:`textarea`,label:`Mehrzeilig`},{value:`select`,label:`Auswahl`},{value:`date`,label:`Datum`},{value:`time`,label:`Uhrzeit`},{value:`checkbox`,label:`Ankreuzfeld`},{value:`nachschlagen`,label:`Nachschlagen`}]},{attributeName:`options`,name:`Auswahl-Optionen`,description:`Nur bei Feldtyp "Auswahl": Einträge durch Komma getrennt (z. B. "Zimmer 1, Zimmer 2") — jeder Eintrag wird eine Dropdown-Zeile.`,kind:`text`,visibleWhen:{attributeName:`fieldType`,equals:`select`}},{attributeName:`nachschlagQuelle`,name:`Quelle`,description:`Nur bei Feldtyp "Nachschlagen": aus dieser Datenquelle wählt der Bediener eine Zeile.`,kind:`quelle`,visibleWhen:gr},{attributeName:`speicherFeld`,name:`Gespeichert wird`,description:`Feld der Nachschlage-Quelle, dessen Wert die Maske sich merkt und die Kette "Wert geändert" weitergibt (z. B. die Nummer). Im Feld sichtbar ist die erste Spalte des Nachschlage-Fensters — ohne eigene Spalten ist das dieser Wert selbst.`,kind:`field`,quelleProp:`nachschlagQuelle`,klarnameProp:`speicherTitel`,visibleWhen:gr},hr(`einzigerTreffer`,`Einzigen Treffer übernehmen`,`Bleibt in der Maske genau EIN Satz übrig (weil das Feld der Auswahl eines anderen folgt), übernimmt es diesen von selbst — ohne dass der Bediener die Lupe drückt. Nur in ein leeres Feld; die Lupe bleibt daneben bedienbar.`,{visibleWhen:gr}),{attributeName:`valueField`,name:`Feld`,description:`Feld der angeschlossenen Datenquelle, dessen Wert angezeigt und lokal aktualisiert wird.`,kind:`field`,visibleWhen:{attributeName:`fieldType`,keinesVon:[`checkbox`,`nachschlagen`]}}];function vr(e){return`${e.toLowerCase()}field`}function yr(e){let t=e.split(`::`);if(t.length!==2)return{quelleId:``,code:e};let[n,r]=t;return n===``||r===``?{quelleId:``,code:e}:{quelleId:n,code:r}}var br=999,xr=`0`,Sr=`255`,Cr=new Map;function wr(e){let t=_t(e);gt(e,[]),t!==void 0&&t.length>0&&fn()}async function Tr(e,t,n,r,i){return(await Fn({id:`relation-lader`,verb:`GET_RELATION`,nr:e.nr,params:[]},[t.belegart,r,i,t.belegnummer,t.jahr,t.archiv,``,String(n),``,``,``,``],{still:!0,satzAntwort:!0})).wert}function Er(e,t,n){let r=(Cr.get(e.id)??0)+1;if(Cr.set(e.id,r),n===void 0){wr(e.name);return}let i={belegart:M(n,t.belegartFeld),belegnummer:M(n,t.belegnummerFeld),jahr:t.jahrFeld===``?``:M(n,t.jahrFeld),archiv:t.archivFeld===``?``:M(n,t.archivFeld)};if(i.belegart===``||i.belegnummer===``){wr(e.name);return}wr(e.name),(async()=>{let n=[],a=!1;for(let o=1;o<=br;o+=1){let s=await Tr(t,i,o,xr,Sr);if(Cr.get(e.id)!==r)return;if(t.endeFelder.every(e=>M({SATZ:s},e)===``)){a=!0;break}let c={SATZ:s};for(let n of t.zusatzFelder){let a=n.indexOf(`_`),s=await Tr(t,i,o,n.slice(0,a),n.slice(a+1));if(Cr.get(e.id)!==r)return;c[n]=s}n.push(c)}a||V(`Positionen laden: nach ${br} Zeilen ohne Ende-Kennung abgebrochen (Relation Nr. ${t.nr}) — die Liste ist wahrscheinlich unvollständig, vermutlich passen Relationsnummer oder Ende-Felder nicht.`),Cr.get(e.id)===r&&(gt(e.name,n),fn())})()}var Dr=new Map,Or=!1;function kr(){let e=new Map;for(let t of qe())t.satzWahl&&e.set(t.tagName.toLowerCase(),(t.satzWahl.quelleProp??`source`).toLowerCase());return e}function Ar(e,t,n=typeof document>`u`?void 0:document){if(e===``||n===void 0)return;let r=null;for(let i of Array.from(n.querySelectorAll(`[data-ff-id]`))){let n=t.get(i.tagName.toLowerCase());if(n===void 0||i.getAttribute(n)!==e)continue;let a=i.getAttribute(`data-ff-id`)??``,o=Mt(a);if(o===void 0)continue;let s=Pt(a);(r===null||s>r.nummer)&&(r={zeile:o,nummer:s})}return r?.zeile}function jr(){let e=H().FF_DATA_SOURCES;if(!Array.isArray(e))return;let t=kr();for(let n of e){if(!A(n)||typeof n.id!=`string`)continue;let r=j(e,n.id);if(!r?.ladeRelation)continue;let i=Ar(r.ladeRelation.geberQuelleId,t),a=wt(i);Dr.get(r.id)!==a&&(Dr.set(r.id,a),Er(r,r.ladeRelation,i))}}function Mr(){Or||(Or=!0,jt(jr),zt(()=>Dr.clear()))}function Nr(e){let t=new Set,n=!1,r=()=>{rn()&&t.forEach(e.hydriere)};return{connect:i=>{i.hasAttribute(`data-ff-editor`)||(t.add(i),e.verdrahte?.(i),n||(n=!0,ln(r),pr(r),jt(r),Mr()),_n(),rn()&&e.hydriere(i))},disconnect:e=>{t.delete(e)}}}var Pr=et.toLowerCase(),Fr=``;function Ir(e){if(e.length===0)return``;let t=[];for(let n of e){let e=n.trim();if(e===``)return``;t.push(e)}return t.join(Fr)}function Lr(e){return Ct(e,Pr,`quelleId`).map(e=>({quelleId:e.id,keyPairs:e.keyPairs}))}function Rr(e){let t=Lr(e);if(t.length===0)return(e,t)=>M(e,yr(t).code);let n=H().SEDATA,r=H().FF_DATA_SOURCES,i=new Map;for(let e of t){let t=j(r,e.quelleId);if(!t)continue;let a=F(n,t.name,t.tableId),o=new Map;for(let t of a){let n=Ir(e.keyPairs.map(e=>M(t,e.toField)));n!==``&&!o.has(n)&&o.set(n,t)}i.set(e.quelleId,{nachSchluessel:o,hierFelder:e.keyPairs.map(e=>e.fromField)})}return(e,t)=>{let{quelleId:n,code:r}=yr(t);if(n===``)return M(e,r);let a=i.get(n);if(!a)return``;let o=Ir(a.hierFelder.map(t=>M(e,t)));if(o===``)return``;let s=a.nachSchluessel.get(o);return s===void 0?``:M(s,r)}}function zr(e,t){let n=e.getAttribute(`source`)??``,r=e.getAttribute(t)??``;if(n===``||r===``)return{art:`ungebunden`};let i=j(H().FF_DATA_SOURCES,n);if(!i)return{art:`ohneQuelle`};let a=Ut(e,F(H().SEDATA,i.name,i.tableId));if(a===void 0)return{art:`ohneZeile`};let{quelleId:o,code:s}=yr(r);return{art:`wert`,wert:o===``?M(a,s):Rr(e)(a,r),zeile:a,quelle:i,quelleId:o,reinerCode:s}}var Br=new WeakMap,Vr=new WeakSet;function Hr(e){let t=/^(\d{2})\.(\d{2})\.(\d{4})$/.exec(e);return t?`${t[3]}-${t[2]}-${t[1]}`:e}function Ur(e){let t=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);return t?`${t[3]}.${t[2]}.${t[1]}`:e}function Wr(e){return typeof e.value==`string`?e.value:``}function Gr(e){if(e.pruefeEigenenWert?.(),e.getAttribute(`fieldtype`)===`nachschlagen`){Br.delete(e);return}let t=zr(e,vr(`value`));if(t.art!==`wert`){Br.delete(e),t.art===`ohneZeile`&&(e.value=``);return}let{zeile:n,quelle:r,quelleId:i,reinerCode:a,wert:o}=t,s=yt(r,n);i===``?Br.set(e,{row:n,code:a,pindex:s}):Br.delete(e),e.value=o}function Kr(e){let t=Br.get(e);return t&&bt(t.row,t.code,Wr(e)),t}function qr(e){Vr.has(e)||(Vr.add(e),e.addEventListener(`input`,()=>{Kr(e)}),e.addEventListener(`change`,()=>{let t=Kr(e);Un(e,`onChange`,{VALUE:Wr(e),PINDEX:t?.pindex??``}).catch(Hn)}))}var Jr=Nr({hydriere:Gr,verdrahte:qr}),Yr=Jr.connect,Xr=Jr.disconnect,Zr=o`
  .feld {
    font-family: var(--se-font);
...
`,Qr=[`text`,`number`,`textarea`,`select`,`date`,`time`,`checkbox`,`nachschlagen`];function $r(e){return Qr.includes(e)?e:`text`}var ei=[`text`,`number`,`textarea`,`select`,`nachschlagen`,`date`,`time`],ti={select:`ph-select`,date:`ph-nativ`,time:`ph-nativ`,nachschlagen:`ph-nachschlag`},ni=4;function ri(e){return e??ni}function ii(e,t,n){return Math.max(1,Math.floor((e-t)/n))}function ai(e,t,n){let r=ii(e,t,n),i=e-t;return i<n?{passen:r,zeilenHoehe:n}:{passen:r,zeilenHoehe:Math.floor(i/r*100)/100}}function oi(e,t){return e===null?null:Math.max(0,e-t)}function si({sichtbar:e,hatQuelle:t,proSeite:n,wunschSeite:r,platzhalterZeilen:i}){let a=t?Math.max(1,Math.ceil(e.length/n)):1,o=Math.min(Math.max(r,0),a-1);return t?{seiten:a,seite:o,zeilen:[...e.slice(o*n,(o+1)*n)]}:{seiten:a,seite:o,zeilen:Array.from({length:i},()=>null)}}function ci(e,t){let n=t.trim().toLowerCase();return e.find(e=>e.wert.trim().toLowerCase()===n)}var li=`text`,ui=`status`,di=`bild`,fi=`bild`,pi=`unter`,mi=[{wert:li,name:`Text`,spur:`minmax(0, 1fr)`,klasse:``,zelle:e=>e},{wert:`zahl`,name:`Zahl`,spur:`90px`,klasse:`zahl`,zelle:e=>e},{wert:`datum`,name:`Datum`,spur:`100px`,klasse:`zahl`,zelle:e=>e},{wert:ui,name:`Status`,spur:`120px`,klasse:`status`,zelle:(e,t)=>{let n=ci(t,e);return n?y`<span class="chip v-${Jn(n.bedeutung)}">${n.name.trim()===``?e:n.name}</span>`:y`<span class="chip">${e}</span>`}},{wert:di,name:`Bild + Name`,spur:`minmax(0, 1fr)`,klasse:`bild`,zusatzFelder:[{key:fi,label:`Bild`},{key:pi,label:`Unterzeile`}],hoehe:e=>(e[fi]??``)!==``||(e[pi]??``)!==``?44:32,zelle:(e,t,n)=>{let r=rr(n[fi]??``),i=n[pi]??``;return y`<div class="bild-name">
        ${r===void 0?x:y`<span class="bild-zeichen">${r}</span>`}
        <div class="bild-text">
          <div class="bild-titel">${e}</div>
          ${i===``?x:y`<div class="bild-unter">${i}</div>`}
        </div>
      </div>`}}];function hi(e){return e.reduce((e,t)=>{let n=gi(t.art);return Math.max(e,n.hoehe?.(t.felder??{})??32)},32)}function gi(e){return mi.find(t=>t.wert===e)??mi[0]}var _i=mi.map(e=>({wert:e.wert,name:e.name,...e.zusatzFelder?{felder:e.zusatzFelder}:{}})),vi=`felder`,yi=`Spalte {n}`;function bi(e){return yi.replace(`{n}`,String(e+1))}function W(e){return{titel:bi(e),feld:``,art:li}}function xi(){return[0,1,2].map(e=>W(e))}function Si(e){return Array.isArray(e)?e.filter(e=>!!e&&typeof e==`object`).map(e=>({wert:typeof e.wert==`string`?e.wert:``,name:typeof e.name==`string`?e.name:``,bedeutung:typeof e.bedeutung==`string`?e.bedeutung:``})).filter(e=>e.wert.trim()!==``):[]}function Ci(e){if(!e||typeof e!=`object`||Array.isArray(e))return{};let t={};for(let[n,r]of Object.entries(e))typeof r==`string`&&r!==``&&(t[n]=r);return t}function wi(e,t){if(e&&typeof e==`object`){let n=e,r=Si(n.zuordnung),i=Ci(n.felder);return{titel:typeof n.titel==`string`?n.titel:bi(t),feld:typeof n.feld==`string`?n.feld:``,art:typeof n.art==`string`?n.art:li,...r.length>0?{zuordnung:r}:{},...Object.keys(i).length>0?{felder:i}:{}}}return typeof e==`string`?{...W(t),titel:e}:W(t)}function Ti(e){let t;if(Array.isArray(e))t=e.map((e,t)=>wi(e,t));else if(typeof e==`number`&&Number.isFinite(e)||typeof e==`string`&&/^\d+$/.test(e)){let n=Math.max(1,Math.floor(Number(e)));t=[...Array(n).keys()].map(e=>W(e))}else t=xi();return t.length>8&&(t=t.slice(0,8)),t.length<1&&(t=[W(0)]),t}function Ei(e){try{return Ti(JSON.parse(e))}catch{return xi()}}var Di={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Oi=e=>(...t)=>({_$litDirective$:e,values:t}),ki=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},Ai=`important`,ji=` !important`,Mi=Oi(class extends ki{constructor(e){if(super(e),e.type!==Di.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(ji);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?Ai:``):n[e]=r}}return b}}),Ni=`Keine Datensätze.`;function Pi(){return{attributeName:`leerText`,name:`Text ohne Datensätze`,description:`Steht in der Maske dort, wo sonst die Zeilen stehen — wenn die Datenquelle keine liefert. Leer lassen: dann steht dort gar nichts.`,kind:`text`,requiresDataSource:!0}}function Fi(e,t=!1){return e.trim()===``?x:y`<div class="leer${t?` leer--tafel`:``}">
    ${$n()}
    <span>${e}</span>
  </div>`}var Ii=o`
  .leer {
...
`;function Li(e,t){if(!e.hasAttribute(`fuellt`))return null;let n=e.renderRoot.querySelector(`.koerper`),r=e.renderRoot.querySelector(`.kopf`);return!(n instanceof HTMLElement)||!(r instanceof HTMLElement)?null:ai(n.clientHeight,r.offsetHeight,t)}function Ri(e,t){if(typeof ResizeObserver>`u`)return null;let n=e.renderRoot.querySelector(`.koerper`);if(!n)return null;let r=new ResizeObserver(t);return r.observe(n),r}function zi(e){return{rohzeilen:e.map(e=>e.rohzeile),datenzeilen:e.map(e=>[...e.zellen]),zusatzzeilen:e.map(e=>(e.zusatz??[]).map(e=>({...e})))}}function Bi(e,t,n){return t===``||n===``?[...e]:e.filter(e=>or(M(e,t))===n)}function Vi(e){return Ei(e.getAttribute(`spalten`)??``)}function Hi(e,t,n){let r={};for(let i of gi(e.art).zusatzFelder??[]){let a=e.felder?.[i.key]??``;a!==``&&(r[i.key]=n(t,a))}return r}function Ui(e,t){let n=j(H().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return n?yt(n,t):``}function Wi(e){let t=()=>{e.datenzeilen=[],e.zusatzzeilen=[]},n=e.getAttribute(`source`)??``;if(n===``){t();return}let r=j(H().FF_DATA_SOURCES,n);if(!r){t();return}let i=Vi(e),{rows:a,gefiltert:o}=Ht(e,Bi(F(H().SEDATA,r.name,r.tableId),e.getAttribute(`tagfield`)??``,dr())),s=Ft(L(e),a,e=>e)[0]??-1,c=Rr(e);e.datenGeliefert=!0,e.rohzeilen=a,e.auswahlIndex=s,e.durchAuswahlGefiltert=o,e.datenzeilen=a.map(e=>i.map(t=>t.feld===``?``:c(e,t.feld))),e.zusatzzeilen=a.map(e=>i.map(t=>Hi(t,e,c)))}var Gi=Nr({hydriere:Wi}),Ki=Gi.connect,qi=Gi.disconnect;function Ji(e){return e.trim().toLowerCase().split(/\s+/).filter(e=>e!==``)}function Yi(e,t){let n=Ji(t);if(n.length===0)return!0;let r=e.join(` `).toLowerCase();return n.every(e=>r.includes(e))}function Xi(e,t){let n=[];return e.forEach((e,r)=>{Yi(e,t)&&n.push(r)}),n}function Zi(e,t){return!e&&t.trim()!==``}function Qi(e,t,n){return e&&t&&n===0}function $i(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}function ea(e,t,n){return y`<div class="steuerung">
    <button
    ...
    >+</button>
  </div>`}function ta(e,t){let n=e.currentTarget;if(!n)return;e.stopPropagation(),e.preventDefault();let r=Array.from(n.childNodes),i=n.textContent??``;n.setAttribute(`contenteditable`,`plaintext-only`),n.focus();let a=window.getSelection(),o=document.createRange();o.selectNodeContents(n),a?.removeAllRanges(),a?.addRange(o);let s=!1,c=e=>{if(s)return;s=!0,n.removeAttribute(`contenteditable`),n.removeEventListener(`blur`,l),n.removeEventListener(`keydown`,u);let a=(n.textContent??``).trim();e&&a&&a!==i.trim()?t(a):n.replaceChildren(...r)},l=()=>c(!0),u=e=>{e.key===`Enter`?(e.preventDefault(),n.blur()):e.key===`Escape`&&(e.preventDefault(),c(!1))};n.addEventListener(`blur`,l),n.addEventListener(`keydown`,u)}function na(e,t,n,r){ta(e,e=>{let i=n();t>=i.length||(i[t]={...i[t],titel:e},r(i))})}var ra=220,ia=new WeakMap;function aa(e){let t=ia.get(e);t!==void 0&&(clearTimeout(t),ia.delete(e))}function oa(e,t,n,r,i){t.stopPropagation();let a=t.currentTarget.getBoundingClientRect();aa(e),ia.set(e,setTimeout(()=>{ia.delete(e),e.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:n,index:r,top:a.bottom+4,left:a.left,...i?{liste:i()}:{}},bubbles:!0,composed:!0}))},ra))}var sa={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:yi,eintragsWahl:{key:`art`,label:`Darstellung`,optionen:_i,standard:li,felderKey:vi},eintragsZuordnung:{key:`zuordnung`,label:`Status-Zuordnung`,nurBeiWahl:ui,wertLabel:`Datenwert`,nameLabel:`Klarname`,bedeutungLabel:`Bedeutung`,bedeutungen:Yn}},ca=1,la=/^-?\d{1,3}(\.\d{3})*(,\d+)?$|^-?\d+(,\d+)?$|^-?\d+(\.\d+)?$/,ua=/^(\d{1,2})\.(\d{1,2})\.(\d{2}|\d{4})$/,da=/^(\d{4})-(\d{2})-(\d{2})$/;function fa(e){let t=e.trim();if(t===``||!la.test(t))return null;let n=t.includes(`,`)?t.replace(/\./g,``).replace(`,`,`.`):/^-?\d{1,3}(\.\d{3})+$/.test(t)?t.replace(/\./g,``):t,r=Number(n);return Number.isFinite(r)?r:null}function pa(e){let t=e.trim();if(t===``)return null;let n=da.exec(t);if(n){let[,e,t,r]=n;return ma(Number(e),Number(t),Number(r))}let r=ua.exec(t);if(r){let[,e,t,n]=r,i=Number(n);return ma(n.length===2?i<=69?2e3+i:1900+i:i,Number(t),Number(e))}return null}function ma(e,t,n){if(t<1||t>12||n<1||n>31)return null;let r=new Date(e,t-1,n);return r.getFullYear()!==e||r.getMonth()!==t-1||r.getDate()!==n?null:r.getTime()}function ha(e){let t=0,n=0,r=0;for(let i of e)i.trim()!==``&&(t++,fa(i)!==null&&n++,pa(i)!==null&&r++);return t===0?`text`:r===t?`datum`:n===t?`zahl`:`text`}var ga=new Intl.Collator(`de`,{numeric:!0,sensitivity:`base`});function _a(e,t,n){if(t<0||e.length===0)return e.map((e,t)=>t);let r=n=>e[n][t]??``,i=ha(e.map(e=>e[t]??``)),a=n?1:-1;return e.map((e,t)=>t).sort((e,t)=>{let n=r(e).trim(),o=r(t).trim();if(n===``&&o===``)return e-t;if(n===``)return ca;if(o===``)return-1;let s=i===`zahl`?(fa(n)??0)-(fa(o)??0):i===`datum`?(pa(n)??0)-(pa(o)??0):ga.compare(n,o);return s===0?e-t:s*a})}function va(e){let t=Xi(e.datenzeilen,e.suchtext);return e.sortSpalte<0?t:_a(t.map(t=>e.datenzeilen[t]),e.sortSpalte,e.sortAuf).map(e=>t[e])}function ya(e){let t={gridTemplateColumns:e.spalten.map(e=>gi(e.art).spur).join(` `)},n=hi(e.spalten),r=e.gemessen?.zeilenHoehe??n,i=e.hatQuelle,a=Qi(i,e.datenGeliefert,e.datenzeilen.length),o=va(e),{seiten:s,seite:c,zeilen:l}=si({sichtbar:o,hatQuelle:i,proSeite:e.gemessen?.passen??10,wunschSeite:e.wunschSeite,platzhalterZeilen:ri(e.gemessen?.passen??null)});return{cols:t,takt:n,zeilenHoehe:r,hatQuelle:i,leer:a,gesamt:o.length,seiten:s,seite:c,zeilen:l,linealTakte:oi(e.gemessen?.passen??null,l.length)}}var ba=[hr(`suche`,`Suchzeile`,`Zeigt über der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,{requiresDataSource:!0}),{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt die Tabelle nur Sätze des Tages, den der Tageswähler zeigt. Leer = alle Sätze.`,kind:`field`},Pi()];function xa(e,t){return y`<div class="fusszeile">
    <div class="seiten-info">${$i({hatQuelle:e.hatQuelle,sichtbar:e.sichtbar,gesamt:e.gesamt,suchtAktiv:e.suchtAktiv,auswahlAktiv:e.auswahlAktiv})}</div>
    <div class="seiten-nav">
  ...
  </div>`}var Sa=`—`;function Ca(e){return e.linealTakte===0?x:y`<div class="lineal" role="presentation" style=${Mi(e.linealTakte===null?e.cols:{...e.cols,flex:`0 1 auto`,height:`calc(var(--zeilen-hoehe) * ${e.linealTakte})`})}>
          ${e.spalten.map(()=>y`<div></div>`)}
        </div>`}function wa(e,t){return y`
      ...
      <div class="kopf" role="row" style=${Mi(e.cols)}>
        ${e.spalten.map((n,r)=>y`<div
            class=${gi(n.art).klasse}
            role="columnheader"
            data-ff-editable
            @dblclick=${e=>t.dblklickKopf(e,r)}
            @click=${e=>t.klickKopf(e,r)}
          >${n.titel}${!e.editable&&e.sortSpalte===r?y`<span class="sort-pfeil">${e.sortAuf?` ▲`:` ▼`}</span>`:``}</div>`)}
      </div>
        ${``}
        ${e.leer?Fi(e.leerText,!0):y`
        ${e.zeilen.map((n,r)=>{let i=n!==null&&!e.imEditor;return y`<div
          ...
          >
            ${``}
            ${e.spalten.map((t,r)=>{let i=gi(t.art),a=n===null?Sa:e.datenzeilen[n]?.[r]??``,o=n===null?{}:e.zusatzzeilen[n]?.[r]??{};return y`<div class=${i.klasse} role="cell">${i.zelle(a,t.zuordnung??[],o)}</div>`})}
          </div>`})}
        ${Ca(e)}`}
      </div>
    `}var Ta=o`
...
`,Ea=`ff-zeile-aktiviert`,Da=`data-ff-roh`;function Oa(e,t){e.dispatchEvent(new CustomEvent(Ea,{detail:t,bubbles:!0,composed:!0}))}function ka(e){let t=e?.activeElement;if(!(t instanceof HTMLElement))return;let n=t.closest(`.zeile`);if(!n)return;let r=n.getAttribute(Da);return r===null||r===``?null:Number(r)}function Aa(e,t){e&&((t===null?null:e.querySelector(`.zeile[data-ff-roh="${t}"]`))??e.querySelector(`.zeile[data-ff-roh]`)??e.querySelector(`.koerper`))?.focus()}var G=class e extends O{constructor(...e){super(...e),this.spalten=xi(),this.source=``,this.suche=`ja`,this.leerText=Ni,this._suchtext=``,this.datenzeilen=[],this.zusatzzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this.datenGeliefert=!1,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._beobachter=null,this._taktGemessen=0,this._fokusZeile=null,this._fokusHolen=!1,this._besitz=`softengine`}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.blockEvents=[{key:`onRowClick`,name:`Zeile gewählt`}]}static{this.listenBindung=sa}static{this.defaultProps={width:`fill`,source:``,spalten:xi(),suche:`ja`,tagField:``,leerText:Ni}}static{this.customProperties=ba}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get besitz(){return this._besitz}set besitz(e){e!==this._besitz&&(this._besitz=e,this.setzeAbgeleitetesZurueck(),this.isConnected&&(e===`provided`?qi(this):Ki(this)),this.requestUpdate())}set bereitgestellteZeilen(e){let t=zi(e);this.rohzeilen=t.rohzeilen,this.datenzeilen=t.datenzeilen,this.zusatzzeilen=t.zusatzzeilen,this.datenGeliefert=!0,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._seite=0,this._mass=null,this._taktGemessen=0,this.requestUpdate()}setzeAbgeleitetesZurueck(){this.rohzeilen=[],this.datenzeilen=[],this.zusatzzeilen=[],this.datenGeliefert=!1,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._suchtext=``,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._taktGemessen=0,this._fokusZeile=null,this._fokusHolen=!1}fokussiereSuche(){let e=this.shadowRoot?.querySelector(`.suchzeile input`);return e?(e.focus(),!0):!1}get hatQuelle(){return this._besitz===`provided`||Zi(this.hasAttribute(`data-ff-editor`),this.source)}merkeZeilenFokus(){let e=ka(this.shadowRoot);this._fokusHolen=e!==void 0,this._fokusZeile=e??null}messeRumpf(){let e=this.zeilenHoehe;this._taktGemessen=e;let t=Li(this,e);t?.passen===this._mass?.passen&&t?.zeilenHoehe===this._mass?.zeilenHoehe||(this._mass=t,this.requestUpdate())}spaltenListe(){return Ti(this.spalten)}get zeilenHoehe(){return hi(this.spaltenListe())}aktiviereZeile(e,t){if(e===null||this.hasAttribute(`data-ff-editor`))return;let n=this.rohzeilen[e];n!==void 0&&(Oa(this,{rohzeile:n,rohIndex:e,ansichtIndex:t}),this.toggleAuswahl(n),Un(this,`onRowClick`,{PINDEX:Ui(this,n)}).catch(Hn))}toggleAuswahl(e){let t=L(this);t!==``&&It(t,e)}setzeSuchtext(e){this.merkeZeilenFokus(),this._suchtext=e,this._seite=0,this.requestUpdate()}klickSortiere(e){this.editable||(this.merkeZeilenFokus(),this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.requestUpdate())}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}beobachte(){this._beobachter||(this._beobachter=Ri(this,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}connectedCallback(){super.connectedCallback(),this._besitz===`softengine`&&Ki(this),this.beobachte()}firstUpdated(){this.beobachte()}updated(){this._taktGemessen!==this.zeilenHoehe&&this.messeRumpf(),this._fokusHolen&&(this._fokusHolen=!1,Aa(this.shadowRoot,this._fokusZeile))}disconnectedCallback(){super.disconnectedCallback(),aa(this),this._beobachter?.disconnect(),this._beobachter=null,qi(this)}static{this.styles=[O.styles,Zn,Ii,Ta]}render(){let t=this.spaltenListe(),n=e=>e.stopPropagation(),r=ya({spalten:t,hatQuelle:this.hatQuelle,datenGeliefert:this.datenGeliefert,datenzeilen:this.datenzeilen,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,wunschSeite:this._seite,gemessen:this._mass});return y`<div class="tabelle" style=${Mi({"--takt":`${r.takt}px`,"--zeilen-hoehe":`${r.zeilenHoehe}px`})}>
      ${ea(()=>this.spaltenListe(),e=>this.aendere(e),n)}
      ${wa({spalten:t,cols:r.cols,editable:this.editable,imEditor:this.hasAttribute(`data-ff-editor`),auswahlSemantik:L(this)!==``,zeigeSuche:this.suche===`ja`,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,zeilen:r.zeilen,linealTakte:r.linealTakte,datenzeilen:this.datenzeilen,zusatzzeilen:this.zusatzzeilen,hatQuelle:r.hatQuelle,auswahlIndex:this.auswahlIndex,leer:r.leer,leerText:this.leerText},{setzeSuchtext:e=>this.setzeSuchtext(e),dblklickKopf:(e,t)=>{this.editable&&(aa(this),na(e,t,()=>this.spaltenListe(),e=>this.aendere(e)))},klickKopf:(t,n)=>{this.editable&&oa(this,t,e.listenBindung.prop,n,()=>this.spaltenListe()),this.klickSortiere(n)},aktiviereZeile:(e,t)=>this.aktiviereZeile(e,t)})}
      ${``}
      ${r.leer?x:xa({hatQuelle:r.hatQuelle,sichtbar:r.gesamt,gesamt:this.datenzeilen.length,suchtAktiv:this._suchtext.trim()!==``,auswahlAktiv:this.durchAuswahlGefiltert,seite:r.seite,seiten:r.seiten},{blaettere:e=>{this.merkeZeilenFokus(),this._seite=e,this.requestUpdate()}})}
    </div>`}};D([T({converter:{fromAttribute:e=>e?Ei(e):xi(),toAttribute:e=>JSON.stringify(e)}})],G.prototype,`spalten`,void 0),D([T()],G.prototype,`source`,void 0),D([T()],G.prototype,`suche`,void 0),D([T()],G.prototype,`leerText`,void 0),D([T({attribute:!1})],G.prototype,`datenzeilen`,void 0),D([T({attribute:!1})],G.prototype,`zusatzzeilen`,void 0),D([T({attribute:!1})],G.prototype,`rohzeilen`,void 0),D([T({attribute:!1})],G.prototype,`auswahlIndex`,void 0),D([T({attribute:!1})],G.prototype,`durchAuswahlGefiltert`,void 0),D([T({attribute:!1})],G.prototype,`datenGeliefert`,void 0),O.defineAndRegister(G);function ja(e){return y`<div class="nachschlag">
    <input
      class="ctrl"
      type="text"
      .value=${e.wert}
  ...
  </div>`}var Ma={prop:`nachschlagSpalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:yi,quelleProp:`nachschlagQuelle`};function Na(e){if(typeof e==`string`)try{e=JSON.parse(e)}catch{return[]}return Array.isArray(e)&&e.length>0?Ti(e):[]}function Pa(e,t){let n=e[0];return n===void 0?t:n.feld}function Fa(e,t){let n=e.trim();return n===``||n===t.trim()}function Ia(e,t,n){let r=t.trim(),i=[],a=Fa(t,n),o=new Set;for(let t of e){let e=M(t,n).trim(),s=r===``?e:M(t,r).trim();if(!(s===``&&e===``)){if(a){if(o.has(e))continue;o.add(e)}i.push({anzeige:s,wert:e,satz:t})}}return i}function La(e,t,n,r){return Ia(Ht(e,t).rows,n,r)}function Ra(e){if(e.quelleId===``||e.speicherFeld===``)return{ok:!1,grund:`unvollstaendig`};let t=j(H().FF_DATA_SOURCES,e.quelleId);if(!t)return{ok:!1,grund:`quelleFehlt`};let n=F(H().SEDATA,t.name,t.tableId),r=Pa(Na([...e.spalten]),e.speicherFeld);return{ok:!0,eintraege:La(e.el,n,r,e.speicherFeld)}}function za(e,t){return t&&e.length===1?e[0]:null}function Ba(e,t){let{rows:n,gefiltert:r}=Ht(e,[t]);return!r||n.length>0}function Va(e,t,n){return e===``?t===``&&n===``?`nichts`:`leeren`:e===t?`nichts`:`zurueck`}var Ha=null,Ua=null,Wa=null;function Ga(e){return e.shadowRoot?.querySelector(`.lupe`)??null}function Ka(e=!0){let t=e?Wa:null;Wa=null,Ha?.remove(),Ha=null,Ua=null,t?.focus()}function qa(e){Ua===e&&Ka(!1)}function Ja(e){return[{titel:e.speicherTitel===``?`Wert`:e.speicherTitel,feld:e.speicherFeld,art:li}]}function Ya(e,t){let n=document.createElement(G.tagName),r=Na([...e.spalten]),i=Fa(Pa(r,e.speicherFeld),e.speicherFeld);return n.besitz=`provided`,n.spalten=r.length>0?r:Ja(e),n.suche=`ja`,n.leerText=`Diese Quelle hat keine Sätze.`,n.bereitgestellteZeilen=t.map(e=>({rohzeile:e.satz,zellen:r.length>0?r.map(t=>t.feld===``?``:M(e.satz,t.feld)):i?[e.wert]:[e.anzeige,e.wert]})),n.toggleAttribute(`fuellt`,!0),n.style.setProperty(`--se-r-lg`,`0px`),n}function Xa(e){let t=Ra(e);if(!t.ok){V(t.grund===`unvollstaendig`?`Nachschlagen braucht an diesem Feld eine Quelle und „Gespeichert wird".`:`Die Nachschlage-Quelle dieses Feldes ist in der Maske nicht vorhanden.`);return}let n=t.eintraege;Ka(!1);let r=document.createElement(Wt);r.setAttribute(`data-ff-nachschlagen`,``),r.viewport=!0,r.escapeSchliesst=!0,r.ohneModal=!0,r.inhaltFest=!0,r.titel=e.titel===``?`Nachschlagen`:e.titel,r.breite=e.breite,r.hoehe=e.hoehe,r.addEventListener(Gt,()=>Ka()),r.addEventListener(`click`,e=>e.stopPropagation());let i=Ya(e,n);i.addEventListener(Ea,t=>{let r=t.detail,i=n[r.rohIndex];i&&(Ka(),e.onUebernehmen(i.anzeige,i.wert,i.satz))}),r.appendChild(i),Wa=Ga(e.el),document.body.appendChild(r),Ha=r,Ua=e.el,Promise.all([r.updateComplete,i.updateComplete]).then(()=>{r.isConnected&&i.fokussiereSuche()})}function Za(e){let t=e=>e.stopPropagation();return y`<ff-dialog-rahmen
    viewport
    escape-schliesst
    ohne-modal
    inhalt-fest
  ...
  >
    <ff-tabelle
      ...
      .spalten=${[...e.spalten]}
      .editable=${!0}
      @ff-prop-change=${t=>{t.stopPropagation();let n=t.detail;n?.attr===`spalten`&&e.onAendern(Ti(n.value))}}
    ...
    ></ff-tabelle>
  </ff-dialog-rahmen>`}var K=class e extends O{constructor(...e){super(...e),this.fieldType=`text`,this.placeholder=`Feldname`,this.options=``,this.source=``,this.value=``,this.valueField=``,this.nachschlagQuelle=``,this.speicherFeld=``,this.speicherTitel=``,this.nachschlagSpalten=[],this.fensterBreite=520,this.fensterHoehe=380,this.einzigerTreffer=`nein`,this.spaltenDialog=!1,this.anzeige=``,this.getippt=null,this.satz=void 0,this.angehakt=!1,this.imSteuerelement=!1}static{this.blockType=`formfeld`}static{this.tagName=`ff-formfeld`}static{this.displayName=`Formularfeld`}static{this.category=`eingabe`}static{this.acceptsDataSource={wenn:{attributeName:`fieldType`,notEquals:`nachschlagen`}}}static{this.kannAuswahlFolgen=!0}static{this.satzWahl={quelleProp:`nachschlagQuelle`,wenn:{attributeName:`fieldType`,equals:`nachschlagen`}}}static{this.listenBindung=Ma}static{this.bindableSpots=[{prop:`value`,label:`Wert`,wenn:{attributeName:`fieldType`,keinesVon:[`checkbox`,`nachschlagen`]},vorschauProp:`placeholder`}]}static{this.actionValueSpots=[{prop:`value`,label:`Wert`}]}static{this.blockEvents=[{key:`onChange`,name:`Wert geändert`}]}static{this.defaultProps={width:240,fieldType:`text`,placeholder:`Feldname`,options:``,source:``,value:``,valueField:``,nachschlagQuelle:``,speicherFeld:``,speicherTitel:``,nachschlagSpalten:[],fensterBreite:520,fensterHoehe:380,einzigerTreffer:`nein`}}static{this.raster={startW:6,startH:2,minW:2,minH:2}}static{this.customProperties=_r}static{this.styles=[O.styles,Zr]}onInput(e){let t=e.target;this.value=$r(this.fieldType)===`date`?Ur(t.value):t.value}onChange(){this.dispatchEvent(new Event(`change`))}textTpl(e,t=!1){return y`<span
      class=${e}
      ?hidden=${t}
      data-ff-editable
    ...
    >${this.placeholder}</span>`}onTextClick(){this.hasAttribute(`data-ff-editor`)||this.setzeHaken(!this.angehakt)}setzeHaken(e){this.angehakt!==e&&(this.angehakt=e,this.dispatchEvent(new Event(`change`)))}controlTpl(e){switch(e){case`textarea`:return y`<textarea class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}></textarea>`;case`select`:{let e=this.options.split(`,`).map(e=>e.trim()).filter(e=>e!==``),t=this.value!==``&&!e.includes(this.value);return y`<select class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}>
        ...
        </select>`}case`nachschlagen`:return ja({wert:this.getippt??this.anzeige,onTippen:e=>{this.getippt=e},onVerlassen:()=>this.onNachschlagVerlassen(),onLupe:()=>this.onLupe()});default:return y`<input
          class="ctrl"
          type=${e}
          .value=${e===`date`?Hr(this.value):this.value}
          @input=${this.onInput}
          @change=${this.onChange}
          @focus=${()=>{this.imSteuerelement=!0}}
          @blur=${()=>{this.imSteuerelement=!1}}
        />`}}onLupe(){if(this.hasAttribute(`data-ff-editor`)){this.spaltenDialog=!0;return}Xa({el:this,quelleId:this.nachschlagQuelle,speicherFeld:this.speicherFeld,speicherTitel:this.speicherTitel,spalten:this.nachschlagSpalten,titel:this.placeholder,breite:this.fensterBreite,hoehe:this.fensterHoehe,onUebernehmen:(e,t,n)=>{this.uebernimmSatz(e,t,n),this.dispatchEvent(new Event(`change`))}})}spaltenEffektiv(){let e=Na(this.nachschlagSpalten);return e.length>0?e:Ja({speicherFeld:this.speicherFeld,speicherTitel:this.speicherTitel})}meldeProp(e,t,n){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:e,value:t,...n===void 0?{}:{geste:n}},bubbles:!0,composed:!0}))}spaltenDialogTpl(){return Za({titel:this.placeholder,spalten:this.spaltenEffektiv(),breite:this.fensterBreite,hoehe:this.fensterHoehe,onGroesse:t=>{let n=t.achse===`breite`?`fensterBreite`:`fensterHoehe`;if(t.geste===`standard`){this.meldeProp(n,e.defaultProps[n]);return}this.meldeProp(n,t.wert,t.geste===`laeuft`?void 0:t.geste)},onAendern:e=>{this.meldeProp(`nachschlagSpalten`,e)},onFeldWahl:e=>{this.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:`nachschlagSpalten`,...e},bubbles:!0,composed:!0}))},onSchliessen:()=>{this.spaltenDialog=!1}})}willUpdate(e){super.willUpdate(e),e.has(`fieldType`)&&$r(this.fieldType)!==`nachschlagen`&&(this.spaltenDialog=!1)}leereNachschlagen(){this.satz=void 0,this.anzeige=``,this.value=``,Rt(L(this))}uebernimmSatz(e,t,n){this.anzeige=e===``?t:e,this.value=t,this.satz=n,Lt(L(this),n)}onNachschlagVerlassen(){if(this.hasAttribute(`data-ff-editor`))return;let e=Va(this.getippt??this.anzeige,this.anzeige,this.value);this.getippt=null,e===`leeren`&&(this.leereNachschlagen(),this.dispatchEvent(new Event(`change`)))}pruefeEigenenWert(){$r(this.fieldType)===`nachschlagen`&&(this.satz!==void 0&&!Ba(this,this.satz)&&this.leereNachschlagen(),this.uebernimmEinzigenTreffer())}uebernimmEinzigenTreffer(){if(this.einzigerTreffer!==`ja`)return;let e=Ra({el:this,quelleId:this.nachschlagQuelle,speicherFeld:this.speicherFeld,spalten:this.nachschlagSpalten});if(!e.ok)return;let t=za(e.eintraege,this.satz===void 0);t&&this.uebernimmSatz(t.anzeige,t.wert,t.satz)}render(){let e=$r(this.fieldType);if(e===`checkbox`)return y`<div class="feld">
        <div class="zeile">
          <input
            class="ctrl"
            type="checkbox"
      ...
      >
        ${this.controlTpl(e)}
        ${ei.includes(e)?this.textTpl(`ph ${ti[e]??``}`.trim(),!n):x}
      </div>
      ${this.spaltenDialog&&this.hasAttribute(`data-ff-editor`)?this.spaltenDialogTpl():x}
    </div>`}connectedCallback(){super.connectedCallback(),Yr(this)}disconnectedCallback(){super.disconnectedCallback(),Xr(this),qa(this)}};D([T()],K.prototype,`fieldType`,void 0),D([T()],K.prototype,`placeholder`,void 0),D([T()],K.prototype,`options`,void 0),D([T()],K.prototype,`source`,void 0),D([T()],K.prototype,`value`,void 0),D([T()],K.prototype,`valueField`,void 0),D([T()],K.prototype,`nachschlagQuelle`,void 0),D([T()],K.prototype,`speicherFeld`,void 0),D([T()],K.prototype,`speicherTitel`,void 0),D([T({converter:{fromAttribute:e=>Na(e??``),toAttribute:e=>JSON.stringify(e)}})],K.prototype,`nachschlagSpalten`,void 0),D([T({type:Number})],K.prototype,`fensterBreite`,void 0),D([T({type:Number})],K.prototype,`fensterHoehe`,void 0),D([T()],K.prototype,`einzigerTreffer`,void 0),D([E()],K.prototype,`spaltenDialog`,void 0),D([E()],K.prototype,`anzeige`,void 0),D([E()],K.prototype,`getippt`,void 0),D([E()],K.prototype,`angehakt`,void 0),D([E()],K.prototype,`imSteuerelement`,void 0),O.defineAndRegister(K);var Qa=`ziel`,$a=o`
...
`,to=`frei · hierher ziehen`,no=`ff-zimmer-inhalt`,q=class extends O{constructor(...e){super(...e),this.heading=`Neues Zimmer`,this.leerHinweis=``}static{this.blockType=`kanban-zimmer`}static{this.tagName=`ff-kanban-zimmer`}static{this.displayName=`Kanban-Zimmer`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[U.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban-spalte`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={heading:`Neues Zimmer`}}static{this.styles=[O.styles,Ii,eo,$a,o`
    ...
    `]}onSlotChange(){this.dispatchEvent(new CustomEvent(no,{bubbles:!0,composed:!0}))}render(){return y`<div class="zimmer ${Qa}">
      <div
        class="kopf"
        data-ff-editable
    ...
    </div>`}};D([T()],q.prototype,`heading`,void 0),D([T({attribute:!1})],q.prototype,`leerHinweis`,void 0),O.defineAndRegister(q);var J=class extends O{static{this.blockType=`kanban-spalte`}static{this.tagName=`ff-kanban-spalte`}static{this.displayName=`Kanban-Spalte`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[U.blockType,q.blockType]}static{this.addChildButton={label:`Zimmer`,childType:q.blockType}}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={variant:`info`,heading:`Neue Spalte`,auffang:`nein`,zimmerField:``}}static{this.customProperties=[Xn(`variant`,`Bedeutung der Spalte — bestimmt ihre Farbwelt (Kopf, Fläche, Rahmen).`),hr(`auffang`,`Auffangspalte`,`Einträge ohne passenden Spaltentitel landen hier. Ohne Auffangspalte landen sie in der ersten Spalte.`,{requiresDataSource:!0,exclusiveAmongSiblings:!0}),{attributeName:`zimmerField`,name:`Unterteilen nach`,description:`Optional: Feld der Datenquelle, dessen Inhalt bestimmt, in welches Zimmer dieser Spalte ein Eintrag kommt. Wirkt erst, wenn die Spalte Zimmer hat.`,kind:`field`}]}static{this.styles=[O.styles,Ii,eo,$a,o`
    ...
    `]}constructor(){super(),this.variant=`info`,this.heading=`Neue Spalte`,this.leerHinweis=``,this._count=0,this.addEventListener(no,()=>this.zaehle())}zaehle(){this._count=Array.from(this.querySelectorAll(U.tagName)).filter(e=>!e.hasAttribute(`data-ff-editor-helper`)).length}render(){return y`<div class="col ${Qa} v-${Jn(this.variant)}">
      <div class="head">
        <span class="dot"></span>
        <span
          class="title"
    ...
    </div>`}};D([T()],J.prototype,`variant`,void 0),D([T()],J.prototype,`heading`,void 0),D([T({attribute:!1})],J.prototype,`leerHinweis`,void 0),D([E()],J.prototype,`_count`,void 0),O.defineAndRegister(J);function ro(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function io(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var ao=new WeakMap,oo=J.tagName,so=q.tagName,co=U.tagName;function lo(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===oo)}function uo(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===co)}function fo(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===so)}function po(e){return[e,...fo(e)]}function mo(e,t){let n=e.getAttribute(`leertext`)??`Keine Datensätze.`,r=(e,t)=>{e.leerHinweis=t};for(let e of t){let t=fo(e);for(let e of t)r(e,uo(e).length===0?to:``);r(e,t.length===0&&uo(e).length===0?n:``)}}function ho(e){return qe().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function go(e,t){let n=fo(e);if(n.length===0)return null;let r=e.getAttribute(`zimmerfield`)??``;if(r===``)return n[0];let i=n.map(e=>e.getAttribute(`heading`)??q.defaultProps.heading),a=ro(M(t,r),i);return a>=0?n[a]:n[0]}function _o(e){X?.board===e&&Co();let t=e.getAttribute(`source`)??``,n=e.getAttribute(`statusfield`)??``;if(t===``)return;let r=j(H().FF_DATA_SOURCES,t);if(!r)return;let i=lo(e);if(i.length===0)return;let a=ao.get(e);if(!a){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(co);t&&(a=t.cloneNode(!0),ao.set(e,a))}if(!a)return;let o=Bi(F(H().SEDATA,r.name,r.tableId),e.getAttribute(`tagfield`)??``,dr()),s=i.map(e=>e.getAttribute(`heading`)??J.defaultProps.heading),c=ho(a.tagName),l=io(i.map(e=>e.getAttribute(`auffang`))),u=Rr(e);for(let e of i)for(let t of po(e))uo(t).forEach(e=>e.remove());for(let e of o){let t=a.cloneNode(!0),o=n===``?-1:ro(M(e,n),s),d=o>=0?i[o]:l>=0?i[l]:i[0];(go(d,e)??d).appendChild(t);for(let n of c){let r=t.getAttribute(vr(n.prop))??``;r!==``&&(t[n.prop]=u(e,r))}let ee=yt(r,e);Y.set(t,{row:e,pindex:ee}),t.draggable=!0}mo(e,i);let d=i.flatMap(e=>po(e).flatMap(uo)),ee=Ft(L(e),d,e=>Y.get(e)?.row);for(let e of ee)d[e].setAttribute(`data-ff-auswahl`,``)}var Y=new WeakMap,X=null,vo=new WeakSet,yo=`data-ff-zieht`,bo=`data-ff-ziel`,xo=null;function So(e){xo!==e&&(xo?.removeAttribute(bo),xo=e,xo?.setAttribute(bo,``))}function Co(){X?.card.removeAttribute(yo),X=null,So(null)}function wo(e,t,n){for(let r of t.composedPath())if(r instanceof HTMLElement&&r.tagName.toLowerCase()===n&&e.contains(r))return r;return null}function To(e,t){return wo(e,t,oo)}function Eo(e,t,n){if(!X||X.board!==e)return;let r=Y.get(X.card);if(!r)return;let i=t.getAttribute(`heading`)??``,a=n?.getAttribute(`heading`)??``;Un(e,`onCardDrop`,{PINDEX:r.pindex,VALUE:i,ZIMMER:a}).catch(Hn)}function Do(e){vo.has(e)||(vo.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&Y.has(e))??null;if(!n)return;let r=Y.get(n);r&&It(L(e),r.row),Un(e,`onCardClick`,{PINDEX:r?.pindex??``}).catch(Hn)}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&Y.has(e))??null;n&&(X={card:n,board:e},t.dataTransfer?.setData(`text/plain`,Y.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`),setTimeout(()=>{X?.card===n&&n.setAttribute(yo,``)},0))}),e.addEventListener(`dragend`,Co),e.addEventListener(`dragover`,t=>{let n=To(e,t);if(X?.board!==e||!n){So(null);return}t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`),So(wo(e,t,so)??n)}),e.addEventListener(`dragleave`,t=>{let n=t.relatedTarget;(!(n instanceof Node)||!e.contains(n))&&So(null)}),e.addEventListener(`drop`,t=>{let n=To(e,t);n&&(t.preventDefault(),Eo(e,n,wo(e,t,so)),Co())}))}var Oo=Nr({hydriere:_o,verdrahte:Do}),ko=Oo.connect,Ao=Oo.disconnect,Z=J.blockType,jo=class extends O{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[Z]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:Z}}static{this.templateChild={type:U.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``,tagField:``,leerText:Ni}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Optional: Feld der Datenquelle, dessen Inhalt bestimmt, in welche Spalte ein Eintrag kommt. Leer = alle Einträge in der Auffang-Spalte.`,kind:`field`},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt das Board nur Einträge des Tages, den der Tageswähler zeigt. Leer = alle Einträge.`,kind:`field`},Pi()]}static{this.defaultChildren=[{type:Z,props:{heading:`Offen`,variant:`warning`},children:[{type:U.blockType}]},{type:Z,props:{heading:`In Arbeit`,variant:`info`}},{type:Z,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[O.styles,o`
    ...
    `]}render(){return y`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),ko(this)}disconnectedCallback(){super.disconnectedCallback(),Ao(this)}};O.defineAndRegister(jo);var Mo={breite:56,breiteOffen:224},No=`ff-seiten-wechsel`,Po=[{wert:`sonne`,name:`Sonnengelb`},{wert:`salbei`,name:`Salbeigrün`},{wert:`himmel`,name:`Himmelblau`},{wert:`flieder`,name:`Flieder`},{wert:`koralle`,name:`Koralle`}],Q=class extends O{static{this.blockType=`navi-eintrag`}static{this.tagName=`ff-navi-eintrag`}static{this.displayName=`Navi-Eintrag`}static{this.category=`layout`}static{this.acceptsChildren=!1}static{this.showInPalette=!1}static{this.allowedParentTypes=[`navi`]}static{this.resizableWidth=!1}static{this.defaultProps={seite:``,seitename:``,ton:`sonne`}}static{this.customProperties=[{attributeName:`seite`,name:`Seite`,description:`Welche Seite dieser Maske der Eintrag zeigt.`,kind:`seite`,klarnameProp:`seitename`,nurImEditor:!0},{attributeName:`ton`,name:`Farbe`,description:`Farbe des Zeichens vor dem Namen.`,kind:`select`,options:Po.map(e=>({value:e.wert,label:e.name}))}]}static{this.styles=[O.styles,o`
      :host {
        --ton: var(--se-amber);
        display: flex;
        align-items: center;
    ...
    `]}constructor(){super(),this.seite=``,this.seitename=``,this.ton=`sonne`,this.addEventListener(`click`,()=>this.melde())}melde(){let e={ansicht:this.seitename};this.dispatchEvent(new CustomEvent(No,{detail:e,bubbles:!0,composed:!0}))}render(){return y`<span class="zeichen"></span>
      <span class="name">${this.seitename===``?`—`:this.seitename}</span>`}};D([T()],Q.prototype,`seite`,void 0),D([T()],Q.prototype,`seitename`,void 0),D([T({reflect:!0})],Q.prototype,`ton`,void 0),O.defineAndRegister(Q);var Fo=`aktiv`;function Io(e){return Array.from(e.querySelectorAll(Q.tagName))}function Lo(e,t){let n=Io(e),r=t??n.find(e=>e.hasAttribute(Fo))??n[0];for(let e of n)e===r?e.setAttribute(Fo,``):e.removeAttribute(Fo)}function Ro(e){let t=e.hasAttribute(`offen`);for(let n of Io(e))n.toggleAttribute(`breit`,t)}function zo(e){return e.getAttribute(`name`)??String(at.defaultProps.name)}function Bo(e,t){let n=e;for(;n&&n.parentElement!==t;)n=n.parentElement;return n}function Vo(e,t){let n=e.ownerDocument,r=Array.from(n.querySelectorAll(at.tagName)),i=r[0]?.parentElement??null;if(!i)return;let a=Bo(e,i);if(!a)return;let o=r.find(e=>zo(e)===t)??null;for(let e of Array.from(i.children))e!==a&&((r.includes(e)?e===o:o===null)?e.removeAttribute(`hidden`):e.setAttribute(`hidden`,``))}var Ho=new WeakMap,Uo=new WeakSet;function Wo(e){let t=t=>{let n=t.detail;n&&(Lo(e,t.target instanceof Element?t.target:void 0),e.removeAttribute(`offen`),Ro(e),!e.hasAttribute(`data-ff-editor`)&&Vo(e,n.ansicht))};e.addEventListener(No,t),Ho.set(e,t)}function Go(e){let t=Ho.get(e);t&&(e.removeEventListener(No,t),Ho.delete(e))}function Ko(e){if(Lo(e),Ro(e),e.hasAttribute(`data-ff-editor`)||Uo.has(e))return;let t=Io(e)[0];if(!t)return;Uo.add(e);let n=()=>Vo(e,t.seitename);e.ownerDocument.readyState===`loading`?e.ownerDocument.addEventListener(`DOMContentLoaded`,n,{once:!0}):queueMicrotask(n)}var qo=Q.blockType,Jo=class extends O{static{this.blockType=`navi`}static{this.tagName=`ff-navi`}static{this.displayName=`Navi`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[qo]}static{this.addChildButton={label:`Eintrag`,childType:qo}}static{this.containerHint=!1}static{this.defaultProps={}}static{this.customProperties=[]}static{this.maskenRand=!0}static{this.allowedParentTypes=[it]}static{this.raster={startW:5,startH:24,minW:3,minH:3}}static{this.styles=[O.styles,o`
      :host {
        height: 100%;
        width: ${Mo.breite}px;
        transition: width var(--se-move);
      }
      :host([offen]) { width: ${Mo.breiteOffen}px; }
      .leiste {
        box-sizing: border-box;
        height: 100%;
        width: 100%;
    ...
    `]}connectedCallback(){super.connectedCallback(),Wo(this)}disconnectedCallback(){super.disconnectedCallback(),Go(this)}klappen(){this.toggleAttribute(`offen`),Ro(this)}render(){return y`<div class="leiste">
        <div class="kopf">
          <button
            class="schalter"
            type="button"
        ...
        <div class="eintraege">
          <slot @slotchange=${()=>Ko(this)}></slot>
        </div>
      </div>`}};O.defineAndRegister(Jo);var Yo=vr(`text`);function Xo(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(Yo)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function Zo(e){let t=zr(e,Yo);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function Qo(e){Xo(e)&&(e.text=``)}var $o=Nr({hydriere:Zo,verdrahte:Qo}),es=$o.connect,ts=$o.disconnect,ns=6,rs=96,is=14,as={duenn:`300`,normal:`400`,fett:`700`},os={links:`left`,mitte:`center`,rechts:`right`},ss={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},cs=`standard`;function ls(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(rs,Math.max(ns,t)):is}function us(e){return typeof e==`string`&&e in as?e:`normal`}function ds(e){return typeof e==`string`&&e in os?e:`links`}function fs(e){return typeof e==`string`&&e in ss?e:cs}var $=class extends O{constructor(...e){super(...e),this.groesse=is,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=cs,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:is,gewicht:`normal`,ausrichtung:`links`,farbe:cs,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:ns,max:rs,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[O.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return y`<div
      class="text"
      style=${Mi({fontSize:`${ls(this.groesse)}px`,fontWeight:as[us(this.gewicht)],textAlign:os[ds(this.ausrichtung)],color:ss[fs(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),es(this)}disconnectedCallback(){super.disconnectedCallback(),ts(this)}};D([T({type:Number})],$.prototype,`groesse`,void 0),D([T()],$.prototype,`gewicht`,void 0),D([T()],$.prototype,`ausrichtung`,void 0),D([T()],$.prototype,`farbe`,void 0),D([T()],$.prototype,`text`,void 0),D([T()],$.prototype,`source`,void 0),D([T()],$.prototype,`textField`,void 0),O.defineAndRegister($);var ps=[`waagerecht`,`senkrecht`],ms=`waagerecht`;function hs(e){return ps.includes(e)?e:ms}var gs=class extends O{constructor(...e){super(...e),this.richtung=ms}static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`,richtung:ms}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1,varianten:[{wenn:{attributeName:`richtung`,equals:`senkrecht`},startW:1,startH:6,breiteZiehbar:!1}]}}static{this.customProperties=[{attributeName:`richtung`,name:`Richtung`,description:`Waagerecht trennt oben von unten, senkrecht links von rechts.`,kind:`select`,options:[{value:`waagerecht`,label:`Waagerecht`},{value:`senkrecht`,label:`Senkrecht`}]}]}static{this.styles=[O.styles,o`
    ...
    `]}render(){return y`<div class="flaeche ${hs(this.richtung)}"><div class="linie"></div></div>`}};D([T()],gs.prototype,`richtung`,void 0),O.defineAndRegister(gs),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;V(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();
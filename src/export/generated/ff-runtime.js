...
\f\r]`,_=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,xe=/-->/g,Se=/>/g,v=RegExp(`>|${be}(?:([^\\s"'>=/]+)(${be}*=${be}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,`g`),Ce=/'/g,we=/"/g,Te=/^(?:script|style|textarea|title)$/i,Ee=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),y=Ee(1),De=Ee(2),b=Symbol.for(`lit-noChange`),x=Symbol.for(`lit-nothing`),Oe=new WeakMap,S=m.createTreeWalker(m,129);function ke(e,t){if(!ve(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return me===void 0?t:me.createHTML(t)}var Ae=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:t===3?`<math>`:``,o=_;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===_?c[1]===`!--`?o=xe:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=v):(Te.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=v):o=Se:o===v?c[0]===`>`?(o=i??_,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?v:c[3]===`"`?we:Ce):o===we||o===Ce?o=v:o===xe||o===Se?o=_:(o=v,i=void 0);let d=o===v&&e[t+1].startsWith(`/>`)?` `:``;a+=o===_?n+_e:l>=0?(r.push(s),n.slice(0,l)+he+n.slice(l)+p+d):n+p+(l===-2?t:d)}return[ke(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:t===3?`</math>`:``)),r]},je=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=Ae(t,n);if(this.el=e.createElement(l,r),S.currentNode=this.el.content,n===2||n===3){let e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;(i=S.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes())for(let e of i.getAttributeNames())if(e.endsWith(he)){let t=u[o++],n=i.getAttribute(e).split(p),r=/([.?@])?(.*)/.exec(t);c.push({type:1,index:a,name:r[2],strings:n,ctor:r[1]===`.`?Fe:r[1]===`?`?Ie:r[1]===`@`?Le:Pe}),i.removeAttribute(e)}else e.startsWith(p)&&(c.push({type:6,index:a}),i.removeAttribute(e));if(Te.test(i.tagName)){let e=i.textContent.split(p),t=e.length-1;if(t>0){i.textContent=pe?pe.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],h()),S.nextNode(),c.push({type:2,index:++a});i.append(e[t],h())}}}else if(i.nodeType===8)if(i.data===ge)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(p,e+1))!==-1;)c.push({type:7,index:a}),e+=p.length-1}a++}}static createElement(e,t){let n=m.createElement(`template`);return n.innerHTML=e,n}};function C(e,t,n=e,r){if(t===b)return t;let i=r===void 0?n._$Cl:n._$Co?.[r],a=g(t)?void 0:t._$litDirective$;return i?.constructor!==a&&(i?._$AO?.(!1),a===void 0?i=void 0:(i=new a(e),i._$AT(e,n,r)),r===void 0?n._$Cl=i:(n._$Co??=[])[r]=i),i!==void 0&&(t=C(e,i._$AS(e,t.values),i,r)),t}var Me=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??m).importNode(t,!0);S.currentNode=r;let i=S.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new Ne(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new Re(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=S.nextNode(),a++)}return S.currentNode=m,r}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},Ne=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,r){this.type=2,this._$AH=x,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=C(this,e,t),g(e)?e===x||e==null||e===``?(this._$AH!==x&&this._$AR(),this._$AH=x):e!==this._$AH&&e!==b&&this._(e):e._$litType$===void 0?e.nodeType===void 0?ye(e)?this.k(e):this._(e):this.T(e):this.$(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==x&&g(this._$AH)?this._$AA.nextSibling.data=e:this.T(m.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=je.createElement(ke(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.p(t);else{let e=new Me(r,this),n=e.u(this.options);e.p(t),this.T(n),this._$AH=e}}_$AC(e){let t=Oe.get(e.strings);return t===void 0&&Oe.set(e.strings,t=new je(e)),t}k(t){ve(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.O(h()),this.O(h()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let t=fe(e).nextSibling;fe(e).remove(),e=t}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},Pe=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,r,i){this.type=1,this._$AH=x,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=x}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=C(this,e,t,0),a=!g(e)||e!==this._$AH&&e!==b,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=C(this,r[n+o],t,o),s===b&&(s=this._$AH[o]),a||=!g(s)||s!==this._$AH[o],s===x?e=x:e!==x&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===x?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},Fe=class extends Pe{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===x?void 0:e}},Ie=class extends Pe{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==x)}},Le=class extends Pe{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=C(this,e,t,0)??x)===b)return;let n=this._$AH,r=e===x&&n!==x||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==x&&(n===x||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Re=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){C(this,e)}},ze=de.litHtmlPolyfillSupport;ze?.(je,Ne),(de.litHtmlVersions??=[]).push(`3.3.3`);var Be=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new Ne(t.insertBefore(h(),e),e,void 0,n??{})}return i._$AI(e),i},Ve=globalThis,w=class extends f{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Be(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return b}};w._$litElement$=!0,w.finalized=!0,Ve.litElementHydrateSupport?.({LitElement:w});var He=Ve.litElementPolyfillSupport;He?.({LitElement:w}),(Ve.litElementVersions??=[]).push(`4.2.2`);var Ue={attribute:!0,type:String,converter:ce,reflect:!1,hasChanged:le},We=(e=Ue,t,n)=>{let{kind:r,metadata:i}=n,a=globalThis.litPropertyMetadata.get(i);if(a===void 0&&globalThis.litPropertyMetadata.set(i,a=new Map),r===`setter`&&((e=Object.create(e)).wrapped=!0),a.set(n.name,e),r===`accessor`){let{name:r}=n;return{set(n){let i=t.get.call(this);t.set.call(this,n),this.requestUpdate(r,i,e,!0,n)},init(t){return t!==void 0&&this.C(r,void 0,e,t),t}}}if(r===`setter`){let{name:r}=n;return function(n){let i=this[r];t.call(this,n),this.requestUpdate(r,i,e,!0,n)}}throw Error(`Unsupported decorator location: `+r)};function T(e){return(t,n)=>typeof n==`object`?We(e,t,n):((e,t,n)=>{let r=t.hasOwnProperty(n);return t.constructor.createProperty(n,e),r?Object.getOwnPropertyDescriptor(t,n):void 0})(e,t,n)}function E(e){return T({...e,state:!0,attribute:!1})}var Ge=new Map;function Ke(e){Ge.has(e.type)&&console.warn(`Block-Typ "${e.type}" wird ueberschrieben.`),Ge.set(e.type,e)}function qe(){return Array.from(Ge.values())}var Je={width:`auto`};function Ye(e){return Object.entries(e).map(([e,t])=>`${e.replace(/[A-Z]/g,e=>`-`+e.toLowerCase())}:${t}`).join(`;`)}var Xe={spalten:24,spaltePx:40,zeilePx:12,gapPx:8},Ze={rasterX:0,rasterY:0,rasterW:Xe.spalten,rasterH:1};function Qe(){return{display:`grid`,gridTemplateColumns:`repeat(${Xe.spalten}, 1fr)`,gridAutoRows:`${Xe.zeilePx}px`,gap:`${Xe.gapPx}px`,alignContent:`start`}}function $e(){return Ye(Qe())}var et=`weitereQuellen`,tt={[et]:[]},nt=`folgtAuswahl`,rt={[nt]:[]};function D(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var O=class extends w{constructor(...e){super(...e),this.editable=!1}static{this.styles=o`
  ...
  `}aktualisiereEscape(){let e=this.isConnected&&this.escapeSchliesst;e!==this.escapeRegistriert&&(e?document.addEventListener(`keydown`,this.aufTaste,!0):document.removeEventListener(`keydown`,this.aufTaste,!0),this.escapeRegistriert=e)}schliesse(){this.dispatchEvent(new CustomEvent(Bt,{bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this.aktualisiereEscape()}updated(e){e.has(`escapeSchliesst`)&&this.aktualisiereEscape()}disconnectedCallback(){this.escapeRegistriert&&=(document.removeEventListener(`keydown`,this.aufTaste,!0),!1),super.disconnectedCallback()}render(){let e=Vt(this.breite,520),t=Vt(this.hoehe,380);return y`
    ...
    `}};D([T()],L.prototype,`titel`,void 0),D([T({type:Number})],L.prototype,`breite`,void 0),D([T({type:Number})],L.prototype,`hoehe`,void 0),D([T({type:Boolean,reflect:!0})],L.prototype,`viewport`,void 0),D([T({type:Boolean,attribute:`escape-schliesst`})],L.prototype,`escapeSchliesst`,void 0),D([T({type:Boolean,attribute:`ohne-modal`})],L.prototype,`ohneModal`,void 0),D([T({type:Boolean,reflect:!0,attribute:`inhalt-fest`})],L.prototype,`inhaltFest`,void 0),customElements.get(`ff-dialog-rahmen`)||customElements.define(zt,L);var Ht=`input,select,textarea,button,a[href],[tabindex]:not([tabindex="-1"])`;function Ut(e){for(let t of Array.from(e.querySelectorAll(`*`))){if(t instanceof HTMLElement&&t.matches(Ht)&&!t.hasAttribute(`disabled`))return t;let e=t.shadowRoot?Ut(t.shadowRoot):null;if(e)return e}return null}var R=class extends O{constructor(...e){super(...e),this.name=`Popup`,this.breite=520,this.hoehe=380,this.offen=!1}static{this.blockType=`popup`}static{this.tagName=`ff-popup`}static{this.displayName=`Popup`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.showInPalette=!1}static{this.allowedParentTypes=[it]}static{this.pageBlock=!0}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.defaultProps={name:`Popup`,breite:520,hoehe:380}}static{this.styles=[O.styles,o`
    ...
    `]}onClose(){this.hasAttribute(`data-ff-editor`)||this.removeAttribute(`offen`)}updated(e){super.updated(e),!(!e.has(`offen`)||!this.offen)&&(this.hasAttribute(`data-ff-editor`)||this.updateComplete.then(()=>{!this.offen||!this.isConnected||(Ut(this)??(this.shadowRoot?Ut(this.shadowRoot):null))?.focus()}))}render(){return y`<ff-dialog-rahmen
        .breite=${this.breite}
        .hoehe=${this.hoehe}
        ohne-modal
        inhalt-fest
      ...
      </ff-dialog-rahmen>`}};D([T()],R.prototype,`name`,void 0),D([T()],R.prototype,`breite`,void 0),D([T()],R.prototype,`hoehe`,void 0),D([T({type:Boolean,reflect:!0})],R.prototype,`offen`,void 0),O.defineAndRegister(R);var Wt=[`GET_RELATION`,`PUT_RELATION`,`PUTADD_RELATION`];function Gt(e){return`${String(e.getDate()).padStart(2,`0`)}.${String(e.getMonth()+1).padStart(2,`0`)}.${e.getFullYear()}`}function Kt(e,t){return e.params.map(e=>e.replace(/\{([A-Za-z0-9_]+)\}/g,(e,n)=>String(t[n]??``)))}var qt=8e3,z=null,B=null;function Jt(){let e=document.createElement(`div`);return e.setAttribute(`data-ff-meldung`,``),e.setAttribute(`role`,`alert`),e.style.cssText=[`position:fixed`,`top:0`,`left:0`,`right:0`,`z-index:2147483647`,`padding:7px 12px`,`background:var(--se-red-soft,#fbe7e6)`,`color:var(--se-red,#c0201a)`,`border-bottom:1px solid var(--se-red,#c0201a)`,`font:500 12px/1.4 system-ui,sans-serif`,`cursor:pointer`].join(`;`),e.title=`Klicken zum Schließen`,e.addEventListener(`click`,Yt),e}function Yt(){B&&=(clearTimeout(B),null),z?.remove(),z=null}function V(e){typeof document>`u`||!document.body||(z||(z=Jt(),document.body.appendChild(z)),z.textContent=e,B&&clearTimeout(B),B=setTimeout(Yt,qt))}function H(){return globalThis}function Xt(){let e=H();return A(e.SEDATA)&&A(e.SEDATA.Daten)}function Zt(){let e=H();try{e.selib?.Json?.InitializeERPConnection?.()}catch{}try{typeof e.InitialisiereSchnittstelle==`function`&&e.InitialisiereSchnittstelle()}catch{}}function Qt(){let e=H();try{typeof e.ResetDataBasis==`function`&&e.ResetDataBasis()}catch{}try{typeof e.InitialisiereDatenBasis==`function`&&e.InitialisiereDatenBasis()}catch{}}var $t=new Set,en=new Set;function tn(e){$t.add(e)}function nn(e){return en.add(e),()=>{en.delete(e)}}function rn(){$t.forEach(e=>e())}function an(){rn()}function on(e){en.forEach(t=>{try{t(e)}catch{}})}function sn(e){let t=xt(e);if(!t){on(e);return}let n=H();A(n.SEDATA)||(n.SEDATA={}),n.SEDATA.Daten=t,Qt(),rn()}function cn(e=0){let t=H();if(typeof t.basisHTML_REGISTER==`function`){try{t.basisHTML_SetConsoleLog?.(!0,!0)}catch{}try{t.basisHTML_REGISTER(e=>{sn(e)},document.title,`1.0`)}catch(e){V(`SoftEngine-Anmeldung fehlgeschlagen: `+(e instanceof Error?e.message:String(e)))}return}e<400?setTimeout(()=>{cn(e+1)},25):V(`SoftEngine-Anschluss nicht gefunden — die Maske bleibt ohne Daten.`)}var ln=!1;function un(){if(ln)return;ln=!0,Zt();let e=H();e.Erstellen=()=>{Qt(),rn()},e.initData=e.Erstellen,e.ReloadData=()=>{rn()},cn(),window.addEventListener(`message`,e=>{if(typeof H().basisHTML_REGISTER==`function`)return;let t=St(e.data);t!==void 0&&sn(t)},!0);let t=0,n=setInterval(()=>{t+=1,Xt()?(clearInterval(n),Qt(),rn()):t>100&&(clearInterval(n),V(`Keine Daten von SoftEngine empfangen — die Maske zeigt nichts an.`))},300)}function dn(e){return e instanceof Error?e.message:String(e)}function fn(e,t){if(!(!Array.isArray(e)||t===``)){for(let n of e)if(!(!A(n)||n.id!==t)&&!(typeof n.verb!=`string`||!Wt.includes(n.verb))&&!(typeof n.nr!=`string`||n.nr===``)&&!(!Array.isArray(n.params)||n.params.some(e=>typeof e!=`string`)))return{id:t,verb:n.verb,nr:n.nr,params:n.params}}}var pn=[`RESULT`,`result`,`PINDEX`,`pindex`,`INDEX`,`index`,`0_10`,`KEY`,`key`,`ID`,`id`,`VALUE`,`value`];function mn(e){if(typeof e!=`string`)return e;try{return JSON.parse(e)}catch{return}}function hn(e){if(typeof e==`string`){let t=e.trim();return t===``?void 0:t}if(typeof e==`number`||typeof e==`boolean`)return String(e)}function gn(e,t){if(t>12)return;let n=hn(e);if(n!==void 0)return n;if(Array.isArray(e)){for(let n of e){let e=gn(n,t+1);if(e!==void 0)return e}return}if(A(e)){for(let n of pn){if(!(n in e))continue;let r=gn(e[n],t+1);if(r!==void 0)return r}for(let n of Object.values(e)){let e=gn(n,t+1);if(e!==void 0)return e}}}function _n(e){let t=mn(e);if(A(t)){for(let e of pn){if(!(e in t))continue;let n=gn(t[e],0);if(n!==void 0)return n}for(let e of Object.values(t))if(Array.isArray(e))for(let t of e){let e=_n(t);if(e!==void 0)return e}else if(A(e)){let t=_n(e);if(t!==void 0)return t}}}var vn=[`RESULT`,`result`];function yn(e,t=0){if(t>12)return;let n=typeof e==`string`?mn(e):e;if(Array.isArray(n)){for(let e of n){let n=yn(e,t+1);if(n!==void 0)return n}return}if(A(n)){for(let e of vn){let t=n[e];if(typeof t==`string`)return t;if(typeof t==`number`||typeof t==`boolean`)return String(t)}for(let e of Object.values(n)){let n=yn(e,t+1);if(n!==void 0)return n}}}function bn(e,t,n=0){if(t.trim()===``||n>12)return``;let r=typeof e==`string`?mn(e):e;if(Array.isArray(r)){for(let e of r){let r=bn(e,t,n+1);if(r!==``)return r}return``}if(!A(r))return``;let i=M(r,t);if(i!==``)return i;for(let e of Object.values(r)){let r=bn(e,t,n+1);if(r!==``)return r}return``}function xn(e){return A(e)?Object.keys(e).filter(e=>/^Message\d+$/.test(e)):[]}function Sn(e,t,n=!1){if(!A(e))return;let r=xn(e).filter(e=>!t.has(e)).sort((e,t)=>Number(t.slice(7))-Number(e.slice(7)));for(let t of r){let r=n?yn(e[t]):_n(e[t]);if(r!==void 0)return{wert:r,roh:e[t]}}}var Cn=[],wn=!1,Tn=6e3,En=100;function Dn(){if(wn||Cn.length===0)return;wn=!0;let e=Cn.shift(),t=H(),n=new Set(xn(t.SEDATA)),r=!1,i=(t,n)=>{r||(r=!0,o(),clearInterval(s),clearTimeout(c),wn=!1,e.resolve({wert:t,roh:n}),queueMicrotask(Dn))},a=e.optionen.satzAntwort===!0,o=nn(e=>{let t=a?yn(e):_n(e);t!==void 0&&i(t,e)}),s=setInterval(()=>{let e=Sn(H().SEDATA,n,a);e!==void 0&&i(e.wert,e.roh)},En),c=setTimeout(()=>{e.optionen.still||V(`Daten laden: SoftEngine hat nicht geantwortet (Relation Nr. ${e.template.nr}).`),i(``,void 0)},Tn);if(typeof t.basisHTML_SND_MSG!=`function`){e.optionen.still||V(`Daten laden nicht möglich: keine Verbindung zu SoftEngine.`),i(``,void 0);return}try{t.basisHTML_SND_MSG(`GET_RELATION`,{NR:e.template.nr,PARAMS:e.params})}catch(t){e.optionen.still||V(`Daten laden fehlgeschlagen (Relation Nr. ${e.template.nr}): ${dn(t)}`),i(``,void 0)}}function On(e,t,n={}){un();let r=H();if(e.verb!==`GET_RELATION`){if(typeof r.basisHTML_SND_MSG!=`function`)return V(`Speichern nicht möglich: keine Verbindung zu SoftEngine. Die Eingabe wurde NICHT übernommen.`),Promise.resolve({wert:``,roh:void 0});try{r.basisHTML_SND_MSG(e.verb,{NR:e.nr,PARAMS:[...t]})}catch(t){V(`Speichern fehlgeschlagen (Relation Nr. ${e.nr}): ${dn(t)}`)}return Promise.resolve({wert:``,roh:void 0})}return new Promise(r=>{Cn.push({template:e,params:[...t],resolve:r,optionen:n}),Dn()})}function kn(e,t){if(!A(t))return``;let n=t.document;if(!n||typeof n.querySelectorAll!=`function`)return``;let r=Array.from(n.querySelectorAll(`[${st}]`)).find(t=>t.getAttribute(st)===e.blockId);if(!r)return``;let i=r[e.value];return i==null?``:String(i)}function An(e,t,n=H()){if(e.source===`aus`)return``;if(e.source===`fixed`)return e.value;if(e.source===`context`)return t.context[e.value]??``;if(e.source===`previous_result`)return t.previousResult;if(e.source===`step_result`){let n=Number(e.value);if(!Number.isInteger(n)||n<0)return``;let r=e.ergebnisFeld??``;return r===``?t.stepResults?.[n]??``:bn(t.stepRohErgebnisse?.[n],r)}if(e.source===`block_value`)return kn(e,n);if(e.source===`gewaehlte_zeile`){let n=t.gewaehlteZeile?.(e.blockId??``);return n===void 0?``:M(n,e.value)}if(!A(n))return``;if(e.source===`se_variable`){let t=n.SEDATA;if(!A(t)||!A(t.Daten)||!A(t.Daten.VARArrays))return``;let r=t.Daten.VARArrays[e.value];return r==null?``:String(r)}let r=j(n.FF_DATA_SOURCES,e.dataSourceId??``);if(!r)return``;let i=P(n.SEDATA,r.name,r.tableId),a=t.context.PINDEX??``,o=a!==``&&r.indexField!==``?i.find(e=>M(e,r.indexField)===a):i[0];return o?M(o,e.value):``}function jn(e,t){let n=`0,START_TOOL,`+e;return t.length>0&&(n+=`,`+t.map(e=>encodeURIComponent(e)).join(`,`)),n}function Mn(e,t){if(e.trim()===``)return;let n=H();try{if(typeof n.sendBWLinkIntern==`function`){n.sendBWLinkIntern(jn(e,t));return}}catch{}try{if(typeof n.basisHTML_SND_MSG==`function`){let r={NR:e};t.length>0&&(r.PARAMS=[...t]),n.basisHTML_SND_MSG(`START_TOOL`,r)}}catch{}}function Nn(e,t,n){if(t.trim()===``)return;let r=Array.from(e.querySelectorAll(R.tagName)),i=r.filter(e=>(e.getAttribute(`name`)??R.defaultProps.name)===t);if(i.length!==1)return;let a=i[0];if(!n){a.removeAttribute(`offen`);return}for(let e of r)e!==a&&e.removeAttribute(`offen`);a.setAttribute(`offen`,``)}var Pn=new WeakMap;function Fn(e){V(`Aktionskette fehlgeschlagen: `+(e instanceof Error?e.message:String(e)))}async function In(e,t,n){if(e.hasAttribute(`data-ff-editor`))return;let r=ft(e.getAttribute(`data-ff-aktionen`))[t];if(!r||r.length===0)return;let i=Pn.get(e);if(i||(i=new Set,Pn.set(e,i)),!i.has(t)){i.add(t);try{let t={...n,NOW_DATE:Gt(new Date)},i=``,a=[],o=[],s=()=>{a.push(``),o.push(void 0)};for(let n of r){if(n.type===`START_TOOL`){Mn(n.toolNr,Kt({params:n.toolParams},t)),s();continue}if(n.type===`POPUP_OPEN`||n.type===`POPUP_CLOSE`){Nn(e.ownerDocument??document,n.popup??``,n.type===`POPUP_OPEN`),s();continue}let r=fn(H().FF_RELATIONS,n.relationId);if(!r){s();continue}let c={context:t,previousResult:i,stepResults:a,stepRohErgebnisse:o,gewaehlteZeile:kt},l=await On(r,[...n.params,...n.extraParams].map(e=>An(e,c))),u=l.wert;a.push(u),o.push(l.roh),r.verb===`GET_RELATION`&&(i=u),n.resultKey!==``&&(t[n.resultKey]=u)}}finally{i.delete(t)}}}var Ln=new WeakSet;function Rn(e,t){if(e.hasAttribute(`data-ff-editor`)||!e.hasAttribute(`data-ff-aktionen`)||Ln.has(e))return;Ln.add(e);let n=ft(e.getAttribute(`data-ff-aktionen`));Object.values(n).some(e=>e.some(e=>e.type===`RELATION`))&&un(),e.addEventListener(`click`,()=>{In(e,t,{}).catch(Fn)})}var zn=class extends O{constructor(...e){super(...e),this.label=`Klick mich`}static{this.blockType=`button`}static{this.tagName=`ff-button`}static{this.displayName=`Schaltfläche`}static{this.category=`eingabe`}static{this.defaultProps={label:`Klick mich`}}static{this.resizableWidth=!1}static{this.blockEvents=[{key:`onClick`,name:`Klick`}]}static{this.raster={startW:4,startH:2,minW:2,minH:2}}static{this.customProperties=[]}static{this.styles=[O.styles,o`
      button {
        box-sizing: border-box;
        padding: 7px 16px;
        cursor: pointer;
    ...
    >${this.label}</button>`}connectedCallback(){super.connectedCallback(),Rn(this,`onClick`)}};D([T()],zn.prototype,`label`,void 0),O.defineAndRegister(zn);var Bn=[`info`,`success`,`warning`,`danger`];function Vn(e){return Bn.includes(e)?e:`info`}var Hn=[{wert:`info`,name:`Hinweis`},{wert:`success`,name:`Erfolg`},{wert:`warning`,name:`Warnung`},{wert:`danger`,name:`Fehler`}];function Un(e,t){return{attributeName:e,name:`Bedeutung`,description:t,kind:`select`,options:Hn.map(e=>({value:e.wert,label:e.name}))}}var Wn=o`
...
`,U=class extends O{constructor(...e){super(...e),this.chipVariant=`info`,this.heading=``,this.heading2=``,this.time=``,this.date=``,this.avatar=``,this.meta=``,this.text=``,this.chipText=``,this.headingField=``,this.heading2Field=``,this.timeField=``,this.dateField=``,this.avatarField=``,this.metaField=``,this.textField=``,this.chipTextField=``}static{this.blockType=`card`}static{this.tagName=`ff-card`}static{this.displayName=`Karte`}static{this.category=`anzeige`}static{this.allowedParentTypes=[`kanban-spalte`,`kanban-zimmer`]}static{this.showInPalette=!1}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={chipVariant:`info`,heading:``,heading2:``,time:``,date:``,avatar:``,meta:``,text:``,chipText:``,headingField:``,heading2Field:``,timeField:``,dateField:``,avatarField:``,metaField:``,textField:``,chipTextField:``}}static{this.bindableSpots=[{prop:`time`,label:`Zeit`},{prop:`date`,label:`Datum`},{prop:`avatar`,label:`Avatar`},{prop:`heading`,label:`Titel`},{prop:`heading2`,label:`Titel 2`},{prop:`meta`,label:`Unterzeile`},{prop:`text`,label:`Textzeile`},{prop:`chipText`,label:`Chip`}]}static{this.customProperties=[Un(`chipVariant`,`Bedeutung des Chips auf der Karte — bestimmt die Chip-Farbe.`)]}static{this.styles=[O.styles,Wn,Qn]}stelle(e,t){return y`<span
    ...
    >${this[e]}</span>`}hatReiter(){return this.hasAttribute(`data-ff-editor`)||this.date.trim()!==``||this.time.trim()!==``}updated(e){super.updated(e),this.toggleAttribute(`hat-reiter`,this.hatReiter())}render(){let e=Vn(this.chipVariant),t=this.hasAttribute(`data-ff-editor`),n=e=>t||e.trim()!==``,r=this.hatReiter(),i=n(this.avatar)||n(this.heading)||n(this.meta),a=n(this.heading2)||n(this.chipText);return y`<div class="card v-${e}${r?``:` ohne-reiter`}">
      ...
      ${i?y`<div class="kopf">
            ${n(this.avatar)?y`<span
                ...
                >${this.avatar.trim()===``?x:Zn(this.avatar)}</span>`:x}
            <div class="namen">
    ...
    `]}setzeTag(e){ar(e),this.tag=ir()}render(){return y`<div class="waehler">
      <div class="riegel">
        <button class="pfeil" title="Vortag" @click=${()=>this.setzeTag(tr(this.tag,-1))}>‹</button>
        <input
          class="feld"
          type="date"
          .value=${this.tag}
        ...
        />
        <button class="pfeil" title="Folgetag" @click=${()=>this.setzeTag(tr(this.tag,1))}>›</button>
      </div>
      <button class="heute" @click=${()=>this.setzeTag(er(new Date))}>Heute</button>
    </div>`}connectedCallback(){super.connectedCallback(),this.tag=ir()||er(new Date),!this.hasAttribute(`data-ff-editor`)&&(this.setzeTag(this.tag),this.tagAbmelden?.(),this.tagAbmelden=or(()=>{this.tag=ir()}))}disconnectedCallback(){super.disconnectedCallback(),this.tagAbmelden?.(),this.tagAbmelden=null}};D([E()],sr.prototype,`tag`,void 0),O.defineAndRegister(sr);var cr={attributeName:`fieldType`,equals:`nachschlagen`},lr=[{attributeName:`fieldType`,name:`Feldtyp`,description:`Welche Art Eingabe das Feld annimmt.`,kind:`select`,options:[{value:`text`,label:`Text`},{value:`number`,label:`Zahl`},{value:`textarea`,label:`Mehrzeilig`},{value:`select`,label:`Auswahl`},{value:`date`,label:`Datum`},{value:`time`,label:`Uhrzeit`},{value:`checkbox`,label:`Ankreuzfeld`},{value:`nachschlagen`,label:`Nachschlagen`}]},{attributeName:`options`,name:`Auswahl-Optionen`,description:`Nur bei Feldtyp "Auswahl": Einträge durch Komma getrennt (z. B. "Zimmer 1, Zimmer 2") — jeder Eintrag wird eine Dropdown-Zeile.`,kind:`text`,visibleWhen:{attributeName:`fieldType`,equals:`select`}},{attributeName:`nachschlagQuelle`,name:`Quelle`,description:`Nur bei Feldtyp "Nachschlagen": aus dieser Datenquelle wählt der Bediener eine Zeile.`,kind:`quelle`,visibleWhen:cr},{attributeName:`anzeigeFeld`,name:`Angezeigt wird (optional)`,description:`Leer lassen: das Feld zeigt den gespeicherten Wert. Sonst das Feld, dessen Wert der Bediener statt des Technikwerts sieht (z. B. der Name).`,kind:`field`,quelleProp:`nachschlagQuelle`,klarnameProp:`anzeigeTitel`,visibleWhen:cr},{attributeName:`speicherFeld`,name:`Gespeichert wird`,description:`Feld der Nachschlage-Quelle, dessen Wert die Maske sich merkt und die Kette "Wert geändert" weitergibt (z. B. die Nummer).`,kind:`field`,quelleProp:`nachschlagQuelle`,klarnameProp:`speicherTitel`,visibleWhen:cr},{attributeName:`einzigerTreffer`,name:`Einzigen Treffer übernehmen`,description:`Bleibt in der Maske genau EIN Satz übrig (weil das Feld der Auswahl eines anderen folgt), übernimmt es diesen von selbst — ohne dass der Bediener die Lupe drückt. Nur in ein leeres Feld; die Lupe bleibt daneben bedienbar.`,kind:`segment`,options:[{value:`ja`,label:`Ja`},{value:`nein`,label:`Nein`}],visibleWhen:cr},{attributeName:`valueField`,name:`Feld`,description:`Feld der angeschlossenen Datenquelle, dessen Wert angezeigt und lokal aktualisiert wird.`,kind:`field`,visibleWhen:{attributeName:`fieldType`,keinesVon:[`checkbox`,`nachschlagen`]}}];function ur(e){return`${e.toLowerCase()}field`}function dr(e){let t=e.split(`::`);if(t.length!==2)return{quelleId:``,code:e};let[n,r]=t;return n===``||r===``?{quelleId:``,code:e}:{quelleId:n,code:r}}var fr=999,pr=`0`,mr=`255`,hr=new Map;function gr(e){let t=_t(e);gt(e,[]),t!==void 0&&t.length>0&&an()}async function _r(e,t,n,r,i){return(await On({id:`relation-lader`,verb:`GET_RELATION`,nr:e.nr,params:[]},[t.belegart,r,i,t.belegnummer,t.jahr,t.archiv,``,String(n),``,``,``,``],{still:!0,satzAntwort:!0})).wert}function vr(e,t,n){let r=(hr.get(e.id)??0)+1;if(hr.set(e.id,r),n===void 0){gr(e.name);return}let i={belegart:M(n,t.belegartFeld),belegnummer:M(n,t.belegnummerFeld),jahr:t.jahrFeld===``?``:M(n,t.jahrFeld),archiv:t.archivFeld===``?``:M(n,t.archivFeld)};if(i.belegart===``||i.belegnummer===``){gr(e.name);return}gr(e.name),(async()=>{let n=[],a=!1;for(let o=1;o<=fr;o+=1){let s=await _r(t,i,o,pr,mr);if(hr.get(e.id)!==r)return;if(t.endeFelder.every(e=>M({SATZ:s},e)===``)){a=!0;break}let c={SATZ:s};for(let n of t.zusatzFelder){let a=n.indexOf(`_`),s=await _r(t,i,o,n.slice(0,a),n.slice(a+1));if(hr.get(e.id)!==r)return;c[n]=s}n.push(c)}a||V(`Positionen laden: nach ${fr} Zeilen ohne Ende-Kennung abgebrochen (Relation Nr. ${t.nr}) — die Liste ist wahrscheinlich unvollständig, vermutlich passen Relationsnummer oder Ende-Felder nicht.`),hr.get(e.id)===r&&(gt(e.name,n),an())})()}var yr=new Map,br=!1;function xr(){let e=new Map;for(let t of qe())t.satzWahl&&e.set(t.tagName.toLowerCase(),(t.satzWahl.quelleProp??`source`).toLowerCase());return e}function Sr(e,t){if(!(e===``||typeof document>`u`))for(let n of Array.from(document.querySelectorAll(`[data-ff-id]`))){let r=t.get(n.tagName.toLowerCase());if(r===void 0||n.getAttribute(r)!==e)continue;let i=kt(n.getAttribute(`data-ff-id`)??``);if(i!==void 0)return i}}function Cr(){let e=H().FF_DATA_SOURCES;if(!Array.isArray(e))return;let t=xr();for(let n of e){if(!A(n)||typeof n.id!=`string`)continue;let r=j(e,n.id);if(!r?.ladeRelation)continue;let i=Sr(r.ladeRelation.geberQuelleId,t),a=Ct(i);yr.get(r.id)!==a&&(yr.set(r.id,a),vr(r,r.ladeRelation,i))}}function wr(){br||(br=!0,Ot(Cr))}function Tr(e){let t=new Set,n=!1,r=()=>{Xt()&&t.forEach(e.hydriere)};return{connect:i=>{i.hasAttribute(`data-ff-editor`)||(t.add(i),e.verdrahte?.(i),n||(n=!0,tn(r),or(r),Ot(r),wr()),un(),Xt()&&e.hydriere(i))},disconnect:e=>{t.delete(e)}}}var Er=et.toLowerCase(),Dr=``;function Or(e){if(e.length===0)return``;let t=[];for(let n of e){let e=n.trim();if(e===``)return``;t.push(e)}return t.join(Dr)}function kr(e){let t=e.getAttribute(Er)??``;if(t===``)return[];try{let e=JSON.parse(t);if(!Array.isArray(e))return[];let n=[];for(let t of e){if(!t||typeof t!=`object`)continue;let e=t;if(typeof e.quelleId!=`string`||e.quelleId===``)continue;let r=[];for(let t of Array.isArray(e.keyPairs)?e.keyPairs:[]){if(!t||typeof t!=`object`)continue;let e=t;typeof e.fromField!=`string`||typeof e.toField!=`string`||e.fromField.trim()===``||e.toField.trim()===``||r.push({fromField:e.fromField,toField:e.toField})}r.length!==0&&n.push({quelleId:e.quelleId,keyPairs:r})}return n}catch{return[]}}function Ar(e){let t=kr(e);if(t.length===0)return(e,t)=>M(e,dr(t).code);let n=H().SEDATA,r=H().FF_DATA_SOURCES,i=new Map;for(let e of t){let t=j(r,e.quelleId);if(!t)continue;let a=P(n,t.name,t.tableId),o=new Map;for(let t of a){let n=Or(e.keyPairs.map(e=>M(t,e.toField)));n!==``&&!o.has(n)&&o.set(n,t)}i.set(e.quelleId,{nachSchluessel:o,hierFelder:e.keyPairs.map(e=>e.fromField)})}return(e,t)=>{let{quelleId:n,code:r}=dr(t);if(n===``)return M(e,r);let a=i.get(n);if(!a)return``;let o=Or(a.hierFelder.map(t=>M(e,t)));if(o===``)return``;let s=a.nachSchluessel.get(o);return s===void 0?``:M(s,r)}}function jr(e,t){let n=e.getAttribute(`source`)??``,r=e.getAttribute(t)??``;if(n===``||r===``)return{art:`ungebunden`};let i=j(H().FF_DATA_SOURCES,n);if(!i)return{art:`ohneQuelle`};let a=Rt(e,P(H().SEDATA,i.name,i.tableId));if(a===void 0)return{art:`ohneZeile`};let{quelleId:o,code:s}=dr(r);return{art:`wert`,wert:o===``?M(a,s):Ar(e)(a,r),zeile:a,quelle:i,quelleId:o,reinerCode:s}}var Mr=new WeakMap,Nr=new WeakSet;function Pr(e){let t=/^(\d{2})\.(\d{2})\.(\d{4})$/.exec(e);return t?`${t[3]}-${t[2]}-${t[1]}`:e}function Fr(e){let t=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);return t?`${t[3]}.${t[2]}.${t[1]}`:e}function Ir(e){return typeof e.value==`string`?e.value:``}function Lr(e){if(e.pruefeEigenenWert?.(),e.getAttribute(`fieldtype`)===`nachschlagen`){Mr.delete(e);return}let t=jr(e,ur(`value`));if(t.art!==`wert`){Mr.delete(e),t.art===`ohneZeile`&&(e.value=``);return}let{zeile:n,quelle:r,quelleId:i,reinerCode:a,wert:o}=t,s=r.indexField===``?``:M(n,r.indexField);i===``?Mr.set(e,{row:n,code:a,pindex:s}):Mr.delete(e),e.value=o}function Rr(e){let t=Mr.get(e);return t&&yt(t.row,t.code,Ir(e)),t}function zr(e){Nr.has(e)||(Nr.add(e),e.addEventListener(`input`,()=>{Rr(e)}),e.addEventListener(`change`,()=>{let t=Rr(e);In(e,`onChange`,{VALUE:Ir(e),PINDEX:t?.pindex??``}).catch(Fn)}))}var Br=Tr({hydriere:Lr,verdrahte:zr}),Vr=Br.connect,Hr=Br.disconnect,Ur=o`
  .feld {
    font-family: var(--se-font);
...
`,Wr=[`text`,`number`,`textarea`,`select`,`date`,`time`,`checkbox`,`nachschlagen`];function Gr(e){return Wr.includes(e)?e:`text`}var Kr=[`text`,`number`,`textarea`,`select`,`nachschlagen`,`date`,`time`],qr={select:`ph-select`,date:`ph-nativ`,time:`ph-nativ`},Jr=4;function Yr(e){return e??Jr}function Xr(e,t,n){return Math.max(1,Math.floor((e-t)/n))}function Zr(e,t,n){let r=Xr(e,t,n),i=e-t;return i<n?{passen:r,zeilenHoehe:n}:{passen:r,zeilenHoehe:Math.floor(i/r*100)/100}}function Qr(e,t){return e===null?null:Math.max(0,e-t)}function $r({sichtbar:e,hatQuelle:t,proSeite:n,wunschSeite:r,platzhalterZeilen:i}){let a=t?Math.max(1,Math.ceil(e.length/n)):1,o=Math.min(Math.max(r,0),a-1);return t?{seiten:a,seite:o,zeilen:[...e.slice(o*n,(o+1)*n)]}:{seiten:a,seite:o,zeilen:Array.from({length:i},()=>null)}}function ei(e,t){let n=t.trim().toLowerCase();return e.find(e=>e.wert.trim().toLowerCase()===n)}var W=`text`,ti=`status`,ni=`bild`,ri=`bild`,ii=`unter`,ai=[{wert:W,name:`Text`,spur:`minmax(0, 1fr)`,klasse:``,zelle:e=>e},{wert:`zahl`,name:`Zahl`,spur:`90px`,klasse:`zahl`,zelle:e=>e},{wert:`datum`,name:`Datum`,spur:`100px`,klasse:`zahl`,zelle:e=>e},{wert:ti,name:`Status`,spur:`120px`,klasse:`status`,zelle:(e,t)=>{let n=ei(t,e);return n?y`<span class="chip v-${Vn(n.bedeutung)}">${n.name.trim()===``?e:n.name}</span>`:y`<span class="chip">${e}</span>`}},{wert:ni,name:`Bild + Name`,spur:`minmax(0, 1fr)`,klasse:`bild`,zusatzFelder:[{key:ri,label:`Bild`},{key:ii,label:`Unterzeile`}],hoehe:e=>(e[ri]??``)!==``||(e[ii]??``)!==``?44:32,zelle:(e,t,n)=>{let r=Xn(n[ri]??``),i=n[ii]??``;return y`<div class="bild-name">
        ${r===void 0?x:y`<span class="bild-zeichen">${r}</span>`}
        <div class="bild-text">
          <div class="bild-titel">${e}</div>
          ${i===``?x:y`<div class="bild-unter">${i}</div>`}
        </div>
      </div>`}}];function oi(e){return e.reduce((e,t)=>{let n=si(t.art);return Math.max(e,n.hoehe?.(t.felder??{})??32)},32)}function si(e){return ai.find(t=>t.wert===e)??ai[0]}var ci=ai.map(e=>({wert:e.wert,name:e.name,...e.zusatzFelder?{felder:e.zusatzFelder}:{}})),li=`felder`,ui=`Spalte {n}`;function di(e){return ui.replace(`{n}`,String(e+1))}function G(e){return{titel:di(e),feld:``,art:W}}function fi(){return[0,1,2].map(e=>G(e))}function pi(e){return Array.isArray(e)?e.filter(e=>!!e&&typeof e==`object`).map(e=>({wert:typeof e.wert==`string`?e.wert:``,name:typeof e.name==`string`?e.name:``,bedeutung:typeof e.bedeutung==`string`?e.bedeutung:``})).filter(e=>e.wert.trim()!==``):[]}function mi(e){if(!e||typeof e!=`object`||Array.isArray(e))return{};let t={};for(let[n,r]of Object.entries(e))typeof r==`string`&&r!==``&&(t[n]=r);return t}function hi(e,t){if(e&&typeof e==`object`){let n=e,r=pi(n.zuordnung),i=mi(n.felder);return{titel:typeof n.titel==`string`?n.titel:di(t),feld:typeof n.feld==`string`?n.feld:``,art:typeof n.art==`string`?n.art:W,...r.length>0?{zuordnung:r}:{},...Object.keys(i).length>0?{felder:i}:{}}}return typeof e==`string`?{...G(t),titel:e}:G(t)}function gi(e){let t;if(Array.isArray(e))t=e.map((e,t)=>hi(e,t));else if(typeof e==`number`&&Number.isFinite(e)||typeof e==`string`&&/^\d+$/.test(e)){let n=Math.max(1,Math.floor(Number(e)));t=[...Array(n).keys()].map(e=>G(e))}else t=fi();return t.length>8&&(t=t.slice(0,8)),t.length<1&&(t=[G(0)]),t}function _i(e){try{return gi(JSON.parse(e))}catch{return fi()}}var vi={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},yi=e=>(...t)=>({_$litDirective$:e,values:t}),bi=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},xi=`important`,Si=` !important`,Ci=yi(class extends bi{constructor(e){if(super(e),e.type!==vi.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(Si);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?xi:``):n[e]=r}}return b}}),wi=`Keine Datensätze.`;function Ti(){return{attributeName:`leerText`,name:`Text ohne Datensätze`,description:`Steht in der Maske dort, wo sonst die Zeilen stehen — wenn die Datenquelle keine liefert. Leer lassen: dann steht dort gar nichts.`,kind:`text`,requiresDataSource:!0}}function Ei(e,t=!1){return e.trim()===``?x:y`<div class="leer${t?` leer--tafel`:``}">
    ${Kn()}
    <span>${e}</span>
  </div>`}var Di=o`
  .leer {
...
`;function Oi(e,t){if(!e.hasAttribute(`fuellt`))return null;let n=e.renderRoot.querySelector(`.koerper`),r=e.renderRoot.querySelector(`.kopf`);return!(n instanceof HTMLElement)||!(r instanceof HTMLElement)?null:Zr(n.clientHeight,r.offsetHeight,t)}function ki(e,t){if(typeof ResizeObserver>`u`)return null;let n=e.renderRoot.querySelector(`.koerper`);if(!n)return null;let r=new ResizeObserver(t);return r.observe(n),r}function Ai(e){return{rohzeilen:e.map(e=>e.rohzeile),datenzeilen:e.map(e=>[...e.zellen]),zusatzzeilen:e.map(e=>(e.zusatz??[]).map(e=>({...e})))}}function ji(e,t,n){return t===``||n===``?[...e]:e.filter(e=>$n(M(e,t))===n)}function Mi(e){return _i(e.getAttribute(`spalten`)??``)}function Ni(e,t,n){let r={};for(let i of si(e.art).zusatzFelder??[]){let a=e.felder?.[i.key]??``;a!==``&&(r[i.key]=n(t,a))}return r}function Pi(e){let t=()=>{e.datenzeilen=[],e.zusatzzeilen=[]},n=e.getAttribute(`source`)??``;if(n===``){t();return}let r=j(H().FF_DATA_SOURCES,n);if(!r){t();return}let i=Mi(e),{rows:a,gefiltert:o}=Lt(e,ji(P(H().SEDATA,r.name,r.tableId),e.getAttribute(`tagfield`)??``,ir())),s=jt(I(e),a,e=>e)[0]??-1,c=Ar(e);e.datenGeliefert=!0,e.rohzeilen=a,e.auswahlIndex=s,e.durchAuswahlGefiltert=o,e.datenzeilen=a.map(e=>i.map(t=>t.feld===``?``:c(e,t.feld))),e.zusatzzeilen=a.map(e=>i.map(t=>Ni(t,e,c)))}var Fi=Tr({hydriere:Pi}),Ii=Fi.connect,Li=Fi.disconnect;function Ri(e){return e.trim().toLowerCase().split(/\s+/).filter(e=>e!==``)}function zi(e,t){let n=Ri(t);if(n.length===0)return!0;let r=e.join(` `).toLowerCase();return n.every(e=>r.includes(e))}function Bi(e,t){let n=[];return e.forEach((e,r)=>{zi(e,t)&&n.push(r)}),n}function Vi(e,t){return!e&&t.trim()!==``}function Hi(e,t,n){return e&&t&&n===0}function Ui(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}function Wi(e,t,n){return y`<div class="steuerung">
    <button
    ...
    >+</button>
  </div>`}function Gi(e,t){let n=e.currentTarget;if(!n)return;e.stopPropagation(),e.preventDefault();let r=Array.from(n.childNodes),i=n.textContent??``;n.setAttribute(`contenteditable`,`plaintext-only`),n.focus();let a=window.getSelection(),o=document.createRange();o.selectNodeContents(n),a?.removeAllRanges(),a?.addRange(o);let s=!1,c=e=>{if(s)return;s=!0,n.removeAttribute(`contenteditable`),n.removeEventListener(`blur`,l),n.removeEventListener(`keydown`,u);let a=(n.textContent??``).trim();e&&a&&a!==i.trim()?t(a):n.replaceChildren(...r)},l=()=>c(!0),u=e=>{e.key===`Enter`?(e.preventDefault(),n.blur()):e.key===`Escape`&&(e.preventDefault(),c(!1))};n.addEventListener(`blur`,l),n.addEventListener(`keydown`,u)}function Ki(e,t,n,r){Gi(e,e=>{let i=n();t>=i.length||(i[t]={...i[t],titel:e},r(i))})}var qi=220,Ji=new WeakMap;function Yi(e){let t=Ji.get(e);t!==void 0&&(clearTimeout(t),Ji.delete(e))}function Xi(e,t,n,r,i){t.stopPropagation();let a=t.currentTarget.getBoundingClientRect();Yi(e),Ji.set(e,setTimeout(()=>{Ji.delete(e),e.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:n,index:r,top:a.bottom+4,left:a.left,...i?{liste:i()}:{}},bubbles:!0,composed:!0}))},qi))}var Zi={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:ui,eintragsWahl:{key:`art`,label:`Darstellung`,optionen:ci,standard:W,felderKey:li},eintragsZuordnung:{key:`zuordnung`,label:`Status-Zuordnung`,nurBeiWahl:ti,wertLabel:`Datenwert`,nameLabel:`Klarname`,bedeutungLabel:`Bedeutung`,bedeutungen:Hn}},Qi=1,$i=/^-?\d{1,3}(\.\d{3})*(,\d+)?$|^-?\d+(,\d+)?$|^-?\d+(\.\d+)?$/,ea=/^(\d{1,2})\.(\d{1,2})\.(\d{2}|\d{4})$/,ta=/^(\d{4})-(\d{2})-(\d{2})$/;function na(e){let t=e.trim();if(t===``||!$i.test(t))return null;let n=t.includes(`,`)?t.replace(/\./g,``).replace(`,`,`.`):/^-?\d{1,3}(\.\d{3})+$/.test(t)?t.replace(/\./g,``):t,r=Number(n);return Number.isFinite(r)?r:null}function ra(e){let t=e.trim();if(t===``)return null;let n=ta.exec(t);if(n){let[,e,t,r]=n;return ia(Number(e),Number(t),Number(r))}let r=ea.exec(t);if(r){let[,e,t,n]=r,i=Number(n);return ia(n.length===2?i<=69?2e3+i:1900+i:i,Number(t),Number(e))}return null}function ia(e,t,n){if(t<1||t>12||n<1||n>31)return null;let r=new Date(e,t-1,n);return r.getFullYear()!==e||r.getMonth()!==t-1||r.getDate()!==n?null:r.getTime()}function aa(e){let t=0,n=0,r=0;for(let i of e)i.trim()!==``&&(t++,na(i)!==null&&n++,ra(i)!==null&&r++);return t===0?`text`:r===t?`datum`:n===t?`zahl`:`text`}var oa=new Intl.Collator(`de`,{numeric:!0,sensitivity:`base`});function sa(e,t,n){if(t<0||e.length===0)return e.map((e,t)=>t);let r=n=>e[n][t]??``,i=aa(e.map(e=>e[t]??``)),a=n?1:-1;return e.map((e,t)=>t).sort((e,t)=>{let n=r(e).trim(),o=r(t).trim();if(n===``&&o===``)return e-t;if(n===``)return Qi;if(o===``)return-1;let s=i===`zahl`?(na(n)??0)-(na(o)??0):i===`datum`?(ra(n)??0)-(ra(o)??0):oa.compare(n,o);return s===0?e-t:s*a})}function ca(e){let t=Bi(e.datenzeilen,e.suchtext);return e.sortSpalte<0?t:sa(t.map(t=>e.datenzeilen[t]),e.sortSpalte,e.sortAuf).map(e=>t[e])}function la(e){let t={gridTemplateColumns:e.spalten.map(e=>si(e.art).spur).join(` `)},n=oi(e.spalten),r=e.gemessen?.zeilenHoehe??n,i=e.hatQuelle,a=Hi(i,e.datenGeliefert,e.datenzeilen.length),o=ca(e),{seiten:s,seite:c,zeilen:l}=$r({sichtbar:o,hatQuelle:i,proSeite:e.gemessen?.passen??10,wunschSeite:e.wunschSeite,platzhalterZeilen:Yr(e.gemessen?.passen??null)});return{cols:t,takt:n,zeilenHoehe:r,hatQuelle:i,leer:a,gesamt:o.length,seiten:s,seite:c,zeilen:l,linealTakte:Qr(e.gemessen?.passen??null,l.length)}}var ua=[{attributeName:`suche`,name:`Suchzeile`,description:`Zeigt über der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,kind:`segment`,options:[{value:`ja`,label:`Ja`},{value:`nein`,label:`Nein`}],requiresDataSource:!0},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt die Tabelle nur Sätze des Tages, den der Tageswähler zeigt. Leer = alle Sätze.`,kind:`field`},Ti()];function da(e,t){return y`<div class="fusszeile">
    <div class="seiten-info">${Ui({hatQuelle:e.hatQuelle,sichtbar:e.sichtbar,gesamt:e.gesamt,suchtAktiv:e.suchtAktiv,auswahlAktiv:e.auswahlAktiv})}</div>
    <div class="seiten-nav">
  ...
  </div>`}var fa=`—`;function pa(e){return e.linealTakte===0?x:y`<div class="lineal" role="presentation" style=${Ci(e.linealTakte===null?e.cols:{...e.cols,flex:`0 1 auto`,height:`calc(var(--zeilen-hoehe) * ${e.linealTakte})`})}>
          ${e.spalten.map(()=>y`<div></div>`)}
        </div>`}function ma(e,t){return y`
      ...
      <div class="kopf" role="row" style=${Ci(e.cols)}>
        ${e.spalten.map((n,r)=>y`<div
            class=${si(n.art).klasse}
            role="columnheader"
            data-ff-editable
        ...
        ${e.zeilen.map((n,r)=>{let i=n!==null&&!e.imEditor;return y`<div
          ...
          >
            ${``}
            ${e.spalten.map((t,r)=>{let i=si(t.art),a=n===null?fa:e.datenzeilen[n]?.[r]??``,o=n===null?{}:e.zusatzzeilen[n]?.[r]??{};return y`<div class=${i.klasse} role="cell">${i.zelle(a,t.zuordnung??[],o)}</div>`})}
          </div>`})}
        ${pa(e)}`}
      </div>
    `}var ha=o`
...
`,ga=`ff-zeile-aktiviert`,_a=`data-ff-roh`;function va(e,t){e.dispatchEvent(new CustomEvent(ga,{detail:t,bubbles:!0,composed:!0}))}function ya(e){let t=e?.activeElement;if(!(t instanceof HTMLElement))return;let n=t.closest(`.zeile`);if(!n)return;let r=n.getAttribute(_a);return r===null||r===``?null:Number(r)}function ba(e,t){e&&((t===null?null:e.querySelector(`.zeile[data-ff-roh="${t}"]`))??e.querySelector(`.zeile[data-ff-roh]`)??e.querySelector(`.koerper`))?.focus()}var K=class e extends O{constructor(...e){super(...e),this.spalten=fi(),this.source=``,this.suche=`ja`,this.leerText=wi,this._suchtext=``,this.datenzeilen=[],this.zusatzzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this.datenGeliefert=!1,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._beobachter=null,this._taktGemessen=0,this._fokusZeile=null,this._fokusHolen=!1,this._besitz=`softengine`}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.listenBindung=Zi}static{this.defaultProps={width:`fill`,source:``,spalten:fi(),suche:`ja`,tagField:``,leerText:wi}}static{this.customProperties=ua}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get besitz(){return this._besitz}set besitz(e){e!==this._besitz&&(this._besitz=e,this.setzeAbgeleitetesZurueck(),this.isConnected&&(e===`provided`?Li(this):Ii(this)),this.requestUpdate())}set bereitgestellteZeilen(e){let t=Ai(e);this.rohzeilen=t.rohzeilen,this.datenzeilen=t.datenzeilen,this.zusatzzeilen=t.zusatzzeilen,this.datenGeliefert=!0,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._seite=0,this._mass=null,this._taktGemessen=0,this.requestUpdate()}setzeAbgeleitetesZurueck(){this.rohzeilen=[],this.datenzeilen=[],this.zusatzzeilen=[],this.datenGeliefert=!1,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._suchtext=``,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._taktGemessen=0,this._fokusZeile=null,this._fokusHolen=!1}fokussiereSuche(){let e=this.shadowRoot?.querySelector(`.suchzeile input`);return e?(e.focus(),!0):!1}get hatQuelle(){return this._besitz===`provided`||Vi(this.hasAttribute(`data-ff-editor`),this.source)}merkeZeilenFokus(){let e=ya(this.shadowRoot);this._fokusHolen=e!==void 0,this._fokusZeile=e??null}messeRumpf(){let e=this.zeilenHoehe;this._taktGemessen=e;let t=Oi(this,e);t?.passen===this._mass?.passen&&t?.zeilenHoehe===this._mass?.zeilenHoehe||(this._mass=t,this.requestUpdate())}spaltenListe(){return gi(this.spalten)}get zeilenHoehe(){return oi(this.spaltenListe())}aktiviereZeile(e,t){if(e===null||this.hasAttribute(`data-ff-editor`))return;let n=this.rohzeilen[e];n!==void 0&&(va(this,{rohzeile:n,rohIndex:e,ansichtIndex:t}),this.toggleAuswahl(n))}toggleAuswahl(e){let t=I(this);t!==``&&Mt(t,e)}setzeSuchtext(e){this.merkeZeilenFokus(),this._suchtext=e,this._seite=0,this.requestUpdate()}klickSortiere(e){this.editable||(this.merkeZeilenFokus(),this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.requestUpdate())}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}beobachte(){this._beobachter||(this._beobachter=ki(this,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}connectedCallback(){super.connectedCallback(),this._besitz===`softengine`&&Ii(this),this.beobachte()}firstUpdated(){this.beobachte()}updated(){this._taktGemessen!==this.zeilenHoehe&&this.messeRumpf(),this._fokusHolen&&(this._fokusHolen=!1,ba(this.shadowRoot,this._fokusZeile))}disconnectedCallback(){super.disconnectedCallback(),Yi(this),this._beobachter?.disconnect(),this._beobachter=null,Li(this)}static{this.styles=[O.styles,Wn,Di,ha]}render(){let t=this.spaltenListe(),n=e=>e.stopPropagation(),r=la({spalten:t,hatQuelle:this.hatQuelle,datenGeliefert:this.datenGeliefert,datenzeilen:this.datenzeilen,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,wunschSeite:this._seite,gemessen:this._mass});return y`<div class="tabelle" style=${Ci({"--takt":`${r.takt}px`,"--zeilen-hoehe":`${r.zeilenHoehe}px`})}>
      ${Wi(()=>this.spaltenListe(),e=>this.aendere(e),n)}
      ${ma({spalten:t,cols:r.cols,editable:this.editable,imEditor:this.hasAttribute(`data-ff-editor`),auswahlSemantik:I(this)!==``,zeigeSuche:this.suche===`ja`,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,zeilen:r.zeilen,linealTakte:r.linealTakte,datenzeilen:this.datenzeilen,zusatzzeilen:this.zusatzzeilen,hatQuelle:r.hatQuelle,auswahlIndex:this.auswahlIndex,leer:r.leer,leerText:this.leerText},{setzeSuchtext:e=>this.setzeSuchtext(e),dblklickKopf:(e,t)=>{this.editable&&(Yi(this),Ki(e,t,()=>this.spaltenListe(),e=>this.aendere(e)))},klickKopf:(t,n)=>{this.editable&&Xi(this,t,e.listenBindung.prop,n,()=>this.spaltenListe()),this.klickSortiere(n)},aktiviereZeile:(e,t)=>this.aktiviereZeile(e,t),stop:n})}
      ${``}
      ${r.leer?x:da({hatQuelle:r.hatQuelle,sichtbar:r.gesamt,gesamt:this.datenzeilen.length,suchtAktiv:this._suchtext.trim()!==``,auswahlAktiv:this.durchAuswahlGefiltert,seite:r.seite,seiten:r.seiten},{blaettere:e=>{this.merkeZeilenFokus(),this._seite=e,this.requestUpdate()},stop:n})}
    </div>`}};D([T({converter:{fromAttribute:e=>e?_i(e):fi(),toAttribute:e=>JSON.stringify(e)}})],K.prototype,`spalten`,void 0),D([T()],K.prototype,`source`,void 0),D([T()],K.prototype,`suche`,void 0),D([T()],K.prototype,`leerText`,void 0),D([T({attribute:!1})],K.prototype,`datenzeilen`,void 0),D([T({attribute:!1})],K.prototype,`zusatzzeilen`,void 0),D([T({attribute:!1})],K.prototype,`rohzeilen`,void 0),D([T({attribute:!1})],K.prototype,`auswahlIndex`,void 0),D([T({attribute:!1})],K.prototype,`durchAuswahlGefiltert`,void 0),D([T({attribute:!1})],K.prototype,`datenGeliefert`,void 0),O.defineAndRegister(K);function xa(e){return y`<div class="nachschlag">
    <input
      class="ctrl"
      type="text"
      .value=${e.wert}
  ...
  </div>`}var Sa={prop:`nachschlagSpalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:ui,quelleProp:`nachschlagQuelle`};function Ca(e){if(typeof e==`string`)try{e=JSON.parse(e)}catch{return[]}return Array.isArray(e)&&e.length>0?gi(e):[]}function wa(e,t){let n=e.trim();return n===``||n===t.trim()}function Ta(e,t,n){let r=t.trim(),i=[],a=wa(t,n),o=new Set;for(let t of e){let e=M(t,n).trim(),s=r===``?e:M(t,r).trim();if(!(s===``&&e===``)){if(a){if(o.has(e))continue;o.add(e)}i.push({anzeige:s,wert:e,satz:t})}}return i}function Ea(e,t,n,r){return Ta(Lt(e,t).rows,n,r)}function Da(e){if(e.quelleId===``||e.speicherFeld===``)return{ok:!1,grund:`unvollstaendig`};let t=j(H().FF_DATA_SOURCES,e.quelleId);if(!t)return{ok:!1,grund:`quelleFehlt`};let n=P(H().SEDATA,t.name,t.tableId);return{ok:!0,eintraege:Ea(e.el,n,e.anzeigeFeld,e.speicherFeld)}}function Oa(e,t){return t&&e.length===1?e[0]:null}function ka(e,t){let{rows:n,gefiltert:r}=Lt(e,[t]);return!r||n.length>0}function Aa(e,t,n){return e===``?t===``&&n===``?`nichts`:`leeren`:e===t?`nichts`:`zurueck`}var ja=null,Ma=null,Na=null;function Pa(e){return e.shadowRoot?.querySelector(`.lupe`)??null}function Fa(e=!0){let t=e?Na:null;Na=null,ja?.remove(),ja=null,Ma=null,t?.focus()}function Ia(e){Ma===e&&Fa(!1)}function La(e){let t={titel:e.speicherTitel===``?e.anzeigeTitel===``?`Wert`:e.anzeigeTitel:e.speicherTitel,feld:e.speicherFeld,art:W};return wa(e.anzeigeFeld,e.speicherFeld)?[t]:[{titel:e.anzeigeTitel===``?`Angezeigt`:e.anzeigeTitel,feld:e.anzeigeFeld,art:W},t]}function Ra(e,t){let n=document.createElement(K.tagName),r=wa(e.anzeigeFeld,e.speicherFeld),i=Ca([...e.spalten]);return n.besitz=`provided`,n.spalten=i.length>0?i:La(e),n.suche=`ja`,n.leerText=`Diese Quelle hat keine Sätze.`,n.bereitgestellteZeilen=t.map(e=>({rohzeile:e.satz,zellen:i.length>0?i.map(t=>t.feld===``?``:M(e.satz,t.feld)):r?[e.wert]:[e.anzeige,e.wert]})),n.toggleAttribute(`fuellt`,!0),n.style.setProperty(`--se-r-lg`,`0px`),n}function za(e){let t=Da(e);if(!t.ok){V(t.grund===`unvollstaendig`?`Nachschlagen braucht an diesem Feld eine Quelle und „Gespeichert wird".`:`Die Nachschlage-Quelle dieses Feldes ist in der Maske nicht vorhanden.`);return}let n=t.eintraege;Fa(!1);let r=document.createElement(zt);r.setAttribute(`data-ff-nachschlagen`,``),r.viewport=!0,r.escapeSchliesst=!0,r.ohneModal=!0,r.inhaltFest=!0,r.titel=e.titel===``?`Nachschlagen`:e.titel,r.breite=520,r.hoehe=380,r.addEventListener(Bt,()=>Fa()),r.addEventListener(`click`,e=>e.stopPropagation());let i=Ra(e,n);i.addEventListener(ga,t=>{let r=t.detail,i=n[r.rohIndex];i&&(Fa(),e.onUebernehmen(i.anzeige,i.wert,i.satz))}),r.appendChild(i),Na=Pa(e.el),document.body.appendChild(r),ja=r,Ma=e.el,Promise.all([r.updateComplete,i.updateComplete]).then(()=>{r.isConnected&&i.fokussiereSuche()})}function Ba(e){let t=e=>e.stopPropagation();return y`<ff-dialog-rahmen
    viewport
    escape-schliesst
    ohne-modal
    inhalt-fest
  ...
  >
    <ff-tabelle
      ...
      .spalten=${[...e.spalten]}
      .editable=${!0}
      @ff-prop-change=${t=>{t.stopPropagation();let n=t.detail;n?.attr===`spalten`&&e.onAendern(gi(n.value))}}
    ...
    ></ff-tabelle>
  </ff-dialog-rahmen>`}var q=class extends O{constructor(...e){super(...e),this.fieldType=`text`,this.placeholder=`Feldname`,this.options=``,this.source=``,this.value=``,this.valueField=``,this.nachschlagQuelle=``,this.anzeigeFeld=``,this.anzeigeTitel=``,this.speicherFeld=``,this.speicherTitel=``,this.nachschlagSpalten=[],this.einzigerTreffer=`nein`,this.spaltenDialog=!1,this.anzeige=``,this.getippt=null,this.satz=void 0,this.angehakt=!1,this.imSteuerelement=!1}static{this.blockType=`formfeld`}static{this.tagName=`ff-formfeld`}static{this.displayName=`Formularfeld`}static{this.category=`eingabe`}static{this.acceptsDataSource={wenn:{attributeName:`fieldType`,notEquals:`nachschlagen`}}}static{this.kannAuswahlFolgen=!0}static{this.satzWahl={quelleProp:`nachschlagQuelle`,wenn:{attributeName:`fieldType`,equals:`nachschlagen`}}}static{this.listenBindung=Sa}static{this.bindableSpots=[{prop:`value`,label:`Wert`,wenn:{attributeName:`fieldType`,keinesVon:[`checkbox`,`nachschlagen`]},vorschauProp:`placeholder`}]}static{this.actionValueSpots=[{prop:`value`,label:`Wert`}]}static{this.blockEvents=[{key:`onChange`,name:`Wert geändert`}]}static{this.defaultProps={width:240,fieldType:`text`,placeholder:`Feldname`,options:``,source:``,value:``,valueField:``,nachschlagQuelle:``,anzeigeFeld:``,anzeigeTitel:``,speicherFeld:``,speicherTitel:``,nachschlagSpalten:[],einzigerTreffer:`nein`}}static{this.raster={startW:6,startH:2,minW:2,minH:2}}static{this.customProperties=lr}static{this.styles=[O.styles,Ur]}onInput(e){let t=e.target;this.value=Gr(this.fieldType)===`date`?Fr(t.value):t.value}onChange(){this.dispatchEvent(new Event(`change`))}textTpl(e,t=!1){return y`<span
      class=${e}
      ?hidden=${t}
      data-ff-editable
    ...
    >${this.placeholder}</span>`}onTextClick(){this.hasAttribute(`data-ff-editor`)||this.setzeHaken(!this.angehakt)}setzeHaken(e){this.angehakt!==e&&(this.angehakt=e,this.dispatchEvent(new Event(`change`)))}controlTpl(e){switch(e){case`textarea`:return y`<textarea class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}></textarea>`;case`select`:{let e=this.options.split(`,`).map(e=>e.trim()).filter(e=>e!==``),t=this.value!==``&&!e.includes(this.value);return y`<select class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}>
        ...
        </select>`}case`nachschlagen`:return xa({wert:this.getippt??this.anzeige,onTippen:e=>{this.getippt=e},onVerlassen:()=>this.onNachschlagVerlassen(),onLupe:()=>this.onLupe()});default:return y`<input
          class="ctrl"
          type=${e}
          .value=${e===`date`?Pr(this.value):this.value}
          @input=${this.onInput}
          @change=${this.onChange}
          @focus=${()=>{this.imSteuerelement=!0}}
          @blur=${()=>{this.imSteuerelement=!1}}
        />`}}onLupe(){if(this.hasAttribute(`data-ff-editor`)){this.spaltenDialog=!0;return}za({el:this,quelleId:this.nachschlagQuelle,anzeigeFeld:this.anzeigeFeld,speicherFeld:this.speicherFeld,anzeigeTitel:this.anzeigeTitel,speicherTitel:this.speicherTitel,spalten:this.nachschlagSpalten,titel:this.placeholder,onUebernehmen:(e,t,n)=>{this.uebernimmSatz(e,t,n),this.dispatchEvent(new Event(`change`))}})}spaltenEffektiv(){let e=Ca(this.nachschlagSpalten);return e.length>0?e:La({anzeigeFeld:this.anzeigeFeld,speicherFeld:this.speicherFeld,anzeigeTitel:this.anzeigeTitel,speicherTitel:this.speicherTitel})}spaltenDialogTpl(){return Ba({titel:this.placeholder,spalten:this.spaltenEffektiv(),onAendern:e=>{this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`nachschlagSpalten`,value:e},bubbles:!0,composed:!0}))},onFeldWahl:e=>{this.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:`nachschlagSpalten`,...e},bubbles:!0,composed:!0}))},onSchliessen:()=>{this.spaltenDialog=!1}})}willUpdate(e){super.willUpdate(e),e.has(`fieldType`)&&Gr(this.fieldType)!==`nachschlagen`&&(this.spaltenDialog=!1)}leereNachschlagen(){this.satz=void 0,this.anzeige=``,this.value=``,Pt(I(this))}uebernimmSatz(e,t,n){this.anzeige=e===``?t:e,this.value=t,this.satz=n,Nt(I(this),n)}onNachschlagVerlassen(){if(this.hasAttribute(`data-ff-editor`))return;let e=Aa(this.getippt??this.anzeige,this.anzeige,this.value);this.getippt=null,e===`leeren`&&(this.leereNachschlagen(),this.dispatchEvent(new Event(`change`)))}pruefeEigenenWert(){Gr(this.fieldType)===`nachschlagen`&&(this.satz!==void 0&&!ka(this,this.satz)&&this.leereNachschlagen(),this.uebernimmEinzigenTreffer())}uebernimmEinzigenTreffer(){if(this.einzigerTreffer!==`ja`)return;let e=Da({el:this,quelleId:this.nachschlagQuelle,anzeigeFeld:this.anzeigeFeld,speicherFeld:this.speicherFeld});if(!e.ok)return;let t=Oa(e.eintraege,this.satz===void 0);t&&this.uebernimmSatz(t.anzeige,t.wert,t.satz)}render(){let e=Gr(this.fieldType);if(e===`checkbox`)return y`<div class="feld">
        <div class="zeile">
          <input
            class="ctrl"
            type="checkbox"
      ...
      >
        ${this.controlTpl(e)}
        ${Kr.includes(e)?this.textTpl(`ph ${qr[e]??``}`.trim(),!n):x}
      </div>
      ${this.spaltenDialog&&this.hasAttribute(`data-ff-editor`)?this.spaltenDialogTpl():x}
    </div>`}connectedCallback(){super.connectedCallback(),Vr(this)}disconnectedCallback(){super.disconnectedCallback(),Hr(this),Ia(this)}};D([T()],q.prototype,`fieldType`,void 0),D([T()],q.prototype,`placeholder`,void 0),D([T()],q.prototype,`options`,void 0),D([T()],q.prototype,`source`,void 0),D([T()],q.prototype,`value`,void 0),D([T()],q.prototype,`valueField`,void 0),D([T()],q.prototype,`nachschlagQuelle`,void 0),D([T()],q.prototype,`anzeigeFeld`,void 0),D([T()],q.prototype,`anzeigeTitel`,void 0),D([T()],q.prototype,`speicherFeld`,void 0),D([T()],q.prototype,`speicherTitel`,void 0),D([T({converter:{fromAttribute:e=>Ca(e??``),toAttribute:e=>JSON.stringify(e)}})],q.prototype,`nachschlagSpalten`,void 0),D([T()],q.prototype,`einzigerTreffer`,void 0),D([E()],q.prototype,`spaltenDialog`,void 0),D([E()],q.prototype,`anzeige`,void 0),D([E()],q.prototype,`getippt`,void 0),D([E()],q.prototype,`angehakt`,void 0),D([E()],q.prototype,`imSteuerelement`,void 0),O.defineAndRegister(q);function Va(e,t,n,r){return{attributeName:e,name:t,description:n,kind:`select`,options:[{value:`nein`,label:`Nein`},{value:`ja`,label:`Ja`}],...r}}var Ha=o`
  ::slotted(:not([hat-reiter])) { margin-top: 24px; }
  slot { display: contents; }
`,Ua=`frei · hierher ziehen`,Wa=`ff-zimmer-inhalt`,J=class extends O{constructor(...e){super(...e),this.heading=`Neues Zimmer`,this.leerHinweis=``}static{this.blockType=`kanban-zimmer`}static{this.tagName=`ff-kanban-zimmer`}static{this.displayName=`Kanban-Zimmer`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[U.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban-spalte`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={heading:`Neues Zimmer`}}static{this.styles=[O.styles,Di,Ha,o`
      :host { display: block; }
    ...
    `]}onSlotChange(){this.dispatchEvent(new CustomEvent(Wa,{bubbles:!0,composed:!0}))}render(){return y`<div class="zimmer">
      <div
        class="kopf"
        data-ff-editable
    ...
    `]}constructor(){super(),this.variant=`info`,this.heading=`Neue Spalte`,this.leerHinweis=``,this._count=0,this.addEventListener(Wa,()=>this.zaehle())}zaehle(){this._count=Array.from(this.querySelectorAll(U.tagName)).filter(e=>!e.hasAttribute(`data-ff-editor-helper`)).length}render(){return y`<div class="col v-${Vn(this.variant)}">
      <div class="head">
        <span class="dot"></span>
        <span
          class="title"
    ...
    </div>`}};D([T()],Y.prototype,`variant`,void 0),D([T()],Y.prototype,`heading`,void 0),D([T({attribute:!1})],Y.prototype,`leerHinweis`,void 0),D([E()],Y.prototype,`_count`,void 0),O.defineAndRegister(Y);function Ga(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function Ka(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var qa=new WeakMap,Ja=Y.tagName,Ya=J.tagName,Xa=U.tagName;function Za(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Ja)}function Qa(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Xa)}function $a(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Ya)}function eo(e){return[e,...$a(e)]}function to(e,t){let n=e.getAttribute(`leertext`)??`Keine Datensätze.`,r=(e,t)=>{e.leerHinweis=t};for(let e of t){let t=$a(e);for(let e of t)r(e,Qa(e).length===0?Ua:``);r(e,t.length===0&&Qa(e).length===0?n:``)}}function no(e){return qe().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function ro(e,t){let n=$a(e);if(n.length===0)return null;let r=e.getAttribute(`zimmerfield`)??``;if(r===``)return n[0];let i=n.map(e=>e.getAttribute(`heading`)??J.defaultProps.heading),a=Ga(M(t,r),i);return a>=0?n[a]:n[0]}function io(e){Z?.board===e&&uo();let t=e.getAttribute(`source`)??``,n=e.getAttribute(`statusfield`)??``;if(t===``)return;let r=j(H().FF_DATA_SOURCES,t);if(!r)return;let i=Za(e);if(i.length===0)return;let a=qa.get(e);if(!a){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(Xa);t&&(a=t.cloneNode(!0),qa.set(e,a))}if(!a)return;let o=ji(P(H().SEDATA,r.name,r.tableId),e.getAttribute(`tagfield`)??``,ir()),s=i.map(e=>e.getAttribute(`heading`)??Y.defaultProps.heading),c=no(a.tagName),l=Ka(i.map(e=>e.getAttribute(`auffang`))),u=Ar(e);for(let e of i)for(let t of eo(e))Qa(t).forEach(e=>e.remove());for(let e of o){let t=a.cloneNode(!0),o=n===``?-1:Ga(M(e,n),s),d=o>=0?i[o]:l>=0?i[l]:i[0];(ro(d,e)??d).appendChild(t);for(let n of c){let r=t.getAttribute(ur(n.prop))??``;r!==``&&(t[n.prop]=u(e,r))}let ee=r.indexField===``?``:M(e,r.indexField);X.set(t,{row:e,pindex:ee}),t.draggable=!0}to(e,i);let d=i.flatMap(e=>eo(e).flatMap(Qa)),ee=jt(I(e),d,e=>X.get(e)?.row);for(let e of ee)d[e].setAttribute(`data-ff-auswahl`,``)}var X=new WeakMap,Z=null,ao=new WeakSet,oo=`data-ff-zieht`,so=`data-ff-ziel`,co=null;function lo(e){co!==e&&(co?.removeAttribute(so),co=e,co?.setAttribute(so,``))}function uo(){Z?.card.removeAttribute(oo),Z=null,lo(null)}function fo(e,t,n){for(let r of t.composedPath())if(r instanceof HTMLElement&&r.tagName.toLowerCase()===n&&e.contains(r))return r;return null}function po(e,t){return fo(e,t,Ja)}function mo(e,t,n){if(!Z||Z.board!==e)return;let r=X.get(Z.card);if(!r)return;let i=t.getAttribute(`heading`)??``,a=n?.getAttribute(`heading`)??``;In(e,`onCardDrop`,{PINDEX:r.pindex,VALUE:i,ZIMMER:a}).catch(Fn)}function ho(e){ao.has(e)||(ao.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;if(!n)return;let r=X.get(n);r&&Mt(I(e),r.row),In(e,`onCardClick`,{PINDEX:r?.pindex??``}).catch(Fn)}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;n&&(Z={card:n,board:e},t.dataTransfer?.setData(`text/plain`,X.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`),setTimeout(()=>{Z?.card===n&&n.setAttribute(oo,``)},0))}),e.addEventListener(`dragend`,uo),e.addEventListener(`dragover`,t=>{let n=po(e,t);if(Z?.board!==e||!n){lo(null);return}t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`),lo(fo(e,t,Ya)??n)}),e.addEventListener(`dragleave`,t=>{let n=t.relatedTarget;(!(n instanceof Node)||!e.contains(n))&&lo(null)}),e.addEventListener(`drop`,t=>{let n=po(e,t);n&&(t.preventDefault(),mo(e,n,fo(e,t,Ya)),uo())}))}var go=Tr({hydriere:io,verdrahte:ho}),_o=go.connect,vo=go.disconnect,yo=Y.blockType,bo=class extends O{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[yo]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:yo}}static{this.templateChild={type:U.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``,tagField:``,leerText:wi}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Optional: Feld der Datenquelle, dessen Inhalt bestimmt, in welche Spalte ein Eintrag kommt. Leer = alle Einträge in der Auffang-Spalte.`,kind:`field`},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt das Board nur Einträge des Tages, den der Tageswähler zeigt. Leer = alle Einträge.`,kind:`field`},Ti()]}static{this.defaultChildren=[{type:yo,props:{heading:`Offen`,variant:`warning`},children:[{type:U.blockType}]},{type:yo,props:{heading:`In Arbeit`,variant:`info`}},{type:yo,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[O.styles,o`
    ...
    `]}render(){return y`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),_o(this)}disconnectedCallback(){super.disconnectedCallback(),vo(this)}};O.defineAndRegister(bo);var xo={breite:56,breiteOffen:224},So=`ff-seiten-wechsel`,Co=[{wert:`sonne`,name:`Sonnengelb`},{wert:`salbei`,name:`Salbeigrün`},{wert:`himmel`,name:`Himmelblau`},{wert:`flieder`,name:`Flieder`},{wert:`koralle`,name:`Koralle`}],Q=class extends O{static{this.blockType=`navi-eintrag`}static{this.tagName=`ff-navi-eintrag`}static{this.displayName=`Navi-Eintrag`}static{this.category=`layout`}static{this.acceptsChildren=!1}static{this.showInPalette=!1}static{this.allowedParentTypes=[`navi`]}static{this.resizableWidth=!1}static{this.defaultProps={seite:``,seitename:``,ton:`sonne`}}static{this.customProperties=[{attributeName:`seite`,name:`Seite`,description:`Welche Seite dieser Maske der Eintrag zeigt.`,kind:`seite`,klarnameProp:`seitename`,nurImEditor:!0},{attributeName:`ton`,name:`Farbe`,description:`Farbe des Zeichens vor dem Namen.`,kind:`select`,options:Co.map(e=>({value:e.wert,label:e.name}))}]}static{this.styles=[O.styles,o`
      :host {
        --ton: var(--se-amber);
        display: flex;
        align-items: center;
    ...
    `]}constructor(){super(),this.seite=``,this.seitename=``,this.ton=`sonne`,this.addEventListener(`click`,()=>this.melde())}melde(){let e={ansicht:this.seitename};this.dispatchEvent(new CustomEvent(So,{detail:e,bubbles:!0,composed:!0}))}render(){return y`<span class="zeichen"></span>
      <span class="name">${this.seitename===``?`—`:this.seitename}</span>`}};D([T()],Q.prototype,`seite`,void 0),D([T()],Q.prototype,`seitename`,void 0),D([T({reflect:!0})],Q.prototype,`ton`,void 0),O.defineAndRegister(Q);var wo=`aktiv`;function To(e){return Array.from(e.querySelectorAll(Q.tagName))}function Eo(e,t){let n=To(e),r=t??n.find(e=>e.hasAttribute(wo))??n[0];for(let e of n)e===r?e.setAttribute(wo,``):e.removeAttribute(wo)}function Do(e){let t=e.hasAttribute(`offen`);for(let n of To(e))n.toggleAttribute(`breit`,t)}function Oo(e){return e.getAttribute(`name`)??String(at.defaultProps.name)}function ko(e,t){let n=e;for(;n&&n.parentElement!==t;)n=n.parentElement;return n}function Ao(e,t){let n=e.ownerDocument,r=Array.from(n.querySelectorAll(at.tagName)),i=r[0]?.parentElement??null;if(!i)return;let a=ko(e,i);if(!a)return;let o=r.find(e=>Oo(e)===t)??null;for(let e of Array.from(i.children))e!==a&&((r.includes(e)?e===o:o===null)?e.removeAttribute(`hidden`):e.setAttribute(`hidden`,``))}var jo=new WeakMap,Mo=new WeakSet;function No(e){let t=t=>{let n=t.detail;n&&(Eo(e,t.target instanceof Element?t.target:void 0),e.removeAttribute(`offen`),Do(e),!e.hasAttribute(`data-ff-editor`)&&Ao(e,n.ansicht))};e.addEventListener(So,t),jo.set(e,t)}function Po(e){let t=jo.get(e);t&&(e.removeEventListener(So,t),jo.delete(e))}function Fo(e){if(Eo(e),Do(e),e.hasAttribute(`data-ff-editor`)||Mo.has(e))return;let t=To(e)[0];if(!t)return;Mo.add(e);let n=()=>Ao(e,t.seitename);e.ownerDocument.readyState===`loading`?e.ownerDocument.addEventListener(`DOMContentLoaded`,n,{once:!0}):queueMicrotask(n)}var Io=Q.blockType,Lo=class extends O{static{this.blockType=`navi`}static{this.tagName=`ff-navi`}static{this.displayName=`Navi`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[Io]}static{this.addChildButton={label:`Eintrag`,childType:Io}}static{this.containerHint=!1}static{this.defaultProps={}}static{this.customProperties=[]}static{this.maskenRand=!0}static{this.allowedParentTypes=[it]}static{this.raster={startW:5,startH:24,minW:3,minH:3}}static{this.styles=[O.styles,o`
      :host {
        height: 100%;
        width: ${xo.breite}px;
        transition: width var(--se-move);
      }
      :host([offen]) { width: ${xo.breiteOffen}px; }
      .leiste {
        box-sizing: border-box;
        height: 100%;
        width: 100%;
    ...
    `]}connectedCallback(){super.connectedCallback(),No(this)}disconnectedCallback(){super.disconnectedCallback(),Po(this)}klappen(){this.toggleAttribute(`offen`),Do(this)}render(){return y`<div class="leiste">
        <div class="kopf">
          <button
            class="schalter"
            type="button"
        ...
        <div class="eintraege">
          <slot @slotchange=${()=>Fo(this)}></slot>
        </div>
      </div>`}};O.defineAndRegister(Lo);var Ro=ur(`text`);function zo(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(Ro)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function Bo(e){let t=jr(e,Ro);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function Vo(e){zo(e)&&(e.text=``)}var Ho=Tr({hydriere:Bo,verdrahte:Vo}),Uo=Ho.connect,Wo=Ho.disconnect,Go=6,Ko=96,qo=14,Jo={duenn:`300`,normal:`400`,fett:`700`},Yo={links:`left`,mitte:`center`,rechts:`right`},Xo={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},Zo=`standard`;function Qo(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(Ko,Math.max(Go,t)):qo}function $o(e){return typeof e==`string`&&e in Jo?e:`normal`}function es(e){return typeof e==`string`&&e in Yo?e:`links`}function ts(e){return typeof e==`string`&&e in Xo?e:Zo}var $=class extends O{constructor(...e){super(...e),this.groesse=qo,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=Zo,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:qo,gewicht:`normal`,ausrichtung:`links`,farbe:Zo,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:Go,max:Ko,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[O.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return y`<div
      class="text"
      style=${Ci({fontSize:`${Qo(this.groesse)}px`,fontWeight:Jo[$o(this.gewicht)],textAlign:Yo[es(this.ausrichtung)],color:Xo[ts(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),Uo(this)}disconnectedCallback(){super.disconnectedCallback(),Wo(this)}};D([T({type:Number})],$.prototype,`groesse`,void 0),D([T()],$.prototype,`gewicht`,void 0),D([T()],$.prototype,`ausrichtung`,void 0),D([T()],$.prototype,`farbe`,void 0),D([T()],$.prototype,`text`,void 0),D([T()],$.prototype,`source`,void 0),D([T()],$.prototype,`textField`,void 0),O.defineAndRegister($);var ns=[`waagerecht`,`senkrecht`],rs=`waagerecht`;function is(e){return ns.includes(e)?e:rs}var as=class extends O{constructor(...e){super(...e),this.richtung=rs}static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`,richtung:rs}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1,varianten:[{wenn:{attributeName:`richtung`,equals:`senkrecht`},startW:1,startH:6,breiteZiehbar:!1}]}}static{this.customProperties=[{attributeName:`richtung`,name:`Richtung`,description:`Waagerecht trennt oben von unten, senkrecht links von rechts.`,kind:`select`,options:[{value:`waagerecht`,label:`Waagerecht`},{value:`senkrecht`,label:`Senkrecht`}]}]}static{this.styles=[O.styles,o`
    ...
    `]}render(){return y`<div class="flaeche ${is(this.richtung)}"><div class="linie"></div></div>`}};D([T()],as.prototype,`richtung`,void 0),O.defineAndRegister(as),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;V(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();
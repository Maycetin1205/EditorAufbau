...
`)+(bt===``?``:`\n\nERSTES PAKET\n${bt}`))}function R(e,t){L.set(e,t),Ct()}function wt(){let e=P();L.set(`basisHTML_REGISTER`,typeof e.basisHTML_REGISTER==`function`?`vorhanden`:`fehlt`),L.set(`basisHTML_SND_MSG`,typeof e.basisHTML_SND_MSG==`function`?`vorhanden`:`fehlt`),L.set(`body.pid`,document.body?.getAttribute(`pid`)?`gesetzt`:`fehlt`),L.set(`body.REGMSG`,document.body?.getAttribute(`REGMSG`)?`gesetzt`:`fehlt`),L.set(`Empfangene Pakete`,String(xt)),L.set(`SEDATA.Daten`,F()?`vorhanden`:`fehlt`),Ct()}function Tt(e){if(bt===``)try{bt=typeof e==`string`?e:JSON.stringify(e)??``,Ct()}catch{}}function Et(e){xt+=1,Tt(e),R(`Empfangene Pakete`,String(xt));let t=dt(e);if(!t){R(`Letztes Paket`,`Antwort ohne Daten`),yt(e);return}let n=P();j(n.SEDATA)||(n.SEDATA={}),n.SEDATA.Daten=t,R(`Letztes Paket`,`Daten-Push angenommen`),R(`SEDATA.Daten`,`vorhanden`),mt(),I()}function Dt(e=0){let t=P();if(typeof t.basisHTML_REGISTER==`function`){wt();try{t.basisHTML_SetConsoleLog?.(!0,!0)}catch{}try{t.basisHTML_REGISTER(e=>{Et(e)},document.title,`1.0`),R(`Registrierung`,`ausgeführt`)}catch(e){R(`Registrierung`,`Fehler: ${e instanceof Error?e.message:String(e)}`)}return}e<400?(e===0&&R(`Registrierung`,`wartet auf Interface`),setTimeout(()=>{Dt(e+1)},25)):(wt(),R(`Registrierung`,`nach 10s kein Interface`))}var Ot=!1;function z(){if(Ot)return;Ot=!0,R(`Runtime`,`gestartet`),R(`Registrierung`,`noch nicht ausgeführt`),wt(),pt();let e=P();e.Erstellen=()=>{mt(),I()},e.initData=e.Erstellen,e.ReloadData=()=>{I()},Dt(),window.addEventListener(`message`,e=>{if(typeof P().basisHTML_REGISTER==`function`)return;let t=ft(e.data);t!==void 0&&Et(t)},!0),document.addEventListener(`keydown`,e=>{if(e.ctrlKey&&e.altKey&&e.key.toLowerCase()===`d`){wt();let e=document.getElementById(`ff-se-diagnose`);e&&(e.style.display=e.style.display===`none`?`block`:`none`)}});let t=0,n=setInterval(()=>{t+=1,F()?(clearInterval(n),R(`SEDATA.Daten`,`vorhanden`),mt(),I()):t>100&&(clearInterval(n),R(`Daten-Wartezeit`,`nach 30s ohne Daten`))},300)}function kt(e,t){if(!(!Array.isArray(e)||t===``)){for(let n of e)if(!(!j(n)||n.id!==t)&&!(typeof n.verb!=`string`||!Ye.includes(n.verb))&&!(typeof n.nr!=`string`||n.nr===``)&&!(!Array.isArray(n.params)||n.params.some(e=>typeof e!=`string`)))return{id:t,verb:n.verb,nr:n.nr,params:n.params}}}var At=[`RESULT`,`result`,`PINDEX`,`pindex`,`INDEX`,`index`,`0_10`,`KEY`,`key`,`ID`,`id`,`VALUE`,`value`];function jt(e){if(typeof e!=`string`)return e;try{return JSON.parse(e)}catch{return}}function Mt(e){if(typeof e==`string`)return e.trim()===``?void 0:e.trim();if(typeof e==`number`||typeof e==`boolean`)return String(e)}function B(e,t){if(t>12)return;let n=Mt(e);if(n!==void 0)return n;if(Array.isArray(e)){for(let n of e){let e=B(n,t+1);if(e!==void 0)return e}return}if(j(e)){for(let n of At){if(!(n in e))continue;let r=B(e[n],t+1);if(r!==void 0)return r}for(let n of Object.values(e)){let e=B(n,t+1);if(e!==void 0)return e}}}function V(e){let t=jt(e);if(j(t)){for(let e of At){if(!(e in t))continue;let n=B(t[e],0);if(n!==void 0)return n}for(let e of Object.values(t))if(Array.isArray(e))for(let t of e){let e=V(t);if(e!==void 0)return e}else if(j(e)){let t=V(e);if(t!==void 0)return t}}}function Nt(e){return j(e)?Object.keys(e).filter(e=>/^Message\d+$/.test(e)):[]}function Pt(e,t){if(!j(e))return;let n=Nt(e).filter(e=>!t.has(e)).sort((e,t)=>Number(t.slice(7))-Number(e.slice(7)));for(let t of n){let n=V(e[t]);if(n!==void 0)return n}}var Ft=[],It=!1,Lt=6e3,Rt=100;function zt(){if(It||Ft.length===0)return;It=!0;let e=Ft.shift(),t=P(),n=new Set(Nt(t.SEDATA)),r=!1,i=t=>{r||(r=!0,a(),clearInterval(o),clearTimeout(s),It=!1,e.resolve(t),zt())},a=vt(e=>{let t=V(e);t!==void 0&&i(t)}),o=setInterval(()=>{let e=Pt(P().SEDATA,n);e!==void 0&&i(e)},Rt),s=setTimeout(()=>{i(``)},Lt);if(typeof t.basisHTML_SND_MSG!=`function`){i(``);return}try{t.basisHTML_SND_MSG(`GET_RELATION`,{NR:e.template.nr,PARAMS:e.params})}catch{i(``)}}function Bt(e,t){z();let n=P();if(e.verb!==`GET_RELATION`){if(typeof n.basisHTML_SND_MSG==`function`)try{n.basisHTML_SND_MSG(e.verb,{NR:e.nr,PARAMS:[...t]})}catch{}return Promise.resolve(``)}return new Promise(n=>{Ft.push({template:e,params:[...t],resolve:n}),zt()})}function Vt(e,t){if(!j(t))return``;let n=t.document;if(!n||typeof n.querySelectorAll!=`function`)return``;let r=Array.from(n.querySelectorAll(`[${Qe}]`)).find(t=>t.getAttribute(Qe)===e.blockId);if(!r)return``;let i=r[e.value];return i==null?``:String(i)}function Ht(e,t,n=P()){if(e.source===`fixed`)return e.value;if(e.source===`context`)return t.context[e.value]??``;if(e.source===`previous_result`)return t.previousResult;if(e.source===`step_result`){let n=Number(e.value);return Number.isInteger(n)&&n>=0?t.stepResults?.[n]??``:``}if(e.source===`block_value`)return Vt(e,n);if(!j(n))return``;if(e.source===`se_variable`){let t=n.SEDATA;if(!j(t)||!j(t.Daten)||!j(t.Daten.VARArrays))return``;let r=t.Daten.VARArrays[e.value];return r==null?``:String(r)}let r=ot(n.FF_DATA_SOURCES,e.dataSourceId??``);if(!r)return``;let i=ut(n.SEDATA,r.name,r.tableId),a=t.context.PINDEX??``,o=a!==``&&r.indexField!==``?i.find(e=>M(e,r.indexField)===a):i[0];return o?M(o,e.value):``}function Ut(e,t){let n=`0,START_TOOL,`+e;return t.length>0&&(n+=`,`+t.map(e=>encodeURIComponent(e)).join(`,`)),n}function Wt(e,t){if(e.trim()===``)return;let n=P();try{if(typeof n.sendBWLinkIntern==`function`){n.sendBWLinkIntern(Ut(e,t));return}}catch{}try{if(typeof n.basisHTML_SND_MSG==`function`){let r={NR:e};t.length>0&&(r.PARAMS=[...t]),n.basisHTML_SND_MSG(`START_TOOL`,r)}}catch{}}function Gt(e,t,n){if(t.trim()!==``)for(let r of Array.from(e.querySelectorAll(A.tagName)))(r.getAttribute(`name`)??``)===t&&(n?r.setAttribute(`offen`,``):r.removeAttribute(`offen`))}var Kt=new WeakMap;async function H(e,t,n){if(e.hasAttribute(`data-ff-editor`))return;let r=rt(e.getAttribute(`data-ff-aktionen`))[t];if(!r||r.length===0)return;let i=Kt.get(e);if(i||(i=new Set,Kt.set(e,i)),!i.has(t)){i.add(t);try{let t={...n,NOW_DATE:Xe(new Date)},i=``,a=[];for(let n of r){if(n.type===`START_TOOL`){Wt(n.toolNr,Ze({params:n.toolParams},t)),a.push(``);continue}if(n.type===`POPUP_OPEN`||n.type===`POPUP_CLOSE`){Gt(e.ownerDocument??document,n.popup??``,n.type===`POPUP_OPEN`),a.push(``);continue}let r=kt(P().FF_RELATIONS,n.relationId);if(!r){a.push(``);continue}let o={context:t,previousResult:i,stepResults:a},s=await Bt(r,[...n.params,...n.extraParams].map(e=>Ht(e,o)));a.push(s),r.verb===`GET_RELATION`&&(i=s),n.resultKey!==``&&(t[n.resultKey]=s)}}finally{i.delete(t)}}}var qt=new WeakSet;function Jt(e,t){if(e.hasAttribute(`data-ff-editor`)||!e.hasAttribute(`data-ff-aktionen`)||qt.has(e))return;qt.add(e);let n=rt(e.getAttribute(`data-ff-aktionen`));Object.values(n).some(e=>e.some(e=>e.type===`RELATION`))&&z(),e.addEventListener(`click`,()=>{H(e,t,{})})}var Yt=class extends k{constructor(...e){super(...e),this.label=`Klick mich`}static{this.blockType=`button`}static{this.tagName=`ff-button`}static{this.displayName=`Schaltfläche`}static{this.category=`eingabe`}static{this.defaultProps={label:`Klick mich`}}static{this.resizableWidth=!1}static{this.blockEvents=[{key:`onClick`,name:`Klick`}]}static{this.raster={startW:4,startH:2,minW:2,minH:2}}static{this.customProperties=[]}static{this.styles=[k.styles,o`
      button {
        box-sizing: border-box;
        padding: 7px 16px;
        cursor: pointer;
...
`,en={dog:x`<ellipse cx="12" cy="13.5" rx="6.3" ry="7"></ellipse><ellipse cx="5.2" cy="11.5" rx="2.4" ry="5.2" transform="rotate(14 5.2 11.5)"></ellipse><ellipse cx="18.8" cy="11.5" rx="2.4" ry="5.2" transform="rotate(-14 18.8 11.5)"></ellipse>`,cat:x`<path d="M5.2 10.5 L3.6 3.2 L10 6.4 Z"></path><path d="M18.8 10.5 L20.4 3.2 L14 6.4 Z"></path><circle cx="12" cy="13.5" r="7"></circle>`,rabbit:x`<ellipse cx="8.8" cy="6.5" rx="2.3" ry="5.6" transform="rotate(-10 8.8 6.5)"></ellipse><ellipse cx="15.2" cy="6.5" rx="2.3" ry="5.6" transform="rotate(10 15.2 6.5)"></ellipse><circle cx="12" cy="16" r="6.2"></circle>`,hamster:x`<circle cx="7.6" cy="8.8" r="2"></circle><ellipse cx="12" cy="14" rx="8.3" ry="6"></ellipse>`,bird:x`<circle cx="9.2" cy="8.8" r="4.6"></circle><ellipse cx="12.5" cy="14.8" rx="5.2" ry="5.4"></ellipse><path d="M5.2 7.6 L2 9.2 L5.4 10.6 Z"></path><path d="M15.5 16.5 L22 20.5 L17.6 13.8 Z"></path>`,reptile:x`<path d="M4.5 14.8 Q4.5 7.2 12 7.2 Q19.5 7.2 19.5 14.8 Z"></path><circle cx="20.6" cy="13.9" r="2.1"></circle><rect x="6.2" y="14.6" width="2.6" height="3" rx="1.2"></rect><rect x="13.4" y="14.6" width="2.6" height="3" rx="1.2"></rect>`,paw:x`<circle cx="6.8" cy="9.6" r="1.9"></circle><circle cx="10.4" cy="7.2" r="1.9"></circle><circle cx="14.6" cy="7.2" r="1.9"></circle><circle cx="18.2" cy="9.6" r="1.9"></circle><path d="M12.5 11.2c-2.9 0-5.3 2.1-5.3 4.4 0 1.7 1.3 2.9 3.1 2.9.9 0 1.5-.3 2.2-.3s1.3.3 2.2.3c1.8 0 3.1-1.2 3.1-2.9 0-2.3-2.4-4.4-5.3-4.4z"></path>`},tn=[[`welpe`,`dog`],[`hund`,`dog`],[`kater`,`cat`],[`katze`,`cat`],[`kaninchen`,`rabbit`],[`hase`,`rabbit`],[`meerschweinchen`,`hamster`],[`hamster`,`hamster`],[`ratte`,`hamster`],[`maus`,`hamster`],[`wellensittich`,`bird`],[`sittich`,`bird`],[`papagei`,`bird`],[`vogel`,`bird`],[`schildkr`,`reptile`],[`echse`,`reptile`],[`schlange`,`reptile`],[`gecko`,`reptile`],[`reptil`,`reptile`]];function nn(e){let t=e.toLowerCase(),n=`paw`;for(let[e,r]of tn)if(t.includes(e)){n=r;break}return b`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">${en[n]}</svg>`}var U=class extends k{constructor(...e){super(...e),this.chipVariant=`info`,this.heading=``,this.heading2=``,this.time=``,this.date=``,this.avatar=``,this.meta=``,this.text=``,this.chipText=``,this.headingField=``,this.heading2Field=``,this.timeField=``,this.dateField=``,this.avatarField=``,this.metaField=``,this.textField=``,this.chipTextField=``}static{this.blockType=`card`}static{this.tagName=`ff-card`}static{this.displayName=`Karte`}static{this.category=`anzeige`}static{this.allowedParentTypes=[`kanban-spalte`]}static{this.showInPalette=!1}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={chipVariant:`info`,heading:``,heading2:``,time:``,date:``,avatar:``,meta:``,text:``,chipText:``,headingField:``,heading2Field:``,timeField:``,dateField:``,avatarField:``,metaField:``,textField:``,chipTextField:``}}static{this.bindableSpots=[{prop:`time`,label:`Zeit`},{prop:`date`,label:`Datum`},{prop:`avatar`,label:`Avatar`},{prop:`heading`,label:`Titel`},{prop:`heading2`,label:`Titel 2`},{prop:`meta`,label:`Unterzeile`},{prop:`text`,label:`Textzeile`},{prop:`chipText`,label:`Chip`}]}static{this.customProperties=[Qt(`chipVariant`,`Bedeutung des Chips auf der Karte — bestimmt die Chip-Farbe.`)]}static{this.styles=[k.styles,$t,o`
    ...
    `]}render(){let e=this.valueField===``?bn(this.zeigt,new Date):{haupt:this.value};return b`<div class="vuhr">
      <span
        class="haupt"
        data-ff-spot="value"
    ...
    `]}onInput(e){let t=e.target;this.value=Sn(this.fieldType)===`date`?cn(t.value):t.value}onChange(){this.dispatchEvent(new Event(`change`))}textTpl(e,t=!1){return b`<span
      class=${e}
      ?hidden=${t}
      data-ff-editable
    ...
    >${this.placeholder}</span>`}onTextClick(){if(this.hasAttribute(`data-ff-editor`))return;let e=this.renderRoot.querySelector(`input[type="checkbox"]`);e&&(e.checked=!e.checked)}controlTpl(e){switch(e){case`textarea`:return b`<textarea class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}></textarea>`;case`select`:{let e=this.options.split(`,`).map(e=>e.trim()).filter(e=>e!==``),t=this.value!==``&&!e.includes(this.value);return b`<select class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}>
          ...
          class="ctrl"
          type=${e}
          .value=${e===`date`?sn(this.value):this.value}
          @input=${this.onInput}
          @change=${this.onChange}
        />`}}render(){let e=Sn(this.fieldType);return e===`checkbox`?b`<div class="feld">
        <div class="zeile">
    ...
    </div>`}};O([D()],q.prototype,`variant`,void 0),O([D()],q.prototype,`heading`,void 0),O([Ue()],q.prototype,`_count`,void 0),k.defineAndRegister(q);function Tn(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function En(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var Dn=new Set,On=new WeakMap,kn=q.tagName,An=U.tagName,J=`data-ff-nicht-zugeordnet`,jn=`Nicht zugeordnet`;function Mn(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===kn&&!e.hasAttribute(J))}function Nn(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===An)}function Pn(e){return Ke().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function Fn(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(`statusfield`)??``;if(t===``)return;let r=ot(P().FF_DATA_SOURCES,t);if(!r)return;let i=Mn(e);if(i.length===0)return;let a=On.get(e);if(!a){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(An);t&&(a=t.cloneNode(!0),On.set(e,a))}if(!a)return;let o=ut(P().SEDATA,r.name,r.tableId),s=i.map(e=>e.getAttribute(`heading`)??``),c=Pn(a.tagName),l=En(i.map(e=>e.getAttribute(`auffang`)));e.querySelectorAll(`[`+J+`]`).forEach(e=>e.remove());let u=null,d=()=>(u||(u=document.createElement(kn),u.setAttribute(`heading`,jn),u.setAttribute(J,``),u.setAttribute(`style`,i[0].getAttribute(`style`)??`flex-grow:1;flex-basis:0;min-width:0`),e.appendChild(u)),u);for(let e of i)Nn(e).forEach(e=>e.remove());for(let e of o){let t=a.cloneNode(!0),o=n===``?-1:Tn(M(e,n),s);(o>=0?i[o]:l>=0?i[l]:d()).appendChild(t);for(let n of c){let r=t.getAttribute(rn(n.prop))??``;r!==``&&(t[n.prop]=M(e,r))}let u=r.indexField===``?``:M(e,r.indexField);Y.set(t,{row:e,pindex:u}),t.draggable=!0}}var Y=new WeakMap,X=null,In=new WeakSet;function Ln(e,t){for(let n of t.composedPath())if(n instanceof HTMLElement&&n.tagName.toLowerCase()===kn&&e.contains(n))return n;return null}function Rn(e,t){if(!X||X.board!==e)return;let n=Y.get(X.card);if(!n)return;let r=t.getAttribute(`heading`)??``;H(e,`onCardDrop`,{PINDEX:n.pindex,VALUE:r})}function zn(e){In.has(e)||(In.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&Y.has(e))??null;n&&H(e,`onCardClick`,{PINDEX:Y.get(n)?.pindex??``})}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&Y.has(e))??null;n&&(X={card:n,board:e},t.dataTransfer?.setData(`text/plain`,Y.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`))}),e.addEventListener(`dragend`,()=>{X=null}),e.addEventListener(`dragover`,t=>{let n=Ln(e,t);X?.board===e&&n&&!n.hasAttribute(J)&&(t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`))}),e.addEventListener(`drop`,t=>{let n=Ln(e,t);!n||n.hasAttribute(J)||(t.preventDefault(),Rn(e,n),X=null)}))}function Bn(){F()&&Dn.forEach(Fn)}var Vn=!1;function Hn(e){e.hasAttribute(`data-ff-editor`)||(Dn.add(e),zn(e),Vn||(Vn=!0,_t(Bn)),z(),F()&&Fn(e))}function Un(e){Dn.delete(e)}var Z=q.blockType,Wn=class extends k{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[Z]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:Z}}static{this.templateChild={type:U.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.bindingRoute={fieldProp:`statusField`}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Optional: Feld der Datenquelle, dessen Inhalt bestimmt, in welche Spalte ein Eintrag kommt. Leer = alle Einträge in der Auffang-Spalte.`,kind:`field`,hiddenInInspector:!0}]}static{this.defaultChildren=[{type:Z,props:{heading:`Offen`,variant:`warning`},children:[{type:U.blockType}]},{type:Z,props:{heading:`In Arbeit`,variant:`info`}},{type:Z,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[k.styles,o`
    ...
    `]}render(){return b`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),Hn(this)}disconnectedCallback(){super.disconnectedCallback(),Un(this)}};k.defineAndRegister(Wn);var Gn={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Kn=e=>(...t)=>({_$litDirective$:e,values:t}),qn=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},Jn=`important`,Yn=` !`+Jn,Xn=Kn(class extends qn{constructor(e){if(super(e),e.type!==Gn.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(Yn);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?Jn:``):n[e]=r}}return S}}),Zn=new Set;function Qn(e){let t=e.getAttribute(`spalten`)??``;if(t===``)return[];try{let e=JSON.parse(t);return Array.isArray(e)?e.map(e=>e&&typeof e==`object`&&typeof e.feld==`string`?e.feld:``):[]}catch{return[]}}function $n(e){let t=e.getAttribute(`source`)??``;if(t===``){e.datenzeilen=[];return}let n=ot(P().FF_DATA_SOURCES,t);if(!n){e.datenzeilen=[];return}let r=Qn(e);e.datenzeilen=ut(P().SEDATA,n.name,n.tableId).map(e=>r.map(t=>t===``?``:M(e,t)))}function er(){F()&&Zn.forEach($n)}var tr=!1;function nr(e){e.hasAttribute(`data-ff-editor`)||(Zn.add(e),tr||(tr=!0,_t(er)),z(),F()&&$n(e))}function rr(e){Zn.delete(e)}var ir=1,ar=8,or=4;function Q(){return[{titel:`Spalte 1`,feld:``},{titel:`Spalte 2`,feld:``},{titel:`Spalte 3`,feld:``}]}function sr(e,t){if(e&&typeof e==`object`){let n=e;return{titel:typeof n.titel==`string`?n.titel:`Spalte ${t+1}`,feld:typeof n.feld==`string`?n.feld:``}}return typeof e==`string`?{titel:e,feld:``}:{titel:`Spalte ${t+1}`,feld:``}}function cr(e){let t;if(Array.isArray(e))t=e.map((e,t)=>sr(e,t));else if(typeof e==`number`&&Number.isFinite(e)||typeof e==`string`&&/^\d+$/.test(e)){let n=Math.max(1,Math.floor(Number(e)));t=[...Array(n).keys()].map(e=>({titel:`Spalte ${e+1}`,feld:``}))}else t=Q();return t.length>ar&&(t=t.slice(0,ar)),t.length<ir&&(t=[{titel:`Spalte 1`,feld:``}]),t}var lr=class extends k{constructor(...e){super(...e),this.spalten=Q(),this.source=``,this.datenzeilen=[]}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.defaultProps={width:`fill`,source:``,spalten:Q()}}static{this.raster={startW:14,startH:8,minW:6,minH:4}}spaltenListe(){return cr(this.spalten)}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}bearbeiteTitel(e,t){if(!this.editable)return;let n=e.currentTarget;if(!n)return;e.stopPropagation(),e.preventDefault();let r=Array.from(n.childNodes),i=n.textContent??``;n.setAttribute(`contenteditable`,`plaintext-only`),n.focus();let a=window.getSelection(),o=document.createRange();o.selectNodeContents(n),a?.removeAllRanges(),a?.addRange(o);let s=!1,c=e=>{if(s)return;s=!0,n.removeAttribute(`contenteditable`),n.removeEventListener(`blur`,l),n.removeEventListener(`keydown`,u);let a=(n.textContent??``).trim(),o=this.spaltenListe();e&&a&&a!==i.trim()&&t<o.length?(o[t]={...o[t],titel:a},this.aendere(o)):n.replaceChildren(...r)},l=()=>c(!0),u=e=>{e.key===`Enter`?(e.preventDefault(),n.blur()):e.key===`Escape`&&(e.preventDefault(),c(!1))};n.addEventListener(`blur`,l),n.addEventListener(`keydown`,u)}connectedCallback(){super.connectedCallback(),nr(this)}disconnectedCallback(){super.disconnectedCallback(),rr(this)}static{this.styles=[k.styles,o`
      :host { min-width: 0; height: 100%; }
      .tabelle {
        position: relative;
        box-sizing: border-box;
    ...
    `]}render(){let e=this.spaltenListe(),t={gridTemplateColumns:`repeat(${e.length}, minmax(0, 1fr))`},n=e=>e.stopPropagation(),r=this.datenzeilen,i=Array.from({length:or},()=>null),a=r.length>0?r:i;return b`<div class="tabelle">
      <div class="steuerung">
        <button
          title="Letzte Spalte entfernen"
          @pointerdown=${n}
          @click=${e=>{n(e);let t=this.spaltenListe();t.length>ir&&(t.pop(),this.aendere(t))}}
        >−</button>
        <button
          title="Spalte hinzufügen"
          @pointerdown=${n}
          @click=${e=>{n(e);let t=this.spaltenListe();t.length<ar&&(t.push({titel:`Spalte ${t.length+1}`,feld:``}),this.aendere(t))}}
        >+ Spalte</button>
      </div>
      <div class="kopf" style=${Xn(t)}>
        ${e.map((e,t)=>b`<div
            data-ff-editable
            @dblclick=${e=>this.bearbeiteTitel(e,t)}
          >${e.titel}</div>`)}
      </div>
      <div class="koerper">
        ${a.map(n=>b`<div class="zeile" style=${Xn(t)}>
            ${n?n.map(e=>b`<div>${e}</div>`):e.map(()=>b`<div>—</div>`)}
          </div>`)}
      </div>
    </div>`}};O([D({converter:{fromAttribute:e=>e?ur(e):Q(),toAttribute:e=>JSON.stringify(e)}})],lr.prototype,`spalten`,void 0),O([D()],lr.prototype,`source`,void 0),O([D({attribute:!1})],lr.prototype,`datenzeilen`,void 0);function ur(e){try{return cr(JSON.parse(e))}catch{return Q()}}k.defineAndRegister(lr);var dr=6,fr=96,pr=14,mr={duenn:`300`,normal:`400`,fett:`700`},hr={links:`left`,mitte:`center`,rechts:`right`};function gr(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(fr,Math.max(dr,t)):pr}function _r(e){return typeof e==`string`&&e in mr?e:`normal`}function vr(e){return typeof e==`string`&&e in hr?e:`links`}var $=class extends k{constructor(...e){super(...e),this.groesse=pr,this.gewicht=`normal`,this.ausrichtung=`links`,this.text=`Text`}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.defaultProps={width:`fill`,groesse:pr,gewicht:`normal`,ausrichtung:`links`,text:`Text`}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:dr,max:fr,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`}]}static{this.styles=[k.styles,o`
      .text {
        font-family: var(--se-font);
        color: var(--se-ink);
        line-height: 1.35;
    ...
    `]}render(){return b`<div class="zeile"><slot></slot></div>`}};k.defineAndRegister(br)})();
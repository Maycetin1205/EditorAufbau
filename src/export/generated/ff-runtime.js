...
`,L=class extends P{constructor(...e){super(...e),this.variant=`info`,this.text=`Hinweis`}static{this.blockType=`badge`}static{this.tagName=`ff-badge`}static{this.displayName=`Status-Chip`}static{this.category=`anzeige`}static{this.resizableWidth=!1}static{this.defaultProps={variant:`info`,text:`Hinweis`}}static{this.customProperties=[I(`variant`,`Bedeutung des Chips — bestimmt die Farbe.`)]}static{this.styles=[P.styles,He]}render(){return w`<span
    ...
    `]}render(){let e=F(this.chipVariant);return w`<div class="card">
      <div class="row">
        <span
          class="heading"
          data-ff-editable
      ...
      >${this.chipText}</span>
    </div>`}};N([j()],R.prototype,`chipVariant`,void 0),N([j()],R.prototype,`heading`,void 0),N([j()],R.prototype,`time`,void 0),N([j()],R.prototype,`meta`,void 0),N([j()],R.prototype,`text`,void 0),N([j()],R.prototype,`chipText`,void 0),N([j()],R.prototype,`headingField`,void 0),N([j()],R.prototype,`timeField`,void 0),N([j()],R.prototype,`metaField`,void 0),N([j()],R.prototype,`textField`,void 0),N([j()],R.prototype,`chipTextField`,void 0),P.defineAndRegister(R);var z=class extends P{constructor(...e){super(...e),this.direction=`column`,this.gap=`md`,this.padding=`none`}static{this.blockType=`container`}static{this.tagName=`ff-container`}static{this.displayName=`Bereich`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.defaultProps={direction:`column`,gap:`md`,padding:`none`,width:`fill`}}static{this.customProperties=[]}static{this.styles=[P.styles,o`
      .wrap {
        display: flex;
    ...
    `]}get optionList(){return this.options.split(`,`).map(e=>e.trim()).filter(e=>e!==``)}render(){let e=st(this.fieldType),t=this.required===`ja`,n=this.readonly===`ja`;switch(e){case`textarea`:return w`<textarea
        ...
        />`;default:return w`<input
          ...
          ?required=${t}
          ?readonly=${n}
        />`}}};N([j()],B.prototype,`fieldType`,void 0),N([j()],B.prototype,`placeholder`,void 0),N([j()],B.prototype,`required`,void 0),N([j()],B.prototype,`readonly`,void 0),N([j()],B.prototype,`options`,void 0),P.defineAndRegister(B);var V=class extends P{constructor(...e){super(...e),this.variant=`info`,this.heading=`Hinweis`,this.message=`Das ist ein Hinweistext.`}static{this.blockType=`infobox`}static{this.tagName=`ff-infobox`}static{this.displayName=`Infobox`}static{this.category=`anzeige`}static{this.defaultProps={variant:`info`,heading:`Hinweis`,message:`Das ist ein Hinweistext.`}}static{this.customProperties=[I(`variant`,`Bedeutung der Box — bestimmt die Farbe.`)]}static{this.styles=[P.styles,o`
      .box {
        box-sizing: border-box;
        border: 1px solid var(--se-line);
    ...
    `]}render(){return w`<div class="box v-${F(this.variant)}">
      <p
        class="heading"
        data-ff-editable
        @dblclick=${e=>this.inlineEdit(e,`heading`)}
      ...
      >${this.message}</p>
    </div>`}};N([j()],V.prototype,`variant`,void 0),N([j()],V.prototype,`heading`,void 0),N([j()],V.prototype,`message`,void 0),P.defineAndRegister(V);var H=class extends P{constructor(...e){super(...e),this.variant=`info`,this.heading=`Neue Spalte`,this._count=0}static{this.blockType=`kanban-spalte`}static{this.tagName=`ff-kanban-spalte`}static{this.displayName=`Kanban-Spalte`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[R.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={variant:`info`,heading:`Neue Spalte`,statusValues:[],auffang:`nein`}}static{this.customProperties=[I(`variant`,`Bedeutung der Spalte — bestimmt ihre Farbwelt (Kopf, Fläche, Rahmen).`),{attributeName:`statusValues`,name:`Wert dieser Spalte`,description:`Einträge, bei denen dieser Wert im Sortier-Feld steht, landen hier; beim Ablegen einer Karte wird er zurückgeschrieben. Leer = der Spaltentitel zählt als Wert. Passt ein Eintrag nirgends, landet er in der ersten Spalte.`,isArray:!0,maxLength:60,kind:`text`,requiresDataSource:!0},at(`auffang`,`Auffangspalte`,`Einträge, die in keine Spalte passen, landen hier. Ohne Auffangspalte zeigt die Maske sie in einer eigenen Spalte "Nicht zugeordnet". Höchstens eine Spalte je Board.`,{requiresDataSource:!0,exclusiveAmongSiblings:!0})]}static{this.styles=[P.styles,o`
      ...
      slot { display: contents; }
    `]}onSlotChange(e){let t=e.target;this._count=t.assignedElements().filter(e=>!e.hasAttribute(`data-ff-editor-helper`)&&e.tagName.toLowerCase()!==`template`).length}render(){return w`<div class="col v-${F(this.variant)}">
      <div class="head">
        <span class="dot"></span>
        <span
          class="title"
    ...
    `]}render(){return w`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),Ht(this)}disconnectedCallback(){super.disconnectedCallback(),Ut(this)}};P.defineAndRegister(Wt);var Gt=class extends P{constructor(...e){super(...e),this.text=`Neuer Text`}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Textblock`}static{this.category=`anzeige`}static{this.defaultProps={text:`Neuer Text`}}static{this.customProperties=[]}static{this.styles=[P.styles,o`
      span {
        display: block;
        min-width: 1ch;
        color: var(--se-ink);
    ...
    `]}render(){return w`<span
      data-ff-editable
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</span>`}};N([j()],Gt.prototype,`text`,void 0),P.defineAndRegister(Gt)})();
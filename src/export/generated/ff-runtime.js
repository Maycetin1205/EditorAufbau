...
\f\r]`,Se=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ce=/-->/g,we=/>/g,g=RegExp(`>|${xe}(?:([^\\s"'>=/]+)(${xe}*=${xe}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,`g`),Te=/'/g,Ee=/"/g,De=/^(?:script|style|textarea|title)$/i,Oe=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),_=Oe(1),ke=Oe(2),v=Symbol.for(`lit-noChange`),y=Symbol.for(`lit-nothing`),Ae=new WeakMap,b=m.createTreeWalker(m,129);function je(e,t){if(!ye(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return me===void 0?t:me.createHTML(t)}var Me=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:t===3?`<math>`:``,o=Se;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===Se?c[1]===`!--`?o=Ce:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=g):(De.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=g):o=we:o===g?c[0]===`>`?(o=i??Se,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?g:c[3]===`"`?Ee:Te):o===Ee||o===Te?o=g:o===Ce||o===we?o=Se:(o=g,i=void 0);let d=o===g&&e[t+1].startsWith(`/>`)?` `:``;a+=o===Se?n+_e:l>=0?(r.push(s),n.slice(0,l)+he+n.slice(l)+p+d):n+p+(l===-2?t:d)}return[je(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:t===3?`</math>`:``)),r]},Ne=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=Me(t,n);if(this.el=e.createElement(l,r),b.currentNode=this.el.content,n===2||n===3){let e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;(i=b.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes())for(let e of i.getAttributeNames())if(e.endsWith(he)){let t=u[o++],n=i.getAttribute(e).split(p),r=/([.?@])?(.*)/.exec(t);c.push({type:1,index:a,name:r[2],strings:n,ctor:r[1]===`.`?Le:r[1]===`?`?Re:r[1]===`@`?ze:Ie}),i.removeAttribute(e)}else e.startsWith(p)&&(c.push({type:6,index:a}),i.removeAttribute(e));if(De.test(i.tagName)){let e=i.textContent.split(p),t=e.length-1;if(t>0){i.textContent=pe?pe.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],h()),b.nextNode(),c.push({type:2,index:++a});i.append(e[t],h())}}}else if(i.nodeType===8)if(i.data===ge)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(p,e+1))!==-1;)c.push({type:7,index:a}),e+=p.length-1}a++}}static createElement(e,t){let n=m.createElement(`template`);return n.innerHTML=e,n}};function x(e,t,n=e,r){if(t===v)return t;let i=r===void 0?n._$Cl:n._$Co?.[r],a=ve(t)?void 0:t._$litDirective$;return i?.constructor!==a&&(i?._$AO?.(!1),a===void 0?i=void 0:(i=new a(e),i._$AT(e,n,r)),r===void 0?n._$Cl=i:(n._$Co??=[])[r]=i),i!==void 0&&(t=x(e,i._$AS(e,t.values),i,r)),t}var Pe=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??m).importNode(t,!0);b.currentNode=r;let i=b.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new Fe(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new Be(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=b.nextNode(),a++)}return b.currentNode=m,r}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},Fe=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,r){this.type=2,this._$AH=y,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=x(this,e,t),ve(e)?e===y||e==null||e===``?(this._$AH!==y&&this._$AR(),this._$AH=y):e!==this._$AH&&e!==v&&this._(e):e._$litType$===void 0?e.nodeType===void 0?be(e)?this.k(e):this._(e):this.T(e):this.$(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==y&&ve(this._$AH)?this._$AA.nextSibling.data=e:this.T(m.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=Ne.createElement(je(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.p(t);else{let e=new Pe(r,this),n=e.u(this.options);e.p(t),this.T(n),this._$AH=e}}_$AC(e){let t=Ae.get(e.strings);return t===void 0&&Ae.set(e.strings,t=new Ne(e)),t}k(t){ye(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.O(h()),this.O(h()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let t=fe(e).nextSibling;fe(e).remove(),e=t}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},Ie=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,r,i){this.type=1,this._$AH=y,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=y}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=x(this,e,t,0),a=!ve(e)||e!==this._$AH&&e!==v,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=x(this,r[n+o],t,o),s===v&&(s=this._$AH[o]),a||=!ve(s)||s!==this._$AH[o],s===y?e=y:e!==y&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===y?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},Le=class extends Ie{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===y?void 0:e}},Re=class extends Ie{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==y)}},ze=class extends Ie{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=x(this,e,t,0)??y)===v)return;let n=this._$AH,r=e===y&&n!==y||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==y&&(n===y||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Be=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){x(this,e)}},Ve=de.litHtmlPolyfillSupport;Ve?.(Ne,Fe),(de.litHtmlVersions??=[]).push(`3.3.3`);var He=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new Fe(t.insertBefore(h(),e),e,void 0,n??{})}return i._$AI(e),i},Ue=globalThis,S=class extends f{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=He(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return v}};S._$litElement$=!0,S.finalized=!0,Ue.litElementHydrateSupport?.({LitElement:S});var We=Ue.litElementPolyfillSupport;We?.({LitElement:S}),(Ue.litElementVersions??=[]).push(`4.2.2`);var Ge={attribute:!0,type:String,converter:ce,reflect:!1,hasChanged:le},Ke=(e=Ge,t,n)=>{let{kind:r,metadata:i}=n,a=globalThis.litPropertyMetadata.get(i);if(a===void 0&&globalThis.litPropertyMetadata.set(i,a=new Map),r===`setter`&&((e=Object.create(e)).wrapped=!0),a.set(n.name,e),r===`accessor`){let{name:r}=n;return{set(n){let i=t.get.call(this);t.set.call(this,n),this.requestUpdate(r,i,e,!0,n)},init(t){return t!==void 0&&this.C(r,void 0,e,t),t}}}if(r===`setter`){let{name:r}=n;return function(n){let i=this[r];t.call(this,n),this.requestUpdate(r,i,e,!0,n)}}throw Error(`Unsupported decorator location: `+r)};function C(e){return(t,n)=>typeof n==`object`?Ke(e,t,n):((e,t,n)=>{let r=t.hasOwnProperty(n);return t.constructor.createProperty(n,e),r?Object.getOwnPropertyDescriptor(t,n):void 0})(e,t,n)}function w(e){return C({...e,state:!0,attribute:!1})}var qe=new Map;function Je(e){qe.has(e.type)&&console.warn(`Block-Typ "${e.type}" wird ueberschrieben.`),qe.set(e.type,e)}function Ye(){return Array.from(qe.values())}var Xe={width:`auto`};function Ze(e){return Object.entries(e).map(([e,t])=>`${e.replace(/[A-Z]/g,e=>`-`+e.toLowerCase())}:${t}`).join(`;`)}var Qe={spalten:24,spaltePx:40,zeilePx:12,gapPx:8},$e={rasterX:0,rasterY:0,rasterW:Qe.spalten,rasterH:1};function et(){return{display:`grid`,gridTemplateColumns:`repeat(${Qe.spalten}, 1fr)`,gridAutoRows:`${Qe.zeilePx}px`,gap:`${Qe.gapPx}px`,alignContent:`start`}}function tt(){return Ze(et())}function nt(e){return`${e.toLowerCase()}field`}function rt(e){let t=e.split(`::`);if(t.length!==2)return{quelleId:``,code:e};let[n,r]=t;return n===``||r===``?{quelleId:``,code:e}:{quelleId:n,code:r}}function it(e){return e.keyPairs.filter(e=>e.fromField.trim()!==``&&e.toField.trim()!==``)}var at=`weitereQuellen`,ot={[at]:[]};function st(e){return e.quelleId!==``&&it(e).length>0}function ct(e,t,n,r){let i=e.trim(),a=t.trim(),o=a===``||a===n?void 0:r.find(e=>e.quelleId===a&&st(e)),s=o?.quelleId??``;if(i===``)return{art:`frei`,quelleId:``,code:``,suchQuelleId:s};let{quelleId:c,code:l}=rt(i);if(c!==``&&c!==n)return{art:`auswahl`,quelleId:c,code:l,suchQuelleId:s};if(o){for(let e of it(o))if(e.fromField===l)return{art:`auswahl`,quelleId:s,code:e.toField,suchQuelleId:s}}return{art:`eigen`,quelleId:``,code:l,suchQuelleId:s}}var lt=`folgtAuswahl`,ut={[lt]:[]};function dt(e,t){let n=e.textContent??``,r=Array.from(e.childNodes),i=r.map(e=>e.textContent??``);e.setAttribute(`contenteditable`,`plaintext-only`),e.focus();let a=window.getSelection(),o=document.createRange();o.selectNodeContents(e),a?.removeAllRanges(),a?.addRange(o);let s=()=>{e.replaceChildren(...r),r.forEach((e,t)=>{e.textContent!==i[t]&&(e.textContent=i[t])})},c=!1,l=r=>{c||(c=!0,e.removeAttribute(`contenteditable`),e.removeEventListener(`blur`,u),e.removeEventListener(`keydown`,d),r&&t((e.textContent??``).trim(),n)||s())},u=()=>l(!0),d=t=>{t.key===`Enter`?(t.preventDefault(),e.blur()):t.key===`Escape`&&(t.preventDefault(),l(!1))};e.addEventListener(`blur`,u),e.addEventListener(`keydown`,d)}function T(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var E=class extends S{constructor(...e){super(...e),this.editable=!1}static{this.styles=o`
  ...
  `}static{this.customProperties=[]}get customProperties(){return this.constructor.customProperties}inlineEdit(e,t){if(!this.editable)return;let n=e.currentTarget;n&&(n.hasAttribute(`data-ff-bound`)||(e.stopPropagation(),e.preventDefault(),dt(n,(e,n)=>(e!==n&&this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:t,value:e},bubbles:!0,composed:!0})),!0))))}static defineAndRegister(e){customElements.get(e.tagName)||customElements.define(e.tagName,e),Je({type:e.blockType,tagName:e.tagName,displayName:e.displayName,category:e.category,defaultProps:{...Xe,...$e,...e.acceptsDataSource?ot:null,...e.kannAuswahlFolgen?ut:null,...e.defaultProps},customProperties:e.customProperties,acceptsChildren:e.acceptsChildren??!1,resizableWidth:e.resizableWidth??!0,resizableHeight:e.resizableHeight??!1,allowedChildTypes:e.allowedChildTypes,allowedParentTypes:e.allowedParentTypes,lockedWidth:e.lockedWidth,defaultChildren:e.defaultChildren,childDirection:e.childDirection,showInPalette:e.showInPalette,templateChild:e.templateChild,containerHint:e.containerHint,addChildButton:e.addChildButton,acceptsDataSource:e.acceptsDataSource,satzWahl:e.satzWahl,kannAuswahlFolgen:e.kannAuswahlFolgen,kannErfassen:e.kannErfassen,bindableSpots:e.bindableSpots,actionValueSpots:e.actionValueSpots,listenBindung:e.listenBindung,blockEvents:e.blockEvents,pageBlock:e.pageBlock,flaechenSeite:e.flaechenSeite,maskenRand:e.maskenRand,raster:e.raster})}};T([C({type:Boolean,reflect:!0,attribute:`data-editable`})],E.prototype,`editable`,void 0);var ft=`root`,pt=class extends E{static{this.blockType=`ansicht`}static{this.tagName=`ff-ansicht`}static{this.displayName=`Ansicht`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.showInPalette=!1}static{this.allowedParentTypes=[ft]}static{this.pageBlock=!0}static{this.flaechenSeite=!0}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.defaultProps={name:`Ansicht`}}static{this.styles=[E.styles,o`
    ...
    </div>`}};T([C()],mt.prototype,`quelle`,void 0),E.defineAndRegister(mt);var ht=`data-ff-block-id`,gt=[`fixed`,`context`,`data_field`,`block_value`,`gewaehlte_zeile`,`erfassungszelle`,`previous_result`,`step_result`,`se_variable`,`aus`];function _t(e){return!!e&&typeof e==`object`&&!Array.isArray(e)}function vt(e){return!_t(e)||typeof e.source!=`string`||!gt.includes(e.source)||typeof e.value!=`string`||e.dataSourceId!==void 0&&typeof e.dataSourceId!=`string`||e.blockId!==void 0&&typeof e.blockId!=`string`||e.ergebnisFeld!==void 0&&typeof e.ergebnisFeld!=`string`?null:{source:e.source,value:e.value,...typeof e.dataSourceId==`string`?{dataSourceId:e.dataSourceId}:{},...typeof e.blockId==`string`?{blockId:e.blockId}:{},...e.source===`step_result`&&typeof e.ergebnisFeld==`string`?{ergebnisFeld:e.ergebnisFeld}:{}}}function yt(e){if(!_t(e)||typeof e.type!=`string`||typeof e.resultKey!=`string`)return null;if(e.type===`START_TOOL`)return typeof e.toolNr!=`string`||!Array.isArray(e.toolParams)||e.toolParams.some(e=>typeof e!=`string`)?null:{type:`START_TOOL`,resultKey:e.resultKey,toolNr:e.toolNr,toolParams:[...e.toolParams]};if(e.type===`POPUP_OPEN`||e.type===`POPUP_CLOSE`){let t=typeof e.popupId==`string`?e.popupId:void 0,n=typeof e.popup==`string`?e.popup:void 0;return t===void 0&&n===void 0?null:{type:e.type,resultKey:e.resultKey,...t===void 0?{}:{popupId:t},...n===void 0?{}:{popup:n}}}if(e.type===`RELATION`){if(typeof e.relationId!=`string`||!Array.isArray(e.extraParams)||!Array.isArray(e.params)&&!_t(e.bindings))return null;let t=[];if(Array.isArray(e.params))for(let n of e.params){let e=vt(n);if(!e)return null;t.push(e)}let n=[];for(let t of e.extraParams){let e=vt(t);if(!e)return null;n.push(e)}return{type:`RELATION`,resultKey:e.resultKey,relationId:e.relationId,params:t,extraParams:n}}return null}function bt(e){if(!e)return{};let t;try{t=JSON.parse(e)}catch{return{}}if(!_t(t))return{};let n={};for(let[e,r]of Object.entries(t)){if(!Array.isArray(r)||r.length===0)continue;let t=[],i=!1;for(let e of r){let n=yt(e);if(!n){i=!0;break}t.push(n)}!i&&t.length>0&&(n[e]=t)}return n}Object.values({idb:{id:`idb`,name:`IDB-Tabelle`,tabellenId:``,felderEinzeln:!1,kennungLabel:`Kennung`,kennungBeispiel:`ID0001`,kopfsatzMoeglich:!1,kopfsatzStandard:``,relationLadenMoeglich:!1,varMoeglich:!1,bestellBlock:`sefileloop`,spaltenNamen:!1,idbKurzform:!0,feldVorsatzMoeglich:!1,standardFelder:[]},adressstamm:{id:`adressstamm`,name:`Adressstamm`,tabellenId:`ADR`,felderEinzeln:!0,kennungLabel:``,kennungBeispiel:``,kopfsatzMoeglich:!1,kopfsatzStandard:``,relationLadenMoeglich:!1,varMoeglich:!0,bestellBlock:`sefileloop`,spaltenNamen:!1,idbKurzform:!0,feldVorsatzMoeglich:!1,standardFelder:[]},artikelstamm:{id:`artikelstamm`,name:`Artikelstamm`,tabellenId:`ART`,felderEinzeln:!0,kennungLabel:``,kennungBeispiel:``,kopfsatzMoeglich:!1,kopfsatzStandard:``,relationLadenMoeglich:!1,varMoeglich:!1,bestellBlock:`sefileloop`,spaltenNamen:!1,idbKurzform:!0,feldVorsatzMoeglich:!1,standardFelder:[]},beleg:{id:`beleg`,name:`Beleg`,tabellenId:`BEL`,felderEinzeln:!0,kennungLabel:``,kennungBeispiel:``,kopfsatzMoeglich:!1,kopfsatzStandard:``,relationLadenMoeglich:!1,varMoeglich:!0,bestellBlock:`sefileloop`,spaltenNamen:!1,idbKurzform:!0,feldVorsatzMoeglich:!1,standardFelder:[{code:`0_11`,label:`Satzschlüssel`},{code:`2_1`,label:`Belegart`},{code:`3_8`,label:`Belegnummer`},{code:`11_8`,label:`Kundennummer`},{code:`19_10`,label:`Belegdatum`},{code:`393_12`,label:`Warenwert`},{code:`441_12`,label:`MwSt-Betrag`},{code:`453_12`,label:`Gesamtbetrag`},{code:`3440_60`,label:`Name`}]},belegposition:{id:`belegposition`,name:`Belegpositionen`,tabellenId:`POS`,felderEinzeln:!0,kennungLabel:``,kennungBeispiel:``,kopfsatzMoeglich:!0,kopfsatzStandard:`BEL_0_11`,relationLadenMoeglich:!0,varMoeglich:!0,bestellBlock:`sefileloop`,spaltenNamen:!1,idbKurzform:!0,feldVorsatzMoeglich:!1,standardFelder:[{code:`2_1`,label:`Belegart`},{code:`3_8`,label:`Belegnummer`},{code:`11_6`,label:`Positionsnummer`},{code:`17_1`,label:`Zeilenart`},{code:`18_25`,label:`Artikelnummer`},{code:`45_60`,label:`Bezeichnung`},{code:`164_8`,label:`Menge`},{code:`246_9`,label:`Einzelpreis`},{code:`280_12`,label:`Gesamtpreis`},{code:`372_5`,label:`MwSt-Satz`},{code:`645_10`,label:`Satznummer`},{code:`689_5`,label:`Mengeneinheit`},{code:`1401_12`,label:`Rohertrag`},{code:`2558_1`,label:`Farbkennzeichen`},{code:`3164_12`,label:`Rabatt`}]},datei:{id:`datei`,name:`Andere Datei`,tabellenId:``,felderEinzeln:!0,kennungLabel:`Kennung`,kennungBeispiel:`SERPOS`,kopfsatzMoeglich:!0,kopfsatzStandard:``,relationLadenMoeglich:!1,varMoeglich:!1,bestellBlock:`sefileloop`,spaltenNamen:!1,idbKurzform:!0,feldVorsatzMoeglich:!1,standardFelder:[]},erpabfrage:{id:`erpabfrage`,name:`ERP-Abfrage`,tabellenId:``,felderEinzeln:!0,kennungLabel:`Kennung`,kennungBeispiel:`LIEFERADRESSE.GET`,kopfsatzMoeglich:!1,kopfsatzStandard:``,relationLadenMoeglich:!1,varMoeglich:!1,bestellBlock:`erpapicall`,spaltenNamen:!1,idbKurzform:!0,feldVorsatzMoeglich:!0,standardFelder:[]},dataset:{id:`dataset`,name:`DataSet`,tabellenId:``,felderEinzeln:!0,kennungLabel:`DataSet-ID`,kennungBeispiel:`ID0001`,kopfsatzMoeglich:!1,kopfsatzStandard:``,relationLadenMoeglich:!1,varMoeglich:!1,bestellBlock:`dataset`,spaltenNamen:!0,idbKurzform:!1,feldVorsatzMoeglich:!1,standardFelder:[]}}).map(e=>e.id);var D=/^\d+_\d+$/,xt=/^\d+$/;function St(e){if(!e||typeof e!=`object`)return null;let t=e,n=e=>typeof e==`string`?e.trim():``,r=n(t.nr),i=n(t.geberQuelleId),a=n(t.belegartFeld),o=n(t.belegnummerFeld),s=n(t.jahrFeld),c=n(t.archivFeld),l=Array.isArray(t.endeFelder)?t.endeFelder.filter(e=>typeof e==`string`&&D.test(e)):[];return!xt.test(r)||i===``||!D.test(a)||!D.test(o)||s!==``&&!D.test(s)||c!==``&&!D.test(c)||l.length===0?null:{nr:r,geberQuelleId:i,belegartFeld:a,belegnummerFeld:o,jahrFeld:s,archivFeld:c,endeFelder:l}}var Ct=new Map;function wt(e,t){e!==``&&Ct.set(e,t)}function Tt(e){return Ct.get(e)}function O(e){return typeof e==`object`&&!!e}function k(e,t){if(!(!Array.isArray(e)||t===``))for(let n of e){if(!O(n)||n.id!==t||typeof n.name!=`string`||typeof n.tableId!=`string`)continue;let e,r=St(n.ladeRelation);if(r&&O(n.ladeRelation)){let t=n.ladeRelation.zusatzFelder,i=Array.isArray(t)?t.filter(e=>typeof e==`string`&&D.test(e)):[];e={...r,zusatzFelder:i}}return{id:t,name:n.name,tableId:n.tableId,indexField:typeof n.indexField==`string`?n.indexField:``,...e?{ladeRelation:e}:{}}}}function Et(e){return e==null?``:String(e).trim()}function A(e,t){if(!O(e)||t===``)return``;let n=t.trim(),r=Et(e[n]);if(r!==``)return r;for(let t of Object.keys(e))if(t===n||t.startsWith(`${n}_`)||t.endsWith(`_${n}`)){let n=Et(e[t]);if(n!==``)return n}let i=/^(\d+)_(\d+)$/.exec(n);if(!i)return``;let a=e.SATZNEU??e.SATZ??e.satzneu??e.satz??e.RAW??e.raw,o=a==null?``:String(a);if(o===``)return``;let s=Number(i[1]),c=Number(i[2]);return c<=0?``:o.substring(s,s+c).trim()}function Dt(e,t){return e.indexField===``?``:A(t,e.indexField)}function Ot(e,t,n){if(!O(e)||t===``)return!1;let r=t.trim(),i=!1;for(let t of Object.keys(e))(t===r||t.startsWith(`${r}_`)||t.endsWith(`_${r}`))&&(e[t]=n,i=!0);let a=/^(\d+)_(\d+)$/.exec(r);if(a){let t=[`SATZNEU`,`SATZ`,`satzneu`,`satz`,`RAW`,`raw`].find(t=>typeof e[t]==`string`);if(t){let r=e[t],o=Number(a[1]),s=Number(a[2]);if(s>0){let a=n.length>s?n.slice(0,s):n.padEnd(s,` `),c=r.length<o?r.padEnd(o,` `):r;e[t]=c.slice(0,o)+a+c.slice(o+s),i=!0}}}return i}function kt(e){if(!O(e))return Array.isArray(e)?e:[];let t=[e.Zeilen,e.zeilen,e.Saetze,e.saetze,e.Rows,e.rows,e.Daten,e.daten];for(let e of t){if(Array.isArray(e))return e;if(typeof e==`string`)try{let t=JSON.parse(e);if(Array.isArray(t))return t}catch{}}return[]}function j(e,t){return Et(e).toLowerCase()===t.trim().toLowerCase()}function At(e,t,n){if(!O(e)||!O(e.Daten))return[];let r=e.Daten,i=r.SEFileLoop;if(Array.isArray(i)){for(let e of i)if(O(e)&&(j(e.ALIAS,t)||j(e.alias,t))){let t=kt(e);if(t.length>0)return t}}else if(O(i))for(let e of Object.keys(i)){let n=i[e];if(j(e,t)||O(n)&&(j(n.ALIAS,t)||j(n.alias,t))){let e=kt(n);if(e.length>0)return e}}for(let e of[`ErpApiCall`,`ERPAPICALL`,`erpapicall`]){let n=r[e];if(O(n))for(let e of Object.keys(n)){if(!j(e,t))continue;let r=kt(n[e]);if(r.length>0)return r}}let a=r.Tabellen;if(O(a)){let e=[t,t.toUpperCase(),t.toLowerCase(),n];for(let t of e)if(t!==``&&t in a){let e=kt(a[t]);if(e.length>0)return e}for(let e of Object.keys(a))if(j(e,t)){let t=kt(a[e]);if(t.length>0)return t}}return Tt(t)??[]}function jt(e){let t=e;if(typeof t==`string`)try{t=JSON.parse(t)}catch{return}if(!O(t)||!O(t.Daten))return;let n=t.Daten;if(!(!n.SEFileLoop&&!n.Tabellen&&!n.ErpApiCall))return n}function Mt(e){let t=e;if(typeof t==`string`)try{t=JSON.parse(t)}catch{return}if(!(!O(t)||!O(t.MSG)))return t.MSG.DATA}function Nt(e,t,n){let r=e.getAttribute(t)??``;if(r===``)return[];try{let e=JSON.parse(r);if(!Array.isArray(e))return[];let t=[];for(let r of e){if(!r||typeof r!=`object`)continue;let e=r,i=e[n];if(typeof i!=`string`||i===``)continue;let a=[];for(let t of Array.isArray(e.keyPairs)?e.keyPairs:[]){if(!t||typeof t!=`object`)continue;let e=t;typeof e.fromField!=`string`||typeof e.toField!=`string`||e.fromField.trim()===``||e.toField.trim()===``||a.push({fromField:e.fromField,toField:e.toField})}a.length!==0&&t.push({id:i,keyPairs:a})}return t}catch{return[]}}function Pt(e){if(e==null)return``;try{return JSON.stringify(e)??``}catch{return``}}var M=new Map,Ft=new Set,It=new Set,Lt=0,Rt=!1,zt=!1;function Bt(){if(Rt){zt=!0;return}Rt=!0;try{do zt=!1,Ft.forEach(e=>e());while(zt)}finally{Rt=!1}}function Vt(e){Ft.add(e)}function Ht(e){return M.get(e)?.zeile}function Ut(e){return M.get(e)?.merkmal??``}function Wt(e){return M.get(e)?.nummer??0}function N(e){return e.getAttribute(`data-ff-id`)??``}function Gt(e,t,n){if(e===``)return[];let r=Ut(e);if(r===``)return[];let i=[];return t.forEach((e,t)=>{Pt(n(e))===r&&i.push(t)}),i.length===0&&Jt(e),i}function Kt(e,t){if(e===``)return;let n=Pt(t);if(n===``)return;let r=M.get(e);r&&r.merkmal===n?M.delete(e):M.set(e,{zeile:t,merkmal:n,nummer:++Lt}),Bt()}function qt(e,t){if(e===``)return;let n=Pt(t);n!==``&&M.get(e)?.merkmal!==n&&(M.set(e,{zeile:t,merkmal:n,nummer:++Lt}),Bt())}function Jt(e){M.has(e)&&(M.delete(e),Bt())}function Yt(e){It.add(e)}var Xt=lt.toLowerCase();function Zt(e){return Nt(e,Xt,`geberId`).map(e=>({geberId:e.id,keyPairs:e.keyPairs}))}function Qt(e,t){let n=t,r=!1;for(let t of Zt(e)){let e=Ht(t.geberId);e!==void 0&&(r=!0,n=n.filter(n=>t.keyPairs.every(t=>{let r=A(e,t.fromField);return r!==``&&r===A(n,t.toField)})))}return{rows:n,gefiltert:r}}function $t(e,t){if(Zt(e).length===0)return t[0];let{rows:n,gefiltert:r}=Qt(e,t);return r?n[0]:void 0}var en=`ff-dialog-rahmen`,tn=`ff-dialog-schliessen`,nn=`ff-dialog-groesse`;function rn(e,t){let n=Number(e);return Number.isFinite(n)&&n>0?n:t}var P=class extends S{constructor(...e){super(...e),this.titel=`Dialog`,this.breite=520,this.hoehe=380,this.viewport=!1,this.escapeSchliesst=!1,this.ohneModal=!1,this.inhaltFest=!1,this.ziehbar=!1,this.escapeRegistriert=!1,this.aufTaste=e=>{e.key===`Escape`&&(e.stopPropagation(),this.schliesse())}}static{this.styles=o`
    :host {
      position: absolute;
      inset: 0;
      display: block;
  ...
  `}aktualisiereEscape(){let e=this.isConnected&&this.escapeSchliesst;e!==this.escapeRegistriert&&(e?document.addEventListener(`keydown`,this.aufTaste,!0):document.removeEventListener(`keydown`,this.aufTaste,!0),this.escapeRegistriert=e)}ziehe(e,t){if(!this.ziehbar)return;e.preventDefault(),e.stopPropagation();let n=t===`breite`?rn(this.breite,520):rn(this.hoehe,380),r=t===`breite`?240:160,i=t===`breite`?e.clientX:e.clientY,a=Math.max(r,Math.round(n)),o=!1,s=(e,n)=>{this.dispatchEvent(new CustomEvent(nn,{detail:{achse:t,wert:e,geste:n},bubbles:!0,composed:!0}))},c=e=>{let c=t===`breite`?e.clientX:e.clientY,l=Math.max(r,Math.round(n+(c-i)*2));l!==a&&(a=l,s(l,o?`laeuft`:`beginn`),o=!0)},l=()=>{window.removeEventListener(`pointermove`,c),window.removeEventListener(`pointerup`,l),window.removeEventListener(`pointercancel`,l),window.removeEventListener(`blur`,l),o&&s(a,`ende`)};window.addEventListener(`pointermove`,c),window.addEventListener(`pointerup`,l),window.addEventListener(`pointercancel`,l),window.addEventListener(`blur`,l)}aufStandard(e,t){this.ziehbar&&(e.stopPropagation(),this.dispatchEvent(new CustomEvent(nn,{detail:{achse:t,wert:0,geste:`standard`},bubbles:!0,composed:!0})))}schliesse(){this.dispatchEvent(new CustomEvent(tn,{bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this.aktualisiereEscape()}updated(e){e.has(`escapeSchliesst`)&&this.aktualisiereEscape()}disconnectedCallback(){this.escapeRegistriert&&=(document.removeEventListener(`keydown`,this.aufTaste,!0),!1),super.disconnectedCallback()}render(){let e=rn(this.breite,520),t=rn(this.hoehe,380);return _`
    ...
    `]}onClose(){this.hasAttribute(`data-ff-editor`)||this.removeAttribute(`offen`)}updated(e){super.updated(e),!(!e.has(`offen`)||!this.offen)&&(this.hasAttribute(`data-ff-editor`)||this.updateComplete.then(()=>{!this.offen||!this.isConnected||(on(this)??(this.shadowRoot?on(this.shadowRoot):null))?.focus()}))}render(){return _`<ff-dialog-rahmen
        .breite=${this.breite}
        .hoehe=${this.hoehe}
        ohne-modal
        inhalt-fest
      ...
      </ff-dialog-rahmen>`}};T([C()],F.prototype,`name`,void 0),T([C()],F.prototype,`breite`,void 0),T([C()],F.prototype,`hoehe`,void 0),T([C({type:Boolean,reflect:!0})],F.prototype,`offen`,void 0),E.defineAndRegister(F);var sn=[`GET_RELATION`,`PUT_RELATION`,`PUTADD_RELATION`];function cn(e){return`${String(e.getDate()).padStart(2,`0`)}.${String(e.getMonth()+1).padStart(2,`0`)}.${e.getFullYear()}`}function ln(e,t){return e.params.map(e=>e.replace(/\{([A-Za-z0-9_]+)\}/g,(e,n)=>String(t[n]??``)))}var un=8e3,I=null,dn=null;function fn(){let e=document.createElement(`div`);return e.setAttribute(`data-ff-meldung`,``),e.setAttribute(`role`,`alert`),e.style.cssText=[`position:fixed`,`top:0`,`left:0`,`right:0`,`z-index:2147483647`,`padding:7px 12px`,`background:var(--se-red-soft,#fbe7e6)`,`color:var(--se-red,#c0201a)`,`border-bottom:1px solid var(--se-red,#c0201a)`,`font:500 12px/1.4 system-ui,sans-serif`,`cursor:pointer`].join(`;`),e.title=`Klicken zum Schließen`,e.addEventListener(`click`,pn),e}function pn(){dn&&=(clearTimeout(dn),null),I?.remove(),I=null}function L(e){typeof document>`u`||!document.body||(I||(I=fn(),document.body.appendChild(I)),I.textContent=e,dn&&clearTimeout(dn),dn=setTimeout(pn,un))}function R(){return globalThis}function mn(){let e=R();return O(e.SEDATA)&&O(e.SEDATA.Daten)}function hn(){let e=R();try{e.selib?.Json?.InitializeERPConnection?.()}catch{}try{typeof e.InitialisiereSchnittstelle==`function`&&e.InitialisiereSchnittstelle()}catch{}}function gn(){let e=R();try{typeof e.ResetDataBasis==`function`&&e.ResetDataBasis()}catch{}try{typeof e.InitialisiereDatenBasis==`function`&&e.InitialisiereDatenBasis()}catch{}}var _n=new Set,vn=new Set;function yn(e){_n.add(e)}function bn(e){return vn.add(e),()=>{vn.delete(e)}}function xn(){_n.forEach(e=>e())}function Sn(){xn()}function Cn(e){vn.forEach(t=>{try{t(e)}catch{}})}function wn(e){let t=jt(e);if(!t){Cn(e);return}let n=R();O(n.SEDATA)||(n.SEDATA={}),n.SEDATA.Daten=t,gn(),xn()}function Tn(e=0){let t=R();if(typeof t.basisHTML_REGISTER==`function`){try{t.basisHTML_SetConsoleLog?.(!0,!0)}catch{}try{t.basisHTML_REGISTER(e=>{wn(e)},document.title,`1.0`)}catch(e){L(`SoftEngine-Anmeldung fehlgeschlagen: `+(e instanceof Error?e.message:String(e)))}return}e<400?setTimeout(()=>{Tn(e+1)},25):L(`SoftEngine-Anschluss nicht gefunden — die Maske bleibt ohne Daten.`)}var En=!1;function Dn(){if(En)return;En=!0,hn();let e=R();e.Erstellen=()=>{gn(),xn()},e.initData=e.Erstellen,e.ReloadData=()=>{xn()},Tn(),window.addEventListener(`message`,e=>{if(typeof R().basisHTML_REGISTER==`function`)return;let t=Mt(e.data);t!==void 0&&wn(t)},!0);let t=0,n=setInterval(()=>{t+=1,mn()?(clearInterval(n),gn(),xn()):t>100&&(clearInterval(n),L(`Keine Daten von SoftEngine empfangen — die Maske zeigt nichts an.`))},300)}function On(e){return e instanceof Error?e.message:String(e)}function kn(e,t){if(!(!Array.isArray(e)||t===``)){for(let n of e)if(!(!O(n)||n.id!==t)&&!(typeof n.verb!=`string`||!sn.includes(n.verb))&&!(typeof n.nr!=`string`||n.nr===``)&&!(!Array.isArray(n.params)||n.params.some(e=>typeof e!=`string`)))return{id:t,verb:n.verb,nr:n.nr,params:n.params}}}var An=[`RESULT`,`result`,`PINDEX`,`pindex`,`INDEX`,`index`,`0_10`,`KEY`,`key`,`ID`,`id`,`VALUE`,`value`];function jn(e){if(typeof e!=`string`)return e;try{return JSON.parse(e)}catch{return}}function Mn(e){if(typeof e==`string`){let t=e.trim();return t===``?void 0:t}if(typeof e==`number`||typeof e==`boolean`)return String(e)}function Nn(e,t){if(t>12)return;let n=Mn(e);if(n!==void 0)return n;if(Array.isArray(e)){for(let n of e){let e=Nn(n,t+1);if(e!==void 0)return e}return}if(O(e)){for(let n of An){if(!(n in e))continue;let r=Nn(e[n],t+1);if(r!==void 0)return r}for(let n of Object.values(e)){let e=Nn(n,t+1);if(e!==void 0)return e}}}function Pn(e){let t=jn(e);if(O(t)){for(let e of An){if(!(e in t))continue;let n=Nn(t[e],0);if(n!==void 0)return n}for(let e of Object.values(t))if(Array.isArray(e))for(let t of e){let e=Pn(t);if(e!==void 0)return e}else if(O(e)){let t=Pn(e);if(t!==void 0)return t}}}var Fn=[`RESULT`,`result`];function In(e,t=0){if(t>12)return;let n=typeof e==`string`?jn(e):e;if(Array.isArray(n)){for(let e of n){let n=In(e,t+1);if(n!==void 0)return n}return}if(O(n)){for(let e of Fn){let t=n[e];if(typeof t==`string`)return t;if(typeof t==`number`||typeof t==`boolean`)return String(t)}for(let e of Object.values(n)){let n=In(e,t+1);if(n!==void 0)return n}}}function Ln(e,t,n=0){if(t.trim()===``||n>12)return``;let r=typeof e==`string`?jn(e):e;if(Array.isArray(r)){for(let e of r){let r=Ln(e,t,n+1);if(r!==``)return r}return``}if(!O(r))return``;let i=A(r,t);if(i!==``)return i;for(let e of Object.values(r)){let r=Ln(e,t,n+1);if(r!==``)return r}return``}function Rn(e){return O(e)?Object.keys(e).filter(e=>/^Message\d+$/.test(e)):[]}function zn(e,t,n=!1){if(!O(e))return;let r=Rn(e).filter(e=>!t.has(e)).sort((e,t)=>Number(t.slice(7))-Number(e.slice(7)));for(let t of r){let r=n?In(e[t]):Pn(e[t]);if(r!==void 0)return{wert:r,roh:e[t]}}}var Bn=[],Vn=!1,Hn=6e3,Un=100;function Wn(){if(Vn||Bn.length===0)return;Vn=!0;let e=Bn.shift(),t=R(),n=new Set(Rn(t.SEDATA)),r=!1,i=(t,n)=>{r||(r=!0,o(),clearInterval(s),clearTimeout(c),Vn=!1,e.resolve({wert:t,roh:n}),queueMicrotask(Wn))},a=e.optionen.satzAntwort===!0,o=bn(e=>{let t=a?In(e):Pn(e);t!==void 0&&i(t,e)}),s=setInterval(()=>{let e=zn(R().SEDATA,n,a);e!==void 0&&i(e.wert,e.roh)},Un),c=setTimeout(()=>{e.optionen.still||L(`Daten laden: SoftEngine hat nicht geantwortet (Relation Nr. ${e.template.nr}).`),i(``,void 0)},Hn);if(typeof t.basisHTML_SND_MSG!=`function`){e.optionen.still||L(`Daten laden nicht möglich: keine Verbindung zu SoftEngine.`),i(``,void 0);return}try{t.basisHTML_SND_MSG(`GET_RELATION`,{NR:e.template.nr,PARAMS:e.params})}catch(t){e.optionen.still||L(`Daten laden fehlgeschlagen (Relation Nr. ${e.template.nr}): ${On(t)}`),i(``,void 0)}}function Gn(e,t,n={}){Dn();let r=R();if(e.verb!==`GET_RELATION`){if(typeof r.basisHTML_SND_MSG!=`function`)return L(`Speichern nicht möglich: keine Verbindung zu SoftEngine. Die Eingabe wurde NICHT übernommen.`),Promise.resolve({wert:``,roh:void 0});try{r.basisHTML_SND_MSG(e.verb,{NR:e.nr,PARAMS:[...t]})}catch(t){L(`Speichern fehlgeschlagen (Relation Nr. ${e.nr}): ${On(t)}`)}return Promise.resolve({wert:``,roh:void 0})}return new Promise(r=>{Bn.push({template:e,params:[...t],resolve:r,optionen:n}),Wn()})}function Kn(e,t){if(!O(t))return``;let n=t.document;if(!n||typeof n.querySelectorAll!=`function`)return``;let r=Array.from(n.querySelectorAll(`[${ht}]`)).find(t=>t.getAttribute(ht)===e.blockId);if(!r)return``;let i=r[e.value];return i==null?``:String(i)}function qn(e,t,n=R()){if(e.source===`aus`)return``;if(e.source===`fixed`)return e.value;if(e.source===`context`)return t.context[e.value]??``;if(e.source===`previous_result`)return t.previousResult;if(e.source===`step_result`){let n=Number(e.value);if(!Number.isInteger(n)||n<0)return``;let r=e.ergebnisFeld??``;return r===``?t.stepResults?.[n]??``:Ln(t.stepRohErgebnisse?.[n],r)}if(e.source===`block_value`)return Kn(e,n);if(e.source===`erfassungszelle`){let n=Number(e.value);return!Number.isInteger(n)||n<0?``:t.erfassteZelle?.(e.blockId??``,n)??``}if(e.source===`gewaehlte_zeile`){let n=t.gewaehlteZeile?.(e.blockId??``);return n===void 0?``:A(n,e.value)}if(!O(n))return``;if(e.source===`se_variable`){let t=n.SEDATA;if(!O(t)||!O(t.Daten)||!O(t.Daten.VARArrays))return``;let r=t.Daten.VARArrays[e.value];return r==null?``:String(r)}let r=k(n.FF_DATA_SOURCES,e.dataSourceId??``);if(!r)return``;let i=At(n.SEDATA,r.name,r.tableId),a=t.context.PINDEX??``,o=a!==``&&r.indexField!==``?i.find(e=>A(e,r.indexField)===a):i[0];return o?A(o,e.value):``}function Jn(e,t){let n=`0,START_TOOL,`+e;return t.length>0&&(n+=`,`+t.map(e=>encodeURIComponent(e)).join(`,`)),n}function Yn(e,t){if(e.trim()===``)return;let n=R();try{if(typeof n.sendBWLinkIntern==`function`){n.sendBWLinkIntern(Jn(e,t));return}}catch{}try{if(typeof n.basisHTML_SND_MSG==`function`){let r={NR:e};t.length>0&&(r.PARAMS=[...t]),n.basisHTML_SND_MSG(`START_TOOL`,r)}}catch{}}function Xn(e,t,n){if(t.trim()===``)return;let r=Array.from(e.querySelectorAll(F.tagName)),i=r.filter(e=>(e.getAttribute(`name`)??F.defaultProps.name)===t);if(i.length===0){L(`Fenster „`+t+`“ gibt es in dieser Maske nicht.`);return}if(i.length>1){L(`Fenster „`+t+`“ gibt es mehrfach — keines ist gemeint.`);return}let a=i[0];if(!n){a.removeAttribute(`offen`);return}for(let e of r)e!==a&&e.removeAttribute(`offen`);a.setAttribute(`offen`,``)}var Zn=new WeakMap;function Qn(e){L(`Aktionskette fehlgeschlagen: `+(e instanceof Error?e.message:String(e)))}function $n(e){let t=new Set;for(let n of e)if(n.type===`RELATION`)for(let e of[...n.params,...n.extraParams])e.source===`erfassungszelle`&&(e.blockId??``)!==``&&t.add(e.blockId??``);return[...t]}function er(e,t){return Array.from(e.querySelectorAll(`[${ht}]`)).find(e=>e.getAttribute(ht)===t)}async function tr(e,t,n,r){let i={...n,NOW_DATE:cn(new Date)},a=``,o=[],s=[],c=()=>{o.push(``),s.push(void 0)};for(let n of t){if(n.type===`START_TOOL`){Yn(n.toolNr,ln({params:n.toolParams},i)),c();continue}if(n.type===`POPUP_OPEN`||n.type===`POPUP_CLOSE`){Xn(e.ownerDocument??document,n.popup??``,n.type===`POPUP_OPEN`),c();continue}let t=kn(R().FF_RELATIONS,n.relationId);if(!t){c();continue}let l={context:i,previousResult:a,stepResults:o,stepRohErgebnisse:s,gewaehlteZeile:Ht,...r?{erfassteZelle:r}:{}},u=await Gn(t,[...n.params,...n.extraParams].map(e=>qn(e,l))),d=u.wert;o.push(d),s.push(u.roh),t.verb===`GET_RELATION`&&(a=d),n.resultKey!==``&&(i[n.resultKey]=d)}}async function nr(e,t,n){if(e.hasAttribute(`data-ff-editor`))return;let r=bt(e.getAttribute(`data-ff-aktionen`))[t];if(!r||r.length===0)return;let i=Zn.get(e);if(i||(i=new Set,Zn.set(e,i)),!i.has(t)){i.add(t);try{let t=$n(r);if(t.length===0){await tr(e,r,n,void 0);return}if(t.length>1){L(`Die Kette liest Erfassungszellen aus mehreren Tabellen — nur eine Tabelle je Kette.`);return}let i=er(e.ownerDocument??document,t[0]),a=i?.erfassteZeilen;if(!i||!Array.isArray(a)){L(`Die Tabelle der Erfassungszellen gibt es in dieser Maske nicht.`);return}for(let i of a)await tr(e,r,n,(e,n)=>e===t[0]?String(i[n]??``):``);a.length>0&&i.erfassungLeeren?.()}finally{i.delete(t)}}}var rr=new WeakSet;function ir(e,t){if(e.hasAttribute(`data-ff-editor`)||!e.hasAttribute(`data-ff-aktionen`)||rr.has(e))return;rr.add(e);let n=bt(e.getAttribute(`data-ff-aktionen`));Object.values(n).some(e=>e.some(e=>e.type===`RELATION`))&&Dn(),e.addEventListener(`click`,()=>{nr(e,t,{}).catch(Qn)})}var ar=class extends E{constructor(...e){super(...e),this.label=`Klick mich`}static{this.blockType=`button`}static{this.tagName=`ff-button`}static{this.displayName=`Schaltfläche`}static{this.category=`eingabe`}static{this.defaultProps={label:`Klick mich`}}static{this.resizableWidth=!1}static{this.blockEvents=[{key:`onClick`,name:`Klick`}]}static{this.raster={startW:4,startH:2,minW:2,minH:2}}static{this.customProperties=[]}static{this.styles=[E.styles,o`
      button {
        box-sizing: border-box;
        padding: 7px 16px;
        cursor: pointer;
    ...
    >${this.label}</button>`}connectedCallback(){super.connectedCallback(),ir(this,`onClick`)}};T([C()],ar.prototype,`label`,void 0),E.defineAndRegister(ar);var or=[`info`,`success`,`warning`,`danger`];function sr(e){return or.includes(e)?e:`info`}var cr=[{wert:`info`,name:`Hinweis`},{wert:`success`,name:`Erfolg`},{wert:`warning`,name:`Warnung`},{wert:`danger`,name:`Fehler`}];function lr(e,t){return{attributeName:e,name:`Bedeutung`,description:t,kind:`select`,options:cr.map(e=>({value:e.wert,label:e.name}))}}var ur=o`
...
`,z=class extends E{constructor(...e){super(...e),this.chipVariant=`info`,this.heading=``,this.heading2=``,this.time=``,this.date=``,this.avatar=``,this.meta=``,this.text=``,this.chipText=``,this.headingField=``,this.heading2Field=``,this.timeField=``,this.dateField=``,this.avatarField=``,this.metaField=``,this.textField=``,this.chipTextField=``}static{this.blockType=`card`}static{this.tagName=`ff-card`}static{this.displayName=`Karte`}static{this.category=`anzeige`}static{this.allowedParentTypes=[`kanban-spalte`,`kanban-zimmer`]}static{this.showInPalette=!1}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={chipVariant:`info`,heading:``,heading2:``,time:``,date:``,avatar:``,meta:``,text:``,chipText:``,headingField:``,heading2Field:``,timeField:``,dateField:``,avatarField:``,metaField:``,textField:``,chipTextField:``}}static{this.bindableSpots=[{prop:`time`,label:`Zeit`},{prop:`date`,label:`Datum`},{prop:`avatar`,label:`Avatar`},{prop:`heading`,label:`Titel`},{prop:`heading2`,label:`Titel 2`},{prop:`meta`,label:`Unterzeile`},{prop:`text`,label:`Textzeile`},{prop:`chipText`,label:`Chip`}]}static{this.customProperties=[lr(`chipVariant`,`Bedeutung des Chips auf der Karte — bestimmt die Chip-Farbe.`)]}static{this.styles=[E.styles,ur,vr]}stelle(e,t){return _`<span
    ...
    >${this[e]}</span>`}hatReiter(){return this.hasAttribute(`data-ff-editor`)||this.date.trim()!==``||this.time.trim()!==``}updated(e){super.updated(e),this.toggleAttribute(`hat-reiter`,this.hatReiter())}render(){let e=sr(this.chipVariant),t=this.hasAttribute(`data-ff-editor`),n=e=>t||e.trim()!==``,r=this.hatReiter(),i=n(this.avatar)||n(this.heading)||n(this.meta),a=n(this.heading2)||n(this.chipText);return _`<div class="card v-${e}${r?``:` ohne-reiter`}">
      ...
      ${i?_`<div class="kopf">
            ${n(this.avatar)?_`<span
                ...
                >${this.avatar.trim()===``?y:_r(this.avatar)}</span>`:y}
            <div class="namen">
    ...
    `]}setzeTag(e){Tr(e),this.tag=wr()}render(){return _`<div class="waehler">
      <div class="riegel">
    ...
    </div>`}connectedCallback(){super.connectedCallback(),this.tag=wr()||br(new Date),!this.hasAttribute(`data-ff-editor`)&&(this.setzeTag(this.tag),this.tagAbmelden?.(),this.tagAbmelden=Er(()=>{this.tag=wr()}))}disconnectedCallback(){super.disconnectedCallback(),this.tagAbmelden?.(),this.tagAbmelden=null}};T([w()],Dr.prototype,`tag`,void 0),E.defineAndRegister(Dr);function Or(e){return e.trim().toLowerCase().split(/\s+/).filter(e=>e!==``)}function kr(e,t){let n=Or(t);if(n.length===0)return!0;let r=e.join(` `).toLowerCase();return n.every(e=>r.includes(e))}function Ar(e,t,n=8){if(t.trim()===``)return[];let r=[];for(let i of e)if(kr([i.anzeige,i.wert],t)&&(r.push(i),r.length>=n))break;return r}function jr(e,t,n){return t<=0?0:((e+n)%t+t)%t}function Mr(e,t){return t<=0||e<0||e>=t?0:e}function Nr(e,t){return e===`ArrowDown`?t.listeOffen?`marke-runter`:`nichts`:e===`ArrowUp`?t.listeOffen?`marke-hoch`:`nichts`:e===`Escape`?t.listeOffen?`liste-zu`:`nichts`:e===`Enter`?t.listeOffen?`uebernehmen`:t.feldLeer?`fenster`:`nichts`:`nichts`}function Pr(e){return _`<ul
    class="vorschlaege"
  ...
  >${e.eintraege.map((t,n)=>_`<li
    ...
    ><span class="vorschlag-anzeige">${t.anzeige===``?t.wert:t.anzeige}</span>${t.wert!==``&&t.wert!==t.anzeige?_`<span class="vorschlag-wert">${t.wert}</span>`:y}</li>`)}</ul>`}var Fr=o`
  .vorschlaege {
    position: absolute;
    top: 100%;
    left: 0;
...
`;function B(e,t,n,r){return{attributeName:e,name:t,description:n,kind:`segment`,options:[{value:`nein`,label:`Nein`},{value:`ja`,label:`Ja`}],...r}}var Ir={attributeName:`fieldType`,equals:`nachschlagen`},Lr=[{attributeName:`fieldType`,name:`Feldtyp`,description:`Welche Art Eingabe das Feld annimmt.`,kind:`select`,options:[{value:`text`,label:`Text`},{value:`number`,label:`Zahl`},{value:`textarea`,label:`Mehrzeilig`},{value:`select`,label:`Auswahl`},{value:`date`,label:`Datum`},{value:`time`,label:`Uhrzeit`},{value:`checkbox`,label:`Ankreuzfeld`},{value:`nachschlagen`,label:`Nachschlagen`}]},{attributeName:`options`,name:`Auswahl-Optionen`,description:`Nur bei Feldtyp "Auswahl": Einträge durch Komma getrennt (z. B. "Zimmer 1, Zimmer 2") — jeder Eintrag wird eine Dropdown-Zeile.`,kind:`text`,visibleWhen:{attributeName:`fieldType`,equals:`select`}},{attributeName:`nachschlagQuelle`,name:`Quelle`,description:`Nur bei Feldtyp "Nachschlagen": aus dieser Datenquelle wählt der Bediener eine Zeile.`,kind:`quelle`,visibleWhen:Ir},{attributeName:`speicherFeld`,name:`Gespeichert wird`,description:`Feld der Nachschlage-Quelle, dessen Wert die Maske sich merkt und die Kette "Wert geändert" weitergibt (z. B. die Nummer). Im Feld sichtbar ist die erste Spalte des Nachschlage-Fensters — ohne eigene Spalten ist das dieser Wert selbst.`,kind:`field`,quelleProp:`nachschlagQuelle`,klarnameProp:`speicherTitel`,visibleWhen:Ir},B(`einzigerTreffer`,`Einzigen Treffer übernehmen`,`Bleibt in der Maske genau EIN Satz übrig (weil das Feld der Auswahl eines anderen folgt), übernimmt es diesen von selbst — ohne dass der Bediener die Lupe drückt. Nur in ein leeres Feld; die Lupe bleibt daneben bedienbar.`,{visibleWhen:Ir}),{attributeName:`valueField`,name:`Feld`,description:`Feld der angeschlossenen Datenquelle, dessen Wert angezeigt und lokal aktualisiert wird.`,kind:`field`,visibleWhen:{attributeName:`fieldType`,keinesVon:[`checkbox`,`nachschlagen`]}}],Rr=999,zr=`0`,Br=`255`,Vr=new Map;function Hr(e){let t=Tt(e);wt(e,[]),t!==void 0&&t.length>0&&Sn()}async function Ur(e,t,n,r,i){return(await Gn({id:`relation-lader`,verb:`GET_RELATION`,nr:e.nr,params:[]},[t.belegart,r,i,t.belegnummer,t.jahr,t.archiv,``,String(n),``,``,``,``],{still:!0,satzAntwort:!0})).wert}function Wr(e,t,n){let r=(Vr.get(e.id)??0)+1;if(Vr.set(e.id,r),n===void 0){Hr(e.name);return}let i={belegart:A(n,t.belegartFeld),belegnummer:A(n,t.belegnummerFeld),jahr:t.jahrFeld===``?``:A(n,t.jahrFeld),archiv:t.archivFeld===``?``:A(n,t.archivFeld)};if(i.belegart===``||i.belegnummer===``){Hr(e.name);return}Hr(e.name),(async()=>{let n=[],a=!1;for(let o=1;o<=Rr;o+=1){let s=await Ur(t,i,o,zr,Br);if(Vr.get(e.id)!==r)return;if(t.endeFelder.every(e=>A({SATZ:s},e)===``)){a=!0;break}let c={SATZ:s};for(let n of t.zusatzFelder){let a=n.indexOf(`_`),s=await Ur(t,i,o,n.slice(0,a),n.slice(a+1));if(Vr.get(e.id)!==r)return;c[n]=s}n.push(c)}a||L(`Positionen laden: nach ${Rr} Zeilen ohne Ende-Kennung abgebrochen (Relation Nr. ${t.nr}) — die Liste ist wahrscheinlich unvollständig, vermutlich passen Relationsnummer oder Ende-Felder nicht.`),Vr.get(e.id)===r&&(wt(e.name,n),Sn())})()}var Gr=new Map,Kr=!1;function qr(){let e=new Map;for(let t of Ye())t.satzWahl&&e.set(t.tagName.toLowerCase(),(t.satzWahl.quelleProp??`source`).toLowerCase());return e}function Jr(e,t,n=typeof document>`u`?void 0:document){if(e===``||n===void 0)return;let r=null;for(let i of Array.from(n.querySelectorAll(`[data-ff-id]`))){let n=t.get(i.tagName.toLowerCase());if(n===void 0||i.getAttribute(n)!==e)continue;let a=i.getAttribute(`data-ff-id`)??``,o=Ht(a);if(o===void 0)continue;let s=Wt(a);(r===null||s>r.nummer)&&(r={zeile:o,nummer:s})}return r?.zeile}function Yr(){let e=R().FF_DATA_SOURCES;if(!Array.isArray(e))return;let t=qr();for(let n of e){if(!O(n)||typeof n.id!=`string`)continue;let r=k(e,n.id);if(!r?.ladeRelation)continue;let i=Jr(r.ladeRelation.geberQuelleId,t),a=Pt(i);Gr.get(r.id)!==a&&(Gr.set(r.id,a),Wr(r,r.ladeRelation,i))}}function Xr(){Kr||(Kr=!0,Vt(Yr),Yt(()=>Gr.clear()))}function Zr(e){let t=new Set,n=!1,r=()=>{mn()&&t.forEach(e.hydriere)};return{connect:i=>{i.hasAttribute(`data-ff-editor`)||(t.add(i),e.verdrahte?.(i),n||(n=!0,yn(r),Er(r),Vt(r),Xr()),Dn(),mn()&&e.hydriere(i))},disconnect:e=>{t.delete(e)}}}var Qr=at.toLowerCase(),$r=``;function ei(e){if(e.length===0)return``;let t=[];for(let n of e){let e=n.trim();if(e===``)return``;t.push(e)}return t.join($r)}function ti(e){return Nt(e,Qr,`quelleId`).map(e=>({quelleId:e.id,keyPairs:e.keyPairs}))}function ni(e){let t=ti(e);if(t.length===0)return(e,t)=>A(e,rt(t).code);let n=R().SEDATA,r=R().FF_DATA_SOURCES,i=new Map;for(let e of t){let t=k(r,e.quelleId);if(!t)continue;let a=At(n,t.name,t.tableId),o=new Map;for(let t of a){let n=ei(e.keyPairs.map(e=>A(t,e.toField)));n!==``&&!o.has(n)&&o.set(n,t)}i.set(e.quelleId,{nachSchluessel:o,hierFelder:e.keyPairs.map(e=>e.fromField)})}return(e,t)=>{let{quelleId:n,code:r}=rt(t);if(n===``)return A(e,r);let a=i.get(n);if(!a)return``;let o=ei(a.hierFelder.map(t=>A(e,t)));if(o===``)return``;let s=a.nachSchluessel.get(o);return s===void 0?``:A(s,r)}}function ri(e,t){let n=e.getAttribute(`source`)??``,r=e.getAttribute(t)??``;if(n===``||r===``)return{art:`ungebunden`};let i=k(R().FF_DATA_SOURCES,n);if(!i)return{art:`ohneQuelle`};let a=$t(e,At(R().SEDATA,i.name,i.tableId));if(a===void 0)return{art:`ohneZeile`};let{quelleId:o,code:s}=rt(r);return{art:`wert`,wert:o===``?A(a,s):ni(e)(a,r),zeile:a,quelle:i,quelleId:o,reinerCode:s}}var ii=new WeakMap,ai=new WeakSet;function oi(e){let t=/^(\d{2})\.(\d{2})\.(\d{4})$/.exec(e);return t?`${t[3]}-${t[2]}-${t[1]}`:e}function si(e){let t=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);return t?`${t[3]}.${t[2]}.${t[1]}`:e}function ci(e){return typeof e.value==`string`?e.value:``}function li(e){if(e.pruefeEigenenWert?.(),e.getAttribute(`fieldtype`)===`nachschlagen`){ii.delete(e);return}let t=ri(e,nt(`value`));if(t.art!==`wert`){ii.delete(e),t.art===`ohneZeile`&&(e.value=``);return}let{zeile:n,quelle:r,quelleId:i,reinerCode:a,wert:o}=t,s=Dt(r,n);i===``?ii.set(e,{row:n,code:a,pindex:s}):ii.delete(e),e.value=o}function ui(e){let t=ii.get(e);return t&&Ot(t.row,t.code,ci(e)),t}function di(e){ai.has(e)||(ai.add(e),e.addEventListener(`input`,()=>{ui(e)}),e.addEventListener(`change`,()=>{let t=ui(e);nr(e,`onChange`,{VALUE:ci(e),PINDEX:t?.pindex??``}).catch(Qn)}))}var fi=Zr({hydriere:li,verdrahte:di}),pi=fi.connect,mi=fi.disconnect,hi=o`
  .feld {
    font-family: var(--se-font);
...
`,gi=[`text`,`number`,`textarea`,`select`,`date`,`time`,`checkbox`,`nachschlagen`];function _i(e){return gi.includes(e)?e:`text`}var vi=[`text`,`number`,`textarea`,`select`,`nachschlagen`,`date`,`time`],yi={select:`ph-select`,date:`ph-nativ`,time:`ph-nativ`,nachschlagen:`ph-nachschlag`};function bi(){return _`<svg viewBox="0 0 16 16" width="14" height="14" aria-hidden="true">
    ...
    </svg>`}var xi=4;function Si(e){return e??xi}function Ci(e,t,n){return Math.max(1,Math.floor((e-t)/n))}function wi(e,t,n){let r=Ci(e,t,n),i=e-t;return i<n?{passen:r,zeilenHoehe:n}:{passen:r,zeilenHoehe:Math.floor(i/r*100)/100}}function Ti(e,t){return e===null?null:Math.max(0,e-t)}function Ei({sichtbar:e,hatQuelle:t,proSeite:n,wunschSeite:r,platzhalterZeilen:i}){let a=t?Math.max(1,Math.ceil(e.length/n)):1,o=Math.min(Math.max(r,0),a-1);return t?{seiten:a,seite:o,zeilen:[...e.slice(o*n,(o+1)*n)]}:{seiten:a,seite:o,zeilen:Array.from({length:i},()=>null)}}function Di(e,t){let n=t.trim().toLowerCase();return e.find(e=>e.wert.trim().toLowerCase()===n)}var V=`text`,Oi=`status`,ki=`bild`,Ai=`bild`,ji=`unter`,Mi=[{wert:V,name:`Text`,spur:`minmax(0, 1fr)`,klasse:``,zelle:e=>e},{wert:`zahl`,name:`Zahl`,spur:`90px`,klasse:`zahl`,zelle:e=>e},{wert:`datum`,name:`Datum`,spur:`100px`,klasse:`zahl`,zelle:e=>e},{wert:Oi,name:`Status`,spur:`120px`,klasse:`status`,zelle:(e,t)=>{let n=Di(t,e);return n?_`<span class="chip v-${sr(n.bedeutung)}">${n.name.trim()===``?e:n.name}</span>`:_`<span class="chip">${e}</span>`}},{wert:ki,name:`Bild + Name`,spur:`minmax(0, 1fr)`,klasse:`bild`,zusatzFelder:[{key:Ai,label:`Bild`},{key:ji,label:`Unterzeile`}],hoehe:e=>(e[Ai]??``)!==``||(e[ji]??``)!==``?44:32,zelle:(e,t,n)=>{let r=gr(n[Ai]??``),i=n[ji]??``;return _`<div class="bild-name">
        ${r===void 0?y:_`<span class="bild-zeichen">${r}</span>`}
        <div class="bild-text">
          <div class="bild-titel">${e}</div>
          ${i===``?y:_`<div class="bild-unter">${i}</div>`}
        </div>
      </div>`}}];function Ni(e){return e.reduce((e,t)=>{let n=H(t.art);return Math.max(e,n.hoehe?.(t.felder??{})??32)},32)}function H(e){return Mi.find(t=>t.wert===e)??Mi[0]}var Pi=Mi.map(e=>({wert:e.wert,name:e.name,...e.zusatzFelder?{felder:e.zusatzFelder}:{}})),Fi=`felder`,Ii=`suchtIn`,Li=`Spalte {n}`;function Ri(e){return Li.replace(`{n}`,String(e+1))}function U(e){return{titel:Ri(e),feld:``,art:V}}function zi(){return[0,1,2].map(e=>U(e))}function Bi(e){return Array.isArray(e)?e.filter(e=>!!e&&typeof e==`object`).map(e=>({wert:typeof e.wert==`string`?e.wert:``,name:typeof e.name==`string`?e.name:``,bedeutung:typeof e.bedeutung==`string`?e.bedeutung:``})).filter(e=>e.wert.trim()!==``):[]}function Vi(e){if(!e||typeof e!=`object`||Array.isArray(e))return{};let t={};for(let[n,r]of Object.entries(e))typeof r==`string`&&r!==``&&(t[n]=r);return t}function Hi(e,t){if(e&&typeof e==`object`){let n=e,r=Bi(n.zuordnung),i=Vi(n.felder),a=typeof n.suchtIn==`string`?n.suchtIn.trim():``;return{titel:typeof n.titel==`string`?n.titel:Ri(t),feld:typeof n.feld==`string`?n.feld:``,art:typeof n.art==`string`?n.art:V,...a===``?{}:{suchtIn:a},...r.length>0?{zuordnung:r}:{},...Object.keys(i).length>0?{felder:i}:{}}}return typeof e==`string`?{...U(t),titel:e}:U(t)}function Ui(e){let t;if(Array.isArray(e))t=e.map((e,t)=>Hi(e,t));else if(typeof e==`number`&&Number.isFinite(e)||typeof e==`string`&&/^\d+$/.test(e)){let n=Math.max(1,Math.floor(Number(e)));t=[...Array(n).keys()].map(e=>U(e))}else t=zi();return t.length>8&&(t=t.slice(0,8)),t.length<1&&(t=[U(0)]),t}function Wi(e){try{return Ui(JSON.parse(e))}catch{return zi()}}var Gi={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Ki=e=>(...t)=>({_$litDirective$:e,values:t}),qi=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},Ji=`important`,Yi=` !important`,W=Ki(class extends qi{constructor(e){if(super(e),e.type!==Gi.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(Yi);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?Ji:``):n[e]=r}}return v}}),Xi=`Keine Datensätze.`;function Zi(){return{attributeName:`leerText`,name:`Text ohne Datensätze`,description:`Steht in der Maske dort, wo sonst die Zeilen stehen — wenn die Datenquelle keine liefert. Leer lassen: dann steht dort gar nichts.`,kind:`text`,requiresDataSource:!0}}function Qi(e,t=!1){return e.trim()===``?y:_`<div class="leer${t?` leer--tafel`:``}">
    ${fr()}
    <span>${e}</span>
  </div>`}var $i=o`
  .leer {
...
`;function ea(e,t){if(!e.hasAttribute(`fuellt`))return null;let n=e.renderRoot.querySelector(`.koerper`);if(!(n instanceof HTMLElement))return null;let r=e.renderRoot.querySelector(`.kopf`),i=r instanceof HTMLElement?r.offsetHeight:0;return wi(n.clientHeight,i,t)}function ta(e,t){if(typeof ResizeObserver>`u`)return null;let n=e.renderRoot.querySelector(`.koerper`);if(!n)return null;let r=new ResizeObserver(t);return r.observe(n),r}function na(e,t){return e.verknuepfungen.find(e=>e.quelleId===t)?.keyPairs??[]}function ra(e,t,n){return ct(e?.feld??``,e?.suchtIn??``,t,n)}function G(e,t){return ra(e.spalten[t],e.quelleId,e.verknuepfungen)}function ia(e){let t=[],n=e=>{e!==``&&!t.includes(e)&&t.push(e)};for(let t=0;t<e.spalten.length;t++){let r=G(e,t);r.art===`auswahl`&&n(r.quelleId),n(r.suchQuelleId)}return t}function aa(e,t){let n=G(e,t);if(n.suchQuelleId===``)return;let r=n.quelleId===n.suchQuelleId?n.code:``;for(let i=0;i<e.spalten.length;i++){if(i===t)continue;let a=G(e,i);if(!(a.art!==`auswahl`||a.quelleId!==n.suchQuelleId)&&!(a.code===``||a.code===r))return{titel:e.spalten[i].titel,code:a.code}}}function oa(e,t){let n=e.spalten[t],r=aa(e,t),i=G(e,t);if(n===void 0||r===void 0)return[];let a=i.quelleId===i.suchQuelleId?i.code:``,o={titel:r.titel,feld:r.code,art:V};return a===``?[o]:[o,{titel:n.titel,feld:a,art:V}]}function sa(e,t,n){let r=e.map(e=>({toField:e.toField,soll:t(e.fromField)})).filter(e=>e.soll!==void 0);return r.length===0?[...n]:n.filter(e=>r.every(t=>t.soll!==``&&t.soll===A(e,t.toField)))}function ca(e,t,n){return _`<input
    class="erf-eingabe"
    type="text"
    ...
    @blur=${()=>t.verlassen(n)}
  />`}function la(e,t,n,r){if(!r)return ca(e,t,n);let i=e.tippSpalte===n&&e.vorschlaege.length>0;return _`<div class=${e.listeNachOben?`erf-halter nach-oben`:`erf-halter`}>
    ${ca(e,t,n)}
    ${i?Pr({eintraege:e.vorschlaege,marke:e.marke,onWaehlen:e=>t.waehleVorschlag(e),onMarke:e=>t.setzeMarke(e)}):y}
  </div>`}function ua(e,t){return _`<div class="zeile erfassung" role="row" style=${W(e.cols)}>
    ${e.umfeld.spalten.map((n,r)=>{let i=H(n.art).klasse;if(e.imEditor){let t=e.zellenGriff;return _`<div
          class=${i}
          role="cell"
          data-ff-editable=${t?``:y}
          @click=${t?e=>t(e,r):y}
        >${`—`}</div>`}return _`<div class=${i} role="cell">${la(e,t,r,G(e.umfeld,r).suchQuelleId!==``)}</div>`})}
  </div>`}function da(e,t,n){let r=e.lauf.vorschlaege[n];r!==void 0&&(e.lauf.uebernimm(e.umfeld(),t,r.satz),e.melde())}function fa(e,t){let n=e.umfeld(),r=n.spalten[t],i=G(n,t);r===void 0||i.suchQuelleId===``||jo({el:e.baustein,quelleId:i.suchQuelleId,speicherFeld:i.quelleId===i.suchQuelleId?i.code:``,speicherTitel:r.titel,spalten:oa(n,t),titel:r.titel,breite:520,hoehe:380,eintraege:e.lauf.eintraege(n,t),rueckFokus:null,onUebernehmen:(n,r,i)=>{e.lauf.uebernimm(e.umfeld(),t,i),e.melde()}})}function pa(e,t,n){let r=e.lauf.naechsteLeere(e.umfeld(),t);r===-1?n&&e.erfasseZeile():e.fokussiere(r)}function ma(e,t,n){if(n.key===`Tab`&&n.shiftKey)return;let r=e.lauf.entscheideTaste(e.umfeld(),t,n.key);if(r===`nichts`){n.key===`Enter`&&n.preventDefault();return}n.preventDefault();let i=n.key===`Enter`;r===`uebernehmen`?(da(e,t,e.lauf.marke),pa(e,t,i)):r===`fenster`?fa(e,t):r===`weiter`?pa(e,t,i):r===`leeren`&&e.lauf.leere(e.umfeld(),t),e.melde()}function ha(e,t,n,r){let i=e.umfeld();return ua({umfeld:i,cols:t,imEditor:e.baustein.hasAttribute(`data-ff-editor`),...r?{zellenGriff:r}:{},wert:t=>e.lauf.wertVon(i,t),tippSpalte:e.lauf.tippSpalte,vorschlaege:e.lauf.vorschlaege,marke:e.lauf.marke,listeNachOben:n},{tippen:(t,n)=>{e.lauf.tippe(t,n),e.melde()},taste:(t,n)=>ma(e,t,n),verlassen:t=>{e.lauf.verlasse(t),e.melde()},waehleVorschlag:t=>da(e,e.lauf.tippSpalte,t),setzeMarke:t=>{e.lauf.setzeMarke(t),e.melde()}})}var ga=class{constructor(){this.getippt=new Map,this.gewaehlt=new Map,this.vonHand=new Map,this._wahlZaehler=0,this._tippSpalte=-1,this._marke=0,this._listeZu=!1,this._vorschlaege=[]}get tippSpalte(){return this._tippSpalte}get marke(){return this._marke}get vorschlaege(){return this._vorschlaege}wertVon(e,t){let n=this.getippt.get(t);if(n!==void 0)return n;let r=G(e,t);if(r.art!==`auswahl`||r.code===``)return``;let i=this.gewaehlt.get(r.quelleId);return i===void 0?``:A(i,r.code)}tippe(e,t){this.getippt.set(e,t),this._tippSpalte=e,this._marke=0,this._listeZu=!1}verlasse(e){this._tippSpalte===e&&(this._tippSpalte=-1,this._listeZu=!1,this._marke=0)}entscheideTaste(e,t,n){let r=this._tippSpalte===t&&this._vorschlaege.length>0;if(n===`Tab`){if(!r)return`weiter`;n=`Enter`}let i=this.wertVon(e,t);if(n===`Escape`&&!r)return i===``?`nichts`:`leeren`;if(G(e,t).suchQuelleId===``)return n===`Enter`?`weiter`:`nichts`;let a=Nr(n,{listeOffen:r,feldLeer:i===``});if(a===`marke-hoch`)this._marke=jr(this._marke,this._vorschlaege.length,-1);else if(a===`marke-runter`)this._marke=jr(this._marke,this._vorschlaege.length,1);else if(a===`liste-zu`)this._listeZu=!0;else if(a===`fenster`&&this.eintraege(e,t).length===0)return`weiter`;else if(a===`nichts`&&n===`Enter`&&i!==``&&this.getippt.get(t)===void 0)return`weiter`;return a}naechsteLeere(e,t){for(let n=t+1;n<e.spalten.length;n++)if(this.wertVon(e,n)===``)return n;return-1}leere(e,t){this.getippt.delete(t);let n=G(e,t);for(let t of[n.quelleId,n.suchQuelleId])t!==``&&this.gewaehlt.has(t)&&this.setze(e,t,void 0);this._listeZu=!1,this._marke=0}setzeMarke(e){this._marke=e}uebernimm(e,t,n){let r=G(e,t).suchQuelleId;r!==``&&(this.setze(e,r,n),this._wahlZaehler+=1,this.vonHand.set(r,this._wahlZaehler),this.gleicheAb(e),this._tippSpalte=-1,this._marke=0,this._listeZu=!1)}setze(e,t,n){n===void 0?(this.gewaehlt.delete(t),this.vonHand.delete(t)):this.gewaehlt.set(t,n);for(let n=0;n<e.spalten.length;n++)G(e,n).quelleId===t&&this.getippt.delete(n)}schluesselWert(e,t,n,r=()=>!0){for(let i of ia(e)){if(i===n)continue;let a=this.vonHand.get(i);if(a===void 0||!r(a))continue;let o=this.gewaehlt.get(i);if(o!==void 0)for(let n of na(e,i)){if(n.fromField!==t)continue;let e=A(o,n.toField);if(e!==``)return e}}}moegliche(e,t,n,r){return sa(na(e,t),n=>this.schluesselWert(e,n,t,r),n)}gleicheAb(e){let t=ia(e);for(let n=0;n<=t.length;n++){let n=!1;for(let r of t){let t=na(e,r);if(t.length===0)continue;let i=this.gewaehlt.get(r);if(i!==void 0){let a=this.vonHand.get(r)??-1/0;t.every(t=>{let n=this.schluesselWert(e,t.fromField,r,e=>e>a);return n===void 0||n!==``&&n===A(i,t.toField)})||(this.setze(e,r,void 0),n=!0);continue}if(!t.some(t=>this.schluesselWert(e,t.fromField,r)!==void 0))continue;let a=_o(r);if(a===null)continue;let o=this.moegliche(e,r,a);o.length===1&&(this.setze(e,r,o[0]),this.vonHand.delete(r),n=!0)}if(!n)break}}zuruecksetzen(){this.getippt.clear(),this.gewaehlt.clear(),this.vonHand.clear(),this._tippSpalte=-1,this._marke=0,this._listeZu=!1,this._vorschlaege=[]}aktualisiereVorschlaege(e){this._vorschlaege=this.berechne(e),this._marke=Mr(this._marke,this._vorschlaege.length)}berechne(e){let t=this._tippSpalte;if(this._listeZu||G(e,t).suchQuelleId===``)return[];let n=this.getippt.get(t)??``;return n===``?[]:Ar(this.eintraege(e,t),n)}eintraege(e,t){let n=G(e,t),r=n.suchQuelleId;if(r===``)return[];let i=_o(r);if(i===null)return[];let a=this.vonHand.get(r)??1/0;return ho(this.moegliche(e,r,i,e=>e<a),aa(e,t)?.code??``,n.quelleId===r?n.code:``)}},_a=class{constructor(){this.lauf=new ga,this._zeilen=[]}get zeilen(){return this._zeilen}umfeld(e,t,n){return{spalten:t,quelleId:n,verknuepfungen:ti(e)}}erfasse(e){let t=e.spalten.map((t,n)=>this.lauf.wertVon(e,n));return t.every(e=>e===``)?!1:(this._zeilen=[...this._zeilen,t],this.lauf.zuruecksetzen(),!0)}leeren(){return this._zeilen.length===0?!1:(this._zeilen=[],!0)}zuruecksetzen(){this._zeilen=[],this.lauf.zuruecksetzen()}},va=o`
      .zeile.erfassung {
        flex: none;
        background: var(--se-panel-2);
...
`;function ya(e){return{rohzeilen:e.map(e=>e.rohzeile),datenzeilen:e.map(e=>[...e.zellen]),zusatzzeilen:e.map(e=>(e.zusatz??[]).map(e=>({...e})))}}function ba(e,t,n){return t===``||n===``?[...e]:e.filter(e=>yr(A(e,t))===n)}function xa(e){let t=e.getAttribute(`source`)??``;if(t===``)return null;let n=k(R().FF_DATA_SOURCES,t);return n?{quelle:n,zeilen:ba(At(R().SEDATA,n.name,n.tableId),e.getAttribute(`tagfield`)??``,wr()),lies:ni(e)}:null}function Sa(e){return Wi(e.getAttribute(`spalten`)??``)}function Ca(e,t,n){let r={};for(let i of H(e.art).zusatzFelder??[]){let a=e.felder?.[i.key]??``;a!==``&&(r[i.key]=n(t,a))}return r}function wa(e,t){let n=k(R().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return n?Dt(n,t):``}function Ta(e){let t=xa(e);if(!t){e.datenzeilen=[],e.zusatzzeilen=[];return}let n=Sa(e),{rows:r,gefiltert:i}=Qt(e,t.zeilen),a=Gt(N(e),r,e=>e)[0]??-1,o=t.lies;e.datenGeliefert=!0,e.rohzeilen=r,e.auswahlIndex=a,e.durchAuswahlGefiltert=i,e.datenzeilen=r.map(e=>n.map(t=>t.feld===``?``:o(e,t.feld))),e.zusatzzeilen=r.map(e=>n.map(t=>Ca(t,e,o)))}var Ea=Zr({hydriere:Ta}),Da=Ea.connect,Oa=Ea.disconnect;function ka(e,t){let n=[];return e.forEach((e,r)=>{kr(e,t)&&n.push(r)}),n}function Aa(e,t){return!e&&t.trim()!==``}function ja(e,t,n){return e&&t&&n===0}function Ma(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}function Na(e,t,n){return _`<div class="steuerung">
    <button
    ...
    >+</button>
  </div>`}function Pa(e,t){let n=e.currentTarget;n&&(e.stopPropagation(),e.preventDefault(),dt(n,(e,n)=>e===``||e===n.trim()?!1:(t(e),!0)))}function Fa(e,t,n,r){Pa(e,e=>{let i=n();t>=i.length||(i[t]={...i[t],titel:e},r(i))})}var Ia=220,La=new WeakMap;function Ra(e){let t=La.get(e);t!==void 0&&(clearTimeout(t),La.delete(e))}function za(e,t,n){t.stopPropagation();let r=t.currentTarget.getBoundingClientRect();Ra(e),La.set(e,setTimeout(()=>{La.delete(e),e.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:n.prop,index:n.index,top:r.bottom+4,left:r.left,...n.liste?{liste:n.liste()}:{}},bubbles:!0,composed:!0}))},Ia))}var Ba={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:Li,eintragsWahl:{key:`art`,label:`Darstellung`,optionen:Pi,standard:V,felderKey:Fi},eintragsQuellenWahl:{key:Ii,label:`Sucht beim Erfassen in`,leerName:`frei`,nurBeiErfassung:!0},eintragsZuordnung:{key:`zuordnung`,label:`Status-Zuordnung`,nurBeiWahl:Oi,wertLabel:`Datenwert`,nameLabel:`Klarname`,bedeutungLabel:`Bedeutung`,bedeutungen:cr}},Va=1,Ha=/^-?\d{1,3}(\.\d{3})*(,\d+)?$|^-?\d+(,\d+)?$|^-?\d+(\.\d+)?$/,Ua=/^(\d{1,2})\.(\d{1,2})\.(\d{2}|\d{4})$/,Wa=/^(\d{4})-(\d{2})-(\d{2})$/;function Ga(e){let t=e.trim();if(t===``||!Ha.test(t))return null;let n=t.includes(`,`)?t.replace(/\./g,``).replace(`,`,`.`):/^-?\d{1,3}(\.\d{3})+$/.test(t)?t.replace(/\./g,``):t,r=Number(n);return Number.isFinite(r)?r:null}function Ka(e){let t=e.trim();if(t===``)return null;let n=Wa.exec(t);if(n){let[,e,t,r]=n;return qa(Number(e),Number(t),Number(r))}let r=Ua.exec(t);if(r){let[,e,t,n]=r,i=Number(n);return qa(n.length===2?i<=69?2e3+i:1900+i:i,Number(t),Number(e))}return null}function qa(e,t,n){if(t<1||t>12||n<1||n>31)return null;let r=new Date(e,t-1,n);return r.getFullYear()!==e||r.getMonth()!==t-1||r.getDate()!==n?null:r.getTime()}function Ja(e){let t=0,n=0,r=0;for(let i of e)i.trim()!==``&&(t++,Ga(i)!==null&&n++,Ka(i)!==null&&r++);return t===0?`text`:r===t?`datum`:n===t?`zahl`:`text`}var Ya=new Intl.Collator(`de`,{numeric:!0,sensitivity:`base`});function Xa(e,t,n){if(t<0||e.length===0)return e.map((e,t)=>t);let r=n=>e[n][t]??``,i=Ja(e.map(e=>e[t]??``)),a=n?1:-1;return e.map((e,t)=>t).sort((e,t)=>{let n=r(e).trim(),o=r(t).trim();if(n===``&&o===``)return e-t;if(n===``)return Va;if(o===``)return-1;let s=i===`zahl`?(Ga(n)??0)-(Ga(o)??0):i===`datum`?(Ka(n)??0)-(Ka(o)??0):Ya.compare(n,o);return s===0?e-t:s*a})}function Za(e){let t=ka(e.datenzeilen,e.suchtext);return e.sortSpalte<0?t:Xa(t.map(t=>e.datenzeilen[t]),e.sortSpalte,e.sortAuf).map(e=>t[e])}function Qa(e){let t={gridTemplateColumns:e.spalten.map(e=>H(e.art).spur).join(` `)},n=Ni(e.spalten),r=e.gemessen?.zeilenHoehe??n,i=e.hatQuelle,a=!e.erfassungAn&&ja(i,e.datenGeliefert,e.datenzeilen.length),o=Za(e),s=e.erfassungAn?1+e.erfassteAnzahl:0,c=e.gemessen===null?null:Math.max(1,e.gemessen.passen-s),{seiten:l,seite:u,zeilen:d}=Ei({sichtbar:o,hatQuelle:i,proSeite:c??Math.max(1,10-s),wunschSeite:e.wunschSeite,platzhalterZeilen:Si(c)});return{cols:t,takt:n,zeilenHoehe:r,hatQuelle:i,leer:a,gesamt:o.length,seiten:l,seite:u,zeilen:d,linealTakte:Ti(c,d.length)}}var $a=[B(`suche`,`Suchzeile`,`Zeigt über der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,{requiresDataSource:!0}),B(`erfassung`,`Erfassungszeile`,`Zeigt als nächste freie Zeile eine leere Zeile, in der der Bediener neue Positionen tippt. Eingestellt wird an ihr nichts: Was eine Zelle tut, ergibt sich aus der Bindung ihrer Spalte (Spaltenkopf) und der Verknüpfung des Bausteins. Enter am Zeilenende lässt die Zeile stehen; geschrieben wird über einen Knopf, dessen Kette „Wert aus Erfassungszelle“ liest — einmal je Zeile.`),B(`schlank`,`Schlank`,`Nimmt den Rahmen der Tafel weg und macht die Polster enger — die Tabelle liegt bündig auf der Maske. Die Fußzeile erscheint ohnehin nur noch, wenn geblättert wird oder ein Filter greift.`),B(`kopfzeile`,`Kopfzeile`,`Aus: Die Titelzeile fällt weg, die Spaltennamen stehen blass in den Zellen der Erfassungszeile. Gebunden wird dann per Klick auf eine Zelle; zum Umbenennen die Kopfzeile kurz einschalten. An der fertigen Maske entfällt ohne Kopf das Sortieren per Titelklick.`),{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt die Tabelle nur Sätze des Tages, den der Tageswähler zeigt. Leer = alle Sätze.`,kind:`field`},Zi()];function eo(e,t){return _`<div class="fusszeile">
    <div class="seiten-info">${Ma({hatQuelle:e.hatQuelle,sichtbar:e.sichtbar,gesamt:e.gesamt,suchtAktiv:e.suchtAktiv,auswahlAktiv:e.auswahlAktiv})}</div>
  ...
  </div>`}function to(e){return e.linealTakte===0?y:_`<div class="lineal" role="presentation" style=${W(e.linealTakte===null?e.cols:{...e.cols,flex:`0 1 auto`,height:`calc(var(--zeilen-hoehe) * ${e.linealTakte})`})}>
          ${e.spalten.map(()=>_`<div></div>`)}
        </div>`}function no(e,t){return _`
...
`,io=`ff-zeile-aktiviert`,ao=`data-ff-roh`;function oo(e,t){e.dispatchEvent(new CustomEvent(io,{detail:t,bubbles:!0,composed:!0}))}function so(e){let t=e?.activeElement;if(!(t instanceof HTMLElement))return;let n=t.closest(`.zeile`);if(!n)return;let r=n.getAttribute(ao);return r===null||r===``?null:Number(r)}function co(e,t){e&&((t===null?null:e.querySelector(`.zeile[data-ff-roh="${t}"]`))??e.querySelector(`.zeile[data-ff-roh]`)??e.querySelector(`.koerper`))?.focus()}var K=class e extends E{constructor(...e){super(...e),this.spalten=zi(),this.source=``,this.suche=`ja`,this.erfassung=`nein`,this.schlank=`nein`,this.kopfzeile=`ja`,this.leerText=Xi,this._suchtext=``,this.datenzeilen=[],this.zusatzzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this.datenGeliefert=!1,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._beobachter=null,this._taktGemessen=0,this._fokusZeile=null,this._fokusHolen=!1,this._besitz=`softengine`,this._erfassung=new _a}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.kannErfassen={wenn:{attributeName:`erfassung`,equals:`ja`}}}static{this.blockEvents=[{key:`onRowClick`,name:`Zeile gewählt`}]}static{this.listenBindung=Ba}static{this.defaultProps={width:`fill`,source:``,spalten:zi(),suche:`ja`,erfassung:`nein`,schlank:`nein`,kopfzeile:`ja`,tagField:``,leerText:Xi}}static{this.customProperties=$a}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get besitz(){return this._besitz}set besitz(e){e!==this._besitz&&(this._besitz=e,this.setzeAbgeleitetesZurueck(),this.isConnected&&(e===`provided`?Oa(this):Da(this)),this.requestUpdate())}set bereitgestellteZeilen(e){let t=ya(e);this.rohzeilen=t.rohzeilen,this.datenzeilen=t.datenzeilen,this.zusatzzeilen=t.zusatzzeilen,this.datenGeliefert=!0,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._seite=0,this._mass=null,this._taktGemessen=0,this.requestUpdate()}setzeAbgeleitetesZurueck(){this.rohzeilen=[],this.datenzeilen=[],this.zusatzzeilen=[],this.datenGeliefert=!1,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._suchtext=``,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._taktGemessen=0,this._fokusZeile=null,this._fokusHolen=!1,this._erfassung.zuruecksetzen()}get erfassteZeilen(){return this._erfassung.zeilen}erfassungLeeren(){this._erfassung.leeren()&&this.requestUpdate()}erfasseZeile(){this._erfassung.erfasse(this.erfassungsUmfeld())&&(this.requestUpdate(),this.fokussiereErfassungsZelle(0))}fokussiereSuche(){let e=this.shadowRoot?.querySelector(`.suchzeile input`);return e?(e.focus(),!0):!1}get hatQuelle(){return this._besitz===`provided`||Aa(this.hasAttribute(`data-ff-editor`),this.source)}merkeZeilenFokus(){let e=so(this.shadowRoot);this._fokusHolen=e!==void 0,this._fokusZeile=e??null}messeRumpf(){let e=this.zeilenHoehe;this._taktGemessen=e;let t=ea(this,e);t?.passen===this._mass?.passen&&t?.zeilenHoehe===this._mass?.zeilenHoehe||(this._mass=t,this.requestUpdate())}spaltenListe(){return Ui(this.spalten)}get zeilenHoehe(){return Ni(this.spaltenListe())}aktiviereZeile(e,t){if(e===null||this.hasAttribute(`data-ff-editor`))return;let n=this.rohzeilen[e];n!==void 0&&(oo(this,{rohzeile:n,rohIndex:e,ansichtIndex:t}),this.toggleAuswahl(n),nr(this,`onRowClick`,{PINDEX:wa(this,n)}).catch(Qn))}toggleAuswahl(e){let t=N(this);t!==``&&Kt(t,e)}setzeSuchtext(e){this.merkeZeilenFokus(),this._suchtext=e,this._seite=0,this.requestUpdate()}klickSortiere(e){this.editable||(this.merkeZeilenFokus(),this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.requestUpdate())}get erfassungAn(){return this.erfassung===`ja`}fussNoetig(e){return e>1||this._suchtext.trim()!==``||this.durchAuswahlGefiltert}erfassungsWirt(){return{baustein:this,lauf:this._erfassung.lauf,umfeld:()=>this.erfassungsUmfeld(),melde:()=>this.requestUpdate(),fokussiere:e=>this.fokussiereErfassungsZelle(e),erfasseZeile:()=>this.erfasseZeile()}}fokussiereErfassungsZelle(e){this.updateComplete.then(()=>{(this.shadowRoot?.querySelectorAll(`.zeile.erfassung .erf-eingabe`))?.[e]?.focus()})}erfassungsUmfeld(){return this._erfassung.umfeld(this,this.spaltenListe(),this.source)}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}beobachte(){this._beobachter||(this._beobachter=ta(this,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}connectedCallback(){super.connectedCallback(),this._besitz===`softengine`&&Da(this),this.beobachte()}firstUpdated(){this.beobachte()}willUpdate(e){super.willUpdate(e),!(!this.erfassungAn||this.hasAttribute(`data-ff-editor`))&&this._erfassung.lauf.aktualisiereVorschlaege(this.erfassungsUmfeld())}updated(){this._taktGemessen!==this.zeilenHoehe&&this.messeRumpf(),this._fokusHolen&&(this._fokusHolen=!1,co(this.shadowRoot,this._fokusZeile))}disconnectedCallback(){super.disconnectedCallback(),Ra(this),this._beobachter?.disconnect(),this._beobachter=null,Do(this),Oa(this)}static{this.styles=[E.styles,ur,$i,ro,Fr,va]}render(){let t=this.spaltenListe(),n=e=>e.stopPropagation(),r=Qa({spalten:t,hatQuelle:this.hatQuelle,datenGeliefert:this.datenGeliefert,datenzeilen:this.datenzeilen,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,wunschSeite:this._seite,gemessen:this._mass,erfassungAn:this.erfassungAn,erfassteAnzahl:this._erfassung.zeilen.length});return _`<div class=${this.schlank===`ja`?`tabelle schlank`:`tabelle`} style=${W({"--takt":`${r.takt}px`,"--zeilen-hoehe":`${r.zeilenHoehe}px`})}>
      ${Na(()=>this.spaltenListe(),e=>this.aendere(e),n)}
      ${no({spalten:t,cols:r.cols,editable:this.editable,imEditor:this.hasAttribute(`data-ff-editor`),zeigeKopf:this.kopfzeile===`ja`,auswahlSemantik:N(this)!==``,zeigeSuche:this.suche===`ja`,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,zeilen:r.zeilen,linealTakte:r.linealTakte,datenzeilen:this.datenzeilen,zusatzzeilen:this.zusatzzeilen,hatQuelle:r.hatQuelle,auswahlIndex:this.auswahlIndex,leer:r.leer,leerText:this.leerText,erfasste:this._erfassung.zeilen,erfassung:this.erfassungAn?ha(this.erfassungsWirt(),r.cols,(r.linealTakte??1)<=0,this.hasAttribute(`data-ff-editor`)&&this.editable&&this.kopfzeile!==`ja`?(t,n)=>za(this,t,{prop:e.listenBindung.prop,index:n,liste:()=>this.spaltenListe()}):void 0):y},{setzeSuchtext:e=>this.setzeSuchtext(e),dblklickKopf:(e,t)=>{this.editable&&(Ra(this),Fa(e,t,()=>this.spaltenListe(),e=>this.aendere(e)))},klickKopf:(t,n)=>{this.editable&&za(this,t,{prop:e.listenBindung.prop,index:n,liste:()=>this.spaltenListe()}),this.klickSortiere(n)},aktiviereZeile:(e,t)=>this.aktiviereZeile(e,t)})}
      ${``}
      ${r.leer||!this.fussNoetig(r.seiten)?y:eo({hatQuelle:r.hatQuelle,sichtbar:r.gesamt,gesamt:this.datenzeilen.length,suchtAktiv:this._suchtext.trim()!==``,auswahlAktiv:this.durchAuswahlGefiltert,seite:r.seite,seiten:r.seiten},{blaettere:e=>{this.merkeZeilenFokus(),this._seite=e,this.requestUpdate()}})}
    </div>`}};T([C({converter:{fromAttribute:e=>e?Wi(e):zi(),toAttribute:e=>JSON.stringify(e)}})],K.prototype,`spalten`,void 0),T([C()],K.prototype,`source`,void 0),T([C()],K.prototype,`suche`,void 0),T([C()],K.prototype,`erfassung`,void 0),T([C()],K.prototype,`schlank`,void 0),T([C()],K.prototype,`kopfzeile`,void 0),T([C()],K.prototype,`leerText`,void 0),T([C({attribute:!1})],K.prototype,`datenzeilen`,void 0),T([C({attribute:!1})],K.prototype,`zusatzzeilen`,void 0),T([C({attribute:!1})],K.prototype,`rohzeilen`,void 0),T([C({attribute:!1})],K.prototype,`auswahlIndex`,void 0),T([C({attribute:!1})],K.prototype,`durchAuswahlGefiltert`,void 0),T([C({attribute:!1})],K.prototype,`datenGeliefert`,void 0),E.defineAndRegister(K);function lo(e){return _`<div class="nachschlag">
    <input
      class="ctrl"
      type="text"
      .value=${e.wert}
    ...
    >${bi()}</button>
    ${e.liste}
  </div>`}var uo={prop:`nachschlagSpalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:Li,quelleProp:`nachschlagQuelle`};function fo(e){if(typeof e==`string`)try{e=JSON.parse(e)}catch{return[]}return Array.isArray(e)&&e.length>0?Ui(e):[]}function po(e,t){let n=e[0];return n===void 0?t:n.feld}function mo(e,t){let n=e.trim();return n===``||n===t.trim()}function ho(e,t,n){let r=t.trim(),i=[],a=mo(t,n),o=new Set;for(let t of e){let e=A(t,n).trim(),s=r===``?e:A(t,r).trim();if(!(s===``&&e===``)){if(a){if(o.has(e))continue;o.add(e)}i.push({anzeige:s,wert:e,satz:t})}}return i}function go(e,t,n,r){return ho(Qt(e,t).rows,n,r)}function _o(e){let t=k(R().FF_DATA_SOURCES,e);return t?At(R().SEDATA,t.name,t.tableId):null}function vo(e){if(e.quelleId===``||e.speicherFeld===``)return{ok:!1,grund:`unvollstaendig`};let t=_o(e.quelleId);if(t===null)return{ok:!1,grund:`quelleFehlt`};let n=po(fo([...e.spalten]),e.speicherFeld);return{ok:!0,eintraege:go(e.el,t,n,e.speicherFeld)}}function yo(e,t){return t&&e.length===1?e[0]:null}function bo(e,t){let{rows:n,gefiltert:r}=Qt(e,[t]);return!r||n.length>0}function xo(e,t,n){return e===``?t===``&&n===``?`nichts`:`leeren`:e===t?`nichts`:`zurueck`}var So=null,Co=null,wo=null;function To(e){return e.shadowRoot?.querySelector(`.lupe`)??null}function Eo(e=!0){let t=e?wo:null;wo=null,So?.remove(),So=null,Co=null,t?.focus()}function Do(e){Co===e&&Eo(!1)}function Oo(e){return[{titel:e.speicherTitel===``?`Wert`:e.speicherTitel,feld:e.speicherFeld,art:V}]}function ko(e){let t=e=>e.stopPropagation(),n=e.editor;return _`<ff-dialog-rahmen
    viewport
    escape-schliesst
    ohne-modal
    inhalt-fest
  ...
  >${e.inhalt}</ff-dialog-rahmen>`}function Ao(e,t){let n=fo([...e.spalten]),r=mo(po(n,e.speicherFeld),e.speicherFeld);return _`<ff-tabelle
    fuellt
    suche="ja"
    style="--se-r-lg:0px"
    .besitz=${`provided`}
    .spalten=${n.length>0?n:Oo(e)}
  ...
  ></ff-tabelle>`}function jo(e){let t=e.eintraege;if(t===void 0){let n=vo(e);if(!n.ok){L(n.grund===`unvollstaendig`?`Nachschlagen braucht an diesem Feld eine Quelle und „Gespeichert wird".`:`Die Nachschlage-Quelle dieses Feldes ist in der Maske nicht vorhanden.`);return}t=n.eintraege}Eo(!1);let n=document.createElement(`div`);n.style.display=`contents`,He(ko({titel:e.titel,breite:e.breite,hoehe:e.hoehe,inhalt:Ao(e,t),onSchliessen:()=>Eo()}),n);let r=n.querySelector(en),i=n.querySelector(K.tagName);i?.addEventListener(io,n=>{let r=n.detail,i=t[r.rohIndex];i&&(Eo(),e.onUebernehmen(i.anzeige,i.wert,i.satz))}),wo=e.rueckFokus??To(e.el),document.body.appendChild(n),So=n,Co=e.el,r&&i&&Promise.all([r.updateComplete,i.updateComplete]).then(()=>{r.isConnected&&i.fokussiereSuche()})}function Mo(e){return ko({titel:e.titel,breite:e.breite,hoehe:e.hoehe,onSchliessen:e.onSchliessen,editor:{onGroesse:e.onGroesse},inhalt:_`<ff-tabelle
      data-ff-editor
      fuellt
      suche="ja"
      style="--se-r-lg:0px"
      .spalten=${[...e.spalten]}
      .editable=${!0}
      @ff-prop-change=${t=>{t.stopPropagation();let n=t.detail;n?.attr===`spalten`&&e.onAendern(Ui(n.value))}}
    ...
    >${this.placeholder}</span>`}onTextClick(){this.hasAttribute(`data-ff-editor`)||this.setzeHaken(!this.angehakt)}setzeHaken(e){this.angehakt!==e&&(this.angehakt=e,this.dispatchEvent(new Event(`change`)))}controlTpl(e){switch(e){case`textarea`:return _`<textarea class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}></textarea>`;case`select`:{let e=this.options.split(`,`).map(e=>e.trim()).filter(e=>e!==``),t=this.value!==``&&!e.includes(this.value);return _`<select class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}>
        ...
        </select>`}case`nachschlagen`:return lo({wert:this.getippt??this.anzeige,onTippen:e=>{this.getippt=e,this.marke=0,this.listeZu=!1},onTaste:e=>this.onNachschlagTaste(e),onVerlassen:()=>this.onNachschlagVerlassen(),onLupe:()=>this.onLupe(),liste:this.vorschlaege.length===0?y:Pr({eintraege:this.vorschlaege,marke:this.marke,onWaehlen:e=>this.uebernimmVorschlag(e),onMarke:e=>{this.marke=e}})});default:return _`<input
          class="ctrl"
          type=${e}
          .value=${e===`date`?oi(this.value):this.value}
          @input=${this.onInput}
          @change=${this.onChange}
          @focus=${()=>{this.imSteuerelement=!0}}
          @blur=${()=>{this.imSteuerelement=!1}}
        />`}}onLupe(){if(this.hasAttribute(`data-ff-editor`)){this.spaltenDialog=!0;return}jo({el:this,quelleId:this.nachschlagQuelle,speicherFeld:this.speicherFeld,speicherTitel:this.speicherTitel,spalten:this.nachschlagSpalten,titel:this.placeholder,breite:this.fensterBreite,hoehe:this.fensterHoehe,onUebernehmen:(e,t,n)=>this.uebernimmUndMelde(e,t,n)})}spaltenEffektiv(){let e=fo(this.nachschlagSpalten);return e.length>0?e:Oo({speicherFeld:this.speicherFeld,speicherTitel:this.speicherTitel})}meldeProp(e,t,n){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:e,value:t,...n===void 0?{}:{geste:n}},bubbles:!0,composed:!0}))}spaltenDialogTpl(){return Mo({titel:this.placeholder,spalten:this.spaltenEffektiv(),breite:this.fensterBreite,hoehe:this.fensterHoehe,onGroesse:t=>{let n=t.achse===`breite`?`fensterBreite`:`fensterHoehe`;if(t.geste===`standard`){this.meldeProp(n,e.defaultProps[n]);return}this.meldeProp(n,t.wert,t.geste===`laeuft`?void 0:t.geste)},onAendern:e=>{this.meldeProp(`nachschlagSpalten`,e)},onFeldWahl:e=>{this.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:`nachschlagSpalten`,...e},bubbles:!0,composed:!0}))},onSchliessen:()=>{this.spaltenDialog=!1}})}willUpdate(e){super.willUpdate(e),e.has(`fieldType`)&&_i(this.fieldType)!==`nachschlagen`&&(this.spaltenDialog=!1),this.vorschlaege=this.berechneVorschlaege(),this.marke=Mr(this.marke,this.vorschlaege.length)}updated(e){super.updated(e),this.toggleAttribute(`data-ff-liste`,this.vorschlaege.length>0)}berechneVorschlaege(){if(this.getippt===null||this.listeZu||_i(this.fieldType)!==`nachschlagen`||this.hasAttribute(`data-ff-editor`))return[];let e=vo({el:this,quelleId:this.nachschlagQuelle,speicherFeld:this.speicherFeld,spalten:this.nachschlagSpalten});return e.ok?Ar(e.eintraege,this.getippt):[]}onNachschlagTaste(e){if(this.hasAttribute(`data-ff-editor`))return;let t=this.vorschlaege.length,n=Nr(e.key,{listeOffen:t>0,feldLeer:(this.getippt??this.anzeige)===``});if(n===`nichts`){e.key===`Enter`&&e.preventDefault();return}e.preventDefault(),n===`marke-hoch`?this.marke=jr(this.marke,t,-1):n===`marke-runter`?this.marke=jr(this.marke,t,1):n===`uebernehmen`?this.uebernimmVorschlag(this.marke):n===`liste-zu`?this.listeZu=!0:this.onLupe()}uebernimmVorschlag(e){let t=this.vorschlaege[e];t&&this.uebernimmUndMelde(t.anzeige,t.wert,t.satz)}leereNachschlagen(){this.satz=void 0,this.anzeige=``,this.value=``,Jt(N(this))}uebernimmUndMelde(e,t,n){this.getippt=null,this.listeZu=!1,this.marke=0,this.uebernimmSatz(e,t,n),this.dispatchEvent(new Event(`change`))}uebernimmSatz(e,t,n){this.anzeige=e===``?t:e,this.value=t,this.satz=n,qt(N(this),n)}onNachschlagVerlassen(){if(this.hasAttribute(`data-ff-editor`))return;let e=xo(this.getippt??this.anzeige,this.anzeige,this.value);this.getippt=null,this.listeZu=!1,this.marke=0,e===`leeren`&&(this.leereNachschlagen(),this.dispatchEvent(new Event(`change`)))}pruefeEigenenWert(){_i(this.fieldType)===`nachschlagen`&&(this.getippt!==null&&this.requestUpdate(),this.satz!==void 0&&!bo(this,this.satz)&&this.leereNachschlagen(),this.uebernimmEinzigenTreffer())}uebernimmEinzigenTreffer(){if(this.einzigerTreffer!==`ja`)return;let e=vo({el:this,quelleId:this.nachschlagQuelle,speicherFeld:this.speicherFeld,spalten:this.nachschlagSpalten});if(!e.ok)return;let t=yo(e.eintraege,this.satz===void 0);t&&this.uebernimmSatz(t.anzeige,t.wert,t.satz)}render(){let e=_i(this.fieldType);if(e===`checkbox`)return _`<div class="feld">
        <div class="zeile">
          <input
            class="ctrl"
            type="checkbox"
      ...
      >
        ${this.controlTpl(e)}
        ${vi.includes(e)?this.textTpl(`ph ${yi[e]??``}`.trim(),!n):y}
      </div>
      ${this.spaltenDialog&&this.hasAttribute(`data-ff-editor`)?this.spaltenDialogTpl():y}
    </div>`}connectedCallback(){super.connectedCallback(),pi(this)}disconnectedCallback(){super.disconnectedCallback(),mi(this),Do(this)}};T([C()],q.prototype,`fieldType`,void 0),T([C()],q.prototype,`placeholder`,void 0),T([C()],q.prototype,`options`,void 0),T([C()],q.prototype,`source`,void 0),T([C()],q.prototype,`value`,void 0),T([C()],q.prototype,`valueField`,void 0),T([C()],q.prototype,`nachschlagQuelle`,void 0),T([C()],q.prototype,`speicherFeld`,void 0),T([C()],q.prototype,`speicherTitel`,void 0),T([C({converter:{fromAttribute:e=>fo(e??``),toAttribute:e=>JSON.stringify(e)}})],q.prototype,`nachschlagSpalten`,void 0),T([C({type:Number})],q.prototype,`fensterBreite`,void 0),T([C({type:Number})],q.prototype,`fensterHoehe`,void 0),T([C()],q.prototype,`einzigerTreffer`,void 0),T([w()],q.prototype,`spaltenDialog`,void 0),T([w()],q.prototype,`anzeige`,void 0),T([w()],q.prototype,`getippt`,void 0),T([w()],q.prototype,`marke`,void 0),T([w()],q.prototype,`listeZu`,void 0),T([w()],q.prototype,`angehakt`,void 0),T([w()],q.prototype,`imSteuerelement`,void 0),E.defineAndRegister(q);var No=`ziel`,Po=o`
...
`,Io=`frei · hierher ziehen`,Lo=`ff-zimmer-inhalt`,J=class extends E{constructor(...e){super(...e),this.heading=`Neues Zimmer`,this.leerHinweis=``}static{this.blockType=`kanban-zimmer`}static{this.tagName=`ff-kanban-zimmer`}static{this.displayName=`Kanban-Zimmer`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[z.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban-spalte`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={heading:`Neues Zimmer`}}static{this.styles=[E.styles,$i,Fo,Po,o`
    ...
    `]}onSlotChange(){this.dispatchEvent(new CustomEvent(Lo,{bubbles:!0,composed:!0}))}render(){return _`<div class="zimmer ${No}">
      <div
        class="kopf"
        data-ff-editable
    ...
    `]}constructor(){super(),this.variant=`info`,this.heading=`Neue Spalte`,this.leerHinweis=``,this._count=0,this.addEventListener(Lo,()=>this.zaehle())}zaehle(){this._count=Array.from(this.querySelectorAll(z.tagName)).filter(e=>!e.hasAttribute(`data-ff-editor-helper`)).length}render(){return _`<div class="col ${No} v-${sr(this.variant)}">
      <div class="head">
        <span class="dot"></span>
        <span
          class="title"
    ...
    </div>`}};T([C()],Y.prototype,`variant`,void 0),T([C()],Y.prototype,`heading`,void 0),T([C({attribute:!1})],Y.prototype,`leerHinweis`,void 0),T([w()],Y.prototype,`_count`,void 0),E.defineAndRegister(Y);function Ro(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function zo(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var Bo=new WeakMap,Vo=Y.tagName,Ho=J.tagName,Uo=z.tagName;function Wo(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Vo)}function Go(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Uo)}function Ko(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Ho)}function qo(e){return[e,...Ko(e)]}function Jo(e,t){let n=e.getAttribute(`leertext`)??`Keine Datensätze.`,r=(e,t)=>{e.leerHinweis=t};for(let e of t){let t=Ko(e);for(let e of t)r(e,Go(e).length===0?Io:``);r(e,t.length===0&&Go(e).length===0?n:``)}}function Yo(e){return Ye().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function Xo(e,t){let n=Ko(e);if(n.length===0)return null;let r=e.getAttribute(`zimmerfield`)??``;if(r===``)return n[0];let i=n.map(e=>e.getAttribute(`heading`)??J.defaultProps.heading),a=Ro(A(t,r),i);return a>=0?n[a]:n[0]}function Zo(e){Z?.board===e&&rs();let t=e.getAttribute(`statusfield`)??``,n=xa(e);if(!n)return;let r=Wo(e);if(r.length===0)return;let i=Bo.get(e);if(!i){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(Uo);t&&(i=t.cloneNode(!0),Bo.set(e,i))}if(!i)return;let a=n.zeilen,o=r.map(e=>e.getAttribute(`heading`)??Y.defaultProps.heading),s=Yo(i.tagName),c=zo(r.map(e=>e.getAttribute(`auffang`))),l=n.lies;for(let e of r)for(let t of qo(e))Go(t).forEach(e=>e.remove());for(let e of a){let a=i.cloneNode(!0),u=t===``?-1:Ro(A(e,t),o),d=u>=0?r[u]:c>=0?r[c]:r[0];(Xo(d,e)??d).appendChild(a);for(let t of s){let n=a.getAttribute(nt(t.prop))??``;n!==``&&(a[t.prop]=l(e,n))}let ee=Dt(n.quelle,e);X.set(a,{row:e,pindex:ee}),a.draggable=!0}Jo(e,r);let u=r.flatMap(e=>qo(e).flatMap(Go)),d=Gt(N(e),u,e=>X.get(e)?.row);for(let e of d)u[e].setAttribute(`data-ff-auswahl`,``)}var X=new WeakMap,Z=null,Qo=new WeakSet,$o=`data-ff-zieht`,es=`data-ff-ziel`,ts=null;function ns(e){ts!==e&&(ts?.removeAttribute(es),ts=e,ts?.setAttribute(es,``))}function rs(){Z?.card.removeAttribute($o),Z=null,ns(null)}function is(e,t,n){for(let r of t.composedPath())if(r instanceof HTMLElement&&r.tagName.toLowerCase()===n&&e.contains(r))return r;return null}function as(e,t){return is(e,t,Vo)}function os(e,t,n){if(!Z||Z.board!==e)return;let r=X.get(Z.card);if(!r)return;let i=t.getAttribute(`heading`)??``,a=n?.getAttribute(`heading`)??``;nr(e,`onCardDrop`,{PINDEX:r.pindex,VALUE:i,ZIMMER:a}).catch(Qn)}function ss(e){Qo.has(e)||(Qo.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;if(!n)return;let r=X.get(n);r&&Kt(N(e),r.row),nr(e,`onCardClick`,{PINDEX:r?.pindex??``}).catch(Qn)}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;n&&(Z={card:n,board:e},t.dataTransfer?.setData(`text/plain`,X.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`),setTimeout(()=>{Z?.card===n&&n.setAttribute($o,``)},0))}),e.addEventListener(`dragend`,rs),e.addEventListener(`dragover`,t=>{let n=as(e,t);if(Z?.board!==e||!n){ns(null);return}t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`),ns(is(e,t,Ho)??n)}),e.addEventListener(`dragleave`,t=>{let n=t.relatedTarget;(!(n instanceof Node)||!e.contains(n))&&ns(null)}),e.addEventListener(`drop`,t=>{let n=as(e,t);n&&(t.preventDefault(),os(e,n,is(e,t,Ho)),rs())}))}var cs=Zr({hydriere:Zo,verdrahte:ss}),ls=cs.connect,us=cs.disconnect,ds=Y.blockType,fs=class extends E{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[ds]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:ds}}static{this.templateChild={type:z.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``,tagField:``,leerText:Xi}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Optional: Feld der Datenquelle, dessen Inhalt bestimmt, in welche Spalte ein Eintrag kommt. Leer = alle Einträge in der Auffang-Spalte.`,kind:`field`},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt das Board nur Einträge des Tages, den der Tageswähler zeigt. Leer = alle Einträge.`,kind:`field`},Zi()]}static{this.defaultChildren=[{type:ds,props:{heading:`Offen`,variant:`warning`},children:[{type:z.blockType}]},{type:ds,props:{heading:`In Arbeit`,variant:`info`}},{type:ds,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[E.styles,o`
    ...
    `]}render(){return _`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),ls(this)}disconnectedCallback(){super.disconnectedCallback(),us(this)}};E.defineAndRegister(fs);var ps={breite:56,breiteOffen:224},ms=`ff-seiten-wechsel`,hs=[{wert:`sonne`,name:`Sonnengelb`},{wert:`salbei`,name:`Salbeigrün`},{wert:`himmel`,name:`Himmelblau`},{wert:`flieder`,name:`Flieder`},{wert:`koralle`,name:`Koralle`}],Q=class extends E{static{this.blockType=`navi-eintrag`}static{this.tagName=`ff-navi-eintrag`}static{this.displayName=`Navi-Eintrag`}static{this.category=`layout`}static{this.acceptsChildren=!1}static{this.showInPalette=!1}static{this.allowedParentTypes=[`navi`]}static{this.resizableWidth=!1}static{this.defaultProps={seite:``,seitename:``,ton:`sonne`}}static{this.customProperties=[{attributeName:`seite`,name:`Seite`,description:`Welche Seite dieser Maske der Eintrag zeigt.`,kind:`seite`,klarnameProp:`seitename`,nurImEditor:!0},{attributeName:`ton`,name:`Farbe`,description:`Farbe des Zeichens vor dem Namen.`,kind:`select`,options:hs.map(e=>({value:e.wert,label:e.name}))}]}static{this.styles=[E.styles,o`
      :host {
        --ton: var(--se-amber);
        display: flex;
        align-items: center;
    ...
    `]}constructor(){super(),this.seite=``,this.seitename=``,this.ton=`sonne`,this.addEventListener(`click`,()=>this.melde())}melde(){let e={ansicht:this.seitename};this.dispatchEvent(new CustomEvent(ms,{detail:e,bubbles:!0,composed:!0}))}render(){return _`<span class="zeichen"></span>
      <span class="name">${this.seitename===``?`—`:this.seitename}</span>`}};T([C()],Q.prototype,`seite`,void 0),T([C()],Q.prototype,`seitename`,void 0),T([C({reflect:!0})],Q.prototype,`ton`,void 0),E.defineAndRegister(Q);var gs=`aktiv`;function _s(e){return Array.from(e.querySelectorAll(Q.tagName))}function vs(e,t){let n=_s(e),r=t??n.find(e=>e.hasAttribute(gs))??n[0];for(let e of n)e===r?e.setAttribute(gs,``):e.removeAttribute(gs)}function ys(e){let t=e.hasAttribute(`offen`);for(let n of _s(e))n.toggleAttribute(`breit`,t)}function bs(e){return e.getAttribute(`name`)??String(pt.defaultProps.name)}function xs(e,t){let n=e;for(;n&&n.parentElement!==t;)n=n.parentElement;return n}function Ss(e,t){let n=e.ownerDocument,r=Array.from(n.querySelectorAll(pt.tagName)),i=r[0]?.parentElement??null;if(!i)return;let a=xs(e,i);if(!a)return;let o=r.find(e=>bs(e)===t)??null;for(let e of Array.from(i.children))e!==a&&((r.includes(e)?e===o:o===null)?e.removeAttribute(`hidden`):e.setAttribute(`hidden`,``))}var Cs=new WeakMap,ws=new WeakSet;function Ts(e){let t=t=>{let n=t.detail;n&&(vs(e,t.target instanceof Element?t.target:void 0),e.removeAttribute(`offen`),ys(e),!e.hasAttribute(`data-ff-editor`)&&Ss(e,n.ansicht))};e.addEventListener(ms,t),Cs.set(e,t)}function Es(e){let t=Cs.get(e);t&&(e.removeEventListener(ms,t),Cs.delete(e))}function Ds(e){if(vs(e),ys(e),e.hasAttribute(`data-ff-editor`)||ws.has(e))return;let t=_s(e)[0];if(!t)return;ws.add(e);let n=()=>Ss(e,t.seitename);e.ownerDocument.readyState===`loading`?e.ownerDocument.addEventListener(`DOMContentLoaded`,n,{once:!0}):queueMicrotask(n)}var Os=Q.blockType,ks=class extends E{static{this.blockType=`navi`}static{this.tagName=`ff-navi`}static{this.displayName=`Navi`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[Os]}static{this.addChildButton={label:`Eintrag`,childType:Os}}static{this.containerHint=!1}static{this.defaultProps={}}static{this.customProperties=[]}static{this.maskenRand=!0}static{this.allowedParentTypes=[ft]}static{this.raster={startW:5,startH:24,minW:3,minH:3}}static{this.styles=[E.styles,o`
      :host {
        height: 100%;
        width: ${ps.breite}px;
        transition: width var(--se-move);
      }
      :host([offen]) { width: ${ps.breiteOffen}px; }
      .leiste {
        box-sizing: border-box;
        height: 100%;
        width: 100%;
    ...
    `]}connectedCallback(){super.connectedCallback(),Ts(this)}disconnectedCallback(){super.disconnectedCallback(),Es(this)}klappen(){this.toggleAttribute(`offen`),ys(this)}render(){return _`<div class="leiste">
        <div class="kopf">
          <button
            class="schalter"
            type="button"
        ...
        <div class="eintraege">
          <slot @slotchange=${()=>Ds(this)}></slot>
        </div>
      </div>`}};E.defineAndRegister(ks);var As=nt(`text`);function js(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(As)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function Ms(e){let t=ri(e,As);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function Ns(e){js(e)&&(e.text=``)}var Ps=Zr({hydriere:Ms,verdrahte:Ns}),Fs=Ps.connect,Is=Ps.disconnect,Ls=6,Rs=96,zs=14,Bs={duenn:`300`,normal:`400`,fett:`700`},Vs={links:`left`,mitte:`center`,rechts:`right`},Hs={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},Us=`standard`;function Ws(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(Rs,Math.max(Ls,t)):zs}function Gs(e){return typeof e==`string`&&e in Bs?e:`normal`}function Ks(e){return typeof e==`string`&&e in Vs?e:`links`}function qs(e){return typeof e==`string`&&e in Hs?e:Us}var $=class extends E{constructor(...e){super(...e),this.groesse=zs,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=Us,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:zs,gewicht:`normal`,ausrichtung:`links`,farbe:Us,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:Ls,max:Rs,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[E.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return _`<div
      class="text"
      style=${W({fontSize:`${Ws(this.groesse)}px`,fontWeight:Bs[Gs(this.gewicht)],textAlign:Vs[Ks(this.ausrichtung)],color:Hs[qs(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),Fs(this)}disconnectedCallback(){super.disconnectedCallback(),Is(this)}};T([C({type:Number})],$.prototype,`groesse`,void 0),T([C()],$.prototype,`gewicht`,void 0),T([C()],$.prototype,`ausrichtung`,void 0),T([C()],$.prototype,`farbe`,void 0),T([C()],$.prototype,`text`,void 0),T([C()],$.prototype,`source`,void 0),T([C()],$.prototype,`textField`,void 0),E.defineAndRegister($);var Js=[`waagerecht`,`senkrecht`],Ys=`waagerecht`;function Xs(e){return Js.includes(e)?e:Ys}var Zs=class extends E{constructor(...e){super(...e),this.richtung=Ys}static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`,richtung:Ys}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1,varianten:[{wenn:{attributeName:`richtung`,equals:`senkrecht`},startW:1,startH:6,breiteZiehbar:!1}]}}static{this.customProperties=[{attributeName:`richtung`,name:`Richtung`,description:`Waagerecht trennt oben von unten, senkrecht links von rechts.`,kind:`select`,options:[{value:`waagerecht`,label:`Waagerecht`},{value:`senkrecht`,label:`Senkrecht`}]}]}static{this.styles=[E.styles,o`
    ...
    `]}render(){return _`<div class="flaeche ${Xs(this.richtung)}"><div class="linie"></div></div>`}};T([C()],Zs.prototype,`richtung`,void 0),E.defineAndRegister(Zs),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;L(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();
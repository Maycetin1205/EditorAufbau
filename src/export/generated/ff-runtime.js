...
`;function Hr(e,t,n,r){return{attributeName:e,name:t,description:n,kind:`select`,options:[{value:`nein`,label:`Nein`},{value:`ja`,label:`Ja`}],...r}}var J=class extends M{constructor(...e){super(...e),this.variant=`info`,this.heading=`Neue Spalte`,this.leerHinweis=``,this._count=0}static{this.blockType=`kanban-spalte`}static{this.tagName=`ff-kanban-spalte`}static{this.displayName=`Kanban-Spalte`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[G.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={variant:`info`,heading:`Neue Spalte`,auffang:`nein`}}static{this.customProperties=[kn(`variant`,`Bedeutung der Spalte — bestimmt ihre Farbwelt (Kopf, Fläche, Rahmen).`),Hr(`auffang`,`Auffangspalte`,`Einträge ohne passenden Spaltentitel landen hier. Ohne Auffangspalte landen sie in der ersten Spalte.`,{requiresDataSource:!0,exclusiveAmongSiblings:!0})]}static{this.styles=[M.styles,Vr,o`
    ...
    `]}render(){return w`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),ai(this)}disconnectedCallback(){super.disconnectedCallback(),oi(this)}};M.defineAndRegister(ci);var li={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},ui=e=>(...t)=>({_$litDirective$:e,values:t}),di=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},fi=`important`,pi=` !important`,mi=ui(class extends di{constructor(e){if(super(e),e.type!==li.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(pi);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?fi:``):n[e]=r}}return T}}),hi=[10,25,50],gi=`passend`,_i=hi[0],vi=4;function yi(e,t){return bi(e)??t??vi}function bi(e){let t=Number(e);return hi.some(e=>e===t)?t:null}function xi(e,t,n){return Math.max(1,Math.floor((e-t)/n))}function Si({sichtbar:e,hatQuelle:t,proSeite:n,wunschSeite:r,platzhalterZeilen:i}){let a=t?Math.max(1,Math.ceil(e.length/n)):1,o=Math.min(Math.max(r,0),a-1);return t?{seiten:a,seite:o,zeilen:[...e.slice(o*n,(o+1)*n)]}:{seiten:a,seite:o,zeilen:Array.from({length:i},()=>null)}}function Ci(e,t){if(!e.hasAttribute(`fuellt`))return null;let n=e.renderRoot.querySelector(`.koerper`),r=e.renderRoot.querySelector(`.kopf`);return!(n instanceof HTMLElement)||!(r instanceof HTMLElement)?null:xi(n.clientHeight,r.offsetHeight,t)}function wi(e,t){if(typeof ResizeObserver>`u`)return null;let n=e.renderRoot.querySelector(`.koerper`);if(!n)return null;let r=new ResizeObserver(t);return r.observe(n),r}function Ti(e,t){let n=t.trim().toLowerCase();return e.find(e=>e.wert.trim().toLowerCase()===n)}var Ei=`text`,Di=`status`,Oi=`bild`,ki=`bild`,Ai=`unter`,ji=[{wert:Ei,name:`Text`,spur:`minmax(0, 1fr)`,klasse:``,zelle:e=>e},{wert:`zahl`,name:`Zahl`,spur:`90px`,klasse:`zahl`,zelle:e=>e},{wert:`datum`,name:`Datum`,spur:`100px`,klasse:`zahl`,zelle:e=>e},{wert:Di,name:`Status`,spur:`120px`,klasse:`status`,zelle:(e,t)=>{let n=Ti(t,e);return n?w`<span class="chip v-${Dn(n.bedeutung)}">${n.name.trim()===``?e:n.name}</span>`:w`<span class="chip">${e}</span>`}},{wert:Oi,name:`Bild + Name`,spur:`minmax(0, 1fr)`,klasse:`bild`,zusatzFelder:[{key:ki,label:`Bild`},{key:Ai,label:`Unterzeile`}],hoehe:e=>(e[ki]??``)!==``||(e[Ai]??``)!==``?44:32,zelle:(e,t,n)=>{let r=In(n[ki]??``),i=n[Ai]??``;return w`<div class="bild-name">
        ${r===void 0?E:w`<span class="bild-zeichen">${r}</span>`}
        <div class="bild-text">
          <div class="bild-titel">${e}</div>
          ${i===``?E:w`<div class="bild-unter">${i}</div>`}
        </div>
      </div>`}}];function Mi(e){return e.reduce((e,t)=>{let n=Ni(t.art);return Math.max(e,n.hoehe?.(t.felder??{})??32)},32)}function Ni(e){return ji.find(t=>t.wert===e)??ji[0]}var Pi=ji.map(e=>({wert:e.wert,name:e.name,...e.zusatzFelder?{felder:e.zusatzFelder}:{}})),Fi=`felder`,Ii=`Spalte {n}`;function Li(e){return Ii.replace(`{n}`,String(e+1))}function Z(e){return{titel:Li(e),feld:``,art:Ei}}function Ri(){return[0,1,2].map(e=>Z(e))}function zi(e){return Array.isArray(e)?e.filter(e=>!!e&&typeof e==`object`).map(e=>({wert:typeof e.wert==`string`?e.wert:``,name:typeof e.name==`string`?e.name:``,bedeutung:typeof e.bedeutung==`string`?e.bedeutung:``})).filter(e=>e.wert.trim()!==``):[]}function Bi(e){if(!e||typeof e!=`object`||Array.isArray(e))return{};let t={};for(let[n,r]of Object.entries(e))typeof r==`string`&&r!==``&&(t[n]=r);return t}function Vi(e,t){if(e&&typeof e==`object`){let n=e,r=zi(n.zuordnung),i=Bi(n.felder);return{titel:typeof n.titel==`string`?n.titel:Li(t),feld:typeof n.feld==`string`?n.feld:``,art:typeof n.art==`string`?n.art:Ei,...r.length>0?{zuordnung:r}:{},...Object.keys(i).length>0?{felder:i}:{}}}return typeof e==`string`?{...Z(t),titel:e}:Z(t)}function Hi(e){let t;if(Array.isArray(e))t=e.map((e,t)=>Vi(e,t));else if(typeof e==`number`&&Number.isFinite(e)||typeof e==`string`&&/^\d+$/.test(e)){let n=Math.max(1,Math.floor(Number(e)));t=[...Array(n).keys()].map(e=>Z(e))}else t=Ri();return t.length>8&&(t=t.slice(0,8)),t.length<1&&(t=[Z(0)]),t}function Ui(e){try{return Hi(JSON.parse(e))}catch{return Ri()}}function Wi(e){return Ui(e.getAttribute(`spalten`)??``)}function Gi(e,t,n){let r={};for(let i of Ni(e.art).zusatzFelder??[]){let a=e.felder?.[i.key]??``;a!==``&&(r[i.key]=n(t,a))}return r}function Ki(e){let t=()=>{e.datenzeilen=[],e.zusatzzeilen=[]},n=e.getAttribute(`source`)??``;if(n===``){t();return}let r=nt(H().FF_DATA_SOURCES,n);if(!r){t();return}let i=Wi(e),{rows:a,gefiltert:o}=St(e,Ur(I(H().SEDATA,r.name,r.tableId),e.getAttribute(`tagfield`)??``,Wn())),s=gt(R(e),a,e=>e)[0]??-1,c=rr(e);e.datenGeliefert=!0,e.rohzeilen=a,e.auswahlIndex=s,e.durchAuswahlGefiltert=o,e.datenzeilen=a.map(e=>i.map(t=>t.feld===``?``:c(e,t.feld))),e.zusatzzeilen=a.map(e=>i.map(t=>Gi(t,e,c)))}var qi=Qn({hydriere:Ki}),Ji=qi.connect,Yi=qi.disconnect;function Xi(e,t,n){return w`<div class="steuerung">
    <button
    ...
    >+</button>
  </div>`}function Zi(e,t){let n=e.currentTarget;if(!n)return;e.stopPropagation(),e.preventDefault();let r=Array.from(n.childNodes),i=n.textContent??``;n.setAttribute(`contenteditable`,`plaintext-only`),n.focus();let a=window.getSelection(),o=document.createRange();o.selectNodeContents(n),a?.removeAllRanges(),a?.addRange(o);let s=!1,c=e=>{if(s)return;s=!0,n.removeAttribute(`contenteditable`),n.removeEventListener(`blur`,l),n.removeEventListener(`keydown`,u);let a=(n.textContent??``).trim();e&&a&&a!==i.trim()?t(a):n.replaceChildren(...r)},l=()=>c(!0),u=e=>{e.key===`Enter`?(e.preventDefault(),n.blur()):e.key===`Escape`&&(e.preventDefault(),c(!1))};n.addEventListener(`blur`,l),n.addEventListener(`keydown`,u)}function Qi(e,t,n,r){Zi(e,e=>{let i=n();t>=i.length||(i[t]={...i[t],titel:e},r(i))})}var $i=220,ea=new WeakMap;function ta(e){let t=ea.get(e);t!==void 0&&(clearTimeout(t),ea.delete(e))}function na(e,t,n,r){t.stopPropagation();let i=t.currentTarget.getBoundingClientRect();ta(e),ea.set(e,setTimeout(()=>{ea.delete(e),e.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:n,index:r,top:i.bottom+4,left:i.left},bubbles:!0,composed:!0}))},$i))}var ra={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:Ii,eintragsWahl:{key:`art`,label:`Darstellung`,optionen:Pi,standard:Ei,felderKey:Fi},eintragsZuordnung:{key:`zuordnung`,label:`Status-Zuordnung`,nurBeiWahl:Di,wertLabel:`Datenwert`,nameLabel:`Klarname`,bedeutungLabel:`Bedeutung`,bedeutungen:On}},ia=1,aa=/^-?\d{1,3}(\.\d{3})*(,\d+)?$|^-?\d+(,\d+)?$|^-?\d+(\.\d+)?$/,oa=/^(\d{1,2})\.(\d{1,2})\.(\d{2}|\d{4})$/,sa=/^(\d{4})-(\d{2})-(\d{2})$/;function ca(e){let t=e.trim();if(t===``||!aa.test(t))return null;let n=t.includes(`,`)?t.replace(/\./g,``).replace(`,`,`.`):/^-?\d{1,3}(\.\d{3})+$/.test(t)?t.replace(/\./g,``):t,r=Number(n);return Number.isFinite(r)?r:null}function la(e){let t=e.trim();if(t===``)return null;let n=sa.exec(t);if(n){let[,e,t,r]=n;return ua(Number(e),Number(t),Number(r))}let r=oa.exec(t);if(r){let[,e,t,n]=r,i=Number(n);return ua(n.length===2?i<=69?2e3+i:1900+i:i,Number(t),Number(e))}return null}function ua(e,t,n){if(t<1||t>12||n<1||n>31)return null;let r=new Date(e,t-1,n);return r.getFullYear()!==e||r.getMonth()!==t-1||r.getDate()!==n?null:r.getTime()}function da(e){let t=0,n=0,r=0;for(let i of e)i.trim()!==``&&(t++,ca(i)!==null&&n++,la(i)!==null&&r++);return t===0?`text`:r===t?`datum`:n===t?`zahl`:`text`}var fa=new Intl.Collator(`de`,{numeric:!0,sensitivity:`base`});function pa(e,t,n){if(t<0||e.length===0)return e.map((e,t)=>t);let r=n=>e[n][t]??``,i=da(e.map(e=>e[t]??``)),a=n?1:-1;return e.map((e,t)=>t).sort((e,t)=>{let n=r(e).trim(),o=r(t).trim();if(n===``&&o===``)return e-t;if(n===``)return ia;if(o===``)return-1;let s=i===`zahl`?(ca(n)??0)-(ca(o)??0):i===`datum`?(la(n)??0)-(la(o)??0):fa.compare(n,o);return s===0?e-t:s*a})}function ma(e,t){let n=[];return e.forEach((e,r)=>{xr(e,t)&&n.push(r)}),n}function ha(e,t){return!e&&t.trim()!==``}function ga(e,t,n){return e&&t&&n===0}function _a(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}function va(e){let t=ma(e.datenzeilen,e.suchtext);return e.sortSpalte<0?t:pa(t.map(t=>e.datenzeilen[t]),e.sortSpalte,e.sortAuf).map(e=>t[e])}function ya(e){let t={gridTemplateColumns:e.spalten.map(e=>Ni(e.art).spur).join(` `)},n=Mi(e.spalten),r=ha(e.imEditor,e.source),i=ga(r,e.datenGeliefert,e.datenzeilen.length),a=va(e),{seiten:o,seite:s,zeilen:c}=Si({sichtbar:a,hatQuelle:r,proSeite:bi(e.einstellung)??e.gemessen??_i,wunschSeite:e.wunschSeite,platzhalterZeilen:yi(e.einstellung,e.gemessen)});return{cols:t,zeilenHoehe:n,hatQuelle:r,leer:i,gesamt:a.length,seiten:o,seite:s,zeilen:c}}var ba=[{value:`ja`,label:`Ja`},{value:`nein`,label:`Nein`}],xa=[{attributeName:`suche`,name:`Suchzeile`,description:`Zeigt über der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,kind:`segment`,options:ba,requiresDataSource:!0},{attributeName:`zeilenWaehler`,name:`Zeilen-Wähler`,description:`Zeigt dem Bediener unten in der Maske den Wähler „Zeilen pro Seite" — er darf die Einstellung dann für seine Sitzung übersteuern. Nein: es gilt unveränderlich, was hier im Editor eingestellt ist.`,kind:`segment`,options:ba,requiresDataSource:!0},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt die Tabelle nur Sätze des Tages, den der Tageswähler zeigt. Leer = alle Sätze.`,kind:`field`},zr()];function Sa(e,t){return w`<div class="fusszeile">
    <div class="seiten-info">${_a({hatQuelle:e.hatQuelle,sichtbar:e.sichtbar,gesamt:e.gesamt,suchtAktiv:e.suchtAktiv,auswahlAktiv:e.auswahlAktiv})}</div>
    <div class="seiten-nav">
  ...
  </div>`}var Ca=`—`;function wa(e,t){return w`
      ...
      <div class="kopf" style=${mi(e.cols)}>
        ...
        ${e.zeilen.map(n=>w`<div
          ...
          >
            ${``}
            ${e.spalten.map((t,r)=>{let i=Ni(t.art),a=n===null?Ca:e.datenzeilen[n]?.[r]??``,o=n===null?{}:e.zusatzzeilen[n]?.[r]??{};return w`<div class=${i.klasse}>${i.zelle(a,t.zuordnung??[],o)}</div>`})}
          </div>`)}
        ${``}
...
`,Q=class e extends M{constructor(...e){super(...e),this.spalten=Ri(),this.source=``,this.suche=`ja`,this.proSeite=gi,this.zeilenWaehler=`nein`,this.leerText=Rr,this._suchtext=``,this.datenzeilen=[],this.zusatzzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this.datenGeliefert=!1,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._proSeiteWahl=null,this._proSeiteGemessen=null,this._beobachter=null,this._taktGemessen=0}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.listenBindung=ra}static{this.defaultProps={width:`fill`,source:``,spalten:Ri(),suche:`ja`,tagField:``,proSeite:gi,zeilenWaehler:`nein`,leerText:Rr}}static{this.customProperties=xa}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get einstellung(){return this._proSeiteWahl??this.proSeite}waehleProSeite(e){this.hasAttribute(`data-ff-editor`)?this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`proSeite`,value:e},bubbles:!0,composed:!0})):this._proSeiteWahl=e,this._seite=0,this.requestUpdate()}messeRumpf(){let e=this.zeilenHoehe;this._taktGemessen=e;let t=Ci(this,e);t!==this._proSeiteGemessen&&(this._proSeiteGemessen=t,this.requestUpdate())}spaltenListe(){return Hi(this.spalten)}get zeilenHoehe(){return Mi(this.spaltenListe())}klickZeile(e){if(e===null||this.hasAttribute(`data-ff-editor`))return;let t=R(this),n=this.rohzeilen[e];t===``||n===void 0||_t(t,n)}setzeSuchtext(e){this._suchtext=e,this._seite=0,this.requestUpdate()}klickSortiere(e){this.editable||(this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.requestUpdate())}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}beobachte(){this._beobachter||(this._beobachter=wi(this,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}connectedCallback(){super.connectedCallback(),Ji(this),this.beobachte()}firstUpdated(){this.beobachte()}updated(){this._taktGemessen!==this.zeilenHoehe&&this.messeRumpf()}disconnectedCallback(){super.disconnectedCallback(),ta(this),this._beobachter?.disconnect(),this._beobachter=null,Yi(this)}static{this.styles=[M.styles,An,Vr,Ta]}render(){let t=this.spaltenListe(),n=e=>e.stopPropagation(),r=ya({spalten:t,imEditor:this.hasAttribute(`data-ff-editor`),source:this.source,datenGeliefert:this.datenGeliefert,datenzeilen:this.datenzeilen,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,wunschSeite:this._seite,einstellung:this.einstellung,gemessen:this._proSeiteGemessen});return w`<div class="tabelle" style=${mi({"--zeilen-hoehe":`${r.zeilenHoehe}px`})}>
      ${Xi(()=>this.spaltenListe(),e=>this.aendere(e),n)}
      ${wa({spalten:t,cols:r.cols,editable:this.editable,zeigeSuche:this.suche===`ja`,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,zeilen:r.zeilen,datenzeilen:this.datenzeilen,zusatzzeilen:this.zusatzzeilen,hatQuelle:r.hatQuelle,auswahlIndex:this.auswahlIndex,leer:r.leer,leerText:this.leerText},{setzeSuchtext:e=>this.setzeSuchtext(e),dblklickKopf:(e,t)=>{this.editable&&(ta(this),Qi(e,t,()=>this.spaltenListe(),e=>this.aendere(e)))},klickKopf:(t,n)=>{this.editable&&na(this,t,e.listenBindung.prop,n),this.klickSortiere(n)},klickZeile:e=>this.klickZeile(e),stop:n})}
      ${``}
      ${r.leer?E:Sa({hatQuelle:r.hatQuelle,sichtbar:r.gesamt,gesamt:this.datenzeilen.length,suchtAktiv:this._suchtext.trim()!==``,auswahlAktiv:this.durchAuswahlGefiltert,zeigeWaehler:this.hasAttribute(`data-ff-editor`)||this.zeilenWaehler===`ja`,einstellung:this.einstellung,seite:r.seite,seiten:r.seiten},{waehleProSeite:e=>this.waehleProSeite(e),blaettere:e=>{this._seite=e,this.requestUpdate()},stop:n})}
    </div>`}};j([A({converter:{fromAttribute:e=>e?Ui(e):Ri(),toAttribute:e=>JSON.stringify(e)}})],Q.prototype,`spalten`,void 0),j([A()],Q.prototype,`source`,void 0),j([A()],Q.prototype,`suche`,void 0),j([A()],Q.prototype,`proSeite`,void 0),j([A()],Q.prototype,`zeilenWaehler`,void 0),j([A()],Q.prototype,`leerText`,void 0),j([A({attribute:!1})],Q.prototype,`datenzeilen`,void 0),j([A({attribute:!1})],Q.prototype,`zusatzzeilen`,void 0),j([A({attribute:!1})],Q.prototype,`rohzeilen`,void 0),j([A({attribute:!1})],Q.prototype,`auswahlIndex`,void 0),j([A({attribute:!1})],Q.prototype,`durchAuswahlGefiltert`,void 0),j([A({attribute:!1})],Q.prototype,`datenGeliefert`,void 0),M.defineAndRegister(Q);var Ea=Xn(`text`);function Da(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(Ea)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function Oa(e){let t=ir(e,Ea);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function ka(e){Da(e)&&(e.text=``)}var Aa=Qn({hydriere:Oa,verdrahte:ka}),ja=Aa.connect,Ma=Aa.disconnect,Na=6,Pa=96,Fa=14,Ia={duenn:`300`,normal:`400`,fett:`700`},La={links:`left`,mitte:`center`,rechts:`right`},Ra={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},za=`standard`;function Ba(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(Pa,Math.max(Na,t)):Fa}function Va(e){return typeof e==`string`&&e in Ia?e:`normal`}function Ha(e){return typeof e==`string`&&e in La?e:`links`}function Ua(e){return typeof e==`string`&&e in Ra?e:za}var $=class extends M{constructor(...e){super(...e),this.groesse=Fa,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=za,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:Fa,gewicht:`normal`,ausrichtung:`links`,farbe:za,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:Na,max:Pa,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[M.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return w`<div
      class="text"
      style=${mi({fontSize:`${Ba(this.groesse)}px`,fontWeight:Ia[Va(this.gewicht)],textAlign:La[Ha(this.ausrichtung)],color:Ra[Ua(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),ja(this)}disconnectedCallback(){super.disconnectedCallback(),Ma(this)}};j([A({type:Number})],$.prototype,`groesse`,void 0),j([A()],$.prototype,`gewicht`,void 0),j([A()],$.prototype,`ausrichtung`,void 0),j([A()],$.prototype,`farbe`,void 0),j([A()],$.prototype,`text`,void 0),j([A()],$.prototype,`source`,void 0),j([A()],$.prototype,`textField`,void 0),M.defineAndRegister($);var Wa=[`waagerecht`,`senkrecht`],Ga=`waagerecht`;function Ka(e){return Wa.includes(e)?e:Ga}var qa=class extends M{constructor(...e){super(...e),this.richtung=Ga}static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`,richtung:Ga}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1,varianten:[{wenn:{attributeName:`richtung`,equals:`senkrecht`},startW:1,startH:6,breiteZiehbar:!1}]}}static{this.customProperties=[{attributeName:`richtung`,name:`Richtung`,description:`Waagerecht trennt oben von unten, senkrecht links von rechts.`,kind:`select`,options:[{value:`waagerecht`,label:`Waagerecht`},{value:`senkrecht`,label:`Senkrecht`}]}]}static{this.styles=[M.styles,o`
    ...
    `]}render(){return w`<div class="zeile"><slot></slot></div>`}};M.defineAndRegister(Ja),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;V(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();
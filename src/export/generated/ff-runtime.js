...
`,gr=`Spalte {n}`;function Y(e){return gr.replace(`{n}`,String(e+1))}function X(){return[0,1,2].map(e=>({titel:Y(e),feld:``}))}function _r(e,t){if(e&&typeof e==`object`){let n=e;return{titel:typeof n.titel==`string`?n.titel:Y(t),feld:typeof n.feld==`string`?n.feld:``}}return typeof e==`string`?{titel:e,feld:``}:{titel:Y(t),feld:``}}function vr(e){let t;if(Array.isArray(e))t=e.map((e,t)=>_r(e,t));else if(typeof e==`number`&&Number.isFinite(e)||typeof e==`string`&&/^\d+$/.test(e)){let n=Math.max(1,Math.floor(Number(e)));t=[...Array(n).keys()].map(e=>({titel:Y(e),feld:``}))}else t=X();return t.length>8&&(t=t.slice(0,8)),t.length<1&&(t=[{titel:Y(0),feld:``}]),t}function yr(e){try{return vr(JSON.parse(e))}catch{return X()}}var br=4,Z=[10,25,50],xr=220,Q=class e extends k{constructor(...e){super(...e),this.spalten=X(),this.source=``,this.proSeite=String(Z[0]),this.suche=`ja`,this._suchtext=``,this.datenzeilen=[],this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._proSeiteWahl=null,this._klickTimer=null}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.listenBindung={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:gr}}static{this.defaultProps={width:`fill`,source:``,spalten:X(),proSeite:String(Z[0]),suche:`ja`}}static{this.customProperties=[{attributeName:`suche`,name:`Suchzeile`,description:`Zeigt ueber der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,kind:`segment`,options:[{value:`ja`,label:`Ja`},{value:`nein`,label:`Nein`}],requiresDataSource:!0},{attributeName:`proSeite`,name:`Zeilen pro Seite`,description:`Wie viele Datensaetze eine Seite der Tabelle zeigt.`,kind:`select`,options:Z.map(e=>({value:String(e),label:String(e)})),requiresDataSource:!0}]}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get proSeiteAktuell(){if(this._proSeiteWahl!==null)return this._proSeiteWahl;let e=Number(this.proSeite);return Number.isFinite(e)&&e>0?Math.floor(e):Z[0]}spaltenListe(){return vr(this.spalten)}sichtbareZeilen(){let e=mr(this.datenzeilen,this._suchtext);return this._sortSpalte<0?e:dr(e,this._sortSpalte,this._sortAuf)}setzeSuchtext(e){this._suchtext=e,this._seite=0,this.requestUpdate()}klickSortiere(e){this.editable||(this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.requestUpdate())}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}klickSpaltenkopf(t,n){if(!this.editable)return;t.stopPropagation();let r=t.currentTarget.getBoundingClientRect();this.klickTimerAus(),this._klickTimer=setTimeout(()=>{this._klickTimer=null,this.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:e.listenBindung.prop,index:n,top:r.bottom+4,left:r.left},bubbles:!0,composed:!0}))},xr)}klickTimerAus(){this._klickTimer!==null&&(clearTimeout(this._klickTimer),this._klickTimer=null)}bearbeiteTitel(e,t){if(!this.editable)return;let n=e.currentTarget;if(!n)return;e.stopPropagation(),e.preventDefault();let r=Array.from(n.childNodes),i=n.textContent??``;n.setAttribute(`contenteditable`,`plaintext-only`),n.focus();let a=window.getSelection(),o=document.createRange();o.selectNodeContents(n),a?.removeAllRanges(),a?.addRange(o);let s=!1,c=e=>{if(s)return;s=!0,n.removeAttribute(`contenteditable`),n.removeEventListener(`blur`,l),n.removeEventListener(`keydown`,u);let a=(n.textContent??``).trim(),o=this.spaltenListe();e&&a&&a!==i.trim()&&t<o.length?(o[t]={...o[t],titel:a},this.aendere(o)):n.replaceChildren(...r)},l=()=>c(!0),u=e=>{e.key===`Enter`?(e.preventDefault(),n.blur()):e.key===`Escape`&&(e.preventDefault(),c(!1))};n.addEventListener(`blur`,l),n.addEventListener(`keydown`,u)}connectedCallback(){super.connectedCallback(),er(this)}disconnectedCallback(){super.disconnectedCallback(),this.klickTimerAus(),tr(this)}static{this.styles=[k.styles,hr]}render(){let e=this.spaltenListe(),t={gridTemplateColumns:`repeat(${e.length}, minmax(0, 1fr))`},n=e=>e.stopPropagation(),r=this.sichtbareZeilen(),i=this.datenzeilen.length>0,a=r.length,o=this.proSeiteAktuell,s=i?Math.max(1,Math.ceil(a/o)):1,c=Math.min(Math.max(this._seite,0),s-1),l=i?r.slice(c*o,(c+1)*o):[],u=i?o:br,d=i?``:`—`,ee=[...l,...Array.from({length:Math.max(0,u-l.length)},()=>null)];return b`<div class="tabelle">
      ...
      <!-- Fusszeile IMMER: sie gehoert zum Aufbau der Tabelle, also muss der
           ...
           ein Strich (Regel 7). -->
      <div class="fusszeile">
        <div class="seiten-info">${i?`${a} Datensätze`:`— Datensätze`}</div>
    ...
    </div>`}};O([D({converter:{fromAttribute:e=>e?yr(e):X(),toAttribute:e=>JSON.stringify(e)}})],Q.prototype,`spalten`,void 0),O([D()],Q.prototype,`source`,void 0),O([D()],Q.prototype,`proSeite`,void 0),O([D()],Q.prototype,`suche`,void 0),O([D({attribute:!1})],Q.prototype,`datenzeilen`,void 0),k.defineAndRegister(Q);var Sr=6,Cr=96,wr=14,Tr={duenn:`300`,normal:`400`,fett:`700`},Er={links:`left`,mitte:`center`,rechts:`right`};function Dr(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(Cr,Math.max(Sr,t)):wr}function Or(e){return typeof e==`string`&&e in Tr?e:`normal`}function kr(e){return typeof e==`string`&&e in Er?e:`links`}var $=class extends k{constructor(...e){super(...e),this.groesse=wr,this.gewicht=`normal`,this.ausrichtung=`links`,this.text=`Text`}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.defaultProps={width:`fill`,groesse:wr,gewicht:`normal`,ausrichtung:`links`,text:`Text`}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:Sr,max:Cr,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`}]}static{this.styles=[k.styles,o`
      .text {
        font-family: var(--se-font);
        color: var(--se-ink);
        line-height: 1.35;
    ...
    `]}render(){return b`<div class="zeile"><slot></slot></div>`}};k.defineAndRegister(jr)})();
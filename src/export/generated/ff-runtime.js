...
`)+(Xt===``?``:`\n\nERSTES PAKET\n${Xt}`))}function K(e,t){G.set(e,t),$t()}function en(){let e=W();G.set(`basisHTML_REGISTER`,typeof e.basisHTML_REGISTER==`function`?`vorhanden`:`fehlt`),G.set(`basisHTML_SND_MSG`,typeof e.basisHTML_SND_MSG==`function`?`vorhanden`:`fehlt`),G.set(`body.pid`,document.body?.getAttribute(`pid`)?`gesetzt`:`fehlt`),G.set(`body.REGMSG`,document.body?.getAttribute(`REGMSG`)?`gesetzt`:`fehlt`),G.set(`Empfangene Pakete`,String(Zt)),G.set(`SEDATA.Daten`,Bt()?`vorhanden`:`fehlt`),$t()}function tn(e){if(Xt===``)try{Xt=typeof e==`string`?e:JSON.stringify(e)??``,$t()}catch{}}function nn(e){Zt+=1,tn(e),K(`Empfangene Pakete`,String(Zt));let t=dt(e);if(!t){K(`Letztes Paket`,`Antwort ohne Daten`),Yt(e);return}let n=W();N(n.SEDATA)||(n.SEDATA={}),n.SEDATA.Daten=t,K(`Letztes Paket`,`Daten-Push angenommen`),K(`SEDATA.Daten`,`vorhanden`),Ht(),qt()}function rn(e=0){let t=W();if(typeof t.basisHTML_REGISTER==`function`){en();try{t.basisHTML_SetConsoleLog?.(!0,!0)}catch{}try{t.basisHTML_REGISTER(e=>{nn(e)},document.title,`1.0`),K(`Registrierung`,`ausgeführt`)}catch(e){K(`Registrierung`,`Fehler: ${e instanceof Error?e.message:String(e)}`)}return}e<400?(e===0&&K(`Registrierung`,`wartet auf Interface`),setTimeout(()=>{rn(e+1)},25)):(en(),K(`Registrierung`,`nach 10s kein Interface`),U(`SoftEngine-Anschluss nicht gefunden — die Maske bleibt ohne Daten (Strg+Alt+D für Details).`))}var an=!1;function on(){if(an)return;an=!0,K(`Runtime`,`gestartet`),K(`Registrierung`,`noch nicht ausgeführt`),en(),Vt();let e=W();e.Erstellen=()=>{Ht(),qt()},e.initData=e.Erstellen,e.ReloadData=()=>{qt()},rn(),window.addEventListener(`message`,e=>{if(typeof W().basisHTML_REGISTER==`function`)return;let t=ft(e.data);t!==void 0&&nn(t)},!0),document.addEventListener(`keydown`,e=>{if(e.ctrlKey&&e.altKey&&e.key.toLowerCase()===`d`){en();let e=document.getElementById(`ff-se-diagnose`);e&&(e.style.display=e.style.display===`none`?`block`:`none`)}});let t=0,n=setInterval(()=>{t+=1,Bt()?(clearInterval(n),K(`SEDATA.Daten`,`vorhanden`),Ht(),qt()):t>100&&(clearInterval(n),K(`Daten-Wartezeit`,`nach 30s ohne Daten`),U(`Keine Daten von SoftEngine empfangen — die Maske zeigt nichts an (Strg+Alt+D für Details).`))},300)}function sn(e){return e instanceof Error?e.message:String(e)}function cn(e,t){if(!(!Array.isArray(e)||t===``)){for(let n of e)if(!(!N(n)||n.id!==t)&&!(typeof n.verb!=`string`||!Nt.includes(n.verb))&&!(typeof n.nr!=`string`||n.nr===``)&&!(!Array.isArray(n.params)||n.params.some(e=>typeof e!=`string`)))return{id:t,verb:n.verb,nr:n.nr,params:n.params}}}var ln=[`RESULT`,`result`,`PINDEX`,`pindex`,`INDEX`,`index`,`0_10`,`KEY`,`key`,`ID`,`id`,`VALUE`,`value`];function un(e){if(typeof e!=`string`)return e;try{return JSON.parse(e)}catch{return}}function dn(e){if(typeof e==`string`){let t=e.trim();return t===``?void 0:t}if(typeof e==`number`||typeof e==`boolean`)return String(e)}function fn(e,t){if(t>12)return;let n=dn(e);if(n!==void 0)return n;if(Array.isArray(e)){for(let n of e){let e=fn(n,t+1);if(e!==void 0)return e}return}if(N(e)){for(let n of ln){if(!(n in e))continue;let r=fn(e[n],t+1);if(r!==void 0)return r}for(let n of Object.values(e)){let e=fn(n,t+1);if(e!==void 0)return e}}}function pn(e){let t=un(e);if(N(t)){for(let e of ln){if(!(e in t))continue;let n=fn(t[e],0);if(n!==void 0)return n}for(let e of Object.values(t))if(Array.isArray(e))for(let t of e){let e=pn(t);if(e!==void 0)return e}else if(N(e)){let t=pn(e);if(t!==void 0)return t}}}var mn=[`RESULT`,`result`];function hn(e,t=0){if(t>12)return;let n=typeof e==`string`?un(e):e;if(Array.isArray(n)){for(let e of n){let n=hn(e,t+1);if(n!==void 0)return n}return}if(N(n)){for(let e of mn){let t=n[e];if(typeof t==`string`)return t;if(typeof t==`number`||typeof t==`boolean`)return String(t)}for(let e of Object.values(n)){let n=hn(e,t+1);if(n!==void 0)return n}}}function gn(e,t,n=0){if(t.trim()===``||n>12)return``;let r=typeof e==`string`?un(e):e;if(Array.isArray(r)){for(let e of r){let r=gn(e,t,n+1);if(r!==``)return r}return``}if(!N(r))return``;let i=F(r,t);if(i!==``)return i;for(let e of Object.values(r)){let r=gn(e,t,n+1);if(r!==``)return r}return``}function _n(e){return N(e)?Object.keys(e).filter(e=>/^Message\d+$/.test(e)):[]}function vn(e,t,n=!1){if(!N(e))return;let r=_n(e).filter(e=>!t.has(e)).sort((e,t)=>Number(t.slice(7))-Number(e.slice(7)));for(let t of r){let r=n?hn(e[t]):pn(e[t]);if(r!==void 0)return{wert:r,roh:e[t]}}}var yn=[],bn=!1,xn=6e3,Sn=100;function Cn(){if(bn||yn.length===0)return;bn=!0;let e=yn.shift(),t=W(),n=new Set(_n(t.SEDATA)),r=!1,i=(t,n)=>{r||(r=!0,o(),clearInterval(s),clearTimeout(c),bn=!1,e.resolve({wert:t,roh:n}),queueMicrotask(Cn))},a=e.optionen.satzAntwort===!0,o=Kt(e=>{let t=a?hn(e):pn(e);t!==void 0&&i(t,e)}),s=setInterval(()=>{let e=vn(W().SEDATA,n,a);e!==void 0&&i(e.wert,e.roh)},Sn),c=setTimeout(()=>{e.optionen.still||U(`Daten laden: SoftEngine hat nicht geantwortet (Relation Nr. ${e.template.nr}).`),i(``,void 0)},xn);if(typeof t.basisHTML_SND_MSG!=`function`){e.optionen.still||U(`Daten laden nicht möglich: keine Verbindung zu SoftEngine.`),i(``,void 0);return}try{t.basisHTML_SND_MSG(`GET_RELATION`,{NR:e.template.nr,PARAMS:e.params})}catch(t){e.optionen.still||U(`Daten laden fehlgeschlagen (Relation Nr. ${e.template.nr}): ${sn(t)}`),i(``,void 0)}}function wn(e,t,n={}){on();let r=W();if(e.verb!==`GET_RELATION`){if(typeof r.basisHTML_SND_MSG!=`function`)return U(`Speichern nicht möglich: keine Verbindung zu SoftEngine. Die Eingabe wurde NICHT übernommen.`),Promise.resolve({wert:``,roh:void 0});try{r.basisHTML_SND_MSG(e.verb,{NR:e.nr,PARAMS:[...t]})}catch(t){U(`Speichern fehlgeschlagen (Relation Nr. ${e.nr}): ${sn(t)}`)}return Promise.resolve({wert:``,roh:void 0})}return new Promise(r=>{yn.push({template:e,params:[...t],resolve:r,optionen:n}),Cn()})}function Tn(e,t){if(!N(t))return``;let n=t.document;if(!n||typeof n.querySelectorAll!=`function`)return``;let r=Array.from(n.querySelectorAll(`[${Ze}]`)).find(t=>t.getAttribute(Ze)===e.blockId);if(!r)return``;let i=r[e.value];return i==null?``:String(i)}function En(e,t,n=W()){if(e.source===`aus`)return``;if(e.source===`fixed`)return e.value;if(e.source===`context`)return t.context[e.value]??``;if(e.source===`previous_result`)return t.previousResult;if(e.source===`step_result`){let n=Number(e.value);if(!Number.isInteger(n)||n<0)return``;let r=e.ergebnisFeld??``;return r===``?t.stepResults?.[n]??``:gn(t.stepRohErgebnisse?.[n],r)}if(e.source===`block_value`)return Tn(e,n);if(e.source===`gewaehlte_zeile`){let n=t.gewaehlteZeile?.(e.blockId??``);return n===void 0?``:F(n,e.value)}if(!N(n))return``;if(e.source===`se_variable`){let t=n.SEDATA;if(!N(t)||!N(t.Daten)||!N(t.Daten.VARArrays))return``;let r=t.Daten.VARArrays[e.value];return r==null?``:String(r)}let r=P(n.FF_DATA_SOURCES,e.dataSourceId??``);if(!r)return``;let i=L(n.SEDATA,r.name,r.tableId),a=t.context.PINDEX??``,o=a!==``&&r.indexField!==``?i.find(e=>F(e,r.indexField)===a):i[0];return o?F(o,e.value):``}function Dn(e,t){let n=`0,START_TOOL,`+e;return t.length>0&&(n+=`,`+t.map(e=>encodeURIComponent(e)).join(`,`)),n}function On(e,t){if(e.trim()===``)return;let n=W();try{if(typeof n.sendBWLinkIntern==`function`){n.sendBWLinkIntern(Dn(e,t));return}}catch{}try{if(typeof n.basisHTML_SND_MSG==`function`){let r={NR:e};t.length>0&&(r.PARAMS=[...t]),n.basisHTML_SND_MSG(`START_TOOL`,r)}}catch{}}function kn(e,t,n){if(t.trim()!==``)for(let r of Array.from(e.querySelectorAll(V.tagName)))(r.getAttribute(`name`)??V.defaultProps.name)===t&&(n?r.setAttribute(`offen`,``):r.removeAttribute(`offen`))}var An=new WeakMap;function jn(e){U(`Aktionskette fehlgeschlagen: `+(e instanceof Error?e.message:String(e)))}async function Mn(e,t,n){if(e.hasAttribute(`data-ff-editor`))return;let r=nt(e.getAttribute(`data-ff-aktionen`))[t];if(!r||r.length===0)return;let i=An.get(e);if(i||(i=new Set,An.set(e,i)),!i.has(t)){i.add(t);try{let t={...n,NOW_DATE:Pt(new Date)},i=``,a=[],o=[],s=()=>{a.push(``),o.push(void 0)};for(let n of r){if(n.type===`START_TOOL`){On(n.toolNr,Ft({params:n.toolParams},t)),s();continue}if(n.type===`POPUP_OPEN`||n.type===`POPUP_CLOSE`){kn(e.ownerDocument??document,n.popup??``,n.type===`POPUP_OPEN`),s();continue}let r=cn(W().FF_RELATIONS,n.relationId);if(!r){s();continue}let c={context:t,previousResult:i,stepResults:a,stepRohErgebnisse:o,gewaehlteZeile:yt},l=await wn(r,[...n.params,...n.extraParams].map(e=>En(e,c))),u=l.wert;a.push(u),o.push(l.roh),r.verb===`GET_RELATION`&&(i=u),n.resultKey!==``&&(t[n.resultKey]=u)}}finally{i.delete(t)}}}var Nn=new WeakSet;function Pn(e,t){if(e.hasAttribute(`data-ff-editor`)||!e.hasAttribute(`data-ff-aktionen`)||Nn.has(e))return;Nn.add(e);let n=nt(e.getAttribute(`data-ff-aktionen`));Object.values(n).some(e=>e.some(e=>e.type===`RELATION`))&&on(),e.addEventListener(`click`,()=>{Mn(e,t,{}).catch(jn)})}var Fn=class extends j{constructor(...e){super(...e),this.label=`Klick mich`}static{this.blockType=`button`}static{this.tagName=`ff-button`}static{this.displayName=`Schaltfläche`}static{this.category=`eingabe`}static{this.defaultProps={label:`Klick mich`}}static{this.resizableWidth=!1}static{this.blockEvents=[{key:`onClick`,name:`Klick`}]}static{this.raster={startW:4,startH:2,minW:2,minH:2}}static{this.customProperties=[]}static{this.styles=[j.styles,o`
      button {
        box-sizing: border-box;
        padding: 7px 16px;
        cursor: pointer;
    ...
    >${this.label}</button>`}connectedCallback(){super.connectedCallback(),Pn(this,`onClick`)}};A([k()],Fn.prototype,`label`,void 0),j.defineAndRegister(Fn);var In=[`info`,`success`,`warning`,`danger`];function Ln(e){return In.includes(e)?e:`info`}var Rn=[{wert:`info`,name:`Hinweis`},{wert:`success`,name:`Erfolg`},{wert:`warning`,name:`Warnung`},{wert:`danger`,name:`Fehler`}];function zn(e,t){return{attributeName:e,name:`Farbe`,description:t,kind:`select`,options:Rn.map(e=>({value:e.wert,label:e.name}))}}var Bn=o`
...
`,q=class extends j{constructor(...e){super(...e),this.chipVariant=`info`,this.heading=``,this.heading2=``,this.time=``,this.date=``,this.avatar=``,this.meta=``,this.text=``,this.chipText=``,this.headingField=``,this.heading2Field=``,this.timeField=``,this.dateField=``,this.avatarField=``,this.metaField=``,this.textField=``,this.chipTextField=``}static{this.blockType=`card`}static{this.tagName=`ff-card`}static{this.displayName=`Karte`}static{this.category=`anzeige`}static{this.allowedParentTypes=[`kanban-spalte`]}static{this.showInPalette=!1}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={chipVariant:`info`,heading:``,heading2:``,time:``,date:``,avatar:``,meta:``,text:``,chipText:``,headingField:``,heading2Field:``,timeField:``,dateField:``,avatarField:``,metaField:``,textField:``,chipTextField:``}}static{this.bindableSpots=[{prop:`time`,label:`Zeit`},{prop:`date`,label:`Datum`},{prop:`avatar`,label:`Avatar`},{prop:`heading`,label:`Titel`},{prop:`heading2`,label:`Titel 2`},{prop:`meta`,label:`Unterzeile`},{prop:`text`,label:`Textzeile`},{prop:`chipText`,label:`Chip`}]}static{this.customProperties=[zn(`chipVariant`,`Bedeutung des Chips auf der Karte — bestimmt die Chip-Farbe.`)]}static{this.styles=[j.styles,Bn,Jn]}stelle(e,t){return C`<span
    ...
    >${this[e]}</span>`}hatReiter(){return this.hasAttribute(`data-ff-editor`)||this.date.trim()!==``||this.time.trim()!==``}updated(e){super.updated(e),this.toggleAttribute(`hat-reiter`,this.hatReiter())}render(){let e=Ln(this.chipVariant),t=this.hasAttribute(`data-ff-editor`),n=e=>t||e.trim()!==``,r=this.hatReiter(),i=n(this.avatar)||n(this.heading)||n(this.meta),a=n(this.heading2)||n(this.chipText);return C`<div class="card v-${e}${r?``:` ohne-reiter`}">
      ...
      ${i?C`<div class="kopf">
            ${n(this.avatar)?C`<span
                ...
                >${this.avatar.trim()===``?T:qn(this.avatar)}</span>`:T}
            <div class="namen">
    ...
    `]}setzeTag(e){tr(e),this.tag=er()}render(){return C`<div class="waehler">
      <div class="riegel">
      ...
      <button class="heute" @click=${()=>this.setzeTag(Xn(new Date))}>Heute</button>
    </div>`}connectedCallback(){super.connectedCallback(),this.tag=er()||Xn(new Date),!this.hasAttribute(`data-ff-editor`)&&(this.setzeTag(this.tag),this.tagAbmelden?.(),this.tagAbmelden=nr(()=>{this.tag=er()}))}disconnectedCallback(){super.disconnectedCallback(),this.tagAbmelden?.(),this.tagAbmelden=null}};A([Ve()],rr.prototype,`tag`,void 0),j.defineAndRegister(rr);var ir={attributeName:`fieldType`,equals:`nachschlagen`},ar=[{attributeName:`fieldType`,name:`Feldtyp`,description:`Welche Art Eingabe das Feld annimmt.`,kind:`select`,options:[{value:`text`,label:`Text`},{value:`number`,label:`Zahl`},{value:`textarea`,label:`Mehrzeilig`},{value:`select`,label:`Auswahl`},{value:`date`,label:`Datum`},{value:`checkbox`,label:`Ankreuzfeld`},{value:`nachschlagen`,label:`Nachschlagen`}]},{attributeName:`options`,name:`Auswahl-Optionen`,description:`Nur bei Feldtyp "Auswahl": Einträge durch Komma getrennt (z. B. "Zimmer 1, Zimmer 2") — jeder Eintrag wird eine Dropdown-Zeile.`,kind:`text`,visibleWhen:{attributeName:`fieldType`,equals:`select`}},{attributeName:`nachschlagQuelle`,name:`Quelle`,description:`Nur bei Feldtyp "Nachschlagen": aus dieser Datenquelle wählt der Bediener eine Zeile.`,kind:`quelle`,visibleWhen:ir},{attributeName:`anzeigeFeld`,name:`Angezeigt wird`,description:`Feld der Nachschlage-Quelle, dessen Wert der Bediener sieht (z. B. der Name).`,kind:`field`,quelleProp:`nachschlagQuelle`,klarnameProp:`anzeigeTitel`,visibleWhen:ir},{attributeName:`speicherFeld`,name:`Gespeichert wird`,description:`Feld der Nachschlage-Quelle, dessen Wert die Maske sich merkt und die Kette "Wert geändert" weitergibt (z. B. die Nummer).`,kind:`field`,quelleProp:`nachschlagQuelle`,klarnameProp:`speicherTitel`,visibleWhen:ir},{attributeName:`einzigerTreffer`,name:`Einzigen Treffer übernehmen`,description:`Bleibt in der Maske genau EIN Satz übrig (weil das Feld der Auswahl eines anderen folgt), übernimmt es diesen von selbst — ohne dass der Bediener die Lupe drückt. Nur in ein leeres Feld; die Lupe bleibt daneben bedienbar.`,kind:`segment`,options:[{value:`ja`,label:`Ja`},{value:`nein`,label:`Nein`}],visibleWhen:ir},{attributeName:`valueField`,name:`Feld`,description:`Feld der angeschlossenen Datenquelle, dessen Wert angezeigt und lokal aktualisiert wird.`,kind:`field`,visibleWhen:{attributeName:`fieldType`,notEquals:`nachschlagen`}}];function or(e){return`${e.toLowerCase()}field`}function sr(e){let t=e.split(`::`);if(t.length!==2)return{quelleId:``,code:e};let[n,r]=t;return n===``||r===``?{quelleId:``,code:e}:{quelleId:n,code:r}}var cr=999,lr=`0`,ur=`255`,dr=new Map;function fr(e){let t=st(e);ot(e,[]),t!==void 0&&t.length>0&&Jt()}async function pr(e,t,n,r,i){return(await wn({id:`relation-lader`,verb:`GET_RELATION`,nr:e.nr,params:[]},[t.belegart,r,i,t.belegnummer,t.jahr,t.archiv,``,String(n),``,``,``,``],{still:!0,satzAntwort:!0})).wert}function mr(e,t,n){let r=(dr.get(e.id)??0)+1;if(dr.set(e.id,r),n===void 0){fr(e.name);return}let i={belegart:F(n,t.belegartFeld),belegnummer:F(n,t.belegnummerFeld),jahr:t.jahrFeld===``?``:F(n,t.jahrFeld),archiv:t.archivFeld===``?``:F(n,t.archivFeld)};if(i.belegart===``||i.belegnummer===``){fr(e.name);return}fr(e.name),(async()=>{let n=[],a=!1;for(let o=1;o<=cr;o+=1){let s=await pr(t,i,o,lr,ur);if(dr.get(e.id)!==r)return;if(t.endeFelder.every(e=>F({SATZ:s},e)===``)){a=!0;break}let c={SATZ:s};for(let n of t.zusatzFelder){let a=n.indexOf(`_`),s=await pr(t,i,o,n.slice(0,a),n.slice(a+1));if(dr.get(e.id)!==r)return;c[n]=s}n.push(c)}a||U(`Positionen laden: nach ${cr} Zeilen ohne Ende-Kennung abgebrochen (Relation Nr. ${t.nr}) — die Liste ist wahrscheinlich unvollständig, vermutlich passen Relationsnummer oder Ende-Felder nicht.`),dr.get(e.id)===r&&(ot(e.name,n),Jt())})()}var hr=new Map,gr=!1;function _r(e){if(!(e===``||typeof document>`u`))for(let t of Array.from(document.querySelectorAll(`[data-ff-id]`))){if(t.getAttribute(`source`)!==e)continue;let n=yt(t.getAttribute(`data-ff-id`)??``);if(n!==void 0)return n}}function vr(){let e=W().FF_DATA_SOURCES;if(Array.isArray(e))for(let t of e){if(!N(t)||typeof t.id!=`string`)continue;let n=P(e,t.id);if(!n?.ladeRelation)continue;let r=_r(n.ladeRelation.geberQuelleId),i=pt(r);hr.get(n.id)!==i&&(hr.set(n.id,i),mr(n,n.ladeRelation,r))}}function yr(){gr||(gr=!0,vt(vr))}function br(e){let t=new Set,n=!1,r=()=>{Bt()&&t.forEach(e.hydriere)};return{connect:i=>{i.hasAttribute(`data-ff-editor`)||(t.add(i),e.verdrahte?.(i),n||(n=!0,Gt(r),nr(r),vt(r),yr()),on(),Bt()&&e.hydriere(i))},disconnect:e=>{t.delete(e)}}}var xr=qe.toLowerCase(),Sr=``;function Cr(e){if(e.length===0)return``;let t=[];for(let n of e){let e=n.trim();if(e===``)return``;t.push(e)}return t.join(Sr)}function wr(e){let t=e.getAttribute(xr)??``;if(t===``)return[];try{let e=JSON.parse(t);if(!Array.isArray(e))return[];let n=[];for(let t of e){if(!t||typeof t!=`object`)continue;let e=t;if(typeof e.quelleId!=`string`||e.quelleId===``)continue;let r=[];for(let t of Array.isArray(e.keyPairs)?e.keyPairs:[]){if(!t||typeof t!=`object`)continue;let e=t;typeof e.fromField!=`string`||typeof e.toField!=`string`||e.fromField.trim()===``||e.toField.trim()===``||r.push({fromField:e.fromField,toField:e.toField})}r.length!==0&&n.push({quelleId:e.quelleId,keyPairs:r})}return n}catch{return[]}}function Tr(e){let t=wr(e);if(t.length===0)return(e,t)=>F(e,sr(t).code);let n=W().SEDATA,r=W().FF_DATA_SOURCES,i=new Map;for(let e of t){let t=P(r,e.quelleId);if(!t)continue;let a=L(n,t.name,t.tableId),o=new Map;for(let t of a){let n=Cr(e.keyPairs.map(e=>F(t,e.toField)));n!==``&&!o.has(n)&&o.set(n,t)}i.set(e.quelleId,{nachSchluessel:o,hierFelder:e.keyPairs.map(e=>e.fromField)})}return(e,t)=>{let{quelleId:n,code:r}=sr(t);if(n===``)return F(e,r);let a=i.get(n);if(!a)return``;let o=Cr(a.hierFelder.map(t=>F(e,t)));if(o===``)return``;let s=a.nachSchluessel.get(o);return s===void 0?``:F(s,r)}}function Er(e,t){let n=e.getAttribute(`source`)??``,r=e.getAttribute(t)??``;if(n===``||r===``)return{art:`ungebunden`};let i=P(W().FF_DATA_SOURCES,n);if(!i)return{art:`ohneQuelle`};let a=Ot(e,L(W().SEDATA,i.name,i.tableId));if(a===void 0)return{art:`ohneZeile`};let{quelleId:o,code:s}=sr(r);return{art:`wert`,wert:o===``?F(a,s):Tr(e)(a,r),zeile:a,quelle:i,quelleId:o,reinerCode:s}}var Dr=new WeakMap,Or=new WeakSet;function kr(e){let t=/^(\d{2})\.(\d{2})\.(\d{4})$/.exec(e);return t?`${t[3]}-${t[2]}-${t[1]}`:e}function Ar(e){let t=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);return t?`${t[3]}.${t[2]}.${t[1]}`:e}function jr(e){return typeof e.value==`string`?e.value:``}function Mr(e){if(e.pruefeEigenenWert?.(),e.getAttribute(`fieldtype`)===`nachschlagen`){Dr.delete(e);return}let t=Er(e,or(`value`));if(t.art!==`wert`){Dr.delete(e),t.art===`ohneZeile`&&(e.value=``);return}let{zeile:n,quelle:r,quelleId:i,reinerCode:a,wert:o}=t,s=r.indexField===``?``:F(n,r.indexField);i===``?Dr.set(e,{row:n,code:a,pindex:s}):Dr.delete(e),e.value=o}function Nr(e){let t=Dr.get(e);return t&&lt(t.row,t.code,jr(e)),t}function Pr(e){Or.has(e)||(Or.add(e),e.addEventListener(`input`,()=>{Nr(e)}),e.addEventListener(`change`,()=>{let t=Nr(e);Mn(e,`onChange`,{VALUE:jr(e),PINDEX:t?.pindex??``}).catch(jn)}))}var Fr=br({hydriere:Mr,verdrahte:Pr}),Ir=Fr.connect,Lr=Fr.disconnect,Rr=o`
  .feld {
    font-family: var(--se-font);
...
`;function zr(e){return e.trim().toLowerCase().split(/\s+/).filter(e=>e!==``)}function Br(e,t){let n=zr(t);if(n.length===0)return!0;let r=e.join(` `).toLowerCase();return n.every(e=>r.includes(e))}var Vr=10;function Hr(e,t,n){let r=[];for(let i of e){let e=F(i,t).trim(),a=F(i,n).trim();(e!==``||a!==``)&&r.push({anzeige:e,wert:a,satz:i})}return r}function Ur(e,t){return e.filter(e=>Br([e.anzeige,e.wert],t))}function Wr(e,t,n,r){return Hr(Dt(e,t).rows,n,r)}function Gr(e){if(e.quelleId===``||e.anzeigeFeld===``||e.speicherFeld===``)return{ok:!1,grund:`unvollstaendig`};let t=P(W().FF_DATA_SOURCES,e.quelleId);if(!t)return{ok:!1,grund:`quelleFehlt`};let n=L(W().SEDATA,t.name,t.tableId);return{ok:!0,eintraege:Wr(e.el,n,e.anzeigeFeld,e.speicherFeld)}}function Kr(e,t){return t&&e.length===1?e[0]:null}function qr(e,t){let{rows:n,gefiltert:r}=Dt(e,[t]);return!r||n.length>0}function Jr(e,t,n){return e===``?t===``&&n===``?`nichts`:`leeren`:e===t?`nichts`:`zurueck`}var Yr=null;function Xr(){Yr?.remove(),Yr=null}function Zr(e,t=!1){let n=document.createElement(t?`th`:`td`);return n.textContent=e,n.style.cssText=t?`position:sticky;top:0;z-index:1;padding:6px 10px;text-align:left;font-size:var(--se-fs-sm);font-weight:600;color:var(--se-muted);border-bottom:var(--se-border) solid var(--se-line);background:var(--se-panel-2)`:`box-sizing:border-box;height:24px;padding:3px 10px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;border-bottom:var(--se-border) solid var(--se-line-soft)`,n}function Qr(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.setAttribute(`aria-label`,t),n.style.cssText=`box-sizing:border-box;width:26px;height:24px;padding:0;border:var(--se-border) solid var(--se-line);border-radius:var(--se-r-sm);background:var(--se-panel);color:var(--se-ink);font:inherit;cursor:pointer`,n}function $r(e){let t=Gr(e);if(!t.ok){U(t.grund===`unvollstaendig`?`Nachschlagen ist an diesem Feld nicht vollstaendig eingestellt (Quelle, Angezeigt, Gespeichert).`:`Die Nachschlage-Quelle dieses Feldes ist in der Maske nicht vorhanden.`);return}let n=t.eintraege;Xr();let r=document.createElement(At);r.setAttribute(`data-ff-nachschlagen`,``),r.viewport=!0,r.mitWerkzeug=!0,r.escapeSchliesst=!0,r.titel=e.titel===``?`Nachschlagen`:e.titel,r.breite=520,r.hoehe=380,r.addEventListener(jt,Xr),r.addEventListener(`click`,e=>e.stopPropagation());let i=document.createElement(`input`);i.slot=`werkzeug`,i.type=`search`,i.placeholder=`suchen ...`,i.setAttribute(`aria-label`,`Nachschlagen durchsuchen`),i.style.cssText=`box-sizing:border-box;width:100%;padding:5px 8px;font:inherit;color:inherit;background:var(--se-panel);border:var(--se-border) solid var(--se-line);border-radius:var(--se-r-sm)`;let a=document.createElement(`table`);a.style.cssText=`width:100%;table-layout:fixed;border-collapse:collapse`;let o=document.createElement(`colgroup`),s=document.createElement(`col`);s.style.width=`65%`;let c=document.createElement(`col`);c.style.width=`35%`,o.append(s,c);let l=document.createElement(`thead`),u=document.createElement(`tr`);u.append(Zr(e.anzeigeTitel===``?`Angezeigt`:e.anzeigeTitel,!0),Zr(e.speicherTitel===``?`Wert`:e.speicherTitel,!0)),l.appendChild(u);let d=document.createElement(`tbody`);a.append(o,l,d);let f=document.createElement(`div`);f.style.cssText=`flex:1 1 auto;min-height:0;overflow:auto`,f.appendChild(a);let ee=document.createElement(`div`);ee.style.cssText=`box-sizing:border-box;flex:none;display:flex;align-items:center;min-height:33px;padding:4px 10px;border-top:var(--se-border) solid var(--se-line);background:var(--se-panel-2);font-size:var(--se-fs-sm)`;let te=document.createElement(`span`);te.setAttribute(`aria-live`,`polite`),te.style.cssText=`flex:1;color:var(--se-muted)`;let p=document.createElement(`nav`);p.setAttribute(`aria-label`,`Trefferseiten`),p.style.cssText=`display:flex;align-items:center;gap:6px`;let m=Qr(`‹`,`Vorherige Seite`),ne=document.createElement(`span`);ne.style.cssText=`min-width:48px;text-align:center;color:var(--se-muted)`;let h=Qr(`›`,`Nächste Seite`);p.append(m,ne,h),ee.append(te,p);let g=document.createElement(`div`);g.style.cssText=`box-sizing:border-box;height:100%;min-height:0;display:flex;flex-direction:column`,g.append(f,ee);let _=1,v=1,y=()=>{d.replaceChildren();let t=Ur(n,i.value);v=Math.max(1,Math.ceil(t.length/Vr)),_=Math.min(_,v);let r=(_-1)*Vr,a=t.slice(r,r+Vr);if(te.textContent=t.length===0?`0 von 0`:`${r+1}-${Math.min(r+Vr,t.length)} von ${t.length}`,ne.textContent=`${_} / ${v}`,m.disabled=_===1,h.disabled=_===v,m.style.opacity=m.disabled?`0.4`:`1`,h.style.opacity=h.disabled?`0.4`:`1`,m.style.cursor=m.disabled?`default`:`pointer`,h.style.cursor=h.disabled?`default`:`pointer`,f.scrollTop=0,a.length===0){let e=document.createElement(`tr`),t=Zr(n.length===0?`Diese Quelle hat keine Sätze.`:`Kein Satz passt zur Suche.`);t.colSpan=2,t.style.color=`var(--se-faint)`,t.style.fontSize=`var(--se-fs-sm)`,t.style.padding=`16px 10px`,e.appendChild(t),d.appendChild(e);return}for(let t of a){let n=document.createElement(`tr`);n.tabIndex=0,n.style.cursor=`pointer`;let r=Zr(t.anzeige),i=Zr(t.wert);i.style.fontFamily=`var(--se-mono)`,i.style.color=`var(--se-muted)`,n.append(r,i);let a=()=>{Xr(),e.onUebernehmen(t.anzeige,t.wert,t.satz)};n.addEventListener(`click`,a),n.addEventListener(`keydown`,e=>{e.key===`Enter`&&(e.preventDefault(),a())}),n.addEventListener(`mouseenter`,()=>{n.style.background=`var(--se-accent-soft)`}),n.addEventListener(`mouseleave`,()=>{n.style.background=``}),d.appendChild(n)}};i.addEventListener(`input`,()=>{_=1,y()}),m.addEventListener(`click`,()=>{_!==1&&(--_,y())}),h.addEventListener(`click`,()=>{_!==v&&(_+=1,y())}),y(),r.append(i,g),document.body.appendChild(r),Yr=r,r.updateComplete.then(()=>{r.isConnected&&i.focus()})}var ei=[`text`,`number`,`textarea`,`select`,`date`,`checkbox`,`nachschlagen`];function ti(e){return ei.includes(e)?e:`text`}var ni=[`text`,`number`,`textarea`,`select`,`nachschlagen`],J=class extends j{constructor(...e){super(...e),this.fieldType=`text`,this.placeholder=`Feldname`,this.options=``,this.source=``,this.value=``,this.valueField=``,this.nachschlagQuelle=``,this.anzeigeFeld=``,this.anzeigeTitel=``,this.speicherFeld=``,this.speicherTitel=``,this.einzigerTreffer=`nein`,this.anzeige=``,this.getippt=null,this.satz=void 0,this.angehakt=!1}static{this.blockType=`formfeld`}static{this.tagName=`ff-formfeld`}static{this.displayName=`Formularfeld`}static{this.category=`eingabe`}static{this.acceptsDataSource={wenn:{attributeName:`fieldType`,notEquals:`nachschlagen`}}}static{this.kannAuswahlFolgen=!0}static{this.satzWahl={quelleProp:`nachschlagQuelle`,wenn:{attributeName:`fieldType`,equals:`nachschlagen`}}}static{this.bindableSpots=[{prop:`value`,label:`Wert`,wenn:{attributeName:`fieldType`,notEquals:`nachschlagen`},vorschauProp:`placeholder`}]}static{this.actionValueSpots=[{prop:`value`,label:`Wert`}]}static{this.blockEvents=[{key:`onChange`,name:`Wert geändert`}]}static{this.defaultProps={width:240,fieldType:`text`,placeholder:`Feldname`,options:``,source:``,value:``,valueField:``,nachschlagQuelle:``,anzeigeFeld:``,anzeigeTitel:``,speicherFeld:``,speicherTitel:``,einzigerTreffer:`nein`}}static{this.raster={startW:6,startH:2,minW:2,minH:2}}static{this.customProperties=ar}static{this.styles=[j.styles,Rr]}onInput(e){let t=e.target;this.value=ti(this.fieldType)===`date`?Ar(t.value):t.value}onChange(){this.dispatchEvent(new Event(`change`))}textTpl(e,t=!1){return C`<span
    ...
    >${this.placeholder}</span>`}onTextClick(){this.hasAttribute(`data-ff-editor`)||this.setzeHaken(!this.angehakt)}setzeHaken(e){this.angehakt!==e&&(this.angehakt=e,this.dispatchEvent(new Event(`change`)))}controlTpl(e){switch(e){case`textarea`:return C`<textarea class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}></textarea>`;case`select`:{let e=this.options.split(`,`).map(e=>e.trim()).filter(e=>e!==``),t=this.value!==``&&!e.includes(this.value);return C`<select class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}>
          ...
          class="ctrl"
          type=${e}
          .value=${e===`date`?kr(this.value):this.value}
          @input=${this.onInput}
...
`;function si(e,t,n,r){return{attributeName:e,name:t,description:n,kind:`select`,options:[{value:`nein`,label:`Nein`},{value:`ja`,label:`Ja`}],...r}}var Y=class extends j{constructor(...e){super(...e),this.variant=`info`,this.heading=`Neue Spalte`,this.leerHinweis=``,this._count=0}static{this.blockType=`kanban-spalte`}static{this.tagName=`ff-kanban-spalte`}static{this.displayName=`Kanban-Spalte`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[q.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={variant:`info`,heading:`Neue Spalte`,auffang:`nein`}}static{this.customProperties=[zn(`variant`,`Bedeutung der Spalte — bestimmt ihre Farbwelt (Kopf, Fläche, Rahmen).`),si(`auffang`,`Auffangspalte`,`Einträge ohne passenden Spaltentitel landen hier. Ohne Auffangspalte landen sie in der ersten Spalte.`,{requiresDataSource:!0,exclusiveAmongSiblings:!0})]}static{this.styles=[j.styles,oi,o`
    ...
    `]}onSlotChange(e){let t=e.target;this._count=t.assignedElements().filter(e=>!e.hasAttribute(`data-ff-editor-helper`)&&e.tagName.toLowerCase()!==`template`).length}render(){return C`<div class="col v-${Ln(this.variant)}">
      <div class="head">
        <span class="dot"></span>
        <span
          class="title"
    ...
    </div>`}};A([k()],Y.prototype,`variant`,void 0),A([k()],Y.prototype,`heading`,void 0),A([k({attribute:!1})],Y.prototype,`leerHinweis`,void 0),A([Ve()],Y.prototype,`_count`,void 0),j.defineAndRegister(Y);function ci(e,t,n){return t===``||n===``?[...e]:e.filter(e=>Yn(F(e,t))===n)}function li(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function ui(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var di=new WeakMap,fi=Y.tagName,pi=q.tagName;function mi(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===fi)}function hi(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===pi)}function gi(e,t){let n=e.getAttribute(`leertext`)??`Keine Datensätze.`;for(let e of t)e.leerHinweis=hi(e).length===0?n:``}function _i(e){return We().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function vi(e){Z?.board===e&&(Z=null);let t=e.getAttribute(`source`)??``,n=e.getAttribute(`statusfield`)??``;if(t===``)return;let r=P(W().FF_DATA_SOURCES,t);if(!r)return;let i=mi(e);if(i.length===0)return;let a=di.get(e);if(!a){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(pi);t&&(a=t.cloneNode(!0),di.set(e,a))}if(!a)return;let o=ci(L(W().SEDATA,r.name,r.tableId),e.getAttribute(`tagfield`)??``,er()),s=i.map(e=>e.getAttribute(`heading`)??Y.defaultProps.heading),c=_i(a.tagName),l=ui(i.map(e=>e.getAttribute(`auffang`))),u=Tr(e);for(let e of i)hi(e).forEach(e=>e.remove());for(let e of o){let t=a.cloneNode(!0),o=n===``?-1:li(F(e,n),s);(o>=0?i[o]:l>=0?i[l]:i[0]).appendChild(t);for(let n of c){let r=t.getAttribute(or(n.prop))??``;r!==``&&(t[n.prop]=u(e,r))}let d=r.indexField===``?``:F(e,r.indexField);X.set(t,{row:e,pindex:d}),t.draggable=!0}gi(e,i);let d=i.flatMap(hi),f=xt(z(e),d,e=>X.get(e)?.row);for(let e of f)d[e].setAttribute(`data-ff-auswahl`,``)}var X=new WeakMap,Z=null,yi=new WeakSet;function bi(e,t){for(let n of t.composedPath())if(n instanceof HTMLElement&&n.tagName.toLowerCase()===fi&&e.contains(n))return n;return null}function xi(e,t){if(!Z||Z.board!==e)return;let n=X.get(Z.card);if(!n)return;let r=t.getAttribute(`heading`)??``;Mn(e,`onCardDrop`,{PINDEX:n.pindex,VALUE:r}).catch(jn)}function Si(e){yi.has(e)||(yi.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;if(!n)return;let r=X.get(n);r&&St(z(e),r.row),Mn(e,`onCardClick`,{PINDEX:r?.pindex??``}).catch(jn)}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;n&&(Z={card:n,board:e},t.dataTransfer?.setData(`text/plain`,X.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`))}),e.addEventListener(`dragend`,()=>{Z=null}),e.addEventListener(`dragover`,t=>{let n=bi(e,t);Z?.board===e&&n&&(t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`))}),e.addEventListener(`drop`,t=>{let n=bi(e,t);n&&(t.preventDefault(),xi(e,n),Z=null)}))}var Ci=br({hydriere:vi,verdrahte:Si}),wi=Ci.connect,Ti=Ci.disconnect,Ei=Y.blockType,Di=class extends j{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[Ei]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:Ei}}static{this.templateChild={type:q.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``,tagField:``,leerText:ri}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Optional: Feld der Datenquelle, dessen Inhalt bestimmt, in welche Spalte ein Eintrag kommt. Leer = alle Einträge in der Auffang-Spalte.`,kind:`field`},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt das Board nur Einträge des Tages, den der Tageswähler zeigt. Leer = alle Einträge.`,kind:`field`},ii()]}static{this.defaultChildren=[{type:Ei,props:{heading:`Offen`,variant:`warning`},children:[{type:q.blockType}]},{type:Ei,props:{heading:`In Arbeit`,variant:`info`}},{type:Ei,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[j.styles,o`
    ...
    <button
      ...
      @pointerdown=${n}
      @click=${r=>{n(r);let i=e();i.length<8&&(i.push(ta(i.length)),t(i))}}
    >+</button>
  </div>`}function ha(e,t){let n=e.currentTarget;if(!n)return;e.stopPropagation(),e.preventDefault();let r=Array.from(n.childNodes),i=n.textContent??``;n.setAttribute(`contenteditable`,`plaintext-only`),n.focus();let a=window.getSelection(),o=document.createRange();o.selectNodeContents(n),a?.removeAllRanges(),a?.addRange(o);let s=!1,c=e=>{if(s)return;s=!0,n.removeAttribute(`contenteditable`),n.removeEventListener(`blur`,l),n.removeEventListener(`keydown`,u);let a=(n.textContent??``).trim();e&&a&&a!==i.trim()?t(a):n.replaceChildren(...r)},l=()=>c(!0),u=e=>{e.key===`Enter`?(e.preventDefault(),n.blur()):e.key===`Escape`&&(e.preventDefault(),c(!1))};n.addEventListener(`blur`,l),n.addEventListener(`keydown`,u)}function ga(e,t,n,r){ha(e,e=>{let i=n();t>=i.length||(i[t]={...i[t],titel:e},r(i))})}var _a=220,va=new WeakMap;function ya(e){let t=va.get(e);t!==void 0&&(clearTimeout(t),va.delete(e))}function ba(e,t,n,r){t.stopPropagation();let i=t.currentTarget.getBoundingClientRect();ya(e),va.set(e,setTimeout(()=>{va.delete(e),e.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:n,index:r,top:i.bottom+4,left:i.left},bubbles:!0,composed:!0}))},_a))}var xa={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:$i,eintragsWahl:{key:`art`,label:`Darstellung`,optionen:Zi,standard:Ui,felderKey:Qi},eintragsZuordnung:{key:`zuordnung`,label:`Status-Zuordnung`,nurBeiWahl:Wi,wertLabel:`Datenwert`,nameLabel:`Klarname`,bedeutungLabel:`Bedeutung`,bedeutungen:Rn}},Sa=1,Ca=/^-?\d{1,3}(\.\d{3})*(,\d+)?$|^-?\d+(,\d+)?$|^-?\d+(\.\d+)?$/,wa=/^(\d{1,2})\.(\d{1,2})\.(\d{2}|\d{4})$/,Ta=/^(\d{4})-(\d{2})-(\d{2})$/;function Ea(e){let t=e.trim();if(t===``||!Ca.test(t))return null;let n=t.includes(`,`)?t.replace(/\./g,``).replace(`,`,`.`):/^-?\d{1,3}(\.\d{3})+$/.test(t)?t.replace(/\./g,``):t,r=Number(n);return Number.isFinite(r)?r:null}function Da(e){let t=e.trim();if(t===``)return null;let n=Ta.exec(t);if(n){let[,e,t,r]=n;return Oa(Number(e),Number(t),Number(r))}let r=wa.exec(t);if(r){let[,e,t,n]=r,i=Number(n);return Oa(n.length===2?i<=69?2e3+i:1900+i:i,Number(t),Number(e))}return null}function Oa(e,t,n){if(t<1||t>12||n<1||n>31)return null;let r=new Date(e,t-1,n);return r.getFullYear()!==e||r.getMonth()!==t-1||r.getDate()!==n?null:r.getTime()}function ka(e){let t=0,n=0,r=0;for(let i of e)i.trim()!==``&&(t++,Ea(i)!==null&&n++,Da(i)!==null&&r++);return t===0?`text`:r===t?`datum`:n===t?`zahl`:`text`}var Aa=new Intl.Collator(`de`,{numeric:!0,sensitivity:`base`});function ja(e,t,n){if(t<0||e.length===0)return e.map((e,t)=>t);let r=n=>e[n][t]??``,i=ka(e.map(e=>e[t]??``)),a=n?1:-1;return e.map((e,t)=>t).sort((e,t)=>{let n=r(e).trim(),o=r(t).trim();if(n===``&&o===``)return e-t;if(n===``)return Sa;if(o===``)return-1;let s=i===`zahl`?(Ea(n)??0)-(Ea(o)??0):i===`datum`?(Da(n)??0)-(Da(o)??0):Aa.compare(n,o);return s===0?e-t:s*a})}function Ma(e,t){let n=[];return e.forEach((e,r)=>{Br(e,t)&&n.push(r)}),n}function Na(e,t){return!e&&t.trim()!==``}function Pa(e,t,n){return e&&t&&n===0}function Fa(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}function Ia(e){let t=Ma(e.datenzeilen,e.suchtext);return e.sortSpalte<0?t:ja(t.map(t=>e.datenzeilen[t]),e.sortSpalte,e.sortAuf).map(e=>t[e])}function La(e){let t={gridTemplateColumns:e.spalten.map(e=>Xi(e.art).spur).join(` `)},n=Yi(e.spalten),r=e.gemessen?.zeilenHoehe??n,i=Na(e.imEditor,e.source),a=Pa(i,e.datenGeliefert,e.datenzeilen.length),o=Ia(e),{seiten:s,seite:c,zeilen:l}=zi({sichtbar:o,hatQuelle:i,proSeite:e.gemessen?.passen??10,wunschSeite:e.wunschSeite,platzhalterZeilen:Fi(e.gemessen?.passen??null)});return{cols:t,takt:n,zeilenHoehe:r,hatQuelle:i,leer:a,gesamt:o.length,seiten:s,seite:c,zeilen:l,linealTakte:Ri(e.gemessen?.passen??null,l.length)}}var Ra=[{attributeName:`suche`,name:`Suchzeile`,description:`Zeigt über der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,kind:`segment`,options:[{value:`ja`,label:`Ja`},{value:`nein`,label:`Nein`}],requiresDataSource:!0},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt die Tabelle nur Sätze des Tages, den der Tageswähler zeigt. Leer = alle Sätze.`,kind:`field`},ii()];function za(e,t){return C`<div class="fusszeile">
    <div class="seiten-info">${Fa({hatQuelle:e.hatQuelle,sichtbar:e.sichtbar,gesamt:e.gesamt,suchtAktiv:e.suchtAktiv,auswahlAktiv:e.auswahlAktiv})}</div>
    <div class="seiten-nav">
  ...
  </div>`}var Ba=`—`;function Va(e){return e.linealTakte===0?T:C`<div class="lineal" style=${Ni(e.linealTakte===null?e.cols:{...e.cols,flex:`0 1 auto`,height:`calc(var(--zeilen-hoehe) * ${e.linealTakte})`})}>
          ${e.spalten.map(()=>C`<div></div>`)}
        </div>`}function Ha(e,t){return C`
      ...
      <div class="kopf" style=${Ni(e.cols)}>
        ...
        ${e.zeilen.map(n=>C`<div
          ...
          >
            ${``}
            ${e.spalten.map((t,r)=>{let i=Xi(t.art),a=n===null?Ba:e.datenzeilen[n]?.[r]??``,o=n===null?{}:e.zusatzzeilen[n]?.[r]??{};return C`<div class=${i.klasse}>${i.zelle(a,t.zuordnung??[],o)}</div>`})}
          </div>`)}
        ${Va(e)}`}
      </div>
    `}var Ua=o`
...
`,Q=class e extends j{constructor(...e){super(...e),this.spalten=na(),this.source=``,this.suche=`ja`,this.leerText=ri,this._suchtext=``,this.datenzeilen=[],this.zusatzzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this.datenGeliefert=!1,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._beobachter=null,this._taktGemessen=0}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.listenBindung=xa}static{this.defaultProps={width:`fill`,source:``,spalten:na(),suche:`ja`,tagField:``,leerText:ri}}static{this.customProperties=Ra}static{this.raster={startW:14,startH:8,minW:6,minH:4}}messeRumpf(){let e=this.zeilenHoehe;this._taktGemessen=e;let t=Bi(this,e);t?.passen===this._mass?.passen&&t?.zeilenHoehe===this._mass?.zeilenHoehe||(this._mass=t,this.requestUpdate())}spaltenListe(){return oa(this.spalten)}get zeilenHoehe(){return Yi(this.spaltenListe())}klickZeile(e){if(e===null||this.hasAttribute(`data-ff-editor`))return;let t=z(this),n=this.rohzeilen[e];t===``||n===void 0||St(t,n)}setzeSuchtext(e){this._suchtext=e,this._seite=0,this.requestUpdate()}klickSortiere(e){this.editable||(this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.requestUpdate())}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}beobachte(){this._beobachter||(this._beobachter=Vi(this,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}connectedCallback(){super.connectedCallback(),fa(this),this.beobachte()}firstUpdated(){this.beobachte()}updated(){this._taktGemessen!==this.zeilenHoehe&&this.messeRumpf()}disconnectedCallback(){super.disconnectedCallback(),ya(this),this._beobachter?.disconnect(),this._beobachter=null,pa(this)}static{this.styles=[j.styles,Bn,oi,Ua]}render(){let t=this.spaltenListe(),n=e=>e.stopPropagation(),r=La({spalten:t,imEditor:this.hasAttribute(`data-ff-editor`),source:this.source,datenGeliefert:this.datenGeliefert,datenzeilen:this.datenzeilen,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,wunschSeite:this._seite,gemessen:this._mass});return C`<div class="tabelle" style=${Ni({"--takt":`${r.takt}px`,"--zeilen-hoehe":`${r.zeilenHoehe}px`})}>
      ${ma(()=>this.spaltenListe(),e=>this.aendere(e),n)}
      ${Ha({spalten:t,cols:r.cols,editable:this.editable,zeigeSuche:this.suche===`ja`,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,zeilen:r.zeilen,linealTakte:r.linealTakte,datenzeilen:this.datenzeilen,zusatzzeilen:this.zusatzzeilen,hatQuelle:r.hatQuelle,auswahlIndex:this.auswahlIndex,leer:r.leer,leerText:this.leerText},{setzeSuchtext:e=>this.setzeSuchtext(e),dblklickKopf:(e,t)=>{this.editable&&(ya(this),ga(e,t,()=>this.spaltenListe(),e=>this.aendere(e)))},klickKopf:(t,n)=>{this.editable&&ba(this,t,e.listenBindung.prop,n),this.klickSortiere(n)},klickZeile:e=>this.klickZeile(e),stop:n})}
      ${``}
      ${r.leer?T:za({hatQuelle:r.hatQuelle,sichtbar:r.gesamt,gesamt:this.datenzeilen.length,suchtAktiv:this._suchtext.trim()!==``,auswahlAktiv:this.durchAuswahlGefiltert,seite:r.seite,seiten:r.seiten},{blaettere:e=>{this._seite=e,this.requestUpdate()},stop:n})}
    </div>`}};A([k({converter:{fromAttribute:e=>e?sa(e):na(),toAttribute:e=>JSON.stringify(e)}})],Q.prototype,`spalten`,void 0),A([k()],Q.prototype,`source`,void 0),A([k()],Q.prototype,`suche`,void 0),A([k()],Q.prototype,`leerText`,void 0),A([k({attribute:!1})],Q.prototype,`datenzeilen`,void 0),A([k({attribute:!1})],Q.prototype,`zusatzzeilen`,void 0),A([k({attribute:!1})],Q.prototype,`rohzeilen`,void 0),A([k({attribute:!1})],Q.prototype,`auswahlIndex`,void 0),A([k({attribute:!1})],Q.prototype,`durchAuswahlGefiltert`,void 0),A([k({attribute:!1})],Q.prototype,`datenGeliefert`,void 0),j.defineAndRegister(Q);var Wa=or(`text`);function Ga(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(Wa)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function Ka(e){let t=Er(e,Wa);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function qa(e){Ga(e)&&(e.text=``)}var Ja=br({hydriere:Ka,verdrahte:qa}),Ya=Ja.connect,Xa=Ja.disconnect,Za=6,Qa=96,$a=14,eo={duenn:`300`,normal:`400`,fett:`700`},to={links:`left`,mitte:`center`,rechts:`right`},no={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},ro=`standard`;function io(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(Qa,Math.max(Za,t)):$a}function ao(e){return typeof e==`string`&&e in eo?e:`normal`}function oo(e){return typeof e==`string`&&e in to?e:`links`}function so(e){return typeof e==`string`&&e in no?e:ro}var $=class extends j{constructor(...e){super(...e),this.groesse=$a,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=ro,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:$a,gewicht:`normal`,ausrichtung:`links`,farbe:ro,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:Za,max:Qa,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[j.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return C`<div
      class="text"
      style=${Ni({fontSize:`${io(this.groesse)}px`,fontWeight:eo[ao(this.gewicht)],textAlign:to[oo(this.ausrichtung)],color:no[so(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),Ya(this)}disconnectedCallback(){super.disconnectedCallback(),Xa(this)}};A([k({type:Number})],$.prototype,`groesse`,void 0),A([k()],$.prototype,`gewicht`,void 0),A([k()],$.prototype,`ausrichtung`,void 0),A([k()],$.prototype,`farbe`,void 0),A([k()],$.prototype,`text`,void 0),A([k()],$.prototype,`source`,void 0),A([k()],$.prototype,`textField`,void 0),j.defineAndRegister($);var co=[`waagerecht`,`senkrecht`],lo=`waagerecht`;function uo(e){return co.includes(e)?e:lo}var fo=class extends j{constructor(...e){super(...e),this.richtung=lo}static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`,richtung:lo}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1,varianten:[{wenn:{attributeName:`richtung`,equals:`senkrecht`},startW:1,startH:6,breiteZiehbar:!1}]}}static{this.customProperties=[{attributeName:`richtung`,name:`Richtung`,description:`Waagerecht trennt oben von unten, senkrecht links von rechts.`,kind:`select`,options:[{value:`waagerecht`,label:`Waagerecht`},{value:`senkrecht`,label:`Senkrecht`}]}]}static{this.styles=[j.styles,o`
    ...
    `]}render(){return C`<div class="zeile"><slot></slot></div>`}};j.defineAndRegister(po),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;U(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();
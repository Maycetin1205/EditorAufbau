...
`,pi=`frei · hierher ziehen`,mi=`ff-zimmer-inhalt`,J=class extends M{constructor(...e){super(...e),this.heading=`Neues Zimmer`,this.leerHinweis=``}static{this.blockType=`kanban-zimmer`}static{this.tagName=`ff-kanban-zimmer`}static{this.displayName=`Kanban-Zimmer`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[K.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban-spalte`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={heading:`Neues Zimmer`}}static{this.styles=[M.styles,ui,fi,o`
    ...
    `]}connectedCallback(){super.connectedCallback(),ia(this)}disconnectedCallback(){super.disconnectedCallback(),aa(this)}klappen(){this.toggleAttribute(`offen`),Qi(this)}render(){return w`<div class="leiste">
      ...
      </div>`}};M.defineAndRegister(ca);var la={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},ua=e=>(...t)=>({_$litDirective$:e,values:t}),da=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},fa=`important`,pa=` !important`,ma=ua(class extends da{constructor(e){if(super(e),e.type!==la.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(pa);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?fa:``):n[e]=r}}return T}}),ha=4;function ga(e){return e??ha}function _a(e,t,n){return Math.max(1,Math.floor((e-t)/n))}function va(e,t,n){let r=_a(e,t,n),i=e-t;return i<n?{passen:r,zeilenHoehe:n}:{passen:r,zeilenHoehe:Math.floor(i/r*100)/100}}function ya(e,t){return e===null?null:Math.max(0,e-t)}function ba({sichtbar:e,hatQuelle:t,proSeite:n,wunschSeite:r,platzhalterZeilen:i}){let a=t?Math.max(1,Math.ceil(e.length/n)):1,o=Math.min(Math.max(r,0),a-1);return t?{seiten:a,seite:o,zeilen:[...e.slice(o*n,(o+1)*n)]}:{seiten:a,seite:o,zeilen:Array.from({length:i},()=>null)}}function xa(e,t){if(!e.hasAttribute(`fuellt`))return null;let n=e.renderRoot.querySelector(`.koerper`),r=e.renderRoot.querySelector(`.kopf`);return!(n instanceof HTMLElement)||!(r instanceof HTMLElement)?null:va(n.clientHeight,r.offsetHeight,t)}function Sa(e,t){if(typeof ResizeObserver>`u`)return null;let n=e.renderRoot.querySelector(`.koerper`);if(!n)return null;let r=new ResizeObserver(t);return r.observe(n),r}function Ca(e,t){let n=t.trim().toLowerCase();return e.find(e=>e.wert.trim().toLowerCase()===n)}var wa=`text`,Ta=`status`,Ea=`bild`,Da=`bild`,Oa=`unter`,ka=[{wert:wa,name:`Text`,spur:`minmax(0, 1fr)`,klasse:``,zelle:e=>e},{wert:`zahl`,name:`Zahl`,spur:`90px`,klasse:`zahl`,zelle:e=>e},{wert:`datum`,name:`Datum`,spur:`100px`,klasse:`zahl`,zelle:e=>e},{wert:Ta,name:`Status`,spur:`120px`,klasse:`status`,zelle:(e,t)=>{let n=Ca(t,e);return n?w`<span class="chip v-${Rn(n.bedeutung)}">${n.name.trim()===``?e:n.name}</span>`:w`<span class="chip">${e}</span>`}},{wert:Ea,name:`Bild + Name`,spur:`minmax(0, 1fr)`,klasse:`bild`,zusatzFelder:[{key:Da,label:`Bild`},{key:Oa,label:`Unterzeile`}],hoehe:e=>(e[Da]??``)!==``||(e[Oa]??``)!==``?44:32,zelle:(e,t,n)=>{let r=qn(n[Da]??``),i=n[Oa]??``;return w`<div class="bild-name">
        ${r===void 0?E:w`<span class="bild-zeichen">${r}</span>`}
        <div class="bild-text">
          <div class="bild-titel">${e}</div>
          ${i===``?E:w`<div class="bild-unter">${i}</div>`}
        </div>
      </div>`}}];function Aa(e){return e.reduce((e,t)=>{let n=ja(t.art);return Math.max(e,n.hoehe?.(t.felder??{})??32)},32)}function ja(e){return ka.find(t=>t.wert===e)??ka[0]}var Ma=ka.map(e=>({wert:e.wert,name:e.name,...e.zusatzFelder?{felder:e.zusatzFelder}:{}})),Na=`felder`,Pa=`Spalte {n}`;function Fa(e){return Pa.replace(`{n}`,String(e+1))}function Ia(e){return{titel:Fa(e),feld:``,art:wa}}function La(){return[0,1,2].map(e=>Ia(e))}function Ra(e){return Array.isArray(e)?e.filter(e=>!!e&&typeof e==`object`).map(e=>({wert:typeof e.wert==`string`?e.wert:``,name:typeof e.name==`string`?e.name:``,bedeutung:typeof e.bedeutung==`string`?e.bedeutung:``})).filter(e=>e.wert.trim()!==``):[]}function za(e){if(!e||typeof e!=`object`||Array.isArray(e))return{};let t={};for(let[n,r]of Object.entries(e))typeof r==`string`&&r!==``&&(t[n]=r);return t}function Ba(e,t){if(e&&typeof e==`object`){let n=e,r=Ra(n.zuordnung),i=za(n.felder);return{titel:typeof n.titel==`string`?n.titel:Fa(t),feld:typeof n.feld==`string`?n.feld:``,art:typeof n.art==`string`?n.art:wa,...r.length>0?{zuordnung:r}:{},...Object.keys(i).length>0?{felder:i}:{}}}return typeof e==`string`?{...Ia(t),titel:e}:Ia(t)}function Va(e){let t;if(Array.isArray(e))t=e.map((e,t)=>Ba(e,t));else if(typeof e==`number`&&Number.isFinite(e)||typeof e==`string`&&/^\d+$/.test(e)){let n=Math.max(1,Math.floor(Number(e)));t=[...Array(n).keys()].map(e=>Ia(e))}else t=La();return t.length>8&&(t=t.slice(0,8)),t.length<1&&(t=[Ia(0)]),t}function Ha(e){try{return Va(JSON.parse(e))}catch{return La()}}function Ua(e){return Ha(e.getAttribute(`spalten`)??``)}function Wa(e,t,n){let r={};for(let i of ja(e.art).zusatzFelder??[]){let a=e.felder?.[i.key]??``;a!==``&&(r[i.key]=n(t,a))}return r}function Ga(e){let t=()=>{e.datenzeilen=[],e.zusatzzeilen=[]},n=e.getAttribute(`source`)??``;if(n===``){t();return}let r=F(G().FF_DATA_SOURCES,n);if(!r){t();return}let i=Ua(e),{rows:a,gefiltert:o}=Nt(e,hi(R(G().SEDATA,r.name,r.tableId),e.getAttribute(`tagfield`)??``,tr())),s=Dt(B(e),a,e=>e)[0]??-1,c=Dr(e);e.datenGeliefert=!0,e.rohzeilen=a,e.auswahlIndex=s,e.durchAuswahlGefiltert=o,e.datenzeilen=a.map(e=>i.map(t=>t.feld===``?``:c(e,t.feld))),e.zusatzzeilen=a.map(e=>i.map(t=>Wa(t,e,c)))}var Ka=Sr({hydriere:Ga}),qa=Ka.connect,Ja=Ka.disconnect;function Ya(e,t,n){return w`<div class="steuerung">
    <button
    ...
    <button
      ...
      @pointerdown=${n}
      @click=${r=>{n(r);let i=e();i.length<8&&(i.push(Ia(i.length)),t(i))}}
    >+</button>
  </div>`}function Xa(e,t){let n=e.currentTarget;if(!n)return;e.stopPropagation(),e.preventDefault();let r=Array.from(n.childNodes),i=n.textContent??``;n.setAttribute(`contenteditable`,`plaintext-only`),n.focus();let a=window.getSelection(),o=document.createRange();o.selectNodeContents(n),a?.removeAllRanges(),a?.addRange(o);let s=!1,c=e=>{if(s)return;s=!0,n.removeAttribute(`contenteditable`),n.removeEventListener(`blur`,l),n.removeEventListener(`keydown`,u);let a=(n.textContent??``).trim();e&&a&&a!==i.trim()?t(a):n.replaceChildren(...r)},l=()=>c(!0),u=e=>{e.key===`Enter`?(e.preventDefault(),n.blur()):e.key===`Escape`&&(e.preventDefault(),c(!1))};n.addEventListener(`blur`,l),n.addEventListener(`keydown`,u)}function Za(e,t,n,r){Xa(e,e=>{let i=n();t>=i.length||(i[t]={...i[t],titel:e},r(i))})}var Qa=220,$a=new WeakMap;function eo(e){let t=$a.get(e);t!==void 0&&(clearTimeout(t),$a.delete(e))}function to(e,t,n,r){t.stopPropagation();let i=t.currentTarget.getBoundingClientRect();eo(e),$a.set(e,setTimeout(()=>{$a.delete(e),e.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:n,index:r,top:i.bottom+4,left:i.left},bubbles:!0,composed:!0}))},Qa))}var no={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:Pa,eintragsWahl:{key:`art`,label:`Darstellung`,optionen:Ma,standard:wa,felderKey:Na},eintragsZuordnung:{key:`zuordnung`,label:`Status-Zuordnung`,nurBeiWahl:Ta,wertLabel:`Datenwert`,nameLabel:`Klarname`,bedeutungLabel:`Bedeutung`,bedeutungen:zn}},ro=1,io=/^-?\d{1,3}(\.\d{3})*(,\d+)?$|^-?\d+(,\d+)?$|^-?\d+(\.\d+)?$/,ao=/^(\d{1,2})\.(\d{1,2})\.(\d{2}|\d{4})$/,oo=/^(\d{4})-(\d{2})-(\d{2})$/;function so(e){let t=e.trim();if(t===``||!io.test(t))return null;let n=t.includes(`,`)?t.replace(/\./g,``).replace(`,`,`.`):/^-?\d{1,3}(\.\d{3})+$/.test(t)?t.replace(/\./g,``):t,r=Number(n);return Number.isFinite(r)?r:null}function co(e){let t=e.trim();if(t===``)return null;let n=oo.exec(t);if(n){let[,e,t,r]=n;return lo(Number(e),Number(t),Number(r))}let r=ao.exec(t);if(r){let[,e,t,n]=r,i=Number(n);return lo(n.length===2?i<=69?2e3+i:1900+i:i,Number(t),Number(e))}return null}function lo(e,t,n){if(t<1||t>12||n<1||n>31)return null;let r=new Date(e,t-1,n);return r.getFullYear()!==e||r.getMonth()!==t-1||r.getDate()!==n?null:r.getTime()}function uo(e){let t=0,n=0,r=0;for(let i of e)i.trim()!==``&&(t++,so(i)!==null&&n++,co(i)!==null&&r++);return t===0?`text`:r===t?`datum`:n===t?`zahl`:`text`}var fo=new Intl.Collator(`de`,{numeric:!0,sensitivity:`base`});function po(e,t,n){if(t<0||e.length===0)return e.map((e,t)=>t);let r=n=>e[n][t]??``,i=uo(e.map(e=>e[t]??``)),a=n?1:-1;return e.map((e,t)=>t).sort((e,t)=>{let n=r(e).trim(),o=r(t).trim();if(n===``&&o===``)return e-t;if(n===``)return ro;if(o===``)return-1;let s=i===`zahl`?(so(n)??0)-(so(o)??0):i===`datum`?(co(n)??0)-(co(o)??0):fo.compare(n,o);return s===0?e-t:s*a})}function mo(e,t){let n=[];return e.forEach((e,r)=>{Kr(e,t)&&n.push(r)}),n}function ho(e,t){return!e&&t.trim()!==``}function go(e,t,n){return e&&t&&n===0}function _o(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}function vo(e){let t=mo(e.datenzeilen,e.suchtext);return e.sortSpalte<0?t:po(t.map(t=>e.datenzeilen[t]),e.sortSpalte,e.sortAuf).map(e=>t[e])}function yo(e){let t={gridTemplateColumns:e.spalten.map(e=>ja(e.art).spur).join(` `)},n=Aa(e.spalten),r=e.gemessen?.zeilenHoehe??n,i=ho(e.imEditor,e.source),a=go(i,e.datenGeliefert,e.datenzeilen.length),o=vo(e),{seiten:s,seite:c,zeilen:l}=ba({sichtbar:o,hatQuelle:i,proSeite:e.gemessen?.passen??10,wunschSeite:e.wunschSeite,platzhalterZeilen:ga(e.gemessen?.passen??null)});return{cols:t,takt:n,zeilenHoehe:r,hatQuelle:i,leer:a,gesamt:o.length,seiten:s,seite:c,zeilen:l,linealTakte:ya(e.gemessen?.passen??null,l.length)}}var bo=[{attributeName:`suche`,name:`Suchzeile`,description:`Zeigt über der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,kind:`segment`,options:[{value:`ja`,label:`Ja`},{value:`nein`,label:`Nein`}],requiresDataSource:!0},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt die Tabelle nur Sätze des Tages, den der Tageswähler zeigt. Leer = alle Sätze.`,kind:`field`},ci()];function xo(e,t){return w`<div class="fusszeile">
    <div class="seiten-info">${_o({hatQuelle:e.hatQuelle,sichtbar:e.sichtbar,gesamt:e.gesamt,suchtAktiv:e.suchtAktiv,auswahlAktiv:e.auswahlAktiv})}</div>
    <div class="seiten-nav">
  ...
  </div>`}var So=`—`;function Co(e){return e.linealTakte===0?E:w`<div class="lineal" role="presentation" style=${ma(e.linealTakte===null?e.cols:{...e.cols,flex:`0 1 auto`,height:`calc(var(--zeilen-hoehe) * ${e.linealTakte})`})}>
          ${e.spalten.map(()=>w`<div></div>`)}
        </div>`}function wo(e,t){return w`
      ...
      <div class="kopf" role="row" style=${ma(e.cols)}>
        ...
        ${e.zeilen.map((n,r)=>{let i=n!==null&&!e.imEditor;return w`<div
          ...
          >
            ${``}
            ${e.spalten.map((t,r)=>{let i=ja(t.art),a=n===null?So:e.datenzeilen[n]?.[r]??``,o=n===null?{}:e.zusatzzeilen[n]?.[r]??{};return w`<div class=${i.klasse} role="cell">${i.zelle(a,t.zuordnung??[],o)}</div>`})}
          </div>`})}
        ${Co(e)}`}
      </div>
    `}var To=o`
...
`,Eo=`ff-zeile-aktiviert`,Do=`data-ff-roh`;function Oo(e,t){e.dispatchEvent(new CustomEvent(Eo,{detail:t,bubbles:!0,composed:!0}))}function ko(e){let t=e?.activeElement;if(!(t instanceof HTMLElement))return;let n=t.closest(`.zeile`);if(!n)return;let r=n.getAttribute(Do);return r===null||r===``?null:Number(r)}function Ao(e,t){e&&((t===null?null:e.querySelector(`.zeile[data-ff-roh="${t}"]`))??e.querySelector(`.zeile[data-ff-roh]`)??e.querySelector(`.koerper`))?.focus()}var Q=class e extends M{constructor(...e){super(...e),this.spalten=La(),this.source=``,this.suche=`ja`,this.leerText=si,this._suchtext=``,this.datenzeilen=[],this.zusatzzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this.datenGeliefert=!1,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._beobachter=null,this._taktGemessen=0,this._fokusZeile=null,this._fokusHolen=!1}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.listenBindung=no}static{this.defaultProps={width:`fill`,source:``,spalten:La(),suche:`ja`,tagField:``,leerText:si}}static{this.customProperties=bo}static{this.raster={startW:14,startH:8,minW:6,minH:4}}merkeZeilenFokus(){let e=ko(this.shadowRoot);this._fokusHolen=e!==void 0,this._fokusZeile=e??null}messeRumpf(){let e=this.zeilenHoehe;this._taktGemessen=e;let t=xa(this,e);t?.passen===this._mass?.passen&&t?.zeilenHoehe===this._mass?.zeilenHoehe||(this._mass=t,this.requestUpdate())}spaltenListe(){return Va(this.spalten)}get zeilenHoehe(){return Aa(this.spaltenListe())}aktiviereZeile(e,t){if(e===null||this.hasAttribute(`data-ff-editor`))return;let n=this.rohzeilen[e];n!==void 0&&(Oo(this,{rohzeile:n,rohIndex:e,ansichtIndex:t}),this.toggleAuswahl(n))}toggleAuswahl(e){let t=B(this);t!==``&&Ot(t,e)}setzeSuchtext(e){this.merkeZeilenFokus(),this._suchtext=e,this._seite=0,this.requestUpdate()}klickSortiere(e){this.editable||(this.merkeZeilenFokus(),this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.requestUpdate())}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}beobachte(){this._beobachter||(this._beobachter=Sa(this,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}connectedCallback(){super.connectedCallback(),qa(this),this.beobachte()}firstUpdated(){this.beobachte()}updated(){this._taktGemessen!==this.zeilenHoehe&&this.messeRumpf(),this._fokusHolen&&(this._fokusHolen=!1,Ao(this.shadowRoot,this._fokusZeile))}disconnectedCallback(){super.disconnectedCallback(),eo(this),this._beobachter?.disconnect(),this._beobachter=null,Ja(this)}static{this.styles=[M.styles,Vn,ui,To]}render(){let t=this.spaltenListe(),n=e=>e.stopPropagation(),r=yo({spalten:t,imEditor:this.hasAttribute(`data-ff-editor`),source:this.source,datenGeliefert:this.datenGeliefert,datenzeilen:this.datenzeilen,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,wunschSeite:this._seite,gemessen:this._mass});return w`<div class="tabelle" style=${ma({"--takt":`${r.takt}px`,"--zeilen-hoehe":`${r.zeilenHoehe}px`})}>
    ...
    `]}render(){return w`<div
      class="text"
      style=${ma({fontSize:`${Go(this.groesse)}px`,fontWeight:Vo[Ko(this.gewicht)],textAlign:Ho[qo(this.ausrichtung)],color:Uo[Jo(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),Io(this)}disconnectedCallback(){super.disconnectedCallback(),Lo(this)}};j([k({type:Number})],$.prototype,`groesse`,void 0),j([k()],$.prototype,`gewicht`,void 0),j([k()],$.prototype,`ausrichtung`,void 0),j([k()],$.prototype,`farbe`,void 0),j([k()],$.prototype,`text`,void 0),j([k()],$.prototype,`source`,void 0),j([k()],$.prototype,`textField`,void 0),M.defineAndRegister($);var Yo=[`waagerecht`,`senkrecht`],Xo=`waagerecht`;function Zo(e){return Yo.includes(e)?e:Xo}var Qo=class extends M{constructor(...e){super(...e),this.richtung=Xo}static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`,richtung:Xo}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1,varianten:[{wenn:{attributeName:`richtung`,equals:`senkrecht`},startW:1,startH:6,breiteZiehbar:!1}]}}static{this.customProperties=[{attributeName:`richtung`,name:`Richtung`,description:`Waagerecht trennt oben von unten, senkrecht links von rechts.`,kind:`select`,options:[{value:`waagerecht`,label:`Waagerecht`},{value:`senkrecht`,label:`Senkrecht`}]}]}static{this.styles=[M.styles,o`
    ...
    `]}render(){return w`<div class="flaeche ${Zo(this.richtung)}"><div class="linie"></div></div>`}};j([k()],Qo.prototype,`richtung`,void 0),M.defineAndRegister(Qo),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;W(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();
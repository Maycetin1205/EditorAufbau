...
`,_r=`ff-dialog-rahmen`,vr=`ff-dialog-schliessen`;function yr(e,t){let n=Number(e);return Number.isFinite(n)&&n>0?n:t}var K=class extends O{constructor(...e){super(...e),this.titel=`Dialog`,this.breite=520,this.hoehe=380,this.viewport=!1,this.mitWerkzeug=!1,this.escapeSchliesst=!1,this.escapeRegistriert=!1,this.aufTaste=e=>{e.key===`Escape`&&(e.stopPropagation(),this.schliesse())}}static{this.styles=o`
  ...
  `}aktualisiereEscape(){let e=this.isConnected&&this.escapeSchliesst;e!==this.escapeRegistriert&&(e?document.addEventListener(`keydown`,this.aufTaste,!0):document.removeEventListener(`keydown`,this.aufTaste,!0),this.escapeRegistriert=e)}schliesse(){this.dispatchEvent(new CustomEvent(vr,{bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this.aktualisiereEscape()}updated(e){e.has(`escapeSchliesst`)&&this.aktualisiereEscape()}disconnectedCallback(){this.escapeRegistriert&&=(document.removeEventListener(`keydown`,this.aufTaste,!0),!1),super.disconnectedCallback()}render(){return w`
    ...
    >${this.placeholder}</span>`}onTextClick(){this.hasAttribute(`data-ff-editor`)||this.setzeHaken(!this.angehakt)}setzeHaken(e){this.angehakt!==e&&(this.angehakt=e,this.dispatchEvent(new Event(`change`)))}controlTpl(e){switch(e){case`textarea`:return w`<textarea class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}></textarea>`;case`select`:{let e=this.options.split(`,`).map(e=>e.trim()).filter(e=>e!==``),t=this.value!==``&&!e.includes(this.value);return w`<select class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}>
        ...
        />`}}onLupe(){this.hasAttribute(`data-ff-editor`)||Nr({el:this,quelleId:this.nachschlagQuelle,anzeigeFeld:this.anzeigeFeld,speicherFeld:this.speicherFeld,anzeigeTitel:this.anzeigeTitel,speicherTitel:this.speicherTitel,titel:this.placeholder,onUebernehmen:(e,t,n)=>{this.uebernimmSatz(e,t,n),this.dispatchEvent(new Event(`change`))}})}leereNachschlagen(){this.satz=void 0,this.anzeige=``,this.value=``,yt(R(this))}uebernimmSatz(e,t,n){this.anzeige=e===``?t:e,this.value=t,this.satz=n,vt(R(this),n)}onLoeschen(){this.hasAttribute(`data-ff-editor`)||(this.leereNachschlagen(),this.dispatchEvent(new Event(`change`)))}pruefeEigenenWert(){Fr(this.fieldType)===`nachschlagen`&&(this.satz!==void 0&&!Or(this,this.satz)&&this.leereNachschlagen(),this.uebernimmEinzigenTreffer())}uebernimmEinzigenTreffer(){if(this.einzigerTreffer!==`ja`)return;let e=Er({el:this,quelleId:this.nachschlagQuelle,anzeigeFeld:this.anzeigeFeld,speicherFeld:this.speicherFeld});if(!e.ok)return;let t=Dr(e.eintraege,this.satz===void 0);t&&this.uebernimmSatz(t.anzeige,t.wert,t.satz)}render(){let e=Fr(this.fieldType);if(e===`checkbox`)return w`<div class="feld">
        <div class="zeile">
          <input
            class="ctrl"
            type="checkbox"
      ...
      >
        ${this.controlTpl(e)}
        ${Ir.includes(e)?this.textTpl(e===`select`?`ph ph-select`:`ph`,this.value!==``):E}
      </div>
    </div>`}connectedCallback(){super.connectedCallback(),mr(this)}disconnectedCallback(){super.disconnectedCallback(),hr(this)}};A([k()],q.prototype,`fieldType`,void 0),A([k()],q.prototype,`placeholder`,void 0),A([k()],q.prototype,`options`,void 0),A([k()],q.prototype,`source`,void 0),A([k()],q.prototype,`value`,void 0),A([k()],q.prototype,`valueField`,void 0),A([k()],q.prototype,`nachschlagQuelle`,void 0),A([k()],q.prototype,`anzeigeFeld`,void 0),A([k()],q.prototype,`anzeigeTitel`,void 0),A([k()],q.prototype,`speicherFeld`,void 0),A([k()],q.prototype,`speicherTitel`,void 0),A([k()],q.prototype,`einzigerTreffer`,void 0),A([Ve()],q.prototype,`anzeige`,void 0),A([Ve()],q.prototype,`angehakt`,void 0),j.defineAndRegister(q);var Lr=`Keine Einträge.`;function Rr(){return{attributeName:`leerText`,name:`Text wenn leer`,description:`Der Satz, den die Maske zeigt, wenn die Datenquelle keine Zeile liefert. Leer lassen: dann steht dort gar nichts.`,kind:`text`,requiresDataSource:!0}}function zr(e,t=!1){return e.trim()===``?E:w`<div class="leer${t?` leer--tafel`:``}">
    ${Mn()}
    <span>${e}</span>
  </div>`}var Br=o`
  .leer {
...
`;function Vr(e,t,n,r){return{attributeName:e,name:t,description:n,kind:`select`,options:[{value:`nein`,label:`Nein`},{value:`ja`,label:`Ja`}],...r}}var J=class extends j{constructor(...e){super(...e),this.variant=`info`,this.heading=`Neue Spalte`,this.leerHinweis=``,this._count=0}static{this.blockType=`kanban-spalte`}static{this.tagName=`ff-kanban-spalte`}static{this.displayName=`Kanban-Spalte`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[G.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={variant:`info`,heading:`Neue Spalte`,auffang:`nein`}}static{this.customProperties=[kn(`variant`,`Bedeutung der Spalte — bestimmt ihre Farbwelt (Kopf, Fläche, Rahmen).`),Vr(`auffang`,`Auffangspalte`,`Einträge ohne passenden Spaltentitel landen hier. Ohne Auffangspalte landen sie in der ersten Spalte.`,{requiresDataSource:!0,exclusiveAmongSiblings:!0})]}static{this.styles=[j.styles,Br,o`
    ...
    </div>`}};A([k()],J.prototype,`variant`,void 0),A([k()],J.prototype,`heading`,void 0),A([k({attribute:!1})],J.prototype,`leerHinweis`,void 0),A([Ve()],J.prototype,`_count`,void 0),j.defineAndRegister(J);function Hr(e,t,n){return t===``||n===``?[...e]:e.filter(e=>zn(P(e,t))===n)}function Ur(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function Wr(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var Gr=new WeakMap,Kr=J.tagName,qr=G.tagName;function Jr(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Kr)}function Yr(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===qr)}function Xr(e,t){let n=e.getAttribute(`leertext`)??`Keine Einträge.`;for(let e of t)e.leerHinweis=Yr(e).length===0?n:``}function Zr(e){return We().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function Qr(e){X?.board===e&&(X=null);let t=e.getAttribute(`source`)??``,n=e.getAttribute(`statusfield`)??``;if(t===``)return;let r=N(H().FF_DATA_SOURCES,t);if(!r)return;let i=Jr(e);if(i.length===0)return;let a=Gr.get(e);if(!a){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(qr);t&&(a=t.cloneNode(!0),Gr.set(e,a))}if(!a)return;let o=Hr(I(H().SEDATA,r.name,r.tableId),e.getAttribute(`tagfield`)??``,Wn()),s=i.map(e=>e.getAttribute(`heading`)??J.defaultProps.heading),c=Zr(a.tagName),l=Wr(i.map(e=>e.getAttribute(`auffang`))),u=rr(e);for(let e of i)Yr(e).forEach(e=>e.remove());for(let e of o){let t=a.cloneNode(!0),o=n===``?-1:Ur(P(e,n),s);(o>=0?i[o]:l>=0?i[l]:i[0]).appendChild(t);for(let n of c){let r=t.getAttribute(Xn(n.prop))??``;r!==``&&(t[n.prop]=u(e,r))}let d=r.indexField===``?``:P(e,r.indexField);Y.set(t,{row:e,pindex:d}),t.draggable=!0}Xr(e,i);let d=i.flatMap(Yr),f=gt(R(e),d,e=>Y.get(e)?.row);for(let e of f)d[e].setAttribute(`data-ff-auswahl`,``)}var Y=new WeakMap,X=null,$r=new WeakSet;function ei(e,t){for(let n of t.composedPath())if(n instanceof HTMLElement&&n.tagName.toLowerCase()===Kr&&e.contains(n))return n;return null}function ti(e,t){if(!X||X.board!==e)return;let n=Y.get(X.card);if(!n)return;let r=t.getAttribute(`heading`)??``;Sn(e,`onCardDrop`,{PINDEX:n.pindex,VALUE:r}).catch(xn)}function ni(e){$r.has(e)||($r.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&Y.has(e))??null;if(!n)return;let r=Y.get(n);r&&_t(R(e),r.row),Sn(e,`onCardClick`,{PINDEX:r?.pindex??``}).catch(xn)}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&Y.has(e))??null;n&&(X={card:n,board:e},t.dataTransfer?.setData(`text/plain`,Y.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`))}),e.addEventListener(`dragend`,()=>{X=null}),e.addEventListener(`dragover`,t=>{let n=ei(e,t);X?.board===e&&n&&(t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`))}),e.addEventListener(`drop`,t=>{let n=ei(e,t);n&&(t.preventDefault(),ti(e,n),X=null)}))}var ri=Qn({hydriere:Qr,verdrahte:ni}),ii=ri.connect,ai=ri.disconnect,oi=J.blockType,si=class extends j{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[oi]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:oi}}static{this.templateChild={type:G.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``,tagField:``,leerText:Lr}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Optional: Feld der Datenquelle, dessen Inhalt bestimmt, in welche Spalte ein Eintrag kommt. Leer = alle Einträge in der Auffang-Spalte.`,kind:`field`},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt das Board nur Einträge des Tages, den der Tageswähler zeigt. Leer = alle Einträge.`,kind:`field`},Rr()]}static{this.defaultChildren=[{type:oi,props:{heading:`Offen`,variant:`warning`},children:[{type:G.blockType}]},{type:oi,props:{heading:`In Arbeit`,variant:`info`}},{type:oi,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[j.styles,o`
    ...
    `]}render(){return w`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),ii(this)}disconnectedCallback(){super.disconnectedCallback(),ai(this)}};j.defineAndRegister(si);var ci={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},li=e=>(...t)=>({_$litDirective$:e,values:t}),ui=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},di=`important`,fi=` !important`,pi=li(class extends ui{constructor(e){if(super(e),e.type!==ci.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(fi);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?di:``):n[e]=r}}return T}}),mi=[10,25,50],hi=`passend`,gi=mi[0];function _i(e){let t=Number(e);return mi.some(e=>e===t)?t:null}function vi(e,t,n){return Math.max(1,Math.floor((e-t)/n))}function yi({sichtbar:e,hatQuelle:t,proSeite:n,wunschSeite:r,platzhalterZeilen:i}){let a=t?Math.max(1,Math.ceil(e.length/n)):1,o=Math.min(Math.max(r,0),a-1);return t?{seiten:a,seite:o,zeilen:[...e.slice(o*n,(o+1)*n)]}:{seiten:a,seite:o,zeilen:Array.from({length:i},()=>null)}}function bi(e,t){if(!e.hasAttribute(`fuellt`))return null;let n=e.renderRoot.querySelector(`.koerper`),r=e.renderRoot.querySelector(`.kopf`);return!(n instanceof HTMLElement)||!(r instanceof HTMLElement)?null:vi(n.clientHeight,r.offsetHeight,t)}function xi(e,t){if(typeof ResizeObserver>`u`)return null;let n=e.renderRoot.querySelector(`.koerper`);if(!n)return null;let r=new ResizeObserver(t);return r.observe(n),r}function Si(e,t){let n=t.trim().toLowerCase();return e.find(e=>e.wert.trim().toLowerCase()===n)}var Ci=`text`,wi=`status`,Ti=`bild`,Ei=`bild`,Di=`unter`,Oi=[{wert:Ci,name:`Text`,spur:`minmax(0, 1fr)`,klasse:``,zelle:e=>e},{wert:`zahl`,name:`Zahl`,spur:`90px`,klasse:`zahl`,zelle:e=>e},{wert:`datum`,name:`Datum`,spur:`100px`,klasse:`zahl`,zelle:e=>e},{wert:wi,name:`Status`,spur:`120px`,klasse:`status`,zelle:(e,t)=>{let n=Si(t,e);return n?w`<span class="chip v-${Dn(n.bedeutung)}">${n.name.trim()===``?e:n.name}</span>`:w`<span class="chip">${e}</span>`}},{wert:Ti,name:`Bild + Name`,spur:`minmax(0, 1fr)`,klasse:`bild`,zusatzFelder:[{key:Ei,label:`Bild`},{key:Di,label:`Unterzeile`}],hoehe:e=>(e[Ei]??``)!==``||(e[Di]??``)!==``?44:32,zelle:(e,t,n)=>{let r=In(n[Ei]??``),i=n[Di]??``;return w`<div class="bild-name">
        ${r===void 0?E:w`<span class="bild-zeichen">${r}</span>`}
        <div class="bild-text">
          <div class="bild-titel">${e}</div>
          ${i===``?E:w`<div class="bild-unter">${i}</div>`}
        </div>
      </div>`}}];function ki(e){return e.reduce((e,t)=>{let n=Ai(t.art);return Math.max(e,n.hoehe?.(t.felder??{})??32)},32)}function Ai(e){return Oi.find(t=>t.wert===e)??Oi[0]}var ji=Oi.map(e=>({wert:e.wert,name:e.name,...e.zusatzFelder?{felder:e.zusatzFelder}:{}})),Mi=`felder`,Ni=`Spalte {n}`;function Pi(e){return Ni.replace(`{n}`,String(e+1))}function Z(e){return{titel:Pi(e),feld:``,art:Ci}}function Fi(){return[0,1,2].map(e=>Z(e))}function Ii(e){return Array.isArray(e)?e.filter(e=>!!e&&typeof e==`object`).map(e=>({wert:typeof e.wert==`string`?e.wert:``,name:typeof e.name==`string`?e.name:``,bedeutung:typeof e.bedeutung==`string`?e.bedeutung:``})).filter(e=>e.wert.trim()!==``):[]}function Li(e){if(!e||typeof e!=`object`||Array.isArray(e))return{};let t={};for(let[n,r]of Object.entries(e))typeof r==`string`&&r!==``&&(t[n]=r);return t}function Ri(e,t){if(e&&typeof e==`object`){let n=e,r=Ii(n.zuordnung),i=Li(n.felder);return{titel:typeof n.titel==`string`?n.titel:Pi(t),feld:typeof n.feld==`string`?n.feld:``,art:typeof n.art==`string`?n.art:Ci,...r.length>0?{zuordnung:r}:{},...Object.keys(i).length>0?{felder:i}:{}}}return typeof e==`string`?{...Z(t),titel:e}:Z(t)}function zi(e){let t;if(Array.isArray(e))t=e.map((e,t)=>Ri(e,t));else if(typeof e==`number`&&Number.isFinite(e)||typeof e==`string`&&/^\d+$/.test(e)){let n=Math.max(1,Math.floor(Number(e)));t=[...Array(n).keys()].map(e=>Z(e))}else t=Fi();return t.length>8&&(t=t.slice(0,8)),t.length<1&&(t=[Z(0)]),t}function Bi(e){try{return zi(JSON.parse(e))}catch{return Fi()}}function Vi(e){return Bi(e.getAttribute(`spalten`)??``)}function Hi(e,t,n){let r={};for(let i of Ai(e.art).zusatzFelder??[]){let a=e.felder?.[i.key]??``;a!==``&&(r[i.key]=n(t,a))}return r}function Ui(e){let t=()=>{e.datenzeilen=[],e.zusatzzeilen=[]},n=e.getAttribute(`source`)??``;if(n===``){t();return}let r=N(H().FF_DATA_SOURCES,n);if(!r){t();return}let i=Vi(e),{rows:a,gefiltert:o}=St(e,Hr(I(H().SEDATA,r.name,r.tableId),e.getAttribute(`tagfield`)??``,Wn())),s=gt(R(e),a,e=>e)[0]??-1,c=rr(e);e.datenGeliefert=!0,e.rohzeilen=a,e.auswahlIndex=s,e.durchAuswahlGefiltert=o,e.datenzeilen=a.map(e=>i.map(t=>t.feld===``?``:c(e,t.feld))),e.zusatzzeilen=a.map(e=>i.map(t=>Hi(t,e,c)))}var Wi=Qn({hydriere:Ui}),Gi=Wi.connect,Ki=Wi.disconnect,qi=1,Ji=/^-?\d{1,3}(\.\d{3})*(,\d+)?$|^-?\d+(,\d+)?$|^-?\d+(\.\d+)?$/,Yi=/^(\d{1,2})\.(\d{1,2})\.(\d{2}|\d{4})$/,Xi=/^(\d{4})-(\d{2})-(\d{2})$/;function Zi(e){let t=e.trim();if(t===``||!Ji.test(t))return null;let n=t.includes(`,`)?t.replace(/\./g,``).replace(`,`,`.`):/^-?\d{1,3}(\.\d{3})+$/.test(t)?t.replace(/\./g,``):t,r=Number(n);return Number.isFinite(r)?r:null}function Qi(e){let t=e.trim();if(t===``)return null;let n=Xi.exec(t);if(n){let[,e,t,r]=n;return $i(Number(e),Number(t),Number(r))}let r=Yi.exec(t);if(r){let[,e,t,n]=r,i=Number(n);return $i(n.length===2?i<=69?2e3+i:1900+i:i,Number(t),Number(e))}return null}function $i(e,t,n){if(t<1||t>12||n<1||n>31)return null;let r=new Date(e,t-1,n);return r.getFullYear()!==e||r.getMonth()!==t-1||r.getDate()!==n?null:r.getTime()}function ea(e){let t=0,n=0,r=0;for(let i of e)i.trim()!==``&&(t++,Zi(i)!==null&&n++,Qi(i)!==null&&r++);return t===0?`text`:r===t?`datum`:n===t?`zahl`:`text`}var ta=new Intl.Collator(`de`,{numeric:!0,sensitivity:`base`});function na(e,t,n){if(t<0||e.length===0)return e.map((e,t)=>t);let r=n=>e[n][t]??``,i=ea(e.map(e=>e[t]??``)),a=n?1:-1;return e.map((e,t)=>t).sort((e,t)=>{let n=r(e).trim(),o=r(t).trim();if(n===``&&o===``)return e-t;if(n===``)return qi;if(o===``)return-1;let s=i===`zahl`?(Zi(n)??0)-(Zi(o)??0):i===`datum`?(Qi(n)??0)-(Qi(o)??0):ta.compare(n,o);return s===0?e-t:s*a})}function ra(e,t,n){return w`<div class="steuerung">
    <button
    ...
    >+</button>
  </div>`}function ia(e,t){let n=e.currentTarget;if(!n)return;e.stopPropagation(),e.preventDefault();let r=Array.from(n.childNodes),i=n.textContent??``;n.setAttribute(`contenteditable`,`plaintext-only`),n.focus();let a=window.getSelection(),o=document.createRange();o.selectNodeContents(n),a?.removeAllRanges(),a?.addRange(o);let s=!1,c=e=>{if(s)return;s=!0,n.removeAttribute(`contenteditable`),n.removeEventListener(`blur`,l),n.removeEventListener(`keydown`,u);let a=(n.textContent??``).trim();e&&a&&a!==i.trim()?t(a):n.replaceChildren(...r)},l=()=>c(!0),u=e=>{e.key===`Enter`?(e.preventDefault(),n.blur()):e.key===`Escape`&&(e.preventDefault(),c(!1))};n.addEventListener(`blur`,l),n.addEventListener(`keydown`,u)}function aa(e,t,n,r){ia(e,e=>{let i=n();t>=i.length||(i[t]={...i[t],titel:e},r(i))})}var oa=220,sa=new WeakMap;function ca(e){let t=sa.get(e);t!==void 0&&(clearTimeout(t),sa.delete(e))}function la(e,t,n,r){t.stopPropagation();let i=t.currentTarget.getBoundingClientRect();ca(e),sa.set(e,setTimeout(()=>{sa.delete(e),e.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:n,index:r,top:i.bottom+4,left:i.left},bubbles:!0,composed:!0}))},oa))}var ua={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:Ni,eintragsWahl:{key:`art`,label:`Darstellung`,optionen:ji,standard:Ci,felderKey:Mi},eintragsZuordnung:{key:`zuordnung`,label:`Status-Zuordnung`,nurBeiWahl:wi,wertLabel:`Datenwert`,nameLabel:`Klarname`,bedeutungLabel:`Bedeutung`,bedeutungen:On}};function da(e,t){let n=[];return e.forEach((e,r)=>{xr(e,t)&&n.push(r)}),n}function fa(e,t){return!e&&t.trim()!==``}function pa(e,t,n){return e&&t&&n===0}function ma(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}var ha=[{value:`ja`,label:`Ja`},{value:`nein`,label:`Nein`}],ga=[{attributeName:`suche`,name:`Suchzeile`,description:`Zeigt ueber der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,kind:`segment`,options:ha,requiresDataSource:!0},{attributeName:`zeilenWaehler`,name:`Zeilen-Wähler`,description:`Zeigt dem Bediener unten in der Maske den Wähler „Zeilen pro Seite" — er darf die Einstellung dann für seine Sitzung übersteuern. Nein: es gilt unveränderlich, was hier im Editor eingestellt ist.`,kind:`segment`,options:ha,requiresDataSource:!0},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt die Tabelle nur Saetze des Tages, den der Tageswaehler zeigt. Leer = alle Saetze.`,kind:`field`},Rr()];function _a(e,t){return w`<div class="fusszeile">
    ...
    <div class="seiten-nav">
      ...
      >
        ...
        <option value=${hi} ?selected=${e.einstellung===hi}>passend zur Höhe</option>
        ${mi.map(t=>w`<option value=${t} ?selected=${e.einstellung===String(t)}>${t} pro Seite</option>`)}
      </select>`:E}
      <button
  ...
  </div>`}var va=`—`;function ya(e,t){return w`
      ...
      <div class="koerper">
      <div class="kopf" style=${pi(e.cols)}>
        ${e.spalten.map((n,r)=>w`<div
            class=${Ai(n.art).klasse}
            data-ff-editable
        ...
        ${e.zeilen.map(n=>w`<div
          ...
          >
            ${``}
            ${e.spalten.map((t,r)=>{let i=Ai(t.art),a=n===null?va:e.datenzeilen[n]?.[r]??``,o=n===null?{}:e.zusatzzeilen[n]?.[r]??{};return w`<div class=${i.klasse}>${i.zelle(a,t.zuordnung??[],o)}</div>`})}
          </div>`)}
        ${``}
        <div class="lineal" style=${pi(e.cols)}>
...
`,xa=4,Q=class e extends j{constructor(...e){super(...e),this.spalten=Fi(),this.source=``,this.suche=`ja`,this.proSeite=hi,this.zeilenWaehler=`nein`,this.leerText=Lr,this._suchtext=``,this.datenzeilen=[],this.zusatzzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this.datenGeliefert=!1,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._proSeiteWahl=null,this._proSeiteGemessen=null,this._beobachter=null,this._taktGemessen=0}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.listenBindung=ua}static{this.defaultProps={width:`fill`,source:``,spalten:Fi(),suche:`ja`,tagField:``,proSeite:hi,zeilenWaehler:`nein`,leerText:Lr}}static{this.customProperties=ga}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get einstellung(){return this._proSeiteWahl??this.proSeite}get proSeiteAktuell(){return _i(this.einstellung)??this._proSeiteGemessen??gi}waehleProSeite(e){this.hasAttribute(`data-ff-editor`)?this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`proSeite`,value:e},bubbles:!0,composed:!0})):this._proSeiteWahl=e,this._seite=0,this.requestUpdate()}messeRumpf(){let e=this.zeilenHoehe;this._taktGemessen=e;let t=bi(this,e);t!==this._proSeiteGemessen&&(this._proSeiteGemessen=t,this.requestUpdate())}spaltenListe(){return zi(this.spalten)}get zeilenHoehe(){return ki(this.spaltenListe())}sichtbareIndizes(){let e=da(this.datenzeilen,this._suchtext);return this._sortSpalte<0?e:na(e.map(e=>this.datenzeilen[e]),this._sortSpalte,this._sortAuf).map(t=>e[t])}klickZeile(e){if(e===null||this.hasAttribute(`data-ff-editor`))return;let t=R(this),n=this.rohzeilen[e];t===``||n===void 0||_t(t,n)}setzeSuchtext(e){this._suchtext=e,this._seite=0,this.requestUpdate()}klickSortiere(e){this.editable||(this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.requestUpdate())}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}beobachte(){this._beobachter||(this._beobachter=xi(this,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}connectedCallback(){super.connectedCallback(),Gi(this),this.beobachte()}firstUpdated(){this.beobachte()}updated(){this._taktGemessen!==this.zeilenHoehe&&this.messeRumpf()}disconnectedCallback(){super.disconnectedCallback(),ca(this),this._beobachter?.disconnect(),this._beobachter=null,Ki(this)}static{this.styles=[j.styles,An,Br,ba]}render(){let t=this.spaltenListe(),n={gridTemplateColumns:t.map(e=>Ai(e.art).spur).join(` `)},r=e=>e.stopPropagation(),i=this.sichtbareIndizes(),a=fa(this.hasAttribute(`data-ff-editor`),this.source),o=pa(a,this.datenGeliefert,this.datenzeilen.length),s=i.length,c=this.proSeiteAktuell,{seiten:l,seite:u,zeilen:d}=yi({sichtbar:i,hatQuelle:a,proSeite:c,wunschSeite:this._seite,platzhalterZeilen:xa});return w`<div class="tabelle" style=${pi({"--zeilen-hoehe":`${this.zeilenHoehe}px`})}>
      ${ra(()=>this.spaltenListe(),e=>this.aendere(e),r)}
      ${ya({spalten:t,cols:n,editable:this.editable,zeigeSuche:this.suche===`ja`,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,zeilen:d,datenzeilen:this.datenzeilen,zusatzzeilen:this.zusatzzeilen,hatQuelle:a,auswahlIndex:this.auswahlIndex,leer:o,leerText:this.leerText},{setzeSuchtext:e=>this.setzeSuchtext(e),dblklickKopf:(e,t)=>{this.editable&&(ca(this),aa(e,t,()=>this.spaltenListe(),e=>this.aendere(e)))},klickKopf:(t,n)=>{this.editable&&la(this,t,e.listenBindung.prop,n),this.klickSortiere(n)},klickZeile:e=>this.klickZeile(e),stop:r})}
      ${``}
      ${o?E:_a({hatQuelle:a,sichtbar:s,gesamt:this.datenzeilen.length,suchtAktiv:this._suchtext.trim()!==``,auswahlAktiv:this.durchAuswahlGefiltert,zeigeWaehler:this.hasAttribute(`data-ff-editor`)||this.zeilenWaehler===`ja`,einstellung:this.einstellung,seite:u,seiten:l},{waehleProSeite:e=>this.waehleProSeite(e),blaettere:e=>{this._seite=e,this.requestUpdate()},stop:r})}
    </div>`}};A([k({converter:{fromAttribute:e=>e?Bi(e):Fi(),toAttribute:e=>JSON.stringify(e)}})],Q.prototype,`spalten`,void 0),A([k()],Q.prototype,`source`,void 0),A([k()],Q.prototype,`suche`,void 0),A([k()],Q.prototype,`proSeite`,void 0),A([k()],Q.prototype,`zeilenWaehler`,void 0),A([k()],Q.prototype,`leerText`,void 0),A([k({attribute:!1})],Q.prototype,`datenzeilen`,void 0),A([k({attribute:!1})],Q.prototype,`zusatzzeilen`,void 0),A([k({attribute:!1})],Q.prototype,`rohzeilen`,void 0),A([k({attribute:!1})],Q.prototype,`auswahlIndex`,void 0),A([k({attribute:!1})],Q.prototype,`durchAuswahlGefiltert`,void 0),A([k({attribute:!1})],Q.prototype,`datenGeliefert`,void 0),j.defineAndRegister(Q);var Sa=Xn(`text`);function Ca(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(Sa)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function wa(e){let t=ir(e,Sa);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function Ta(e){Ca(e)&&(e.text=``)}var Ea=Qn({hydriere:wa,verdrahte:Ta}),Da=Ea.connect,Oa=Ea.disconnect,ka=6,Aa=96,ja=14,Ma={duenn:`300`,normal:`400`,fett:`700`},Na={links:`left`,mitte:`center`,rechts:`right`},Pa={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},Fa=`standard`;function Ia(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(Aa,Math.max(ka,t)):ja}function La(e){return typeof e==`string`&&e in Ma?e:`normal`}function Ra(e){return typeof e==`string`&&e in Na?e:`links`}function za(e){return typeof e==`string`&&e in Pa?e:Fa}var $=class extends j{constructor(...e){super(...e),this.groesse=ja,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=Fa,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:ja,gewicht:`normal`,ausrichtung:`links`,farbe:Fa,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:ka,max:Aa,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[j.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return w`<div
      class="text"
      style=${pi({fontSize:`${Ia(this.groesse)}px`,fontWeight:Ma[La(this.gewicht)],textAlign:Na[Ra(this.ausrichtung)],color:Pa[za(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),Da(this)}disconnectedCallback(){super.disconnectedCallback(),Oa(this)}};A([k({type:Number})],$.prototype,`groesse`,void 0),A([k()],$.prototype,`gewicht`,void 0),A([k()],$.prototype,`ausrichtung`,void 0),A([k()],$.prototype,`farbe`,void 0),A([k()],$.prototype,`text`,void 0),A([k()],$.prototype,`source`,void 0),A([k()],$.prototype,`textField`,void 0),j.defineAndRegister($);var Ba=[`waagerecht`,`senkrecht`],Va=`waagerecht`;function Ha(e){return Ba.includes(e)?e:Va}var Ua=class extends j{constructor(...e){super(...e),this.richtung=Va}static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`,richtung:Va}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1,varianten:[{wenn:{attributeName:`richtung`,equals:`senkrecht`},startW:1,startH:6,breiteZiehbar:!1}]}}static{this.customProperties=[{attributeName:`richtung`,name:`Richtung`,description:`Waagerecht trennt oben von unten, senkrecht links von rechts.`,kind:`select`,options:[{value:`waagerecht`,label:`Waagerecht`},{value:`senkrecht`,label:`Senkrecht`}]}]}static{this.styles=[j.styles,o`
    ...
    `]}render(){return w`<div class="zeile"><slot></slot></div>`}};j.defineAndRegister(Wa),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;V(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();
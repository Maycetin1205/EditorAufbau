...
`,Qa=`ff-zeile-aktiviert`,$a=`data-ff-roh`;function eo(e,t){e.dispatchEvent(new CustomEvent(Qa,{detail:t,bubbles:!0,composed:!0}))}function to(e){let t=e?.activeElement;if(!(t instanceof HTMLElement))return;let n=t.closest(`.zeile`);if(!n)return;let r=n.getAttribute($a);return r===null||r===``?null:Number(r)}function no(e,t){e&&((t===null?null:e.querySelector(`.zeile[data-ff-roh="${t}"]`))??e.querySelector(`.zeile[data-ff-roh]`)??e.querySelector(`.koerper`))?.focus()}var K=class e extends E{constructor(...e){super(...e),this.spalten=Fi(),this.source=``,this.suche=`ja`,this.erfassung=`nein`,this.leerText=Ki,this._suchtext=``,this.datenzeilen=[],this.zusatzzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this.datenGeliefert=!1,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._beobachter=null,this._taktGemessen=0,this._fokusZeile=null,this._fokusHolen=!1,this._besitz=`softengine`,this._lauf=new da,this._erfasste=[]}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.kannErfassen={wenn:{attributeName:`erfassung`,equals:`ja`}}}static{this.blockEvents=[{key:`onRowClick`,name:`Zeile gewählt`}]}static{this.listenBindung=Pa}static{this.defaultProps={width:`fill`,source:``,spalten:Fi(),suche:`ja`,erfassung:`nein`,tagField:``,leerText:Ki}}static{this.customProperties=qa}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get besitz(){return this._besitz}set besitz(e){e!==this._besitz&&(this._besitz=e,this.setzeAbgeleitetesZurueck(),this.isConnected&&(e===`provided`?Sa(this):xa(this)),this.requestUpdate())}set bereitgestellteZeilen(e){let t=pa(e);this.rohzeilen=t.rohzeilen,this.datenzeilen=t.datenzeilen,this.zusatzzeilen=t.zusatzzeilen,this.datenGeliefert=!0,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._seite=0,this._mass=null,this._taktGemessen=0,this.requestUpdate()}setzeAbgeleitetesZurueck(){this.rohzeilen=[],this.datenzeilen=[],this.zusatzzeilen=[],this.datenGeliefert=!1,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._suchtext=``,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._taktGemessen=0,this._fokusZeile=null,this._fokusHolen=!1,this._lauf.zuruecksetzen(),this._erfasste=[]}get erfassteZeilen(){return this._erfasste}erfassungLeeren(){this._erfasste.length!==0&&(this._erfasste=[],this.requestUpdate())}erfasseZeile(){let e=this.erfassungsUmfeld(),t=e.spalten.map((t,n)=>this._lauf.wertVon(e,n));t.every(e=>e===``)||(this._erfasste=[...this._erfasste,t],this._lauf.zuruecksetzen(),this.requestUpdate(),this.fokussiereErfassungsZelle(0))}fokussiereSuche(){let e=this.shadowRoot?.querySelector(`.suchzeile input`);return e?(e.focus(),!0):!1}get hatQuelle(){return this._besitz===`provided`||wa(this.hasAttribute(`data-ff-editor`),this.source)}merkeZeilenFokus(){let e=to(this.shadowRoot);this._fokusHolen=e!==void 0,this._fokusZeile=e??null}messeRumpf(){let e=this.zeilenHoehe;this._taktGemessen=e;let t=Xi(this,e);t?.passen===this._mass?.passen&&t?.zeilenHoehe===this._mass?.zeilenHoehe||(this._mass=t,this.requestUpdate())}spaltenListe(){return zi(this.spalten)}get zeilenHoehe(){return Ai(this.spaltenListe())}aktiviereZeile(e,t){if(e===null||this.hasAttribute(`data-ff-editor`))return;let n=this.rohzeilen[e];n!==void 0&&(eo(this,{rohzeile:n,rohIndex:e,ansichtIndex:t}),this.toggleAuswahl(n),Xn(this,`onRowClick`,{PINDEX:va(this,n)}).catch(Kn))}toggleAuswahl(e){let t=N(this);t!==``&&Vt(t,e)}setzeSuchtext(e){this.merkeZeilenFokus(),this._suchtext=e,this._seite=0,this.requestUpdate()}klickSortiere(e){this.editable||(this.merkeZeilenFokus(),this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.requestUpdate())}get erfassungAn(){return this.erfassung===`ja`}erfassungsWirt(){return{baustein:this,lauf:this._lauf,umfeld:()=>this.erfassungsUmfeld(),melde:()=>this.requestUpdate(),fokussiere:e=>this.fokussiereErfassungsZelle(e),erfasseZeile:()=>this.erfasseZeile()}}fokussiereErfassungsZelle(e){this.updateComplete.then(()=>{(this.shadowRoot?.querySelectorAll(`.zeile.erfassung .erf-eingabe`))?.[e]?.focus()})}erfassungsUmfeld(){let e=Qr(this);return{spalten:this.spaltenListe(),quelleId:this.source,paareZu:t=>e.find(e=>e.quelleId===t)?.keyPairs??[]}}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}beobachte(){this._beobachter||(this._beobachter=Zi(this,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}connectedCallback(){super.connectedCallback(),this._besitz===`softengine`&&xa(this),this.beobachte()}firstUpdated(){this.beobachte()}willUpdate(e){super.willUpdate(e),!(!this.erfassungAn||this.hasAttribute(`data-ff-editor`))&&this._lauf.aktualisiereVorschlaege(this.erfassungsUmfeld())}updated(){this._taktGemessen!==this.zeilenHoehe&&this.messeRumpf(),this._fokusHolen&&(this._fokusHolen=!1,no(this.shadowRoot,this._fokusZeile))}disconnectedCallback(){super.disconnectedCallback(),Ma(this),this._beobachter?.disconnect(),this._beobachter=null,xo(this),Sa(this)}static{this.styles=[E.styles,ir,Yi,Za,kr,fa]}render(){let t=this.spaltenListe(),n=e=>e.stopPropagation(),r=Ka({spalten:t,hatQuelle:this.hatQuelle,datenGeliefert:this.datenGeliefert,datenzeilen:this.datenzeilen,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,wunschSeite:this._seite,gemessen:this._mass,erfassungAn:this.erfassungAn,erfassteAnzahl:this._erfasste.length});return _`<div class="tabelle" style=${W({"--takt":`${r.takt}px`,"--zeilen-hoehe":`${r.zeilenHoehe}px`})}>
      ...
      ${``}
      ${r.leer?y:Ja({hatQuelle:r.hatQuelle,sichtbar:r.gesamt,gesamt:this.datenzeilen.length,suchtAktiv:this._suchtext.trim()!==``,auswahlAktiv:this.durchAuswahlGefiltert,seite:r.seite,seiten:r.seiten},{blaettere:e=>{this.merkeZeilenFokus(),this._seite=e,this.requestUpdate()}})}
    </div>`}};T([C({converter:{fromAttribute:e=>e?Bi(e):Fi(),toAttribute:e=>JSON.stringify(e)}})],K.prototype,`spalten`,void 0),T([C()],K.prototype,`source`,void 0),T([C()],K.prototype,`suche`,void 0),T([C()],K.prototype,`erfassung`,void 0),T([C()],K.prototype,`leerText`,void 0),T([C({attribute:!1})],K.prototype,`datenzeilen`,void 0),T([C({attribute:!1})],K.prototype,`zusatzzeilen`,void 0),T([C({attribute:!1})],K.prototype,`rohzeilen`,void 0),T([C({attribute:!1})],K.prototype,`auswahlIndex`,void 0),T([C({attribute:!1})],K.prototype,`durchAuswahlGefiltert`,void 0),T([C({attribute:!1})],K.prototype,`datenGeliefert`,void 0),E.defineAndRegister(K);function ro(e){return _`<div class="nachschlag">
    <input
      class="ctrl"
      type="text"
      .value=${e.wert}

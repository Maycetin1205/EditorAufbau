...
`,Ti=[`text`,`number`,`textarea`,`select`,`date`,`time`,`checkbox`,`nachschlagen`];function B(e){return Ti.includes(e)?e:`text`}var Ei=[`text`,`number`,`textarea`,`select`,`nachschlagen`,`date`,`time`],Di={select:`ph-select`,date:`ph-nativ`,time:`ph-nativ`,nachschlagen:`ph-nachschlag`};function Oi(){return g`<svg viewBox="0 0 16 16" width="14" height="14" aria-hidden="true">
    ...
    </svg>`}var ki=4;function Ai(e){return e??ki}function ji(e,t,n){return Math.max(1,Math.floor((e-t)/n))}function Mi(e,t,n){let r=ji(e,t,n),i=e-t;return i<n?{passen:r,zeilenHoehe:n}:{passen:r,zeilenHoehe:Math.floor(i/r*100)/100}}function Ni(e,t){return e===null?null:Math.max(0,e-t)}function Pi({sichtbar:e,hatQuelle:t,proSeite:n,wunschSeite:r,platzhalterZeilen:i}){let a=t?Math.max(1,Math.ceil(e.length/n)):1,o=Math.min(Math.max(r,0),a-1);return t?{seiten:a,seite:o,zeilen:[...e.slice(o*n,(o+1)*n)]}:{seiten:a,seite:o,zeilen:Array.from({length:i},()=>null)}}function Fi(e,t){let n=t.trim().toLowerCase();return e.find(e=>e.wert.trim().toLowerCase()===n)}var V=`text`,Ii=`status`,Li=`bild`,Ri=`bild`,zi=`unter`,Bi=[{wert:V,name:`Text`,spur:`minmax(0, 1fr)`,klasse:``,zelle:e=>e},{wert:`zahl`,name:`Zahl`,spur:`90px`,klasse:`zahl`,zelle:e=>e},{wert:`datum`,name:`Datum`,spur:`100px`,klasse:`zahl`,zelle:e=>e},{wert:Ii,name:`Status`,spur:`120px`,klasse:`status`,zelle:(e,t)=>{let n=Fi(t,e);return n?g`<span class="chip v-${wr(n.bedeutung)}">${n.name.trim()===``?e:n.name}</span>`:g`<span class="chip">${e}</span>`}},{wert:Li,name:`Bild + Name`,spur:`minmax(0, 1fr)`,klasse:`bild`,zusatzFelder:[{key:Ri,label:`Bild`},{key:zi,label:`Unterzeile`}],hoehe:e=>(e[Ri]??``)!==``||(e[zi]??``)!==``?44:32,zelle:(e,t,n)=>{let r=Nr(n[Ri]??``),i=n[zi]??``;return g`<div class="bild-name">
        ${r===void 0?v:g`<span class="bild-zeichen">${r}</span>`}
        <div class="bild-text">
          <div class="bild-titel">${e}</div>
          ${i===``?v:g`<div class="bild-unter">${i}</div>`}
        </div>
      </div>`}}];function Vi(e){return e.reduce((e,t)=>{let n=H(t.art);return Math.max(e,n.hoehe?.(t.felder??{})??32)},32)}function H(e){return Bi.find(t=>t.wert===e)??Bi[0]}var Hi=Bi.map(e=>({wert:e.wert,name:e.name,...e.zusatzFelder?{felder:e.zusatzFelder}:{}})),Ui=`felder`,Wi=`suchtIn`,Gi=`suchFelder`;function Ki(e){return Array.isArray(e)?e.map(e=>{if(typeof e==`string`)return{feld:e.trim(),titel:e.trim()};if(!e||typeof e!=`object`)return{feld:``,titel:``};let t=e,n=typeof t.feld==`string`?t.feld.trim():``;return{feld:n,titel:typeof t.titel==`string`&&t.titel.trim()!==``?t.titel.trim():n}}).filter(e=>e.feld!==``):[]}var qi=`Spalte {n}`;function Ji(e){return qi.replace(`{n}`,String(e+1))}function U(e){return{titel:Ji(e),feld:``,art:V}}function Yi(){return[0,1,2].map(e=>U(e))}function Xi(e){return Array.isArray(e)?e.filter(e=>!!e&&typeof e==`object`).map(e=>({wert:typeof e.wert==`string`?e.wert:``,name:typeof e.name==`string`?e.name:``,bedeutung:typeof e.bedeutung==`string`?e.bedeutung:``})).filter(e=>e.wert.trim()!==``):[]}function Zi(e){if(!e||typeof e!=`object`||Array.isArray(e))return{};let t={};for(let[n,r]of Object.entries(e))typeof r==`string`&&r!==``&&(t[n]=r);return t}function Qi(e,t){if(e&&typeof e==`object`){let n=e,r=Xi(n.zuordnung),i=Zi(n.felder),a=typeof n.suchtIn==`string`?n.suchtIn.trim():``,o=Ki(n.suchFelder);return{titel:typeof n.titel==`string`?n.titel:Ji(t),feld:typeof n.feld==`string`?n.feld:``,art:typeof n.art==`string`?n.art:V,...a===``?{}:{suchtIn:a},...o.length>0?{suchFelder:o}:{},...r.length>0?{zuordnung:r}:{},...Object.keys(i).length>0?{felder:i}:{}}}return typeof e==`string`?{...U(t),titel:e}:U(t)}function $i(e){let t;if(Array.isArray(e))t=e.map((e,t)=>Qi(e,t));else if(typeof e==`number`&&Number.isFinite(e)||typeof e==`string`&&/^\d+$/.test(e)){let n=Math.max(1,Math.floor(Number(e)));t=[...Array(n).keys()].map(e=>U(e))}else t=Yi();return t.length>16&&(t=t.slice(0,16)),t.length<1&&(t=[U(0)]),t}function ea(e){try{return $i(JSON.parse(e))}catch{return Yi()}}var ta={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},na=e=>(...t)=>({_$litDirective$:e,values:t}),ra=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},ia=`important`,aa=` !important`,W=na(class extends ra{constructor(e){if(super(e),e.type!==ta.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(aa);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?ia:``):n[e]=r}}return _}}),oa=`Keine Datensätze.`;function sa(){return{attributeName:`leerText`,name:`Text ohne Datensätze`,description:`Steht in der Maske dort, wo sonst die Zeilen stehen — wenn die Datenquelle keine liefert. Leer lassen: dann steht dort gar nichts.`,kind:`text`,requiresDataSource:!0}}function ca(e,t=!1){return e.trim()===``?v:g`<div class="leer${t?` leer--tafel`:``}">
    ${kr()}
    <span>${e}</span>
  </div>`}var la=o`
  .leer {
...
`;function ua(e,t){if(!e.hasAttribute(`fuellt`))return null;let n=e.renderRoot.querySelector(`.koerper`);return n instanceof HTMLElement?Mi(n.clientHeight,(t=>{let n=e.renderRoot.querySelector(t);return n instanceof HTMLElement?n.offsetHeight:0})(`.kopf`),t):null}function da(e,t){if(typeof ResizeObserver>`u`)return null;let n=e.renderRoot.querySelector(`.koerper`);if(!n)return null;let r=new ResizeObserver(t);return r.observe(n),r}function fa(e,t){return e.verknuepfungen.find(e=>e.quelleId===t)?.keyPairs??[]}function pa(e,t){let n=e.verknuepfungen.find(e=>e.quelleId===t);return n===void 0?e.quelleId:lt(n,e.quelleId)}function ma(e,t,n){return ut(e?.feld??``,e?.suchtIn??``,t,n)}function G(e,t){return ma(e.spalten[t],e.quelleId,e.verknuepfungen)}function ha(e){let t=[],n=e=>{e!==``&&!t.includes(e)&&t.push(e)};for(let t=0;t<e.spalten.length;t++){let r=G(e,t);r.art===`auswahl`&&n(r.quelleId),n(r.suchQuelleId)}return t}function ga(e,t){let n=G(e,t);if(n.suchQuelleId===``)return;let r=_a(e,t)[0];if(r!==void 0)return{titel:r.titel,code:r.feld};let i=n.quelleId===n.suchQuelleId?n.code:``;for(let r=0;r<e.spalten.length;r++){if(r===t)continue;let a=G(e,r);if(!(a.art!==`auswahl`||a.quelleId!==n.suchQuelleId)&&!(a.code===``||a.code===i))return{titel:e.spalten[r].titel,code:a.code}}}function _a(e,t){return e.spalten[t]?.suchFelder??[]}function va(e,t){let n=e.spalten[t];if(n===void 0)return[];let r=_a(e,t);if(r.length>0)return r.map(e=>({titel:e.titel,feld:e.feld,art:V}));let i=ga(e,t),a=G(e,t);if(i===void 0)return[];let o=a.quelleId===a.suchQuelleId?a.code:``,s={titel:i.titel,feld:i.code,art:V};return o===``?[s]:[s,{titel:n.titel,feld:o,art:V}]}function ya(e,t,n){let r=e.map(e=>({toField:e.toField,soll:t(e.fromField)})).filter(e=>e.soll!==void 0);return r.length===0?[...n]:n.filter(e=>r.every(t=>t.soll!==``&&t.soll===k(e,t.toField)))}function ba(e,t){let n=G(e,t);if(n.art===`auswahl`||n.suchQuelleId===``)return``;let r=_a(e,t)[0]?.feld??``;return r===``?n.art===`frei`?ga(e,t)?.code??``:``:r}var xa=`32px`;function Sa(e){return String(e).padStart(2,`0`)}function Ca(e){return g`<div
    class=${e.aktiv?`griff aktiv`:`griff`}
    role="cell"
    @click=${e.aufKlick??v}
  >${e.nummer===null?v:Sa(e.nummer)}</div>`}function wa(){return g`<div class="griff leer" role="presentation"></div>`}function Ta(e,t,n){return g`<input
    class="erf-eingabe"
    type="text"
    data-spalte=${n}
    ...
    @focus=${()=>t.betreten(n)}
    @blur=${()=>t.verlassen(n)}
  />`}function Ea(e,t,n,r){if(!r)return Ta(e,t,n);let i=e.tippSpalte===n&&e.vorschlaege.length>0;return g`<div class=${e.listeNachOben?`erf-halter nach-oben`:`erf-halter`}>
    ${Ta(e,t,n)}
    ${i?Zr({eintraege:e.vorschlaege,marke:e.marke,onWaehlen:e=>t.waehleVorschlag(e),onMarke:e=>t.setzeMarke(e)}):v}
  </div>`}function Da(e){return[`zeile`,`erfassung`].concat(e.aktiv?[`aktiv`]:[],e.gefuellt?[`gefuellt`]:[]).join(` `)}function Oa(e,t){return g`<div
    class=${Da(e)}
    role="row"
    data-erf-zeile=${e.zeile}
    style=${W(e.cols)}
  >
    ${Ca({nummer:e.nummer,aktiv:e.aktiv,aufKlick:()=>t.waehleZeile()})}
    ${e.umfeld.spalten.map((n,r)=>{let i=H(n.art).klasse;if(e.imEditor){let t=e.zellenGriff;return g`<div
          class=${i}
          role="cell"
          data-ff-editable=${t?``:v}
          @click=${t?e=>t(e,r):v}
        >${t?g`<span class="spalten-name">${n.titel}</span>`:`—`}</div>`}return g`<div class=${i} role="cell">${Ea(e,t,r,G(e.umfeld,r).suchQuelleId!==``)}</div>`})}
  </div>`}function ka(e,t,n,r){let i=e.anschluss.lauf(t),a=i.vorschlaege[r];a!==void 0&&(i.uebernimm(e.umfeld(),n,a.satz),e.melde())}function Aa(e,t,n){let r=e.umfeld(),i=r.spalten[n],a=G(r,n);if(i===void 0||a.suchQuelleId===``)return;let o=e.anschluss.lauf(t);ns({el:e.baustein,quelleId:a.suchQuelleId,speicherFeld:a.quelleId===a.suchQuelleId?a.code:``,speicherTitel:i.titel,spalten:va(r,n),titel:i.titel,breite:520,hoehe:380,eintraege:o.eintraege(r,n),rueckFokus:null,onUebernehmen:(t,r,i)=>{o.uebernimm(e.umfeld(),n,i),e.melde()}})}function ja(e,t,n,r){let i=e.umfeld(),a=r===`enter`?e.anschluss.lauf(t).naechsteLeere(i,n):n+1<i.spalten.length?n+1:-1;if(a!==-1){e.fokussiere(t,a);return}let o=r===`enter`?e.anschluss.weiter(i,t):t+1<e.anschluss.anzahl?t+1:null;if(o===null)return;r===`tab`&&e.anschluss.waehle(o);let s=e.anschluss.lauf(o).naechsteLeere(i,-1);e.fokussiere(o,r===`enter`&&s!==-1?s:0)}function Ma(e,t,n,r){let i=t+r;return i<0||i>=e.anschluss.anzahl?!1:(e.fokussiere(i,n),!0)}function Na(e,t,n,r){if(r.key===`Tab`&&r.shiftKey)return;let i=r.key===`Tab`?`tab`:`enter`,a=e.anschluss.lauf(t).entscheideTaste(e.umfeld(),n,r.key);if(a===`nichts`){(r.key===`Enter`||r.key===`ArrowDown`&&Ma(e,t,n,1)||r.key===`ArrowUp`&&Ma(e,t,n,-1))&&r.preventDefault();return}r.preventDefault(),a===`uebernehmen`?(ka(e,t,n,e.anschluss.lauf(t).marke),ja(e,t,n,i)):a===`fenster`?Aa(e,t,n):a===`weiter`?ja(e,t,n,i):a===`leeren`&&e.anschluss.lauf(t).leere(e.umfeld(),n),e.melde()}function Pa(e,t,n,r,i){let a=e.umfeld(),o=e.baustein.hasAttribute(`data-ff-editor`),s=[];for(let c=0;c<e.anschluss.anzahl;c++){let l=e.anschluss.lauf(c),u=c===e.anschluss.aktiv;s.push(Oa({umfeld:a,cols:t,imEditor:o,zeile:c,aktiv:u,gefuellt:!o&&!e.anschluss.istLeer(a,c),...i?{zellenGriff:i}:{},wert:e=>l.wertVon(a,e),tippSpalte:u?l.tippSpalte:-1,vorschlaege:u?l.vorschlaege:[],marke:l.marke,listeNachOben:r,nummer:n+c+1},{tippen:(t,n)=>{l.tippe(t,n),e.anschluss.waehle(c),e.melde()},taste:(t,n)=>Na(e,c,t,n),verlassen:t=>{l.verlasse(t),e.melde()},betreten:()=>{e.anschluss.waehle(c)&&e.melde()},waehleZeile:()=>{e.anschluss.waehle(c)&&e.melde()},waehleVorschlag:t=>ka(e,c,l.tippSpalte,t),setzeMarke:t=>{l.setzeMarke(t),e.melde()}}))}return s}var Fa=2,Ia=class e{constructor(){this.getippt=new Map,this.gewaehlt=new Map,this.vonHand=new Map,this._wahlZaehler=0,this._tippSpalte=-1,this._marke=0,this._listeZu=!1,this._vorschlaege=[]}get tippSpalte(){return this._tippSpalte}get marke(){return this._marke}get vorschlaege(){return this._vorschlaege}wertVon(e,t){let n=this.getippt.get(t);if(n!==void 0)return n;let r=G(e,t);if(r.art!==`auswahl`||r.code===``)return``;let i=this.gewaehlt.get(r.quelleId);return i===void 0?``:k(i,r.code)}tippe(e,t){this.getippt.set(e,t),this._tippSpalte=e,this._marke=0,this._listeZu=!1}verlasse(e){this._tippSpalte===e&&(this._tippSpalte=-1,this._listeZu=!1,this._marke=0,this._vorschlaege=[])}entscheideTaste(e,t,n){let r=this._tippSpalte===t&&this._vorschlaege.length>0;if(n===`Tab`){if(!r)return`weiter`;n=`Enter`}let i=this.wertVon(e,t);if(n===`Escape`&&!r)return i===``?`nichts`:`leeren`;if(G(e,t).suchQuelleId===``)return n===`Enter`?`weiter`:`nichts`;let a=Xr(n,{listeOffen:r,feldLeer:i===``});if(a===`marke-hoch`)this._marke=Jr(this._marke,this._vorschlaege.length,-1);else if(a===`marke-runter`)this._marke=Jr(this._marke,this._vorschlaege.length,1);else if(a===`liste-zu`)this._listeZu=!0;else if(a===`fenster`&&this.eintraege(e,t).length===0)return`weiter`;else if(a===`nichts`&&n===`Enter`&&i!==``&&this.getippt.get(t)===void 0)return`weiter`;return a}naechsteLeere(e,t){for(let n=t+1;n<e.spalten.length;n++)if(this.wertVon(e,n)===``)return n;return-1}leere(e,t){this.getippt.delete(t);let n=G(e,t);for(let t of[n.quelleId,n.suchQuelleId])t!==``&&this.gewaehlt.has(t)&&this.setze(e,t,void 0);this._listeZu=!1,this._marke=0}setzeMarke(e){this._marke=e}uebernimm(e,t,n){let r=G(e,t).suchQuelleId;r!==``&&(this.setze(e,r,n),this._wahlZaehler+=1,this.vonHand.set(r,this._wahlZaehler),this.gleicheAb(e),this._tippSpalte=-1,this._marke=0,this._listeZu=!1)}setze(e,t,n){n===void 0?(this.gewaehlt.delete(t),this.vonHand.delete(t)):this.gewaehlt.set(t,n);for(let r=0;r<e.spalten.length;r++){let i=G(e,r);if(i.quelleId===t){this.getippt.delete(r);continue}if(i.suchQuelleId!==t)continue;let a=ba(e,r);a!==``&&(n===void 0?this.getippt.delete(r):this.getippt.set(r,k(n,a)))}}schluesselWert(e,t,n,r=()=>!0,i=e.quelleId){if(i!==e.quelleId){if(i===n||i===``)return;let e=this.gewaehlt.get(i);if(e===void 0)return;let a=this.vonHand.get(i);return a!==void 0&&!r(a)?void 0:k(e,t)}for(let i of ha(e)){if(i===n)continue;let a=this.vonHand.get(i);if(a===void 0||!r(a))continue;let o=this.gewaehlt.get(i);if(o!==void 0)for(let n of fa(e,i)){if(n.fromField!==t)continue;let e=k(o,n.toField);if(e!==``)return e}}}moegliche(e,t,n,r){return ya(fa(e,t),n=>this.schluesselWert(e,n,t,r,pa(e,t)),n)}gleicheAb(e){let t=ha(e);for(let n=0;n<=t.length;n++){let n=!1;for(let r of t){let t=fa(e,r);if(t.length===0)continue;let i=this.gewaehlt.get(r);if(i!==void 0){let a=this.vonHand.get(r)??-1/0;t.every(t=>{let n=this.schluesselWert(e,t.fromField,r,e=>e>a,pa(e,r));return n===void 0||n!==``&&n===k(i,t.toField)})||(this.setze(e,r,void 0),n=!0);continue}let a=pa(e,r);if(!t.some(t=>this.schluesselWert(e,t.fromField,r,void 0,a)!==void 0))continue;let o=Ho(r);if(o===null)continue;let s=this.moegliche(e,r,o);s.length===1&&(this.setze(e,r,s[0]),this.vonHand.delete(r),n=!0)}if(!n)break}}zuruecksetzen(){this.getippt.clear(),this.gewaehlt.clear(),this.vonHand.clear(),this._tippSpalte=-1,this._marke=0,this._listeZu=!1,this._vorschlaege=[]}nimmEinzigenTreffer(e){let t=this._tippSpalte;if(t<0||this._vorschlaege.length!==1)return!1;let n=(this.getippt.get(t)??``).trim();if(n.length<Fa)return!1;let r=this._vorschlaege[0];return r.wert===n?!1:(this.uebernimm(e,t,r.satz),!0)}aktualisiereVorschlaege(e){this._vorschlaege=this.berechne(e),this._marke=Yr(this._marke,this._vorschlaege.length)}berechne(e){let t=this._tippSpalte;if(this._listeZu||G(e,t).suchQuelleId===``)return[];let n=this.getippt.get(t)??``;return n===``?[]:qr(this.eintraege(e,t),n)}eintraege(e,t){let n=G(e,t),r=n.suchQuelleId;if(r===``)return[];let i=Ho(r);if(i===null)return[];let a=this.vonHand.get(r)??1/0;return Bo(this.moegliche(e,r,i,e=>e<a),ga(e,t)?.code??``,n.quelleId===r?n.code:``)}get istUnberuehrt(){return this.getippt.size===0&&this.gewaehlt.size===0}kopie(){let t=new e;return t.getippt=new Map(this.getippt),t.gewaehlt=new Map(this.gewaehlt),t.vonHand=new Map(this.vonHand),t._wahlZaehler=this._wahlZaehler,t}};function La(e,t){let n=t.feld.trim();if(n===``)return null;let{quelleId:r,code:i}=it(n),a=r===``?e.quelleId:r;return a===``||i===``?null:{quelleId:a,code:i}}function Ra(e,t){let n={};return e.spalten.forEach((r,i)=>{let a=La(e,r);if(a===null)return;let o=n[a.quelleId]??(n[a.quelleId]={});o[a.code]=t[i]??``}),n}function za(e){let t=[];for(let n of e.spalten){let r=La(e,n);r!==null&&!t.includes(r.quelleId)&&t.push(r.quelleId)}return t}var Ba=class{constructor(){this._laeufe=[new Ia],this._aktiv=0}get anzahl(){return this._laeufe.length}get aktiv(){return this._aktiv}lauf(e){let t=Math.min(Math.max(e,0),this._laeufe.length-1);return this._laeufe[t]}get aktiverLauf(){return this.lauf(this._aktiv)}waehle(e){let t=Math.min(Math.max(e,0),this._laeufe.length-1);return t===this._aktiv?!1:(this._aktiv=t,!0)}werte(e,t){let n=this.lauf(t);return e.spalten.map((t,r)=>n.wertVon(e,r))}istLeer(e,t){return this.werte(e,t).every(e=>e===``)}saetze(e){let t=[];for(let n=0;n<this._laeufe.length;n++){let r=this.werte(e,n);r.every(e=>e===``)||t.push(Ra(e,r))}return t}weiter(e,t){let n=Math.min(Math.max(t,0),this._laeufe.length-1);return n<this._laeufe.length-1?(this._aktiv=n+1,this._aktiv):this.istLeer(e,n)?null:(this._laeufe.push(new Ia),this._aktiv=this._laeufe.length-1,this._aktiv)}haltLeerzeileFrei(e){return this.istLeer(e,this._laeufe.length-1)?!1:(this._laeufe.push(new Ia),!0)}leeren(){return this._laeufe.length===1&&this._laeufe[0].istUnberuehrt?!1:(this._laeufe=[new Ia],this._aktiv=0,!0)}zuruecksetzen(){this._laeufe=[new Ia],this._aktiv=0}haltVorschlaegeAktuell(e){let t=this.aktiverLauf;t.aktualisiereVorschlaege(e),t.nimmEinzigenTreffer(e)&&t.aktualisiereVorschlaege(e)}umfeld(e,t,n){return{spalten:t,quelleId:n,verknuepfungen:ui(e)}}},Va=o`
      .zeile.erfassung {
        flex: none;
        background: var(--se-panel-2);
...
`;function Ha(e){return{rohzeilen:e.map(e=>e.rohzeile),datenzeilen:e.map(e=>[...e.zellen]),zusatzzeilen:e.map(e=>(e.zusatz??[]).map(e=>({...e})))}}function Ua(e,t,n){return t===``||n===``?[...e]:e.filter(e=>Ir(k(e,t))===n)}function Wa(e){let t=e.getAttribute(`source`)??``;if(t===``)return null;let n=O(I().FF_DATA_SOURCES,t);return n?{quelle:n,zeilen:Ua(j(I().SEDATA,n.name,n.tableId),e.getAttribute(`tagfield`)??``,Vr()),lies:di(e)}:null}function Ga(e){return ea(e.getAttribute(`spalten`)??``)}function Ka(e,t,n){let r={};for(let i of H(e.art).zusatzFelder??[]){let a=e.felder?.[i.key]??``;a!==``&&(r[i.key]=n(t,a))}return r}function qa(e,t){let n=O(I().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return n?jt(n,t):``}function Ja(e){let t=Wa(e);if(!t){e.datenzeilen=[],e.zusatzzeilen=[];return}let n=Ga(e),{rows:r,gefiltert:i}=tn(e,t.zeilen),a=Jt(N(e),r,e=>e)[0]??-1,o=t.lies;e.datenGeliefert=!0,e.rohzeilen=r,e.auswahlIndex=a,e.durchAuswahlGefiltert=i,e.datenzeilen=r.map(e=>n.map(t=>t.feld===``?``:o(e,t.feld))),e.zusatzzeilen=r.map(e=>n.map(t=>Ka(t,e,o)))}var Ya=oi({hydriere:Ja}),Xa=Ya.connect,Za=Ya.disconnect;function Qa(e,t){let n=[];return e.forEach((e,r)=>{Kr(e,t)&&n.push(r)}),n}function $a(e,t){return!e&&t.trim()!==``}function eo(e,t,n){return e&&t&&n===0}function to(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}function no(e,t,n){return g`<div class="steuerung">
    <button
    ...
    >+</button>
  </div>`}function ro(e,t){let n=e.currentTarget;n&&(e.stopPropagation(),e.preventDefault(),pt(n,(e,n)=>e===``||e===n.trim()?!1:(t(e),!0)))}function io(e,t,n,r){ro(e,e=>{let i=n();t>=i.length||(i[t]={...i[t],titel:e},r(i))})}var ao=220,oo=new WeakMap;function so(e){let t=oo.get(e);t!==void 0&&(clearTimeout(t),oo.delete(e))}function co(e,t,n){t.stopPropagation();let r=t.currentTarget,i=r.getBoundingClientRect();so(e),oo.set(e,setTimeout(()=>{oo.delete(e),e.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:n.prop,index:n.index,top:i.bottom+4,left:i.left,ausloeser:r,...n.liste?{liste:n.liste()}:{}},bubbles:!0,composed:!0}))},ao))}var lo={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:qi,nurEigeneQuelle:!0,eintragsWahl:{key:`art`,label:`Darstellung`,optionen:Hi,standard:V,felderKey:Ui},eintragsQuellenWahl:{key:Wi,label:`Sucht beim Erfassen in`,leerName:`frei`,nurBeiErfassung:!0},eintragsFelderWahl:{key:Gi,label:`Zeigt beim Suchen`,quelleAusKey:Wi,nurBeiErfassung:!0},eintragsZuordnung:{key:`zuordnung`,label:`Status-Zuordnung`,nurBeiWahl:Ii,wertLabel:`Datenwert`,nameLabel:`Klarname`,bedeutungLabel:`Bedeutung`,bedeutungen:Tr}},uo=1,fo=/^-?\d{1,3}(\.\d{3})*(,\d+)?$|^-?\d+(,\d+)?$|^-?\d+(\.\d+)?$/,po=/^(\d{1,2})\.(\d{1,2})\.(\d{2}|\d{4})$/,mo=/^(\d{4})-(\d{2})-(\d{2})$/;function ho(e){let t=e.trim();if(t===``||!fo.test(t))return null;let n=t.includes(`,`)?t.replace(/\./g,``).replace(`,`,`.`):/^-?\d{1,3}(\.\d{3})+$/.test(t)?t.replace(/\./g,``):t,r=Number(n);return Number.isFinite(r)?r:null}function go(e){let t=e.trim();if(t===``)return null;let n=mo.exec(t);if(n){let[,e,t,r]=n;return _o(Number(e),Number(t),Number(r))}let r=po.exec(t);if(r){let[,e,t,n]=r,i=Number(n);return _o(n.length===2?i<=69?2e3+i:1900+i:i,Number(t),Number(e))}return null}function _o(e,t,n){if(t<1||t>12||n<1||n>31)return null;let r=new Date(e,t-1,n);return r.getFullYear()!==e||r.getMonth()!==t-1||r.getDate()!==n?null:r.getTime()}function vo(e){let t=0,n=0,r=0;for(let i of e)i.trim()!==``&&(t++,ho(i)!==null&&n++,go(i)!==null&&r++);return t===0?`text`:r===t?`datum`:n===t?`zahl`:`text`}var yo=new Intl.Collator(`de`,{numeric:!0,sensitivity:`base`});function bo(e,t,n){if(t<0||e.length===0)return e.map((e,t)=>t);let r=n=>e[n][t]??``,i=vo(e.map(e=>e[t]??``)),a=n?1:-1;return e.map((e,t)=>t).sort((e,t)=>{let n=r(e).trim(),o=r(t).trim();if(n===``&&o===``)return e-t;if(n===``)return uo;if(o===``)return-1;let s=i===`zahl`?(ho(n)??0)-(ho(o)??0):i===`datum`?(go(n)??0)-(go(o)??0):yo.compare(n,o);return s===0?e-t:s*a})}function xo(e){let t=Qa(e.datenzeilen,e.suchtext);return e.sortSpalte<0?t:bo(t.map(t=>e.datenzeilen[t]),e.sortSpalte,e.sortAuf).map(e=>t[e])}function So(e){let t=e.spalten.map(e=>H(e.art).spur),n={gridTemplateColumns:(e.erfassungsZeilen>0?[xa,...t]:t).join(` `)},r=Vi(e.spalten),i=e.gemessen?.zeilenHoehe??r,a=e.hatQuelle,o=e.erfassungsZeilen>0?!1:eo(a,e.datenGeliefert,e.datenzeilen.length),s=xo(e),c=e.erfassungsZeilen,l=e.gemessen===null?null:Math.max(1,e.gemessen.passen-c),{seiten:u,seite:d,zeilen:ee}=Pi({sichtbar:s,hatQuelle:a,proSeite:l??Math.max(1,10-c),wunschSeite:e.wunschSeite,platzhalterZeilen:Ai(l)});return{cols:n,takt:r,zeilenHoehe:i,hatQuelle:a,leer:o,gesamt:s.length,seiten:u,seite:d,zeilen:ee,linealTakte:Ni(l,ee.length)}}function Co(e){return e!==`ja`}function wo(e,t,n){return e===n?{spalte:n,auf:!t}:{spalte:n,auf:!0}}var To=[ri(`suche`,`Suchzeile`,`Zeigt über der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,{requiresDataSource:!0}),ri(`erfassung`,`Erfassungszeile`,`Zeigt als nächste freie Zeile eine leere Zeile, in der der Bediener neue Positionen tippt. Eingestellt wird an ihr nichts: Was eine Zelle tut, ergibt sich aus der Bindung ihrer Spalte (Spaltenkopf) und der Verknüpfung des Bausteins. Enter am Zeilenende lässt die Zeile stehen; geschrieben wird über einen Knopf, dessen Kette „Wert aus Erfassungszelle“ liest — einmal je Zeile.`),ri(`schlank`,`Schlank`,`Lässt die Kopfzeile weg und macht die Polster enger. Der Rahmen der Tafel bleibt. Die Spaltennamen stehen dann blass in den Zellen — im Editor in der ersten Zeile, in der Maske in der leeren Erfassungszelle, wie der Platzhalter an einem Formularfeld. Die Fußzeile erscheint ohnehin nur noch, wenn geblättert wird oder ein Filter greift.`),{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt die Tabelle nur Sätze des Tages, den der Tageswähler zeigt. Leer = alle Sätze.`,kind:`field`},sa()];function Eo(e,t){return g`<div class="fusszeile">
    ...
    <div class="seiten-nav">
  ...
  </div>`}function Do(e){return e.linealTakte===0?v:g`<div class="lineal" role="presentation" style=${W(e.linealTakte===null?e.cols:{...e.cols,flex:`0 1 auto`,height:`calc(var(--zeilen-hoehe) * ${e.linealTakte})`})}>
          ${e.mitGriff?wa():v}
          ${e.spalten.map(()=>g`<div></div>`)}
        </div>`}function Oo(e,t){return g`
      ...
      ${e.zeigeKopf?g`<div class="kopf" role="row" style=${W(e.cols)}>
        ...
        ${e.zeilen.map((n,r)=>{let i=n!==null&&!e.imEditor;return g`<div
          ...
          >
            ${e.mitGriff?Ca({nummer:n===null?null:r+1,aktiv:!1}):v}
...
`,Ao=`ff-zeile-aktiviert`,jo=`data-ff-roh`;function Mo(e,t){e.dispatchEvent(new CustomEvent(Ao,{detail:t,bubbles:!0,composed:!0}))}function No(e){let t=e?.activeElement;if(!(t instanceof HTMLElement))return;let n=t.closest(`.zeile`);if(!n)return;let r=n.getAttribute(jo);return r===null||r===``?null:Number(r)}function Po(e,t){e&&((t===null?null:e.querySelector(`.zeile[data-ff-roh="${t}"]`))??e.querySelector(`.zeile[data-ff-roh]`)??e.querySelector(`.koerper`))?.focus()}var K=class e extends T{constructor(...e){super(...e),this.spalten=Yi(),this.source=``,this.suche=`ja`,this.erfassung=`nein`,this.schlank=`nein`,this.leerText=oa,this._suchtext=``,this.datenzeilen=[],this.zusatzzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this.datenGeliefert=!1,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._beobachter=null,this._taktGemessen=0,this._fokusZeile=null,this._fokusHolen=!1,this._besitz=`softengine`,this._erfassung=new Ba}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannErfassen={wenn:{attributeName:`erfassung`,equals:`ja`}}}static{this.blockEvents=[{key:`onRowClick`,name:`Zeile gewählt`}]}static{this.listenBindung=lo}static{this.defaultProps={width:`fill`,source:``,spalten:Yi(),suche:`ja`,erfassung:`nein`,schlank:`nein`,tagField:``,leerText:oa}}static{this.customProperties=To}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get zeigtKopf(){return Co(this.schlank)}get besitz(){return this._besitz}set besitz(e){e!==this._besitz&&(this._besitz=e,this.setzeAbgeleitetesZurueck(),this.isConnected&&(e===`provided`?Za(this):Xa(this)),this.requestUpdate())}set bereitgestellteZeilen(e){let t=Ha(e);this.rohzeilen=t.rohzeilen,this.datenzeilen=t.datenzeilen,this.zusatzzeilen=t.zusatzzeilen,this.datenGeliefert=!0,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._seite=0,this._mass=null,this._taktGemessen=0,this.requestUpdate()}setzeAbgeleitetesZurueck(){this.rohzeilen=[],this.datenzeilen=[],this.zusatzzeilen=[],this.datenGeliefert=!1,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._suchtext=``,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._taktGemessen=0,this._fokusZeile=null,this._fokusHolen=!1,this._erfassung.zuruecksetzen()}get erfassteSaetze(){return this._erfassung.saetze(this.erfassungsUmfeld())}get erfassteQuellen(){return this.erfassungAn?za(this.erfassungsUmfeld()):[]}erfassungLeeren(){this._erfassung.leeren()&&this.requestUpdate()}fokussiereSuche(){let e=this.shadowRoot?.querySelector(`.suchzeile input`);return e?(e.focus(),!0):!1}get hatQuelle(){return this._besitz===`provided`||$a(this.hasAttribute(`data-ff-editor`),this.source)}merkeZeilenFokus(){let e=No(this.shadowRoot);this._fokusHolen=e!==void 0,this._fokusZeile=e??null}messeRumpf(){let e=this.zeilenHoehe;this._taktGemessen=e;let t=ua(this,e);t?.passen===this._mass?.passen&&t?.zeilenHoehe===this._mass?.zeilenHoehe||(this._mass=t,this.requestUpdate())}spaltenListe(){return $i(this.spalten)}get zeilenHoehe(){return Vi(this.spaltenListe())}aktiviereZeile(e,t){if(e===null||this.hasAttribute(`data-ff-editor`))return;let n=this.rohzeilen[e];n!==void 0&&(Mo(this,{rohzeile:n,rohIndex:e,ansichtIndex:t}),this.toggleAuswahl(n),yr(this,`onRowClick`,{PINDEX:qa(this,n)}).catch(mr))}toggleAuswahl(e){let t=N(this);t!==``&&Yt(t,e)}setzeSuchtext(e){this.merkeZeilenFokus(),this._suchtext=e,this._seite=0,this.requestUpdate()}klickSortiere(e){if(this.editable)return;this.merkeZeilenFokus();let t=wo(this._sortSpalte,this._sortAuf,e);this._sortSpalte=t.spalte,this._sortAuf=t.auf,this._seite=0,this.requestUpdate()}get erfassungAn(){return this.erfassung===`ja`}fussNoetig(e){return e>1||this._suchtext.trim()!==``||this.durchAuswahlGefiltert}erfassungsWirt(){return{baustein:this,anschluss:this._erfassung,umfeld:()=>this.erfassungsUmfeld(),melde:()=>this.requestUpdate(),fokussiere:(e,t)=>this.fokussiereZelle(e,t)}}fokussiereZelle(e,t){this.updateComplete.then(()=>{let n=this.shadowRoot?.querySelector(`.zeile.erfassung[data-erf-zeile="${e}"] .erf-eingabe[data-spalte="${t}"]`);n?.focus(),n?.select()})}erfassungsUmfeld(){return this._erfassung.umfeld(this,this.spaltenListe(),this.source)}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}beobachte(){this._beobachter||(this._beobachter=da(this,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}connectedCallback(){super.connectedCallback(),this._besitz===`softengine`&&Xa(this),this.beobachte()}firstUpdated(){this.beobachte()}willUpdate(e){super.willUpdate(e),!(!this.erfassungAn||this.hasAttribute(`data-ff-editor`))&&(this._erfassung.haltLeerzeileFrei(this.erfassungsUmfeld()),this._erfassung.haltVorschlaegeAktuell(this.erfassungsUmfeld()))}updated(){this._taktGemessen!==this.zeilenHoehe&&this.messeRumpf(),this.shadowRoot&&$r(this.shadowRoot),this._fokusHolen&&(this._fokusHolen=!1,Po(this.shadowRoot,this._fokusZeile))}disconnectedCallback(){super.disconnectedCallback(),so(this),this._beobachter?.disconnect(),this._beobachter=null,Qo(this),Za(this)}static{this.styles=[T.styles,Dr,la,ko,ni,Va]}render(){let t=this.spaltenListe(),n=e=>e.stopPropagation(),r=So({spalten:t,hatQuelle:this.hatQuelle,datenGeliefert:this.datenGeliefert,datenzeilen:this.datenzeilen,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,wunschSeite:this._seite,gemessen:this._mass,erfassungsZeilen:this.erfassungAn?this._erfassung.anzahl:0});return g`<div class=${this.schlank===`ja`?`tabelle schlank`:`tabelle`} style=${W({"--takt":`${r.takt}px`,"--zeilen-hoehe":`${r.zeilenHoehe}px`})}>
      ${no(()=>this.spaltenListe(),e=>this.aendere(e),n)}
      ${Oo({spalten:t,cols:r.cols,editable:this.editable,imEditor:this.hasAttribute(`data-ff-editor`),zeigeKopf:this.zeigtKopf,auswahlSemantik:N(this)!==``,zeigeSuche:this.suche===`ja`,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,zeilen:r.zeilen,linealTakte:r.linealTakte,datenzeilen:this.datenzeilen,zusatzzeilen:this.zusatzzeilen,hatQuelle:r.hatQuelle,auswahlIndex:this.auswahlIndex,leer:r.leer,leerText:this.leerText,erfassungsZeilen:this.erfassungAn?Pa(this.erfassungsWirt(),r.cols,r.zeilen.length,!0,this.hasAttribute(`data-ff-editor`)&&this.editable&&!this.zeigtKopf?(t,n)=>co(this,t,{prop:e.listenBindung.prop,index:n,liste:()=>this.spaltenListe()}):void 0):[],mitGriff:this.erfassungAn},{setzeSuchtext:e=>this.setzeSuchtext(e),dblklickKopf:(e,t)=>{this.editable&&(so(this),io(e,t,()=>this.spaltenListe(),e=>this.aendere(e)))},klickKopf:(t,n)=>{this.editable&&co(this,t,{prop:e.listenBindung.prop,index:n,liste:()=>this.spaltenListe()}),this.klickSortiere(n)},aktiviereZeile:(e,t)=>this.aktiviereZeile(e,t)})}
      ${``}
      ${r.leer||!this.fussNoetig(r.seiten)?v:Eo({hatQuelle:r.hatQuelle,sichtbar:r.gesamt,gesamt:this.datenzeilen.length,suchtAktiv:this._suchtext.trim()!==``,auswahlAktiv:this.durchAuswahlGefiltert,seite:r.seite,seiten:r.seiten},{blaettere:e=>{this.merkeZeilenFokus(),this._seite=e,this.requestUpdate()}})}
    </div>`}};w([S({converter:{fromAttribute:e=>e?ea(e):Yi(),toAttribute:e=>JSON.stringify(e)}})],K.prototype,`spalten`,void 0),w([S()],K.prototype,`source`,void 0),w([S()],K.prototype,`suche`,void 0),w([S()],K.prototype,`erfassung`,void 0),w([S()],K.prototype,`schlank`,void 0),w([S()],K.prototype,`leerText`,void 0),w([S({attribute:!1})],K.prototype,`datenzeilen`,void 0),w([S({attribute:!1})],K.prototype,`zusatzzeilen`,void 0),w([S({attribute:!1})],K.prototype,`rohzeilen`,void 0),w([S({attribute:!1})],K.prototype,`auswahlIndex`,void 0),w([S({attribute:!1})],K.prototype,`durchAuswahlGefiltert`,void 0),w([S({attribute:!1})],K.prototype,`datenGeliefert`,void 0),T.defineAndRegister(K);function Fo(e){return g`<div class="nachschlag">
    <input
      class="ctrl"
      type="text"
      .value=${e.wert}
    ...
    >${Oi()}</button>
    ${e.liste}
  </div>`}var Io={prop:`nachschlagSpalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:qi,quelleProp:`nachschlagQuelle`};function Lo(e){if(typeof e==`string`)try{e=JSON.parse(e)}catch{return[]}return Array.isArray(e)&&e.length>0?$i(e):[]}function Ro(e,t){let n=e[0];return n===void 0?t:n.feld}function zo(e,t){let n=e.trim();return n===``||n===t.trim()}function Bo(e,t,n){let r=t.trim(),i=[],a=zo(t,n)||n.trim()===``,o=new Set;for(let t of e){let e=k(t,n).trim(),s=r===``?e:k(t,r).trim();if(!(s===``&&e===``)){if(a){let t=e===``?s:e;if(o.has(t))continue;o.add(t)}i.push({anzeige:s,wert:e,satz:t})}}return i}function Vo(e,t,n,r){return Bo(tn(e,t).rows,n,r)}function Ho(e){let t=O(I().FF_DATA_SOURCES,e);return t?j(I().SEDATA,t.name,t.tableId):null}function Uo(e){if(e.quelleId===``||e.speicherFeld===``)return{ok:!1,grund:`unvollstaendig`};let t=Ho(e.quelleId);if(t===null)return{ok:!1,grund:`quelleFehlt`};let n=Ro(Lo([...e.spalten]),e.speicherFeld);return{ok:!0,eintraege:Vo(e.el,t,n,e.speicherFeld)}}function Wo(e,t){return t&&e.length===1?e[0]:null}function Go(e,t){let{rows:n,gefiltert:r}=tn(e,[t]);return!r||n.length>0}function Ko(e,t,n){return e===``?t===``&&n===``?`nichts`:`leeren`:e===t?`nichts`:`zurueck`}var qo=null,Jo=null,Yo=null;function Xo(e){return e.shadowRoot?.querySelector(`.lupe`)??null}function Zo(e=!0){let t=e?Yo:null;Yo=null,qo?.remove(),qo=null,Jo=null,t?.focus()}function Qo(e){Jo===e&&Zo(!1)}function $o(e){return[{titel:e.speicherTitel===``?`Wert`:e.speicherTitel,feld:e.speicherFeld,art:V}]}function es(e){let t=e=>e.stopPropagation(),n=e.editor;return g`<ff-dialog-rahmen
    viewport
    escape-schliesst
    ohne-modal
    inhalt-fest
  ...
  >${e.inhalt}</ff-dialog-rahmen>`}function ts(e,t){let n=Lo([...e.spalten]),r=zo(Ro(n,e.speicherFeld),e.speicherFeld);return g`<ff-tabelle
    fuellt
    suche="ja"
    style="--se-r-lg:0px"
    .besitz=${`provided`}
    .spalten=${n.length>0?n:$o(e)}
  ...
  ></ff-tabelle>`}function ns(e){let t=e.eintraege;if(t===void 0){let n=Uo(e);if(!n.ok){F(n.grund===`unvollstaendig`?`Nachschlagen braucht an diesem Feld eine Quelle und „Gespeichert wird".`:`Die Nachschlage-Quelle dieses Feldes ist in der Maske nicht vorhanden.`);return}t=n.eintraege}Zo(!1);let n=document.createElement(`div`);n.style.display=`contents`,Ue(es({titel:e.titel,breite:e.breite,hoehe:e.hoehe,inhalt:ts(e,t),onSchliessen:()=>Zo()}),n);let r=n.querySelector(ir),i=n.querySelector(K.tagName);i?.addEventListener(Ao,n=>{let r=n.detail,i=t[r.rohIndex];i&&(Zo(),e.onUebernehmen(i.anzeige,i.wert,i.satz))}),Yo=e.rueckFokus??Xo(e.el),document.body.appendChild(n),qo=n,Jo=e.el,r&&i&&Promise.all([r.updateComplete,i.updateComplete]).then(()=>{r.isConnected&&i.fokussiereSuche()})}function rs(e){return es({titel:e.titel,breite:e.breite,hoehe:e.hoehe,onSchliessen:e.onSchliessen,editor:{onGroesse:e.onGroesse},inhalt:g`<ff-tabelle
      data-ff-editor
      fuellt
      suche="ja"
      style="--se-r-lg:0px"
    ...
    ></ff-tabelle>`})}var is=[`J`,`1`,`X`,`TRUE`];function as(e){return is.includes(e.trim().toUpperCase())}function os(e){return e?`J`:`N`}function ss(e){return g`<div class="feld">
  ...
  </div>`}function cs(e){let t=e.optionen.split(`,`).map(e=>e.trim()).filter(e=>e!==``),n=e.wert!==``&&!t.includes(e.wert);return g`<select
    class="ctrl"
    .value=${e.wert}
    @input=${e.onInput}
    @change=${e.onChange}
  ...
  </select>`}function ls(e){return g`<textarea
    class="ctrl"
    .value=${e.wert}
    @input=${e.onInput}
    @change=${e.onChange}
  ></textarea>`}function us(e){return g`<input
    class="ctrl"
    type=${e.typ}
    ...
    @focus=${()=>e.onFokus(!0)}
    @blur=${()=>e.onFokus(!1)}
  />`}var q=class e extends T{constructor(...e){super(...e),this.fieldType=`text`,this.placeholder=`Feldname`,this.options=``,this.source=``,this.value=``,this.valueField=``,this.nachschlagQuelle=``,this.speicherFeld=``,this.speicherTitel=``,this.nachschlagSpalten=[],this.fensterBreite=520,this.fensterHoehe=380,this.einzigerTreffer=`nein`,this.spaltenDialog=!1,this.anzeige=``,this.getippt=null,this.marke=0,this.listeZu=!1,this.vorschlaege=[],this.satz=void 0,this.imSteuerelement=!1}static{this.blockType=`formfeld`}static{this.tagName=`ff-formfeld`}static{this.displayName=`Formularfeld`}static{this.category=`eingabe`}static{this.acceptsDataSource={wenn:{attributeName:`fieldType`,notEquals:`nachschlagen`}}}static{this.satzWahl={quelleProp:`nachschlagQuelle`,wenn:{attributeName:`fieldType`,equals:`nachschlagen`}}}static{this.listenBindung=Io}static{this.bindableSpots=[{prop:`value`,label:`Wert`,wenn:{attributeName:`fieldType`,keinesVon:[`nachschlagen`]},vorschauProp:`placeholder`}]}static{this.actionValueSpots=[{prop:`value`,label:`Wert`}]}static{this.blockEvents=[{key:`onChange`,name:`Wert geändert`}]}static{this.defaultProps={width:240,fieldType:`text`,placeholder:`Feldname`,options:``,source:``,value:``,valueField:``,nachschlagQuelle:``,speicherFeld:``,speicherTitel:``,nachschlagSpalten:[],fensterBreite:520,fensterHoehe:380,einzigerTreffer:`nein`}}static{this.raster={startW:6,startH:2,minW:2,minH:2}}static{this.customProperties=ai}static{this.styles=[T.styles,wi,ni]}onInput(e){let t=e.target;this.value=B(this.fieldType)===`date`?gi(t.value):t.value}onChange(){this.dispatchEvent(new Event(`change`))}textTpl(e,t=!1){return g`<span
      class=${e}
      ?hidden=${t}
      data-ff-editable
      @click=${this.onTextClick}
      @dblclick=${e=>this.inlineEdit(e,`placeholder`)}
    >${this.placeholder}</span>`}onTextClick(){this.hasAttribute(`data-ff-editor`)||this.setzeHaken(!this.angehakt)}get angehakt(){return as(this.value)}setzeHaken(e){let t=os(e);this.value!==t&&(this.value=t,this.dispatchEvent(new Event(`change`)))}controlTpl(e){switch(e){case`textarea`:return ls({wert:this.value,onInput:this.onInput,onChange:this.onChange});case`select`:return cs({wert:this.value,optionen:this.options,onInput:this.onInput,onChange:this.onChange});case`nachschlagen`:return Fo({wert:this.getippt??this.anzeige,onTippen:e=>{this.getippt=e,this.marke=0,this.listeZu=!1},onTaste:e=>this.onNachschlagTaste(e),onVerlassen:()=>this.onNachschlagVerlassen(),onLupe:()=>this.onLupe(),liste:this.vorschlaege.length===0?v:Zr({eintraege:this.vorschlaege,marke:this.marke,onWaehlen:e=>this.uebernimmVorschlag(e),onMarke:e=>{this.marke=e}})});default:return us({typ:e,wert:this.value,onInput:this.onInput,onChange:this.onChange,onFokus:e=>{this.imSteuerelement=e}})}}onLupe(){if(this.hasAttribute(`data-ff-editor`)){this.spaltenDialog=!0;return}ns({el:this,quelleId:this.nachschlagQuelle,speicherFeld:this.speicherFeld,speicherTitel:this.speicherTitel,spalten:this.nachschlagSpalten,titel:this.placeholder,breite:this.fensterBreite,hoehe:this.fensterHoehe,onUebernehmen:(e,t,n)=>this.uebernimmUndMelde(e,t,n)})}spaltenEffektiv(){let e=Lo(this.nachschlagSpalten);return e.length>0?e:$o({speicherFeld:this.speicherFeld,speicherTitel:this.speicherTitel})}meldeProp(e,t,n){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:e,value:t,...n===void 0?{}:{geste:n}},bubbles:!0,composed:!0}))}spaltenDialogTpl(){return rs({titel:this.placeholder,spalten:this.spaltenEffektiv(),breite:this.fensterBreite,hoehe:this.fensterHoehe,onGroesse:t=>{let n=t.achse===`breite`?`fensterBreite`:`fensterHoehe`;if(t.geste===`standard`){this.meldeProp(n,e.defaultProps[n]);return}this.meldeProp(n,t.wert,t.geste===`laeuft`?void 0:t.geste)},onAendern:e=>{this.meldeProp(`nachschlagSpalten`,e)},onFeldWahl:e=>{this.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:`nachschlagSpalten`,...e},bubbles:!0,composed:!0}))},onSchliessen:()=>{this.spaltenDialog=!1}})}willUpdate(e){super.willUpdate(e),e.has(`fieldType`)&&B(this.fieldType)!==`nachschlagen`&&(this.spaltenDialog=!1),this.vorschlaege=this.berechneVorschlaege(),this.marke=Yr(this.marke,this.vorschlaege.length)}updated(e){super.updated(e),this.toggleAttribute(`data-ff-liste`,this.vorschlaege.length>0)}berechneVorschlaege(){if(this.getippt===null||this.listeZu||B(this.fieldType)!==`nachschlagen`||this.hasAttribute(`data-ff-editor`))return[];let e=Uo({el:this,quelleId:this.nachschlagQuelle,speicherFeld:this.speicherFeld,spalten:this.nachschlagSpalten});return e.ok?qr(e.eintraege,this.getippt):[]}onNachschlagTaste(e){if(this.hasAttribute(`data-ff-editor`))return;let t=this.vorschlaege.length,n=Xr(e.key,{listeOffen:t>0,feldLeer:(this.getippt??this.anzeige)===``});if(n===`nichts`){e.key===`Enter`&&e.preventDefault();return}e.preventDefault(),n===`marke-hoch`?this.marke=Jr(this.marke,t,-1):n===`marke-runter`?this.marke=Jr(this.marke,t,1):n===`uebernehmen`?this.uebernimmVorschlag(this.marke):n===`liste-zu`?this.listeZu=!0:this.onLupe()}uebernimmVorschlag(e){let t=this.vorschlaege[e];t&&this.uebernimmUndMelde(t.anzeige,t.wert,t.satz)}leereNachschlagen(){this.satz=void 0,this.anzeige=``,this.value=``,Zt(N(this))}uebernimmUndMelde(e,t,n){this.getippt=null,this.listeZu=!1,this.marke=0,this.uebernimmSatz(e,t,n),this.dispatchEvent(new Event(`change`))}uebernimmSatz(e,t,n){this.anzeige=e===``?t:e,this.value=t,this.satz=n,Xt(N(this),n)}onNachschlagVerlassen(){if(this.hasAttribute(`data-ff-editor`))return;let e=Ko(this.getippt??this.anzeige,this.anzeige,this.value);this.getippt=null,this.listeZu=!1,this.marke=0,e===`leeren`&&(this.leereNachschlagen(),this.dispatchEvent(new Event(`change`)))}pruefeEigenenWert(){B(this.fieldType)===`nachschlagen`&&(this.getippt!==null&&this.requestUpdate(),this.satz!==void 0&&!Go(this,this.satz)&&this.leereNachschlagen(),this.uebernimmEinzigenTreffer())}uebernimmEinzigenTreffer(){if(this.einzigerTreffer!==`ja`)return;let e=Uo({el:this,quelleId:this.nachschlagQuelle,speicherFeld:this.speicherFeld,spalten:this.nachschlagSpalten});if(!e.ok)return;let t=Wo(e.eintraege,this.satz===void 0);t&&this.uebernimmSatz(t.anzeige,t.wert,t.satz)}render(){let e=B(this.fieldType);if(e===`checkbox`)return ss({angehakt:this.angehakt,gebunden:this.valueField!==``,onAendern:e=>this.setzeHaken(e),text:this.textTpl(`text`)});let t=e!==`nachschlagen`,n=(t?this.value:this.getippt??this.anzeige)===``;return g`<div class="feld">
      <div
...
`,ms=`frei · hierher ziehen`,hs=`ff-zimmer-inhalt`,J=class extends T{constructor(...e){super(...e),this.heading=`Neues Zimmer`,this.leerHinweis=``}static{this.blockType=`kanban-zimmer`}static{this.tagName=`ff-kanban-zimmer`}static{this.displayName=`Kanban-Zimmer`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[z.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban-spalte`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={heading:`Neues Zimmer`}}static{this.styles=[T.styles,la,ps,fs,o`
    ...
    `]}onSlotChange(){this.dispatchEvent(new CustomEvent(hs,{bubbles:!0,composed:!0}))}render(){return g`<div class="zimmer ${ds}">
      <div
        class="kopf"
        data-ff-editable
    ...
    `]}constructor(){super(),this.variant=`info`,this.heading=`Neue Spalte`,this.leerHinweis=``,this._count=0,this.addEventListener(hs,()=>this.zaehle())}zaehle(){this._count=Array.from(this.querySelectorAll(z.tagName)).filter(e=>!e.hasAttribute(`data-ff-editor-helper`)).length}render(){return g`<div class="col ${ds} v-${wr(this.variant)}">
      <div class="head">
        <span class="dot"></span>
        <span
          class="title"
    ...
    </div>`}};w([S()],Y.prototype,`variant`,void 0),w([S()],Y.prototype,`heading`,void 0),w([S({attribute:!1})],Y.prototype,`leerHinweis`,void 0),w([C()],Y.prototype,`_count`,void 0),T.defineAndRegister(Y);function gs(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function _s(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var vs=new WeakMap,ys=Y.tagName,bs=J.tagName,xs=z.tagName;function Ss(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===ys)}function Cs(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===xs)}function ws(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===bs)}function Ts(e){return[e,...ws(e)]}function Es(e,t){let n=e.getAttribute(`leertext`)??`Keine Datensätze.`,r=(e,t)=>{e.leerHinweis=t};for(let e of t){let t=ws(e);for(let e of t)r(e,Cs(e).length===0?ms:``);r(e,t.length===0&&Cs(e).length===0?n:``)}}function Ds(e){return Xe().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function Os(e,t){let n=ws(e);if(n.length===0)return null;let r=e.getAttribute(`zimmerfield`)??``;if(r===``)return n[0];let i=n.map(e=>e.getAttribute(`heading`)??J.defaultProps.heading),a=gs(k(t,r),i);return a>=0?n[a]:n[0]}function ks(e){Z?.board===e&&Fs();let t=e.getAttribute(`statusfield`)??``,n=Wa(e);if(!n)return;let r=Ss(e);if(r.length===0)return;let i=vs.get(e);if(!i){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(xs);t&&(i=t.cloneNode(!0),vs.set(e,i))}if(!i)return;let a=n.zeilen,o=r.map(e=>e.getAttribute(`heading`)??Y.defaultProps.heading),s=Ds(i.tagName),c=_s(r.map(e=>e.getAttribute(`auffang`))),l=n.lies;for(let e of r)for(let t of Ts(e))Cs(t).forEach(e=>e.remove());for(let e of a){let a=i.cloneNode(!0),u=t===``?-1:gs(k(e,t),o),d=u>=0?r[u]:c>=0?r[c]:r[0];(Os(d,e)??d).appendChild(a);for(let t of s){let n=a.getAttribute(rt(t.prop))??``;n!==``&&(a[t.prop]=l(e,n))}let ee=jt(n.quelle,e);X.set(a,{row:e,pindex:ee}),a.draggable=!0}Es(e,r);let u=r.flatMap(e=>Ts(e).flatMap(Cs)),d=Jt(N(e),u,e=>X.get(e)?.row);for(let e of d)u[e].setAttribute(`data-ff-auswahl`,``)}var X=new WeakMap,Z=null,As=new WeakSet,js=`data-ff-zieht`,Ms=`data-ff-ziel`,Ns=null;function Ps(e){Ns!==e&&(Ns?.removeAttribute(Ms),Ns=e,Ns?.setAttribute(Ms,``))}function Fs(){Z?.card.removeAttribute(js),Z=null,Ps(null)}function Is(e,t,n){for(let r of t.composedPath())if(r instanceof HTMLElement&&r.tagName.toLowerCase()===n&&e.contains(r))return r;return null}function Ls(e,t){return Is(e,t,ys)}function Rs(e,t,n){if(!Z||Z.board!==e)return;let r=X.get(Z.card);if(!r)return;let i=t.getAttribute(`heading`)??``,a=n?.getAttribute(`heading`)??``;yr(e,`onCardDrop`,{PINDEX:r.pindex,VALUE:i,ZIMMER:a}).catch(mr)}function zs(e){As.has(e)||(As.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;if(!n)return;let r=X.get(n);r&&Yt(N(e),r.row),yr(e,`onCardClick`,{PINDEX:r?.pindex??``}).catch(mr)}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;n&&(Z={card:n,board:e},t.dataTransfer?.setData(`text/plain`,X.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`),setTimeout(()=>{Z?.card===n&&n.setAttribute(js,``)},0))}),e.addEventListener(`dragend`,Fs),e.addEventListener(`dragover`,t=>{let n=Ls(e,t);if(Z?.board!==e||!n){Ps(null);return}t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`),Ps(Is(e,t,bs)??n)}),e.addEventListener(`dragleave`,t=>{let n=t.relatedTarget;(!(n instanceof Node)||!e.contains(n))&&Ps(null)}),e.addEventListener(`drop`,t=>{let n=Ls(e,t);n&&(t.preventDefault(),Rs(e,n,Is(e,t,bs)),Fs())}))}var Bs=oi({hydriere:ks,verdrahte:zs}),Vs=Bs.connect,Hs=Bs.disconnect,Us=Y.blockType,Ws=class extends T{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[Us]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:Us}}static{this.templateChild={type:z.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``,tagField:``,leerText:oa}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Optional: Feld der Datenquelle, dessen Inhalt bestimmt, in welche Spalte ein Eintrag kommt. Leer = alle Einträge in der Auffang-Spalte.`,kind:`field`},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt das Board nur Einträge des Tages, den der Tageswähler zeigt. Leer = alle Einträge.`,kind:`field`},sa()]}static{this.defaultChildren=[{type:Us,props:{heading:`Offen`,variant:`warning`},children:[{type:z.blockType}]},{type:Us,props:{heading:`In Arbeit`,variant:`info`}},{type:Us,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[T.styles,o`
    ...
    `]}render(){return g`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),Vs(this)}disconnectedCallback(){super.disconnectedCallback(),Hs(this)}};T.defineAndRegister(Ws);var Gs={breite:56,breiteOffen:224},Ks=`ff-seiten-wechsel`,qs=[{wert:`sonne`,name:`Sonnengelb`},{wert:`salbei`,name:`Salbeigrün`},{wert:`himmel`,name:`Himmelblau`},{wert:`flieder`,name:`Flieder`},{wert:`koralle`,name:`Koralle`}],Q=class extends T{static{this.blockType=`navi-eintrag`}static{this.ohneDaten=!0}static{this.tagName=`ff-navi-eintrag`}static{this.displayName=`Navi-Eintrag`}static{this.category=`layout`}static{this.acceptsChildren=!1}static{this.showInPalette=!1}static{this.allowedParentTypes=[`navi`]}static{this.resizableWidth=!1}static{this.defaultProps={seite:``,seitename:``,ton:`sonne`}}static{this.customProperties=[{attributeName:`seite`,name:`Seite`,description:`Welche Seite dieser Maske der Eintrag zeigt.`,kind:`seite`,klarnameProp:`seitename`,nurImEditor:!0},{attributeName:`ton`,name:`Farbe`,description:`Farbe des Zeichens vor dem Namen.`,kind:`select`,options:qs.map(e=>({value:e.wert,label:e.name}))}]}static{this.styles=[T.styles,o`
      :host {
        --ton: var(--se-amber);
        display: flex;
        align-items: center;
    ...
    `]}constructor(){super(),this.seite=``,this.seitename=``,this.ton=`sonne`,this.addEventListener(`click`,()=>this.melde())}melde(){let e={ansicht:this.seitename};this.dispatchEvent(new CustomEvent(Ks,{detail:e,bubbles:!0,composed:!0}))}render(){return g`<span class="zeichen"></span>
      <span class="name">${this.seitename===``?`—`:this.seitename}</span>`}};w([S()],Q.prototype,`seite`,void 0),w([S()],Q.prototype,`seitename`,void 0),w([S({reflect:!0})],Q.prototype,`ton`,void 0),T.defineAndRegister(Q);var Js=`aktiv`;function Ys(e){return Array.from(e.querySelectorAll(Q.tagName))}function Xs(e,t){let n=Ys(e),r=t??n.find(e=>e.hasAttribute(Js))??n[0];for(let e of n)e===r?e.setAttribute(Js,``):e.removeAttribute(Js)}function Zs(e){let t=e.hasAttribute(`offen`);for(let n of Ys(e))n.toggleAttribute(`breit`,t)}function Qs(e){return e.getAttribute(`name`)??String(ht.defaultProps.name)}function $s(e,t){let n=e;for(;n&&n.parentElement!==t;)n=n.parentElement;return n}function ec(e,t){let n=e.ownerDocument,r=Array.from(n.querySelectorAll(ht.tagName)),i=r[0]?.parentElement??null;if(!i)return;let a=$s(e,i);if(!a)return;let o=r.find(e=>Qs(e)===t)??null;for(let e of Array.from(i.children))e!==a&&((r.includes(e)?e===o:o===null)?e.removeAttribute(`hidden`):e.setAttribute(`hidden`,``))}var tc=new WeakMap,nc=new WeakSet;function rc(e){let t=t=>{let n=t.detail;n&&(Xs(e,t.target instanceof Element?t.target:void 0),e.removeAttribute(`offen`),Zs(e),!e.hasAttribute(`data-ff-editor`)&&ec(e,n.ansicht))};e.addEventListener(Ks,t),tc.set(e,t)}function ic(e){let t=tc.get(e);t&&(e.removeEventListener(Ks,t),tc.delete(e))}function ac(e){if(Xs(e),Zs(e),e.hasAttribute(`data-ff-editor`)||nc.has(e))return;let t=Ys(e)[0];if(!t)return;nc.add(e);let n=()=>ec(e,t.seitename);e.ownerDocument.readyState===`loading`?e.ownerDocument.addEventListener(`DOMContentLoaded`,n,{once:!0}):queueMicrotask(n)}var oc=Q.blockType,sc=class extends T{static{this.blockType=`navi`}static{this.ohneDaten=!0}static{this.tagName=`ff-navi`}static{this.displayName=`Navi`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[oc]}static{this.addChildButton={label:`Eintrag`,childType:oc}}static{this.containerHint=!1}static{this.defaultProps={}}static{this.customProperties=[]}static{this.maskenRand=!0}static{this.allowedParentTypes=[mt]}static{this.raster={startW:5,startH:24,minW:3,minH:3}}static{this.styles=[T.styles,o`
      :host {
        height: 100%;
        width: ${Gs.breite}px;
    ...
    `]}connectedCallback(){super.connectedCallback(),rc(this)}disconnectedCallback(){super.disconnectedCallback(),ic(this)}klappen(){this.toggleAttribute(`offen`),Zs(this)}render(){return g`<div class="leiste">
        <div class="kopf">
          <button
            class="schalter"
            type="button"
      ...
      </div>`}};T.defineAndRegister(sc);var cc=rt(`text`);function lc(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(cc)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function uc(e){let t=fi(e,cc);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function dc(e){lc(e)&&(e.text=``)}var fc=oi({hydriere:uc,verdrahte:dc}),pc=fc.connect,mc=fc.disconnect,hc=6,gc=96,_c=14,vc={duenn:`300`,normal:`400`,fett:`700`},yc={links:`left`,mitte:`center`,rechts:`right`},bc={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},xc=`standard`;function Sc(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(gc,Math.max(hc,t)):_c}function Cc(e){return typeof e==`string`&&e in vc?e:`normal`}function wc(e){return typeof e==`string`&&e in yc?e:`links`}function Tc(e){return typeof e==`string`&&e in bc?e:xc}var $=class extends T{constructor(...e){super(...e),this.groesse=_c,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=xc,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:_c,gewicht:`normal`,ausrichtung:`links`,farbe:xc,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:hc,max:gc,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[T.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return g`<div
      class="text"
      style=${W({fontSize:`${Sc(this.groesse)}px`,fontWeight:vc[Cc(this.gewicht)],textAlign:yc[wc(this.ausrichtung)],color:bc[Tc(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),pc(this)}disconnectedCallback(){super.disconnectedCallback(),mc(this)}};w([S({type:Number})],$.prototype,`groesse`,void 0),w([S()],$.prototype,`gewicht`,void 0),w([S()],$.prototype,`ausrichtung`,void 0),w([S()],$.prototype,`farbe`,void 0),w([S()],$.prototype,`text`,void 0),w([S()],$.prototype,`source`,void 0),w([S()],$.prototype,`textField`,void 0),T.defineAndRegister($);var Ec=[`waagerecht`,`senkrecht`],Dc=`waagerecht`;function Oc(e){return Ec.includes(e)?e:Dc}var kc=class extends T{constructor(...e){super(...e),this.richtung=Dc}static{this.blockType=`trenner`}static{this.ohneDaten=!0}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`,richtung:Dc}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1,varianten:[{wenn:{attributeName:`richtung`,equals:`senkrecht`},startW:1,startH:6,breiteZiehbar:!1}]}}static{this.customProperties=[{attributeName:`richtung`,name:`Richtung`,description:`Waagerecht trennt oben von unten, senkrecht links von rechts.`,kind:`select`,options:[{value:`waagerecht`,label:`Waagerecht`},{value:`senkrecht`,label:`Senkrecht`}]}]}static{this.styles=[T.styles,o`
    ...
    `]}render(){return g`<div class="flaeche ${Oc(this.richtung)}"><div class="linie"></div></div>`}};w([S()],kc.prototype,`richtung`,void 0),T.defineAndRegister(kc),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;F(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();
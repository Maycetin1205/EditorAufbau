...
\f\r]`,he=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ge=/-->/g,_e=/>/g,C=RegExp(`>|${me}(?:([^\\s"'>=/]+)(${me}*=${me}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,`g`),ve=/'/g,ye=/"/g,be=/^(?:script|style|textarea|title)$/i,xe=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),w=xe(1),Se=xe(2),T=Symbol.for(`lit-noChange`),E=Symbol.for(`lit-nothing`),Ce=new WeakMap,D=S.createTreeWalker(S,129);function we(e,t){if(!fe(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return oe===void 0?t:oe.createHTML(t)}var Te=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:t===3?`<math>`:``,o=he;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===he?c[1]===`!--`?o=ge:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=C):(be.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=C):o=_e:o===C?c[0]===`>`?(o=i??he,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?C:c[3]===`"`?ye:ve):o===ye||o===ve?o=C:o===ge||o===_e?o=he:(o=C,i=void 0);let d=o===C&&e[t+1].startsWith(`/>`)?` `:``;a+=o===he?n+le:l>=0?(r.push(s),n.slice(0,l)+se+n.slice(l)+x+d):n+x+(l===-2?t:d)}return[we(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:t===3?`</math>`:``)),r]},Ee=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=Te(t,n);if(this.el=e.createElement(l,r),D.currentNode=this.el.content,n===2||n===3){let e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;(i=D.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes())for(let e of i.getAttributeNames())if(e.endsWith(se)){let t=u[o++],n=i.getAttribute(e).split(x),r=/([.?@])?(.*)/.exec(t);c.push({type:1,index:a,name:r[2],strings:n,ctor:r[1]===`.`?je:r[1]===`?`?Me:r[1]===`@`?Ne:Ae}),i.removeAttribute(e)}else e.startsWith(x)&&(c.push({type:6,index:a}),i.removeAttribute(e));if(be.test(i.tagName)){let e=i.textContent.split(x),t=e.length-1;if(t>0){i.textContent=ae?ae.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],ue()),D.nextNode(),c.push({type:2,index:++a});i.append(e[t],ue())}}}else if(i.nodeType===8)if(i.data===ce)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(x,e+1))!==-1;)c.push({type:7,index:a}),e+=x.length-1}a++}}static createElement(e,t){let n=S.createElement(`template`);return n.innerHTML=e,n}};function De(e,t,n=e,r){if(t===T)return t;let i=r===void 0?n._$Cl:n._$Co?.[r],a=de(t)?void 0:t._$litDirective$;return i?.constructor!==a&&(i?._$AO?.(!1),a===void 0?i=void 0:(i=new a(e),i._$AT(e,n,r)),r===void 0?n._$Cl=i:(n._$Co??=[])[r]=i),i!==void 0&&(t=De(e,i._$AS(e,t.values),i,r)),t}var Oe=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??S).importNode(t,!0);D.currentNode=r;let i=D.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new ke(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new Pe(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=D.nextNode(),a++)}return D.currentNode=S,r}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},ke=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,r){this.type=2,this._$AH=E,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=De(this,e,t),de(e)?e===E||e==null||e===``?(this._$AH!==E&&this._$AR(),this._$AH=E):e!==this._$AH&&e!==T&&this._(e):e._$litType$===void 0?e.nodeType===void 0?pe(e)?this.k(e):this._(e):this.T(e):this.$(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==E&&de(this._$AH)?this._$AA.nextSibling.data=e:this.T(S.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=Ee.createElement(we(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.p(t);else{let e=new Oe(r,this),n=e.u(this.options);e.p(t),this.T(n),this._$AH=e}}_$AC(e){let t=Ce.get(e.strings);return t===void 0&&Ce.set(e.strings,t=new Ee(e)),t}k(t){fe(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.O(ue()),this.O(ue()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let t=ie(e).nextSibling;ie(e).remove(),e=t}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},Ae=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,r,i){this.type=1,this._$AH=E,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=E}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=De(this,e,t,0),a=!de(e)||e!==this._$AH&&e!==T,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=De(this,r[n+o],t,o),s===T&&(s=this._$AH[o]),a||=!de(s)||s!==this._$AH[o],s===E?e=E:e!==E&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===E?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},je=class extends Ae{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===E?void 0:e}},Me=class extends Ae{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==E)}},Ne=class extends Ae{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=De(this,e,t,0)??E)===T)return;let n=this._$AH,r=e===E&&n!==E||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==E&&(n===E||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Pe=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){De(this,e)}},Fe=re.litHtmlPolyfillSupport;Fe?.(Ee,ke),(re.litHtmlVersions??=[]).push(`3.3.3`);var Ie=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new ke(t.insertBefore(ue(),e),e,void 0,n??{})}return i._$AI(e),i},Le=globalThis,Re=class extends b{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Ie(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return T}};Re._$litElement$=!0,Re.finalized=!0,Le.litElementHydrateSupport?.({LitElement:Re});var ze=Le.litElementPolyfillSupport;ze?.({LitElement:Re}),(Le.litElementVersions??=[]).push(`4.2.2`);var Be={attribute:!0,type:String,converter:_,reflect:!1,hasChanged:v},Ve=(e=Be,t,n)=>{let{kind:r,metadata:i}=n,a=globalThis.litPropertyMetadata.get(i);if(a===void 0&&globalThis.litPropertyMetadata.set(i,a=new Map),r===`setter`&&((e=Object.create(e)).wrapped=!0),a.set(n.name,e),r===`accessor`){let{name:r}=n;return{set(n){let i=t.get.call(this);t.set.call(this,n),this.requestUpdate(r,i,e,!0,n)},init(t){return t!==void 0&&this.C(r,void 0,e,t),t}}}if(r===`setter`){let{name:r}=n;return function(n){let i=this[r];t.call(this,n),this.requestUpdate(r,i,e,!0,n)}}throw Error(`Unsupported decorator location: `+r)};function O(e){return(t,n)=>typeof n==`object`?Ve(e,t,n):((e,t,n)=>{let r=t.hasOwnProperty(n);return t.constructor.createProperty(n,e),r?Object.getOwnPropertyDescriptor(t,n):void 0})(e,t,n)}function He(e){return O({...e,state:!0,attribute:!1})}var Ue=new Map;function We(e){Ue.has(e.type)&&console.warn(`Block-Typ "${e.type}" wird ueberschrieben.`),Ue.set(e.type,e)}function Ge(){return Array.from(Ue.values())}var Ke={width:`auto`};function qe(e){return Object.entries(e).map(([e,t])=>`${e.replace(/[A-Z]/g,e=>`-`+e.toLowerCase())}:${t}`).join(`;`)}var Je={spalten:24,spaltePx:40,zeilePx:12,gapPx:8},Ye={rasterX:0,rasterY:0,rasterW:Je.spalten,rasterH:1};function Xe(){return{display:`grid`,gridTemplateColumns:`repeat(${Je.spalten}, 1fr)`,gridAutoRows:`${Je.zeilePx}px`,gap:`${Je.gapPx}px`,alignContent:`start`}}function Ze(){return qe(Xe())}var Qe=`weitereQuellen`,$e={[Qe]:[]},et=`folgtAuswahl`,tt={[et]:[]};function k(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var A=class extends Re{constructor(...e){super(...e),this.editable=!1}static{this.styles=o`
    :host { display: block; }
  ...
  `}static{this.customProperties=[]}get customProperties(){return this.constructor.customProperties}inlineEdit(e,t){if(!this.editable)return;let n=e.currentTarget;if(!n||n.hasAttribute(`data-ff-bound`))return;e.stopPropagation(),e.preventDefault();let r=n.textContent??``,i=Array.from(n.childNodes),a=i.map(e=>e.textContent??``);n.setAttribute(`contenteditable`,`plaintext-only`),n.focus();let o=window.getSelection(),s=document.createRange();s.selectNodeContents(n),o?.removeAllRanges(),o?.addRange(s);let c=!1,l=e=>{if(!c)if(c=!0,n.removeAttribute(`contenteditable`),n.removeEventListener(`blur`,u),n.removeEventListener(`keydown`,d),e){let e=(n.textContent??``).trim();e!==r&&this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:t,value:e},bubbles:!0,composed:!0}))}else n.replaceChildren(...i),i.forEach((e,t)=>{e.textContent!==a[t]&&(e.textContent=a[t])})},u=()=>l(!0),d=e=>{e.key===`Enter`?(e.preventDefault(),n.blur()):e.key===`Escape`&&(e.preventDefault(),l(!1))};n.addEventListener(`blur`,u),n.addEventListener(`keydown`,d)}static defineAndRegister(e){customElements.get(e.tagName)||customElements.define(e.tagName,e),We({type:e.blockType,tagName:e.tagName,displayName:e.displayName,category:e.category,defaultProps:{...Ke,...Ye,...e.acceptsDataSource?$e:null,...e.kannAuswahlFolgen?tt:null,...e.defaultProps},customProperties:e.customProperties,acceptsChildren:e.acceptsChildren??!1,resizableWidth:e.resizableWidth??!0,resizableHeight:e.resizableHeight??!1,allowedChildTypes:e.allowedChildTypes,allowedParentTypes:e.allowedParentTypes,lockedWidth:e.lockedWidth,defaultChildren:e.defaultChildren,childDirection:e.childDirection,showInPalette:e.showInPalette,templateChild:e.templateChild,containerHint:e.containerHint,addChildButton:e.addChildButton,acceptsDataSource:e.acceptsDataSource,satzWahl:e.satzWahl,kannAuswahlFolgen:e.kannAuswahlFolgen,bindableSpots:e.bindableSpots,actionValueSpots:e.actionValueSpots,listenBindung:e.listenBindung,blockEvents:e.blockEvents,pageBlock:e.pageBlock,flaechenSeite:e.flaechenSeite,maskenRand:e.maskenRand,raster:e.raster})}};k([O({type:Boolean,reflect:!0,attribute:`data-editable`})],A.prototype,`editable`,void 0);var nt=`root`,rt=class extends A{static{this.blockType=`ansicht`}static{this.tagName=`ff-ansicht`}static{this.displayName=`Ansicht`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.showInPalette=!1}static{this.allowedParentTypes=[nt]}static{this.pageBlock=!0}static{this.flaechenSeite=!0}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.defaultProps={name:`Ansicht`}}static{this.styles=[A.styles,o`
    ...
    `]}render(){return w`<div class="flaeche">
      ${this.quelle===``?w`<div class="platzhalter">Bild</div>`:w`<img src=${this.quelle} alt="">`}
    </div>`}};k([O()],it.prototype,`quelle`,void 0),A.defineAndRegister(it);var at=`data-ff-block-id`,ot=[`fixed`,`context`,`data_field`,`block_value`,`gewaehlte_zeile`,`previous_result`,`step_result`,`se_variable`,`aus`];function st(e){return!!e&&typeof e==`object`&&!Array.isArray(e)}function ct(e){return!st(e)||typeof e.source!=`string`||!ot.includes(e.source)||typeof e.value!=`string`||e.dataSourceId!==void 0&&typeof e.dataSourceId!=`string`||e.blockId!==void 0&&typeof e.blockId!=`string`||e.ergebnisFeld!==void 0&&typeof e.ergebnisFeld!=`string`?null:{source:e.source,value:e.value,...typeof e.dataSourceId==`string`?{dataSourceId:e.dataSourceId}:{},...typeof e.blockId==`string`?{blockId:e.blockId}:{},...e.source===`step_result`&&typeof e.ergebnisFeld==`string`?{ergebnisFeld:e.ergebnisFeld}:{}}}function lt(e){if(!st(e)||typeof e.type!=`string`||typeof e.resultKey!=`string`)return null;if(e.type===`START_TOOL`)return typeof e.toolNr!=`string`||!Array.isArray(e.toolParams)||e.toolParams.some(e=>typeof e!=`string`)?null:{type:`START_TOOL`,resultKey:e.resultKey,toolNr:e.toolNr,toolParams:[...e.toolParams]};if(e.type===`POPUP_OPEN`||e.type===`POPUP_CLOSE`){let t=typeof e.popupId==`string`?e.popupId:void 0,n=typeof e.popup==`string`?e.popup:void 0;return t===void 0&&n===void 0?null:{type:e.type,resultKey:e.resultKey,...t===void 0?{}:{popupId:t},...n===void 0?{}:{popup:n}}}if(e.type===`RELATION`){if(typeof e.relationId!=`string`||!Array.isArray(e.extraParams)||!Array.isArray(e.params)&&!st(e.bindings))return null;let t=[];if(Array.isArray(e.params))for(let n of e.params){let e=ct(n);if(!e)return null;t.push(e)}let n=[];for(let t of e.extraParams){let e=ct(t);if(!e)return null;n.push(e)}return{type:`RELATION`,resultKey:e.resultKey,relationId:e.relationId,params:t,extraParams:n}}return null}function ut(e){if(!e)return{};let t;try{t=JSON.parse(e)}catch{return{}}if(!st(t))return{};let n={};for(let[e,r]of Object.entries(t)){if(!Array.isArray(r)||r.length===0)continue;let t=[],i=!1;for(let e of r){let n=lt(e);if(!n){i=!0;break}t.push(n)}!i&&t.length>0&&(n[e]=t)}return n}Object.values({idb:{id:`idb`,name:`IDB-Tabelle`,tabellenId:``,felderEinzeln:!1,kennungLabel:`Kennung`,kennungBeispiel:`ID0001`,kopfsatzMoeglich:!1,kopfsatzStandard:``,relationLadenMoeglich:!1,varMoeglich:!1,standardFelder:[]},adressstamm:{id:`adressstamm`,name:`Adressstamm`,tabellenId:`ADR`,felderEinzeln:!0,kennungLabel:``,kennungBeispiel:``,kopfsatzMoeglich:!1,kopfsatzStandard:``,relationLadenMoeglich:!1,varMoeglich:!0,standardFelder:[]},artikelstamm:{id:`artikelstamm`,name:`Artikelstamm`,tabellenId:`ART`,felderEinzeln:!0,kennungLabel:``,kennungBeispiel:``,kopfsatzMoeglich:!1,kopfsatzStandard:``,relationLadenMoeglich:!1,varMoeglich:!1,standardFelder:[]},beleg:{id:`beleg`,name:`Beleg`,tabellenId:`BEL`,felderEinzeln:!0,kennungLabel:``,kennungBeispiel:``,kopfsatzMoeglich:!1,kopfsatzStandard:``,relationLadenMoeglich:!1,varMoeglich:!0,standardFelder:[{code:`0_11`,label:`Satzschlüssel`},{code:`2_1`,label:`Belegart`},{code:`3_8`,label:`Belegnummer`},{code:`11_8`,label:`Kundennummer`},{code:`19_10`,label:`Belegdatum`},{code:`393_12`,label:`Warenwert`},{code:`441_12`,label:`MwSt-Betrag`},{code:`453_12`,label:`Gesamtbetrag`},{code:`3440_60`,label:`Name`}]},belegposition:{id:`belegposition`,name:`Belegpositionen`,tabellenId:`POS`,felderEinzeln:!0,kennungLabel:``,kennungBeispiel:``,kopfsatzMoeglich:!0,kopfsatzStandard:`BEL_0_11`,relationLadenMoeglich:!0,varMoeglich:!0,standardFelder:[{code:`2_1`,label:`Belegart`},{code:`3_8`,label:`Belegnummer`},{code:`11_6`,label:`Positionsnummer`},{code:`17_1`,label:`Zeilenart`},{code:`18_25`,label:`Artikelnummer`},{code:`45_60`,label:`Bezeichnung`},{code:`164_8`,label:`Menge`},{code:`246_9`,label:`Einzelpreis`},{code:`280_12`,label:`Gesamtpreis`},{code:`372_5`,label:`MwSt-Satz`},{code:`645_10`,label:`Satznummer`},{code:`689_5`,label:`Mengeneinheit`},{code:`1401_12`,label:`Rohertrag`},{code:`2558_1`,label:`Farbkennzeichen`},{code:`3164_12`,label:`Rabatt`}]},datei:{id:`datei`,name:`Andere Datei`,tabellenId:``,felderEinzeln:!0,kennungLabel:`Kennung`,kennungBeispiel:`SERPOS`,kopfsatzMoeglich:!0,kopfsatzStandard:``,relationLadenMoeglich:!1,varMoeglich:!1,standardFelder:[]}}).map(e=>e.id);var j=/^\d+_\d+$/,dt=/^\d+$/;function ft(e){if(!e||typeof e!=`object`)return null;let t=e,n=e=>typeof e==`string`?e.trim():``,r=n(t.nr),i=n(t.geberQuelleId),a=n(t.belegartFeld),o=n(t.belegnummerFeld),s=n(t.jahrFeld),c=n(t.archivFeld),l=Array.isArray(t.endeFelder)?t.endeFelder.filter(e=>typeof e==`string`&&j.test(e)):[];return!dt.test(r)||i===``||!j.test(a)||!j.test(o)||s!==``&&!j.test(s)||c!==``&&!j.test(c)||l.length===0?null:{nr:r,geberQuelleId:i,belegartFeld:a,belegnummerFeld:o,jahrFeld:s,archivFeld:c,endeFelder:l}}var pt=new Map;function mt(e,t){e!==``&&pt.set(e,t)}function ht(e){return pt.get(e)}function M(e){return typeof e==`object`&&!!e}function N(e,t){if(!(!Array.isArray(e)||t===``))for(let n of e){if(!M(n)||n.id!==t||typeof n.name!=`string`||typeof n.tableId!=`string`)continue;let e,r=ft(n.ladeRelation);if(r&&M(n.ladeRelation)){let t=n.ladeRelation.zusatzFelder,i=Array.isArray(t)?t.filter(e=>typeof e==`string`&&j.test(e)):[];e={...r,zusatzFelder:i}}return{id:t,name:n.name,tableId:n.tableId,indexField:typeof n.indexField==`string`?n.indexField:``,...e?{ladeRelation:e}:{}}}}function gt(e){return e==null?``:String(e).trim()}function P(e,t){if(!M(e)||t===``)return``;let n=t.trim(),r=gt(e[n]);if(r!==``)return r;for(let t of Object.keys(e))if(t===n||t.startsWith(`${n}_`)||t.endsWith(`_${n}`)){let n=gt(e[t]);if(n!==``)return n}let i=/^(\d+)_(\d+)$/.exec(n);if(!i)return``;let a=e.SATZNEU??e.SATZ??e.satzneu??e.satz??e.RAW??e.raw,o=a==null?``:String(a);if(o===``)return``;let s=Number(i[1]),c=Number(i[2]);return c<=0?``:o.substring(s,s+c).trim()}function _t(e,t,n){if(!M(e)||t===``)return!1;let r=t.trim(),i=!1;for(let t of Object.keys(e))(t===r||t.startsWith(`${r}_`)||t.endsWith(`_${r}`))&&(e[t]=n,i=!0);let a=/^(\d+)_(\d+)$/.exec(r);if(a){let t=[`SATZNEU`,`SATZ`,`satzneu`,`satz`,`RAW`,`raw`].find(t=>typeof e[t]==`string`);if(t){let r=e[t],o=Number(a[1]),s=Number(a[2]);if(s>0){let a=n.length>s?n.slice(0,s):n.padEnd(s,` `),c=r.length<o?r.padEnd(o,` `):r;e[t]=c.slice(0,o)+a+c.slice(o+s),i=!0}}}return i}function vt(e){if(!M(e))return Array.isArray(e)?e:[];let t=[e.Zeilen,e.zeilen,e.Saetze,e.saetze,e.Rows,e.rows,e.Daten,e.daten];for(let e of t){if(Array.isArray(e))return e;if(typeof e==`string`)try{let t=JSON.parse(e);if(Array.isArray(t))return t}catch{}}return[]}function F(e,t){return gt(e).toLowerCase()===t.trim().toLowerCase()}function I(e,t,n){if(!M(e)||!M(e.Daten))return[];let r=e.Daten,i=r.SEFileLoop;if(Array.isArray(i)){for(let e of i)if(M(e)&&(F(e.ALIAS,t)||F(e.alias,t))){let t=vt(e);if(t.length>0)return t}}else if(M(i))for(let e of Object.keys(i)){let n=i[e];if(F(e,t)||M(n)&&(F(n.ALIAS,t)||F(n.alias,t))){let e=vt(n);if(e.length>0)return e}}let a=r.Tabellen;if(M(a)){let e=[t,t.toUpperCase(),t.toLowerCase(),n];for(let t of e)if(t!==``&&t in a){let e=vt(a[t]);if(e.length>0)return e}for(let e of Object.keys(a))if(F(e,t)){let t=vt(a[e]);if(t.length>0)return t}}return ht(t)??[]}function yt(e){let t=e;if(typeof t==`string`)try{t=JSON.parse(t)}catch{return}if(!M(t)||!M(t.Daten))return;let n=t.Daten;if(!(!n.SEFileLoop&&!n.Tabellen&&!n.ErpApiCall))return n}function bt(e){let t=e;if(typeof t==`string`)try{t=JSON.parse(t)}catch{return}if(!(!M(t)||!M(t.MSG)))return t.MSG.DATA}function xt(e){if(e==null)return``;try{return JSON.stringify(e)??``}catch{return``}}var L=new Map,St=new Set,Ct=!1,wt=!1;function Tt(){if(Ct){wt=!0;return}Ct=!0;try{do wt=!1,St.forEach(e=>e());while(wt)}finally{Ct=!1}}function Et(e){St.add(e)}function Dt(e){return L.get(e)?.zeile}function Ot(e){return L.get(e)?.merkmal??``}function R(e){return e.getAttribute(`data-ff-id`)??``}function kt(e,t,n){if(e===``)return[];let r=Ot(e);if(r===``)return[];let i=[];return t.forEach((e,t)=>{xt(n(e))===r&&i.push(t)}),i.length===0&&Mt(e),i}function At(e,t){if(e===``)return;let n=xt(t);if(n===``)return;let r=L.get(e);r&&r.merkmal===n?L.delete(e):L.set(e,{zeile:t,merkmal:n}),Tt()}function jt(e,t){if(e===``)return;let n=xt(t);n!==``&&L.get(e)?.merkmal!==n&&(L.set(e,{zeile:t,merkmal:n}),Tt())}function Mt(e){L.has(e)&&(L.delete(e),Tt())}var Nt=et.toLowerCase();function Pt(e){let t=e.getAttribute(Nt)??``;if(t===``)return[];try{let e=JSON.parse(t);if(!Array.isArray(e))return[];let n=[];for(let t of e){if(!t||typeof t!=`object`)continue;let e=t;if(typeof e.geberId!=`string`||e.geberId===``)continue;let r=[];for(let t of Array.isArray(e.keyPairs)?e.keyPairs:[]){if(!t||typeof t!=`object`)continue;let e=t;typeof e.fromField!=`string`||typeof e.toField!=`string`||e.fromField.trim()===``||e.toField.trim()===``||r.push({fromField:e.fromField,toField:e.toField})}r.length!==0&&n.push({geberId:e.geberId,keyPairs:r})}return n}catch{return[]}}function Ft(e,t){let n=t,r=!1;for(let t of Pt(e)){let e=Dt(t.geberId);e!==void 0&&(r=!0,n=n.filter(n=>t.keyPairs.every(t=>{let r=P(e,t.fromField);return r!==``&&r===P(n,t.toField)})))}return{rows:n,gefiltert:r}}function It(e,t){if(Pt(e).length===0)return t[0];let{rows:n,gefiltert:r}=Ft(e,t);return r?n[0]:void 0}var Lt=`ff-dialog-rahmen`,Rt=`ff-dialog-schliessen`;function zt(e,t){let n=Number(e);return Number.isFinite(n)&&n>0?n:t}var z=class extends Re{constructor(...e){super(...e),this.titel=`Dialog`,this.breite=520,this.hoehe=380,this.viewport=!1,this.mitWerkzeug=!1,this.escapeSchliesst=!1,this.ohneModal=!1,this.inhaltFest=!1,this.escapeRegistriert=!1,this.aufTaste=e=>{e.key===`Escape`&&(e.stopPropagation(),this.schliesse())}}static{this.styles=o`
    :host {
      position: absolute;
      inset: 0;
      display: block;
  ...
  `}aktualisiereEscape(){let e=this.isConnected&&this.escapeSchliesst;e!==this.escapeRegistriert&&(e?document.addEventListener(`keydown`,this.aufTaste,!0):document.removeEventListener(`keydown`,this.aufTaste,!0),this.escapeRegistriert=e)}schliesse(){this.dispatchEvent(new CustomEvent(Rt,{bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this.aktualisiereEscape()}updated(e){e.has(`escapeSchliesst`)&&this.aktualisiereEscape()}disconnectedCallback(){this.escapeRegistriert&&=(document.removeEventListener(`keydown`,this.aufTaste,!0),!1),super.disconnectedCallback()}render(){let e=zt(this.breite,520),t=zt(this.hoehe,380);return w`
      <div class="abdunklung"></div>
      <div class="buehne">
        <section
          class="fenster"
          role="dialog"
          aria-modal=${this.ohneModal?E:`true`}
    ...
    `}};k([O()],z.prototype,`titel`,void 0),k([O({type:Number})],z.prototype,`breite`,void 0),k([O({type:Number})],z.prototype,`hoehe`,void 0),k([O({type:Boolean,reflect:!0})],z.prototype,`viewport`,void 0),k([O({type:Boolean,reflect:!0,attribute:`mit-werkzeug`})],z.prototype,`mitWerkzeug`,void 0),k([O({type:Boolean,attribute:`escape-schliesst`})],z.prototype,`escapeSchliesst`,void 0),k([O({type:Boolean,attribute:`ohne-modal`})],z.prototype,`ohneModal`,void 0),k([O({type:Boolean,reflect:!0,attribute:`inhalt-fest`})],z.prototype,`inhaltFest`,void 0),customElements.get(`ff-dialog-rahmen`)||customElements.define(Lt,z);var Bt=`input,select,textarea,button,a[href],[tabindex]:not([tabindex="-1"])`;function Vt(e){for(let t of Array.from(e.querySelectorAll(`*`))){if(t instanceof HTMLElement&&t.matches(Bt)&&!t.hasAttribute(`disabled`))return t;let e=t.shadowRoot?Vt(t.shadowRoot):null;if(e)return e}return null}var B=class extends A{constructor(...e){super(...e),this.name=`Popup`,this.breite=520,this.hoehe=380,this.offen=!1}static{this.blockType=`popup`}static{this.tagName=`ff-popup`}static{this.displayName=`Popup`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.showInPalette=!1}static{this.allowedParentTypes=[nt]}static{this.pageBlock=!0}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.defaultProps={name:`Popup`,breite:520,hoehe:380}}static{this.styles=[A.styles,o`
    ...
    `]}onClose(){this.hasAttribute(`data-ff-editor`)||this.removeAttribute(`offen`)}updated(e){super.updated(e),!(!e.has(`offen`)||!this.offen)&&(this.hasAttribute(`data-ff-editor`)||this.updateComplete.then(()=>{!this.offen||!this.isConnected||(Vt(this)??(this.shadowRoot?Vt(this.shadowRoot):null))?.focus()}))}render(){return w`<ff-dialog-rahmen
        .breite=${this.breite}
        .hoehe=${this.hoehe}
        ohne-modal
        inhalt-fest
      ...
      </ff-dialog-rahmen>`}};k([O()],B.prototype,`name`,void 0),k([O()],B.prototype,`breite`,void 0),k([O()],B.prototype,`hoehe`,void 0),k([O({type:Boolean,reflect:!0})],B.prototype,`offen`,void 0),A.defineAndRegister(B);var Ht=[`GET_RELATION`,`PUT_RELATION`,`PUTADD_RELATION`];function Ut(e){return`${String(e.getDate()).padStart(2,`0`)}.${String(e.getMonth()+1).padStart(2,`0`)}.${e.getFullYear()}`}function Wt(e,t){return e.params.map(e=>e.replace(/\{([A-Za-z0-9_]+)\}/g,(e,n)=>String(t[n]??``)))}var Gt=8e3,V=null,Kt=null;function qt(){let e=document.createElement(`div`);return e.setAttribute(`data-ff-meldung`,``),e.setAttribute(`role`,`alert`),e.style.cssText=[`position:fixed`,`top:0`,`left:0`,`right:0`,`z-index:2147483647`,`padding:7px 12px`,`background:var(--se-red-soft,#fbe7e6)`,`color:var(--se-red,#c0201a)`,`border-bottom:1px solid var(--se-red,#c0201a)`,`font:500 12px/1.4 system-ui,sans-serif`,`cursor:pointer`].join(`;`),e.title=`Klicken zum Schließen`,e.addEventListener(`click`,Jt),e}function Jt(){Kt&&=(clearTimeout(Kt),null),V?.remove(),V=null}function H(e){typeof document>`u`||!document.body||(V||(V=qt(),document.body.appendChild(V)),V.textContent=e,Kt&&clearTimeout(Kt),Kt=setTimeout(Jt,Gt))}function U(){return globalThis}function Yt(){let e=U();return M(e.SEDATA)&&M(e.SEDATA.Daten)}function Xt(){let e=U();try{e.selib?.Json?.InitializeERPConnection?.()}catch{}try{typeof e.InitialisiereSchnittstelle==`function`&&e.InitialisiereSchnittstelle()}catch{}}function Zt(){let e=U();try{typeof e.ResetDataBasis==`function`&&e.ResetDataBasis()}catch{}try{typeof e.InitialisiereDatenBasis==`function`&&e.InitialisiereDatenBasis()}catch{}}var Qt=new Set,$t=new Set;function en(e){Qt.add(e)}function tn(e){return $t.add(e),()=>{$t.delete(e)}}function nn(){Qt.forEach(e=>e())}function rn(){nn()}function an(e){$t.forEach(t=>{try{t(e)}catch{}})}var W=new Map,on=``,sn=0;function cn(){try{let e=document.getElementById(`ff-se-diagnose`);return!e&&document.body&&(e=document.createElement(`textarea`),e.id=`ff-se-diagnose`,e.readOnly=!0,e.style.cssText=`display:none;position:fixed;left:8px;right:8px;bottom:8px;height:40vh;z-index:99999;font:11px monospace;`,document.body.appendChild(e)),e}catch{return null}}function ln(){let e=cn();e&&(e.value=Array.from(W,([e,t])=>`${e}: ${t}`).join(`
`)+(on===``?``:`\n\nERSTES PAKET\n${on}`))}function G(e,t){W.set(e,t),ln()}function un(){let e=U();W.set(`basisHTML_REGISTER`,typeof e.basisHTML_REGISTER==`function`?`vorhanden`:`fehlt`),W.set(`basisHTML_SND_MSG`,typeof e.basisHTML_SND_MSG==`function`?`vorhanden`:`fehlt`),W.set(`body.pid`,document.body?.getAttribute(`pid`)?`gesetzt`:`fehlt`),W.set(`body.REGMSG`,document.body?.getAttribute(`REGMSG`)?`gesetzt`:`fehlt`),W.set(`Empfangene Pakete`,String(sn)),W.set(`SEDATA.Daten`,Yt()?`vorhanden`:`fehlt`),ln()}function dn(e){if(on===``)try{on=typeof e==`string`?e:JSON.stringify(e)??``,ln()}catch{}}function fn(e){sn+=1,dn(e),G(`Empfangene Pakete`,String(sn));let t=yt(e);if(!t){G(`Letztes Paket`,`Antwort ohne Daten`),an(e);return}let n=U();M(n.SEDATA)||(n.SEDATA={}),n.SEDATA.Daten=t,G(`Letztes Paket`,`Daten-Push angenommen`),G(`SEDATA.Daten`,`vorhanden`),Zt(),nn()}function pn(e=0){let t=U();if(typeof t.basisHTML_REGISTER==`function`){un();try{t.basisHTML_SetConsoleLog?.(!0,!0)}catch{}try{t.basisHTML_REGISTER(e=>{fn(e)},document.title,`1.0`),G(`Registrierung`,`ausgeführt`)}catch(e){G(`Registrierung`,`Fehler: ${e instanceof Error?e.message:String(e)}`)}return}e<400?(e===0&&G(`Registrierung`,`wartet auf Interface`),setTimeout(()=>{pn(e+1)},25)):(un(),G(`Registrierung`,`nach 10s kein Interface`),H(`SoftEngine-Anschluss nicht gefunden — die Maske bleibt ohne Daten (Strg+Alt+D für Details).`))}var mn=!1;function hn(){if(mn)return;mn=!0,G(`Runtime`,`gestartet`),G(`Registrierung`,`noch nicht ausgeführt`),un(),Xt();let e=U();e.Erstellen=()=>{Zt(),nn()},e.initData=e.Erstellen,e.ReloadData=()=>{nn()},pn(),window.addEventListener(`message`,e=>{if(typeof U().basisHTML_REGISTER==`function`)return;let t=bt(e.data);t!==void 0&&fn(t)},!0),document.addEventListener(`keydown`,e=>{if(e.ctrlKey&&e.altKey&&e.key.toLowerCase()===`d`){un();let e=document.getElementById(`ff-se-diagnose`);e&&(e.style.display=e.style.display===`none`?`block`:`none`)}});let t=0,n=setInterval(()=>{t+=1,Yt()?(clearInterval(n),G(`SEDATA.Daten`,`vorhanden`),Zt(),nn()):t>100&&(clearInterval(n),G(`Daten-Wartezeit`,`nach 30s ohne Daten`),H(`Keine Daten von SoftEngine empfangen — die Maske zeigt nichts an (Strg+Alt+D für Details).`))},300)}function gn(e){return e instanceof Error?e.message:String(e)}function _n(e,t){if(!(!Array.isArray(e)||t===``)){for(let n of e)if(!(!M(n)||n.id!==t)&&!(typeof n.verb!=`string`||!Ht.includes(n.verb))&&!(typeof n.nr!=`string`||n.nr===``)&&!(!Array.isArray(n.params)||n.params.some(e=>typeof e!=`string`)))return{id:t,verb:n.verb,nr:n.nr,params:n.params}}}var vn=[`RESULT`,`result`,`PINDEX`,`pindex`,`INDEX`,`index`,`0_10`,`KEY`,`key`,`ID`,`id`,`VALUE`,`value`];function yn(e){if(typeof e!=`string`)return e;try{return JSON.parse(e)}catch{return}}function bn(e){if(typeof e==`string`){let t=e.trim();return t===``?void 0:t}if(typeof e==`number`||typeof e==`boolean`)return String(e)}function xn(e,t){if(t>12)return;let n=bn(e);if(n!==void 0)return n;if(Array.isArray(e)){for(let n of e){let e=xn(n,t+1);if(e!==void 0)return e}return}if(M(e)){for(let n of vn){if(!(n in e))continue;let r=xn(e[n],t+1);if(r!==void 0)return r}for(let n of Object.values(e)){let e=xn(n,t+1);if(e!==void 0)return e}}}function Sn(e){let t=yn(e);if(M(t)){for(let e of vn){if(!(e in t))continue;let n=xn(t[e],0);if(n!==void 0)return n}for(let e of Object.values(t))if(Array.isArray(e))for(let t of e){let e=Sn(t);if(e!==void 0)return e}else if(M(e)){let t=Sn(e);if(t!==void 0)return t}}}var Cn=[`RESULT`,`result`];function wn(e,t=0){if(t>12)return;let n=typeof e==`string`?yn(e):e;if(Array.isArray(n)){for(let e of n){let n=wn(e,t+1);if(n!==void 0)return n}return}if(M(n)){for(let e of Cn){let t=n[e];if(typeof t==`string`)return t;if(typeof t==`number`||typeof t==`boolean`)return String(t)}for(let e of Object.values(n)){let n=wn(e,t+1);if(n!==void 0)return n}}}function Tn(e,t,n=0){if(t.trim()===``||n>12)return``;let r=typeof e==`string`?yn(e):e;if(Array.isArray(r)){for(let e of r){let r=Tn(e,t,n+1);if(r!==``)return r}return``}if(!M(r))return``;let i=P(r,t);if(i!==``)return i;for(let e of Object.values(r)){let r=Tn(e,t,n+1);if(r!==``)return r}return``}function En(e){return M(e)?Object.keys(e).filter(e=>/^Message\d+$/.test(e)):[]}function Dn(e,t,n=!1){if(!M(e))return;let r=En(e).filter(e=>!t.has(e)).sort((e,t)=>Number(t.slice(7))-Number(e.slice(7)));for(let t of r){let r=n?wn(e[t]):Sn(e[t]);if(r!==void 0)return{wert:r,roh:e[t]}}}var On=[],kn=!1,An=6e3,jn=100;function Mn(){if(kn||On.length===0)return;kn=!0;let e=On.shift(),t=U(),n=new Set(En(t.SEDATA)),r=!1,i=(t,n)=>{r||(r=!0,o(),clearInterval(s),clearTimeout(c),kn=!1,e.resolve({wert:t,roh:n}),queueMicrotask(Mn))},a=e.optionen.satzAntwort===!0,o=tn(e=>{let t=a?wn(e):Sn(e);t!==void 0&&i(t,e)}),s=setInterval(()=>{let e=Dn(U().SEDATA,n,a);e!==void 0&&i(e.wert,e.roh)},jn),c=setTimeout(()=>{e.optionen.still||H(`Daten laden: SoftEngine hat nicht geantwortet (Relation Nr. ${e.template.nr}).`),i(``,void 0)},An);if(typeof t.basisHTML_SND_MSG!=`function`){e.optionen.still||H(`Daten laden nicht möglich: keine Verbindung zu SoftEngine.`),i(``,void 0);return}try{t.basisHTML_SND_MSG(`GET_RELATION`,{NR:e.template.nr,PARAMS:e.params})}catch(t){e.optionen.still||H(`Daten laden fehlgeschlagen (Relation Nr. ${e.template.nr}): ${gn(t)}`),i(``,void 0)}}function Nn(e,t,n={}){hn();let r=U();if(e.verb!==`GET_RELATION`){if(typeof r.basisHTML_SND_MSG!=`function`)return H(`Speichern nicht möglich: keine Verbindung zu SoftEngine. Die Eingabe wurde NICHT übernommen.`),Promise.resolve({wert:``,roh:void 0});try{r.basisHTML_SND_MSG(e.verb,{NR:e.nr,PARAMS:[...t]})}catch(t){H(`Speichern fehlgeschlagen (Relation Nr. ${e.nr}): ${gn(t)}`)}return Promise.resolve({wert:``,roh:void 0})}return new Promise(r=>{On.push({template:e,params:[...t],resolve:r,optionen:n}),Mn()})}function Pn(e,t){if(!M(t))return``;let n=t.document;if(!n||typeof n.querySelectorAll!=`function`)return``;let r=Array.from(n.querySelectorAll(`[${at}]`)).find(t=>t.getAttribute(at)===e.blockId);if(!r)return``;let i=r[e.value];return i==null?``:String(i)}function Fn(e,t,n=U()){if(e.source===`aus`)return``;if(e.source===`fixed`)return e.value;if(e.source===`context`)return t.context[e.value]??``;if(e.source===`previous_result`)return t.previousResult;if(e.source===`step_result`){let n=Number(e.value);if(!Number.isInteger(n)||n<0)return``;let r=e.ergebnisFeld??``;return r===``?t.stepResults?.[n]??``:Tn(t.stepRohErgebnisse?.[n],r)}if(e.source===`block_value`)return Pn(e,n);if(e.source===`gewaehlte_zeile`){let n=t.gewaehlteZeile?.(e.blockId??``);return n===void 0?``:P(n,e.value)}if(!M(n))return``;if(e.source===`se_variable`){let t=n.SEDATA;if(!M(t)||!M(t.Daten)||!M(t.Daten.VARArrays))return``;let r=t.Daten.VARArrays[e.value];return r==null?``:String(r)}let r=N(n.FF_DATA_SOURCES,e.dataSourceId??``);if(!r)return``;let i=I(n.SEDATA,r.name,r.tableId),a=t.context.PINDEX??``,o=a!==``&&r.indexField!==``?i.find(e=>P(e,r.indexField)===a):i[0];return o?P(o,e.value):``}function In(e,t){let n=`0,START_TOOL,`+e;return t.length>0&&(n+=`,`+t.map(e=>encodeURIComponent(e)).join(`,`)),n}function Ln(e,t){if(e.trim()===``)return;let n=U();try{if(typeof n.sendBWLinkIntern==`function`){n.sendBWLinkIntern(In(e,t));return}}catch{}try{if(typeof n.basisHTML_SND_MSG==`function`){let r={NR:e};t.length>0&&(r.PARAMS=[...t]),n.basisHTML_SND_MSG(`START_TOOL`,r)}}catch{}}function Rn(e,t,n){if(t.trim()===``)return;let r=Array.from(e.querySelectorAll(B.tagName)),i=r.filter(e=>(e.getAttribute(`name`)??B.defaultProps.name)===t);if(i.length!==1)return;let a=i[0];if(!n){a.removeAttribute(`offen`);return}for(let e of r)e!==a&&e.removeAttribute(`offen`);a.setAttribute(`offen`,``)}var zn=new WeakMap;function Bn(e){H(`Aktionskette fehlgeschlagen: `+(e instanceof Error?e.message:String(e)))}async function Vn(e,t,n){if(e.hasAttribute(`data-ff-editor`))return;let r=ut(e.getAttribute(`data-ff-aktionen`))[t];if(!r||r.length===0)return;let i=zn.get(e);if(i||(i=new Set,zn.set(e,i)),!i.has(t)){i.add(t);try{let t={...n,NOW_DATE:Ut(new Date)},i=``,a=[],o=[],s=()=>{a.push(``),o.push(void 0)};for(let n of r){if(n.type===`START_TOOL`){Ln(n.toolNr,Wt({params:n.toolParams},t)),s();continue}if(n.type===`POPUP_OPEN`||n.type===`POPUP_CLOSE`){Rn(e.ownerDocument??document,n.popup??``,n.type===`POPUP_OPEN`),s();continue}let r=_n(U().FF_RELATIONS,n.relationId);if(!r){s();continue}let c={context:t,previousResult:i,stepResults:a,stepRohErgebnisse:o,gewaehlteZeile:Dt},l=await Nn(r,[...n.params,...n.extraParams].map(e=>Fn(e,c))),u=l.wert;a.push(u),o.push(l.roh),r.verb===`GET_RELATION`&&(i=u),n.resultKey!==``&&(t[n.resultKey]=u)}}finally{i.delete(t)}}}var Hn=new WeakSet;function Un(e,t){if(e.hasAttribute(`data-ff-editor`)||!e.hasAttribute(`data-ff-aktionen`)||Hn.has(e))return;Hn.add(e);let n=ut(e.getAttribute(`data-ff-aktionen`));Object.values(n).some(e=>e.some(e=>e.type===`RELATION`))&&hn(),e.addEventListener(`click`,()=>{Vn(e,t,{}).catch(Bn)})}var Wn=class extends A{constructor(...e){super(...e),this.label=`Klick mich`}static{this.blockType=`button`}static{this.tagName=`ff-button`}static{this.displayName=`Schaltfläche`}static{this.category=`eingabe`}static{this.defaultProps={label:`Klick mich`}}static{this.resizableWidth=!1}static{this.blockEvents=[{key:`onClick`,name:`Klick`}]}static{this.raster={startW:4,startH:2,minW:2,minH:2}}static{this.customProperties=[]}static{this.styles=[A.styles,o`
      button {
        box-sizing: border-box;
        padding: 7px 16px;
        cursor: pointer;
    ...
    >${this.label}</button>`}connectedCallback(){super.connectedCallback(),Un(this,`onClick`)}};k([O()],Wn.prototype,`label`,void 0),A.defineAndRegister(Wn);var Gn=[`info`,`success`,`warning`,`danger`];function Kn(e){return Gn.includes(e)?e:`info`}var qn=[{wert:`info`,name:`Hinweis`},{wert:`success`,name:`Erfolg`},{wert:`warning`,name:`Warnung`},{wert:`danger`,name:`Fehler`}];function Jn(e,t){return{attributeName:e,name:`Bedeutung`,description:t,kind:`select`,options:qn.map(e=>({value:e.wert,label:e.name}))}}var Yn=o`
...
`,K=class extends A{constructor(...e){super(...e),this.chipVariant=`info`,this.heading=``,this.heading2=``,this.time=``,this.date=``,this.avatar=``,this.meta=``,this.text=``,this.chipText=``,this.headingField=``,this.heading2Field=``,this.timeField=``,this.dateField=``,this.avatarField=``,this.metaField=``,this.textField=``,this.chipTextField=``}static{this.blockType=`card`}static{this.tagName=`ff-card`}static{this.displayName=`Karte`}static{this.category=`anzeige`}static{this.allowedParentTypes=[`kanban-spalte`,`kanban-zimmer`]}static{this.showInPalette=!1}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={chipVariant:`info`,heading:``,heading2:``,time:``,date:``,avatar:``,meta:``,text:``,chipText:``,headingField:``,heading2Field:``,timeField:``,dateField:``,avatarField:``,metaField:``,textField:``,chipTextField:``}}static{this.bindableSpots=[{prop:`time`,label:`Zeit`},{prop:`date`,label:`Datum`},{prop:`avatar`,label:`Avatar`},{prop:`heading`,label:`Titel`},{prop:`heading2`,label:`Titel 2`},{prop:`meta`,label:`Unterzeile`},{prop:`text`,label:`Textzeile`},{prop:`chipText`,label:`Chip`}]}static{this.customProperties=[Jn(`chipVariant`,`Bedeutung des Chips auf der Karte — bestimmt die Chip-Farbe.`)]}static{this.styles=[A.styles,Yn,rr]}stelle(e,t){return w`<span
    ...
    >${this[e]}</span>`}hatReiter(){return this.hasAttribute(`data-ff-editor`)||this.date.trim()!==``||this.time.trim()!==``}updated(e){super.updated(e),this.toggleAttribute(`hat-reiter`,this.hatReiter())}render(){let e=Kn(this.chipVariant),t=this.hasAttribute(`data-ff-editor`),n=e=>t||e.trim()!==``,r=this.hatReiter(),i=n(this.avatar)||n(this.heading)||n(this.meta),a=n(this.heading2)||n(this.chipText);return w`<div class="card v-${e}${r?``:` ohne-reiter`}">
      ...
      ${i?w`<div class="kopf">
            ${n(this.avatar)?w`<span
                ...
                >${this.avatar.trim()===``?E:nr(this.avatar)}</span>`:E}
            <div class="namen">
    ...
    </div>`}};k([O()],K.prototype,`chipVariant`,void 0),k([O()],K.prototype,`heading`,void 0),k([O()],K.prototype,`heading2`,void 0),k([O()],K.prototype,`time`,void 0),k([O()],K.prototype,`date`,void 0),k([O()],K.prototype,`avatar`,void 0),k([O()],K.prototype,`meta`,void 0),k([O()],K.prototype,`text`,void 0),k([O()],K.prototype,`chipText`,void 0),k([O()],K.prototype,`headingField`,void 0),k([O()],K.prototype,`heading2Field`,void 0),k([O()],K.prototype,`timeField`,void 0),k([O()],K.prototype,`dateField`,void 0),k([O()],K.prototype,`avatarField`,void 0),k([O()],K.prototype,`metaField`,void 0),k([O()],K.prototype,`textField`,void 0),k([O()],K.prototype,`chipTextField`,void 0),A.defineAndRegister(K);function ir(e){let t=String(e??``).trim();if(t===``)return``;let n=/^(\d{1,2})\.(\d{1,2})\.(\d{4})/.exec(t);if(n)return`${n[3]}-${n[2].padStart(2,`0`)}-${n[1].padStart(2,`0`)}`;let r=/^(\d{4})-(\d{2})-(\d{2})/.exec(t);return r?`${r[1]}-${r[2]}-${r[3]}`:``}function ar(e){let t=String(e.getMonth()+1).padStart(2,`0`),n=String(e.getDate()).padStart(2,`0`);return`${e.getFullYear()}-${t}-${n}`}function or(e,t){let n=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);if(!n)return``;let r=new Date(Number(n[1]),Number(n[2])-1,Number(n[3]));return r.setDate(r.getDate()+t),ar(r)}var sr=``,cr=new Set;function lr(){return sr}function ur(e){let t=ir(e);t!==sr&&(sr=t,cr.forEach(e=>e()))}function dr(e){return cr.add(e),()=>{cr.delete(e)}}var fr=class extends A{constructor(...e){super(...e),this.tag=``,this.tagAbmelden=null}static{this.blockType=`datum`}static{this.tagName=`ff-datum`}static{this.displayName=`Datum`}static{this.category=`anzeige`}static{this.defaultProps={}}static{this.customProperties=[]}static{this.raster={startW:9,startH:2,minW:5,minH:2}}static{this.styles=[A.styles,o`
    ...
    `]}setzeTag(e){ur(e),this.tag=lr()}render(){return w`<div class="waehler">
      <div class="riegel">
        <button class="pfeil" title="Vortag" @click=${()=>this.setzeTag(or(this.tag,-1))}>‹</button>
        <input
          class="feld"
          type="date"
          .value=${this.tag}
        ...
        />
        <button class="pfeil" title="Folgetag" @click=${()=>this.setzeTag(or(this.tag,1))}>›</button>
      </div>
      <button class="heute" @click=${()=>this.setzeTag(ar(new Date))}>Heute</button>
    </div>`}connectedCallback(){super.connectedCallback(),this.tag=lr()||ar(new Date),!this.hasAttribute(`data-ff-editor`)&&(this.setzeTag(this.tag),this.tagAbmelden?.(),this.tagAbmelden=dr(()=>{this.tag=lr()}))}disconnectedCallback(){super.disconnectedCallback(),this.tagAbmelden?.(),this.tagAbmelden=null}};k([He()],fr.prototype,`tag`,void 0),A.defineAndRegister(fr);var pr={attributeName:`fieldType`,equals:`nachschlagen`},mr=[{attributeName:`fieldType`,name:`Feldtyp`,description:`Welche Art Eingabe das Feld annimmt.`,kind:`select`,options:[{value:`text`,label:`Text`},{value:`number`,label:`Zahl`},{value:`textarea`,label:`Mehrzeilig`},{value:`select`,label:`Auswahl`},{value:`date`,label:`Datum`},{value:`checkbox`,label:`Ankreuzfeld`},{value:`nachschlagen`,label:`Nachschlagen`}]},{attributeName:`options`,name:`Auswahl-Optionen`,description:`Nur bei Feldtyp "Auswahl": Einträge durch Komma getrennt (z. B. "Zimmer 1, Zimmer 2") — jeder Eintrag wird eine Dropdown-Zeile.`,kind:`text`,visibleWhen:{attributeName:`fieldType`,equals:`select`}},{attributeName:`nachschlagQuelle`,name:`Quelle`,description:`Nur bei Feldtyp "Nachschlagen": aus dieser Datenquelle wählt der Bediener eine Zeile.`,kind:`quelle`,visibleWhen:pr},{attributeName:`anzeigeFeld`,name:`Angezeigt wird`,description:`Feld der Nachschlage-Quelle, dessen Wert der Bediener sieht (z. B. der Name).`,kind:`field`,quelleProp:`nachschlagQuelle`,klarnameProp:`anzeigeTitel`,visibleWhen:pr},{attributeName:`speicherFeld`,name:`Gespeichert wird`,description:`Feld der Nachschlage-Quelle, dessen Wert die Maske sich merkt und die Kette "Wert geändert" weitergibt (z. B. die Nummer).`,kind:`field`,quelleProp:`nachschlagQuelle`,klarnameProp:`speicherTitel`,visibleWhen:pr},{attributeName:`einzigerTreffer`,name:`Einzigen Treffer übernehmen`,description:`Bleibt in der Maske genau EIN Satz übrig (weil das Feld der Auswahl eines anderen folgt), übernimmt es diesen von selbst — ohne dass der Bediener die Lupe drückt. Nur in ein leeres Feld; die Lupe bleibt daneben bedienbar.`,kind:`segment`,options:[{value:`ja`,label:`Ja`},{value:`nein`,label:`Nein`}],visibleWhen:pr},{attributeName:`valueField`,name:`Feld`,description:`Feld der angeschlossenen Datenquelle, dessen Wert angezeigt und lokal aktualisiert wird.`,kind:`field`,visibleWhen:{attributeName:`fieldType`,notEquals:`nachschlagen`}}];function hr(e){return`${e.toLowerCase()}field`}function gr(e){let t=e.split(`::`);if(t.length!==2)return{quelleId:``,code:e};let[n,r]=t;return n===``||r===``?{quelleId:``,code:e}:{quelleId:n,code:r}}var _r=999,vr=`0`,yr=`255`,br=new Map;function xr(e){let t=ht(e);mt(e,[]),t!==void 0&&t.length>0&&rn()}async function Sr(e,t,n,r,i){return(await Nn({id:`relation-lader`,verb:`GET_RELATION`,nr:e.nr,params:[]},[t.belegart,r,i,t.belegnummer,t.jahr,t.archiv,``,String(n),``,``,``,``],{still:!0,satzAntwort:!0})).wert}function Cr(e,t,n){let r=(br.get(e.id)??0)+1;if(br.set(e.id,r),n===void 0){xr(e.name);return}let i={belegart:P(n,t.belegartFeld),belegnummer:P(n,t.belegnummerFeld),jahr:t.jahrFeld===``?``:P(n,t.jahrFeld),archiv:t.archivFeld===``?``:P(n,t.archivFeld)};if(i.belegart===``||i.belegnummer===``){xr(e.name);return}xr(e.name),(async()=>{let n=[],a=!1;for(let o=1;o<=_r;o+=1){let s=await Sr(t,i,o,vr,yr);if(br.get(e.id)!==r)return;if(t.endeFelder.every(e=>P({SATZ:s},e)===``)){a=!0;break}let c={SATZ:s};for(let n of t.zusatzFelder){let a=n.indexOf(`_`),s=await Sr(t,i,o,n.slice(0,a),n.slice(a+1));if(br.get(e.id)!==r)return;c[n]=s}n.push(c)}a||H(`Positionen laden: nach ${_r} Zeilen ohne Ende-Kennung abgebrochen (Relation Nr. ${t.nr}) — die Liste ist wahrscheinlich unvollständig, vermutlich passen Relationsnummer oder Ende-Felder nicht.`),br.get(e.id)===r&&(mt(e.name,n),rn())})()}var wr=new Map,Tr=!1;function Er(){let e=new Map;for(let t of Ge())t.satzWahl&&e.set(t.tagName.toLowerCase(),(t.satzWahl.quelleProp??`source`).toLowerCase());return e}function Dr(e,t){if(!(e===``||typeof document>`u`))for(let n of Array.from(document.querySelectorAll(`[data-ff-id]`))){let r=t.get(n.tagName.toLowerCase());if(r===void 0||n.getAttribute(r)!==e)continue;let i=Dt(n.getAttribute(`data-ff-id`)??``);if(i!==void 0)return i}}function Or(){let e=U().FF_DATA_SOURCES;if(!Array.isArray(e))return;let t=Er();for(let n of e){if(!M(n)||typeof n.id!=`string`)continue;let r=N(e,n.id);if(!r?.ladeRelation)continue;let i=Dr(r.ladeRelation.geberQuelleId,t),a=xt(i);wr.get(r.id)!==a&&(wr.set(r.id,a),Cr(r,r.ladeRelation,i))}}function kr(){Tr||(Tr=!0,Et(Or))}function Ar(e){let t=new Set,n=!1,r=()=>{Yt()&&t.forEach(e.hydriere)};return{connect:i=>{i.hasAttribute(`data-ff-editor`)||(t.add(i),e.verdrahte?.(i),n||(n=!0,en(r),dr(r),Et(r),kr()),hn(),Yt()&&e.hydriere(i))},disconnect:e=>{t.delete(e)}}}var jr=Qe.toLowerCase(),Mr=``;function Nr(e){if(e.length===0)return``;let t=[];for(let n of e){let e=n.trim();if(e===``)return``;t.push(e)}return t.join(Mr)}function Pr(e){let t=e.getAttribute(jr)??``;if(t===``)return[];try{let e=JSON.parse(t);if(!Array.isArray(e))return[];let n=[];for(let t of e){if(!t||typeof t!=`object`)continue;let e=t;if(typeof e.quelleId!=`string`||e.quelleId===``)continue;let r=[];for(let t of Array.isArray(e.keyPairs)?e.keyPairs:[]){if(!t||typeof t!=`object`)continue;let e=t;typeof e.fromField!=`string`||typeof e.toField!=`string`||e.fromField.trim()===``||e.toField.trim()===``||r.push({fromField:e.fromField,toField:e.toField})}r.length!==0&&n.push({quelleId:e.quelleId,keyPairs:r})}return n}catch{return[]}}function Fr(e){let t=Pr(e);if(t.length===0)return(e,t)=>P(e,gr(t).code);let n=U().SEDATA,r=U().FF_DATA_SOURCES,i=new Map;for(let e of t){let t=N(r,e.quelleId);if(!t)continue;let a=I(n,t.name,t.tableId),o=new Map;for(let t of a){let n=Nr(e.keyPairs.map(e=>P(t,e.toField)));n!==``&&!o.has(n)&&o.set(n,t)}i.set(e.quelleId,{nachSchluessel:o,hierFelder:e.keyPairs.map(e=>e.fromField)})}return(e,t)=>{let{quelleId:n,code:r}=gr(t);if(n===``)return P(e,r);let a=i.get(n);if(!a)return``;let o=Nr(a.hierFelder.map(t=>P(e,t)));if(o===``)return``;let s=a.nachSchluessel.get(o);return s===void 0?``:P(s,r)}}function Ir(e,t){let n=e.getAttribute(`source`)??``,r=e.getAttribute(t)??``;if(n===``||r===``)return{art:`ungebunden`};let i=N(U().FF_DATA_SOURCES,n);if(!i)return{art:`ohneQuelle`};let a=It(e,I(U().SEDATA,i.name,i.tableId));if(a===void 0)return{art:`ohneZeile`};let{quelleId:o,code:s}=gr(r);return{art:`wert`,wert:o===``?P(a,s):Fr(e)(a,r),zeile:a,quelle:i,quelleId:o,reinerCode:s}}var Lr=new WeakMap,Rr=new WeakSet;function zr(e){let t=/^(\d{2})\.(\d{2})\.(\d{4})$/.exec(e);return t?`${t[3]}-${t[2]}-${t[1]}`:e}function Br(e){let t=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);return t?`${t[3]}.${t[2]}.${t[1]}`:e}function Vr(e){return typeof e.value==`string`?e.value:``}function Hr(e){if(e.pruefeEigenenWert?.(),e.getAttribute(`fieldtype`)===`nachschlagen`){Lr.delete(e);return}let t=Ir(e,hr(`value`));if(t.art!==`wert`){Lr.delete(e),t.art===`ohneZeile`&&(e.value=``);return}let{zeile:n,quelle:r,quelleId:i,reinerCode:a,wert:o}=t,s=r.indexField===``?``:P(n,r.indexField);i===``?Lr.set(e,{row:n,code:a,pindex:s}):Lr.delete(e),e.value=o}function Ur(e){let t=Lr.get(e);return t&&_t(t.row,t.code,Vr(e)),t}function Wr(e){Rr.has(e)||(Rr.add(e),e.addEventListener(`input`,()=>{Ur(e)}),e.addEventListener(`change`,()=>{let t=Ur(e);Vn(e,`onChange`,{VALUE:Vr(e),PINDEX:t?.pindex??``}).catch(Bn)}))}var Gr=Ar({hydriere:Hr,verdrahte:Wr}),Kr=Gr.connect,qr=Gr.disconnect,Jr=o`
  .feld {
    font-family: var(--se-font);
...
`;function Yr(e){return e.trim().toLowerCase().split(/\s+/).filter(e=>e!==``)}function Xr(e,t){let n=Yr(t);if(n.length===0)return!0;let r=e.join(` `).toLowerCase();return n.every(e=>r.includes(e))}var Zr=10;function Qr(e,t,n){let r=[];for(let i of e){let e=P(i,t).trim(),a=P(i,n).trim();(e!==``||a!==``)&&r.push({anzeige:e,wert:a,satz:i})}return r}function $r(e,t){return e.filter(e=>Xr([e.anzeige,e.wert],t))}function ei(e,t,n,r){return Qr(Ft(e,t).rows,n,r)}function ti(e){if(e.quelleId===``||e.anzeigeFeld===``||e.speicherFeld===``)return{ok:!1,grund:`unvollstaendig`};let t=N(U().FF_DATA_SOURCES,e.quelleId);if(!t)return{ok:!1,grund:`quelleFehlt`};let n=I(U().SEDATA,t.name,t.tableId);return{ok:!0,eintraege:ei(e.el,n,e.anzeigeFeld,e.speicherFeld)}}function ni(e,t){return t&&e.length===1?e[0]:null}function ri(e,t){let{rows:n,gefiltert:r}=Ft(e,[t]);return!r||n.length>0}function ii(e,t,n){return e===``?t===``&&n===``?`nichts`:`leeren`:e===t?`nichts`:`zurueck`}var ai=null;function oi(){ai?.remove(),ai=null}function si(e,t=!1){let n=document.createElement(t?`th`:`td`);return n.textContent=e,n.style.cssText=t?`position:sticky;top:0;z-index:1;padding:6px 10px;text-align:left;font-size:var(--se-fs-sm);font-weight:600;color:var(--se-muted);border-bottom:var(--se-border) solid var(--se-line);background:var(--se-panel-2)`:`box-sizing:border-box;height:24px;padding:3px 10px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;border-bottom:var(--se-border) solid var(--se-line-soft)`,n}function ci(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.setAttribute(`aria-label`,t),n.style.cssText=`box-sizing:border-box;width:26px;height:24px;padding:0;border:var(--se-border) solid var(--se-line);border-radius:var(--se-r-sm);background:var(--se-panel);color:var(--se-ink);font:inherit;cursor:pointer`,n}function li(e){let t=ti(e);if(!t.ok){H(t.grund===`unvollstaendig`?`Nachschlagen ist an diesem Feld nicht vollstaendig eingestellt (Quelle, Angezeigt, Gespeichert).`:`Die Nachschlage-Quelle dieses Feldes ist in der Maske nicht vorhanden.`);return}let n=t.eintraege;oi();let r=document.createElement(Lt);r.setAttribute(`data-ff-nachschlagen`,``),r.viewport=!0,r.mitWerkzeug=!0,r.escapeSchliesst=!0,r.titel=e.titel===``?`Nachschlagen`:e.titel,r.breite=520,r.hoehe=380,r.addEventListener(Rt,oi),r.addEventListener(`click`,e=>e.stopPropagation());let i=document.createElement(`input`);i.slot=`werkzeug`,i.type=`search`,i.placeholder=`suchen ...`,i.setAttribute(`aria-label`,`Nachschlagen durchsuchen`),i.style.cssText=`box-sizing:border-box;width:100%;padding:5px 8px;font:inherit;color:inherit;background:var(--se-panel);border:var(--se-border) solid var(--se-line);border-radius:var(--se-r-sm)`;let a=document.createElement(`table`);a.style.cssText=`width:100%;table-layout:fixed;border-collapse:collapse`;let o=document.createElement(`colgroup`),s=document.createElement(`col`);s.style.width=`65%`;let c=document.createElement(`col`);c.style.width=`35%`,o.append(s,c);let l=document.createElement(`thead`),u=document.createElement(`tr`);u.append(si(e.anzeigeTitel===``?`Angezeigt`:e.anzeigeTitel,!0),si(e.speicherTitel===``?`Wert`:e.speicherTitel,!0)),l.appendChild(u);let d=document.createElement(`tbody`);a.append(o,l,d);let f=document.createElement(`div`);f.style.cssText=`flex:1 1 auto;min-height:0;overflow:auto`,f.appendChild(a);let ee=document.createElement(`div`);ee.style.cssText=`box-sizing:border-box;flex:none;display:flex;align-items:center;min-height:33px;padding:4px 10px;border-top:var(--se-border) solid var(--se-line);background:var(--se-panel-2);font-size:var(--se-fs-sm)`;let te=document.createElement(`span`);te.setAttribute(`aria-live`,`polite`),te.style.cssText=`flex:1;color:var(--se-muted)`;let p=document.createElement(`nav`);p.setAttribute(`aria-label`,`Trefferseiten`),p.style.cssText=`display:flex;align-items:center;gap:6px`;let m=ci(`‹`,`Vorherige Seite`),ne=document.createElement(`span`);ne.style.cssText=`min-width:48px;text-align:center;color:var(--se-muted)`;let h=ci(`›`,`Nächste Seite`);p.append(m,ne,h),ee.append(te,p);let g=document.createElement(`div`);g.style.cssText=`box-sizing:border-box;height:100%;min-height:0;display:flex;flex-direction:column`,g.append(f,ee);let _=1,v=1,y=()=>{d.replaceChildren();let t=$r(n,i.value);v=Math.max(1,Math.ceil(t.length/Zr)),_=Math.min(_,v);let r=(_-1)*Zr,a=t.slice(r,r+Zr);if(te.textContent=t.length===0?`0 von 0`:`${r+1}-${Math.min(r+Zr,t.length)} von ${t.length}`,ne.textContent=`${_} / ${v}`,m.disabled=_===1,h.disabled=_===v,m.style.opacity=m.disabled?`0.4`:`1`,h.style.opacity=h.disabled?`0.4`:`1`,m.style.cursor=m.disabled?`default`:`pointer`,h.style.cursor=h.disabled?`default`:`pointer`,f.scrollTop=0,a.length===0){let e=document.createElement(`tr`),t=si(n.length===0?`Diese Quelle hat keine Sätze.`:`Kein Satz passt zur Suche.`);t.colSpan=2,t.style.color=`var(--se-faint)`,t.style.fontSize=`var(--se-fs-sm)`,t.style.padding=`16px 10px`,e.appendChild(t),d.appendChild(e);return}for(let t of a){let n=document.createElement(`tr`);n.tabIndex=0,n.style.cursor=`pointer`;let r=si(t.anzeige),i=si(t.wert);i.style.fontFamily=`var(--se-mono)`,i.style.color=`var(--se-muted)`,n.append(r,i);let a=()=>{oi(),e.onUebernehmen(t.anzeige,t.wert,t.satz)};n.addEventListener(`click`,a),n.addEventListener(`keydown`,e=>{e.key===`Enter`&&(e.preventDefault(),a())}),n.addEventListener(`mouseenter`,()=>{n.style.background=`var(--se-accent-soft)`}),n.addEventListener(`mouseleave`,()=>{n.style.background=``}),d.appendChild(n)}};i.addEventListener(`input`,()=>{_=1,y()}),m.addEventListener(`click`,()=>{_!==1&&(--_,y())}),h.addEventListener(`click`,()=>{_!==v&&(_+=1,y())}),y(),r.append(i,g),document.body.appendChild(r),ai=r,r.updateComplete.then(()=>{r.isConnected&&i.focus()})}var ui=[`text`,`number`,`textarea`,`select`,`date`,`checkbox`,`nachschlagen`];function di(e){return ui.includes(e)?e:`text`}var fi=[`text`,`number`,`textarea`,`select`,`nachschlagen`],q=class extends A{constructor(...e){super(...e),this.fieldType=`text`,this.placeholder=`Feldname`,this.options=``,this.source=``,this.value=``,this.valueField=``,this.nachschlagQuelle=``,this.anzeigeFeld=``,this.anzeigeTitel=``,this.speicherFeld=``,this.speicherTitel=``,this.einzigerTreffer=`nein`,this.anzeige=``,this.getippt=null,this.satz=void 0,this.angehakt=!1}static{this.blockType=`formfeld`}static{this.tagName=`ff-formfeld`}static{this.displayName=`Formularfeld`}static{this.category=`eingabe`}static{this.acceptsDataSource={wenn:{attributeName:`fieldType`,notEquals:`nachschlagen`}}}static{this.kannAuswahlFolgen=!0}static{this.satzWahl={quelleProp:`nachschlagQuelle`,wenn:{attributeName:`fieldType`,equals:`nachschlagen`}}}static{this.bindableSpots=[{prop:`value`,label:`Wert`,wenn:{attributeName:`fieldType`,keinesVon:[`checkbox`,`nachschlagen`]},vorschauProp:`placeholder`}]}static{this.actionValueSpots=[{prop:`value`,label:`Wert`}]}static{this.blockEvents=[{key:`onChange`,name:`Wert geändert`}]}static{this.defaultProps={width:240,fieldType:`text`,placeholder:`Feldname`,options:``,source:``,value:``,valueField:``,nachschlagQuelle:``,anzeigeFeld:``,anzeigeTitel:``,speicherFeld:``,speicherTitel:``,einzigerTreffer:`nein`}}static{this.raster={startW:6,startH:2,minW:2,minH:2}}static{this.customProperties=mr}static{this.styles=[A.styles,Jr]}onInput(e){let t=e.target;this.value=di(this.fieldType)===`date`?Br(t.value):t.value}onChange(){this.dispatchEvent(new Event(`change`))}textTpl(e,t=!1){return w`<span
      class=${e}
      ?hidden=${t}
      data-ff-editable
    ...
    >${this.placeholder}</span>`}onTextClick(){this.hasAttribute(`data-ff-editor`)||this.setzeHaken(!this.angehakt)}setzeHaken(e){this.angehakt!==e&&(this.angehakt=e,this.dispatchEvent(new Event(`change`)))}controlTpl(e){switch(e){case`textarea`:return w`<textarea class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}></textarea>`;case`select`:{let e=this.options.split(`,`).map(e=>e.trim()).filter(e=>e!==``),t=this.value!==``&&!e.includes(this.value);return w`<select class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}>
          ...
          class="ctrl"
          type=${e}
          .value=${e===`date`?zr(this.value):this.value}
          @input=${this.onInput}
          @change=${this.onChange}
        />`}}onLupe(){this.hasAttribute(`data-ff-editor`)||li({el:this,quelleId:this.nachschlagQuelle,anzeigeFeld:this.anzeigeFeld,speicherFeld:this.speicherFeld,anzeigeTitel:this.anzeigeTitel,speicherTitel:this.speicherTitel,titel:this.placeholder,onUebernehmen:(e,t,n)=>{this.uebernimmSatz(e,t,n),this.dispatchEvent(new Event(`change`))}})}leereNachschlagen(){this.satz=void 0,this.anzeige=``,this.value=``,Mt(R(this))}uebernimmSatz(e,t,n){this.anzeige=e===``?t:e,this.value=t,this.satz=n,jt(R(this),n)}onNachschlagVerlassen(){if(this.hasAttribute(`data-ff-editor`))return;let e=ii(this.getippt??this.anzeige,this.anzeige,this.value);this.getippt=null,e===`leeren`&&(this.leereNachschlagen(),this.dispatchEvent(new Event(`change`)))}pruefeEigenenWert(){di(this.fieldType)===`nachschlagen`&&(this.satz!==void 0&&!ri(this,this.satz)&&this.leereNachschlagen(),this.uebernimmEinzigenTreffer())}uebernimmEinzigenTreffer(){if(this.einzigerTreffer!==`ja`)return;let e=ti({el:this,quelleId:this.nachschlagQuelle,anzeigeFeld:this.anzeigeFeld,speicherFeld:this.speicherFeld});if(!e.ok)return;let t=ni(e.eintraege,this.satz===void 0);t&&this.uebernimmSatz(t.anzeige,t.wert,t.satz)}render(){let e=di(this.fieldType);if(e===`checkbox`)return w`<div class="feld">
        <div class="zeile">
          <input
            class="ctrl"
            type="checkbox"
      ...
      </div>`;let t=e!==`nachschlagen`,n=t?this.value:this.getippt??this.anzeige;return w`<div class="feld">
      <div
        class="huelle"
      ...
      >
        ${this.controlTpl(e)}
        ${fi.includes(e)?this.textTpl(e===`select`?`ph ph-select`:`ph`,n!==``):E}
      </div>
    </div>`}connectedCallback(){super.connectedCallback(),Kr(this)}disconnectedCallback(){super.disconnectedCallback(),qr(this)}};k([O()],q.prototype,`fieldType`,void 0),k([O()],q.prototype,`placeholder`,void 0),k([O()],q.prototype,`options`,void 0),k([O()],q.prototype,`source`,void 0),k([O()],q.prototype,`value`,void 0),k([O()],q.prototype,`valueField`,void 0),k([O()],q.prototype,`nachschlagQuelle`,void 0),k([O()],q.prototype,`anzeigeFeld`,void 0),k([O()],q.prototype,`anzeigeTitel`,void 0),k([O()],q.prototype,`speicherFeld`,void 0),k([O()],q.prototype,`speicherTitel`,void 0),k([O()],q.prototype,`einzigerTreffer`,void 0),k([He()],q.prototype,`anzeige`,void 0),k([He()],q.prototype,`getippt`,void 0),k([He()],q.prototype,`angehakt`,void 0),A.defineAndRegister(q);var pi=`Keine Datensätze.`;function mi(){return{attributeName:`leerText`,name:`Text ohne Datensätze`,description:`Steht in der Maske dort, wo sonst die Zeilen stehen — wenn die Datenquelle keine liefert. Leer lassen: dann steht dort gar nichts.`,kind:`text`,requiresDataSource:!0}}function hi(e,t=!1){return e.trim()===``?E:w`<div class="leer${t?` leer--tafel`:``}">
    ${Zn()}
    <span>${e}</span>
  </div>`}var gi=o`
  .leer {
...
`;function _i(e,t,n,r){return{attributeName:e,name:t,description:n,kind:`select`,options:[{value:`nein`,label:`Nein`},{value:`ja`,label:`Ja`}],...r}}var vi=o`
  ::slotted(:not([hat-reiter])) { margin-top: 24px; }
  slot { display: contents; }
`,yi=`frei · hierher ziehen`,bi=`ff-zimmer-inhalt`,J=class extends A{constructor(...e){super(...e),this.heading=`Neues Zimmer`,this.leerHinweis=``}static{this.blockType=`kanban-zimmer`}static{this.tagName=`ff-kanban-zimmer`}static{this.displayName=`Kanban-Zimmer`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[K.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban-spalte`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={heading:`Neues Zimmer`}}static{this.styles=[A.styles,gi,vi,o`
      :host { display: block; }
    ...
    `]}onSlotChange(){this.dispatchEvent(new CustomEvent(bi,{bubbles:!0,composed:!0}))}render(){return w`<div class="zimmer">
      <div
        class="kopf"
        data-ff-editable
    ...
    </div>`}};k([O()],J.prototype,`heading`,void 0),k([O({attribute:!1})],J.prototype,`leerHinweis`,void 0),A.defineAndRegister(J);var Y=class extends A{static{this.blockType=`kanban-spalte`}static{this.tagName=`ff-kanban-spalte`}static{this.displayName=`Kanban-Spalte`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[K.blockType,J.blockType]}static{this.addChildButton={label:`Zimmer`,childType:J.blockType}}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={variant:`info`,heading:`Neue Spalte`,auffang:`nein`,zimmerField:``}}static{this.customProperties=[Jn(`variant`,`Bedeutung der Spalte — bestimmt ihre Farbwelt (Kopf, Fläche, Rahmen).`),_i(`auffang`,`Auffangspalte`,`Einträge ohne passenden Spaltentitel landen hier. Ohne Auffangspalte landen sie in der ersten Spalte.`,{requiresDataSource:!0,exclusiveAmongSiblings:!0}),{attributeName:`zimmerField`,name:`Unterteilen nach`,description:`Optional: Feld der Datenquelle, dessen Inhalt bestimmt, in welches Zimmer dieser Spalte ein Eintrag kommt. Wirkt erst, wenn die Spalte Zimmer hat.`,kind:`field`}]}static{this.styles=[A.styles,gi,vi,o`
    ...
    `]}constructor(){super(),this.variant=`info`,this.heading=`Neue Spalte`,this.leerHinweis=``,this._count=0,this.addEventListener(bi,()=>this.zaehle())}zaehle(){this._count=Array.from(this.querySelectorAll(K.tagName)).filter(e=>!e.hasAttribute(`data-ff-editor-helper`)).length}render(){return w`<div class="col v-${Kn(this.variant)}">
      <div class="head">
        <span class="dot"></span>
        <span
          class="title"
    ...
    </div>`}};k([O()],Y.prototype,`variant`,void 0),k([O()],Y.prototype,`heading`,void 0),k([O({attribute:!1})],Y.prototype,`leerHinweis`,void 0),k([He()],Y.prototype,`_count`,void 0),A.defineAndRegister(Y);function xi(e,t,n){return t===``||n===``?[...e]:e.filter(e=>ir(P(e,t))===n)}function Si(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function Ci(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var wi=new WeakMap,Ti=Y.tagName,Ei=J.tagName,Di=K.tagName;function Oi(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Ti)}function ki(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Di)}function Ai(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Ei)}function ji(e){return[e,...Ai(e)]}function Mi(e,t){let n=e.getAttribute(`leertext`)??`Keine Datensätze.`,r=(e,t)=>{e.leerHinweis=t};for(let e of t){let t=Ai(e);for(let e of t)r(e,ki(e).length===0?yi:``);r(e,t.length===0&&ki(e).length===0?n:``)}}function Ni(e){return Ge().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function Pi(e,t){let n=Ai(e);if(n.length===0)return null;let r=e.getAttribute(`zimmerfield`)??``;if(r===``)return n[0];let i=n.map(e=>e.getAttribute(`heading`)??J.defaultProps.heading),a=Si(P(t,r),i);return a>=0?n[a]:n[0]}function Fi(e){Z?.board===e&&(Z=null);let t=e.getAttribute(`source`)??``,n=e.getAttribute(`statusfield`)??``;if(t===``)return;let r=N(U().FF_DATA_SOURCES,t);if(!r)return;let i=Oi(e);if(i.length===0)return;let a=wi.get(e);if(!a){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(Di);t&&(a=t.cloneNode(!0),wi.set(e,a))}if(!a)return;let o=xi(I(U().SEDATA,r.name,r.tableId),e.getAttribute(`tagfield`)??``,lr()),s=i.map(e=>e.getAttribute(`heading`)??Y.defaultProps.heading),c=Ni(a.tagName),l=Ci(i.map(e=>e.getAttribute(`auffang`))),u=Fr(e);for(let e of i)for(let t of ji(e))ki(t).forEach(e=>e.remove());for(let e of o){let t=a.cloneNode(!0),o=n===``?-1:Si(P(e,n),s),d=o>=0?i[o]:l>=0?i[l]:i[0];(Pi(d,e)??d).appendChild(t);for(let n of c){let r=t.getAttribute(hr(n.prop))??``;r!==``&&(t[n.prop]=u(e,r))}let f=r.indexField===``?``:P(e,r.indexField);X.set(t,{row:e,pindex:f}),t.draggable=!0}Mi(e,i);let d=i.flatMap(e=>ji(e).flatMap(ki)),f=kt(R(e),d,e=>X.get(e)?.row);for(let e of f)d[e].setAttribute(`data-ff-auswahl`,``)}var X=new WeakMap,Z=null,Ii=new WeakSet;function Li(e,t,n){for(let r of t.composedPath())if(r instanceof HTMLElement&&r.tagName.toLowerCase()===n&&e.contains(r))return r;return null}function Ri(e,t){return Li(e,t,Ti)}function zi(e,t,n){if(!Z||Z.board!==e)return;let r=X.get(Z.card);if(!r)return;let i=t.getAttribute(`heading`)??``,a=n?.getAttribute(`heading`)??``;Vn(e,`onCardDrop`,{PINDEX:r.pindex,VALUE:i,ZIMMER:a}).catch(Bn)}function Bi(e){Ii.has(e)||(Ii.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;if(!n)return;let r=X.get(n);r&&At(R(e),r.row),Vn(e,`onCardClick`,{PINDEX:r?.pindex??``}).catch(Bn)}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;n&&(Z={card:n,board:e},t.dataTransfer?.setData(`text/plain`,X.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`))}),e.addEventListener(`dragend`,()=>{Z=null}),e.addEventListener(`dragover`,t=>{let n=Ri(e,t);Z?.board===e&&n&&(t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`))}),e.addEventListener(`drop`,t=>{let n=Ri(e,t);n&&(t.preventDefault(),zi(e,n,Li(e,t,Ei)),Z=null)}))}var Vi=Ar({hydriere:Fi,verdrahte:Bi}),Hi=Vi.connect,Ui=Vi.disconnect,Wi=Y.blockType,Gi=class extends A{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[Wi]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:Wi}}static{this.templateChild={type:K.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``,tagField:``,leerText:pi}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Optional: Feld der Datenquelle, dessen Inhalt bestimmt, in welche Spalte ein Eintrag kommt. Leer = alle Einträge in der Auffang-Spalte.`,kind:`field`},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt das Board nur Einträge des Tages, den der Tageswähler zeigt. Leer = alle Einträge.`,kind:`field`},mi()]}static{this.defaultChildren=[{type:Wi,props:{heading:`Offen`,variant:`warning`},children:[{type:K.blockType}]},{type:Wi,props:{heading:`In Arbeit`,variant:`info`}},{type:Wi,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[A.styles,o`
    ...
    `]}render(){return w`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),Hi(this)}disconnectedCallback(){super.disconnectedCallback(),Ui(this)}};A.defineAndRegister(Gi);var Ki={breite:56,breiteOffen:224},qi=`ff-seiten-wechsel`,Ji=[{wert:`sonne`,name:`Sonnengelb`},{wert:`salbei`,name:`Salbeigrün`},{wert:`himmel`,name:`Himmelblau`},{wert:`flieder`,name:`Flieder`},{wert:`koralle`,name:`Koralle`}],Yi=class extends A{static{this.blockType=`navi-eintrag`}static{this.tagName=`ff-navi-eintrag`}static{this.displayName=`Navi-Eintrag`}static{this.category=`layout`}static{this.acceptsChildren=!1}static{this.showInPalette=!1}static{this.allowedParentTypes=[`navi`]}static{this.resizableWidth=!1}static{this.defaultProps={seite:``,seitename:``,ton:`sonne`}}static{this.customProperties=[{attributeName:`seite`,name:`Seite`,description:`Welche Seite dieser Maske der Eintrag zeigt.`,kind:`seite`,klarnameProp:`seitename`,nurImEditor:!0},{attributeName:`ton`,name:`Farbe`,description:`Farbe des Zeichens vor dem Namen.`,kind:`select`,options:Ji.map(e=>({value:e.wert,label:e.name}))}]}static{this.styles=[A.styles,o`
      :host {
        --ton: var(--se-amber);
        display: flex;
        align-items: center;
    ...
    `]}constructor(){super(),this.seite=``,this.seitename=``,this.ton=`sonne`,this.addEventListener(`click`,()=>this.melde())}melde(){let e={ansicht:this.seitename};this.dispatchEvent(new CustomEvent(qi,{detail:e,bubbles:!0,composed:!0}))}render(){return w`<span class="zeichen"></span>
      <span class="name">${this.seitename===``?`—`:this.seitename}</span>`}};k([O()],Yi.prototype,`seite`,void 0),k([O()],Yi.prototype,`seitename`,void 0),k([O({reflect:!0})],Yi.prototype,`ton`,void 0),A.defineAndRegister(Yi);var Xi=`aktiv`;function Zi(e){return Array.from(e.querySelectorAll(Yi.tagName))}function Qi(e,t){let n=Zi(e),r=t??n.find(e=>e.hasAttribute(Xi))??n[0];for(let e of n)e===r?e.setAttribute(Xi,``):e.removeAttribute(Xi)}function $i(e){let t=e.hasAttribute(`offen`);for(let n of Zi(e))n.toggleAttribute(`breit`,t)}function ea(e){return e.getAttribute(`name`)??String(rt.defaultProps.name)}function ta(e,t){let n=e;for(;n&&n.parentElement!==t;)n=n.parentElement;return n}function na(e,t){let n=e.ownerDocument,r=Array.from(n.querySelectorAll(rt.tagName)),i=r[0]?.parentElement??null;if(!i)return;let a=ta(e,i);if(!a)return;let o=r.find(e=>ea(e)===t)??null;for(let e of Array.from(i.children))e!==a&&((r.includes(e)?e===o:o===null)?e.removeAttribute(`hidden`):e.setAttribute(`hidden`,``))}var ra=new WeakMap,ia=new WeakSet;function aa(e){let t=t=>{let n=t.detail;n&&(Qi(e,t.target instanceof Element?t.target:void 0),e.removeAttribute(`offen`),$i(e),!e.hasAttribute(`data-ff-editor`)&&na(e,n.ansicht))};e.addEventListener(qi,t),ra.set(e,t)}function oa(e){let t=ra.get(e);t&&(e.removeEventListener(qi,t),ra.delete(e))}function sa(e){if(Qi(e),$i(e),e.hasAttribute(`data-ff-editor`)||ia.has(e))return;let t=Zi(e)[0];if(!t)return;ia.add(e);let n=()=>na(e,t.seitename);e.ownerDocument.readyState===`loading`?e.ownerDocument.addEventListener(`DOMContentLoaded`,n,{once:!0}):queueMicrotask(n)}var ca=Yi.blockType,la=class extends A{static{this.blockType=`navi`}static{this.tagName=`ff-navi`}static{this.displayName=`Navi`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[ca]}static{this.addChildButton={label:`Eintrag`,childType:ca}}static{this.containerHint=!1}static{this.defaultProps={}}static{this.customProperties=[]}static{this.maskenRand=!0}static{this.allowedParentTypes=[nt]}static{this.raster={startW:5,startH:24,minW:3,minH:3}}static{this.styles=[A.styles,o`
      :host {
        height: 100%;
        width: ${Ki.breite}px;
        transition: width var(--se-move);
      }
      :host([offen]) { width: ${Ki.breiteOffen}px; }
      .leiste {
        box-sizing: border-box;
        height: 100%;
        width: 100%;
    ...
    `]}connectedCallback(){super.connectedCallback(),aa(this)}disconnectedCallback(){super.disconnectedCallback(),oa(this)}klappen(){this.toggleAttribute(`offen`),$i(this)}render(){return w`<div class="leiste">
        <div class="kopf">
          <button
            class="schalter"
            type="button"
        ...
        <div class="eintraege">
          <slot @slotchange=${()=>sa(this)}></slot>
        </div>
      </div>`}};A.defineAndRegister(la);var ua={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},da=e=>(...t)=>({_$litDirective$:e,values:t}),fa=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},pa=`important`,ma=` !important`,ha=da(class extends fa{constructor(e){if(super(e),e.type!==ua.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(ma);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?pa:``):n[e]=r}}return T}}),ga=4;function _a(e){return e??ga}function va(e,t,n){return Math.max(1,Math.floor((e-t)/n))}function ya(e,t,n){let r=va(e,t,n),i=e-t;return i<n?{passen:r,zeilenHoehe:n}:{passen:r,zeilenHoehe:Math.floor(i/r*100)/100}}function ba(e,t){return e===null?null:Math.max(0,e-t)}function xa({sichtbar:e,hatQuelle:t,proSeite:n,wunschSeite:r,platzhalterZeilen:i}){let a=t?Math.max(1,Math.ceil(e.length/n)):1,o=Math.min(Math.max(r,0),a-1);return t?{seiten:a,seite:o,zeilen:[...e.slice(o*n,(o+1)*n)]}:{seiten:a,seite:o,zeilen:Array.from({length:i},()=>null)}}function Sa(e,t){if(!e.hasAttribute(`fuellt`))return null;let n=e.renderRoot.querySelector(`.koerper`),r=e.renderRoot.querySelector(`.kopf`);return!(n instanceof HTMLElement)||!(r instanceof HTMLElement)?null:ya(n.clientHeight,r.offsetHeight,t)}function Ca(e,t){if(typeof ResizeObserver>`u`)return null;let n=e.renderRoot.querySelector(`.koerper`);if(!n)return null;let r=new ResizeObserver(t);return r.observe(n),r}function wa(e,t){let n=t.trim().toLowerCase();return e.find(e=>e.wert.trim().toLowerCase()===n)}var Ta=`text`,Ea=`status`,Da=`bild`,Oa=`bild`,ka=`unter`,Aa=[{wert:Ta,name:`Text`,spur:`minmax(0, 1fr)`,klasse:``,zelle:e=>e},{wert:`zahl`,name:`Zahl`,spur:`90px`,klasse:`zahl`,zelle:e=>e},{wert:`datum`,name:`Datum`,spur:`100px`,klasse:`zahl`,zelle:e=>e},{wert:Ea,name:`Status`,spur:`120px`,klasse:`status`,zelle:(e,t)=>{let n=wa(t,e);return n?w`<span class="chip v-${Kn(n.bedeutung)}">${n.name.trim()===``?e:n.name}</span>`:w`<span class="chip">${e}</span>`}},{wert:Da,name:`Bild + Name`,spur:`minmax(0, 1fr)`,klasse:`bild`,zusatzFelder:[{key:Oa,label:`Bild`},{key:ka,label:`Unterzeile`}],hoehe:e=>(e[Oa]??``)!==``||(e[ka]??``)!==``?44:32,zelle:(e,t,n)=>{let r=tr(n[Oa]??``),i=n[ka]??``;return w`<div class="bild-name">
        ${r===void 0?E:w`<span class="bild-zeichen">${r}</span>`}
        <div class="bild-text">
          <div class="bild-titel">${e}</div>
          ${i===``?E:w`<div class="bild-unter">${i}</div>`}
        </div>
      </div>`}}];function ja(e){return e.reduce((e,t)=>{let n=Ma(t.art);return Math.max(e,n.hoehe?.(t.felder??{})??32)},32)}function Ma(e){return Aa.find(t=>t.wert===e)??Aa[0]}var Na=Aa.map(e=>({wert:e.wert,name:e.name,...e.zusatzFelder?{felder:e.zusatzFelder}:{}})),Pa=`felder`,Fa=`Spalte {n}`;function Ia(e){return Fa.replace(`{n}`,String(e+1))}function La(e){return{titel:Ia(e),feld:``,art:Ta}}function Ra(){return[0,1,2].map(e=>La(e))}function za(e){return Array.isArray(e)?e.filter(e=>!!e&&typeof e==`object`).map(e=>({wert:typeof e.wert==`string`?e.wert:``,name:typeof e.name==`string`?e.name:``,bedeutung:typeof e.bedeutung==`string`?e.bedeutung:``})).filter(e=>e.wert.trim()!==``):[]}function Ba(e){if(!e||typeof e!=`object`||Array.isArray(e))return{};let t={};for(let[n,r]of Object.entries(e))typeof r==`string`&&r!==``&&(t[n]=r);return t}function Va(e,t){if(e&&typeof e==`object`){let n=e,r=za(n.zuordnung),i=Ba(n.felder);return{titel:typeof n.titel==`string`?n.titel:Ia(t),feld:typeof n.feld==`string`?n.feld:``,art:typeof n.art==`string`?n.art:Ta,...r.length>0?{zuordnung:r}:{},...Object.keys(i).length>0?{felder:i}:{}}}return typeof e==`string`?{...La(t),titel:e}:La(t)}function Ha(e){let t;if(Array.isArray(e))t=e.map((e,t)=>Va(e,t));else if(typeof e==`number`&&Number.isFinite(e)||typeof e==`string`&&/^\d+$/.test(e)){let n=Math.max(1,Math.floor(Number(e)));t=[...Array(n).keys()].map(e=>La(e))}else t=Ra();return t.length>8&&(t=t.slice(0,8)),t.length<1&&(t=[La(0)]),t}function Ua(e){try{return Ha(JSON.parse(e))}catch{return Ra()}}function Wa(e){return Ua(e.getAttribute(`spalten`)??``)}function Ga(e,t,n){let r={};for(let i of Ma(e.art).zusatzFelder??[]){let a=e.felder?.[i.key]??``;a!==``&&(r[i.key]=n(t,a))}return r}function Ka(e){let t=()=>{e.datenzeilen=[],e.zusatzzeilen=[]},n=e.getAttribute(`source`)??``;if(n===``){t();return}let r=N(U().FF_DATA_SOURCES,n);if(!r){t();return}let i=Wa(e),{rows:a,gefiltert:o}=Ft(e,xi(I(U().SEDATA,r.name,r.tableId),e.getAttribute(`tagfield`)??``,lr())),s=kt(R(e),a,e=>e)[0]??-1,c=Fr(e);e.datenGeliefert=!0,e.rohzeilen=a,e.auswahlIndex=s,e.durchAuswahlGefiltert=o,e.datenzeilen=a.map(e=>i.map(t=>t.feld===``?``:c(e,t.feld))),e.zusatzzeilen=a.map(e=>i.map(t=>Ga(t,e,c)))}var qa=Ar({hydriere:Ka}),Ja=qa.connect,Ya=qa.disconnect;function Xa(e,t,n){return w`<div class="steuerung">
    <button
    ...
    <button
      ...
      @pointerdown=${n}
      @click=${r=>{n(r);let i=e();i.length<8&&(i.push(La(i.length)),t(i))}}
    >+</button>
  </div>`}function Za(e,t){let n=e.currentTarget;if(!n)return;e.stopPropagation(),e.preventDefault();let r=Array.from(n.childNodes),i=n.textContent??``;n.setAttribute(`contenteditable`,`plaintext-only`),n.focus();let a=window.getSelection(),o=document.createRange();o.selectNodeContents(n),a?.removeAllRanges(),a?.addRange(o);let s=!1,c=e=>{if(s)return;s=!0,n.removeAttribute(`contenteditable`),n.removeEventListener(`blur`,l),n.removeEventListener(`keydown`,u);let a=(n.textContent??``).trim();e&&a&&a!==i.trim()?t(a):n.replaceChildren(...r)},l=()=>c(!0),u=e=>{e.key===`Enter`?(e.preventDefault(),n.blur()):e.key===`Escape`&&(e.preventDefault(),c(!1))};n.addEventListener(`blur`,l),n.addEventListener(`keydown`,u)}function Qa(e,t,n,r){Za(e,e=>{let i=n();t>=i.length||(i[t]={...i[t],titel:e},r(i))})}var $a=220,eo=new WeakMap;function to(e){let t=eo.get(e);t!==void 0&&(clearTimeout(t),eo.delete(e))}function no(e,t,n,r){t.stopPropagation();let i=t.currentTarget.getBoundingClientRect();to(e),eo.set(e,setTimeout(()=>{eo.delete(e),e.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:n,index:r,top:i.bottom+4,left:i.left},bubbles:!0,composed:!0}))},$a))}var ro={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:Fa,eintragsWahl:{key:`art`,label:`Darstellung`,optionen:Na,standard:Ta,felderKey:Pa},eintragsZuordnung:{key:`zuordnung`,label:`Status-Zuordnung`,nurBeiWahl:Ea,wertLabel:`Datenwert`,nameLabel:`Klarname`,bedeutungLabel:`Bedeutung`,bedeutungen:qn}},io=1,ao=/^-?\d{1,3}(\.\d{3})*(,\d+)?$|^-?\d+(,\d+)?$|^-?\d+(\.\d+)?$/,oo=/^(\d{1,2})\.(\d{1,2})\.(\d{2}|\d{4})$/,so=/^(\d{4})-(\d{2})-(\d{2})$/;function co(e){let t=e.trim();if(t===``||!ao.test(t))return null;let n=t.includes(`,`)?t.replace(/\./g,``).replace(`,`,`.`):/^-?\d{1,3}(\.\d{3})+$/.test(t)?t.replace(/\./g,``):t,r=Number(n);return Number.isFinite(r)?r:null}function lo(e){let t=e.trim();if(t===``)return null;let n=so.exec(t);if(n){let[,e,t,r]=n;return uo(Number(e),Number(t),Number(r))}let r=oo.exec(t);if(r){let[,e,t,n]=r,i=Number(n);return uo(n.length===2?i<=69?2e3+i:1900+i:i,Number(t),Number(e))}return null}function uo(e,t,n){if(t<1||t>12||n<1||n>31)return null;let r=new Date(e,t-1,n);return r.getFullYear()!==e||r.getMonth()!==t-1||r.getDate()!==n?null:r.getTime()}function fo(e){let t=0,n=0,r=0;for(let i of e)i.trim()!==``&&(t++,co(i)!==null&&n++,lo(i)!==null&&r++);return t===0?`text`:r===t?`datum`:n===t?`zahl`:`text`}var po=new Intl.Collator(`de`,{numeric:!0,sensitivity:`base`});function mo(e,t,n){if(t<0||e.length===0)return e.map((e,t)=>t);let r=n=>e[n][t]??``,i=fo(e.map(e=>e[t]??``)),a=n?1:-1;return e.map((e,t)=>t).sort((e,t)=>{let n=r(e).trim(),o=r(t).trim();if(n===``&&o===``)return e-t;if(n===``)return io;if(o===``)return-1;let s=i===`zahl`?(co(n)??0)-(co(o)??0):i===`datum`?(lo(n)??0)-(lo(o)??0):po.compare(n,o);return s===0?e-t:s*a})}function ho(e,t){let n=[];return e.forEach((e,r)=>{Xr(e,t)&&n.push(r)}),n}function go(e,t){return!e&&t.trim()!==``}function _o(e,t,n){return e&&t&&n===0}function vo(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}function yo(e){let t=ho(e.datenzeilen,e.suchtext);return e.sortSpalte<0?t:mo(t.map(t=>e.datenzeilen[t]),e.sortSpalte,e.sortAuf).map(e=>t[e])}function bo(e){let t={gridTemplateColumns:e.spalten.map(e=>Ma(e.art).spur).join(` `)},n=ja(e.spalten),r=e.gemessen?.zeilenHoehe??n,i=go(e.imEditor,e.source),a=_o(i,e.datenGeliefert,e.datenzeilen.length),o=yo(e),{seiten:s,seite:c,zeilen:l}=xa({sichtbar:o,hatQuelle:i,proSeite:e.gemessen?.passen??10,wunschSeite:e.wunschSeite,platzhalterZeilen:_a(e.gemessen?.passen??null)});return{cols:t,takt:n,zeilenHoehe:r,hatQuelle:i,leer:a,gesamt:o.length,seiten:s,seite:c,zeilen:l,linealTakte:ba(e.gemessen?.passen??null,l.length)}}var xo=[{attributeName:`suche`,name:`Suchzeile`,description:`Zeigt über der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,kind:`segment`,options:[{value:`ja`,label:`Ja`},{value:`nein`,label:`Nein`}],requiresDataSource:!0},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt die Tabelle nur Sätze des Tages, den der Tageswähler zeigt. Leer = alle Sätze.`,kind:`field`},mi()];function So(e,t){return w`<div class="fusszeile">
    <div class="seiten-info">${vo({hatQuelle:e.hatQuelle,sichtbar:e.sichtbar,gesamt:e.gesamt,suchtAktiv:e.suchtAktiv,auswahlAktiv:e.auswahlAktiv})}</div>
    <div class="seiten-nav">
  ...
  </div>`}var Co=`—`;function wo(e){return e.linealTakte===0?E:w`<div class="lineal" style=${ha(e.linealTakte===null?e.cols:{...e.cols,flex:`0 1 auto`,height:`calc(var(--zeilen-hoehe) * ${e.linealTakte})`})}>
          ${e.spalten.map(()=>w`<div></div>`)}
        </div>`}function To(e,t){return w`
      ...
      <div class="koerper">
      <div class="kopf" style=${ha(e.cols)}>
        ${e.spalten.map((n,r)=>w`<div
            class=${Ma(n.art).klasse}
            data-ff-editable
        ...
        ${e.zeilen.map(n=>w`<div
          ...
          >
            ${``}
            ${e.spalten.map((t,r)=>{let i=Ma(t.art),a=n===null?Co:e.datenzeilen[n]?.[r]??``,o=n===null?{}:e.zusatzzeilen[n]?.[r]??{};return w`<div class=${i.klasse}>${i.zelle(a,t.zuordnung??[],o)}</div>`})}
          </div>`)}
        ${wo(e)}`}
      </div>
    `}var Eo=o`
...
`,Q=class e extends A{constructor(...e){super(...e),this.spalten=Ra(),this.source=``,this.suche=`ja`,this.leerText=pi,this._suchtext=``,this.datenzeilen=[],this.zusatzzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this.datenGeliefert=!1,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._beobachter=null,this._taktGemessen=0}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.listenBindung=ro}static{this.defaultProps={width:`fill`,source:``,spalten:Ra(),suche:`ja`,tagField:``,leerText:pi}}static{this.customProperties=xo}static{this.raster={startW:14,startH:8,minW:6,minH:4}}messeRumpf(){let e=this.zeilenHoehe;this._taktGemessen=e;let t=Sa(this,e);t?.passen===this._mass?.passen&&t?.zeilenHoehe===this._mass?.zeilenHoehe||(this._mass=t,this.requestUpdate())}spaltenListe(){return Ha(this.spalten)}get zeilenHoehe(){return ja(this.spaltenListe())}klickZeile(e){if(e===null||this.hasAttribute(`data-ff-editor`))return;let t=R(this),n=this.rohzeilen[e];t===``||n===void 0||At(t,n)}setzeSuchtext(e){this._suchtext=e,this._seite=0,this.requestUpdate()}klickSortiere(e){this.editable||(this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.requestUpdate())}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}beobachte(){this._beobachter||(this._beobachter=Ca(this,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}connectedCallback(){super.connectedCallback(),Ja(this),this.beobachte()}firstUpdated(){this.beobachte()}updated(){this._taktGemessen!==this.zeilenHoehe&&this.messeRumpf()}disconnectedCallback(){super.disconnectedCallback(),to(this),this._beobachter?.disconnect(),this._beobachter=null,Ya(this)}static{this.styles=[A.styles,Yn,gi,Eo]}render(){let t=this.spaltenListe(),n=e=>e.stopPropagation(),r=bo({spalten:t,imEditor:this.hasAttribute(`data-ff-editor`),source:this.source,datenGeliefert:this.datenGeliefert,datenzeilen:this.datenzeilen,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,wunschSeite:this._seite,gemessen:this._mass});return w`<div class="tabelle" style=${ha({"--takt":`${r.takt}px`,"--zeilen-hoehe":`${r.zeilenHoehe}px`})}>
      ${Xa(()=>this.spaltenListe(),e=>this.aendere(e),n)}
      ${To({spalten:t,cols:r.cols,editable:this.editable,zeigeSuche:this.suche===`ja`,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,zeilen:r.zeilen,linealTakte:r.linealTakte,datenzeilen:this.datenzeilen,zusatzzeilen:this.zusatzzeilen,hatQuelle:r.hatQuelle,auswahlIndex:this.auswahlIndex,leer:r.leer,leerText:this.leerText},{setzeSuchtext:e=>this.setzeSuchtext(e),dblklickKopf:(e,t)=>{this.editable&&(to(this),Qa(e,t,()=>this.spaltenListe(),e=>this.aendere(e)))},klickKopf:(t,n)=>{this.editable&&no(this,t,e.listenBindung.prop,n),this.klickSortiere(n)},klickZeile:e=>this.klickZeile(e),stop:n})}
      ${``}
      ${r.leer?E:So({hatQuelle:r.hatQuelle,sichtbar:r.gesamt,gesamt:this.datenzeilen.length,suchtAktiv:this._suchtext.trim()!==``,auswahlAktiv:this.durchAuswahlGefiltert,seite:r.seite,seiten:r.seiten},{blaettere:e=>{this._seite=e,this.requestUpdate()},stop:n})}
    </div>`}};k([O({converter:{fromAttribute:e=>e?Ua(e):Ra(),toAttribute:e=>JSON.stringify(e)}})],Q.prototype,`spalten`,void 0),k([O()],Q.prototype,`source`,void 0),k([O()],Q.prototype,`suche`,void 0),k([O()],Q.prototype,`leerText`,void 0),k([O({attribute:!1})],Q.prototype,`datenzeilen`,void 0),k([O({attribute:!1})],Q.prototype,`zusatzzeilen`,void 0),k([O({attribute:!1})],Q.prototype,`rohzeilen`,void 0),k([O({attribute:!1})],Q.prototype,`auswahlIndex`,void 0),k([O({attribute:!1})],Q.prototype,`durchAuswahlGefiltert`,void 0),k([O({attribute:!1})],Q.prototype,`datenGeliefert`,void 0),A.defineAndRegister(Q);var Do=hr(`text`);function Oo(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(Do)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function ko(e){let t=Ir(e,Do);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function Ao(e){Oo(e)&&(e.text=``)}var jo=Ar({hydriere:ko,verdrahte:Ao}),Mo=jo.connect,No=jo.disconnect,Po=6,Fo=96,Io=14,Lo={duenn:`300`,normal:`400`,fett:`700`},Ro={links:`left`,mitte:`center`,rechts:`right`},zo={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},Bo=`standard`;function Vo(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(Fo,Math.max(Po,t)):Io}function Ho(e){return typeof e==`string`&&e in Lo?e:`normal`}function Uo(e){return typeof e==`string`&&e in Ro?e:`links`}function Wo(e){return typeof e==`string`&&e in zo?e:Bo}var $=class extends A{constructor(...e){super(...e),this.groesse=Io,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=Bo,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:Io,gewicht:`normal`,ausrichtung:`links`,farbe:Bo,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:Po,max:Fo,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[A.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return w`<div
      class="text"
      style=${ha({fontSize:`${Vo(this.groesse)}px`,fontWeight:Lo[Ho(this.gewicht)],textAlign:Ro[Uo(this.ausrichtung)],color:zo[Wo(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),Mo(this)}disconnectedCallback(){super.disconnectedCallback(),No(this)}};k([O({type:Number})],$.prototype,`groesse`,void 0),k([O()],$.prototype,`gewicht`,void 0),k([O()],$.prototype,`ausrichtung`,void 0),k([O()],$.prototype,`farbe`,void 0),k([O()],$.prototype,`text`,void 0),k([O()],$.prototype,`source`,void 0),k([O()],$.prototype,`textField`,void 0),A.defineAndRegister($);var Go=[`waagerecht`,`senkrecht`],Ko=`waagerecht`;function qo(e){return Go.includes(e)?e:Ko}var Jo=class extends A{constructor(...e){super(...e),this.richtung=Ko}static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`,richtung:Ko}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1,varianten:[{wenn:{attributeName:`richtung`,equals:`senkrecht`},startW:1,startH:6,breiteZiehbar:!1}]}}static{this.customProperties=[{attributeName:`richtung`,name:`Richtung`,description:`Waagerecht trennt oben von unten, senkrecht links von rechts.`,kind:`select`,options:[{value:`waagerecht`,label:`Waagerecht`},{value:`senkrecht`,label:`Senkrecht`}]}]}static{this.styles=[A.styles,o`
    ...
    `]}render(){return w`<div class="flaeche ${qo(this.richtung)}"><div class="linie"></div></div>`}};k([O()],Jo.prototype,`richtung`,void 0),A.defineAndRegister(Jo),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;H(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();
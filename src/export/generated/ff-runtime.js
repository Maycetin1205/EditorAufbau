...
\f\r]`,v=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,be=/-->/g,xe=/>/g,y=RegExp(`>|${ye}(?:([^\\s"'>=/]+)(${ye}*=${ye}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,`g`),Se=/'/g,Ce=/"/g,we=/^(?:script|style|textarea|title)$/i,Te=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),b=Te(1),x=Te(2),S=Symbol.for(`lit-noChange`),C=Symbol.for(`lit-nothing`),Ee=new WeakMap,w=h.createTreeWalker(h,129);function De(e,t){if(!_e(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return pe===void 0?t:pe.createHTML(t)}var Oe=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:t===3?`<math>`:``,o=v;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===v?c[1]===`!--`?o=be:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=y):(we.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=y):o=xe:o===y?c[0]===`>`?(o=i??v,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?y:c[3]===`"`?Ce:Se):o===Ce||o===Se?o=y:o===be||o===xe?o=v:(o=y,i=void 0);let d=o===y&&e[t+1].startsWith(`/>`)?` `:``;a+=o===v?n+ge:l>=0?(r.push(s),n.slice(0,l)+me+n.slice(l)+m+d):n+m+(l===-2?t:d)}return[De(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:t===3?`</math>`:``)),r]},ke=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=Oe(t,n);if(this.el=e.createElement(l,r),w.currentNode=this.el.content,n===2||n===3){let e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;(i=w.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes())for(let e of i.getAttributeNames())if(e.endsWith(me)){let t=u[o++],n=i.getAttribute(e).split(m),r=/([.?@])?(.*)/.exec(t);c.push({type:1,index:a,name:r[2],strings:n,ctor:r[1]===`.`?Ne:r[1]===`?`?Pe:r[1]===`@`?Fe:Me}),i.removeAttribute(e)}else e.startsWith(m)&&(c.push({type:6,index:a}),i.removeAttribute(e));if(we.test(i.tagName)){let e=i.textContent.split(m),t=e.length-1;if(t>0){i.textContent=fe?fe.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],g()),w.nextNode(),c.push({type:2,index:++a});i.append(e[t],g())}}}else if(i.nodeType===8)if(i.data===he)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(m,e+1))!==-1;)c.push({type:7,index:a}),e+=m.length-1}a++}}static createElement(e,t){let n=h.createElement(`template`);return n.innerHTML=e,n}};function T(e,t,n=e,r){if(t===S)return t;let i=r===void 0?n._$Cl:n._$Co?.[r],a=_(t)?void 0:t._$litDirective$;return i?.constructor!==a&&(i?._$AO?.(!1),a===void 0?i=void 0:(i=new a(e),i._$AT(e,n,r)),r===void 0?n._$Cl=i:(n._$Co??=[])[r]=i),i!==void 0&&(t=T(e,i._$AS(e,t.values),i,r)),t}var Ae=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??h).importNode(t,!0);w.currentNode=r;let i=w.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new je(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new Ie(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=w.nextNode(),a++)}return w.currentNode=h,r}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},je=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,r){this.type=2,this._$AH=C,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=T(this,e,t),_(e)?e===C||e==null||e===``?(this._$AH!==C&&this._$AR(),this._$AH=C):e!==this._$AH&&e!==S&&this._(e):e._$litType$===void 0?e.nodeType===void 0?ve(e)?this.k(e):this._(e):this.T(e):this.$(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==C&&_(this._$AH)?this._$AA.nextSibling.data=e:this.T(h.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=ke.createElement(De(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.p(t);else{let e=new Ae(r,this),n=e.u(this.options);e.p(t),this.T(n),this._$AH=e}}_$AC(e){let t=Ee.get(e.strings);return t===void 0&&Ee.set(e.strings,t=new ke(e)),t}k(t){_e(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.O(g()),this.O(g()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let t=de(e).nextSibling;de(e).remove(),e=t}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},Me=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,r,i){this.type=1,this._$AH=C,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=C}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=T(this,e,t,0),a=!_(e)||e!==this._$AH&&e!==S,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=T(this,r[n+o],t,o),s===S&&(s=this._$AH[o]),a||=!_(s)||s!==this._$AH[o],s===C?e=C:e!==C&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===C?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},Ne=class extends Me{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===C?void 0:e}},Pe=class extends Me{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==C)}},Fe=class extends Me{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=T(this,e,t,0)??C)===S)return;let n=this._$AH,r=e===C&&n!==C||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==C&&(n===C||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Ie=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){T(this,e)}},Le=ue.litHtmlPolyfillSupport;Le?.(ke,je),(ue.litHtmlVersions??=[]).push(`3.3.3`);var Re=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new je(t.insertBefore(g(),e),e,void 0,n??{})}return i._$AI(e),i},ze=globalThis,E=class extends p{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Re(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return S}};E._$litElement$=!0,E.finalized=!0,ze.litElementHydrateSupport?.({LitElement:E});var Be=ze.litElementPolyfillSupport;Be?.({LitElement:E}),(ze.litElementVersions??=[]).push(`4.2.2`);var Ve={attribute:!0,type:String,converter:se,reflect:!1,hasChanged:ce},He=(e=Ve,t,n)=>{let{kind:r,metadata:i}=n,a=globalThis.litPropertyMetadata.get(i);if(a===void 0&&globalThis.litPropertyMetadata.set(i,a=new Map),r===`setter`&&((e=Object.create(e)).wrapped=!0),a.set(n.name,e),r===`accessor`){let{name:r}=n;return{set(n){let i=t.get.call(this);t.set.call(this,n),this.requestUpdate(r,i,e,!0,n)},init(t){return t!==void 0&&this.C(r,void 0,e,t),t}}}if(r===`setter`){let{name:r}=n;return function(n){let i=this[r];t.call(this,n),this.requestUpdate(r,i,e,!0,n)}}throw Error(`Unsupported decorator location: `+r)};function D(e){return(t,n)=>typeof n==`object`?He(e,t,n):((e,t,n)=>{let r=t.hasOwnProperty(n);return t.constructor.createProperty(n,e),r?Object.getOwnPropertyDescriptor(t,n):void 0})(e,t,n)}function Ue(e){return D({...e,state:!0,attribute:!1})}var We=new Map;function Ge(e){We.has(e.type)&&console.warn(`Block-Typ "${e.type}" wird ueberschrieben.`),We.set(e.type,e)}function Ke(){return Array.from(We.values())}var qe={width:`auto`},Je={rasterX:0,rasterY:0,rasterW:{spalten:24,spaltePx:40,zeilePx:12,gapPx:8}.spalten,rasterH:1},Ye=`weitereQuellen`,Xe={[Ye]:[]},Ze=`folgtAuswahl`,Qe={[Ze]:[]};function O(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var k=class extends E{constructor(...e){super(...e),this.editable=!1}static{this.styles=o`
  ...
  `}static{this.customProperties=[]}get customProperties(){return this.constructor.customProperties}inlineEdit(e,t){if(!this.editable)return;let n=e.currentTarget;if(!n||n.hasAttribute(`data-ff-bound`))return;e.stopPropagation(),e.preventDefault();let r=n.textContent??``,i=Array.from(n.childNodes),a=i.map(e=>e.textContent??``);n.setAttribute(`contenteditable`,`plaintext-only`),n.focus();let o=window.getSelection(),s=document.createRange();s.selectNodeContents(n),o?.removeAllRanges(),o?.addRange(s);let c=!1,l=e=>{if(!c)if(c=!0,n.removeAttribute(`contenteditable`),n.removeEventListener(`blur`,u),n.removeEventListener(`keydown`,d),e){let e=(n.textContent??``).trim();e!==r&&this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:t,value:e},bubbles:!0,composed:!0}))}else n.replaceChildren(...i),i.forEach((e,t)=>{e.textContent!==a[t]&&(e.textContent=a[t])})},u=()=>l(!0),d=e=>{e.key===`Enter`?(e.preventDefault(),n.blur()):e.key===`Escape`&&(e.preventDefault(),l(!1))};n.addEventListener(`blur`,u),n.addEventListener(`keydown`,d)}static defineAndRegister(e){customElements.get(e.tagName)||customElements.define(e.tagName,e),Ge({type:e.blockType,tagName:e.tagName,displayName:e.displayName,category:e.category,defaultProps:{...qe,...Je,...e.acceptsDataSource?Xe:null,...e.kannAuswahlFolgen?Qe:null,...e.defaultProps},customProperties:e.customProperties,acceptsChildren:e.acceptsChildren??!1,resizableWidth:e.resizableWidth??!0,resizableHeight:e.resizableHeight??!1,allowedChildTypes:e.allowedChildTypes,allowedParentTypes:e.allowedParentTypes,lockedWidth:e.lockedWidth,defaultChildren:e.defaultChildren,childDirection:e.childDirection,showInPalette:e.showInPalette,templateChild:e.templateChild,containerHint:e.containerHint,addChildButton:e.addChildButton,acceptsDataSource:e.acceptsDataSource,auswahlGeber:e.auswahlGeber,kannAuswahlFolgen:e.kannAuswahlFolgen,bindableSpots:e.bindableSpots,actionValueSpots:e.actionValueSpots,listenBindung:e.listenBindung,blockEvents:e.blockEvents,pageBlock:e.pageBlock,raster:e.raster})}};O([D({type:Boolean,reflect:!0,attribute:`data-editable`})],k.prototype,`editable`,void 0);var $e=`data-ff-block-id`,et=[`fixed`,`context`,`data_field`,`block_value`,`gewaehlte_zeile`,`previous_result`,`step_result`,`se_variable`];function tt(e){return!!e&&typeof e==`object`&&!Array.isArray(e)}function nt(e){return!tt(e)||typeof e.source!=`string`||!et.includes(e.source)||typeof e.value!=`string`||e.dataSourceId!==void 0&&typeof e.dataSourceId!=`string`||e.blockId!==void 0&&typeof e.blockId!=`string`?null:{source:e.source,value:e.value,...typeof e.dataSourceId==`string`?{dataSourceId:e.dataSourceId}:{},...typeof e.blockId==`string`?{blockId:e.blockId}:{}}}function rt(e){if(!tt(e)||typeof e.type!=`string`||typeof e.resultKey!=`string`)return null;if(e.type===`START_TOOL`)return typeof e.toolNr!=`string`||!Array.isArray(e.toolParams)||e.toolParams.some(e=>typeof e!=`string`)?null:{type:`START_TOOL`,resultKey:e.resultKey,toolNr:e.toolNr,toolParams:[...e.toolParams]};if(e.type===`POPUP_OPEN`||e.type===`POPUP_CLOSE`){let t=typeof e.popupId==`string`?e.popupId:void 0,n=typeof e.popup==`string`?e.popup:void 0;return t===void 0&&n===void 0?null:{type:e.type,resultKey:e.resultKey,...t===void 0?{}:{popupId:t},...n===void 0?{}:{popup:n}}}if(e.type===`RELATION`){if(typeof e.relationId!=`string`||!Array.isArray(e.extraParams)||!Array.isArray(e.params)&&!tt(e.bindings))return null;let t=[];if(Array.isArray(e.params))for(let n of e.params){let e=nt(n);if(!e)return null;t.push(e)}let n=[];for(let t of e.extraParams){let e=nt(t);if(!e)return null;n.push(e)}return{type:`RELATION`,resultKey:e.resultKey,relationId:e.relationId,params:t,extraParams:n}}return null}function it(e){if(!e)return{};let t;try{t=JSON.parse(e)}catch{return{}}if(!tt(t))return{};let n={};for(let[e,r]of Object.entries(t)){if(!Array.isArray(r)||r.length===0)continue;let t=[],i=!1;for(let e of r){let n=rt(e);if(!n){i=!0;break}t.push(n)}!i&&t.length>0&&(n[e]=t)}return n}function A(e){return typeof e==`object`&&!!e}function j(e,t){if(!(!Array.isArray(e)||t===``)){for(let n of e)if(!(!A(n)||n.id!==t)&&!(typeof n.name!=`string`||typeof n.tableId!=`string`))return{id:t,name:n.name,tableId:n.tableId,indexField:typeof n.indexField==`string`?n.indexField:``}}}function at(e){return e==null?``:String(e).trim()}function M(e,t){if(!A(e)||t===``)return``;let n=t.trim(),r=at(e[n]);if(r!==``)return r;for(let t of Object.keys(e))if(t===n||t.startsWith(`${n}_`)||t.endsWith(`_${n}`)){let n=at(e[t]);if(n!==``)return n}let i=/^(\d+)_(\d+)$/.exec(n);if(!i)return``;let a=at(e.SATZNEU??e.SATZ??e.satzneu??e.satz??e.RAW??e.raw);if(a===``)return``;let o=Number(i[1]),s=Number(i[2]);return s<=0?``:a.substring(o,o+s).trim()}function ot(e,t,n){if(!A(e)||t===``)return!1;let r=t.trim(),i=!1;for(let t of Object.keys(e))(t===r||t.startsWith(`${r}_`)||t.endsWith(`_${r}`))&&(e[t]=n,i=!0);let a=/^(\d+)_(\d+)$/.exec(r);if(a){let t=[`SATZNEU`,`SATZ`,`satzneu`,`satz`,`RAW`,`raw`].find(t=>typeof e[t]==`string`);if(t){let r=e[t],o=Number(a[1]),s=Number(a[2]);if(s>0){let a=n.length>s?n.slice(0,s):n.padEnd(s,` `),c=r.length<o?r.padEnd(o,` `):r;e[t]=c.slice(0,o)+a+c.slice(o+s),i=!0}}}return i}function st(e){if(!A(e))return Array.isArray(e)?e:[];let t=[e.Zeilen,e.zeilen,e.Saetze,e.saetze,e.Rows,e.rows,e.Daten,e.daten];for(let e of t){if(Array.isArray(e))return e;if(typeof e==`string`)try{let t=JSON.parse(e);if(Array.isArray(t))return t}catch{}}return[]}function N(e,t){return at(e).toLowerCase()===t.trim().toLowerCase()}function P(e,t,n){if(!A(e)||!A(e.Daten))return[];let r=e.Daten,i=r.SEFileLoop;if(Array.isArray(i)){for(let e of i)if(A(e)&&(N(e.ALIAS,t)||N(e.alias,t))){let t=st(e);if(t.length>0)return t}}else if(A(i))for(let e of Object.keys(i)){let n=i[e];if(N(e,t)||A(n)&&(N(n.ALIAS,t)||N(n.alias,t))){let e=st(n);if(e.length>0)return e}}let a=r.Tabellen;if(A(a)){let e=[t,t.toUpperCase(),t.toLowerCase(),n];for(let t of e)if(t!==``&&t in a){let e=st(a[t]);if(e.length>0)return e}for(let e of Object.keys(a))if(N(e,t)){let t=st(a[e]);if(t.length>0)return t}}return[]}function ct(e){let t=e;if(typeof t==`string`)try{t=JSON.parse(t)}catch{return}if(!A(t)||!A(t.Daten))return;let n=t.Daten;if(!(!n.SEFileLoop&&!n.Tabellen&&!n.ErpApiCall))return n}function lt(e){let t=e;if(typeof t==`string`)try{t=JSON.parse(t)}catch{return}if(!(!A(t)||!A(t.MSG)))return t.MSG.DATA}function ut(e){if(e==null)return``;try{return JSON.stringify(e)??``}catch{return``}}var F=new Map,dt=new Set,ft=!1,pt=!1;function mt(){if(ft){pt=!0;return}ft=!0;try{do pt=!1,dt.forEach(e=>e());while(pt)}finally{ft=!1}}function ht(e){dt.add(e)}function gt(e){return F.get(e)?.zeile}function _t(e){return F.get(e)?.merkmal??``}function vt(e){return e.getAttribute(`data-ff-id`)??``}function yt(e,t,n){if(e===``)return[];let r=_t(e);if(r===``)return[];let i=[];return t.forEach((e,t)=>{ut(n(e))===r&&i.push(t)}),i.length===0&&xt(e),i}function bt(e,t){if(e===``)return;let n=ut(t);if(n===``)return;let r=F.get(e);r&&r.merkmal===n?F.delete(e):F.set(e,{zeile:t,merkmal:n}),mt()}function xt(e){F.has(e)&&(F.delete(e),mt())}var St=Ze.toLowerCase();function Ct(e){let t=e.getAttribute(St)??``;if(t===``)return[];try{let e=JSON.parse(t);if(!Array.isArray(e))return[];let n=[];for(let t of e){if(!t||typeof t!=`object`)continue;let e=t;if(typeof e.geberId!=`string`||e.geberId===``)continue;let r=[];for(let t of Array.isArray(e.keyPairs)?e.keyPairs:[]){if(!t||typeof t!=`object`)continue;let e=t;typeof e.fromField!=`string`||typeof e.toField!=`string`||e.fromField.trim()===``||e.toField.trim()===``||r.push({fromField:e.fromField,toField:e.toField})}r.length!==0&&n.push({geberId:e.geberId,keyPairs:r})}return n}catch{return[]}}function wt(e,t){let n=t,r=!1;for(let t of Ct(e)){let e=gt(t.geberId);e!==void 0&&(r=!0,n=n.filter(n=>t.keyPairs.every(t=>{let r=M(e,t.fromField);return r!==``&&r===M(n,t.toField)})))}return{rows:n,gefiltert:r}}function Tt(e,t){if(Ct(e).length===0)return t[0];let{rows:n,gefiltert:r}=wt(e,t);return r?n[0]:void 0}var Et=`root`;function Dt(e,t){let n=Number(e);return Number.isFinite(n)&&n>0?n:t}var I=class extends k{constructor(...e){super(...e),this.name=`Popup`,this.breite=520,this.hoehe=380}static{this.blockType=`popup`}static{this.tagName=`ff-popup`}static{this.displayName=`Popup`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.showInPalette=!1}static{this.allowedParentTypes=[Et]}static{this.pageBlock=!0}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.defaultProps={name:`Popup`,breite:520,hoehe:380}}static{this.styles=[k.styles,o`
    ...
    `]}onClose(){this.hasAttribute(`data-ff-editor`)||this.removeAttribute(`offen`)}render(){return b`<div class="abdunklung"></div>
      <div class="buehne">
        <div class="fenster" style="width:${Dt(this.breite,520)}px;height:${Dt(this.hoehe,380)}px">
          <div class="kopf">
            <span
              class="titel"
              data-ff-editable
      ...
      </div>`}};O([D()],I.prototype,`name`,void 0),O([D()],I.prototype,`breite`,void 0),O([D()],I.prototype,`hoehe`,void 0),k.defineAndRegister(I);var Ot=[`GET_RELATION`,`PUT_RELATION`,`PUTADD_RELATION`];function kt(e){return`${String(e.getDate()).padStart(2,`0`)}.${String(e.getMonth()+1).padStart(2,`0`)}.${e.getFullYear()}`}function At(e,t){return e.params.map(e=>e.replace(/\{([A-Za-z0-9_]+)\}/g,(e,n)=>String(t[n]??``)))}var jt=8e3,L=null,R=null;function Mt(){let e=document.createElement(`div`);return e.setAttribute(`data-ff-meldung`,``),e.setAttribute(`role`,`alert`),e.style.cssText=[`position:fixed`,`top:0`,`left:0`,`right:0`,`z-index:2147483647`,`padding:7px 12px`,`background:var(--se-red-soft,#fbe7e6)`,`color:var(--se-red,#c0201a)`,`border-bottom:1px solid var(--se-red,#c0201a)`,`font:500 12px/1.4 system-ui,sans-serif`,`cursor:pointer`].join(`;`),e.title=`Klicken zum Schliessen`,e.addEventListener(`click`,Nt),e}function Nt(){R&&=(clearTimeout(R),null),L?.remove(),L=null}function z(e){typeof document>`u`||!document.body||(L||(L=Mt(),document.body.appendChild(L)),L.textContent=e,R&&clearTimeout(R),R=setTimeout(Nt,jt))}function B(){return globalThis}function Pt(){let e=B();return A(e.SEDATA)&&A(e.SEDATA.Daten)}function Ft(){let e=B();try{e.selib?.Json?.InitializeERPConnection?.()}catch{}try{typeof e.InitialisiereSchnittstelle==`function`&&e.InitialisiereSchnittstelle()}catch{}}function It(){let e=B();try{typeof e.ResetDataBasis==`function`&&e.ResetDataBasis()}catch{}try{typeof e.InitialisiereDatenBasis==`function`&&e.InitialisiereDatenBasis()}catch{}}var Lt=new Set,Rt=new Set;function zt(e){Lt.add(e)}function Bt(e){return Rt.add(e),()=>{Rt.delete(e)}}function Vt(){Lt.forEach(e=>e())}function Ht(e){Rt.forEach(t=>{try{t(e)}catch{}})}var V=new Map,Ut=``,Wt=0;function Gt(){try{let e=document.getElementById(`ff-se-diagnose`);return!e&&document.body&&(e=document.createElement(`textarea`),e.id=`ff-se-diagnose`,e.readOnly=!0,e.style.cssText=`display:none;position:fixed;left:8px;right:8px;bottom:8px;height:40vh;z-index:99999;font:11px monospace;`,document.body.appendChild(e)),e}catch{return null}}function Kt(){let e=Gt();e&&(e.value=Array.from(V,([e,t])=>`${e}: ${t}`).join(`
`)+(Ut===``?``:`\n\nERSTES PAKET\n${Ut}`))}function H(e,t){V.set(e,t),Kt()}function qt(){let e=B();V.set(`basisHTML_REGISTER`,typeof e.basisHTML_REGISTER==`function`?`vorhanden`:`fehlt`),V.set(`basisHTML_SND_MSG`,typeof e.basisHTML_SND_MSG==`function`?`vorhanden`:`fehlt`),V.set(`body.pid`,document.body?.getAttribute(`pid`)?`gesetzt`:`fehlt`),V.set(`body.REGMSG`,document.body?.getAttribute(`REGMSG`)?`gesetzt`:`fehlt`),V.set(`Empfangene Pakete`,String(Wt)),V.set(`SEDATA.Daten`,Pt()?`vorhanden`:`fehlt`),Kt()}function Jt(e){if(Ut===``)try{Ut=typeof e==`string`?e:JSON.stringify(e)??``,Kt()}catch{}}function Yt(e){Wt+=1,Jt(e),H(`Empfangene Pakete`,String(Wt));let t=ct(e);if(!t){H(`Letztes Paket`,`Antwort ohne Daten`),Ht(e);return}let n=B();A(n.SEDATA)||(n.SEDATA={}),n.SEDATA.Daten=t,H(`Letztes Paket`,`Daten-Push angenommen`),H(`SEDATA.Daten`,`vorhanden`),It(),Vt()}function Xt(e=0){let t=B();if(typeof t.basisHTML_REGISTER==`function`){qt();try{t.basisHTML_SetConsoleLog?.(!0,!0)}catch{}try{t.basisHTML_REGISTER(e=>{Yt(e)},document.title,`1.0`),H(`Registrierung`,`ausgeführt`)}catch(e){H(`Registrierung`,`Fehler: ${e instanceof Error?e.message:String(e)}`)}return}e<400?(e===0&&H(`Registrierung`,`wartet auf Interface`),setTimeout(()=>{Xt(e+1)},25)):(qt(),H(`Registrierung`,`nach 10s kein Interface`),z(`SoftEngine-Anschluss nicht gefunden — die Maske bleibt ohne Daten (Strg+Alt+D für Details).`))}var Zt=!1;function Qt(){if(Zt)return;Zt=!0,H(`Runtime`,`gestartet`),H(`Registrierung`,`noch nicht ausgeführt`),qt(),Ft();let e=B();e.Erstellen=()=>{It(),Vt()},e.initData=e.Erstellen,e.ReloadData=()=>{Vt()},Xt(),window.addEventListener(`message`,e=>{if(typeof B().basisHTML_REGISTER==`function`)return;let t=lt(e.data);t!==void 0&&Yt(t)},!0),document.addEventListener(`keydown`,e=>{if(e.ctrlKey&&e.altKey&&e.key.toLowerCase()===`d`){qt();let e=document.getElementById(`ff-se-diagnose`);e&&(e.style.display=e.style.display===`none`?`block`:`none`)}});let t=0,n=setInterval(()=>{t+=1,Pt()?(clearInterval(n),H(`SEDATA.Daten`,`vorhanden`),It(),Vt()):t>100&&(clearInterval(n),H(`Daten-Wartezeit`,`nach 30s ohne Daten`),z(`Keine Daten von SoftEngine empfangen — die Maske zeigt nichts an (Strg+Alt+D für Details).`))},300)}function $t(e){return e instanceof Error?e.message:String(e)}function en(e,t){if(!(!Array.isArray(e)||t===``)){for(let n of e)if(!(!A(n)||n.id!==t)&&!(typeof n.verb!=`string`||!Ot.includes(n.verb))&&!(typeof n.nr!=`string`||n.nr===``)&&!(!Array.isArray(n.params)||n.params.some(e=>typeof e!=`string`)))return{id:t,verb:n.verb,nr:n.nr,params:n.params}}}var tn=[`RESULT`,`result`,`PINDEX`,`pindex`,`INDEX`,`index`,`0_10`,`KEY`,`key`,`ID`,`id`,`VALUE`,`value`];function nn(e){if(typeof e!=`string`)return e;try{return JSON.parse(e)}catch{return}}function rn(e){if(typeof e==`string`)return e.trim()===``?void 0:e.trim();if(typeof e==`number`||typeof e==`boolean`)return String(e)}function an(e,t){if(t>12)return;let n=rn(e);if(n!==void 0)return n;if(Array.isArray(e)){for(let n of e){let e=an(n,t+1);if(e!==void 0)return e}return}if(A(e)){for(let n of tn){if(!(n in e))continue;let r=an(e[n],t+1);if(r!==void 0)return r}for(let n of Object.values(e)){let e=an(n,t+1);if(e!==void 0)return e}}}function on(e){let t=nn(e);if(A(t)){for(let e of tn){if(!(e in t))continue;let n=an(t[e],0);if(n!==void 0)return n}for(let e of Object.values(t))if(Array.isArray(e))for(let t of e){let e=on(t);if(e!==void 0)return e}else if(A(e)){let t=on(e);if(t!==void 0)return t}}}function sn(e){return A(e)?Object.keys(e).filter(e=>/^Message\d+$/.test(e)):[]}function cn(e,t){if(!A(e))return;let n=sn(e).filter(e=>!t.has(e)).sort((e,t)=>Number(t.slice(7))-Number(e.slice(7)));for(let t of n){let n=on(e[t]);if(n!==void 0)return n}}var ln=[],un=!1,dn=6e3,fn=100;function pn(){if(un||ln.length===0)return;un=!0;let e=ln.shift(),t=B(),n=new Set(sn(t.SEDATA)),r=!1,i=t=>{r||(r=!0,a(),clearInterval(o),clearTimeout(s),un=!1,e.resolve(t),pn())},a=Bt(e=>{let t=on(e);t!==void 0&&i(t)}),o=setInterval(()=>{let e=cn(B().SEDATA,n);e!==void 0&&i(e)},fn),s=setTimeout(()=>{z(`Daten laden: SoftEngine hat nicht geantwortet (Relation Nr. ${e.template.nr}).`),i(``)},dn);if(typeof t.basisHTML_SND_MSG!=`function`){z(`Daten laden nicht moeglich: keine Verbindung zu SoftEngine.`),i(``);return}try{t.basisHTML_SND_MSG(`GET_RELATION`,{NR:e.template.nr,PARAMS:e.params})}catch(t){z(`Daten laden fehlgeschlagen (Relation Nr. ${e.template.nr}): ${$t(t)}`),i(``)}}function mn(e,t){Qt();let n=B();if(e.verb!==`GET_RELATION`){if(typeof n.basisHTML_SND_MSG!=`function`)return z(`Speichern nicht moeglich: keine Verbindung zu SoftEngine. Die Eingabe wurde NICHT uebernommen.`),Promise.resolve(``);try{n.basisHTML_SND_MSG(e.verb,{NR:e.nr,PARAMS:[...t]})}catch(t){z(`Speichern fehlgeschlagen (Relation Nr. ${e.nr}): ${$t(t)}`)}return Promise.resolve(``)}return new Promise(n=>{ln.push({template:e,params:[...t],resolve:n}),pn()})}function hn(e,t){if(!A(t))return``;let n=t.document;if(!n||typeof n.querySelectorAll!=`function`)return``;let r=Array.from(n.querySelectorAll(`[${$e}]`)).find(t=>t.getAttribute($e)===e.blockId);if(!r)return``;let i=r[e.value];return i==null?``:String(i)}function gn(e,t,n=B()){if(e.source===`fixed`)return e.value;if(e.source===`context`)return t.context[e.value]??``;if(e.source===`previous_result`)return t.previousResult;if(e.source===`step_result`){let n=Number(e.value);return Number.isInteger(n)&&n>=0?t.stepResults?.[n]??``:``}if(e.source===`block_value`)return hn(e,n);if(e.source===`gewaehlte_zeile`){let n=t.gewaehlteZeile?.(e.blockId??``);return n===void 0?``:M(n,e.value)}if(!A(n))return``;if(e.source===`se_variable`){let t=n.SEDATA;if(!A(t)||!A(t.Daten)||!A(t.Daten.VARArrays))return``;let r=t.Daten.VARArrays[e.value];return r==null?``:String(r)}let r=j(n.FF_DATA_SOURCES,e.dataSourceId??``);if(!r)return``;let i=P(n.SEDATA,r.name,r.tableId),a=t.context.PINDEX??``,o=a!==``&&r.indexField!==``?i.find(e=>M(e,r.indexField)===a):i[0];return o?M(o,e.value):``}function _n(e,t){let n=`0,START_TOOL,`+e;return t.length>0&&(n+=`,`+t.map(e=>encodeURIComponent(e)).join(`,`)),n}function vn(e,t){if(e.trim()===``)return;let n=B();try{if(typeof n.sendBWLinkIntern==`function`){n.sendBWLinkIntern(_n(e,t));return}}catch{}try{if(typeof n.basisHTML_SND_MSG==`function`){let r={NR:e};t.length>0&&(r.PARAMS=[...t]),n.basisHTML_SND_MSG(`START_TOOL`,r)}}catch{}}function yn(e,t,n){if(t.trim()!==``)for(let r of Array.from(e.querySelectorAll(I.tagName)))(r.getAttribute(`name`)??I.defaultProps.name)===t&&(n?r.setAttribute(`offen`,``):r.removeAttribute(`offen`))}var bn=new WeakMap;function xn(e){z(`Aktionskette fehlgeschlagen: `+(e instanceof Error?e.message:String(e)))}async function Sn(e,t,n){if(e.hasAttribute(`data-ff-editor`))return;let r=it(e.getAttribute(`data-ff-aktionen`))[t];if(!r||r.length===0)return;let i=bn.get(e);if(i||(i=new Set,bn.set(e,i)),!i.has(t)){i.add(t);try{let t={...n,NOW_DATE:kt(new Date)},i=``,a=[];for(let n of r){if(n.type===`START_TOOL`){vn(n.toolNr,At({params:n.toolParams},t)),a.push(``);continue}if(n.type===`POPUP_OPEN`||n.type===`POPUP_CLOSE`){yn(e.ownerDocument??document,n.popup??``,n.type===`POPUP_OPEN`),a.push(``);continue}let r=en(B().FF_RELATIONS,n.relationId);if(!r){a.push(``);continue}let o={context:t,previousResult:i,stepResults:a,gewaehlteZeile:gt},s=await mn(r,[...n.params,...n.extraParams].map(e=>gn(e,o)));a.push(s),r.verb===`GET_RELATION`&&(i=s),n.resultKey!==``&&(t[n.resultKey]=s)}}finally{i.delete(t)}}}var Cn=new WeakSet;function wn(e,t){if(e.hasAttribute(`data-ff-editor`)||!e.hasAttribute(`data-ff-aktionen`)||Cn.has(e))return;Cn.add(e);let n=it(e.getAttribute(`data-ff-aktionen`));Object.values(n).some(e=>e.some(e=>e.type===`RELATION`))&&Qt(),e.addEventListener(`click`,()=>{Sn(e,t,{}).catch(xn)})}var Tn=class extends k{constructor(...e){super(...e),this.label=`Klick mich`}static{this.blockType=`button`}static{this.tagName=`ff-button`}static{this.displayName=`Schaltfläche`}static{this.category=`eingabe`}static{this.defaultProps={label:`Klick mich`}}static{this.resizableWidth=!1}static{this.blockEvents=[{key:`onClick`,name:`Klick`}]}static{this.raster={startW:4,startH:2,minW:2,minH:2}}static{this.customProperties=[]}static{this.styles=[k.styles,o`
      button {
        box-sizing: border-box;
        padding: 7px 16px;
        cursor: pointer;
    ...
    >${this.label}</button>`}connectedCallback(){super.connectedCallback(),wn(this,`onClick`)}};O([D()],Tn.prototype,`label`,void 0),k.defineAndRegister(Tn);var En=[`info`,`success`,`warning`,`danger`];function Dn(e){return En.includes(e)?e:`info`}function On(e,t){return{attributeName:e,name:`Farbe`,description:t,kind:`select`,options:[{value:`info`,label:`Hinweis`},{value:`success`,label:`Erfolg`},{value:`warning`,label:`Warnung`},{value:`danger`,label:`Fehler`}]}}var kn=o`
  .chip {
...
`,An={dog:x`<ellipse cx="12" cy="13.5" rx="6.3" ry="7"></ellipse><ellipse cx="5.2" cy="11.5" rx="2.4" ry="5.2" transform="rotate(14 5.2 11.5)"></ellipse><ellipse cx="18.8" cy="11.5" rx="2.4" ry="5.2" transform="rotate(-14 18.8 11.5)"></ellipse>`,cat:x`<path d="M5.2 10.5 L3.6 3.2 L10 6.4 Z"></path><path d="M18.8 10.5 L20.4 3.2 L14 6.4 Z"></path><circle cx="12" cy="13.5" r="7"></circle>`,rabbit:x`<ellipse cx="8.8" cy="6.5" rx="2.3" ry="5.6" transform="rotate(-10 8.8 6.5)"></ellipse><ellipse cx="15.2" cy="6.5" rx="2.3" ry="5.6" transform="rotate(10 15.2 6.5)"></ellipse><circle cx="12" cy="16" r="6.2"></circle>`,hamster:x`<circle cx="7.6" cy="8.8" r="2"></circle><ellipse cx="12" cy="14" rx="8.3" ry="6"></ellipse>`,bird:x`<circle cx="9.2" cy="8.8" r="4.6"></circle><ellipse cx="12.5" cy="14.8" rx="5.2" ry="5.4"></ellipse><path d="M5.2 7.6 L2 9.2 L5.4 10.6 Z"></path><path d="M15.5 16.5 L22 20.5 L17.6 13.8 Z"></path>`,reptile:x`<path d="M4.5 14.8 Q4.5 7.2 12 7.2 Q19.5 7.2 19.5 14.8 Z"></path><circle cx="20.6" cy="13.9" r="2.1"></circle><rect x="6.2" y="14.6" width="2.6" height="3" rx="1.2"></rect><rect x="13.4" y="14.6" width="2.6" height="3" rx="1.2"></rect>`,paw:x`<circle cx="6.8" cy="9.6" r="1.9"></circle><circle cx="10.4" cy="7.2" r="1.9"></circle><circle cx="14.6" cy="7.2" r="1.9"></circle><circle cx="18.2" cy="9.6" r="1.9"></circle><path d="M12.5 11.2c-2.9 0-5.3 2.1-5.3 4.4 0 1.7 1.3 2.9 3.1 2.9.9 0 1.5-.3 2.2-.3s1.3.3 2.2.3c1.8 0 3.1-1.2 3.1-2.9 0-2.3-2.4-4.4-5.3-4.4z"></path>`},jn=[[`welpe`,`dog`],[`hund`,`dog`],[`kater`,`cat`],[`katze`,`cat`],[`kaninchen`,`rabbit`],[`hase`,`rabbit`],[`meerschweinchen`,`hamster`],[`hamster`,`hamster`],[`ratte`,`hamster`],[`maus`,`hamster`],[`wellensittich`,`bird`],[`sittich`,`bird`],[`papagei`,`bird`],[`vogel`,`bird`],[`schildkr`,`reptile`],[`echse`,`reptile`],[`schlange`,`reptile`],[`gecko`,`reptile`],[`reptil`,`reptile`]];function Mn(e){let t=e.toLowerCase(),n=`paw`;for(let[e,r]of jn)if(t.includes(e)){n=r;break}return b`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">${An[n]}</svg>`}var U=class extends k{constructor(...e){super(...e),this.chipVariant=`info`,this.heading=``,this.heading2=``,this.time=``,this.date=``,this.avatar=``,this.meta=``,this.text=``,this.chipText=``,this.headingField=``,this.heading2Field=``,this.timeField=``,this.dateField=``,this.avatarField=``,this.metaField=``,this.textField=``,this.chipTextField=``}static{this.blockType=`card`}static{this.tagName=`ff-card`}static{this.displayName=`Karte`}static{this.category=`anzeige`}static{this.allowedParentTypes=[`kanban-spalte`]}static{this.showInPalette=!1}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={chipVariant:`info`,heading:``,heading2:``,time:``,date:``,avatar:``,meta:``,text:``,chipText:``,headingField:``,heading2Field:``,timeField:``,dateField:``,avatarField:``,metaField:``,textField:``,chipTextField:``}}static{this.bindableSpots=[{prop:`time`,label:`Zeit`},{prop:`date`,label:`Datum`},{prop:`avatar`,label:`Avatar`},{prop:`heading`,label:`Titel`},{prop:`heading2`,label:`Titel 2`},{prop:`meta`,label:`Unterzeile`},{prop:`text`,label:`Textzeile`},{prop:`chipText`,label:`Chip`}]}static{this.customProperties=[On(`chipVariant`,`Bedeutung des Chips auf der Karte — bestimmt die Chip-Farbe.`)]}static{this.styles=[k.styles,kn,o`
      .card {
        box-sizing: border-box;
        display: flex;
        flex-direction: column;
    ...
    >${this[e]}</span>`}render(){let e=Dn(this.chipVariant),t=this.hasAttribute(`data-ff-editor`),n=e=>t||e.trim()!==``,r=n(this.heading)||n(this.heading2),i=n(this.time)||n(this.date);return b`<div class="card v-${e}">
      ${n(this.avatar)||r||n(this.meta)||i?b`<div class="main">
            ${n(this.avatar)?b`<span
                  class="avatar"
                  data-ff-spot="avatar"
                  ?data-ff-bound=${this.avatarField!==``}
                >${this.avatar.trim()===``?C:Mn(this.avatar)}</span>`:C}
            <div class="titles">
              ${r?b`<div class="trow">
    ...
    `]}setzeTag(e){Rn(e),this.tag=W()}render(){return b`<div class="waehler">
      <div class="riegel">
        <button class="pfeil" title="Vortag" @click=${()=>this.setzeTag(Fn(this.tag,-1))}>‹</button>
        <input
          class="feld"
          type="date"
          .value=${this.tag}
        ...
        />
        <button class="pfeil" title="Folgetag" @click=${()=>this.setzeTag(Fn(this.tag,1))}>›</button>
      </div>
      <button class="heute" @click=${()=>this.setzeTag(Pn(new Date))}>Heute</button>
    </div>`}connectedCallback(){super.connectedCallback(),this.tag=W()||Pn(new Date),!this.hasAttribute(`data-ff-editor`)&&(this.setzeTag(this.tag),this.tagAbmelden?.(),this.tagAbmelden=zn(()=>{this.tag=W()}))}disconnectedCallback(){super.disconnectedCallback(),this.tagAbmelden?.(),this.tagAbmelden=null}};O([Ue()],Bn.prototype,`tag`,void 0),k.defineAndRegister(Bn);function Vn(e){return`${e.toLowerCase()}field`}function Hn(e){let t=e.split(`::`);if(t.length!==2)return{quelleId:``,code:e};let[n,r]=t;return n===``||r===``?{quelleId:``,code:e}:{quelleId:n,code:r}}function Un(e){let t=new Set,n=!1,r=()=>{Pt()&&t.forEach(e.hydriere)};return{connect:i=>{i.hasAttribute(`data-ff-editor`)||(t.add(i),e.verdrahte?.(i),n||(n=!0,zt(r),zn(r),ht(r)),Qt(),Pt()&&e.hydriere(i))},disconnect:e=>{t.delete(e)}}}var Wn=Ye.toLowerCase(),Gn=``;function Kn(e){if(e.length===0)return``;let t=[];for(let n of e){let e=n.trim();if(e===``)return``;t.push(e)}return t.join(Gn)}function qn(e){let t=e.getAttribute(Wn)??``;if(t===``)return[];try{let e=JSON.parse(t);if(!Array.isArray(e))return[];let n=[];for(let t of e){if(!t||typeof t!=`object`)continue;let e=t;if(typeof e.quelleId!=`string`||e.quelleId===``)continue;let r=[];for(let t of Array.isArray(e.keyPairs)?e.keyPairs:[]){if(!t||typeof t!=`object`)continue;let e=t;typeof e.fromField!=`string`||typeof e.toField!=`string`||e.fromField.trim()===``||e.toField.trim()===``||r.push({fromField:e.fromField,toField:e.toField})}r.length!==0&&n.push({quelleId:e.quelleId,keyPairs:r})}return n}catch{return[]}}function Jn(e){let t=qn(e);if(t.length===0)return(e,t)=>M(e,Hn(t).code);let n=B().SEDATA,r=B().FF_DATA_SOURCES,i=new Map;for(let e of t){let t=j(r,e.quelleId);if(!t)continue;let a=P(n,t.name,t.tableId),o=new Map;for(let t of a){let n=Kn(e.keyPairs.map(e=>M(t,e.toField)));n!==``&&!o.has(n)&&o.set(n,t)}i.set(e.quelleId,{nachSchluessel:o,hierFelder:e.keyPairs.map(e=>e.fromField)})}return(e,t)=>{let{quelleId:n,code:r}=Hn(t);if(n===``)return M(e,r);let a=i.get(n);if(!a)return``;let o=Kn(a.hierFelder.map(t=>M(e,t)));if(o===``)return``;let s=a.nachSchluessel.get(o);return s===void 0?``:M(s,r)}}function Yn(e,t){let n=e.getAttribute(`source`)??``,r=e.getAttribute(t)??``;if(n===``||r===``)return{art:`ungebunden`};let i=j(B().FF_DATA_SOURCES,n);if(!i)return{art:`ohneQuelle`};let a=Tt(e,P(B().SEDATA,i.name,i.tableId));if(a===void 0)return{art:`ohneZeile`};let{quelleId:o,code:s}=Hn(r);return{art:`wert`,wert:o===``?M(a,s):Jn(e)(a,r),zeile:a,quelle:i,quelleId:o,reinerCode:s}}var Xn=new WeakMap,Zn=new WeakSet;function Qn(e){let t=/^(\d{2})\.(\d{2})\.(\d{4})$/.exec(e);return t?`${t[3]}-${t[2]}-${t[1]}`:e}function $n(e){let t=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);return t?`${t[3]}.${t[2]}.${t[1]}`:e}function er(e){return typeof e.value==`string`?e.value:``}function tr(e){let t=Yn(e,Vn(`value`));if(t.art!==`wert`){Xn.delete(e),t.art===`ohneZeile`&&(e.value=``);return}let{zeile:n,quelle:r,quelleId:i,reinerCode:a,wert:o}=t,s=r.indexField===``?``:M(n,r.indexField);i===``?Xn.set(e,{row:n,code:a,pindex:s}):Xn.delete(e),e.value=o}function nr(e){let t=Xn.get(e);return t&&ot(t.row,t.code,er(e)),t}function rr(e){Zn.has(e)||(Zn.add(e),e.addEventListener(`input`,()=>{nr(e)}),e.addEventListener(`change`,()=>{let t=nr(e);Sn(e,`onChange`,{VALUE:er(e),PINDEX:t?.pindex??``}).catch(xn)}))}var ir=Un({hydriere:tr,verdrahte:rr}),ar=ir.connect,or=ir.disconnect,sr=[`text`,`number`,`textarea`,`select`,`date`,`checkbox`];function cr(e){return sr.includes(e)?e:`text`}var lr=[`text`,`number`,`textarea`,`select`],G=class extends k{constructor(...e){super(...e),this.fieldType=`text`,this.placeholder=`Feldname`,this.options=``,this.source=``,this.value=``,this.valueField=``,this.angehakt=!1}static{this.blockType=`formfeld`}static{this.tagName=`ff-formfeld`}static{this.displayName=`Formularfeld`}static{this.category=`eingabe`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`value`,label:`Wert`}]}static{this.actionValueSpots=[{prop:`value`,label:`Wert`}]}static{this.blockEvents=[{key:`onChange`,name:`Wert geändert`}]}static{this.defaultProps={width:240,fieldType:`text`,placeholder:`Feldname`,options:``,source:``,value:``,valueField:``}}static{this.raster={startW:6,startH:2,minW:2,minH:2}}static{this.customProperties=[{attributeName:`fieldType`,name:`Feldtyp`,description:`Welche Art Eingabe das Feld annimmt.`,kind:`select`,options:[{value:`text`,label:`Text`},{value:`number`,label:`Zahl`},{value:`textarea`,label:`Mehrzeilig`},{value:`select`,label:`Auswahl`},{value:`date`,label:`Datum`},{value:`checkbox`,label:`Ankreuzfeld`}]},{attributeName:`options`,name:`Auswahl-Optionen`,description:`Nur bei Feldtyp "Auswahl": Einträge durch Komma getrennt (z. B. "Zimmer 1, Zimmer 2") — jeder Eintrag wird eine Dropdown-Zeile.`,kind:`text`,visibleWhen:{attributeName:`fieldType`,equals:`select`}},{attributeName:`valueField`,name:`Feld`,description:`Feld der angeschlossenen Datenquelle, dessen Wert angezeigt und lokal aktualisiert wird.`,kind:`field`}]}static{this.styles=[k.styles,o`
      .feld {
        font-family: var(--se-font);
    ...
    `]}onInput(e){let t=e.target;this.value=cr(this.fieldType)===`date`?$n(t.value):t.value}onChange(){this.dispatchEvent(new Event(`change`))}textTpl(e,t=!1){return b`<span
      class=${e}
      ?hidden=${t}
      data-ff-editable
    ...
    >${this.placeholder}</span>`}onTextClick(){this.hasAttribute(`data-ff-editor`)||this.setzeHaken(!this.angehakt)}setzeHaken(e){this.angehakt!==e&&(this.angehakt=e,this.dispatchEvent(new Event(`change`)))}controlTpl(e){switch(e){case`textarea`:return b`<textarea class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}></textarea>`;case`select`:{let e=this.options.split(`,`).map(e=>e.trim()).filter(e=>e!==``),t=this.value!==``&&!e.includes(this.value);return b`<select class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}>
        ...
        />`}}render(){let e=cr(this.fieldType);return e===`checkbox`?b`<div class="feld">
        <div class="zeile">
          <input
            class="ctrl"
            type="checkbox"
    ...
    `]}onSlotChange(e){let t=e.target;this._count=t.assignedElements().filter(e=>!e.hasAttribute(`data-ff-editor-helper`)&&e.tagName.toLowerCase()!==`template`).length}render(){return b`<div class="col v-${Dn(this.variant)}">
      <div class="head">
        <span class="dot"></span>
        <span
          class="title"
    ...
    </div>`}};O([D()],K.prototype,`variant`,void 0),O([D()],K.prototype,`heading`,void 0),O([Ue()],K.prototype,`_count`,void 0),k.defineAndRegister(K);function dr(e,t,n){return t===``||n===``?[...e]:e.filter(e=>Nn(M(e,t))===n)}function fr(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function pr(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var mr=new WeakMap,hr=K.tagName,gr=U.tagName;function _r(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===hr)}function vr(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===gr)}function yr(e){return Ke().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function br(e){J?.board===e&&(J=null);let t=e.getAttribute(`source`)??``,n=e.getAttribute(`statusfield`)??``;if(t===``)return;let r=j(B().FF_DATA_SOURCES,t);if(!r)return;let i=_r(e);if(i.length===0)return;let a=mr.get(e);if(!a){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(gr);t&&(a=t.cloneNode(!0),mr.set(e,a))}if(!a)return;let o=dr(P(B().SEDATA,r.name,r.tableId),e.getAttribute(`tagfield`)??``,W()),s=i.map(e=>e.getAttribute(`heading`)??K.defaultProps.heading),c=yr(a.tagName),l=pr(i.map(e=>e.getAttribute(`auffang`))),u=Jn(e);for(let e of i)vr(e).forEach(e=>e.remove());for(let e of o){let t=a.cloneNode(!0),o=n===``?-1:fr(M(e,n),s);(o>=0?i[o]:l>=0?i[l]:i[0]).appendChild(t);for(let n of c){let r=t.getAttribute(Vn(n.prop))??``;r!==``&&(t[n.prop]=u(e,r))}let d=r.indexField===``?``:M(e,r.indexField);q.set(t,{row:e,pindex:d}),t.draggable=!0}let d=i.flatMap(vr),ee=yt(vt(e),d,e=>q.get(e)?.row);for(let e of ee)d[e].setAttribute(`data-ff-auswahl`,``)}var q=new WeakMap,J=null,xr=new WeakSet;function Sr(e,t){for(let n of t.composedPath())if(n instanceof HTMLElement&&n.tagName.toLowerCase()===hr&&e.contains(n))return n;return null}function Cr(e,t){if(!J||J.board!==e)return;let n=q.get(J.card);if(!n)return;let r=t.getAttribute(`heading`)??``;Sn(e,`onCardDrop`,{PINDEX:n.pindex,VALUE:r}).catch(xn)}function wr(e){xr.has(e)||(xr.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&q.has(e))??null;if(!n)return;let r=q.get(n);r&&bt(vt(e),r.row),Sn(e,`onCardClick`,{PINDEX:r?.pindex??``}).catch(xn)}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&q.has(e))??null;n&&(J={card:n,board:e},t.dataTransfer?.setData(`text/plain`,q.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`))}),e.addEventListener(`dragend`,()=>{J=null}),e.addEventListener(`dragover`,t=>{let n=Sr(e,t);J?.board===e&&n&&(t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`))}),e.addEventListener(`drop`,t=>{let n=Sr(e,t);n&&(t.preventDefault(),Cr(e,n),J=null)}))}var Tr=Un({hydriere:br,verdrahte:wr}),Er=Tr.connect,Dr=Tr.disconnect,Y=K.blockType,Or=class extends k{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[Y]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:Y}}static{this.templateChild={type:U.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.auswahlGeber=!0}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``,tagField:``}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Optional: Feld der Datenquelle, dessen Inhalt bestimmt, in welche Spalte ein Eintrag kommt. Leer = alle Einträge in der Auffang-Spalte.`,kind:`field`},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt das Board nur Einträge des Tages, den der Tageswähler zeigt. Leer = alle Einträge.`,kind:`field`}]}static{this.defaultChildren=[{type:Y,props:{heading:`Offen`,variant:`warning`},children:[{type:U.blockType}]},{type:Y,props:{heading:`In Arbeit`,variant:`info`}},{type:Y,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[k.styles,o`
    ...
    `]}render(){return b`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),Er(this)}disconnectedCallback(){super.disconnectedCallback(),Dr(this)}};k.defineAndRegister(Or);var kr={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Ar=e=>(...t)=>({_$litDirective$:e,values:t}),jr=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},Mr=`important`,Nr=` !important`,Pr=Ar(class extends jr{constructor(e){if(super(e),e.type!==kr.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(Nr);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?Mr:``):n[e]=r}}return S}}),Fr=`Spalte {n}`;function X(e){return Fr.replace(`{n}`,String(e+1))}function Z(){return[0,1,2].map(e=>({titel:X(e),feld:``}))}function Ir(e,t){if(e&&typeof e==`object`){let n=e;return{titel:typeof n.titel==`string`?n.titel:X(t),feld:typeof n.feld==`string`?n.feld:``}}return typeof e==`string`?{titel:e,feld:``}:{titel:X(t),feld:``}}function Lr(e){let t;if(Array.isArray(e))t=e.map((e,t)=>Ir(e,t));else if(typeof e==`number`&&Number.isFinite(e)||typeof e==`string`&&/^\d+$/.test(e)){let n=Math.max(1,Math.floor(Number(e)));t=[...Array(n).keys()].map(e=>({titel:X(e),feld:``}))}else t=Z();return t.length>8&&(t=t.slice(0,8)),t.length<1&&(t=[{titel:X(0),feld:``}]),t}function Rr(e){try{return Lr(JSON.parse(e))}catch{return Z()}}function zr(e){return Rr(e.getAttribute(`spalten`)??``).map(e=>e.feld)}function Br(e){let t=e.getAttribute(`source`)??``;if(t===``){e.datenzeilen=[];return}let n=j(B().FF_DATA_SOURCES,t);if(!n){e.datenzeilen=[];return}let r=zr(e),{rows:i,gefiltert:a}=wt(e,dr(P(B().SEDATA,n.name,n.tableId),e.getAttribute(`tagfield`)??``,W())),o=yt(vt(e),i,e=>e)[0]??-1,s=Jn(e);e.rohzeilen=i,e.auswahlIndex=o,e.durchAuswahlGefiltert=a,e.datenzeilen=i.map(e=>r.map(t=>t===``?``:s(e,t)))}var Vr=Un({hydriere:Br}),Hr=Vr.connect,Ur=Vr.disconnect,Wr=1,Gr=/^-?\d{1,3}(\.\d{3})*(,\d+)?$|^-?\d+(,\d+)?$|^-?\d+(\.\d+)?$/,Kr=/^(\d{1,2})\.(\d{1,2})\.(\d{2}|\d{4})$/,qr=/^(\d{4})-(\d{2})-(\d{2})$/;function Jr(e){let t=e.trim();if(t===``||!Gr.test(t))return null;let n=t.includes(`,`)?t.replace(/\./g,``).replace(`,`,`.`):/^-?\d{1,3}(\.\d{3})+$/.test(t)?t.replace(/\./g,``):t,r=Number(n);return Number.isFinite(r)?r:null}function Yr(e){let t=e.trim();if(t===``)return null;let n=qr.exec(t);if(n){let[,e,t,r]=n;return Xr(Number(e),Number(t),Number(r))}let r=Kr.exec(t);if(r){let[,e,t,n]=r,i=Number(n);return Xr(n.length===2?i<=69?2e3+i:1900+i:i,Number(t),Number(e))}return null}function Xr(e,t,n){if(t<1||t>12||n<1||n>31)return null;let r=new Date(e,t-1,n);return r.getFullYear()!==e||r.getMonth()!==t-1||r.getDate()!==n?null:r.getTime()}function Zr(e){let t=0,n=0,r=0;for(let i of e)i.trim()!==``&&(t++,Jr(i)!==null&&n++,Yr(i)!==null&&r++);return t===0?`text`:r===t?`datum`:n===t?`zahl`:`text`}var Qr=new Intl.Collator(`de`,{numeric:!0,sensitivity:`base`});function $r(e,t,n){if(t<0||e.length===0)return e.map((e,t)=>t);let r=n=>e[n][t]??``,i=Zr(e.map(e=>e[t]??``)),a=n?1:-1;return e.map((e,t)=>t).sort((e,t)=>{let n=r(e).trim(),o=r(t).trim();if(n===``&&o===``)return e-t;if(n===``)return Wr;if(o===``)return-1;let s=i===`zahl`?(Jr(n)??0)-(Jr(o)??0):i===`datum`?(Yr(n)??0)-(Yr(o)??0):Qr.compare(n,o);return s===0?e-t:s*a})}function ei(e){return e.trim().toLowerCase().split(/\s+/).filter(e=>e!==``)}function ti(e,t){let n=ei(t);if(n.length===0)return!0;let r=e.join(` `).toLowerCase();return n.every(e=>r.includes(e))}function ni(e,t){let n=[];return e.forEach((e,r)=>{ti(e,t)&&n.push(r)}),n}function ri(e,t){return!e&&t.trim()!==``}function ii(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}var ai=o`
      :host { min-width: 0; height: 100%; }
...
`,oi=4,si=[10,25,50],ci=220,Q=class e extends k{constructor(...e){super(...e),this.spalten=Z(),this.source=``,this.suche=`ja`,this._suchtext=``,this.datenzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._proSeiteWahl=null,this._klickTimer=null}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.auswahlGeber=!0}static{this.kannAuswahlFolgen=!0}static{this.listenBindung={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:Fr}}static{this.defaultProps={width:`fill`,source:``,spalten:Z(),suche:`ja`,tagField:``}}static{this.customProperties=[{attributeName:`suche`,name:`Suchzeile`,description:`Zeigt ueber der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,kind:`segment`,options:[{value:`ja`,label:`Ja`},{value:`nein`,label:`Nein`}],requiresDataSource:!0},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt die Tabelle nur Saetze des Tages, den der Tageswaehler zeigt. Leer = alle Saetze.`,kind:`field`}]}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get proSeiteAktuell(){return this._proSeiteWahl??si[0]}spaltenListe(){return Lr(this.spalten)}sichtbareIndizes(){let e=ni(this.datenzeilen,this._suchtext);return this._sortSpalte<0?e:$r(e.map(e=>this.datenzeilen[e]),this._sortSpalte,this._sortAuf).map(t=>e[t])}klickZeile(e){if(e===null||this.hasAttribute(`data-ff-editor`))return;let t=vt(this),n=this.rohzeilen[e];t===``||n===void 0||bt(t,n)}setzeSuchtext(e){this._suchtext=e,this._seite=0,this.requestUpdate()}klickSortiere(e){this.editable||(this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.requestUpdate())}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}klickSpaltenkopf(t,n){if(!this.editable)return;t.stopPropagation();let r=t.currentTarget.getBoundingClientRect();this.klickTimerAus(),this._klickTimer=setTimeout(()=>{this._klickTimer=null,this.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:e.listenBindung.prop,index:n,top:r.bottom+4,left:r.left},bubbles:!0,composed:!0}))},ci)}klickTimerAus(){this._klickTimer!==null&&(clearTimeout(this._klickTimer),this._klickTimer=null)}bearbeiteTitel(e,t){if(!this.editable)return;let n=e.currentTarget;if(!n)return;e.stopPropagation(),e.preventDefault();let r=Array.from(n.childNodes),i=n.textContent??``;n.setAttribute(`contenteditable`,`plaintext-only`),n.focus();let a=window.getSelection(),o=document.createRange();o.selectNodeContents(n),a?.removeAllRanges(),a?.addRange(o);let s=!1,c=e=>{if(s)return;s=!0,n.removeAttribute(`contenteditable`),n.removeEventListener(`blur`,l),n.removeEventListener(`keydown`,u);let a=(n.textContent??``).trim(),o=this.spaltenListe();e&&a&&a!==i.trim()&&t<o.length?(o[t]={...o[t],titel:a},this.aendere(o)):n.replaceChildren(...r)},l=()=>c(!0),u=e=>{e.key===`Enter`?(e.preventDefault(),n.blur()):e.key===`Escape`&&(e.preventDefault(),c(!1))};n.addEventListener(`blur`,l),n.addEventListener(`keydown`,u)}connectedCallback(){super.connectedCallback(),Hr(this)}disconnectedCallback(){super.disconnectedCallback(),this.klickTimerAus(),Ur(this)}static{this.styles=[k.styles,ai]}render(){let e=this.spaltenListe(),t={gridTemplateColumns:`repeat(${e.length}, minmax(0, 1fr))`},n=e=>e.stopPropagation(),r=this.sichtbareIndizes(),i=ri(this.hasAttribute(`data-ff-editor`),this.source),a=r.length,o=this.proSeiteAktuell,s=i?Math.max(1,Math.ceil(a/o)):1,c=Math.min(Math.max(this._seite,0),s-1),l=i?r.slice(c*o,(c+1)*o):[],u=i?o:oi,d=i?``:`—`,ee=[...l,...Array.from({length:Math.max(0,u-l.length)},()=>null)];return b`<div class="tabelle" style=${Pr({"--spalten-zahl":String(e.length)})}>
      ...
      <!-- Fusszeile IMMER: sie gehoert zum Aufbau der Tabelle, also muss der
           ...
           ein Strich (Regel 7). -->
      <div class="fusszeile">
        <div class="seiten-info">${ii({hatQuelle:i,sichtbar:a,gesamt:this.datenzeilen.length,suchtAktiv:this._suchtext.trim()!==``,auswahlAktiv:this.durchAuswahlGefiltert})}</div>
        <div class="seiten-nav">
          ...
          >${si.map(e=>b`<option value=${e} ?selected=${e===o}>${e} pro Seite</option>`)}</select>
    ...
    </div>`}};O([D({converter:{fromAttribute:e=>e?Rr(e):Z(),toAttribute:e=>JSON.stringify(e)}})],Q.prototype,`spalten`,void 0),O([D()],Q.prototype,`source`,void 0),O([D()],Q.prototype,`suche`,void 0),O([D({attribute:!1})],Q.prototype,`datenzeilen`,void 0),O([D({attribute:!1})],Q.prototype,`rohzeilen`,void 0),O([D({attribute:!1})],Q.prototype,`auswahlIndex`,void 0),O([D({attribute:!1})],Q.prototype,`durchAuswahlGefiltert`,void 0),k.defineAndRegister(Q);var li=Vn(`text`);function ui(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(li)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function di(e){let t=Yn(e,li);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function fi(e){ui(e)&&(e.text=``)}var pi=Un({hydriere:di,verdrahte:fi}),mi=pi.connect,hi=pi.disconnect,gi=6,_i=96,vi=14,yi={duenn:`300`,normal:`400`,fett:`700`},bi={links:`left`,mitte:`center`,rechts:`right`},xi={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},Si=`standard`;function Ci(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(_i,Math.max(gi,t)):vi}function wi(e){return typeof e==`string`&&e in yi?e:`normal`}function Ti(e){return typeof e==`string`&&e in bi?e:`links`}function Ei(e){return typeof e==`string`&&e in xi?e:Si}var $=class extends k{constructor(...e){super(...e),this.groesse=vi,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=Si,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:vi,gewicht:`normal`,ausrichtung:`links`,farbe:Si,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:gi,max:_i,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[k.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return b`<div
      class="text"
      style=${Pr({fontSize:`${Ci(this.groesse)}px`,fontWeight:yi[wi(this.gewicht)],textAlign:bi[Ti(this.ausrichtung)],color:xi[Ei(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),mi(this)}disconnectedCallback(){super.disconnectedCallback(),hi(this)}};O([D({type:Number})],$.prototype,`groesse`,void 0),O([D()],$.prototype,`gewicht`,void 0),O([D()],$.prototype,`ausrichtung`,void 0),O([D()],$.prototype,`farbe`,void 0),O([D()],$.prototype,`text`,void 0),O([D()],$.prototype,`source`,void 0),O([D()],$.prototype,`textField`,void 0),k.defineAndRegister($);var Di=class extends k{static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1}}static{this.customProperties=[]}static{this.styles=[k.styles,o`
    ...
    `]}render(){return b`<div class="zeile"><slot></slot></div>`}};k.defineAndRegister(Oi),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;z(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();
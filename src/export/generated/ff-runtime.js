...
\f\r]`,ge=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,_e=/-->/g,ve=/>/g,S=RegExp(`>|${he}(?:([^\\s"'>=/]+)(${he}*=${he}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,`g`),ye=/'/g,be=/"/g,xe=/^(?:script|style|textarea|title)$/i,Se=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),C=Se(1),Ce=Se(2),w=Symbol.for(`lit-noChange`),T=Symbol.for(`lit-nothing`),we=new WeakMap,E=x.createTreeWalker(x,129);function Te(e,t){if(!pe(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return se===void 0?t:se.createHTML(t)}var Ee=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:t===3?`<math>`:``,o=ge;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===ge?c[1]===`!--`?o=_e:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=S):(xe.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=S):o=ve:o===S?c[0]===`>`?(o=i??ge,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?S:c[3]===`"`?be:ye):o===be||o===ye?o=S:o===_e||o===ve?o=ge:(o=S,i=void 0);let d=o===S&&e[t+1].startsWith(`/>`)?` `:``;a+=o===ge?n+ue:l>=0?(r.push(s),n.slice(0,l)+ce+n.slice(l)+b+d):n+b+(l===-2?t:d)}return[Te(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:t===3?`</math>`:``)),r]},De=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=Ee(t,n);if(this.el=e.createElement(l,r),E.currentNode=this.el.content,n===2||n===3){let e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;(i=E.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes())for(let e of i.getAttributeNames())if(e.endsWith(ce)){let t=u[o++],n=i.getAttribute(e).split(b),r=/([.?@])?(.*)/.exec(t);c.push({type:1,index:a,name:r[2],strings:n,ctor:r[1]===`.`?je:r[1]===`?`?Me:r[1]===`@`?Ne:Ae}),i.removeAttribute(e)}else e.startsWith(b)&&(c.push({type:6,index:a}),i.removeAttribute(e));if(xe.test(i.tagName)){let e=i.textContent.split(b),t=e.length-1;if(t>0){i.textContent=oe?oe.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],de()),E.nextNode(),c.push({type:2,index:++a});i.append(e[t],de())}}}else if(i.nodeType===8)if(i.data===le)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(b,e+1))!==-1;)c.push({type:7,index:a}),e+=b.length-1}a++}}static createElement(e,t){let n=x.createElement(`template`);return n.innerHTML=e,n}};function D(e,t,n=e,r){if(t===w)return t;let i=r===void 0?n._$Cl:n._$Co?.[r],a=fe(t)?void 0:t._$litDirective$;return i?.constructor!==a&&(i?._$AO?.(!1),a===void 0?i=void 0:(i=new a(e),i._$AT(e,n,r)),r===void 0?n._$Cl=i:(n._$Co??=[])[r]=i),i!==void 0&&(t=D(e,i._$AS(e,t.values),i,r)),t}var Oe=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??x).importNode(t,!0);E.currentNode=r;let i=E.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new ke(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new Pe(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=E.nextNode(),a++)}return E.currentNode=x,r}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},ke=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,r){this.type=2,this._$AH=T,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=D(this,e,t),fe(e)?e===T||e==null||e===``?(this._$AH!==T&&this._$AR(),this._$AH=T):e!==this._$AH&&e!==w&&this._(e):e._$litType$===void 0?e.nodeType===void 0?me(e)?this.k(e):this._(e):this.T(e):this.$(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==T&&fe(this._$AH)?this._$AA.nextSibling.data=e:this.T(x.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=De.createElement(Te(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.p(t);else{let e=new Oe(r,this),n=e.u(this.options);e.p(t),this.T(n),this._$AH=e}}_$AC(e){let t=we.get(e.strings);return t===void 0&&we.set(e.strings,t=new De(e)),t}k(t){pe(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.O(de()),this.O(de()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let t=ae(e).nextSibling;ae(e).remove(),e=t}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},Ae=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,r,i){this.type=1,this._$AH=T,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=T}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=D(this,e,t,0),a=!fe(e)||e!==this._$AH&&e!==w,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=D(this,r[n+o],t,o),s===w&&(s=this._$AH[o]),a||=!fe(s)||s!==this._$AH[o],s===T?e=T:e!==T&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===T?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},je=class extends Ae{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===T?void 0:e}},Me=class extends Ae{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==T)}},Ne=class extends Ae{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=D(this,e,t,0)??T)===w)return;let n=this._$AH,r=e===T&&n!==T||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==T&&(n===T||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Pe=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){D(this,e)}},Fe=ie.litHtmlPolyfillSupport;Fe?.(De,ke),(ie.litHtmlVersions??=[]).push(`3.3.3`);var Ie=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new ke(t.insertBefore(de(),e),e,void 0,n??{})}return i._$AI(e),i},Le=globalThis,O=class extends re{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Ie(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return w}};O._$litElement$=!0,O.finalized=!0,Le.litElementHydrateSupport?.({LitElement:O});var Re=Le.litElementPolyfillSupport;Re?.({LitElement:O}),(Le.litElementVersions??=[]).push(`4.2.2`);var ze={attribute:!0,type:String,converter:_,reflect:!1,hasChanged:v},Be=(e=ze,t,n)=>{let{kind:r,metadata:i}=n,a=globalThis.litPropertyMetadata.get(i);if(a===void 0&&globalThis.litPropertyMetadata.set(i,a=new Map),r===`setter`&&((e=Object.create(e)).wrapped=!0),a.set(n.name,e),r===`accessor`){let{name:r}=n;return{set(n){let i=t.get.call(this);t.set.call(this,n),this.requestUpdate(r,i,e,!0,n)},init(t){return t!==void 0&&this.C(r,void 0,e,t),t}}}if(r===`setter`){let{name:r}=n;return function(n){let i=this[r];t.call(this,n),this.requestUpdate(r,i,e,!0,n)}}throw Error(`Unsupported decorator location: `+r)};function k(e){return(t,n)=>typeof n==`object`?Be(e,t,n):((e,t,n)=>{let r=t.hasOwnProperty(n);return t.constructor.createProperty(n,e),r?Object.getOwnPropertyDescriptor(t,n):void 0})(e,t,n)}function Ve(e){return k({...e,state:!0,attribute:!1})}var He=new Map;function Ue(e){He.has(e.type)&&console.warn(`Block-Typ "${e.type}" wird ueberschrieben.`),He.set(e.type,e)}function We(){return Array.from(He.values())}var Ge={width:`auto`},Ke={rasterX:0,rasterY:0,rasterW:{spalten:24,spaltePx:40,zeilePx:12,gapPx:8}.spalten,rasterH:1},qe=`weitereQuellen`,Je={[qe]:[]},Ye=`folgtAuswahl`,Xe={[Ye]:[]};function A(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var j=class extends O{constructor(...e){super(...e),this.editable=!1}static{this.styles=o`
  ...
  `}aktualisiereEscape(){let e=this.isConnected&&this.escapeSchliesst;e!==this.escapeRegistriert&&(e?document.addEventListener(`keydown`,this.aufTaste,!0):document.removeEventListener(`keydown`,this.aufTaste,!0),this.escapeRegistriert=e)}schliesse(){this.dispatchEvent(new CustomEvent(jt,{bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this.aktualisiereEscape()}updated(e){e.has(`escapeSchliesst`)&&this.aktualisiereEscape()}disconnectedCallback(){this.escapeRegistriert&&=(document.removeEventListener(`keydown`,this.aufTaste,!0),!1),super.disconnectedCallback()}render(){let e=Mt(this.breite,520),t=Mt(this.hoehe,380);return C`
    ...
    `]}onClose(){this.hasAttribute(`data-ff-editor`)||this.removeAttribute(`offen`)}render(){return C`<ff-dialog-rahmen
      ...
      </ff-dialog-rahmen>`}};A([k()],V.prototype,`name`,void 0),A([k()],V.prototype,`breite`,void 0),A([k()],V.prototype,`hoehe`,void 0),j.defineAndRegister(V);var Nt=[`GET_RELATION`,`PUT_RELATION`,`PUTADD_RELATION`];function Pt(e){return`${String(e.getDate()).padStart(2,`0`)}.${String(e.getMonth()+1).padStart(2,`0`)}.${e.getFullYear()}`}function Ft(e,t){return e.params.map(e=>e.replace(/\{([A-Za-z0-9_]+)\}/g,(e,n)=>String(t[n]??``)))}var It=8e3,H=null,Lt=null;function Rt(){let e=document.createElement(`div`);return e.setAttribute(`data-ff-meldung`,``),e.setAttribute(`role`,`alert`),e.style.cssText=[`position:fixed`,`top:0`,`left:0`,`right:0`,`z-index:2147483647`,`padding:7px 12px`,`background:var(--se-red-soft,#fbe7e6)`,`color:var(--se-red,#c0201a)`,`border-bottom:1px solid var(--se-red,#c0201a)`,`font:500 12px/1.4 system-ui,sans-serif`,`cursor:pointer`].join(`;`),e.title=`Klicken zum Schließen`,e.addEventListener(`click`,zt),e}function zt(){Lt&&=(clearTimeout(Lt),null),H?.remove(),H=null}function U(e){typeof document>`u`||!document.body||(H||(H=Rt(),document.body.appendChild(H)),H.textContent=e,Lt&&clearTimeout(Lt),Lt=setTimeout(zt,It))}function W(){return globalThis}function Bt(){let e=W();return N(e.SEDATA)&&N(e.SEDATA.Daten)}function Vt(){let e=W();try{e.selib?.Json?.InitializeERPConnection?.()}catch{}try{typeof e.InitialisiereSchnittstelle==`function`&&e.InitialisiereSchnittstelle()}catch{}}function Ht(){let e=W();try{typeof e.ResetDataBasis==`function`&&e.ResetDataBasis()}catch{}try{typeof e.InitialisiereDatenBasis==`function`&&e.InitialisiereDatenBasis()}catch{}}var Ut=new Set,Wt=new Set;function Gt(e){Ut.add(e)}function Kt(e){return Wt.add(e),()=>{Wt.delete(e)}}function qt(){Ut.forEach(e=>e())}function Jt(){qt()}function Yt(e){Wt.forEach(t=>{try{t(e)}catch{}})}var G=new Map,Xt=``,Zt=0;function Qt(){try{let e=document.getElementById(`ff-se-diagnose`);return!e&&document.body&&(e=document.createElement(`textarea`),e.id=`ff-se-diagnose`,e.readOnly=!0,e.style.cssText=`display:none;position:fixed;left:8px;right:8px;bottom:8px;height:40vh;z-index:99999;font:11px monospace;`,document.body.appendChild(e)),e}catch{return null}}function $t(){let e=Qt();e&&(e.value=Array.from(G,([e,t])=>`${e}: ${t}`).join(`
`)+(Xt===``?``:`\n\nERSTES PAKET\n${Xt}`))}function K(e,t){G.set(e,t),$t()}function en(){let e=W();G.set(`basisHTML_REGISTER`,typeof e.basisHTML_REGISTER==`function`?`vorhanden`:`fehlt`),G.set(`basisHTML_SND_MSG`,typeof e.basisHTML_SND_MSG==`function`?`vorhanden`:`fehlt`),G.set(`body.pid`,document.body?.getAttribute(`pid`)?`gesetzt`:`fehlt`),G.set(`body.REGMSG`,document.body?.getAttribute(`REGMSG`)?`gesetzt`:`fehlt`),G.set(`Empfangene Pakete`,String(Zt)),G.set(`SEDATA.Daten`,Bt()?`vorhanden`:`fehlt`),$t()}function tn(e){if(Xt===``)try{Xt=typeof e==`string`?e:JSON.stringify(e)??``,$t()}catch{}}function nn(e){Zt+=1,tn(e),K(`Empfangene Pakete`,String(Zt));let t=dt(e);if(!t){K(`Letztes Paket`,`Antwort ohne Daten`),Yt(e);return}let n=W();N(n.SEDATA)||(n.SEDATA={}),n.SEDATA.Daten=t,K(`Letztes Paket`,`Daten-Push angenommen`),K(`SEDATA.Daten`,`vorhanden`),Ht(),qt()}function rn(e=0){let t=W();if(typeof t.basisHTML_REGISTER==`function`){en();try{t.basisHTML_SetConsoleLog?.(!0,!0)}catch{}try{t.basisHTML_REGISTER(e=>{nn(e)},document.title,`1.0`),K(`Registrierung`,`ausgeführt`)}catch(e){K(`Registrierung`,`Fehler: ${e instanceof Error?e.message:String(e)}`)}return}e<400?(e===0&&K(`Registrierung`,`wartet auf Interface`),setTimeout(()=>{rn(e+1)},25)):(en(),K(`Registrierung`,`nach 10s kein Interface`),U(`SoftEngine-Anschluss nicht gefunden — die Maske bleibt ohne Daten (Strg+Alt+D für Details).`))}var an=!1;function on(){if(an)return;an=!0,K(`Runtime`,`gestartet`),K(`Registrierung`,`noch nicht ausgeführt`),en(),Vt();let e=W();e.Erstellen=()=>{Ht(),qt()},e.initData=e.Erstellen,e.ReloadData=()=>{qt()},rn(),window.addEventListener(`message`,e=>{if(typeof W().basisHTML_REGISTER==`function`)return;let t=ft(e.data);t!==void 0&&nn(t)},!0),document.addEventListener(`keydown`,e=>{if(e.ctrlKey&&e.altKey&&e.key.toLowerCase()===`d`){en();let e=document.getElementById(`ff-se-diagnose`);e&&(e.style.display=e.style.display===`none`?`block`:`none`)}});let t=0,n=setInterval(()=>{t+=1,Bt()?(clearInterval(n),K(`SEDATA.Daten`,`vorhanden`),Ht(),qt()):t>100&&(clearInterval(n),K(`Daten-Wartezeit`,`nach 30s ohne Daten`),U(`Keine Daten von SoftEngine empfangen — die Maske zeigt nichts an (Strg+Alt+D für Details).`))},300)}function sn(e){return e instanceof Error?e.message:String(e)}function cn(e,t){if(!(!Array.isArray(e)||t===``)){for(let n of e)if(!(!N(n)||n.id!==t)&&!(typeof n.verb!=`string`||!Nt.includes(n.verb))&&!(typeof n.nr!=`string`||n.nr===``)&&!(!Array.isArray(n.params)||n.params.some(e=>typeof e!=`string`)))return{id:t,verb:n.verb,nr:n.nr,params:n.params}}}var ln=[`RESULT`,`result`,`PINDEX`,`pindex`,`INDEX`,`index`,`0_10`,`KEY`,`key`,`ID`,`id`,`VALUE`,`value`];function un(e){if(typeof e!=`string`)return e;try{return JSON.parse(e)}catch{return}}function dn(e,t){if(typeof e==`string`){if(t)return e;let n=e.trim();return n===``?void 0:n}if(typeof e==`number`||typeof e==`boolean`)return String(e)}function fn(e,t,n){if(t>12)return;let r=dn(e,n);if(r!==void 0)return r;if(Array.isArray(e)){for(let r of e){let e=fn(r,t+1,n);if(e!==void 0)return e}return}if(N(e)){for(let r of ln){if(!(r in e))continue;let i=fn(e[r],t+1,n);if(i!==void 0)return i}for(let r of Object.values(e)){let e=fn(r,t+1,n);if(e!==void 0)return e}}}function pn(e,t=!1){let n=un(e);if(N(n)){for(let e of ln){if(!(e in n))continue;let r=fn(n[e],0,t);if(r!==void 0)return r}for(let e of Object.values(n))if(Array.isArray(e))for(let n of e){let e=pn(n,t);if(e!==void 0)return e}else if(N(e)){let n=pn(e,t);if(n!==void 0)return n}}}function mn(e,t,n=0){if(t.trim()===``||n>12)return``;let r=typeof e==`string`?un(e):e;if(Array.isArray(r)){for(let e of r){let r=mn(e,t,n+1);if(r!==``)return r}return``}if(!N(r))return``;let i=F(r,t);if(i!==``)return i;for(let e of Object.values(r)){let r=mn(e,t,n+1);if(r!==``)return r}return``}function hn(e){return N(e)?Object.keys(e).filter(e=>/^Message\d+$/.test(e)):[]}function gn(e,t,n=!1){if(!N(e))return;let r=hn(e).filter(e=>!t.has(e)).sort((e,t)=>Number(t.slice(7))-Number(e.slice(7)));for(let t of r){let r=pn(e[t],n);if(r!==void 0)return{wert:r,roh:e[t]}}}var _n=[],vn=!1,yn=6e3,bn=100;function xn(){if(vn||_n.length===0)return;vn=!0;let e=_n.shift(),t=W(),n=new Set(hn(t.SEDATA)),r=!1,i=(t,n)=>{r||(r=!0,o(),clearInterval(s),clearTimeout(c),vn=!1,e.resolve({wert:t,roh:n}),queueMicrotask(xn))},a=e.optionen.satzAntwort===!0,o=Kt(e=>{let t=pn(e,a);t!==void 0&&i(t,e)}),s=setInterval(()=>{let e=gn(W().SEDATA,n,a);e!==void 0&&i(e.wert,e.roh)},bn),c=setTimeout(()=>{e.optionen.still||U(`Daten laden: SoftEngine hat nicht geantwortet (Relation Nr. ${e.template.nr}).`),i(``,void 0)},yn);if(typeof t.basisHTML_SND_MSG!=`function`){e.optionen.still||U(`Daten laden nicht möglich: keine Verbindung zu SoftEngine.`),i(``,void 0);return}try{t.basisHTML_SND_MSG(`GET_RELATION`,{NR:e.template.nr,PARAMS:e.params})}catch(t){e.optionen.still||U(`Daten laden fehlgeschlagen (Relation Nr. ${e.template.nr}): ${sn(t)}`),i(``,void 0)}}function Sn(e,t,n={}){on();let r=W();if(e.verb!==`GET_RELATION`){if(typeof r.basisHTML_SND_MSG!=`function`)return U(`Speichern nicht möglich: keine Verbindung zu SoftEngine. Die Eingabe wurde NICHT übernommen.`),Promise.resolve({wert:``,roh:void 0});try{r.basisHTML_SND_MSG(e.verb,{NR:e.nr,PARAMS:[...t]})}catch(t){U(`Speichern fehlgeschlagen (Relation Nr. ${e.nr}): ${sn(t)}`)}return Promise.resolve({wert:``,roh:void 0})}return new Promise(r=>{_n.push({template:e,params:[...t],resolve:r,optionen:n}),xn()})}function Cn(e,t){if(!N(t))return``;let n=t.document;if(!n||typeof n.querySelectorAll!=`function`)return``;let r=Array.from(n.querySelectorAll(`[${Ze}]`)).find(t=>t.getAttribute(Ze)===e.blockId);if(!r)return``;let i=r[e.value];return i==null?``:String(i)}function wn(e,t,n=W()){if(e.source===`aus`)return``;if(e.source===`fixed`)return e.value;if(e.source===`context`)return t.context[e.value]??``;if(e.source===`previous_result`)return t.previousResult;if(e.source===`step_result`){let n=Number(e.value);if(!Number.isInteger(n)||n<0)return``;let r=e.ergebnisFeld??``;return r===``?t.stepResults?.[n]??``:mn(t.stepRohErgebnisse?.[n],r)}if(e.source===`block_value`)return Cn(e,n);if(e.source===`gewaehlte_zeile`){let n=t.gewaehlteZeile?.(e.blockId??``);return n===void 0?``:F(n,e.value)}if(!N(n))return``;if(e.source===`se_variable`){let t=n.SEDATA;if(!N(t)||!N(t.Daten)||!N(t.Daten.VARArrays))return``;let r=t.Daten.VARArrays[e.value];return r==null?``:String(r)}let r=P(n.FF_DATA_SOURCES,e.dataSourceId??``);if(!r)return``;let i=L(n.SEDATA,r.name,r.tableId),a=t.context.PINDEX??``,o=a!==``&&r.indexField!==``?i.find(e=>F(e,r.indexField)===a):i[0];return o?F(o,e.value):``}function Tn(e,t){let n=`0,START_TOOL,`+e;return t.length>0&&(n+=`,`+t.map(e=>encodeURIComponent(e)).join(`,`)),n}function En(e,t){if(e.trim()===``)return;let n=W();try{if(typeof n.sendBWLinkIntern==`function`){n.sendBWLinkIntern(Tn(e,t));return}}catch{}try{if(typeof n.basisHTML_SND_MSG==`function`){let r={NR:e};t.length>0&&(r.PARAMS=[...t]),n.basisHTML_SND_MSG(`START_TOOL`,r)}}catch{}}function Dn(e,t,n){if(t.trim()!==``)for(let r of Array.from(e.querySelectorAll(V.tagName)))(r.getAttribute(`name`)??V.defaultProps.name)===t&&(n?r.setAttribute(`offen`,``):r.removeAttribute(`offen`))}var On=new WeakMap;function kn(e){U(`Aktionskette fehlgeschlagen: `+(e instanceof Error?e.message:String(e)))}async function An(e,t,n){if(e.hasAttribute(`data-ff-editor`))return;let r=nt(e.getAttribute(`data-ff-aktionen`))[t];if(!r||r.length===0)return;let i=On.get(e);if(i||(i=new Set,On.set(e,i)),!i.has(t)){i.add(t);try{let t={...n,NOW_DATE:Pt(new Date)},i=``,a=[],o=[],s=()=>{a.push(``),o.push(void 0)};for(let n of r){if(n.type===`START_TOOL`){En(n.toolNr,Ft({params:n.toolParams},t)),s();continue}if(n.type===`POPUP_OPEN`||n.type===`POPUP_CLOSE`){Dn(e.ownerDocument??document,n.popup??``,n.type===`POPUP_OPEN`),s();continue}let r=cn(W().FF_RELATIONS,n.relationId);if(!r){s();continue}let c={context:t,previousResult:i,stepResults:a,stepRohErgebnisse:o,gewaehlteZeile:yt},l=await Sn(r,[...n.params,...n.extraParams].map(e=>wn(e,c))),u=l.wert;a.push(u),o.push(l.roh),r.verb===`GET_RELATION`&&(i=u),n.resultKey!==``&&(t[n.resultKey]=u)}}finally{i.delete(t)}}}var jn=new WeakSet;function Mn(e,t){if(e.hasAttribute(`data-ff-editor`)||!e.hasAttribute(`data-ff-aktionen`)||jn.has(e))return;jn.add(e);let n=nt(e.getAttribute(`data-ff-aktionen`));Object.values(n).some(e=>e.some(e=>e.type===`RELATION`))&&on(),e.addEventListener(`click`,()=>{An(e,t,{}).catch(kn)})}var Nn=class extends j{constructor(...e){super(...e),this.label=`Klick mich`}static{this.blockType=`button`}static{this.tagName=`ff-button`}static{this.displayName=`Schaltfläche`}static{this.category=`eingabe`}static{this.defaultProps={label:`Klick mich`}}static{this.resizableWidth=!1}static{this.blockEvents=[{key:`onClick`,name:`Klick`}]}static{this.raster={startW:4,startH:2,minW:2,minH:2}}static{this.customProperties=[]}static{this.styles=[j.styles,o`
      button {
        box-sizing: border-box;
        padding: 7px 16px;
        cursor: pointer;
    ...
    >${this.label}</button>`}connectedCallback(){super.connectedCallback(),Mn(this,`onClick`)}};A([k()],Nn.prototype,`label`,void 0),j.defineAndRegister(Nn);var Pn=[`info`,`success`,`warning`,`danger`];function Fn(e){return Pn.includes(e)?e:`info`}var In=[{wert:`info`,name:`Hinweis`},{wert:`success`,name:`Erfolg`},{wert:`warning`,name:`Warnung`},{wert:`danger`,name:`Fehler`}];function Ln(e,t){return{attributeName:e,name:`Farbe`,description:t,kind:`select`,options:In.map(e=>({value:e.wert,label:e.name}))}}var Rn=o`
...
`,q=class extends j{constructor(...e){super(...e),this.chipVariant=`info`,this.heading=``,this.heading2=``,this.time=``,this.date=``,this.avatar=``,this.meta=``,this.text=``,this.chipText=``,this.headingField=``,this.heading2Field=``,this.timeField=``,this.dateField=``,this.avatarField=``,this.metaField=``,this.textField=``,this.chipTextField=``}static{this.blockType=`card`}static{this.tagName=`ff-card`}static{this.displayName=`Karte`}static{this.category=`anzeige`}static{this.allowedParentTypes=[`kanban-spalte`]}static{this.showInPalette=!1}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={chipVariant:`info`,heading:``,heading2:``,time:``,date:``,avatar:``,meta:``,text:``,chipText:``,headingField:``,heading2Field:``,timeField:``,dateField:``,avatarField:``,metaField:``,textField:``,chipTextField:``}}static{this.bindableSpots=[{prop:`time`,label:`Zeit`},{prop:`date`,label:`Datum`},{prop:`avatar`,label:`Avatar`},{prop:`heading`,label:`Titel`},{prop:`heading2`,label:`Titel 2`},{prop:`meta`,label:`Unterzeile`},{prop:`text`,label:`Textzeile`},{prop:`chipText`,label:`Chip`}]}static{this.customProperties=[Ln(`chipVariant`,`Bedeutung des Chips auf der Karte — bestimmt die Chip-Farbe.`)]}static{this.styles=[j.styles,Rn,Kn]}stelle(e,t){return C`<span
    ...
    >${this[e]}</span>`}hatReiter(){return this.hasAttribute(`data-ff-editor`)||this.date.trim()!==``||this.time.trim()!==``}updated(e){super.updated(e),this.toggleAttribute(`hat-reiter`,this.hatReiter())}render(){let e=Fn(this.chipVariant),t=this.hasAttribute(`data-ff-editor`),n=e=>t||e.trim()!==``,r=this.hatReiter(),i=n(this.avatar)||n(this.heading)||n(this.meta),a=n(this.heading2)||n(this.chipText);return C`<div class="card v-${e}${r?``:` ohne-reiter`}">
      ...
      ${i?C`<div class="kopf">
            ${n(this.avatar)?C`<span
                ...
                >${this.avatar.trim()===``?T:Gn(this.avatar)}</span>`:T}
            <div class="namen">
    ...
    `]}setzeTag(e){$n(e),this.tag=Qn()}render(){return C`<div class="waehler">
      <div class="riegel">
        <button class="pfeil" title="Vortag" @click=${()=>this.setzeTag(Yn(this.tag,-1))}>‹</button>
        <input
          class="feld"
          type="date"
          .value=${this.tag}
        ...
        />
        <button class="pfeil" title="Folgetag" @click=${()=>this.setzeTag(Yn(this.tag,1))}>›</button>
      </div>
      <button class="heute" @click=${()=>this.setzeTag(Jn(new Date))}>Heute</button>
    </div>`}connectedCallback(){super.connectedCallback(),this.tag=Qn()||Jn(new Date),!this.hasAttribute(`data-ff-editor`)&&(this.setzeTag(this.tag),this.tagAbmelden?.(),this.tagAbmelden=er(()=>{this.tag=Qn()}))}disconnectedCallback(){super.disconnectedCallback(),this.tagAbmelden?.(),this.tagAbmelden=null}};A([Ve()],tr.prototype,`tag`,void 0),j.defineAndRegister(tr);var nr={attributeName:`fieldType`,equals:`nachschlagen`},rr=[{attributeName:`fieldType`,name:`Feldtyp`,description:`Welche Art Eingabe das Feld annimmt.`,kind:`select`,options:[{value:`text`,label:`Text`},{value:`number`,label:`Zahl`},{value:`textarea`,label:`Mehrzeilig`},{value:`select`,label:`Auswahl`},{value:`date`,label:`Datum`},{value:`checkbox`,label:`Ankreuzfeld`},{value:`nachschlagen`,label:`Nachschlagen`}]},{attributeName:`options`,name:`Auswahl-Optionen`,description:`Nur bei Feldtyp "Auswahl": Einträge durch Komma getrennt (z. B. "Zimmer 1, Zimmer 2") — jeder Eintrag wird eine Dropdown-Zeile.`,kind:`text`,visibleWhen:{attributeName:`fieldType`,equals:`select`}},{attributeName:`nachschlagQuelle`,name:`Quelle`,description:`Nur bei Feldtyp "Nachschlagen": aus dieser Datenquelle wählt der Bediener eine Zeile.`,kind:`quelle`,visibleWhen:nr},{attributeName:`anzeigeFeld`,name:`Angezeigt wird`,description:`Feld der Nachschlage-Quelle, dessen Wert der Bediener sieht (z. B. der Name).`,kind:`field`,quelleProp:`nachschlagQuelle`,klarnameProp:`anzeigeTitel`,visibleWhen:nr},{attributeName:`speicherFeld`,name:`Gespeichert wird`,description:`Feld der Nachschlage-Quelle, dessen Wert die Maske sich merkt und die Kette "Wert geändert" weitergibt (z. B. die Nummer).`,kind:`field`,quelleProp:`nachschlagQuelle`,klarnameProp:`speicherTitel`,visibleWhen:nr},{attributeName:`einzigerTreffer`,name:`Einzigen Treffer übernehmen`,description:`Bleibt in der Maske genau EIN Satz übrig (weil das Feld der Auswahl eines anderen folgt), übernimmt es diesen von selbst — ohne dass der Bediener die Lupe drückt. Nur in ein leeres Feld; die Lupe bleibt daneben bedienbar.`,kind:`segment`,options:[{value:`ja`,label:`Ja`},{value:`nein`,label:`Nein`}],visibleWhen:nr},{attributeName:`valueField`,name:`Feld`,description:`Feld der angeschlossenen Datenquelle, dessen Wert angezeigt und lokal aktualisiert wird.`,kind:`field`,visibleWhen:{attributeName:`fieldType`,notEquals:`nachschlagen`}}];function ir(e){return`${e.toLowerCase()}field`}function ar(e){let t=e.split(`::`);if(t.length!==2)return{quelleId:``,code:e};let[n,r]=t;return n===``||r===``?{quelleId:``,code:e}:{quelleId:n,code:r}}var or=999,sr=`0`,cr=`255`,lr=new Map;function ur(e){let t=st(e);ot(e,[]),t!==void 0&&t.length>0&&Jt()}async function dr(e,t,n,r,i){return(await Sn({id:`relation-lader`,verb:`GET_RELATION`,nr:e.nr,params:[]},[t.belegart,r,i,t.belegnummer,t.jahr,t.archiv,``,String(n),``,``,``,``],{still:!0,satzAntwort:!0})).wert}function fr(e,t,n){let r=(lr.get(e.id)??0)+1;if(lr.set(e.id,r),n===void 0){ur(e.name);return}let i={belegart:F(n,t.belegartFeld),belegnummer:F(n,t.belegnummerFeld),jahr:t.jahrFeld===``?``:F(n,t.jahrFeld),archiv:t.archivFeld===``?``:F(n,t.archivFeld)};if(i.belegart===``||i.belegnummer===``){ur(e.name);return}ur(e.name),(async()=>{let n=[],a=!1;for(let o=1;o<=or;o+=1){let s=await dr(t,i,o,sr,cr);if(lr.get(e.id)!==r)return;if(t.endeFelder.every(e=>F({SATZ:s},e)===``)){a=!0;break}let c={SATZ:s};for(let n of t.zusatzFelder){let a=n.indexOf(`_`),s=await dr(t,i,o,n.slice(0,a),n.slice(a+1));if(lr.get(e.id)!==r)return;c[n]=s}n.push(c)}a||U(`Positionen laden: nach ${or} Zeilen ohne Ende-Kennung abgebrochen (Relation Nr. ${t.nr}) — die Liste ist wahrscheinlich unvollständig, vermutlich passen Relationsnummer oder Ende-Felder nicht.`),lr.get(e.id)===r&&(ot(e.name,n),Jt())})()}var pr=new Map,mr=!1;function hr(e){if(!(e===``||typeof document>`u`))for(let t of Array.from(document.querySelectorAll(`[data-ff-id]`))){if(t.getAttribute(`source`)!==e)continue;let n=yt(t.getAttribute(`data-ff-id`)??``);if(n!==void 0)return n}}function gr(){let e=W().FF_DATA_SOURCES;if(Array.isArray(e))for(let t of e){if(!N(t)||typeof t.id!=`string`)continue;let n=P(e,t.id);if(!n?.ladeRelation)continue;let r=hr(n.ladeRelation.geberQuelleId),i=pt(r);pr.get(n.id)!==i&&(pr.set(n.id,i),fr(n,n.ladeRelation,r))}}function _r(){mr||(mr=!0,vt(gr))}function vr(e){let t=new Set,n=!1,r=()=>{Bt()&&t.forEach(e.hydriere)};return{connect:i=>{i.hasAttribute(`data-ff-editor`)||(t.add(i),e.verdrahte?.(i),n||(n=!0,Gt(r),er(r),vt(r),_r()),on(),Bt()&&e.hydriere(i))},disconnect:e=>{t.delete(e)}}}var yr=qe.toLowerCase(),br=``;function xr(e){if(e.length===0)return``;let t=[];for(let n of e){let e=n.trim();if(e===``)return``;t.push(e)}return t.join(br)}function Sr(e){let t=e.getAttribute(yr)??``;if(t===``)return[];try{let e=JSON.parse(t);if(!Array.isArray(e))return[];let n=[];for(let t of e){if(!t||typeof t!=`object`)continue;let e=t;if(typeof e.quelleId!=`string`||e.quelleId===``)continue;let r=[];for(let t of Array.isArray(e.keyPairs)?e.keyPairs:[]){if(!t||typeof t!=`object`)continue;let e=t;typeof e.fromField!=`string`||typeof e.toField!=`string`||e.fromField.trim()===``||e.toField.trim()===``||r.push({fromField:e.fromField,toField:e.toField})}r.length!==0&&n.push({quelleId:e.quelleId,keyPairs:r})}return n}catch{return[]}}function Cr(e){let t=Sr(e);if(t.length===0)return(e,t)=>F(e,ar(t).code);let n=W().SEDATA,r=W().FF_DATA_SOURCES,i=new Map;for(let e of t){let t=P(r,e.quelleId);if(!t)continue;let a=L(n,t.name,t.tableId),o=new Map;for(let t of a){let n=xr(e.keyPairs.map(e=>F(t,e.toField)));n!==``&&!o.has(n)&&o.set(n,t)}i.set(e.quelleId,{nachSchluessel:o,hierFelder:e.keyPairs.map(e=>e.fromField)})}return(e,t)=>{let{quelleId:n,code:r}=ar(t);if(n===``)return F(e,r);let a=i.get(n);if(!a)return``;let o=xr(a.hierFelder.map(t=>F(e,t)));if(o===``)return``;let s=a.nachSchluessel.get(o);return s===void 0?``:F(s,r)}}function wr(e,t){let n=e.getAttribute(`source`)??``,r=e.getAttribute(t)??``;if(n===``||r===``)return{art:`ungebunden`};let i=P(W().FF_DATA_SOURCES,n);if(!i)return{art:`ohneQuelle`};let a=Ot(e,L(W().SEDATA,i.name,i.tableId));if(a===void 0)return{art:`ohneZeile`};let{quelleId:o,code:s}=ar(r);return{art:`wert`,wert:o===``?F(a,s):Cr(e)(a,r),zeile:a,quelle:i,quelleId:o,reinerCode:s}}var Tr=new WeakMap,Er=new WeakSet;function Dr(e){let t=/^(\d{2})\.(\d{2})\.(\d{4})$/.exec(e);return t?`${t[3]}-${t[2]}-${t[1]}`:e}function Or(e){let t=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);return t?`${t[3]}.${t[2]}.${t[1]}`:e}function kr(e){return typeof e.value==`string`?e.value:``}function Ar(e){if(e.pruefeEigenenWert?.(),e.getAttribute(`fieldtype`)===`nachschlagen`){Tr.delete(e);return}let t=wr(e,ir(`value`));if(t.art!==`wert`){Tr.delete(e),t.art===`ohneZeile`&&(e.value=``);return}let{zeile:n,quelle:r,quelleId:i,reinerCode:a,wert:o}=t,s=r.indexField===``?``:F(n,r.indexField);i===``?Tr.set(e,{row:n,code:a,pindex:s}):Tr.delete(e),e.value=o}function jr(e){let t=Tr.get(e);return t&&lt(t.row,t.code,kr(e)),t}function Mr(e){Er.has(e)||(Er.add(e),e.addEventListener(`input`,()=>{jr(e)}),e.addEventListener(`change`,()=>{let t=jr(e);An(e,`onChange`,{VALUE:kr(e),PINDEX:t?.pindex??``}).catch(kn)}))}var Nr=vr({hydriere:Ar,verdrahte:Mr}),Pr=Nr.connect,Fr=Nr.disconnect,Ir=o`
  .feld {
    font-family: var(--se-font);
...
`;function Lr(e){return e.trim().toLowerCase().split(/\s+/).filter(e=>e!==``)}function Rr(e,t){let n=Lr(t);if(n.length===0)return!0;let r=e.join(` `).toLowerCase();return n.every(e=>r.includes(e))}var zr=10;function Br(e,t,n){let r=[];for(let i of e){let e=F(i,t).trim(),a=F(i,n).trim();(e!==``||a!==``)&&r.push({anzeige:e,wert:a,satz:i})}return r}function Vr(e,t){return e.filter(e=>Rr([e.anzeige,e.wert],t))}function Hr(e,t,n,r){return Br(Dt(e,t).rows,n,r)}function Ur(e){if(e.quelleId===``||e.anzeigeFeld===``||e.speicherFeld===``)return{ok:!1,grund:`unvollstaendig`};let t=P(W().FF_DATA_SOURCES,e.quelleId);if(!t)return{ok:!1,grund:`quelleFehlt`};let n=L(W().SEDATA,t.name,t.tableId);return{ok:!0,eintraege:Hr(e.el,n,e.anzeigeFeld,e.speicherFeld)}}function Wr(e,t){return t&&e.length===1?e[0]:null}function Gr(e,t){let{rows:n,gefiltert:r}=Dt(e,[t]);return!r||n.length>0}function Kr(e,t,n){return e===``?t===``&&n===``?`nichts`:`leeren`:e===t?`nichts`:`zurueck`}var qr=null;function Jr(){qr?.remove(),qr=null}function Yr(e,t=!1){let n=document.createElement(t?`th`:`td`);return n.textContent=e,n.style.cssText=t?`position:sticky;top:0;z-index:1;padding:6px 10px;text-align:left;font-size:var(--se-fs-sm);font-weight:600;color:var(--se-muted);border-bottom:var(--se-border) solid var(--se-line);background:var(--se-panel-2)`:`box-sizing:border-box;height:24px;padding:3px 10px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;border-bottom:var(--se-border) solid var(--se-line-soft)`,n}function Xr(e,t){let n=document.createElement(`button`);return n.type=`button`,n.textContent=e,n.setAttribute(`aria-label`,t),n.style.cssText=`box-sizing:border-box;width:26px;height:24px;padding:0;border:var(--se-border) solid var(--se-line);border-radius:var(--se-r-sm);background:var(--se-panel);color:var(--se-ink);font:inherit;cursor:pointer`,n}function Zr(e){let t=Ur(e);if(!t.ok){U(t.grund===`unvollstaendig`?`Nachschlagen ist an diesem Feld nicht vollstaendig eingestellt (Quelle, Angezeigt, Gespeichert).`:`Die Nachschlage-Quelle dieses Feldes ist in der Maske nicht vorhanden.`);return}let n=t.eintraege;Jr();let r=document.createElement(At);r.setAttribute(`data-ff-nachschlagen`,``),r.viewport=!0,r.mitWerkzeug=!0,r.escapeSchliesst=!0,r.titel=e.titel===``?`Nachschlagen`:e.titel,r.breite=520,r.hoehe=380,r.addEventListener(jt,Jr),r.addEventListener(`click`,e=>e.stopPropagation());let i=document.createElement(`input`);i.slot=`werkzeug`,i.type=`search`,i.placeholder=`suchen ...`,i.setAttribute(`aria-label`,`Nachschlagen durchsuchen`),i.style.cssText=`box-sizing:border-box;width:100%;padding:5px 8px;font:inherit;color:inherit;background:var(--se-panel);border:var(--se-border) solid var(--se-line);border-radius:var(--se-r-sm)`;let a=document.createElement(`table`);a.style.cssText=`width:100%;table-layout:fixed;border-collapse:collapse`;let o=document.createElement(`colgroup`),s=document.createElement(`col`);s.style.width=`65%`;let c=document.createElement(`col`);c.style.width=`35%`,o.append(s,c);let l=document.createElement(`thead`),u=document.createElement(`tr`);u.append(Yr(e.anzeigeTitel===``?`Angezeigt`:e.anzeigeTitel,!0),Yr(e.speicherTitel===``?`Wert`:e.speicherTitel,!0)),l.appendChild(u);let d=document.createElement(`tbody`);a.append(o,l,d);let f=document.createElement(`div`);f.style.cssText=`flex:1 1 auto;min-height:0;overflow:auto`,f.appendChild(a);let ee=document.createElement(`div`);ee.style.cssText=`box-sizing:border-box;flex:none;display:flex;align-items:center;min-height:33px;padding:4px 10px;border-top:var(--se-border) solid var(--se-line);background:var(--se-panel-2);font-size:var(--se-fs-sm)`;let te=document.createElement(`span`);te.setAttribute(`aria-live`,`polite`),te.style.cssText=`flex:1;color:var(--se-muted)`;let p=document.createElement(`nav`);p.setAttribute(`aria-label`,`Trefferseiten`),p.style.cssText=`display:flex;align-items:center;gap:6px`;let m=Xr(`‹`,`Vorherige Seite`),ne=document.createElement(`span`);ne.style.cssText=`min-width:48px;text-align:center;color:var(--se-muted)`;let h=Xr(`›`,`Nächste Seite`);p.append(m,ne,h),ee.append(te,p);let g=document.createElement(`div`);g.style.cssText=`box-sizing:border-box;height:100%;min-height:0;display:flex;flex-direction:column`,g.append(f,ee);let _=1,v=1,y=()=>{d.replaceChildren();let t=Vr(n,i.value);v=Math.max(1,Math.ceil(t.length/zr)),_=Math.min(_,v);let r=(_-1)*zr,a=t.slice(r,r+zr);if(te.textContent=t.length===0?`0 von 0`:`${r+1}-${Math.min(r+zr,t.length)} von ${t.length}`,ne.textContent=`${_} / ${v}`,m.disabled=_===1,h.disabled=_===v,m.style.opacity=m.disabled?`0.4`:`1`,h.style.opacity=h.disabled?`0.4`:`1`,m.style.cursor=m.disabled?`default`:`pointer`,h.style.cursor=h.disabled?`default`:`pointer`,f.scrollTop=0,a.length===0){let e=document.createElement(`tr`),t=Yr(n.length===0?`Diese Quelle hat keine Sätze.`:`Kein Satz passt zur Suche.`);t.colSpan=2,t.style.color=`var(--se-faint)`,t.style.fontSize=`var(--se-fs-sm)`,t.style.padding=`16px 10px`,e.appendChild(t),d.appendChild(e);return}for(let t of a){let n=document.createElement(`tr`);n.tabIndex=0,n.style.cursor=`pointer`;let r=Yr(t.anzeige),i=Yr(t.wert);i.style.fontFamily=`var(--se-mono)`,i.style.color=`var(--se-muted)`,n.append(r,i);let a=()=>{Jr(),e.onUebernehmen(t.anzeige,t.wert,t.satz)};n.addEventListener(`click`,a),n.addEventListener(`keydown`,e=>{e.key===`Enter`&&(e.preventDefault(),a())}),n.addEventListener(`mouseenter`,()=>{n.style.background=`var(--se-accent-soft)`}),n.addEventListener(`mouseleave`,()=>{n.style.background=``}),d.appendChild(n)}};i.addEventListener(`input`,()=>{_=1,y()}),m.addEventListener(`click`,()=>{_!==1&&(--_,y())}),h.addEventListener(`click`,()=>{_!==v&&(_+=1,y())}),y(),r.append(i,g),document.body.appendChild(r),qr=r,r.updateComplete.then(()=>{r.isConnected&&i.focus()})}var Qr=[`text`,`number`,`textarea`,`select`,`date`,`checkbox`,`nachschlagen`];function $r(e){return Qr.includes(e)?e:`text`}var ei=[`text`,`number`,`textarea`,`select`,`nachschlagen`],J=class extends j{constructor(...e){super(...e),this.fieldType=`text`,this.placeholder=`Feldname`,this.options=``,this.source=``,this.value=``,this.valueField=``,this.nachschlagQuelle=``,this.anzeigeFeld=``,this.anzeigeTitel=``,this.speicherFeld=``,this.speicherTitel=``,this.einzigerTreffer=`nein`,this.anzeige=``,this.getippt=null,this.satz=void 0,this.angehakt=!1}static{this.blockType=`formfeld`}static{this.tagName=`ff-formfeld`}static{this.displayName=`Formularfeld`}static{this.category=`eingabe`}static{this.acceptsDataSource={wenn:{attributeName:`fieldType`,notEquals:`nachschlagen`}}}static{this.kannAuswahlFolgen=!0}static{this.satzWahl={quelleProp:`nachschlagQuelle`,wenn:{attributeName:`fieldType`,equals:`nachschlagen`}}}static{this.bindableSpots=[{prop:`value`,label:`Wert`,wenn:{attributeName:`fieldType`,notEquals:`nachschlagen`},vorschauProp:`placeholder`}]}static{this.actionValueSpots=[{prop:`value`,label:`Wert`}]}static{this.blockEvents=[{key:`onChange`,name:`Wert geändert`}]}static{this.defaultProps={width:240,fieldType:`text`,placeholder:`Feldname`,options:``,source:``,value:``,valueField:``,nachschlagQuelle:``,anzeigeFeld:``,anzeigeTitel:``,speicherFeld:``,speicherTitel:``,einzigerTreffer:`nein`}}static{this.raster={startW:6,startH:2,minW:2,minH:2}}static{this.customProperties=rr}static{this.styles=[j.styles,Ir]}onInput(e){let t=e.target;this.value=$r(this.fieldType)===`date`?Or(t.value):t.value}onChange(){this.dispatchEvent(new Event(`change`))}textTpl(e,t=!1){return C`<span
      class=${e}
      ?hidden=${t}
      data-ff-editable
    ...
    >${this.placeholder}</span>`}onTextClick(){this.hasAttribute(`data-ff-editor`)||this.setzeHaken(!this.angehakt)}setzeHaken(e){this.angehakt!==e&&(this.angehakt=e,this.dispatchEvent(new Event(`change`)))}controlTpl(e){switch(e){case`textarea`:return C`<textarea class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}></textarea>`;case`select`:{let e=this.options.split(`,`).map(e=>e.trim()).filter(e=>e!==``),t=this.value!==``&&!e.includes(this.value);return C`<select class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}>
          ...
          class="ctrl"
          type=${e}
          .value=${e===`date`?Dr(this.value):this.value}
          @input=${this.onInput}
          @change=${this.onChange}
        />`}}onLupe(){this.hasAttribute(`data-ff-editor`)||Zr({el:this,quelleId:this.nachschlagQuelle,anzeigeFeld:this.anzeigeFeld,speicherFeld:this.speicherFeld,anzeigeTitel:this.anzeigeTitel,speicherTitel:this.speicherTitel,titel:this.placeholder,onUebernehmen:(e,t,n)=>{this.uebernimmSatz(e,t,n),this.dispatchEvent(new Event(`change`))}})}leereNachschlagen(){this.satz=void 0,this.anzeige=``,this.value=``,wt(z(this))}uebernimmSatz(e,t,n){this.anzeige=e===``?t:e,this.value=t,this.satz=n,Ct(z(this),n)}onNachschlagVerlassen(){if(this.hasAttribute(`data-ff-editor`))return;let e=Kr(this.getippt??this.anzeige,this.anzeige,this.value);this.getippt=null,e===`leeren`&&(this.leereNachschlagen(),this.dispatchEvent(new Event(`change`)))}pruefeEigenenWert(){$r(this.fieldType)===`nachschlagen`&&(this.satz!==void 0&&!Gr(this,this.satz)&&this.leereNachschlagen(),this.uebernimmEinzigenTreffer())}uebernimmEinzigenTreffer(){if(this.einzigerTreffer!==`ja`)return;let e=Ur({el:this,quelleId:this.nachschlagQuelle,anzeigeFeld:this.anzeigeFeld,speicherFeld:this.speicherFeld});if(!e.ok)return;let t=Wr(e.eintraege,this.satz===void 0);t&&this.uebernimmSatz(t.anzeige,t.wert,t.satz)}render(){let e=$r(this.fieldType);if(e===`checkbox`)return C`<div class="feld">
        <div class="zeile">
          <input
            class="ctrl"
            type="checkbox"
      ...
      >
        ${this.controlTpl(e)}
        ${ei.includes(e)?this.textTpl(e===`select`?`ph ph-select`:`ph`,n!==``):T}
      </div>
    </div>`}connectedCallback(){super.connectedCallback(),Pr(this)}disconnectedCallback(){super.disconnectedCallback(),Fr(this)}};A([k()],J.prototype,`fieldType`,void 0),A([k()],J.prototype,`placeholder`,void 0),A([k()],J.prototype,`options`,void 0),A([k()],J.prototype,`source`,void 0),A([k()],J.prototype,`value`,void 0),A([k()],J.prototype,`valueField`,void 0),A([k()],J.prototype,`nachschlagQuelle`,void 0),A([k()],J.prototype,`anzeigeFeld`,void 0),A([k()],J.prototype,`anzeigeTitel`,void 0),A([k()],J.prototype,`speicherFeld`,void 0),A([k()],J.prototype,`speicherTitel`,void 0),A([k()],J.prototype,`einzigerTreffer`,void 0),A([Ve()],J.prototype,`anzeige`,void 0),A([Ve()],J.prototype,`getippt`,void 0),A([Ve()],J.prototype,`angehakt`,void 0),j.defineAndRegister(J);var ti=`Keine Datensätze.`;function ni(){return{attributeName:`leerText`,name:`Text ohne Datensätze`,description:`Steht in der Maske dort, wo sonst die Zeilen stehen — wenn die Datenquelle keine liefert. Leer lassen: dann steht dort gar nichts.`,kind:`text`,requiresDataSource:!0}}function ri(e,t=!1){return e.trim()===``?T:C`<div class="leer${t?` leer--tafel`:``}">
    ${Bn()}
    <span>${e}</span>
  </div>`}var ii=o`
  .leer {
...
`;function ai(e,t,n,r){return{attributeName:e,name:t,description:n,kind:`select`,options:[{value:`nein`,label:`Nein`},{value:`ja`,label:`Ja`}],...r}}var Y=class extends j{constructor(...e){super(...e),this.variant=`info`,this.heading=`Neue Spalte`,this.leerHinweis=``,this._count=0}static{this.blockType=`kanban-spalte`}static{this.tagName=`ff-kanban-spalte`}static{this.displayName=`Kanban-Spalte`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[q.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={variant:`info`,heading:`Neue Spalte`,auffang:`nein`}}static{this.customProperties=[Ln(`variant`,`Bedeutung der Spalte — bestimmt ihre Farbwelt (Kopf, Fläche, Rahmen).`),ai(`auffang`,`Auffangspalte`,`Einträge ohne passenden Spaltentitel landen hier. Ohne Auffangspalte landen sie in der ersten Spalte.`,{requiresDataSource:!0,exclusiveAmongSiblings:!0})]}static{this.styles=[j.styles,ii,o`
    ...
    `]}onSlotChange(e){let t=e.target;this._count=t.assignedElements().filter(e=>!e.hasAttribute(`data-ff-editor-helper`)&&e.tagName.toLowerCase()!==`template`).length}render(){return C`<div class="col v-${Fn(this.variant)}">
      <div class="head">
        <span class="dot"></span>
        <span
          class="title"
    ...
    </div>`}};A([k()],Y.prototype,`variant`,void 0),A([k()],Y.prototype,`heading`,void 0),A([k({attribute:!1})],Y.prototype,`leerHinweis`,void 0),A([Ve()],Y.prototype,`_count`,void 0),j.defineAndRegister(Y);function oi(e,t,n){return t===``||n===``?[...e]:e.filter(e=>qn(F(e,t))===n)}function si(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function ci(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var li=new WeakMap,ui=Y.tagName,di=q.tagName;function fi(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===ui)}function pi(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===di)}function mi(e,t){let n=e.getAttribute(`leertext`)??`Keine Datensätze.`;for(let e of t)e.leerHinweis=pi(e).length===0?n:``}function hi(e){return We().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function gi(e){Z?.board===e&&(Z=null);let t=e.getAttribute(`source`)??``,n=e.getAttribute(`statusfield`)??``;if(t===``)return;let r=P(W().FF_DATA_SOURCES,t);if(!r)return;let i=fi(e);if(i.length===0)return;let a=li.get(e);if(!a){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(di);t&&(a=t.cloneNode(!0),li.set(e,a))}if(!a)return;let o=oi(L(W().SEDATA,r.name,r.tableId),e.getAttribute(`tagfield`)??``,Qn()),s=i.map(e=>e.getAttribute(`heading`)??Y.defaultProps.heading),c=hi(a.tagName),l=ci(i.map(e=>e.getAttribute(`auffang`))),u=Cr(e);for(let e of i)pi(e).forEach(e=>e.remove());for(let e of o){let t=a.cloneNode(!0),o=n===``?-1:si(F(e,n),s);(o>=0?i[o]:l>=0?i[l]:i[0]).appendChild(t);for(let n of c){let r=t.getAttribute(ir(n.prop))??``;r!==``&&(t[n.prop]=u(e,r))}let d=r.indexField===``?``:F(e,r.indexField);X.set(t,{row:e,pindex:d}),t.draggable=!0}mi(e,i);let d=i.flatMap(pi),f=xt(z(e),d,e=>X.get(e)?.row);for(let e of f)d[e].setAttribute(`data-ff-auswahl`,``)}var X=new WeakMap,Z=null,_i=new WeakSet;function vi(e,t){for(let n of t.composedPath())if(n instanceof HTMLElement&&n.tagName.toLowerCase()===ui&&e.contains(n))return n;return null}function yi(e,t){if(!Z||Z.board!==e)return;let n=X.get(Z.card);if(!n)return;let r=t.getAttribute(`heading`)??``;An(e,`onCardDrop`,{PINDEX:n.pindex,VALUE:r}).catch(kn)}function bi(e){_i.has(e)||(_i.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;if(!n)return;let r=X.get(n);r&&St(z(e),r.row),An(e,`onCardClick`,{PINDEX:r?.pindex??``}).catch(kn)}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;n&&(Z={card:n,board:e},t.dataTransfer?.setData(`text/plain`,X.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`))}),e.addEventListener(`dragend`,()=>{Z=null}),e.addEventListener(`dragover`,t=>{let n=vi(e,t);Z?.board===e&&n&&(t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`))}),e.addEventListener(`drop`,t=>{let n=vi(e,t);n&&(t.preventDefault(),yi(e,n),Z=null)}))}var xi=vr({hydriere:gi,verdrahte:bi}),Si=xi.connect,Ci=xi.disconnect,wi=Y.blockType,Ti=class extends j{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[wi]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:wi}}static{this.templateChild={type:q.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``,tagField:``,leerText:ti}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Optional: Feld der Datenquelle, dessen Inhalt bestimmt, in welche Spalte ein Eintrag kommt. Leer = alle Einträge in der Auffang-Spalte.`,kind:`field`},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt das Board nur Einträge des Tages, den der Tageswähler zeigt. Leer = alle Einträge.`,kind:`field`},ni()]}static{this.defaultChildren=[{type:wi,props:{heading:`Offen`,variant:`warning`},children:[{type:q.blockType}]},{type:wi,props:{heading:`In Arbeit`,variant:`info`}},{type:wi,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[j.styles,o`
    ...
    `]}render(){return C`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),Si(this)}disconnectedCallback(){super.disconnectedCallback(),Ci(this)}};j.defineAndRegister(Ti);var Ei={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Di=e=>(...t)=>({_$litDirective$:e,values:t}),Oi=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},ki=`important`,Ai=` !important`,ji=Di(class extends Oi{constructor(e){if(super(e),e.type!==Ei.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(Ai);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?ki:``):n[e]=r}}return w}}),Mi=4;function Ni(e){return e??Mi}function Pi(e,t,n){return Math.max(1,Math.floor((e-t)/n))}function Fi(e,t,n){let r=Pi(e,t,n),i=e-t;return i<n?{passen:r,zeilenHoehe:n}:{passen:r,zeilenHoehe:Math.floor(i/r*100)/100}}function Ii(e,t){return e===null?null:Math.max(0,e-t)}function Li({sichtbar:e,hatQuelle:t,proSeite:n,wunschSeite:r,platzhalterZeilen:i}){let a=t?Math.max(1,Math.ceil(e.length/n)):1,o=Math.min(Math.max(r,0),a-1);return t?{seiten:a,seite:o,zeilen:[...e.slice(o*n,(o+1)*n)]}:{seiten:a,seite:o,zeilen:Array.from({length:i},()=>null)}}function Ri(e,t){if(!e.hasAttribute(`fuellt`))return null;let n=e.renderRoot.querySelector(`.koerper`),r=e.renderRoot.querySelector(`.kopf`);return!(n instanceof HTMLElement)||!(r instanceof HTMLElement)?null:Fi(n.clientHeight,r.offsetHeight,t)}function zi(e,t){if(typeof ResizeObserver>`u`)return null;let n=e.renderRoot.querySelector(`.koerper`);if(!n)return null;let r=new ResizeObserver(t);return r.observe(n),r}function Bi(e,t){let n=t.trim().toLowerCase();return e.find(e=>e.wert.trim().toLowerCase()===n)}var Vi=`text`,Hi=`status`,Ui=`bild`,Wi=`bild`,Gi=`unter`,Ki=[{wert:Vi,name:`Text`,spur:`minmax(0, 1fr)`,klasse:``,zelle:e=>e},{wert:`zahl`,name:`Zahl`,spur:`90px`,klasse:`zahl`,zelle:e=>e},{wert:`datum`,name:`Datum`,spur:`100px`,klasse:`zahl`,zelle:e=>e},{wert:Hi,name:`Status`,spur:`120px`,klasse:`status`,zelle:(e,t)=>{let n=Bi(t,e);return n?C`<span class="chip v-${Fn(n.bedeutung)}">${n.name.trim()===``?e:n.name}</span>`:C`<span class="chip">${e}</span>`}},{wert:Ui,name:`Bild + Name`,spur:`minmax(0, 1fr)`,klasse:`bild`,zusatzFelder:[{key:Wi,label:`Bild`},{key:Gi,label:`Unterzeile`}],hoehe:e=>(e[Wi]??``)!==``||(e[Gi]??``)!==``?44:32,zelle:(e,t,n)=>{let r=Wn(n[Wi]??``),i=n[Gi]??``;return C`<div class="bild-name">
        ${r===void 0?T:C`<span class="bild-zeichen">${r}</span>`}
        <div class="bild-text">
          <div class="bild-titel">${e}</div>
          ${i===``?T:C`<div class="bild-unter">${i}</div>`}
        </div>
      </div>`}}];function qi(e){return e.reduce((e,t)=>{let n=Ji(t.art);return Math.max(e,n.hoehe?.(t.felder??{})??32)},32)}function Ji(e){return Ki.find(t=>t.wert===e)??Ki[0]}var Yi=Ki.map(e=>({wert:e.wert,name:e.name,...e.zusatzFelder?{felder:e.zusatzFelder}:{}})),Xi=`felder`,Zi=`Spalte {n}`;function Qi(e){return Zi.replace(`{n}`,String(e+1))}function $i(e){return{titel:Qi(e),feld:``,art:Vi}}function ea(){return[0,1,2].map(e=>$i(e))}function ta(e){return Array.isArray(e)?e.filter(e=>!!e&&typeof e==`object`).map(e=>({wert:typeof e.wert==`string`?e.wert:``,name:typeof e.name==`string`?e.name:``,bedeutung:typeof e.bedeutung==`string`?e.bedeutung:``})).filter(e=>e.wert.trim()!==``):[]}function na(e){if(!e||typeof e!=`object`||Array.isArray(e))return{};let t={};for(let[n,r]of Object.entries(e))typeof r==`string`&&r!==``&&(t[n]=r);return t}function ra(e,t){if(e&&typeof e==`object`){let n=e,r=ta(n.zuordnung),i=na(n.felder);return{titel:typeof n.titel==`string`?n.titel:Qi(t),feld:typeof n.feld==`string`?n.feld:``,art:typeof n.art==`string`?n.art:Vi,...r.length>0?{zuordnung:r}:{},...Object.keys(i).length>0?{felder:i}:{}}}return typeof e==`string`?{...$i(t),titel:e}:$i(t)}function ia(e){let t;if(Array.isArray(e))t=e.map((e,t)=>ra(e,t));else if(typeof e==`number`&&Number.isFinite(e)||typeof e==`string`&&/^\d+$/.test(e)){let n=Math.max(1,Math.floor(Number(e)));t=[...Array(n).keys()].map(e=>$i(e))}else t=ea();return t.length>8&&(t=t.slice(0,8)),t.length<1&&(t=[$i(0)]),t}function aa(e){try{return ia(JSON.parse(e))}catch{return ea()}}function oa(e){return aa(e.getAttribute(`spalten`)??``)}function sa(e,t,n){let r={};for(let i of Ji(e.art).zusatzFelder??[]){let a=e.felder?.[i.key]??``;a!==``&&(r[i.key]=n(t,a))}return r}function ca(e){let t=()=>{e.datenzeilen=[],e.zusatzzeilen=[]},n=e.getAttribute(`source`)??``;if(n===``){t();return}let r=P(W().FF_DATA_SOURCES,n);if(!r){t();return}let i=oa(e),{rows:a,gefiltert:o}=Dt(e,oi(L(W().SEDATA,r.name,r.tableId),e.getAttribute(`tagfield`)??``,Qn())),s=xt(z(e),a,e=>e)[0]??-1,c=Cr(e);e.datenGeliefert=!0,e.rohzeilen=a,e.auswahlIndex=s,e.durchAuswahlGefiltert=o,e.datenzeilen=a.map(e=>i.map(t=>t.feld===``?``:c(e,t.feld))),e.zusatzzeilen=a.map(e=>i.map(t=>sa(t,e,c)))}var la=vr({hydriere:ca}),ua=la.connect,da=la.disconnect;function fa(e,t,n){return C`<div class="steuerung">
    <button
    ...
    <button
      ...
      @pointerdown=${n}
      @click=${r=>{n(r);let i=e();i.length<8&&(i.push($i(i.length)),t(i))}}
    >+</button>
  </div>`}function pa(e,t){let n=e.currentTarget;if(!n)return;e.stopPropagation(),e.preventDefault();let r=Array.from(n.childNodes),i=n.textContent??``;n.setAttribute(`contenteditable`,`plaintext-only`),n.focus();let a=window.getSelection(),o=document.createRange();o.selectNodeContents(n),a?.removeAllRanges(),a?.addRange(o);let s=!1,c=e=>{if(s)return;s=!0,n.removeAttribute(`contenteditable`),n.removeEventListener(`blur`,l),n.removeEventListener(`keydown`,u);let a=(n.textContent??``).trim();e&&a&&a!==i.trim()?t(a):n.replaceChildren(...r)},l=()=>c(!0),u=e=>{e.key===`Enter`?(e.preventDefault(),n.blur()):e.key===`Escape`&&(e.preventDefault(),c(!1))};n.addEventListener(`blur`,l),n.addEventListener(`keydown`,u)}function ma(e,t,n,r){pa(e,e=>{let i=n();t>=i.length||(i[t]={...i[t],titel:e},r(i))})}var ha=220,ga=new WeakMap;function _a(e){let t=ga.get(e);t!==void 0&&(clearTimeout(t),ga.delete(e))}function va(e,t,n,r){t.stopPropagation();let i=t.currentTarget.getBoundingClientRect();_a(e),ga.set(e,setTimeout(()=>{ga.delete(e),e.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:n,index:r,top:i.bottom+4,left:i.left},bubbles:!0,composed:!0}))},ha))}var ya={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:Zi,eintragsWahl:{key:`art`,label:`Darstellung`,optionen:Yi,standard:Vi,felderKey:Xi},eintragsZuordnung:{key:`zuordnung`,label:`Status-Zuordnung`,nurBeiWahl:Hi,wertLabel:`Datenwert`,nameLabel:`Klarname`,bedeutungLabel:`Bedeutung`,bedeutungen:In}},ba=1,xa=/^-?\d{1,3}(\.\d{3})*(,\d+)?$|^-?\d+(,\d+)?$|^-?\d+(\.\d+)?$/,Sa=/^(\d{1,2})\.(\d{1,2})\.(\d{2}|\d{4})$/,Ca=/^(\d{4})-(\d{2})-(\d{2})$/;function wa(e){let t=e.trim();if(t===``||!xa.test(t))return null;let n=t.includes(`,`)?t.replace(/\./g,``).replace(`,`,`.`):/^-?\d{1,3}(\.\d{3})+$/.test(t)?t.replace(/\./g,``):t,r=Number(n);return Number.isFinite(r)?r:null}function Ta(e){let t=e.trim();if(t===``)return null;let n=Ca.exec(t);if(n){let[,e,t,r]=n;return Ea(Number(e),Number(t),Number(r))}let r=Sa.exec(t);if(r){let[,e,t,n]=r,i=Number(n);return Ea(n.length===2?i<=69?2e3+i:1900+i:i,Number(t),Number(e))}return null}function Ea(e,t,n){if(t<1||t>12||n<1||n>31)return null;let r=new Date(e,t-1,n);return r.getFullYear()!==e||r.getMonth()!==t-1||r.getDate()!==n?null:r.getTime()}function Da(e){let t=0,n=0,r=0;for(let i of e)i.trim()!==``&&(t++,wa(i)!==null&&n++,Ta(i)!==null&&r++);return t===0?`text`:r===t?`datum`:n===t?`zahl`:`text`}var Oa=new Intl.Collator(`de`,{numeric:!0,sensitivity:`base`});function ka(e,t,n){if(t<0||e.length===0)return e.map((e,t)=>t);let r=n=>e[n][t]??``,i=Da(e.map(e=>e[t]??``)),a=n?1:-1;return e.map((e,t)=>t).sort((e,t)=>{let n=r(e).trim(),o=r(t).trim();if(n===``&&o===``)return e-t;if(n===``)return ba;if(o===``)return-1;let s=i===`zahl`?(wa(n)??0)-(wa(o)??0):i===`datum`?(Ta(n)??0)-(Ta(o)??0):Oa.compare(n,o);return s===0?e-t:s*a})}function Aa(e,t){let n=[];return e.forEach((e,r)=>{Rr(e,t)&&n.push(r)}),n}function ja(e,t){return!e&&t.trim()!==``}function Ma(e,t,n){return e&&t&&n===0}function Na(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}function Pa(e){let t=Aa(e.datenzeilen,e.suchtext);return e.sortSpalte<0?t:ka(t.map(t=>e.datenzeilen[t]),e.sortSpalte,e.sortAuf).map(e=>t[e])}function Fa(e){let t={gridTemplateColumns:e.spalten.map(e=>Ji(e.art).spur).join(` `)},n=qi(e.spalten),r=e.gemessen?.zeilenHoehe??n,i=ja(e.imEditor,e.source),a=Ma(i,e.datenGeliefert,e.datenzeilen.length),o=Pa(e),{seiten:s,seite:c,zeilen:l}=Li({sichtbar:o,hatQuelle:i,proSeite:e.gemessen?.passen??10,wunschSeite:e.wunschSeite,platzhalterZeilen:Ni(e.gemessen?.passen??null)});return{cols:t,takt:n,zeilenHoehe:r,hatQuelle:i,leer:a,gesamt:o.length,seiten:s,seite:c,zeilen:l,linealTakte:Ii(e.gemessen?.passen??null,l.length)}}var Ia=[{attributeName:`suche`,name:`Suchzeile`,description:`Zeigt über der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,kind:`segment`,options:[{value:`ja`,label:`Ja`},{value:`nein`,label:`Nein`}],requiresDataSource:!0},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt die Tabelle nur Sätze des Tages, den der Tageswähler zeigt. Leer = alle Sätze.`,kind:`field`},ni()];function La(e,t){return C`<div class="fusszeile">
    <div class="seiten-info">${Na({hatQuelle:e.hatQuelle,sichtbar:e.sichtbar,gesamt:e.gesamt,suchtAktiv:e.suchtAktiv,auswahlAktiv:e.auswahlAktiv})}</div>
    <div class="seiten-nav">
  ...
  </div>`}var Ra=`—`;function za(e){return e.linealTakte===0?T:C`<div class="lineal" style=${ji(e.linealTakte===null?e.cols:{...e.cols,flex:`0 1 auto`,height:`calc(var(--zeilen-hoehe) * ${e.linealTakte})`})}>
          ${e.spalten.map(()=>C`<div></div>`)}
        </div>`}function Ba(e,t){return C`
      ...
      <div class="koerper">
      <div class="kopf" style=${ji(e.cols)}>
        ${e.spalten.map((n,r)=>C`<div
            class=${Ji(n.art).klasse}
            data-ff-editable
        ...
        ${e.zeilen.map(n=>C`<div
          ...
          >
            ${``}
            ${e.spalten.map((t,r)=>{let i=Ji(t.art),a=n===null?Ra:e.datenzeilen[n]?.[r]??``,o=n===null?{}:e.zusatzzeilen[n]?.[r]??{};return C`<div class=${i.klasse}>${i.zelle(a,t.zuordnung??[],o)}</div>`})}
          </div>`)}
        ${za(e)}`}
      </div>
    `}var Va=o`
...
`,Q=class e extends j{constructor(...e){super(...e),this.spalten=ea(),this.source=``,this.suche=`ja`,this.leerText=ti,this._suchtext=``,this.datenzeilen=[],this.zusatzzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this.datenGeliefert=!1,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._beobachter=null,this._taktGemessen=0}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.listenBindung=ya}static{this.defaultProps={width:`fill`,source:``,spalten:ea(),suche:`ja`,tagField:``,leerText:ti}}static{this.customProperties=Ia}static{this.raster={startW:14,startH:8,minW:6,minH:4}}messeRumpf(){let e=this.zeilenHoehe;this._taktGemessen=e;let t=Ri(this,e);t?.passen===this._mass?.passen&&t?.zeilenHoehe===this._mass?.zeilenHoehe||(this._mass=t,this.requestUpdate())}spaltenListe(){return ia(this.spalten)}get zeilenHoehe(){return qi(this.spaltenListe())}klickZeile(e){if(e===null||this.hasAttribute(`data-ff-editor`))return;let t=z(this),n=this.rohzeilen[e];t===``||n===void 0||St(t,n)}setzeSuchtext(e){this._suchtext=e,this._seite=0,this.requestUpdate()}klickSortiere(e){this.editable||(this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.requestUpdate())}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}beobachte(){this._beobachter||(this._beobachter=zi(this,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}connectedCallback(){super.connectedCallback(),ua(this),this.beobachte()}firstUpdated(){this.beobachte()}updated(){this._taktGemessen!==this.zeilenHoehe&&this.messeRumpf()}disconnectedCallback(){super.disconnectedCallback(),_a(this),this._beobachter?.disconnect(),this._beobachter=null,da(this)}static{this.styles=[j.styles,Rn,ii,Va]}render(){let t=this.spaltenListe(),n=e=>e.stopPropagation(),r=Fa({spalten:t,imEditor:this.hasAttribute(`data-ff-editor`),source:this.source,datenGeliefert:this.datenGeliefert,datenzeilen:this.datenzeilen,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,wunschSeite:this._seite,gemessen:this._mass});return C`<div class="tabelle" style=${ji({"--takt":`${r.takt}px`,"--zeilen-hoehe":`${r.zeilenHoehe}px`})}>
      ${fa(()=>this.spaltenListe(),e=>this.aendere(e),n)}
      ${Ba({spalten:t,cols:r.cols,editable:this.editable,zeigeSuche:this.suche===`ja`,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,zeilen:r.zeilen,linealTakte:r.linealTakte,datenzeilen:this.datenzeilen,zusatzzeilen:this.zusatzzeilen,hatQuelle:r.hatQuelle,auswahlIndex:this.auswahlIndex,leer:r.leer,leerText:this.leerText},{setzeSuchtext:e=>this.setzeSuchtext(e),dblklickKopf:(e,t)=>{this.editable&&(_a(this),ma(e,t,()=>this.spaltenListe(),e=>this.aendere(e)))},klickKopf:(t,n)=>{this.editable&&va(this,t,e.listenBindung.prop,n),this.klickSortiere(n)},klickZeile:e=>this.klickZeile(e),stop:n})}
      ${``}
      ${r.leer?T:La({hatQuelle:r.hatQuelle,sichtbar:r.gesamt,gesamt:this.datenzeilen.length,suchtAktiv:this._suchtext.trim()!==``,auswahlAktiv:this.durchAuswahlGefiltert,seite:r.seite,seiten:r.seiten},{blaettere:e=>{this._seite=e,this.requestUpdate()},stop:n})}
    </div>`}};A([k({converter:{fromAttribute:e=>e?aa(e):ea(),toAttribute:e=>JSON.stringify(e)}})],Q.prototype,`spalten`,void 0),A([k()],Q.prototype,`source`,void 0),A([k()],Q.prototype,`suche`,void 0),A([k()],Q.prototype,`leerText`,void 0),A([k({attribute:!1})],Q.prototype,`datenzeilen`,void 0),A([k({attribute:!1})],Q.prototype,`zusatzzeilen`,void 0),A([k({attribute:!1})],Q.prototype,`rohzeilen`,void 0),A([k({attribute:!1})],Q.prototype,`auswahlIndex`,void 0),A([k({attribute:!1})],Q.prototype,`durchAuswahlGefiltert`,void 0),A([k({attribute:!1})],Q.prototype,`datenGeliefert`,void 0),j.defineAndRegister(Q);var Ha=ir(`text`);function Ua(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(Ha)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function Wa(e){let t=wr(e,Ha);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function Ga(e){Ua(e)&&(e.text=``)}var Ka=vr({hydriere:Wa,verdrahte:Ga}),qa=Ka.connect,Ja=Ka.disconnect,Ya=6,Xa=96,Za=14,Qa={duenn:`300`,normal:`400`,fett:`700`},$a={links:`left`,mitte:`center`,rechts:`right`},eo={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},to=`standard`;function no(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(Xa,Math.max(Ya,t)):Za}function ro(e){return typeof e==`string`&&e in Qa?e:`normal`}function io(e){return typeof e==`string`&&e in $a?e:`links`}function ao(e){return typeof e==`string`&&e in eo?e:to}var $=class extends j{constructor(...e){super(...e),this.groesse=Za,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=to,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:Za,gewicht:`normal`,ausrichtung:`links`,farbe:to,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:Ya,max:Xa,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[j.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return C`<div
      class="text"
      style=${ji({fontSize:`${no(this.groesse)}px`,fontWeight:Qa[ro(this.gewicht)],textAlign:$a[io(this.ausrichtung)],color:eo[ao(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),qa(this)}disconnectedCallback(){super.disconnectedCallback(),Ja(this)}};A([k({type:Number})],$.prototype,`groesse`,void 0),A([k()],$.prototype,`gewicht`,void 0),A([k()],$.prototype,`ausrichtung`,void 0),A([k()],$.prototype,`farbe`,void 0),A([k()],$.prototype,`text`,void 0),A([k()],$.prototype,`source`,void 0),A([k()],$.prototype,`textField`,void 0),j.defineAndRegister($);var oo=[`waagerecht`,`senkrecht`],so=`waagerecht`;function co(e){return oo.includes(e)?e:so}var lo=class extends j{constructor(...e){super(...e),this.richtung=so}static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`,richtung:so}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1,varianten:[{wenn:{attributeName:`richtung`,equals:`senkrecht`},startW:1,startH:6,breiteZiehbar:!1}]}}static{this.customProperties=[{attributeName:`richtung`,name:`Richtung`,description:`Waagerecht trennt oben von unten, senkrecht links von rechts.`,kind:`select`,options:[{value:`waagerecht`,label:`Waagerecht`},{value:`senkrecht`,label:`Senkrecht`}]}]}static{this.styles=[j.styles,o`
    ...
    `]}render(){return C`<div class="zeile"><slot></slot></div>`}};j.defineAndRegister(uo),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;U(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();
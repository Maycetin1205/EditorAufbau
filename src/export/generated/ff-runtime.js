...
`;function $r(e,t,n,r){return{attributeName:e,name:t,description:n,kind:`segment`,options:[{value:`nein`,label:`Nein`},{value:`ja`,label:`Ja`}],...r}}var ei={attributeName:`fieldType`,equals:`nachschlagen`},ti=[{attributeName:`fieldType`,name:`Feldtyp`,description:`Welche Art Eingabe das Feld annimmt.`,kind:`select`,options:[{value:`text`,label:`Text`},{value:`number`,label:`Zahl`},{value:`textarea`,label:`Mehrzeilig`},{value:`select`,label:`Auswahl`},{value:`date`,label:`Datum`},{value:`time`,label:`Uhrzeit`},{value:`checkbox`,label:`Ankreuzfeld`},{value:`nachschlagen`,label:`Nachschlagen`}]},{attributeName:`options`,name:`Auswahl-Optionen`,description:`Nur bei Feldtyp "Auswahl": Einträge durch Komma getrennt (z. B. "Zimmer 1, Zimmer 2") — jeder Eintrag wird eine Dropdown-Zeile.`,kind:`text`,visibleWhen:{attributeName:`fieldType`,equals:`select`}},{attributeName:`nachschlagQuelle`,name:`Quelle`,description:`Nur bei Feldtyp "Nachschlagen": aus dieser Datenquelle wählt der Bediener eine Zeile.`,kind:`quelle`,visibleWhen:ei},{attributeName:`speicherFeld`,name:`Gespeichert wird`,description:`Feld der Nachschlage-Quelle, dessen Wert die Maske sich merkt und die Kette "Wert geändert" weitergibt (z. B. die Nummer). Im Feld sichtbar ist die erste Spalte des Nachschlage-Fensters — ohne eigene Spalten ist das dieser Wert selbst.`,kind:`field`,quelleProp:`nachschlagQuelle`,klarnameProp:`speicherTitel`,visibleWhen:ei},$r(`einzigerTreffer`,`Einzigen Treffer übernehmen`,`Bleibt in der Maske genau EIN Satz übrig (weil das Feld der Auswahl eines anderen folgt), übernimmt es diesen von selbst — ohne dass der Bediener die Lupe drückt. Nur in ein leeres Feld; die Lupe bleibt daneben bedienbar.`,{visibleWhen:ei}),{attributeName:`valueField`,name:`Feld`,description:`Feld der angeschlossenen Datenquelle, dessen Wert angezeigt und lokal aktualisiert wird.`,kind:`field`,visibleWhen:{attributeName:`fieldType`,keinesVon:[`checkbox`,`nachschlagen`]}}];function ni(e){let t=new Set,n=!1,r=()=>{cn()&&t.forEach(e.hydriere)};return{connect:i=>{i.hasAttribute(`data-ff-editor`)||(t.add(i),e.verdrahte?.(i),n||(n=!0,pn(r),Ur(r),Wt(r),rr()),xn(),cn()&&e.hydriere(i))},disconnect:e=>{t.delete(e)}}}var ri=ot.toLowerCase(),ii=``;function ai(e){if(e.length===0)return``;let t=[];for(let n of e){let e=n.trim();if(e===``)return``;t.push(e)}return t.join(ii)}function oi(e){return It(e,ri,`quelleId`,`vonQuelleId`).map(e=>({quelleId:e.id,...e.von===void 0?{}:{vonQuelleId:e.von},keyPairs:e.keyPairs}))}function si(e){let t=oi(e);if(t.length===0)return(e,t)=>k(e,it(t).code);let n=I().SEDATA,r=I().FF_DATA_SOURCES,i=new Map;for(let e of t){let t=O(r,e.quelleId);if(!t)continue;let a=Nt(n,t.name,t.tableId),o=new Map;for(let t of a){let n=ai(e.keyPairs.map(e=>k(t,e.toField)));n!==``&&!o.has(n)&&o.set(n,t)}i.set(e.quelleId,{nachSchluessel:o,hierFelder:e.keyPairs.map(e=>e.fromField),von:e.vonQuelleId??``})}let a=(e,n,r)=>{let o=i.get(n);if(!o||r>t.length)return;let s=o.von===``?e:a(e,o.von,r+1);if(s===void 0)return;let c=ai(o.hierFelder.map(e=>k(s,e)));if(c!==``)return o.nachSchluessel.get(c)};return(e,t)=>{let{quelleId:n,code:r}=it(t);if(n===``)return k(e,r);let i=a(e,n,0);return i===void 0?``:k(i,r)}}function ci(e,t){let n=e.getAttribute(`source`)??``,r=e.getAttribute(t)??``;if(n===``||r===``)return{art:`ungebunden`};let i=O(I().FF_DATA_SOURCES,n);if(!i)return{art:`ohneQuelle`};let a=nn(e,Nt(I().SEDATA,i.name,i.tableId));if(a===void 0)return{art:`ohneZeile`};let{quelleId:o,code:s}=it(r);return{art:`wert`,wert:o===``?k(a,s):si(e)(a,r),zeile:a,quelle:i,quelleId:o,reinerCode:s}}var li=new WeakMap,ui=new WeakSet;function di(e){let t=/^(\d{2})\.(\d{2})\.(\d{4})$/.exec(e);return t?`${t[3]}-${t[2]}-${t[1]}`:e}function fi(e){let t=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);return t?`${t[3]}.${t[2]}.${t[1]}`:e}function pi(e){return typeof e.value==`string`?e.value:``}function mi(e){if(e.pruefeEigenenWert?.(),e.getAttribute(`fieldtype`)===`nachschlagen`){li.delete(e);return}let t=ci(e,rt(`value`));if(t.art!==`wert`){li.delete(e),t.art===`ohneZeile`&&(e.value=``);return}let{zeile:n,quelle:r,quelleId:i,reinerCode:a,wert:o}=t,s=jt(r,n);i===``?li.set(e,{row:n,code:a,pindex:s}):li.delete(e),e.value=o}function hi(e){let t=li.get(e);return t&&Mt(t.row,t.code,pi(e)),t}function gi(e){ui.has(e)||(ui.add(e),e.addEventListener(`input`,()=>{hi(e)}),e.addEventListener(`change`,()=>{let t=hi(e);yr(e,`onChange`,{VALUE:pi(e),PINDEX:t?.pindex??``}).catch(mr)}))}var _i=ni({hydriere:mi,verdrahte:gi}),vi=_i.connect,yi=_i.disconnect,bi=o`
  .feld {
    font-family: var(--se-font);
...
`;function sa(e,t){if(!e.hasAttribute(`fuellt`))return null;let n=e.renderRoot.querySelector(`.koerper`);return n instanceof HTMLElement?ki(n.clientHeight,(t=>{let n=e.renderRoot.querySelector(t);return n instanceof HTMLElement?n.offsetHeight:0})(`.kopf`),t):null}function ca(e,t){if(typeof ResizeObserver>`u`)return null;let n=e.renderRoot.querySelector(`.koerper`);if(!n)return null;let r=new ResizeObserver(t);return r.observe(n),r}function la(e,t){return e.verknuepfungen.find(e=>e.quelleId===t)?.keyPairs??[]}function ua(e,t){let n=e.verknuepfungen.find(e=>e.quelleId===t);return n===void 0?e.quelleId:lt(n,e.quelleId)}function da(e,t,n){return ut(e?.feld??``,e?.suchtIn??``,t,n)}function W(e,t){return da(e.spalten[t],e.quelleId,e.verknuepfungen)}function fa(e){let t=[],n=e=>{e!==``&&!t.includes(e)&&t.push(e)};for(let t=0;t<e.spalten.length;t++){let r=W(e,t);r.art===`auswahl`&&n(r.quelleId),n(r.suchQuelleId)}return t}function pa(e,t){let n=W(e,t);if(n.suchQuelleId===``)return;let r=ma(e,t)[0];if(r!==void 0)return{titel:r.titel,code:r.feld};let i=n.quelleId===n.suchQuelleId?n.code:``;for(let r=0;r<e.spalten.length;r++){if(r===t)continue;let a=W(e,r);if(!(a.art!==`auswahl`||a.quelleId!==n.suchQuelleId)&&!(a.code===``||a.code===i))return{titel:e.spalten[r].titel,code:a.code}}}function ma(e,t){return e.spalten[t]?.suchFelder??[]}function ha(e,t){let n=e.spalten[t];if(n===void 0)return[];let r=ma(e,t);if(r.length>0)return r.map(e=>({titel:e.titel,feld:e.feld,art:B}));let i=pa(e,t),a=W(e,t);if(i===void 0)return[];let o=a.quelleId===a.suchQuelleId?a.code:``,s={titel:i.titel,feld:i.code,art:B};return o===``?[s]:[s,{titel:n.titel,feld:o,art:B}]}function ga(e,t,n){let r=e.map(e=>({toField:e.toField,soll:t(e.fromField)})).filter(e=>e.soll!==void 0);return r.length===0?[...n]:n.filter(e=>r.every(t=>t.soll!==``&&t.soll===k(e,t.toField)))}function _a(e,t){let n=W(e,t);if(n.art===`auswahl`||n.suchQuelleId===``)return``;let r=ma(e,t)[0]?.feld??``;return r===``?n.art===`frei`?pa(e,t)?.code??``:``:r}var va=`32px`;function ya(e){return String(e).padStart(2,`0`)}function ba(e){return g`<div
  ...
  >${e.nummer===null?v:ya(e.nummer)}</div>`}function xa(){return g`<div class="griff leer" role="presentation"></div>`}function Sa(e,t,n){return g`<input
    ...
    @focus=${()=>t.betreten(n)}
    @blur=${()=>t.verlassen(n)}
  />`}function Ca(e,t,n,r){if(!r)return Sa(e,t,n);let i=e.tippSpalte===n&&e.vorschlaege.length>0;return g`<div class=${e.listeNachOben?`erf-halter nach-oben`:`erf-halter`}>
    ${Sa(e,t,n)}
    ${i?Zr({eintraege:e.vorschlaege,marke:e.marke,onWaehlen:e=>t.waehleVorschlag(e),onMarke:e=>t.setzeMarke(e)}):v}
  </div>`}function wa(e){return[`zeile`,`erfassung`].concat(e.aktiv?[`aktiv`]:[],e.gefuellt?[`gefuellt`]:[]).join(` `)}function Ta(e,t){return g`<div
    class=${wa(e)}
    role="row"
    data-erf-zeile=${e.zeile}
    style=${U(e.cols)}
  >
    ${ba({nummer:e.nummer,aktiv:e.aktiv,aufKlick:()=>t.waehleZeile()})}
    ${e.umfeld.spalten.map((n,r)=>{let i=V(n.art).klasse;if(e.imEditor){let t=e.zellenGriff;return g`<div
          class=${i}
          role="cell"
          data-ff-editable=${t?``:v}
          @click=${t?e=>t(e,r):v}
        >${t?g`<span class="spalten-name">${n.titel}</span>`:`—`}</div>`}return g`<div class=${i} role="cell">${Ca(e,t,r,W(e.umfeld,r).suchQuelleId!==``)}</div>`})}
  </div>`}function Ea(e,t,n,r){let i=e.anschluss.lauf(t),a=i.vorschlaege[r];a!==void 0&&(i.uebernimm(e.umfeld(),n,a.satz),e.melde())}function Da(e,t,n){let r=e.umfeld(),i=r.spalten[n],a=W(r,n);if(i===void 0||a.suchQuelleId===``)return;let o=e.anschluss.lauf(t);$o({el:e.baustein,quelleId:a.suchQuelleId,speicherFeld:a.quelleId===a.suchQuelleId?a.code:``,speicherTitel:i.titel,spalten:ha(r,n),titel:i.titel,breite:520,hoehe:380,eintraege:o.eintraege(r,n),rueckFokus:null,onUebernehmen:(t,r,i)=>{o.uebernimm(e.umfeld(),n,i),e.melde()}})}function Oa(e,t,n,r){let i=e.umfeld(),a=r===`enter`?e.anschluss.lauf(t).naechsteLeere(i,n):n+1<i.spalten.length?n+1:-1;if(a!==-1){e.fokussiere(t,a);return}let o=r===`enter`?e.anschluss.weiter(i,t):t+1<e.anschluss.anzahl?t+1:null;if(o===null)return;r===`tab`&&e.anschluss.waehle(o);let s=e.anschluss.lauf(o).naechsteLeere(i,-1);e.fokussiere(o,r===`enter`&&s!==-1?s:0)}function ka(e,t,n,r){let i=t+r;return i<0||i>=e.anschluss.anzahl?!1:(e.fokussiere(i,n),!0)}function Aa(e,t,n,r){if(r.key===`Tab`&&r.shiftKey)return;let i=r.key===`Tab`?`tab`:`enter`,a=e.anschluss.lauf(t).entscheideTaste(e.umfeld(),n,r.key);if(a===`nichts`){(r.key===`Enter`||r.key===`ArrowDown`&&ka(e,t,n,1)||r.key===`ArrowUp`&&ka(e,t,n,-1))&&r.preventDefault();return}r.preventDefault(),a===`uebernehmen`?(Ea(e,t,n,e.anschluss.lauf(t).marke),Oa(e,t,n,i)):a===`fenster`?Da(e,t,n):a===`weiter`?Oa(e,t,n,i):a===`leeren`&&e.anschluss.lauf(t).leere(e.umfeld(),n),e.melde()}function ja(e,t,n,r,i){let a=e.umfeld(),o=e.baustein.hasAttribute(`data-ff-editor`),s=[];for(let c=0;c<e.anschluss.anzahl;c++){let l=e.anschluss.lauf(c),u=c===e.anschluss.aktiv;s.push(Ta({umfeld:a,cols:t,imEditor:o,zeile:c,aktiv:u,gefuellt:!o&&!e.anschluss.istLeer(a,c),...i?{zellenGriff:i}:{},wert:e=>l.wertVon(a,e),tippSpalte:u?l.tippSpalte:-1,vorschlaege:u?l.vorschlaege:[],marke:l.marke,listeNachOben:r,nummer:n+c+1},{tippen:(t,n)=>{l.tippe(t,n),e.anschluss.waehle(c),e.melde()},taste:(t,n)=>Aa(e,c,t,n),verlassen:t=>{l.verlasse(t),e.melde()},betreten:()=>{e.anschluss.waehle(c)&&e.melde()},waehleZeile:()=>{e.anschluss.waehle(c)&&e.melde()},waehleVorschlag:t=>Ea(e,c,l.tippSpalte,t),setzeMarke:t=>{l.setzeMarke(t),e.melde()}}))}return s}var Ma=2,Na=class e{constructor(){this.getippt=new Map,this.gewaehlt=new Map,this.vonHand=new Map,this._wahlZaehler=0,this._tippSpalte=-1,this._marke=0,this._listeZu=!1,this._vorschlaege=[]}get tippSpalte(){return this._tippSpalte}get marke(){return this._marke}get vorschlaege(){return this._vorschlaege}wertVon(e,t){let n=this.getippt.get(t);if(n!==void 0)return n;let r=W(e,t);if(r.art!==`auswahl`||r.code===``)return``;let i=this.gewaehlt.get(r.quelleId);return i===void 0?``:k(i,r.code)}tippe(e,t){this.getippt.set(e,t),this._tippSpalte=e,this._marke=0,this._listeZu=!1}verlasse(e){this._tippSpalte===e&&(this._tippSpalte=-1,this._listeZu=!1,this._marke=0,this._vorschlaege=[])}entscheideTaste(e,t,n){let r=this._tippSpalte===t&&this._vorschlaege.length>0;if(n===`Tab`){if(!r)return`weiter`;n=`Enter`}let i=this.wertVon(e,t);if(n===`Escape`&&!r)return i===``?`nichts`:`leeren`;if(W(e,t).suchQuelleId===``)return n===`Enter`?`weiter`:`nichts`;let a=Xr(n,{listeOffen:r,feldLeer:i===``});if(a===`marke-hoch`)this._marke=Jr(this._marke,this._vorschlaege.length,-1);else if(a===`marke-runter`)this._marke=Jr(this._marke,this._vorschlaege.length,1);else if(a===`liste-zu`)this._listeZu=!0;else if(a===`fenster`&&this.eintraege(e,t).length===0)return`weiter`;else if(a===`nichts`&&n===`Enter`&&i!==``&&this.getippt.get(t)===void 0)return`weiter`;return a}naechsteLeere(e,t){for(let n=t+1;n<e.spalten.length;n++)if(this.wertVon(e,n)===``)return n;return-1}leere(e,t){this.getippt.delete(t);let n=W(e,t);for(let t of[n.quelleId,n.suchQuelleId])t!==``&&this.gewaehlt.has(t)&&this.setze(e,t,void 0);this._listeZu=!1,this._marke=0}setzeMarke(e){this._marke=e}uebernimm(e,t,n){let r=W(e,t).suchQuelleId;r!==``&&(this.setze(e,r,n),this._wahlZaehler+=1,this.vonHand.set(r,this._wahlZaehler),this.gleicheAb(e),this._tippSpalte=-1,this._marke=0,this._listeZu=!1)}setze(e,t,n){n===void 0?(this.gewaehlt.delete(t),this.vonHand.delete(t)):this.gewaehlt.set(t,n);for(let r=0;r<e.spalten.length;r++){let i=W(e,r);if(i.quelleId===t){this.getippt.delete(r);continue}if(i.suchQuelleId!==t)continue;let a=_a(e,r);a!==``&&(n===void 0?this.getippt.delete(r):this.getippt.set(r,k(n,a)))}}schluesselWert(e,t,n,r=()=>!0,i=e.quelleId){if(i!==e.quelleId){if(i===n||i===``)return;let e=this.gewaehlt.get(i);if(e===void 0)return;let a=this.vonHand.get(i);return a!==void 0&&!r(a)?void 0:k(e,t)}for(let i of fa(e)){if(i===n)continue;let a=this.vonHand.get(i);if(a===void 0||!r(a))continue;let o=this.gewaehlt.get(i);if(o!==void 0)for(let n of la(e,i)){if(n.fromField!==t)continue;let e=k(o,n.toField);if(e!==``)return e}}}moegliche(e,t,n,r){return ga(la(e,t),n=>this.schluesselWert(e,n,t,r,ua(e,t)),n)}gleicheAb(e){let t=fa(e);for(let n=0;n<=t.length;n++){let n=!1;for(let r of t){let t=la(e,r);if(t.length===0)continue;let i=this.gewaehlt.get(r);if(i!==void 0){let a=this.vonHand.get(r)??-1/0;t.every(t=>{let n=this.schluesselWert(e,t.fromField,r,e=>e>a,ua(e,r));return n===void 0||n!==``&&n===k(i,t.toField)})||(this.setze(e,r,void 0),n=!0);continue}let a=ua(e,r);if(!t.some(t=>this.schluesselWert(e,t.fromField,r,void 0,a)!==void 0))continue;let o=zo(r);if(o===null)continue;let s=this.moegliche(e,r,o);s.length===1&&(this.setze(e,r,s[0]),this.vonHand.delete(r),n=!0)}if(!n)break}}zuruecksetzen(){this.getippt.clear(),this.gewaehlt.clear(),this.vonHand.clear(),this._tippSpalte=-1,this._marke=0,this._listeZu=!1,this._vorschlaege=[]}nimmEinzigenTreffer(e){let t=this._tippSpalte;if(t<0||this._vorschlaege.length!==1)return!1;let n=(this.getippt.get(t)??``).trim();if(n.length<Ma)return!1;let r=this._vorschlaege[0];return r.wert===n?!1:(this.uebernimm(e,t,r.satz),!0)}aktualisiereVorschlaege(e){this._vorschlaege=this.berechne(e),this._marke=Yr(this._marke,this._vorschlaege.length)}berechne(e){let t=this._tippSpalte;if(this._listeZu||W(e,t).suchQuelleId===``)return[];let n=this.getippt.get(t)??``;return n===``?[]:qr(this.eintraege(e,t),n)}eintraege(e,t){let n=W(e,t),r=n.suchQuelleId;if(r===``)return[];let i=zo(r);if(i===null)return[];let a=this.vonHand.get(r)??1/0;return Lo(this.moegliche(e,r,i,e=>e<a),pa(e,t)?.code??``,n.quelleId===r?n.code:``)}get istUnberuehrt(){return this.getippt.size===0&&this.gewaehlt.size===0}kopie(){let t=new e;return t.getippt=new Map(this.getippt),t.gewaehlt=new Map(this.gewaehlt),t.vonHand=new Map(this.vonHand),t._wahlZaehler=this._wahlZaehler,t}};function Pa(e,t){let n=t.feld.trim();if(n===``)return null;let{quelleId:r,code:i}=it(n),a=r===``?e.quelleId:r;return a===``||i===``?null:{quelleId:a,code:i}}function Fa(e,t){let n={};return e.spalten.forEach((r,i)=>{let a=Pa(e,r);if(a===null)return;let o=n[a.quelleId]??(n[a.quelleId]={});o[a.code]=t[i]??``}),n}function Ia(e){let t=[];for(let n of e.spalten){let r=Pa(e,n);r!==null&&!t.includes(r.quelleId)&&t.push(r.quelleId)}return t}var La=class{constructor(){this._laeufe=[new Na],this._aktiv=0}get anzahl(){return this._laeufe.length}get aktiv(){return this._aktiv}lauf(e){let t=Math.min(Math.max(e,0),this._laeufe.length-1);return this._laeufe[t]}get aktiverLauf(){return this.lauf(this._aktiv)}waehle(e){let t=Math.min(Math.max(e,0),this._laeufe.length-1);return t===this._aktiv?!1:(this._aktiv=t,!0)}werte(e,t){let n=this.lauf(t);return e.spalten.map((t,r)=>n.wertVon(e,r))}istLeer(e,t){return this.werte(e,t).every(e=>e===``)}saetze(e){let t=[];for(let n=0;n<this._laeufe.length;n++){let r=this.werte(e,n);r.every(e=>e===``)||t.push(Fa(e,r))}return t}weiter(e,t){let n=Math.min(Math.max(t,0),this._laeufe.length-1);return n<this._laeufe.length-1?(this._aktiv=n+1,this._aktiv):this.istLeer(e,n)?null:(this._laeufe.push(new Na),this._aktiv=this._laeufe.length-1,this._aktiv)}haltLeerzeileFrei(e){return this.istLeer(e,this._laeufe.length-1)?!1:(this._laeufe.push(new Na),!0)}leeren(){return this._laeufe.length===1&&this._laeufe[0].istUnberuehrt?!1:(this._laeufe=[new Na],this._aktiv=0,!0)}zuruecksetzen(){this._laeufe=[new Na],this._aktiv=0}haltVorschlaegeAktuell(e){let t=this.aktiverLauf;t.aktualisiereVorschlaege(e),t.nimmEinzigenTreffer(e)&&t.aktualisiereVorschlaege(e)}umfeld(e,t,n){return{spalten:t,quelleId:n,verknuepfungen:oi(e)}}},Ra=o`
      .zeile.erfassung {
        flex: none;
        background: var(--se-panel-2);
...
`;function za(e){return{rohzeilen:e.map(e=>e.rohzeile),datenzeilen:e.map(e=>[...e.zellen]),zusatzzeilen:e.map(e=>(e.zusatz??[]).map(e=>({...e})))}}function Ba(e,t,n){return t===``||n===``?[...e]:e.filter(e=>Ir(k(e,t))===n)}function Va(e){let t=e.getAttribute(`source`)??``;if(t===``)return null;let n=O(I().FF_DATA_SOURCES,t);return n?{quelle:n,zeilen:Ba(Nt(I().SEDATA,n.name,n.tableId),e.getAttribute(`tagfield`)??``,Vr()),lies:si(e)}:null}function Ha(e){return Zi(e.getAttribute(`spalten`)??``)}function Ua(e,t,n){let r={};for(let i of V(e.art).zusatzFelder??[]){let a=e.felder?.[i.key]??``;a!==``&&(r[i.key]=n(t,a))}return r}function Wa(e,t){let n=O(I().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return n?jt(n,t):``}function Ga(e){let t=Va(e);if(!t){e.datenzeilen=[],e.zusatzzeilen=[];return}let n=Ha(e),{rows:r,gefiltert:i}=tn(e,t.zeilen),a=Jt(N(e),r,e=>e)[0]??-1,o=t.lies;e.datenGeliefert=!0,e.rohzeilen=r,e.auswahlIndex=a,e.durchAuswahlGefiltert=i,e.datenzeilen=r.map(e=>n.map(t=>t.feld===``?``:o(e,t.feld))),e.zusatzzeilen=r.map(e=>n.map(t=>Ua(t,e,o)))}var Ka=ni({hydriere:Ga}),qa=Ka.connect,Ja=Ka.disconnect;function Ya(e,t){let n=[];return e.forEach((e,r)=>{Kr(e,t)&&n.push(r)}),n}function Xa(e,t){return!e&&t.trim()!==``}function Za(e,t,n){return e&&t&&n===0}function Qa(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}function $a(e,t,n){return g`<div class="steuerung">
    <button
    ...
    >+</button>
  </div>`}function eo(e,t){let n=e.currentTarget;n&&(e.stopPropagation(),e.preventDefault(),pt(n,(e,n)=>e===``||e===n.trim()?!1:(t(e),!0)))}function to(e,t,n,r){eo(e,e=>{let i=n();t>=i.length||(i[t]={...i[t],titel:e},r(i))})}var no=220,ro=new WeakMap;function io(e){let t=ro.get(e);t!==void 0&&(clearTimeout(t),ro.delete(e))}function ao(e,t,n){t.stopPropagation();let r=t.currentTarget,i=r.getBoundingClientRect();io(e),ro.set(e,setTimeout(()=>{ro.delete(e),e.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:n.prop,index:n.index,top:i.bottom+4,left:i.left,ausloeser:r,...n.liste?{liste:n.liste()}:{}},bubbles:!0,composed:!0}))},no))}var oo={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:Wi,nurEigeneQuelle:!0,eintragsWahl:{key:`art`,label:`Darstellung`,optionen:zi,standard:B,felderKey:Bi},eintragsQuellenWahl:{key:Vi,label:`Sucht beim Erfassen in`,leerName:`frei`,nurBeiErfassung:!0},eintragsFelderWahl:{key:Hi,label:`Zeigt beim Suchen`,quelleAusKey:Vi,nurBeiErfassung:!0},eintragsZuordnung:{key:`zuordnung`,label:`Status-Zuordnung`,nurBeiWahl:Ni,wertLabel:`Datenwert`,nameLabel:`Klarname`,bedeutungLabel:`Bedeutung`,bedeutungen:Tr}},so=1,co=/^-?\d{1,3}(\.\d{3})*(,\d+)?$|^-?\d+(,\d+)?$|^-?\d+(\.\d+)?$/,lo=/^(\d{1,2})\.(\d{1,2})\.(\d{2}|\d{4})$/,uo=/^(\d{4})-(\d{2})-(\d{2})$/;function fo(e){let t=e.trim();if(t===``||!co.test(t))return null;let n=t.includes(`,`)?t.replace(/\./g,``).replace(`,`,`.`):/^-?\d{1,3}(\.\d{3})+$/.test(t)?t.replace(/\./g,``):t,r=Number(n);return Number.isFinite(r)?r:null}function po(e){let t=e.trim();if(t===``)return null;let n=uo.exec(t);if(n){let[,e,t,r]=n;return mo(Number(e),Number(t),Number(r))}let r=lo.exec(t);if(r){let[,e,t,n]=r,i=Number(n);return mo(n.length===2?i<=69?2e3+i:1900+i:i,Number(t),Number(e))}return null}function mo(e,t,n){if(t<1||t>12||n<1||n>31)return null;let r=new Date(e,t-1,n);return r.getFullYear()!==e||r.getMonth()!==t-1||r.getDate()!==n?null:r.getTime()}function ho(e){let t=0,n=0,r=0;for(let i of e)i.trim()!==``&&(t++,fo(i)!==null&&n++,po(i)!==null&&r++);return t===0?`text`:r===t?`datum`:n===t?`zahl`:`text`}var go=new Intl.Collator(`de`,{numeric:!0,sensitivity:`base`});function _o(e,t,n){if(t<0||e.length===0)return e.map((e,t)=>t);let r=n=>e[n][t]??``,i=ho(e.map(e=>e[t]??``)),a=n?1:-1;return e.map((e,t)=>t).sort((e,t)=>{let n=r(e).trim(),o=r(t).trim();if(n===``&&o===``)return e-t;if(n===``)return so;if(o===``)return-1;let s=i===`zahl`?(fo(n)??0)-(fo(o)??0):i===`datum`?(po(n)??0)-(po(o)??0):go.compare(n,o);return s===0?e-t:s*a})}function vo(e){let t=Ya(e.datenzeilen,e.suchtext);return e.sortSpalte<0?t:_o(t.map(t=>e.datenzeilen[t]),e.sortSpalte,e.sortAuf).map(e=>t[e])}function yo(e){let t=e.spalten.map(e=>V(e.art).spur),n={gridTemplateColumns:(e.erfassungsZeilen>0?[va,...t]:t).join(` `)},r=Ri(e.spalten),i=e.gemessen?.zeilenHoehe??r,a=e.hatQuelle,o=e.erfassungsZeilen>0?!1:Za(a,e.datenGeliefert,e.datenzeilen.length),s=vo(e),c=e.erfassungsZeilen,l=e.gemessen===null?null:Math.max(1,e.gemessen.passen-c),{seiten:u,seite:d,zeilen:ee}=ji({sichtbar:s,hatQuelle:a,proSeite:l??Math.max(1,10-c),wunschSeite:e.wunschSeite,platzhalterZeilen:Di(l)});return{cols:n,takt:r,zeilenHoehe:i,hatQuelle:a,leer:o,gesamt:s.length,seiten:u,seite:d,zeilen:ee,linealTakte:Ai(l,ee.length)}}function bo(e){return e!==`ja`}function xo(e,t,n){return e===n?{spalte:n,auf:!t}:{spalte:n,auf:!0}}var So=[$r(`suche`,`Suchzeile`,`Zeigt über der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,{requiresDataSource:!0}),$r(`erfassung`,`Erfassungszeile`,`Zeigt als nächste freie Zeile eine leere Zeile, in der der Bediener neue Positionen tippt. Eingestellt wird an ihr nichts: Was eine Zelle tut, ergibt sich aus der Bindung ihrer Spalte (Spaltenkopf) und der Verknüpfung des Bausteins. Enter am Zeilenende lässt die Zeile stehen; geschrieben wird über einen Knopf, dessen Kette „Wert aus Erfassungszelle“ liest — einmal je Zeile.`),$r(`schlank`,`Schlank`,`Lässt die Kopfzeile weg und macht die Polster enger. Der Rahmen der Tafel bleibt. Die Spaltennamen stehen dann blass in den Zellen — im Editor in der ersten Zeile, in der Maske in der leeren Erfassungszelle, wie der Platzhalter an einem Formularfeld. Die Fußzeile erscheint ohnehin nur noch, wenn geblättert wird oder ein Filter greift.`),{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt die Tabelle nur Sätze des Tages, den der Tageswähler zeigt. Leer = alle Sätze.`,kind:`field`},ia()];function Co(e,t){return g`<div class="fusszeile">
    <div class="seiten-info">${Qa({hatQuelle:e.hatQuelle,sichtbar:e.sichtbar,gesamt:e.gesamt,suchtAktiv:e.suchtAktiv,auswahlAktiv:e.auswahlAktiv})}</div>
    <div class="seiten-nav">
  ...
  </div>`}function wo(e){return e.linealTakte===0?v:g`<div class="lineal" role="presentation" style=${U(e.linealTakte===null?e.cols:{...e.cols,flex:`0 1 auto`,height:`calc(var(--zeilen-hoehe) * ${e.linealTakte})`})}>
          ${e.mitGriff?xa():v}
          ${e.spalten.map(()=>g`<div></div>`)}
        </div>`}function To(e,t){return g`
      ...
      ${e.zeigeKopf?g`<div class="kopf" role="row" style=${U(e.cols)}>
        ...
        ${e.zeilen.map((n,r)=>{let i=n!==null&&!e.imEditor;return g`<div
          ...
          >
            ${e.mitGriff?ba({nummer:n===null?null:r+1,aktiv:!1}):v}
...
`,Do=`ff-zeile-aktiviert`,Oo=`data-ff-roh`;function ko(e,t){e.dispatchEvent(new CustomEvent(Do,{detail:t,bubbles:!0,composed:!0}))}function Ao(e){let t=e?.activeElement;if(!(t instanceof HTMLElement))return;let n=t.closest(`.zeile`);if(!n)return;let r=n.getAttribute(Oo);return r===null||r===``?null:Number(r)}function jo(e,t){e&&((t===null?null:e.querySelector(`.zeile[data-ff-roh="${t}"]`))??e.querySelector(`.zeile[data-ff-roh]`)??e.querySelector(`.koerper`))?.focus()}var G=class e extends T{constructor(...e){super(...e),this.spalten=Ki(),this.source=``,this.suche=`ja`,this.erfassung=`nein`,this.schlank=`nein`,this.leerText=ra,this._suchtext=``,this.datenzeilen=[],this.zusatzzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this.datenGeliefert=!1,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._beobachter=null,this._taktGemessen=0,this._fokusZeile=null,this._fokusHolen=!1,this._besitz=`softengine`,this._erfassung=new La}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannErfassen={wenn:{attributeName:`erfassung`,equals:`ja`}}}static{this.blockEvents=[{key:`onRowClick`,name:`Zeile gewählt`}]}static{this.listenBindung=oo}static{this.defaultProps={width:`fill`,source:``,spalten:Ki(),suche:`ja`,erfassung:`nein`,schlank:`nein`,tagField:``,leerText:ra}}static{this.customProperties=So}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get zeigtKopf(){return bo(this.schlank)}get besitz(){return this._besitz}set besitz(e){e!==this._besitz&&(this._besitz=e,this.setzeAbgeleitetesZurueck(),this.isConnected&&(e===`provided`?Ja(this):qa(this)),this.requestUpdate())}set bereitgestellteZeilen(e){let t=za(e);this.rohzeilen=t.rohzeilen,this.datenzeilen=t.datenzeilen,this.zusatzzeilen=t.zusatzzeilen,this.datenGeliefert=!0,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._seite=0,this._mass=null,this._taktGemessen=0,this.requestUpdate()}setzeAbgeleitetesZurueck(){this.rohzeilen=[],this.datenzeilen=[],this.zusatzzeilen=[],this.datenGeliefert=!1,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._suchtext=``,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._taktGemessen=0,this._fokusZeile=null,this._fokusHolen=!1,this._erfassung.zuruecksetzen()}get erfassteSaetze(){return this._erfassung.saetze(this.erfassungsUmfeld())}get erfassteQuellen(){return this.erfassungAn?Ia(this.erfassungsUmfeld()):[]}erfassungLeeren(){this._erfassung.leeren()&&this.requestUpdate()}fokussiereSuche(){let e=this.shadowRoot?.querySelector(`.suchzeile input`);return e?(e.focus(),!0):!1}get hatQuelle(){return this._besitz===`provided`||Xa(this.hasAttribute(`data-ff-editor`),this.source)}merkeZeilenFokus(){let e=Ao(this.shadowRoot);this._fokusHolen=e!==void 0,this._fokusZeile=e??null}messeRumpf(){let e=this.zeilenHoehe;this._taktGemessen=e;let t=sa(this,e);t?.passen===this._mass?.passen&&t?.zeilenHoehe===this._mass?.zeilenHoehe||(this._mass=t,this.requestUpdate())}spaltenListe(){return Xi(this.spalten)}get zeilenHoehe(){return Ri(this.spaltenListe())}aktiviereZeile(e,t){if(e===null||this.hasAttribute(`data-ff-editor`))return;let n=this.rohzeilen[e];n!==void 0&&(ko(this,{rohzeile:n,rohIndex:e,ansichtIndex:t}),this.toggleAuswahl(n),yr(this,`onRowClick`,{PINDEX:Wa(this,n)}).catch(mr))}toggleAuswahl(e){let t=N(this);t!==``&&Yt(t,e)}setzeSuchtext(e){this.merkeZeilenFokus(),this._suchtext=e,this._seite=0,this.requestUpdate()}klickSortiere(e){if(this.editable)return;this.merkeZeilenFokus();let t=xo(this._sortSpalte,this._sortAuf,e);this._sortSpalte=t.spalte,this._sortAuf=t.auf,this._seite=0,this.requestUpdate()}get erfassungAn(){return this.erfassung===`ja`}fussNoetig(e){return e>1||this._suchtext.trim()!==``||this.durchAuswahlGefiltert}erfassungsWirt(){return{baustein:this,anschluss:this._erfassung,umfeld:()=>this.erfassungsUmfeld(),melde:()=>this.requestUpdate(),fokussiere:(e,t)=>this.fokussiereZelle(e,t)}}fokussiereZelle(e,t){this.updateComplete.then(()=>{let n=this.shadowRoot?.querySelector(`.zeile.erfassung[data-erf-zeile="${e}"] .erf-eingabe[data-spalte="${t}"]`);n?.focus(),n?.select()})}erfassungsUmfeld(){return this._erfassung.umfeld(this,this.spaltenListe(),this.source)}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}beobachte(){this._beobachter||(this._beobachter=ca(this,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}connectedCallback(){super.connectedCallback(),this._besitz===`softengine`&&qa(this),this.beobachte()}firstUpdated(){this.beobachte()}willUpdate(e){super.willUpdate(e),!(!this.erfassungAn||this.hasAttribute(`data-ff-editor`))&&(this._erfassung.haltLeerzeileFrei(this.erfassungsUmfeld()),this._erfassung.haltVorschlaegeAktuell(this.erfassungsUmfeld()))}updated(){this._taktGemessen!==this.zeilenHoehe&&this.messeRumpf(),this._fokusHolen&&(this._fokusHolen=!1,jo(this.shadowRoot,this._fokusZeile))}disconnectedCallback(){super.disconnectedCallback(),io(this),this._beobachter?.disconnect(),this._beobachter=null,Yo(this),Ja(this)}static{this.styles=[T.styles,Dr,oa,Eo,Qr,Ra]}render(){let t=this.spaltenListe(),n=e=>e.stopPropagation(),r=yo({spalten:t,hatQuelle:this.hatQuelle,datenGeliefert:this.datenGeliefert,datenzeilen:this.datenzeilen,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,wunschSeite:this._seite,gemessen:this._mass,erfassungsZeilen:this.erfassungAn?this._erfassung.anzahl:0});return g`<div class=${this.schlank===`ja`?`tabelle schlank`:`tabelle`} style=${U({"--takt":`${r.takt}px`,"--zeilen-hoehe":`${r.zeilenHoehe}px`})}>
    ...
    >${Ti()}</button>
    ${e.liste}
  </div>`}var No={prop:`nachschlagSpalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:Wi,quelleProp:`nachschlagQuelle`};function Po(e){if(typeof e==`string`)try{e=JSON.parse(e)}catch{return[]}return Array.isArray(e)&&e.length>0?Xi(e):[]}function Fo(e,t){let n=e[0];return n===void 0?t:n.feld}function Io(e,t){let n=e.trim();return n===``||n===t.trim()}function Lo(e,t,n){let r=t.trim(),i=[],a=Io(t,n)||n.trim()===``,o=new Set;for(let t of e){let e=k(t,n).trim(),s=r===``?e:k(t,r).trim();if(!(s===``&&e===``)){if(a){let t=e===``?s:e;if(o.has(t))continue;o.add(t)}i.push({anzeige:s,wert:e,satz:t})}}return i}function Ro(e,t,n,r){return Lo(tn(e,t).rows,n,r)}function zo(e){let t=O(I().FF_DATA_SOURCES,e);return t?Nt(I().SEDATA,t.name,t.tableId):null}function Bo(e){if(e.quelleId===``||e.speicherFeld===``)return{ok:!1,grund:`unvollstaendig`};let t=zo(e.quelleId);if(t===null)return{ok:!1,grund:`quelleFehlt`};let n=Fo(Po([...e.spalten]),e.speicherFeld);return{ok:!0,eintraege:Ro(e.el,t,n,e.speicherFeld)}}function Vo(e,t){return t&&e.length===1?e[0]:null}function Ho(e,t){let{rows:n,gefiltert:r}=tn(e,[t]);return!r||n.length>0}function Uo(e,t,n){return e===``?t===``&&n===``?`nichts`:`leeren`:e===t?`nichts`:`zurueck`}var Wo=null,Go=null,Ko=null;function qo(e){return e.shadowRoot?.querySelector(`.lupe`)??null}function Jo(e=!0){let t=e?Ko:null;Ko=null,Wo?.remove(),Wo=null,Go=null,t?.focus()}function Yo(e){Go===e&&Jo(!1)}function Xo(e){return[{titel:e.speicherTitel===``?`Wert`:e.speicherTitel,feld:e.speicherFeld,art:B}]}function Zo(e){let t=e=>e.stopPropagation(),n=e.editor;return g`<ff-dialog-rahmen
    viewport
    escape-schliesst
    ohne-modal
    inhalt-fest
  ...
  >${e.inhalt}</ff-dialog-rahmen>`}function Qo(e,t){let n=Po([...e.spalten]),r=Io(Fo(n,e.speicherFeld),e.speicherFeld);return g`<ff-tabelle
    fuellt
    suche="ja"
    style="--se-r-lg:0px"
    .besitz=${`provided`}
    .spalten=${n.length>0?n:Xo(e)}
  ...
  ></ff-tabelle>`}function $o(e){let t=e.eintraege;if(t===void 0){let n=Bo(e);if(!n.ok){F(n.grund===`unvollstaendig`?`Nachschlagen braucht an diesem Feld eine Quelle und „Gespeichert wird".`:`Die Nachschlage-Quelle dieses Feldes ist in der Maske nicht vorhanden.`);return}t=n.eintraege}Jo(!1);let n=document.createElement(`div`);n.style.display=`contents`,Ue(Zo({titel:e.titel,breite:e.breite,hoehe:e.hoehe,inhalt:Qo(e,t),onSchliessen:()=>Jo()}),n);let r=n.querySelector(ir),i=n.querySelector(G.tagName);i?.addEventListener(Do,n=>{let r=n.detail,i=t[r.rohIndex];i&&(Jo(),e.onUebernehmen(i.anzeige,i.wert,i.satz))}),Ko=e.rueckFokus??qo(e.el),document.body.appendChild(n),Wo=n,Go=e.el,r&&i&&Promise.all([r.updateComplete,i.updateComplete]).then(()=>{r.isConnected&&i.fokussiereSuche()})}function es(e){return Zo({titel:e.titel,breite:e.breite,hoehe:e.hoehe,onSchliessen:e.onSchliessen,editor:{onGroesse:e.onGroesse},inhalt:g`<ff-tabelle
      data-ff-editor
      fuellt
      suche="ja"
      style="--se-r-lg:0px"
    ...
    ></ff-tabelle>`})}var ts=[`J`,`1`,`X`,`TRUE`];function ns(e){return ts.includes(e.trim().toUpperCase())}function rs(e){return e?`J`:`N`}function is(e){return g`<div class="feld">
  ...
  </div>`}function as(e){let t=e.optionen.split(`,`).map(e=>e.trim()).filter(e=>e!==``),n=e.wert!==``&&!t.includes(e.wert);return g`<select
    class="ctrl"
    .value=${e.wert}
    @input=${e.onInput}
    @change=${e.onChange}
  ...
  />`}var K=class e extends T{constructor(...e){super(...e),this.fieldType=`text`,this.placeholder=`Feldname`,this.options=``,this.source=``,this.value=``,this.valueField=``,this.nachschlagQuelle=``,this.speicherFeld=``,this.speicherTitel=``,this.nachschlagSpalten=[],this.fensterBreite=520,this.fensterHoehe=380,this.einzigerTreffer=`nein`,this.spaltenDialog=!1,this.anzeige=``,this.getippt=null,this.marke=0,this.listeZu=!1,this.vorschlaege=[],this.satz=void 0,this.imSteuerelement=!1}static{this.blockType=`formfeld`}static{this.tagName=`ff-formfeld`}static{this.displayName=`Formularfeld`}static{this.category=`eingabe`}static{this.acceptsDataSource={wenn:{attributeName:`fieldType`,notEquals:`nachschlagen`}}}static{this.satzWahl={quelleProp:`nachschlagQuelle`,wenn:{attributeName:`fieldType`,equals:`nachschlagen`}}}static{this.listenBindung=No}static{this.bindableSpots=[{prop:`value`,label:`Wert`,wenn:{attributeName:`fieldType`,keinesVon:[`nachschlagen`]},vorschauProp:`placeholder`}]}static{this.actionValueSpots=[{prop:`value`,label:`Wert`}]}static{this.blockEvents=[{key:`onChange`,name:`Wert geändert`}]}static{this.defaultProps={width:240,fieldType:`text`,placeholder:`Feldname`,options:``,source:``,value:``,valueField:``,nachschlagQuelle:``,speicherFeld:``,speicherTitel:``,nachschlagSpalten:[],fensterBreite:520,fensterHoehe:380,einzigerTreffer:`nein`}}static{this.raster={startW:6,startH:2,minW:2,minH:2}}static{this.customProperties=ti}static{this.styles=[T.styles,bi,Qr]}onInput(e){let t=e.target;this.value=Si(this.fieldType)===`date`?fi(t.value):t.value}onChange(){this.dispatchEvent(new Event(`change`))}textTpl(e,t=!1){return g`<span
    ...
    </div>`}connectedCallback(){super.connectedCallback(),vi(this)}disconnectedCallback(){super.disconnectedCallback(),yi(this),Yo(this)}};w([S()],K.prototype,`fieldType`,void 0),w([S()],K.prototype,`placeholder`,void 0),w([S()],K.prototype,`options`,void 0),w([S()],K.prototype,`source`,void 0),w([S()],K.prototype,`value`,void 0),w([S()],K.prototype,`valueField`,void 0),w([S()],K.prototype,`nachschlagQuelle`,void 0),w([S()],K.prototype,`speicherFeld`,void 0),w([S()],K.prototype,`speicherTitel`,void 0),w([S({converter:{fromAttribute:e=>Po(e??``),toAttribute:e=>JSON.stringify(e)}})],K.prototype,`nachschlagSpalten`,void 0),w([S({type:Number})],K.prototype,`fensterBreite`,void 0),w([S({type:Number})],K.prototype,`fensterHoehe`,void 0),w([S()],K.prototype,`einzigerTreffer`,void 0),w([C()],K.prototype,`spaltenDialog`,void 0),w([C()],K.prototype,`anzeige`,void 0),w([C()],K.prototype,`getippt`,void 0),w([C()],K.prototype,`marke`,void 0),w([C()],K.prototype,`listeZu`,void 0),w([C()],K.prototype,`imSteuerelement`,void 0),T.defineAndRegister(K);var cs=`ziel`,ls=o`
...
`,ds=`frei · hierher ziehen`,fs=`ff-zimmer-inhalt`,q=class extends T{constructor(...e){super(...e),this.heading=`Neues Zimmer`,this.leerHinweis=``}static{this.blockType=`kanban-zimmer`}static{this.tagName=`ff-kanban-zimmer`}static{this.displayName=`Kanban-Zimmer`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[z.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban-spalte`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={heading:`Neues Zimmer`}}static{this.styles=[T.styles,oa,us,ls,o`
    ...
    `]}onSlotChange(){this.dispatchEvent(new CustomEvent(fs,{bubbles:!0,composed:!0}))}render(){return g`<div class="zimmer ${cs}">
      <div
        class="kopf"
        data-ff-editable
    ...
    `]}constructor(){super(),this.variant=`info`,this.heading=`Neue Spalte`,this.leerHinweis=``,this._count=0,this.addEventListener(fs,()=>this.zaehle())}zaehle(){this._count=Array.from(this.querySelectorAll(z.tagName)).filter(e=>!e.hasAttribute(`data-ff-editor-helper`)).length}render(){return g`<div class="col ${cs} v-${wr(this.variant)}">
      <div class="head">
        <span class="dot"></span>
        <span
          class="title"
    ...
    </div>`}};w([S()],J.prototype,`variant`,void 0),w([S()],J.prototype,`heading`,void 0),w([S({attribute:!1})],J.prototype,`leerHinweis`,void 0),w([C()],J.prototype,`_count`,void 0),T.defineAndRegister(J);function ps(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function ms(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var hs=new WeakMap,gs=J.tagName,_s=q.tagName,vs=z.tagName;function ys(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===gs)}function bs(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===vs)}function xs(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===_s)}function Ss(e){return[e,...xs(e)]}function Cs(e,t){let n=e.getAttribute(`leertext`)??`Keine Datensätze.`,r=(e,t)=>{e.leerHinweis=t};for(let e of t){let t=xs(e);for(let e of t)r(e,bs(e).length===0?ds:``);r(e,t.length===0&&bs(e).length===0?n:``)}}function ws(e){return Xe().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function Ts(e,t){let n=xs(e);if(n.length===0)return null;let r=e.getAttribute(`zimmerfield`)??``;if(r===``)return n[0];let i=n.map(e=>e.getAttribute(`heading`)??q.defaultProps.heading),a=ps(k(t,r),i);return a>=0?n[a]:n[0]}function Es(e){X?.board===e&&Ms();let t=e.getAttribute(`statusfield`)??``,n=Va(e);if(!n)return;let r=ys(e);if(r.length===0)return;let i=hs.get(e);if(!i){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(vs);t&&(i=t.cloneNode(!0),hs.set(e,i))}if(!i)return;let a=n.zeilen,o=r.map(e=>e.getAttribute(`heading`)??J.defaultProps.heading),s=ws(i.tagName),c=ms(r.map(e=>e.getAttribute(`auffang`))),l=n.lies;for(let e of r)for(let t of Ss(e))bs(t).forEach(e=>e.remove());for(let e of a){let a=i.cloneNode(!0),u=t===``?-1:ps(k(e,t),o),d=u>=0?r[u]:c>=0?r[c]:r[0];(Ts(d,e)??d).appendChild(a);for(let t of s){let n=a.getAttribute(rt(t.prop))??``;n!==``&&(a[t.prop]=l(e,n))}let ee=jt(n.quelle,e);Y.set(a,{row:e,pindex:ee}),a.draggable=!0}Cs(e,r);let u=r.flatMap(e=>Ss(e).flatMap(bs)),d=Jt(N(e),u,e=>Y.get(e)?.row);for(let e of d)u[e].setAttribute(`data-ff-auswahl`,``)}var Y=new WeakMap,X=null,Ds=new WeakSet,Os=`data-ff-zieht`,ks=`data-ff-ziel`,As=null;function js(e){As!==e&&(As?.removeAttribute(ks),As=e,As?.setAttribute(ks,``))}function Ms(){X?.card.removeAttribute(Os),X=null,js(null)}function Ns(e,t,n){for(let r of t.composedPath())if(r instanceof HTMLElement&&r.tagName.toLowerCase()===n&&e.contains(r))return r;return null}function Ps(e,t){return Ns(e,t,gs)}function Fs(e,t,n){if(!X||X.board!==e)return;let r=Y.get(X.card);if(!r)return;let i=t.getAttribute(`heading`)??``,a=n?.getAttribute(`heading`)??``;yr(e,`onCardDrop`,{PINDEX:r.pindex,VALUE:i,ZIMMER:a}).catch(mr)}function Is(e){Ds.has(e)||(Ds.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&Y.has(e))??null;if(!n)return;let r=Y.get(n);r&&Yt(N(e),r.row),yr(e,`onCardClick`,{PINDEX:r?.pindex??``}).catch(mr)}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&Y.has(e))??null;n&&(X={card:n,board:e},t.dataTransfer?.setData(`text/plain`,Y.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`),setTimeout(()=>{X?.card===n&&n.setAttribute(Os,``)},0))}),e.addEventListener(`dragend`,Ms),e.addEventListener(`dragover`,t=>{let n=Ps(e,t);if(X?.board!==e||!n){js(null);return}t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`),js(Ns(e,t,_s)??n)}),e.addEventListener(`dragleave`,t=>{let n=t.relatedTarget;(!(n instanceof Node)||!e.contains(n))&&js(null)}),e.addEventListener(`drop`,t=>{let n=Ps(e,t);n&&(t.preventDefault(),Fs(e,n,Ns(e,t,_s)),Ms())}))}var Ls=ni({hydriere:Es,verdrahte:Is}),Rs=Ls.connect,zs=Ls.disconnect,Z=J.blockType,Bs=class extends T{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[Z]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:Z}}static{this.templateChild={type:z.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``,tagField:``,leerText:ra}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Optional: Feld der Datenquelle, dessen Inhalt bestimmt, in welche Spalte ein Eintrag kommt. Leer = alle Einträge in der Auffang-Spalte.`,kind:`field`},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt das Board nur Einträge des Tages, den der Tageswähler zeigt. Leer = alle Einträge.`,kind:`field`},ia()]}static{this.defaultChildren=[{type:Z,props:{heading:`Offen`,variant:`warning`},children:[{type:z.blockType}]},{type:Z,props:{heading:`In Arbeit`,variant:`info`}},{type:Z,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[T.styles,o`
    ...
    `]}render(){return g`<div
      class="text"
      style=${U({fontSize:`${vc(this.groesse)}px`,fontWeight:mc[yc(this.gewicht)],textAlign:hc[bc(this.ausrichtung)],color:gc[xc(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
    ...
    `]}render(){return g`<div class="flaeche ${wc(this.richtung)}"><div class="linie"></div></div>`}};w([S()],Tc.prototype,`richtung`,void 0),T.defineAndRegister(Tc),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;F(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();
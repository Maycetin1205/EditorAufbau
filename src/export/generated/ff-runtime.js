...
\f\r]`,v=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,be=/-->/g,xe=/>/g,y=RegExp(`>|${ye}(?:([^\\s"'>=/]+)(${ye}*=${ye}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,`g`),Se=/'/g,Ce=/"/g,we=/^(?:script|style|textarea|title)$/i,Te=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),b=Te(1),x=Te(2),S=Symbol.for(`lit-noChange`),C=Symbol.for(`lit-nothing`),Ee=new WeakMap,w=h.createTreeWalker(h,129);function De(e,t){if(!_e(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return pe===void 0?t:pe.createHTML(t)}var Oe=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:t===3?`<math>`:``,o=v;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===v?c[1]===`!--`?o=be:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=y):(we.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=y):o=xe:o===y?c[0]===`>`?(o=i??v,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?y:c[3]===`"`?Ce:Se):o===Ce||o===Se?o=y:o===be||o===xe?o=v:(o=y,i=void 0);let d=o===y&&e[t+1].startsWith(`/>`)?` `:``;a+=o===v?n+ge:l>=0?(r.push(s),n.slice(0,l)+me+n.slice(l)+m+d):n+m+(l===-2?t:d)}return[De(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:t===3?`</math>`:``)),r]},ke=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=Oe(t,n);if(this.el=e.createElement(l,r),w.currentNode=this.el.content,n===2||n===3){let e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;(i=w.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes())for(let e of i.getAttributeNames())if(e.endsWith(me)){let t=u[o++],n=i.getAttribute(e).split(m),r=/([.?@])?(.*)/.exec(t);c.push({type:1,index:a,name:r[2],strings:n,ctor:r[1]===`.`?Ne:r[1]===`?`?Pe:r[1]===`@`?Fe:Me}),i.removeAttribute(e)}else e.startsWith(m)&&(c.push({type:6,index:a}),i.removeAttribute(e));if(we.test(i.tagName)){let e=i.textContent.split(m),t=e.length-1;if(t>0){i.textContent=fe?fe.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],g()),w.nextNode(),c.push({type:2,index:++a});i.append(e[t],g())}}}else if(i.nodeType===8)if(i.data===he)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(m,e+1))!==-1;)c.push({type:7,index:a}),e+=m.length-1}a++}}static createElement(e,t){let n=h.createElement(`template`);return n.innerHTML=e,n}};function T(e,t,n=e,r){if(t===S)return t;let i=r===void 0?n._$Cl:n._$Co?.[r],a=_(t)?void 0:t._$litDirective$;return i?.constructor!==a&&(i?._$AO?.(!1),a===void 0?i=void 0:(i=new a(e),i._$AT(e,n,r)),r===void 0?n._$Cl=i:(n._$Co??=[])[r]=i),i!==void 0&&(t=T(e,i._$AS(e,t.values),i,r)),t}var Ae=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??h).importNode(t,!0);w.currentNode=r;let i=w.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new je(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new Ie(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=w.nextNode(),a++)}return w.currentNode=h,r}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},je=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,r){this.type=2,this._$AH=C,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=T(this,e,t),_(e)?e===C||e==null||e===``?(this._$AH!==C&&this._$AR(),this._$AH=C):e!==this._$AH&&e!==S&&this._(e):e._$litType$===void 0?e.nodeType===void 0?ve(e)?this.k(e):this._(e):this.T(e):this.$(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==C&&_(this._$AH)?this._$AA.nextSibling.data=e:this.T(h.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=ke.createElement(De(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.p(t);else{let e=new Ae(r,this),n=e.u(this.options);e.p(t),this.T(n),this._$AH=e}}_$AC(e){let t=Ee.get(e.strings);return t===void 0&&Ee.set(e.strings,t=new ke(e)),t}k(t){_e(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.O(g()),this.O(g()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let t=de(e).nextSibling;de(e).remove(),e=t}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},Me=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,r,i){this.type=1,this._$AH=C,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=C}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=T(this,e,t,0),a=!_(e)||e!==this._$AH&&e!==S,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=T(this,r[n+o],t,o),s===S&&(s=this._$AH[o]),a||=!_(s)||s!==this._$AH[o],s===C?e=C:e!==C&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===C?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},Ne=class extends Me{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===C?void 0:e}},Pe=class extends Me{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==C)}},Fe=class extends Me{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=T(this,e,t,0)??C)===S)return;let n=this._$AH,r=e===C&&n!==C||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==C&&(n===C||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Ie=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){T(this,e)}},Le=ue.litHtmlPolyfillSupport;Le?.(ke,je),(ue.litHtmlVersions??=[]).push(`3.3.3`);var Re=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new je(t.insertBefore(g(),e),e,void 0,n??{})}return i._$AI(e),i},ze=globalThis,E=class extends p{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Re(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return S}};E._$litElement$=!0,E.finalized=!0,ze.litElementHydrateSupport?.({LitElement:E});var Be=ze.litElementPolyfillSupport;Be?.({LitElement:E}),(ze.litElementVersions??=[]).push(`4.2.2`);var Ve={attribute:!0,type:String,converter:se,reflect:!1,hasChanged:ce},He=(e=Ve,t,n)=>{let{kind:r,metadata:i}=n,a=globalThis.litPropertyMetadata.get(i);if(a===void 0&&globalThis.litPropertyMetadata.set(i,a=new Map),r===`setter`&&((e=Object.create(e)).wrapped=!0),a.set(n.name,e),r===`accessor`){let{name:r}=n;return{set(n){let i=t.get.call(this);t.set.call(this,n),this.requestUpdate(r,i,e,!0,n)},init(t){return t!==void 0&&this.C(r,void 0,e,t),t}}}if(r===`setter`){let{name:r}=n;return function(n){let i=this[r];t.call(this,n),this.requestUpdate(r,i,e,!0,n)}}throw Error(`Unsupported decorator location: `+r)};function D(e){return(t,n)=>typeof n==`object`?He(e,t,n):((e,t,n)=>{let r=t.hasOwnProperty(n);return t.constructor.createProperty(n,e),r?Object.getOwnPropertyDescriptor(t,n):void 0})(e,t,n)}function Ue(e){return D({...e,state:!0,attribute:!1})}var We=new Map;function Ge(e){We.has(e.type)&&console.warn(`Block-Typ "${e.type}" wird ueberschrieben.`),We.set(e.type,e)}function Ke(){return Array.from(We.values())}var qe={width:`auto`},Je={rasterX:0,rasterY:0,rasterW:{spalten:24,spaltePx:40,zeilePx:12,gapPx:8}.spalten,rasterH:1},Ye=`weitereQuellen`,Xe={[Ye]:[]};function O(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var k=class extends E{constructor(...e){super(...e),this.editable=!1}static{this.styles=o`
  ...
  `}static{this.customProperties=[]}get customProperties(){return this.constructor.customProperties}inlineEdit(e,t){if(!this.editable)return;let n=e.currentTarget;if(!n||n.hasAttribute(`data-ff-bound`))return;e.stopPropagation(),e.preventDefault();let r=n.textContent??``,i=Array.from(n.childNodes),a=i.map(e=>e.textContent??``);n.setAttribute(`contenteditable`,`plaintext-only`),n.focus();let o=window.getSelection(),s=document.createRange();s.selectNodeContents(n),o?.removeAllRanges(),o?.addRange(s);let c=!1,l=e=>{if(!c)if(c=!0,n.removeAttribute(`contenteditable`),n.removeEventListener(`blur`,u),n.removeEventListener(`keydown`,d),e){let e=(n.textContent??``).trim();e!==r&&this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:t,value:e},bubbles:!0,composed:!0}))}else n.replaceChildren(...i),i.forEach((e,t)=>{e.textContent!==a[t]&&(e.textContent=a[t])})},u=()=>l(!0),d=e=>{e.key===`Enter`?(e.preventDefault(),n.blur()):e.key===`Escape`&&(e.preventDefault(),l(!1))};n.addEventListener(`blur`,u),n.addEventListener(`keydown`,d)}static defineAndRegister(e){customElements.get(e.tagName)||customElements.define(e.tagName,e),Ge({type:e.blockType,tagName:e.tagName,displayName:e.displayName,category:e.category,defaultProps:{...qe,...Je,...e.acceptsDataSource?Xe:null,...e.defaultProps},customProperties:e.customProperties,acceptsChildren:e.acceptsChildren??!1,resizableWidth:e.resizableWidth??!0,resizableHeight:e.resizableHeight??!1,allowedChildTypes:e.allowedChildTypes,allowedParentTypes:e.allowedParentTypes,lockedWidth:e.lockedWidth,defaultChildren:e.defaultChildren,childDirection:e.childDirection,showInPalette:e.showInPalette,templateChild:e.templateChild,containerHint:e.containerHint,addChildButton:e.addChildButton,acceptsDataSource:e.acceptsDataSource,bindableSpots:e.bindableSpots,actionValueSpots:e.actionValueSpots,listenBindung:e.listenBindung,blockEvents:e.blockEvents,pageBlock:e.pageBlock,raster:e.raster})}};O([D({type:Boolean,reflect:!0,attribute:`data-editable`})],k.prototype,`editable`,void 0);var Ze=[`GET_RELATION`,`PUT_RELATION`,`PUTADD_RELATION`];function Qe(e){return`${String(e.getDate()).padStart(2,`0`)}.${String(e.getMonth()+1).padStart(2,`0`)}.${e.getFullYear()}`}function $e(e,t){return e.params.map(e=>e.replace(/\{([A-Za-z0-9_]+)\}/g,(e,n)=>String(t[n]??``)))}var et=`data-ff-block-id`,tt=[`fixed`,`context`,`data_field`,`block_value`,`previous_result`,`step_result`,`se_variable`];function A(e){return!!e&&typeof e==`object`&&!Array.isArray(e)}function nt(e){return!A(e)||typeof e.source!=`string`||!tt.includes(e.source)||typeof e.value!=`string`||e.dataSourceId!==void 0&&typeof e.dataSourceId!=`string`||e.blockId!==void 0&&typeof e.blockId!=`string`?null:{source:e.source,value:e.value,...typeof e.dataSourceId==`string`?{dataSourceId:e.dataSourceId}:{},...typeof e.blockId==`string`?{blockId:e.blockId}:{}}}function rt(e){if(!A(e)||typeof e.type!=`string`||typeof e.resultKey!=`string`)return null;if(e.type===`START_TOOL`)return typeof e.toolNr!=`string`||!Array.isArray(e.toolParams)||e.toolParams.some(e=>typeof e!=`string`)?null:{type:`START_TOOL`,resultKey:e.resultKey,toolNr:e.toolNr,toolParams:[...e.toolParams]};if(e.type===`POPUP_OPEN`||e.type===`POPUP_CLOSE`){let t=typeof e.popupId==`string`?e.popupId:void 0,n=typeof e.popup==`string`?e.popup:void 0;return t===void 0&&n===void 0?null:{type:e.type,resultKey:e.resultKey,...t===void 0?{}:{popupId:t},...n===void 0?{}:{popup:n}}}if(e.type===`RELATION`){if(typeof e.relationId!=`string`||!Array.isArray(e.extraParams)||!Array.isArray(e.params)&&!A(e.bindings))return null;let t=[];if(Array.isArray(e.params))for(let n of e.params){let e=nt(n);if(!e)return null;t.push(e)}let n=[];for(let t of e.extraParams){let e=nt(t);if(!e)return null;n.push(e)}return{type:`RELATION`,resultKey:e.resultKey,relationId:e.relationId,params:t,extraParams:n}}return null}function it(e){if(!e)return{};let t;try{t=JSON.parse(e)}catch{return{}}if(!A(t))return{};let n={};for(let[e,r]of Object.entries(t)){if(!Array.isArray(r)||r.length===0)continue;let t=[],i=!1;for(let e of r){let n=rt(e);if(!n){i=!0;break}t.push(n)}!i&&t.length>0&&(n[e]=t)}return n}var at=`root`;function ot(e,t){let n=Number(e);return Number.isFinite(n)&&n>0?n:t}var j=class extends k{constructor(...e){super(...e),this.name=`Popup`,this.breite=520,this.hoehe=380}static{this.blockType=`popup`}static{this.tagName=`ff-popup`}static{this.displayName=`Popup`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.showInPalette=!1}static{this.allowedParentTypes=[at]}static{this.pageBlock=!0}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.defaultProps={name:`Popup`,breite:520,hoehe:380}}static{this.styles=[k.styles,o`
    ...
    `]}onClose(){this.hasAttribute(`data-ff-editor`)||this.removeAttribute(`offen`)}render(){return b`<div class="abdunklung"></div>
      <div class="buehne">
        <div class="fenster" style="width:${ot(this.breite,520)}px;height:${ot(this.hoehe,380)}px">
          <div class="kopf">
            <span
              class="titel"
              data-ff-editable
      ...
      </div>`}};O([D()],j.prototype,`name`,void 0),O([D()],j.prototype,`breite`,void 0),O([D()],j.prototype,`hoehe`,void 0),k.defineAndRegister(j);function M(e){return typeof e==`object`&&!!e}function N(e,t){if(!(!Array.isArray(e)||t===``)){for(let n of e)if(!(!M(n)||n.id!==t)&&!(typeof n.name!=`string`||typeof n.tableId!=`string`))return{id:t,name:n.name,tableId:n.tableId,indexField:typeof n.indexField==`string`?n.indexField:``}}}function st(e){return e==null?``:String(e).trim()}function P(e,t){if(!M(e)||t===``)return``;let n=t.trim(),r=st(e[n]);if(r!==``)return r;for(let t of Object.keys(e))if(t===n||t.startsWith(`${n}_`)||t.endsWith(`_${n}`)){let n=st(e[t]);if(n!==``)return n}let i=/^(\d+)_(\d+)$/.exec(n);if(!i)return``;let a=st(e.SATZNEU??e.SATZ??e.satzneu??e.satz??e.RAW??e.raw);if(a===``)return``;let o=Number(i[1]),s=Number(i[2]);return s<=0?``:a.substring(o,o+s).trim()}function ct(e,t,n){if(!M(e)||t===``)return!1;let r=t.trim(),i=!1;for(let t of Object.keys(e))(t===r||t.startsWith(`${r}_`)||t.endsWith(`_${r}`))&&(e[t]=n,i=!0);let a=/^(\d+)_(\d+)$/.exec(r);if(a){let t=[`SATZNEU`,`SATZ`,`satzneu`,`satz`,`RAW`,`raw`].find(t=>typeof e[t]==`string`);if(t){let r=e[t],o=Number(a[1]),s=Number(a[2]);if(s>0){let a=n.length>s?n.slice(0,s):n.padEnd(s,` `),c=r.length<o?r.padEnd(o,` `):r;e[t]=c.slice(0,o)+a+c.slice(o+s),i=!0}}}return i}function lt(e){if(!M(e))return Array.isArray(e)?e:[];let t=[e.Zeilen,e.zeilen,e.Saetze,e.saetze,e.Rows,e.rows,e.Daten,e.daten];for(let e of t){if(Array.isArray(e))return e;if(typeof e==`string`)try{let t=JSON.parse(e);if(Array.isArray(t))return t}catch{}}return[]}function F(e,t){return st(e).toLowerCase()===t.trim().toLowerCase()}function I(e,t,n){if(!M(e)||!M(e.Daten))return[];let r=e.Daten,i=r.SEFileLoop;if(Array.isArray(i)){for(let e of i)if(M(e)&&(F(e.ALIAS,t)||F(e.alias,t))){let t=lt(e);if(t.length>0)return t}}else if(M(i))for(let e of Object.keys(i)){let n=i[e];if(F(e,t)||M(n)&&(F(n.ALIAS,t)||F(n.alias,t))){let e=lt(n);if(e.length>0)return e}}let a=r.Tabellen;if(M(a)){let e=[t,t.toUpperCase(),t.toLowerCase(),n];for(let t of e)if(t!==``&&t in a){let e=lt(a[t]);if(e.length>0)return e}for(let e of Object.keys(a))if(F(e,t)){let t=lt(a[e]);if(t.length>0)return t}}return[]}function ut(e){let t=e;if(typeof t==`string`)try{t=JSON.parse(t)}catch{return}if(!M(t)||!M(t.Daten))return;let n=t.Daten;if(!(!n.SEFileLoop&&!n.Tabellen&&!n.ErpApiCall))return n}function dt(e){let t=e;if(typeof t==`string`)try{t=JSON.parse(t)}catch{return}if(!(!M(t)||!M(t.MSG)))return t.MSG.DATA}function L(){return globalThis}function ft(){let e=L();return M(e.SEDATA)&&M(e.SEDATA.Daten)}function pt(){let e=L();try{e.selib?.Json?.InitializeERPConnection?.()}catch{}try{typeof e.InitialisiereSchnittstelle==`function`&&e.InitialisiereSchnittstelle()}catch{}}function mt(){let e=L();try{typeof e.ResetDataBasis==`function`&&e.ResetDataBasis()}catch{}try{typeof e.InitialisiereDatenBasis==`function`&&e.InitialisiereDatenBasis()}catch{}}var ht=new Set,gt=new Set;function _t(e){ht.add(e)}function vt(e){return gt.add(e),()=>{gt.delete(e)}}function yt(){ht.forEach(e=>e())}function bt(e){gt.forEach(t=>{try{t(e)}catch{}})}var R=new Map,xt=``,St=0;function Ct(){try{let e=document.getElementById(`ff-se-diagnose`);return!e&&document.body&&(e=document.createElement(`textarea`),e.id=`ff-se-diagnose`,e.readOnly=!0,e.style.cssText=`display:none;position:fixed;left:8px;right:8px;bottom:8px;height:40vh;z-index:99999;font:11px monospace;`,document.body.appendChild(e)),e}catch{return null}}function wt(){let e=Ct();e&&(e.value=Array.from(R,([e,t])=>`${e}: ${t}`).join(`
`)+(xt===``?``:`\n\nERSTES PAKET\n${xt}`))}function z(e,t){R.set(e,t),wt()}function Tt(){let e=L();R.set(`basisHTML_REGISTER`,typeof e.basisHTML_REGISTER==`function`?`vorhanden`:`fehlt`),R.set(`basisHTML_SND_MSG`,typeof e.basisHTML_SND_MSG==`function`?`vorhanden`:`fehlt`),R.set(`body.pid`,document.body?.getAttribute(`pid`)?`gesetzt`:`fehlt`),R.set(`body.REGMSG`,document.body?.getAttribute(`REGMSG`)?`gesetzt`:`fehlt`),R.set(`Empfangene Pakete`,String(St)),R.set(`SEDATA.Daten`,ft()?`vorhanden`:`fehlt`),wt()}function Et(e){if(xt===``)try{xt=typeof e==`string`?e:JSON.stringify(e)??``,wt()}catch{}}function Dt(e){St+=1,Et(e),z(`Empfangene Pakete`,String(St));let t=ut(e);if(!t){z(`Letztes Paket`,`Antwort ohne Daten`),bt(e);return}let n=L();M(n.SEDATA)||(n.SEDATA={}),n.SEDATA.Daten=t,z(`Letztes Paket`,`Daten-Push angenommen`),z(`SEDATA.Daten`,`vorhanden`),mt(),yt()}function Ot(e=0){let t=L();if(typeof t.basisHTML_REGISTER==`function`){Tt();try{t.basisHTML_SetConsoleLog?.(!0,!0)}catch{}try{t.basisHTML_REGISTER(e=>{Dt(e)},document.title,`1.0`),z(`Registrierung`,`ausgeführt`)}catch(e){z(`Registrierung`,`Fehler: ${e instanceof Error?e.message:String(e)}`)}return}e<400?(e===0&&z(`Registrierung`,`wartet auf Interface`),setTimeout(()=>{Ot(e+1)},25)):(Tt(),z(`Registrierung`,`nach 10s kein Interface`))}var kt=!1;function At(){if(kt)return;kt=!0,z(`Runtime`,`gestartet`),z(`Registrierung`,`noch nicht ausgeführt`),Tt(),pt();let e=L();e.Erstellen=()=>{mt(),yt()},e.initData=e.Erstellen,e.ReloadData=()=>{yt()},Ot(),window.addEventListener(`message`,e=>{if(typeof L().basisHTML_REGISTER==`function`)return;let t=dt(e.data);t!==void 0&&Dt(t)},!0),document.addEventListener(`keydown`,e=>{if(e.ctrlKey&&e.altKey&&e.key.toLowerCase()===`d`){Tt();let e=document.getElementById(`ff-se-diagnose`);e&&(e.style.display=e.style.display===`none`?`block`:`none`)}});let t=0,n=setInterval(()=>{t+=1,ft()?(clearInterval(n),z(`SEDATA.Daten`,`vorhanden`),mt(),yt()):t>100&&(clearInterval(n),z(`Daten-Wartezeit`,`nach 30s ohne Daten`))},300)}var jt=8e3,B=null,V=null;function Mt(){let e=document.createElement(`div`);return e.setAttribute(`data-ff-meldung`,``),e.setAttribute(`role`,`alert`),e.style.cssText=[`position:fixed`,`top:0`,`left:0`,`right:0`,`z-index:2147483647`,`padding:7px 12px`,`background:var(--se-red-soft,#fbe7e6)`,`color:var(--se-red,#c0201a)`,`border-bottom:1px solid var(--se-red,#c0201a)`,`font:500 12px/1.4 system-ui,sans-serif`,`cursor:pointer`].join(`;`),e.title=`Klicken zum Schliessen`,e.addEventListener(`click`,Nt),e}function Nt(){V&&=(clearTimeout(V),null),B?.remove(),B=null}function H(e){typeof document>`u`||!document.body||(B||(B=Mt(),document.body.appendChild(B)),B.textContent=e,V&&clearTimeout(V),V=setTimeout(Nt,jt))}function Pt(e){return e instanceof Error?e.message:String(e)}function Ft(e,t){if(!(!Array.isArray(e)||t===``)){for(let n of e)if(!(!M(n)||n.id!==t)&&!(typeof n.verb!=`string`||!Ze.includes(n.verb))&&!(typeof n.nr!=`string`||n.nr===``)&&!(!Array.isArray(n.params)||n.params.some(e=>typeof e!=`string`)))return{id:t,verb:n.verb,nr:n.nr,params:n.params}}}var It=[`RESULT`,`result`,`PINDEX`,`pindex`,`INDEX`,`index`,`0_10`,`KEY`,`key`,`ID`,`id`,`VALUE`,`value`];function Lt(e){if(typeof e!=`string`)return e;try{return JSON.parse(e)}catch{return}}function Rt(e){if(typeof e==`string`)return e.trim()===``?void 0:e.trim();if(typeof e==`number`||typeof e==`boolean`)return String(e)}function zt(e,t){if(t>12)return;let n=Rt(e);if(n!==void 0)return n;if(Array.isArray(e)){for(let n of e){let e=zt(n,t+1);if(e!==void 0)return e}return}if(M(e)){for(let n of It){if(!(n in e))continue;let r=zt(e[n],t+1);if(r!==void 0)return r}for(let n of Object.values(e)){let e=zt(n,t+1);if(e!==void 0)return e}}}function Bt(e){let t=Lt(e);if(M(t)){for(let e of It){if(!(e in t))continue;let n=zt(t[e],0);if(n!==void 0)return n}for(let e of Object.values(t))if(Array.isArray(e))for(let t of e){let e=Bt(t);if(e!==void 0)return e}else if(M(e)){let t=Bt(e);if(t!==void 0)return t}}}function Vt(e){return M(e)?Object.keys(e).filter(e=>/^Message\d+$/.test(e)):[]}function Ht(e,t){if(!M(e))return;let n=Vt(e).filter(e=>!t.has(e)).sort((e,t)=>Number(t.slice(7))-Number(e.slice(7)));for(let t of n){let n=Bt(e[t]);if(n!==void 0)return n}}var Ut=[],Wt=!1,Gt=6e3,Kt=100;function qt(){if(Wt||Ut.length===0)return;Wt=!0;let e=Ut.shift(),t=L(),n=new Set(Vt(t.SEDATA)),r=!1,i=t=>{r||(r=!0,a(),clearInterval(o),clearTimeout(s),Wt=!1,e.resolve(t),qt())},a=vt(e=>{let t=Bt(e);t!==void 0&&i(t)}),o=setInterval(()=>{let e=Ht(L().SEDATA,n);e!==void 0&&i(e)},Kt),s=setTimeout(()=>{H(`Daten laden: SoftEngine hat nicht geantwortet (Relation Nr. ${e.template.nr}).`),i(``)},Gt);if(typeof t.basisHTML_SND_MSG!=`function`){H(`Daten laden nicht moeglich: keine Verbindung zu SoftEngine.`),i(``);return}try{t.basisHTML_SND_MSG(`GET_RELATION`,{NR:e.template.nr,PARAMS:e.params})}catch(t){H(`Daten laden fehlgeschlagen (Relation Nr. ${e.template.nr}): ${Pt(t)}`),i(``)}}function Jt(e,t){At();let n=L();if(e.verb!==`GET_RELATION`){if(typeof n.basisHTML_SND_MSG!=`function`)return H(`Speichern nicht moeglich: keine Verbindung zu SoftEngine. Die Eingabe wurde NICHT uebernommen.`),Promise.resolve(``);try{n.basisHTML_SND_MSG(e.verb,{NR:e.nr,PARAMS:[...t]})}catch(t){H(`Speichern fehlgeschlagen (Relation Nr. ${e.nr}): ${Pt(t)}`)}return Promise.resolve(``)}return new Promise(n=>{Ut.push({template:e,params:[...t],resolve:n}),qt()})}function Yt(e,t){if(!M(t))return``;let n=t.document;if(!n||typeof n.querySelectorAll!=`function`)return``;let r=Array.from(n.querySelectorAll(`[${et}]`)).find(t=>t.getAttribute(et)===e.blockId);if(!r)return``;let i=r[e.value];return i==null?``:String(i)}function Xt(e,t,n=L()){if(e.source===`fixed`)return e.value;if(e.source===`context`)return t.context[e.value]??``;if(e.source===`previous_result`)return t.previousResult;if(e.source===`step_result`){let n=Number(e.value);return Number.isInteger(n)&&n>=0?t.stepResults?.[n]??``:``}if(e.source===`block_value`)return Yt(e,n);if(!M(n))return``;if(e.source===`se_variable`){let t=n.SEDATA;if(!M(t)||!M(t.Daten)||!M(t.Daten.VARArrays))return``;let r=t.Daten.VARArrays[e.value];return r==null?``:String(r)}let r=N(n.FF_DATA_SOURCES,e.dataSourceId??``);if(!r)return``;let i=I(n.SEDATA,r.name,r.tableId),a=t.context.PINDEX??``,o=a!==``&&r.indexField!==``?i.find(e=>P(e,r.indexField)===a):i[0];return o?P(o,e.value):``}function Zt(e,t){let n=`0,START_TOOL,`+e;return t.length>0&&(n+=`,`+t.map(e=>encodeURIComponent(e)).join(`,`)),n}function Qt(e,t){if(e.trim()===``)return;let n=L();try{if(typeof n.sendBWLinkIntern==`function`){n.sendBWLinkIntern(Zt(e,t));return}}catch{}try{if(typeof n.basisHTML_SND_MSG==`function`){let r={NR:e};t.length>0&&(r.PARAMS=[...t]),n.basisHTML_SND_MSG(`START_TOOL`,r)}}catch{}}function $t(e,t,n){if(t.trim()!==``)for(let r of Array.from(e.querySelectorAll(j.tagName)))(r.getAttribute(`name`)??``)===t&&(n?r.setAttribute(`offen`,``):r.removeAttribute(`offen`))}var en=new WeakMap;async function tn(e,t,n){if(e.hasAttribute(`data-ff-editor`))return;let r=it(e.getAttribute(`data-ff-aktionen`))[t];if(!r||r.length===0)return;let i=en.get(e);if(i||(i=new Set,en.set(e,i)),!i.has(t)){i.add(t);try{let t={...n,NOW_DATE:Qe(new Date)},i=``,a=[];for(let n of r){if(n.type===`START_TOOL`){Qt(n.toolNr,$e({params:n.toolParams},t)),a.push(``);continue}if(n.type===`POPUP_OPEN`||n.type===`POPUP_CLOSE`){$t(e.ownerDocument??document,n.popup??``,n.type===`POPUP_OPEN`),a.push(``);continue}let r=Ft(L().FF_RELATIONS,n.relationId);if(!r){a.push(``);continue}let o={context:t,previousResult:i,stepResults:a},s=await Jt(r,[...n.params,...n.extraParams].map(e=>Xt(e,o)));a.push(s),r.verb===`GET_RELATION`&&(i=s),n.resultKey!==``&&(t[n.resultKey]=s)}}finally{i.delete(t)}}}var nn=new WeakSet;function rn(e,t){if(e.hasAttribute(`data-ff-editor`)||!e.hasAttribute(`data-ff-aktionen`)||nn.has(e))return;nn.add(e);let n=it(e.getAttribute(`data-ff-aktionen`));Object.values(n).some(e=>e.some(e=>e.type===`RELATION`))&&At(),e.addEventListener(`click`,()=>{tn(e,t,{})})}var an=class extends k{constructor(...e){super(...e),this.label=`Klick mich`}static{this.blockType=`button`}static{this.tagName=`ff-button`}static{this.displayName=`Schaltfläche`}static{this.category=`eingabe`}static{this.defaultProps={label:`Klick mich`}}static{this.resizableWidth=!1}static{this.blockEvents=[{key:`onClick`,name:`Klick`}]}static{this.raster={startW:4,startH:2,minW:2,minH:2}}static{this.customProperties=[]}static{this.styles=[k.styles,o`
      button {
        box-sizing: border-box;
        padding: 7px 16px;
        cursor: pointer;
    ...
    >${this.label}</button>`}connectedCallback(){super.connectedCallback(),rn(this,`onClick`)}};O([D()],an.prototype,`label`,void 0),k.defineAndRegister(an);var on=[`info`,`success`,`warning`,`danger`];function sn(e){return on.includes(e)?e:`info`}function cn(e,t){return{attributeName:e,name:`Farbe`,description:t,kind:`select`,options:[{value:`info`,label:`Hinweis`},{value:`success`,label:`Erfolg`},{value:`warning`,label:`Warnung`},{value:`danger`,label:`Fehler`}]}}var ln=o`
  .chip {
...
`,un={dog:x`<ellipse cx="12" cy="13.5" rx="6.3" ry="7"></ellipse><ellipse cx="5.2" cy="11.5" rx="2.4" ry="5.2" transform="rotate(14 5.2 11.5)"></ellipse><ellipse cx="18.8" cy="11.5" rx="2.4" ry="5.2" transform="rotate(-14 18.8 11.5)"></ellipse>`,cat:x`<path d="M5.2 10.5 L3.6 3.2 L10 6.4 Z"></path><path d="M18.8 10.5 L20.4 3.2 L14 6.4 Z"></path><circle cx="12" cy="13.5" r="7"></circle>`,rabbit:x`<ellipse cx="8.8" cy="6.5" rx="2.3" ry="5.6" transform="rotate(-10 8.8 6.5)"></ellipse><ellipse cx="15.2" cy="6.5" rx="2.3" ry="5.6" transform="rotate(10 15.2 6.5)"></ellipse><circle cx="12" cy="16" r="6.2"></circle>`,hamster:x`<circle cx="7.6" cy="8.8" r="2"></circle><ellipse cx="12" cy="14" rx="8.3" ry="6"></ellipse>`,bird:x`<circle cx="9.2" cy="8.8" r="4.6"></circle><ellipse cx="12.5" cy="14.8" rx="5.2" ry="5.4"></ellipse><path d="M5.2 7.6 L2 9.2 L5.4 10.6 Z"></path><path d="M15.5 16.5 L22 20.5 L17.6 13.8 Z"></path>`,reptile:x`<path d="M4.5 14.8 Q4.5 7.2 12 7.2 Q19.5 7.2 19.5 14.8 Z"></path><circle cx="20.6" cy="13.9" r="2.1"></circle><rect x="6.2" y="14.6" width="2.6" height="3" rx="1.2"></rect><rect x="13.4" y="14.6" width="2.6" height="3" rx="1.2"></rect>`,paw:x`<circle cx="6.8" cy="9.6" r="1.9"></circle><circle cx="10.4" cy="7.2" r="1.9"></circle><circle cx="14.6" cy="7.2" r="1.9"></circle><circle cx="18.2" cy="9.6" r="1.9"></circle><path d="M12.5 11.2c-2.9 0-5.3 2.1-5.3 4.4 0 1.7 1.3 2.9 3.1 2.9.9 0 1.5-.3 2.2-.3s1.3.3 2.2.3c1.8 0 3.1-1.2 3.1-2.9 0-2.3-2.4-4.4-5.3-4.4z"></path>`},dn=[[`welpe`,`dog`],[`hund`,`dog`],[`kater`,`cat`],[`katze`,`cat`],[`kaninchen`,`rabbit`],[`hase`,`rabbit`],[`meerschweinchen`,`hamster`],[`hamster`,`hamster`],[`ratte`,`hamster`],[`maus`,`hamster`],[`wellensittich`,`bird`],[`sittich`,`bird`],[`papagei`,`bird`],[`vogel`,`bird`],[`schildkr`,`reptile`],[`echse`,`reptile`],[`schlange`,`reptile`],[`gecko`,`reptile`],[`reptil`,`reptile`]];function fn(e){let t=e.toLowerCase(),n=`paw`;for(let[e,r]of dn)if(t.includes(e)){n=r;break}return b`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">${un[n]}</svg>`}var U=class extends k{constructor(...e){super(...e),this.chipVariant=`info`,this.heading=``,this.heading2=``,this.time=``,this.date=``,this.avatar=``,this.meta=``,this.text=``,this.chipText=``,this.headingField=``,this.heading2Field=``,this.timeField=``,this.dateField=``,this.avatarField=``,this.metaField=``,this.textField=``,this.chipTextField=``}static{this.blockType=`card`}static{this.tagName=`ff-card`}static{this.displayName=`Karte`}static{this.category=`anzeige`}static{this.allowedParentTypes=[`kanban-spalte`]}static{this.showInPalette=!1}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={chipVariant:`info`,heading:``,heading2:``,time:``,date:``,avatar:``,meta:``,text:``,chipText:``,headingField:``,heading2Field:``,timeField:``,dateField:``,avatarField:``,metaField:``,textField:``,chipTextField:``}}static{this.bindableSpots=[{prop:`time`,label:`Zeit`},{prop:`date`,label:`Datum`},{prop:`avatar`,label:`Avatar`},{prop:`heading`,label:`Titel`},{prop:`heading2`,label:`Titel 2`},{prop:`meta`,label:`Unterzeile`},{prop:`text`,label:`Textzeile`},{prop:`chipText`,label:`Chip`}]}static{this.customProperties=[cn(`chipVariant`,`Bedeutung des Chips auf der Karte — bestimmt die Chip-Farbe.`)]}static{this.styles=[k.styles,ln,o`
      .card {
        box-sizing: border-box;
        display: flex;
        flex-direction: column;
    ...
    >${this[e]}</span>`}render(){let e=sn(this.chipVariant),t=this.hasAttribute(`data-ff-editor`),n=e=>t||e.trim()!==``,r=n(this.heading)||n(this.heading2),i=n(this.time)||n(this.date);return b`<div class="card">
      ${n(this.avatar)||r||n(this.meta)||i?b`<div class="main">
            ${n(this.avatar)?b`<span
                ...
                >${this.avatar.trim()===``?C:fn(this.avatar)}</span>`:C}
            <div class="titles">
              ${r?b`<div class="trow">
    ...
    `]}setzeTag(e){yn(e),this.tag=vn()}render(){return b`<div class="waehler">
      <div class="riegel">
        <button class="pfeil" title="Vortag" @click=${()=>this.setzeTag(hn(this.tag,-1))}>‹</button>
        <input
          class="feld"
          type="date"
          .value=${this.tag}
        ...
        />
        <button class="pfeil" title="Folgetag" @click=${()=>this.setzeTag(hn(this.tag,1))}>›</button>
      </div>
      <button class="heute" @click=${()=>this.setzeTag(mn(new Date))}>Heute</button>
    </div>`}connectedCallback(){super.connectedCallback(),this.tag=vn()||mn(new Date),this.hasAttribute(`data-ff-editor`)||this.setzeTag(this.tag)}};O([Ue()],xn.prototype,`tag`,void 0),k.defineAndRegister(xn);function Sn(e){return`${e.toLowerCase()}field`}function Cn(e){let t=e.split(`::`);if(t.length!==2)return{quelleId:``,code:e};let[n,r]=t;return n===``||r===``?{quelleId:``,code:e}:{quelleId:n,code:r}}function wn(e){let t=new Set,n=!1,r=()=>{ft()&&t.forEach(e.hydriere)};return{connect:i=>{i.hasAttribute(`data-ff-editor`)||(t.add(i),e.verdrahte?.(i),n||(n=!0,_t(r),bn(r)),At(),ft()&&e.hydriere(i))},disconnect:e=>{t.delete(e)},hydriereAlle:r}}var Tn=Ye.toLowerCase(),En=``;function Dn(e){if(e.length===0)return``;let t=[];for(let n of e){let e=n.trim();if(e===``)return``;t.push(e)}return t.join(En)}function On(e){let t=e.getAttribute(Tn)??``;if(t===``)return[];try{let e=JSON.parse(t);if(!Array.isArray(e))return[];let n=[];for(let t of e){if(!t||typeof t!=`object`)continue;let e=t;if(typeof e.quelleId!=`string`||e.quelleId===``)continue;let r=[];for(let t of Array.isArray(e.keyPairs)?e.keyPairs:[]){if(!t||typeof t!=`object`)continue;let e=t;typeof e.fromField!=`string`||typeof e.toField!=`string`||e.fromField.trim()===``||e.toField.trim()===``||r.push({fromField:e.fromField,toField:e.toField})}r.length!==0&&n.push({quelleId:e.quelleId,keyPairs:r})}return n}catch{return[]}}function kn(e){let t=On(e);if(t.length===0)return(e,t)=>P(e,Cn(t).code);let n=L().SEDATA,r=L().FF_DATA_SOURCES,i=new Map;for(let e of t){let t=N(r,e.quelleId);if(!t)continue;let a=I(n,t.name,t.tableId),o=new Map;for(let t of a){let n=Dn(e.keyPairs.map(e=>P(t,e.toField)));n!==``&&!o.has(n)&&o.set(n,t)}i.set(e.quelleId,{nachSchluessel:o,hierFelder:e.keyPairs.map(e=>e.fromField)})}return(e,t)=>{let{quelleId:n,code:r}=Cn(t);if(n===``)return P(e,r);let a=i.get(n);if(!a)return``;let o=Dn(a.hierFelder.map(t=>P(e,t)));if(o===``)return``;let s=a.nachSchluessel.get(o);return s===void 0?``:P(s,r)}}var W=new WeakMap,An=new WeakSet;function jn(e){let t=/^(\d{2})\.(\d{2})\.(\d{4})$/.exec(e);return t?`${t[3]}-${t[2]}-${t[1]}`:e}function Mn(e){let t=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);return t?`${t[3]}.${t[2]}.${t[1]}`:e}function Nn(e){return typeof e.value==`string`?e.value:``}function Pn(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(Sn(`value`))??``;if(t===``||n===``){W.delete(e);return}let r=N(L().FF_DATA_SOURCES,t);if(!r){W.delete(e);return}let i=I(L().SEDATA,r.name,r.tableId)[0];if(i===void 0){W.delete(e),e.value=``;return}let a=r.indexField===``?``:P(i,r.indexField),{quelleId:o,code:s}=Cn(n);o===``?W.set(e,{row:i,code:s,pindex:a}):W.delete(e),e.value=o===``?P(i,s):kn(e)(i,n)}function Fn(e){let t=W.get(e);return t&&ct(t.row,t.code,Nn(e)),t}function In(e){An.has(e)||(An.add(e),e.addEventListener(`input`,()=>{Fn(e)}),e.addEventListener(`change`,()=>{let t=Fn(e);tn(e,`onChange`,{VALUE:Nn(e),PINDEX:t?.pindex??``})}))}var Ln=wn({hydriere:Pn,verdrahte:In}),Rn=Ln.connect,zn=Ln.disconnect,Bn=[`text`,`number`,`textarea`,`select`,`date`,`checkbox`];function Vn(e){return Bn.includes(e)?e:`text`}var Hn=[`text`,`number`,`textarea`,`select`],G=class extends k{constructor(...e){super(...e),this.fieldType=`text`,this.placeholder=`Feldname`,this.options=``,this.source=``,this.value=``,this.valueField=``,this.angehakt=!1}static{this.blockType=`formfeld`}static{this.tagName=`ff-formfeld`}static{this.displayName=`Formularfeld`}static{this.category=`eingabe`}static{this.acceptsDataSource=!0}static{this.bindableSpots=[{prop:`value`,label:`Wert`}]}static{this.actionValueSpots=[{prop:`value`,label:`Wert`}]}static{this.blockEvents=[{key:`onChange`,name:`Wert geändert`}]}static{this.defaultProps={width:240,fieldType:`text`,placeholder:`Feldname`,options:``,source:``,value:``,valueField:``}}static{this.raster={startW:6,startH:2,minW:2,minH:2}}static{this.customProperties=[{attributeName:`fieldType`,name:`Feldtyp`,description:`Welche Art Eingabe das Feld annimmt.`,kind:`select`,options:[{value:`text`,label:`Text`},{value:`number`,label:`Zahl`},{value:`textarea`,label:`Mehrzeilig`},{value:`select`,label:`Auswahl`},{value:`date`,label:`Datum`},{value:`checkbox`,label:`Ankreuzfeld`}]},{attributeName:`options`,name:`Auswahl-Optionen`,description:`Nur bei Feldtyp "Auswahl": Einträge durch Komma getrennt (z. B. "Zimmer 1, Zimmer 2") — jeder Eintrag wird eine Dropdown-Zeile.`,kind:`text`,visibleWhen:{attributeName:`fieldType`,equals:`select`}},{attributeName:`valueField`,name:`Feld`,description:`Feld der angeschlossenen Datenquelle, dessen Wert angezeigt und lokal aktualisiert wird.`,kind:`field`}]}static{this.styles=[k.styles,o`
      .feld {
        font-family: var(--se-font);
    ...
    `]}onInput(e){let t=e.target;this.value=Vn(this.fieldType)===`date`?Mn(t.value):t.value}onChange(){this.dispatchEvent(new Event(`change`))}textTpl(e,t=!1){return b`<span
      class=${e}
      ?hidden=${t}
      data-ff-editable
    ...
    >${this.placeholder}</span>`}onTextClick(){this.hasAttribute(`data-ff-editor`)||this.setzeHaken(!this.angehakt)}setzeHaken(e){this.angehakt!==e&&(this.angehakt=e,this.dispatchEvent(new Event(`change`)))}controlTpl(e){switch(e){case`textarea`:return b`<textarea class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}></textarea>`;case`select`:{let e=this.options.split(`,`).map(e=>e.trim()).filter(e=>e!==``),t=this.value!==``&&!e.includes(this.value);return b`<select class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}>
        ...
        />`}}render(){let e=Vn(this.fieldType);return e===`checkbox`?b`<div class="feld">
        <div class="zeile">
          <input
            class="ctrl"
            type="checkbox"
    ...
    `]}onSlotChange(e){let t=e.target;this._count=t.assignedElements().filter(e=>!e.hasAttribute(`data-ff-editor-helper`)&&e.tagName.toLowerCase()!==`template`).length}render(){return b`<div class="col v-${sn(this.variant)}">
      <div class="head">
        <span class="dot"></span>
        <span
          class="title"
    ...
    </div>`}};O([D()],K.prototype,`variant`,void 0),O([D()],K.prototype,`heading`,void 0),O([Ue()],K.prototype,`_count`,void 0),k.defineAndRegister(K);function Wn(e,t,n){return t===``||n===``?[...e]:e.filter(e=>pn(P(e,t))===n)}function Gn(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function Kn(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var qn=new WeakMap,Jn=K.tagName,Yn=U.tagName;function Xn(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Jn)}function Zn(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Yn)}function Qn(e){return Ke().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function $n(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(`statusfield`)??``;if(t===``)return;let r=N(L().FF_DATA_SOURCES,t);if(!r)return;let i=Xn(e);if(i.length===0)return;let a=qn.get(e);if(!a){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(Yn);t&&(a=t.cloneNode(!0),qn.set(e,a))}if(!a)return;let o=Wn(I(L().SEDATA,r.name,r.tableId),e.getAttribute(`tagfield`)??``,vn()),s=i.map(e=>e.getAttribute(`heading`)??``),c=Qn(a.tagName),l=Kn(i.map(e=>e.getAttribute(`auffang`))),u=kn(e);for(let e of i)Zn(e).forEach(e=>e.remove());for(let e of o){let t=a.cloneNode(!0),o=n===``?-1:Gn(P(e,n),s);(o>=0?i[o]:l>=0?i[l]:i[0]).appendChild(t);for(let n of c){let r=t.getAttribute(Sn(n.prop))??``;r!==``&&(t[n.prop]=u(e,r))}let d=r.indexField===``?``:P(e,r.indexField);q.set(t,{row:e,pindex:d}),t.draggable=!0}}var q=new WeakMap,J=null,er=new WeakSet;function tr(e,t){for(let n of t.composedPath())if(n instanceof HTMLElement&&n.tagName.toLowerCase()===Jn&&e.contains(n))return n;return null}function nr(e,t){if(!J||J.board!==e)return;let n=q.get(J.card);if(!n)return;let r=t.getAttribute(`heading`)??``;tn(e,`onCardDrop`,{PINDEX:n.pindex,VALUE:r})}function rr(e){er.has(e)||(er.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&q.has(e))??null;n&&tn(e,`onCardClick`,{PINDEX:q.get(n)?.pindex??``})}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&q.has(e))??null;n&&(J={card:n,board:e},t.dataTransfer?.setData(`text/plain`,q.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`))}),e.addEventListener(`dragend`,()=>{J=null}),e.addEventListener(`dragover`,t=>{let n=tr(e,t);J?.board===e&&n&&(t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`))}),e.addEventListener(`drop`,t=>{let n=tr(e,t);n&&(t.preventDefault(),nr(e,n),J=null)}))}var ir=wn({hydriere:$n,verdrahte:rr}),ar=ir.connect,or=ir.disconnect,Y=K.blockType,sr=class extends k{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[Y]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:Y}}static{this.templateChild={type:U.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``,tagField:``}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Optional: Feld der Datenquelle, dessen Inhalt bestimmt, in welche Spalte ein Eintrag kommt. Leer = alle Einträge in der Auffang-Spalte.`,kind:`field`},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt das Board nur Einträge des Tages, den der Tageswähler zeigt. Leer = alle Einträge.`,kind:`field`}]}static{this.defaultChildren=[{type:Y,props:{heading:`Offen`,variant:`warning`},children:[{type:U.blockType}]},{type:Y,props:{heading:`In Arbeit`,variant:`info`}},{type:Y,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[k.styles,o`
    ...
    `]}render(){return b`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),ar(this)}disconnectedCallback(){super.disconnectedCallback(),or(this)}};k.defineAndRegister(sr);var cr={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},lr=e=>(...t)=>({_$litDirective$:e,values:t}),ur=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},dr=`important`,fr=` !important`,pr=lr(class extends ur{constructor(e){if(super(e),e.type!==cr.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(fr);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?dr:``):n[e]=r}}return S}});function mr(e){let t=e.getAttribute(`spalten`)??``;if(t===``)return[];try{let e=JSON.parse(t);return Array.isArray(e)?e.map(e=>e&&typeof e==`object`&&typeof e.feld==`string`?e.feld:``):[]}catch{return[]}}function hr(e){let t=e.getAttribute(`source`)??``;if(t===``){e.datenzeilen=[];return}let n=N(L().FF_DATA_SOURCES,t);if(!n){e.datenzeilen=[];return}let r=mr(e),i=Wn(I(L().SEDATA,n.name,n.tableId),e.getAttribute(`tagfield`)??``,vn()),a=kn(e);e.datenzeilen=i.map(e=>r.map(t=>t===``?``:a(e,t)))}var gr=wn({hydriere:hr}),_r=gr.connect,vr=gr.disconnect,yr=1,br=/^-?\d{1,3}(\.\d{3})*(,\d+)?$|^-?\d+(,\d+)?$|^-?\d+(\.\d+)?$/,xr=/^(\d{1,2})\.(\d{1,2})\.(\d{2}|\d{4})$/,Sr=/^(\d{4})-(\d{2})-(\d{2})$/;function Cr(e){let t=e.trim();if(t===``||!br.test(t))return null;let n=t.includes(`,`)?t.replace(/\./g,``).replace(`,`,`.`):/^-?\d{1,3}(\.\d{3})+$/.test(t)?t.replace(/\./g,``):t,r=Number(n);return Number.isFinite(r)?r:null}function wr(e){let t=e.trim();if(t===``)return null;let n=Sr.exec(t);if(n){let[,e,t,r]=n;return Tr(Number(e),Number(t),Number(r))}let r=xr.exec(t);if(r){let[,e,t,n]=r,i=Number(n);return Tr(n.length===2?i<=69?2e3+i:1900+i:i,Number(t),Number(e))}return null}function Tr(e,t,n){if(t<1||t>12||n<1||n>31)return null;let r=new Date(e,t-1,n);return r.getFullYear()!==e||r.getMonth()!==t-1||r.getDate()!==n?null:r.getTime()}function Er(e){let t=0,n=0,r=0;for(let i of e)i.trim()!==``&&(t++,Cr(i)!==null&&n++,wr(i)!==null&&r++);return t===0?`text`:r===t?`datum`:n===t?`zahl`:`text`}var Dr=new Intl.Collator(`de`,{numeric:!0,sensitivity:`base`});function Or(e,t,n){if(t<0||e.length===0)return e.map(e=>[...e]);let r=e=>e[t]??``,i=Er(e.map(r)),a=n?1:-1;return e.map((e,t)=>({zeile:e,i:t})).sort((e,t)=>{let n=r(e.zeile).trim(),o=r(t.zeile).trim();if(n===``&&o===``)return e.i-t.i;if(n===``)return yr;if(o===``)return-1;let s=i===`zahl`?(Cr(n)??0)-(Cr(o)??0):i===`datum`?(wr(n)??0)-(wr(o)??0):Dr.compare(n,o);return s===0?e.i-t.i:s*a}).map(e=>[...e.zeile])}function kr(e){return e.trim().toLowerCase().split(/\s+/).filter(e=>e!==``)}function Ar(e,t){let n=kr(t);if(n.length===0)return!0;let r=e.join(` `).toLowerCase();return n.every(e=>r.includes(e))}function jr(e,t){return kr(t).length===0?e.map(e=>[...e]):e.filter(e=>Ar(e,t)).map(e=>[...e])}function Mr(e,t){return!e&&t.trim()!==``}function Nr(e){if(!e.hatQuelle)return`— Datensätze`;let t=e=>e===1?`Datensatz`:`Datensätze`,n=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${n(e.gesamt)}`:`${e.sichtbar} von ${e.gesamt} ${n(e.gesamt)}`:e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${t(e.gesamt)}`}var Pr=o`
      :host { min-width: 0; height: 100%; }
...
`,Fr=`Spalte {n}`;function X(e){return Fr.replace(`{n}`,String(e+1))}function Z(){return[0,1,2].map(e=>({titel:X(e),feld:``}))}function Ir(e,t){if(e&&typeof e==`object`){let n=e;return{titel:typeof n.titel==`string`?n.titel:X(t),feld:typeof n.feld==`string`?n.feld:``}}return typeof e==`string`?{titel:e,feld:``}:{titel:X(t),feld:``}}function Lr(e){let t;if(Array.isArray(e))t=e.map((e,t)=>Ir(e,t));else if(typeof e==`number`&&Number.isFinite(e)||typeof e==`string`&&/^\d+$/.test(e)){let n=Math.max(1,Math.floor(Number(e)));t=[...Array(n).keys()].map(e=>({titel:X(e),feld:``}))}else t=Z();return t.length>8&&(t=t.slice(0,8)),t.length<1&&(t=[{titel:X(0),feld:``}]),t}function Rr(e){try{return Lr(JSON.parse(e))}catch{return Z()}}var zr=4,Br=[10,25,50],Vr=220,Q=class e extends k{constructor(...e){super(...e),this.spalten=Z(),this.source=``,this.suche=`ja`,this._suchtext=``,this.datenzeilen=[],this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._proSeiteWahl=null,this._klickTimer=null}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.listenBindung={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:Fr}}static{this.defaultProps={width:`fill`,source:``,spalten:Z(),suche:`ja`,tagField:``}}static{this.customProperties=[{attributeName:`suche`,name:`Suchzeile`,description:`Zeigt ueber der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,kind:`segment`,options:[{value:`ja`,label:`Ja`},{value:`nein`,label:`Nein`}],requiresDataSource:!0},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt die Tabelle nur Saetze des Tages, den der Tageswaehler zeigt. Leer = alle Saetze.`,kind:`field`}]}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get proSeiteAktuell(){return this._proSeiteWahl??Br[0]}spaltenListe(){return Lr(this.spalten)}sichtbareZeilen(){let e=jr(this.datenzeilen,this._suchtext);return this._sortSpalte<0?e:Or(e,this._sortSpalte,this._sortAuf)}setzeSuchtext(e){this._suchtext=e,this._seite=0,this.requestUpdate()}klickSortiere(e){this.editable||(this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.requestUpdate())}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}klickSpaltenkopf(t,n){if(!this.editable)return;t.stopPropagation();let r=t.currentTarget.getBoundingClientRect();this.klickTimerAus(),this._klickTimer=setTimeout(()=>{this._klickTimer=null,this.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:e.listenBindung.prop,index:n,top:r.bottom+4,left:r.left},bubbles:!0,composed:!0}))},Vr)}klickTimerAus(){this._klickTimer!==null&&(clearTimeout(this._klickTimer),this._klickTimer=null)}bearbeiteTitel(e,t){if(!this.editable)return;let n=e.currentTarget;if(!n)return;e.stopPropagation(),e.preventDefault();let r=Array.from(n.childNodes),i=n.textContent??``;n.setAttribute(`contenteditable`,`plaintext-only`),n.focus();let a=window.getSelection(),o=document.createRange();o.selectNodeContents(n),a?.removeAllRanges(),a?.addRange(o);let s=!1,c=e=>{if(s)return;s=!0,n.removeAttribute(`contenteditable`),n.removeEventListener(`blur`,l),n.removeEventListener(`keydown`,u);let a=(n.textContent??``).trim(),o=this.spaltenListe();e&&a&&a!==i.trim()&&t<o.length?(o[t]={...o[t],titel:a},this.aendere(o)):n.replaceChildren(...r)},l=()=>c(!0),u=e=>{e.key===`Enter`?(e.preventDefault(),n.blur()):e.key===`Escape`&&(e.preventDefault(),c(!1))};n.addEventListener(`blur`,l),n.addEventListener(`keydown`,u)}connectedCallback(){super.connectedCallback(),_r(this)}disconnectedCallback(){super.disconnectedCallback(),this.klickTimerAus(),vr(this)}static{this.styles=[k.styles,Pr]}render(){let e=this.spaltenListe(),t={gridTemplateColumns:`repeat(${e.length}, minmax(0, 1fr))`},n=e=>e.stopPropagation(),r=this.sichtbareZeilen(),i=Mr(this.hasAttribute(`data-ff-editor`),this.source),a=r.length,o=this.proSeiteAktuell,s=i?Math.max(1,Math.ceil(a/o)):1,c=Math.min(Math.max(this._seite,0),s-1),l=i?r.slice(c*o,(c+1)*o):[],u=i?o:zr,d=i?``:`—`,ee=[...l,...Array.from({length:Math.max(0,u-l.length)},()=>null)];return b`<div class="tabelle" style=${pr({"--spalten-zahl":String(e.length)})}>
      <div class="steuerung">
        <button
      ...
      <div class="kopf" style=${pr(t)}>
        ...
        ${ee.map(n=>b`<div class="zeile" style=${pr(t)}>
            ${n?n.map(e=>b`<div>${e}</div>`):e.map(()=>b`<div>${d}</div>`)}
          </div>`)}
      ...
      <!-- Fusszeile IMMER: sie gehoert zum Aufbau der Tabelle, also muss der
           ...
           ein Strich (Regel 7). -->
      <div class="fusszeile">
        <div class="seiten-info">${Nr({hatQuelle:i,sichtbar:a,gesamt:this.datenzeilen.length,suchtAktiv:this._suchtext.trim()!==``})}</div>
        <div class="seiten-nav">
          ...
          >${Br.map(e=>b`<option value=${e} ?selected=${e===o}>${e} pro Seite</option>`)}</select>
    ...
    </div>`}};O([D({converter:{fromAttribute:e=>e?Rr(e):Z(),toAttribute:e=>JSON.stringify(e)}})],Q.prototype,`spalten`,void 0),O([D()],Q.prototype,`source`,void 0),O([D()],Q.prototype,`suche`,void 0),O([D({attribute:!1})],Q.prototype,`datenzeilen`,void 0),k.defineAndRegister(Q);var Hr=6,Ur=96,Wr=14,Gr={duenn:`300`,normal:`400`,fett:`700`},Kr={links:`left`,mitte:`center`,rechts:`right`};function qr(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(Ur,Math.max(Hr,t)):Wr}function Jr(e){return typeof e==`string`&&e in Gr?e:`normal`}function Yr(e){return typeof e==`string`&&e in Kr?e:`links`}var $=class extends k{constructor(...e){super(...e),this.groesse=Wr,this.gewicht=`normal`,this.ausrichtung=`links`,this.text=`Text`}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.defaultProps={width:`fill`,groesse:Wr,gewicht:`normal`,ausrichtung:`links`,text:`Text`}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:Hr,max:Ur,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`}]}static{this.styles=[k.styles,o`
      .text {
        font-family: var(--se-font);
        color: var(--se-ink);
        line-height: 1.35;
    ...
    `]}render(){return b`<div class="zeile"><slot></slot></div>`}};k.defineAndRegister(Zr)})();
    ...
    >${this[e]}</span>`}hatReiter(){return this.hasAttribute(`data-ff-editor`)||this.date.trim()!==``||this.time.trim()!==``}updated(e){super.updated(e),this.toggleAttribute(`hat-reiter`,this.hatReiter())}render(){let e=Rn(this.chipVariant),t=this.hasAttribute(`data-ff-editor`),n=e=>t||e.trim()!==``,r=this.hatReiter(),i=n(this.avatar)||n(this.heading)||n(this.meta),a=n(this.heading2)||n(this.chipText);return C`<div class="card v-${e}${r?``:` ohne-reiter`}">
      ...
      ${i?C`<div class="kopf">
            ${n(this.avatar)?C`<span
                ...
                >${this.avatar.trim()===``?T:Jn(this.avatar)}</span>`:T}
            <div class="namen">
...
`,Vr=[`text`,`number`,`textarea`,`select`,`date`,`time`,`checkbox`,`nachschlagen`];function Hr(e){return Vr.includes(e)?e:`text`}var Ur=[`text`,`number`,`textarea`,`select`,`nachschlagen`,`date`,`time`],Wr={select:`ph-select`,date:`ph-nativ`,time:`ph-nativ`};function Gr(e){return e.trim().toLowerCase().split(/\s+/).filter(e=>e!==``)}function Kr(e,t){let n=Gr(t);if(n.length===0)return!0;let r=e.join(` `).toLowerCase();return n.every(e=>r.includes(e))}function qr(e){return C`<div class="nachschlag">
    ...
    >${this.placeholder}</span>`}onTextClick(){this.hasAttribute(`data-ff-editor`)||this.setzeHaken(!this.angehakt)}setzeHaken(e){this.angehakt!==e&&(this.angehakt=e,this.dispatchEvent(new Event(`change`)))}controlTpl(e){switch(e){case`textarea`:return C`<textarea class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}></textarea>`;case`select`:{let e=this.options.split(`,`).map(e=>e.trim()).filter(e=>e!==``),t=this.value!==``&&!e.includes(this.value);return C`<select class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}>
        ...
        </select>`}case`nachschlagen`:return qr({wert:this.getippt??this.anzeige,onTippen:e=>{this.getippt=e},onVerlassen:()=>this.onNachschlagVerlassen(),onLupe:()=>this.onLupe()});default:return C`<input
          class="ctrl"
          type=${e}
      ...
      >
        ${this.controlTpl(e)}
        ${Ur.includes(e)?this.textTpl(`ph ${Wr[e]??``}`.trim(),!n):T}
      </div>
...
`,pi=`frei · hierher ziehen`,mi=`ff-zimmer-inhalt`,J=class extends M{constructor(...e){super(...e),this.heading=`Neues Zimmer`,this.leerHinweis=``}static{this.blockType=`kanban-zimmer`}static{this.tagName=`ff-kanban-zimmer`}static{this.displayName=`Kanban-Zimmer`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[K.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban-spalte`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={heading:`Neues Zimmer`}}static{this.styles=[M.styles,ui,fi,o`
    ...
    `]}onSlotChange(){this.dispatchEvent(new CustomEvent(mi,{bubbles:!0,composed:!0}))}render(){return C`<div class="zimmer">
      <div
        class="kopf"
        data-ff-editable
    ...
    `]}constructor(){super(),this.seite=``,this.seitename=``,this.ton=`sonne`,this.addEventListener(`click`,()=>this.melde())}melde(){let e={ansicht:this.seitename};this.dispatchEvent(new CustomEvent(Ki,{detail:e,bubbles:!0,composed:!0}))}render(){return C`<span class="zeichen"></span>
    ...
    `]}connectedCallback(){super.connectedCallback(),ia(this)}disconnectedCallback(){super.disconnectedCallback(),aa(this)}klappen(){this.toggleAttribute(`offen`),Qi(this)}render(){return C`<div class="leiste">
        <div class="kopf">
          <button
            class="schalter"
            type="button"
    ...
    <div class="seiten-nav">
  ...
  </div>`}var So=`—`;function Co(e){return e.linealTakte===0?T:C`<div class="lineal" style=${ma(e.linealTakte===null?e.cols:{...e.cols,flex:`0 1 auto`,height:`calc(var(--zeilen-hoehe) * ${e.linealTakte})`})}>
          ${e.spalten.map(()=>C`<div></div>`)}
        </div>`}function wo(e,t){return C`
      ...
      <div class="koerper">
      <div class="kopf" style=${ma(e.cols)}>
        ...
        ${e.zeilen.map(n=>C`<div
          ...
          >
            ${``}
            ${e.spalten.map((t,r)=>{let i=ja(t.art),a=n===null?So:e.datenzeilen[n]?.[r]??``,o=n===null?{}:e.zusatzzeilen[n]?.[r]??{};return C`<div class=${i.klasse}>${i.zelle(a,t.zuordnung??[],o)}</div>`})}
          </div>`)}
        ${Co(e)}`}
      </div>
    `}var To=o`
...
`,Q=class e extends M{constructor(...e){super(...e),this.spalten=La(),this.source=``,this.suche=`ja`,this.leerText=si,this._suchtext=``,this.datenzeilen=[],this.zusatzzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this.datenGeliefert=!1,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._beobachter=null,this._taktGemessen=0}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.listenBindung=no}static{this.defaultProps={width:`fill`,source:``,spalten:La(),suche:`ja`,tagField:``,leerText:si}}static{this.customProperties=bo}static{this.raster={startW:14,startH:8,minW:6,minH:4}}messeRumpf(){let e=this.zeilenHoehe;this._taktGemessen=e;let t=xa(this,e);t?.passen===this._mass?.passen&&t?.zeilenHoehe===this._mass?.zeilenHoehe||(this._mass=t,this.requestUpdate())}spaltenListe(){return Va(this.spalten)}get zeilenHoehe(){return Aa(this.spaltenListe())}klickZeile(e){if(e===null||this.hasAttribute(`data-ff-editor`))return;let t=B(this),n=this.rohzeilen[e];t===``||n===void 0||Ot(t,n)}setzeSuchtext(e){this._suchtext=e,this._seite=0,this.requestUpdate()}klickSortiere(e){this.editable||(this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.requestUpdate())}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}beobachte(){this._beobachter||(this._beobachter=Sa(this,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}connectedCallback(){super.connectedCallback(),qa(this),this.beobachte()}firstUpdated(){this.beobachte()}updated(){this._taktGemessen!==this.zeilenHoehe&&this.messeRumpf()}disconnectedCallback(){super.disconnectedCallback(),eo(this),this._beobachter?.disconnect(),this._beobachter=null,Ja(this)}static{this.styles=[M.styles,Vn,ui,To]}render(){let t=this.spaltenListe(),n=e=>e.stopPropagation(),r=yo({spalten:t,imEditor:this.hasAttribute(`data-ff-editor`),source:this.source,datenGeliefert:this.datenGeliefert,datenzeilen:this.datenzeilen,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,wunschSeite:this._seite,gemessen:this._mass});return C`<div class="tabelle" style=${ma({"--takt":`${r.takt}px`,"--zeilen-hoehe":`${r.zeilenHoehe}px`})}>
      ...
      ${``}
      ${r.leer?T:xo({hatQuelle:r.hatQuelle,sichtbar:r.gesamt,gesamt:this.datenzeilen.length,suchtAktiv:this._suchtext.trim()!==``,auswahlAktiv:this.durchAuswahlGefiltert,seite:r.seite,seiten:r.seiten},{blaettere:e=>{this._seite=e,this.requestUpdate()},stop:n})}
    ...
    `]}render(){return C`<div
      class="text"
      style=${ma({fontSize:`${Bo(this.groesse)}px`,fontWeight:Io[Vo(this.gewicht)],textAlign:Lo[Ho(this.ausrichtung)],color:Ro[Uo(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
    ...
    `]}render(){return C`<div class="flaeche ${Ko(this.richtung)}"><div class="linie"></div></div>`}};j([k()],qo.prototype,`richtung`,void 0),M.defineAndRegister(qo),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;W(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();
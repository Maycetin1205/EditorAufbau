...
`,_r=`ff-dialog-rahmen`,vr=`ff-dialog-schliessen`;function yr(e,t){let n=Number(e);return Number.isFinite(n)&&n>0?n:t}var K=class extends Le{constructor(...e){super(...e),this.titel=`Dialog`,this.breite=520,this.hoehe=380,this.viewport=!1,this.mitWerkzeug=!1,this.escapeSchliesst=!1,this.escapeRegistriert=!1,this.aufTaste=e=>{e.key===`Escape`&&(e.stopPropagation(),this.schliesse())}}static{this.styles=o`
  ...
  `}aktualisiereEscape(){let e=this.isConnected&&this.escapeSchliesst;e!==this.escapeRegistriert&&(e?document.addEventListener(`keydown`,this.aufTaste,!0):document.removeEventListener(`keydown`,this.aufTaste,!0),this.escapeRegistriert=e)}schliesse(){this.dispatchEvent(new CustomEvent(vr,{bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this.aktualisiereEscape()}updated(e){e.has(`escapeSchliesst`)&&this.aktualisiereEscape()}disconnectedCallback(){this.escapeRegistriert&&=(document.removeEventListener(`keydown`,this.aufTaste,!0),!1),super.disconnectedCallback()}render(){return w`
    ...
    </div>`}connectedCallback(){super.connectedCallback(),mr(this)}disconnectedCallback(){super.disconnectedCallback(),hr(this)}};A([k()],q.prototype,`fieldType`,void 0),A([k()],q.prototype,`placeholder`,void 0),A([k()],q.prototype,`options`,void 0),A([k()],q.prototype,`source`,void 0),A([k()],q.prototype,`value`,void 0),A([k()],q.prototype,`valueField`,void 0),A([k()],q.prototype,`nachschlagQuelle`,void 0),A([k()],q.prototype,`anzeigeFeld`,void 0),A([k()],q.prototype,`anzeigeTitel`,void 0),A([k()],q.prototype,`speicherFeld`,void 0),A([k()],q.prototype,`speicherTitel`,void 0),A([k()],q.prototype,`einzigerTreffer`,void 0),A([Ve()],q.prototype,`anzeige`,void 0),A([Ve()],q.prototype,`getippt`,void 0),A([Ve()],q.prototype,`angehakt`,void 0),j.defineAndRegister(q);var Rr=`Keine Datensätze.`;function zr(){return{attributeName:`leerText`,name:`Text ohne Datensätze`,description:`Steht in der Maske dort, wo sonst die Zeilen stehen — wenn die Datenquelle keine liefert. Leer lassen: dann steht dort gar nichts.`,kind:`text`,requiresDataSource:!0}}function Br(e,t=!1){return e.trim()===``?E:w`<div class="leer${t?` leer--tafel`:``}">
    ${Mn()}
    <span>${e}</span>
  </div>`}var Vr=o`
  .leer {
...
`;function Hr(e,t,n,r){return{attributeName:e,name:t,description:n,kind:`select`,options:[{value:`nein`,label:`Nein`},{value:`ja`,label:`Ja`}],...r}}var J=class extends j{constructor(...e){super(...e),this.variant=`info`,this.heading=`Neue Spalte`,this.leerHinweis=``,this._count=0}static{this.blockType=`kanban-spalte`}static{this.tagName=`ff-kanban-spalte`}static{this.displayName=`Kanban-Spalte`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[G.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={variant:`info`,heading:`Neue Spalte`,auffang:`nein`}}static{this.customProperties=[kn(`variant`,`Bedeutung der Spalte — bestimmt ihre Farbwelt (Kopf, Fläche, Rahmen).`),Hr(`auffang`,`Auffangspalte`,`Einträge ohne passenden Spaltentitel landen hier. Ohne Auffangspalte landen sie in der ersten Spalte.`,{requiresDataSource:!0,exclusiveAmongSiblings:!0})]}static{this.styles=[j.styles,Vr,o`
    ...
    >+</button>
  </div>`}function Yi(e,t){let n=e.currentTarget;if(!n)return;e.stopPropagation(),e.preventDefault();let r=Array.from(n.childNodes),i=n.textContent??``;n.setAttribute(`contenteditable`,`plaintext-only`),n.focus();let a=window.getSelection(),o=document.createRange();o.selectNodeContents(n),a?.removeAllRanges(),a?.addRange(o);let s=!1,c=e=>{if(s)return;s=!0,n.removeAttribute(`contenteditable`),n.removeEventListener(`blur`,l),n.removeEventListener(`keydown`,u);let a=(n.textContent??``).trim();e&&a&&a!==i.trim()?t(a):n.replaceChildren(...r)},l=()=>c(!0),u=e=>{e.key===`Enter`?(e.preventDefault(),n.blur()):e.key===`Escape`&&(e.preventDefault(),c(!1))};n.addEventListener(`blur`,l),n.addEventListener(`keydown`,u)}function Xi(e,t,n,r){Yi(e,e=>{let i=n();t>=i.length||(i[t]={...i[t],titel:e},r(i))})}var Zi=220,Qi=new WeakMap;function $i(e){let t=Qi.get(e);t!==void 0&&(clearTimeout(t),Qi.delete(e))}function ea(e,t,n,r){t.stopPropagation();let i=t.currentTarget.getBoundingClientRect();$i(e),Qi.set(e,setTimeout(()=>{Qi.delete(e),e.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:n,index:r,top:i.bottom+4,left:i.left},bubbles:!0,composed:!0}))},Zi))}var ta={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:Pi,eintragsWahl:{key:`art`,label:`Darstellung`,optionen:Mi,standard:wi,felderKey:Ni},eintragsZuordnung:{key:`zuordnung`,label:`Status-Zuordnung`,nurBeiWahl:Ti,wertLabel:`Datenwert`,nameLabel:`Klarname`,bedeutungLabel:`Bedeutung`,bedeutungen:On}},na=1,ra=/^-?\d{1,3}(\.\d{3})*(,\d+)?$|^-?\d+(,\d+)?$|^-?\d+(\.\d+)?$/,ia=/^(\d{1,2})\.(\d{1,2})\.(\d{2}|\d{4})$/,aa=/^(\d{4})-(\d{2})-(\d{2})$/;function oa(e){let t=e.trim();if(t===``||!ra.test(t))return null;let n=t.includes(`,`)?t.replace(/\./g,``).replace(`,`,`.`):/^-?\d{1,3}(\.\d{3})+$/.test(t)?t.replace(/\./g,``):t,r=Number(n);return Number.isFinite(r)?r:null}function sa(e){let t=e.trim();if(t===``)return null;let n=aa.exec(t);if(n){let[,e,t,r]=n;return ca(Number(e),Number(t),Number(r))}let r=ia.exec(t);if(r){let[,e,t,n]=r,i=Number(n);return ca(n.length===2?i<=69?2e3+i:1900+i:i,Number(t),Number(e))}return null}function ca(e,t,n){if(t<1||t>12||n<1||n>31)return null;let r=new Date(e,t-1,n);return r.getFullYear()!==e||r.getMonth()!==t-1||r.getDate()!==n?null:r.getTime()}function la(e){let t=0,n=0,r=0;for(let i of e)i.trim()!==``&&(t++,oa(i)!==null&&n++,sa(i)!==null&&r++);return t===0?`text`:r===t?`datum`:n===t?`zahl`:`text`}var ua=new Intl.Collator(`de`,{numeric:!0,sensitivity:`base`});function da(e,t,n){if(t<0||e.length===0)return e.map((e,t)=>t);let r=n=>e[n][t]??``,i=la(e.map(e=>e[t]??``)),a=n?1:-1;return e.map((e,t)=>t).sort((e,t)=>{let n=r(e).trim(),o=r(t).trim();if(n===``&&o===``)return e-t;if(n===``)return na;if(o===``)return-1;let s=i===`zahl`?(oa(n)??0)-(oa(o)??0):i===`datum`?(sa(n)??0)-(sa(o)??0):ua.compare(n,o);return s===0?e-t:s*a})}function fa(e,t){let n=[];return e.forEach((e,r)=>{xr(e,t)&&n.push(r)}),n}function pa(e,t){return!e&&t.trim()!==``}function ma(e,t,n){return e&&t&&n===0}function ha(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}function ga(e){let t=fa(e.datenzeilen,e.suchtext);return e.sortSpalte<0?t:da(t.map(t=>e.datenzeilen[t]),e.sortSpalte,e.sortAuf).map(e=>t[e])}function _a(e){let t={gridTemplateColumns:e.spalten.map(e=>ji(e.art).spur).join(` `)},n=Ai(e.spalten),r=e.gemessen?.zeilenHoehe??n,i=pa(e.imEditor,e.source),a=ma(i,e.datenGeliefert,e.datenzeilen.length),o=ga(e),{seiten:s,seite:c,zeilen:l}=bi({sichtbar:o,hatQuelle:i,proSeite:e.gemessen?.passen??10,wunschSeite:e.wunschSeite,platzhalterZeilen:gi(e.gemessen?.passen??null)});return{cols:t,takt:n,zeilenHoehe:r,hatQuelle:i,leer:a,gesamt:o.length,seiten:s,seite:c,zeilen:l,linealTakte:yi(e.gemessen?.passen??null,l.length)}}var va=[{attributeName:`suche`,name:`Suchzeile`,description:`Zeigt über der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,kind:`segment`,options:[{value:`ja`,label:`Ja`},{value:`nein`,label:`Nein`}],requiresDataSource:!0},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt die Tabelle nur Sätze des Tages, den der Tageswähler zeigt. Leer = alle Sätze.`,kind:`field`},zr()];function ya(e,t){return w`<div class="fusszeile">
    ...
    <div class="seiten-nav">
  ...
  </div>`}var ba=`—`;function xa(e){return e.linealTakte===0?E:w`<div class="lineal" style=${mi(e.linealTakte===null?e.cols:{...e.cols,flex:`0 1 auto`,height:`calc(var(--zeilen-hoehe) * ${e.linealTakte})`})}>
          ${e.spalten.map(()=>w`<div></div>`)}
        </div>`}function Sa(e,t){return w`
      ...
      <div class="kopf" style=${mi(e.cols)}>
        ...
        ${e.zeilen.map(n=>w`<div
          ...
          >
            ${``}
            ${e.spalten.map((t,r)=>{let i=ji(t.art),a=n===null?ba:e.datenzeilen[n]?.[r]??``,o=n===null?{}:e.zusatzzeilen[n]?.[r]??{};return w`<div class=${i.klasse}>${i.zelle(a,t.zuordnung??[],o)}</div>`})}
          </div>`)}
        ${xa(e)}`}
      </div>
    `}var Ca=o`
...
`,Q=class e extends j{constructor(...e){super(...e),this.spalten=Ii(),this.source=``,this.suche=`ja`,this.leerText=Rr,this._suchtext=``,this.datenzeilen=[],this.zusatzzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this.datenGeliefert=!1,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._beobachter=null,this._taktGemessen=0}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.listenBindung=ta}static{this.defaultProps={width:`fill`,source:``,spalten:Ii(),suche:`ja`,tagField:``,leerText:Rr}}static{this.customProperties=va}static{this.raster={startW:14,startH:8,minW:6,minH:4}}messeRumpf(){let e=this.zeilenHoehe;this._taktGemessen=e;let t=xi(this,e);t?.passen===this._mass?.passen&&t?.zeilenHoehe===this._mass?.zeilenHoehe||(this._mass=t,this.requestUpdate())}spaltenListe(){return Bi(this.spalten)}get zeilenHoehe(){return Ai(this.spaltenListe())}klickZeile(e){if(e===null||this.hasAttribute(`data-ff-editor`))return;let t=R(this),n=this.rohzeilen[e];t===``||n===void 0||_t(t,n)}setzeSuchtext(e){this._suchtext=e,this._seite=0,this.requestUpdate()}klickSortiere(e){this.editable||(this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.requestUpdate())}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}beobachte(){this._beobachter||(this._beobachter=Si(this,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}connectedCallback(){super.connectedCallback(),Ki(this),this.beobachte()}firstUpdated(){this.beobachte()}updated(){this._taktGemessen!==this.zeilenHoehe&&this.messeRumpf()}disconnectedCallback(){super.disconnectedCallback(),$i(this),this._beobachter?.disconnect(),this._beobachter=null,qi(this)}static{this.styles=[j.styles,An,Vr,Ca]}render(){let t=this.spaltenListe(),n=e=>e.stopPropagation(),r=_a({spalten:t,imEditor:this.hasAttribute(`data-ff-editor`),source:this.source,datenGeliefert:this.datenGeliefert,datenzeilen:this.datenzeilen,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,wunschSeite:this._seite,gemessen:this._mass});return w`<div class="tabelle" style=${mi({"--takt":`${r.takt}px`,"--zeilen-hoehe":`${r.zeilenHoehe}px`})}>
      ${Ji(()=>this.spaltenListe(),e=>this.aendere(e),n)}
      ${Sa({spalten:t,cols:r.cols,editable:this.editable,zeigeSuche:this.suche===`ja`,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,zeilen:r.zeilen,linealTakte:r.linealTakte,datenzeilen:this.datenzeilen,zusatzzeilen:this.zusatzzeilen,hatQuelle:r.hatQuelle,auswahlIndex:this.auswahlIndex,leer:r.leer,leerText:this.leerText},{setzeSuchtext:e=>this.setzeSuchtext(e),dblklickKopf:(e,t)=>{this.editable&&($i(this),Xi(e,t,()=>this.spaltenListe(),e=>this.aendere(e)))},klickKopf:(t,n)=>{this.editable&&ea(this,t,e.listenBindung.prop,n),this.klickSortiere(n)},klickZeile:e=>this.klickZeile(e),stop:n})}
      ${``}
      ${r.leer?E:ya({hatQuelle:r.hatQuelle,sichtbar:r.gesamt,gesamt:this.datenzeilen.length,suchtAktiv:this._suchtext.trim()!==``,auswahlAktiv:this.durchAuswahlGefiltert,seite:r.seite,seiten:r.seiten},{blaettere:e=>{this._seite=e,this.requestUpdate()},stop:n})}
    </div>`}};A([k({converter:{fromAttribute:e=>e?Vi(e):Ii(),toAttribute:e=>JSON.stringify(e)}})],Q.prototype,`spalten`,void 0),A([k()],Q.prototype,`source`,void 0),A([k()],Q.prototype,`suche`,void 0),A([k()],Q.prototype,`leerText`,void 0),A([k({attribute:!1})],Q.prototype,`datenzeilen`,void 0),A([k({attribute:!1})],Q.prototype,`zusatzzeilen`,void 0),A([k({attribute:!1})],Q.prototype,`rohzeilen`,void 0),A([k({attribute:!1})],Q.prototype,`auswahlIndex`,void 0),A([k({attribute:!1})],Q.prototype,`durchAuswahlGefiltert`,void 0),A([k({attribute:!1})],Q.prototype,`datenGeliefert`,void 0),j.defineAndRegister(Q);var wa=Xn(`text`);function Ta(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(wa)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function Ea(e){let t=ir(e,wa);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function Da(e){Ta(e)&&(e.text=``)}var Oa=Qn({hydriere:Ea,verdrahte:Da}),ka=Oa.connect,Aa=Oa.disconnect,ja=6,Ma=96,Na=14,Pa={duenn:`300`,normal:`400`,fett:`700`},Fa={links:`left`,mitte:`center`,rechts:`right`},Ia={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},La=`standard`;function Ra(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(Ma,Math.max(ja,t)):Na}function za(e){return typeof e==`string`&&e in Pa?e:`normal`}function Ba(e){return typeof e==`string`&&e in Fa?e:`links`}function Va(e){return typeof e==`string`&&e in Ia?e:La}var $=class extends j{constructor(...e){super(...e),this.groesse=Na,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=La,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:Na,gewicht:`normal`,ausrichtung:`links`,farbe:La,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:ja,max:Ma,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[j.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return w`<div
      class="text"
      style=${mi({fontSize:`${Ra(this.groesse)}px`,fontWeight:Pa[za(this.gewicht)],textAlign:Fa[Ba(this.ausrichtung)],color:Ia[Va(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),ka(this)}disconnectedCallback(){super.disconnectedCallback(),Aa(this)}};A([k({type:Number})],$.prototype,`groesse`,void 0),A([k()],$.prototype,`gewicht`,void 0),A([k()],$.prototype,`ausrichtung`,void 0),A([k()],$.prototype,`farbe`,void 0),A([k()],$.prototype,`text`,void 0),A([k()],$.prototype,`source`,void 0),A([k()],$.prototype,`textField`,void 0),j.defineAndRegister($);var Ha=[`waagerecht`,`senkrecht`],Ua=`waagerecht`;function Wa(e){return Ha.includes(e)?e:Ua}var Ga=class extends j{constructor(...e){super(...e),this.richtung=Ua}static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`,richtung:Ua}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1,varianten:[{wenn:{attributeName:`richtung`,equals:`senkrecht`},startW:1,startH:6,breiteZiehbar:!1}]}}static{this.customProperties=[{attributeName:`richtung`,name:`Richtung`,description:`Waagerecht trennt oben von unten, senkrecht links von rechts.`,kind:`select`,options:[{value:`waagerecht`,label:`Waagerecht`},{value:`senkrecht`,label:`Senkrecht`}]}]}static{this.styles=[j.styles,o`
    ...
    `]}render(){return w`<div class="zeile"><slot></slot></div>`}};j.defineAndRegister(Ka),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;V(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();
...
`,sr=`ff-dialog-rahmen`,cr=`ff-dialog-schliessen`;function lr(e,t){let n=Number(e);return Number.isFinite(n)&&n>0?n:t}var q=class extends k{constructor(...e){super(...e),this.titel=`Dialog`,this.breite=520,this.hoehe=380,this.viewport=!1,this.mitWerkzeug=!1,this.escapeSchliesst=!1,this.escapeRegistriert=!1,this.aufTaste=e=>{e.key===`Escape`&&(e.stopPropagation(),this.schliesse())}}static{this.styles=o`
  ...
  `}aktualisiereEscape(){let e=this.isConnected&&this.escapeSchliesst;e!==this.escapeRegistriert&&(e?document.addEventListener(`keydown`,this.aufTaste,!0):document.removeEventListener(`keydown`,this.aufTaste,!0),this.escapeRegistriert=e)}schliesse(){this.dispatchEvent(new CustomEvent(cr,{bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this.aktualisiereEscape()}updated(e){e.has(`escapeSchliesst`)&&this.aktualisiereEscape()}disconnectedCallback(){this.escapeRegistriert&&=(document.removeEventListener(`keydown`,this.aufTaste,!0),!1),super.disconnectedCallback()}render(){return C`
    ...
    `]}render(){return C`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),Vr(this)}disconnectedCallback(){super.disconnectedCallback(),Hr(this)}};M.defineAndRegister(Wr);var Gr={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Kr=e=>(...t)=>({_$litDirective$:e,values:t}),qr=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},Jr=`important`,Yr=` !important`,Xr=Kr(class extends qr{constructor(e){if(super(e),e.type!==Gr.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(Yr);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?Jr:``):n[e]=r}}return T}}),Zr=[10,25,50],Qr=Zr[0];function $r(e,t){return Math.max(1,Math.floor((e-t)/32))}function ei({sichtbar:e,hatQuelle:t,proSeite:n,wunschSeite:r,platzhalterZeilen:i}){let a=t?Math.max(1,Math.ceil(e.length/n)):1,o=Math.min(Math.max(r,0),a-1);return t?{seiten:a,seite:o,zeilen:[...e.slice(o*n,(o+1)*n)]}:{seiten:a,seite:o,zeilen:Array.from({length:i},()=>null)}}var ti=`Spalte {n}`;function ni(e){return ti.replace(`{n}`,String(e+1))}function ri(){return[0,1,2].map(e=>({titel:ni(e),feld:``}))}function ii(e,t){if(e&&typeof e==`object`){let n=e;return{titel:typeof n.titel==`string`?n.titel:ni(t),feld:typeof n.feld==`string`?n.feld:``}}return typeof e==`string`?{titel:e,feld:``}:{titel:ni(t),feld:``}}function ai(e){let t;if(Array.isArray(e))t=e.map((e,t)=>ii(e,t));else if(typeof e==`number`&&Number.isFinite(e)||typeof e==`string`&&/^\d+$/.test(e)){let n=Math.max(1,Math.floor(Number(e)));t=[...Array(n).keys()].map(e=>({titel:ni(e),feld:``}))}else t=ri();return t.length>8&&(t=t.slice(0,8)),t.length<1&&(t=[{titel:ni(0),feld:``}]),t}function oi(e){try{return ai(JSON.parse(e))}catch{return ri()}}function si(e){return oi(e.getAttribute(`spalten`)??``).map(e=>e.feld)}function ci(e){let t=e.getAttribute(`source`)??``;if(t===``){e.datenzeilen=[];return}let n=P(U().FF_DATA_SOURCES,t);if(!n){e.datenzeilen=[];return}let r=si(e),{rows:i,gefiltert:a}=xt(e,Er(L(U().SEDATA,n.name,n.tableId),e.getAttribute(`tagfield`)??``,In())),o=ht(z(e),i,e=>e)[0]??-1,s=qn(e);e.rohzeilen=i,e.auswahlIndex=o,e.durchAuswahlGefiltert=a,e.datenzeilen=i.map(e=>r.map(t=>t===``?``:s(e,t)))}var li=Hn({hydriere:ci}),ui=li.connect,di=li.disconnect,fi=1,pi=/^-?\d{1,3}(\.\d{3})*(,\d+)?$|^-?\d+(,\d+)?$|^-?\d+(\.\d+)?$/,mi=/^(\d{1,2})\.(\d{1,2})\.(\d{2}|\d{4})$/,hi=/^(\d{4})-(\d{2})-(\d{2})$/;function gi(e){let t=e.trim();if(t===``||!pi.test(t))return null;let n=t.includes(`,`)?t.replace(/\./g,``).replace(`,`,`.`):/^-?\d{1,3}(\.\d{3})+$/.test(t)?t.replace(/\./g,``):t,r=Number(n);return Number.isFinite(r)?r:null}function _i(e){let t=e.trim();if(t===``)return null;let n=hi.exec(t);if(n){let[,e,t,r]=n;return vi(Number(e),Number(t),Number(r))}let r=mi.exec(t);if(r){let[,e,t,n]=r,i=Number(n);return vi(n.length===2?i<=69?2e3+i:1900+i:i,Number(t),Number(e))}return null}function vi(e,t,n){if(t<1||t>12||n<1||n>31)return null;let r=new Date(e,t-1,n);return r.getFullYear()!==e||r.getMonth()!==t-1||r.getDate()!==n?null:r.getTime()}function yi(e){let t=0,n=0,r=0;for(let i of e)i.trim()!==``&&(t++,gi(i)!==null&&n++,_i(i)!==null&&r++);return t===0?`text`:r===t?`datum`:n===t?`zahl`:`text`}var bi=new Intl.Collator(`de`,{numeric:!0,sensitivity:`base`});function xi(e,t,n){if(t<0||e.length===0)return e.map((e,t)=>t);let r=n=>e[n][t]??``,i=yi(e.map(e=>e[t]??``)),a=n?1:-1;return e.map((e,t)=>t).sort((e,t)=>{let n=r(e).trim(),o=r(t).trim();if(n===``&&o===``)return e-t;if(n===``)return fi;if(o===``)return-1;let s=i===`zahl`?(gi(n)??0)-(gi(o)??0):i===`datum`?(_i(n)??0)-(_i(o)??0):bi.compare(n,o);return s===0?e-t:s*a})}function Si(e,t,n){return C`<div class="steuerung">
    <button
    ...
    <button
      ...
      @pointerdown=${n}
      @click=${r=>{n(r);let i=e();i.length<8&&(i.push({titel:ni(i.length),feld:``}),t(i))}}
    >+</button>
  </div>`}function Ci(e,t){let n=e.currentTarget;if(!n)return;e.stopPropagation(),e.preventDefault();let r=Array.from(n.childNodes),i=n.textContent??``;n.setAttribute(`contenteditable`,`plaintext-only`),n.focus();let a=window.getSelection(),o=document.createRange();o.selectNodeContents(n),a?.removeAllRanges(),a?.addRange(o);let s=!1,c=e=>{if(s)return;s=!0,n.removeAttribute(`contenteditable`),n.removeEventListener(`blur`,l),n.removeEventListener(`keydown`,u);let a=(n.textContent??``).trim();e&&a&&a!==i.trim()?t(a):n.replaceChildren(...r)},l=()=>c(!0),u=e=>{e.key===`Enter`?(e.preventDefault(),n.blur()):e.key===`Escape`&&(e.preventDefault(),c(!1))};n.addEventListener(`blur`,l),n.addEventListener(`keydown`,u)}function wi(e,t){let n=[];return e.forEach((e,r)=>{dr(e,t)&&n.push(r)}),n}function Ti(e,t){return!e&&t.trim()!==``}function Ei(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}function Di(e,t){return C`<div class="fusszeile">
    <div class="seiten-info">${Ei({hatQuelle:e.hatQuelle,sichtbar:e.sichtbar,gesamt:e.gesamt,suchtAktiv:e.suchtAktiv,auswahlAktiv:e.auswahlAktiv})}</div>
    <div class="seiten-nav">
      <select
        aria-label="Zeilen pro Seite"
        @pointerdown=${t.stop}
        @change=${e=>{let n=Number(e.target.value);t.waehleProSeite(n===0?null:n)}}
      >
        ...
        <option value=${0} ?selected=${e.proSeiteWahl===null}>passend zur Höhe</option>
        ${Zr.map(t=>C`<option value=${t} ?selected=${e.proSeiteWahl===t}>${t} pro Seite</option>`)}
      </select>
      <button
...
`,ki=4,Ai=220,Q=class e extends M{constructor(...e){super(...e),this.spalten=ri(),this.source=``,this.suche=`ja`,this._suchtext=``,this.datenzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._proSeiteWahl=null,this._proSeiteGemessen=null,this._beobachter=null,this._klickTimer=null}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.listenBindung={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:ti}}static{this.defaultProps={width:`fill`,source:``,spalten:ri(),suche:`ja`,tagField:``}}static{this.customProperties=[{attributeName:`suche`,name:`Suchzeile`,description:`Zeigt ueber der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,kind:`segment`,options:[{value:`ja`,label:`Ja`},{value:`nein`,label:`Nein`}],requiresDataSource:!0},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt die Tabelle nur Saetze des Tages, den der Tageswaehler zeigt. Leer = alle Saetze.`,kind:`field`}]}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get proSeiteAktuell(){return this._proSeiteWahl??this._proSeiteGemessen??Qr}messeRumpf(){if(!this.hasAttribute(`fuellt`)){if(this._proSeiteGemessen===null)return;this._proSeiteGemessen=null,this.requestUpdate();return}let e=this.renderRoot.querySelector(`.koerper`),t=this.renderRoot.querySelector(`.kopf`);if(!(e instanceof HTMLElement)||!(t instanceof HTMLElement))return;let n=$r(e.clientHeight,t.offsetHeight);n!==this._proSeiteGemessen&&(this._proSeiteGemessen=n,this.requestUpdate())}spaltenListe(){return ai(this.spalten)}sichtbareIndizes(){let e=wi(this.datenzeilen,this._suchtext);return this._sortSpalte<0?e:xi(e.map(e=>this.datenzeilen[e]),this._sortSpalte,this._sortAuf).map(t=>e[t])}klickZeile(e){if(e===null||this.hasAttribute(`data-ff-editor`))return;let t=z(this),n=this.rohzeilen[e];t===``||n===void 0||gt(t,n)}setzeSuchtext(e){this._suchtext=e,this._seite=0,this.requestUpdate()}klickSortiere(e){this.editable||(this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.requestUpdate())}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}klickSpaltenkopf(t,n){if(!this.editable)return;t.stopPropagation();let r=t.currentTarget.getBoundingClientRect();this.klickTimerAus(),this._klickTimer=setTimeout(()=>{this._klickTimer=null,this.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:e.listenBindung.prop,index:n,top:r.bottom+4,left:r.left},bubbles:!0,composed:!0}))},Ai)}klickTimerAus(){this._klickTimer!==null&&(clearTimeout(this._klickTimer),this._klickTimer=null)}bearbeiteTitel(e,t){this.editable&&Ci(e,e=>{let n=this.spaltenListe();t>=n.length||(n[t]={...n[t],titel:e},this.aendere(n))})}beobachteRumpf(){if(this._beobachter||typeof ResizeObserver>`u`)return;let e=this.renderRoot.querySelector(`.koerper`);e&&(this._beobachter=new ResizeObserver(()=>this.messeRumpf()),this._beobachter.observe(e),this.messeRumpf())}connectedCallback(){super.connectedCallback(),ui(this),this.beobachteRumpf()}firstUpdated(){this.beobachteRumpf()}disconnectedCallback(){super.disconnectedCallback(),this.klickTimerAus(),this._beobachter?.disconnect(),this._beobachter=null,di(this)}static{this.styles=[M.styles,Oi]}render(){let e=this.spaltenListe(),t={gridTemplateColumns:`repeat(${e.length}, minmax(0, 1fr))`},n=e=>e.stopPropagation(),r=this.sichtbareIndizes(),i=Ti(this.hasAttribute(`data-ff-editor`),this.source),a=r.length,o=this.proSeiteAktuell,{seiten:s,seite:c,zeilen:l}=ei({sichtbar:r,hatQuelle:i,proSeite:o,wunschSeite:this._seite,platzhalterZeilen:ki});return C`<div class="tabelle" style=${Xr({"--spalten-zahl":String(e.length),"--zeilen-hoehe":`32px`})}>
      ${Si(()=>this.spaltenListe(),e=>this.aendere(e),n)}
      ...
      ${Di({hatQuelle:i,sichtbar:a,gesamt:this.datenzeilen.length,suchtAktiv:this._suchtext.trim()!==``,auswahlAktiv:this.durchAuswahlGefiltert,proSeiteWahl:this._proSeiteWahl,seite:c,seiten:s},{waehleProSeite:e=>{this._proSeiteWahl=e,this._seite=0,this.requestUpdate()},blaettere:e=>{this._seite=e,this.requestUpdate()},stop:n})}
    </div>`}};j([A({converter:{fromAttribute:e=>e?oi(e):ri(),toAttribute:e=>JSON.stringify(e)}})],Q.prototype,`spalten`,void 0),j([A()],Q.prototype,`source`,void 0),j([A()],Q.prototype,`suche`,void 0),j([A({attribute:!1})],Q.prototype,`datenzeilen`,void 0),j([A({attribute:!1})],Q.prototype,`rohzeilen`,void 0),j([A({attribute:!1})],Q.prototype,`auswahlIndex`,void 0),j([A({attribute:!1})],Q.prototype,`durchAuswahlGefiltert`,void 0),M.defineAndRegister(Q);var ji=Bn(`text`);function Mi(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(ji)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function Ni(e){let t=Jn(e,ji);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function Pi(e){Mi(e)&&(e.text=``)}var Fi=Hn({hydriere:Ni,verdrahte:Pi}),Ii=Fi.connect,Li=Fi.disconnect,Ri=6,zi=96,Bi=14,Vi={duenn:`300`,normal:`400`,fett:`700`},Hi={links:`left`,mitte:`center`,rechts:`right`},Ui={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},Wi=`standard`;function Gi(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(zi,Math.max(Ri,t)):Bi}function Ki(e){return typeof e==`string`&&e in Vi?e:`normal`}function qi(e){return typeof e==`string`&&e in Hi?e:`links`}function Ji(e){return typeof e==`string`&&e in Ui?e:Wi}var $=class extends M{constructor(...e){super(...e),this.groesse=Bi,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=Wi,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:Bi,gewicht:`normal`,ausrichtung:`links`,farbe:Wi,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:Ri,max:zi,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[M.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return C`<div
      class="text"
      style=${Xr({fontSize:`${Gi(this.groesse)}px`,fontWeight:Vi[Ki(this.gewicht)],textAlign:Hi[qi(this.ausrichtung)],color:Ui[Ji(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),Ii(this)}disconnectedCallback(){super.disconnectedCallback(),Li(this)}};j([A({type:Number})],$.prototype,`groesse`,void 0),j([A()],$.prototype,`gewicht`,void 0),j([A()],$.prototype,`ausrichtung`,void 0),j([A()],$.prototype,`farbe`,void 0),j([A()],$.prototype,`text`,void 0),j([A()],$.prototype,`source`,void 0),j([A()],$.prototype,`textField`,void 0),M.defineAndRegister($);var Yi=class extends M{static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1}}static{this.customProperties=[]}static{this.styles=[M.styles,o`
    ...
    `]}render(){return C`<div class="zeile"><slot></slot></div>`}};M.defineAndRegister(Xi),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;H(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();
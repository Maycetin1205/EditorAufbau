...
\f\r]`,xe=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Se=/-->/g,Ce=/>/g,_=RegExp(`>|${be}(?:([^\\s"'>=/]+)(${be}*=${be}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,`g`),we=/'/g,Te=/"/g,Ee=/^(?:script|style|textarea|title)$/i,De=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),v=De(1),Oe=De(2),y=Symbol.for(`lit-noChange`),b=Symbol.for(`lit-nothing`),ke=new WeakMap,x=h.createTreeWalker(h,129);function Ae(e,t){if(!ve(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return pe===void 0?t:pe.createHTML(t)}var je=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:t===3?`<math>`:``,o=xe;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===xe?c[1]===`!--`?o=Se:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=_):(Ee.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=_):o=Ce:o===_?c[0]===`>`?(o=i??xe,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?_:c[3]===`"`?Te:we):o===Te||o===we?o=_:o===Se||o===Ce?o=xe:(o=_,i=void 0);let d=o===_&&e[t+1].startsWith(`/>`)?` `:``;a+=o===xe?n+ge:l>=0?(r.push(s),n.slice(0,l)+me+n.slice(l)+m+d):n+m+(l===-2?t:d)}return[Ae(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:t===3?`</math>`:``)),r]},Me=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=je(t,n);if(this.el=e.createElement(l,r),x.currentNode=this.el.content,n===2||n===3){let e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;(i=x.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes())for(let e of i.getAttributeNames())if(e.endsWith(me)){let t=u[o++],n=i.getAttribute(e).split(m),r=/([.?@])?(.*)/.exec(t);c.push({type:1,index:a,name:r[2],strings:n,ctor:r[1]===`.`?Ie:r[1]===`?`?Le:r[1]===`@`?Re:Fe}),i.removeAttribute(e)}else e.startsWith(m)&&(c.push({type:6,index:a}),i.removeAttribute(e));if(Ee.test(i.tagName)){let e=i.textContent.split(m),t=e.length-1;if(t>0){i.textContent=fe?fe.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],g()),x.nextNode(),c.push({type:2,index:++a});i.append(e[t],g())}}}else if(i.nodeType===8)if(i.data===he)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(m,e+1))!==-1;)c.push({type:7,index:a}),e+=m.length-1}a++}}static createElement(e,t){let n=h.createElement(`template`);return n.innerHTML=e,n}};function S(e,t,n=e,r){if(t===y)return t;let i=r===void 0?n._$Cl:n._$Co?.[r],a=_e(t)?void 0:t._$litDirective$;return i?.constructor!==a&&(i?._$AO?.(!1),a===void 0?i=void 0:(i=new a(e),i._$AT(e,n,r)),r===void 0?n._$Cl=i:(n._$Co??=[])[r]=i),i!==void 0&&(t=S(e,i._$AS(e,t.values),i,r)),t}var Ne=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??h).importNode(t,!0);x.currentNode=r;let i=x.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new Pe(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new ze(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=x.nextNode(),a++)}return x.currentNode=h,r}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},Pe=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,r){this.type=2,this._$AH=b,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=S(this,e,t),_e(e)?e===b||e==null||e===``?(this._$AH!==b&&this._$AR(),this._$AH=b):e!==this._$AH&&e!==y&&this._(e):e._$litType$===void 0?e.nodeType===void 0?ye(e)?this.k(e):this._(e):this.T(e):this.$(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==b&&_e(this._$AH)?this._$AA.nextSibling.data=e:this.T(h.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=Me.createElement(Ae(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.p(t);else{let e=new Ne(r,this),n=e.u(this.options);e.p(t),this.T(n),this._$AH=e}}_$AC(e){let t=ke.get(e.strings);return t===void 0&&ke.set(e.strings,t=new Me(e)),t}k(t){ve(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.O(g()),this.O(g()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let t=de(e).nextSibling;de(e).remove(),e=t}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},Fe=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,r,i){this.type=1,this._$AH=b,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=b}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=S(this,e,t,0),a=!_e(e)||e!==this._$AH&&e!==y,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=S(this,r[n+o],t,o),s===y&&(s=this._$AH[o]),a||=!_e(s)||s!==this._$AH[o],s===b?e=b:e!==b&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===b?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},Ie=class extends Fe{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===b?void 0:e}},Le=class extends Fe{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==b)}},Re=class extends Fe{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=S(this,e,t,0)??b)===y)return;let n=this._$AH,r=e===b&&n!==b||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==b&&(n===b||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},ze=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){S(this,e)}},Be=ue.litHtmlPolyfillSupport;Be?.(Me,Pe),(ue.litHtmlVersions??=[]).push(`3.3.3`);var Ve=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new Pe(t.insertBefore(g(),e),e,void 0,n??{})}return i._$AI(e),i},He=globalThis,C=class extends p{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Ve(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return y}};C._$litElement$=!0,C.finalized=!0,He.litElementHydrateSupport?.({LitElement:C});var Ue=He.litElementPolyfillSupport;Ue?.({LitElement:C}),(He.litElementVersions??=[]).push(`4.2.2`);var We={attribute:!0,type:String,converter:se,reflect:!1,hasChanged:ce},Ge=(e=We,t,n)=>{let{kind:r,metadata:i}=n,a=globalThis.litPropertyMetadata.get(i);if(a===void 0&&globalThis.litPropertyMetadata.set(i,a=new Map),r===`setter`&&((e=Object.create(e)).wrapped=!0),a.set(n.name,e),r===`accessor`){let{name:r}=n;return{set(n){let i=t.get.call(this);t.set.call(this,n),this.requestUpdate(r,i,e,!0,n)},init(t){return t!==void 0&&this.C(r,void 0,e,t),t}}}if(r===`setter`){let{name:r}=n;return function(n){let i=this[r];t.call(this,n),this.requestUpdate(r,i,e,!0,n)}}throw Error(`Unsupported decorator location: `+r)};function w(e){return(t,n)=>typeof n==`object`?Ge(e,t,n):((e,t,n)=>{let r=t.hasOwnProperty(n);return t.constructor.createProperty(n,e),r?Object.getOwnPropertyDescriptor(t,n):void 0})(e,t,n)}function T(e){return w({...e,state:!0,attribute:!1})}var Ke=new Map;function qe(e){Ke.has(e.type)&&console.warn(`Block-Typ "${e.type}" wird ueberschrieben.`),Ke.set(e.type,e)}function Je(){return Array.from(Ke.values())}var Ye={width:`auto`};function Xe(e){return Object.entries(e).map(([e,t])=>`${e.replace(/[A-Z]/g,e=>`-`+e.toLowerCase())}:${t}`).join(`;`)}var Ze={spalten:24,spaltePx:40,zeilePx:12,gapPx:8},Qe={rasterX:0,rasterY:0,rasterW:Ze.spalten,rasterH:1};function $e(){return{display:`grid`,gridTemplateColumns:`repeat(${Ze.spalten}, 1fr)`,gridAutoRows:`${Ze.zeilePx}px`,gap:`${Ze.gapPx}px`,alignContent:`start`}}function et(){return Xe($e())}var tt=`weitereQuellen`,nt={[tt]:[]},rt=`folgtAuswahl`,it={[rt]:[]};function E(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var D=class extends C{constructor(...e){super(...e),this.editable=!1}static{this.styles=o`
    :host { display: block; }
  ...
  `}aktualisiereEscape(){let e=this.isConnected&&this.escapeSchliesst;e!==this.escapeRegistriert&&(e?document.addEventListener(`keydown`,this.aufTaste,!0):document.removeEventListener(`keydown`,this.aufTaste,!0),this.escapeRegistriert=e)}schliesse(){this.dispatchEvent(new CustomEvent(Ht,{bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this.aktualisiereEscape()}updated(e){e.has(`escapeSchliesst`)&&this.aktualisiereEscape()}disconnectedCallback(){this.escapeRegistriert&&=(document.removeEventListener(`keydown`,this.aufTaste,!0),!1),super.disconnectedCallback()}render(){let e=Ut(this.breite,520),t=Ut(this.hoehe,380);return v`
    ...
    `}};E([w()],I.prototype,`titel`,void 0),E([w({type:Number})],I.prototype,`breite`,void 0),E([w({type:Number})],I.prototype,`hoehe`,void 0),E([w({type:Boolean,reflect:!0})],I.prototype,`viewport`,void 0),E([w({type:Boolean,attribute:`escape-schliesst`})],I.prototype,`escapeSchliesst`,void 0),E([w({type:Boolean,attribute:`ohne-modal`})],I.prototype,`ohneModal`,void 0),E([w({type:Boolean,reflect:!0,attribute:`inhalt-fest`})],I.prototype,`inhaltFest`,void 0),customElements.get(`ff-dialog-rahmen`)||customElements.define(Vt,I);var Wt=`input,select,textarea,button,a[href],[tabindex]:not([tabindex="-1"])`;function Gt(e){for(let t of Array.from(e.querySelectorAll(`*`))){if(t instanceof HTMLElement&&t.matches(Wt)&&!t.hasAttribute(`disabled`))return t;let e=t.shadowRoot?Gt(t.shadowRoot):null;if(e)return e}return null}var L=class extends D{constructor(...e){super(...e),this.name=`Popup`,this.breite=520,this.hoehe=380,this.offen=!1}static{this.blockType=`popup`}static{this.tagName=`ff-popup`}static{this.displayName=`Popup`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.showInPalette=!1}static{this.allowedParentTypes=[at]}static{this.pageBlock=!0}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.defaultProps={name:`Popup`,breite:520,hoehe:380}}static{this.styles=[D.styles,o`
    ...
    `]}onClose(){this.hasAttribute(`data-ff-editor`)||this.removeAttribute(`offen`)}updated(e){super.updated(e),!(!e.has(`offen`)||!this.offen)&&(this.hasAttribute(`data-ff-editor`)||this.updateComplete.then(()=>{!this.offen||!this.isConnected||(Gt(this)??(this.shadowRoot?Gt(this.shadowRoot):null))?.focus()}))}render(){return v`<ff-dialog-rahmen
        .breite=${this.breite}
        .hoehe=${this.hoehe}
        ohne-modal
        inhalt-fest
...
`,Kr=[`text`,`number`,`textarea`,`select`,`date`,`time`,`checkbox`,`nachschlagen`];function qr(e){return Kr.includes(e)?e:`text`}var Jr=[`text`,`number`,`textarea`,`select`,`nachschlagen`,`date`,`time`],Yr={select:`ph-select`,date:`ph-nativ`,time:`ph-nativ`},Xr=4;function Zr(e){return e??Xr}function Qr(e,t,n){return Math.max(1,Math.floor((e-t)/n))}function $r(e,t,n){let r=Qr(e,t,n),i=e-t;return i<n?{passen:r,zeilenHoehe:n}:{passen:r,zeilenHoehe:Math.floor(i/r*100)/100}}function ei(e,t){return e===null?null:Math.max(0,e-t)}function ti({sichtbar:e,hatQuelle:t,proSeite:n,wunschSeite:r,platzhalterZeilen:i}){let a=t?Math.max(1,Math.ceil(e.length/n)):1,o=Math.min(Math.max(r,0),a-1);return t?{seiten:a,seite:o,zeilen:[...e.slice(o*n,(o+1)*n)]}:{seiten:a,seite:o,zeilen:Array.from({length:i},()=>null)}}function ni(e,t){let n=t.trim().toLowerCase();return e.find(e=>e.wert.trim().toLowerCase()===n)}var W=`text`,ri=`status`,ii=`bild`,ai=`bild`,oi=`unter`,si=[{wert:W,name:`Text`,spur:`minmax(0, 1fr)`,klasse:``,zelle:e=>e},{wert:`zahl`,name:`Zahl`,spur:`90px`,klasse:`zahl`,zelle:e=>e},{wert:`datum`,name:`Datum`,spur:`100px`,klasse:`zahl`,zelle:e=>e},{wert:ri,name:`Status`,spur:`120px`,klasse:`status`,zelle:(e,t)=>{let n=ni(t,e);return n?v`<span class="chip v-${Hn(n.bedeutung)}">${n.name.trim()===``?e:n.name}</span>`:v`<span class="chip">${e}</span>`}},{wert:ii,name:`Bild + Name`,spur:`minmax(0, 1fr)`,klasse:`bild`,zusatzFelder:[{key:ai,label:`Bild`},{key:oi,label:`Unterzeile`}],hoehe:e=>(e[ai]??``)!==``||(e[oi]??``)!==``?44:32,zelle:(e,t,n)=>{let r=Zn(n[ai]??``),i=n[oi]??``;return v`<div class="bild-name">
        ${r===void 0?b:v`<span class="bild-zeichen">${r}</span>`}
        <div class="bild-text">
          <div class="bild-titel">${e}</div>
          ${i===``?b:v`<div class="bild-unter">${i}</div>`}
        </div>
      </div>`}}];function ci(e){return e.reduce((e,t)=>{let n=li(t.art);return Math.max(e,n.hoehe?.(t.felder??{})??32)},32)}function li(e){return si.find(t=>t.wert===e)??si[0]}var ui=si.map(e=>({wert:e.wert,name:e.name,...e.zusatzFelder?{felder:e.zusatzFelder}:{}})),di=`felder`,fi=`Spalte {n}`;function pi(e){return fi.replace(`{n}`,String(e+1))}function G(e){return{titel:pi(e),feld:``,art:W}}function mi(){return[0,1,2].map(e=>G(e))}function hi(e){return Array.isArray(e)?e.filter(e=>!!e&&typeof e==`object`).map(e=>({wert:typeof e.wert==`string`?e.wert:``,name:typeof e.name==`string`?e.name:``,bedeutung:typeof e.bedeutung==`string`?e.bedeutung:``})).filter(e=>e.wert.trim()!==``):[]}function gi(e){if(!e||typeof e!=`object`||Array.isArray(e))return{};let t={};for(let[n,r]of Object.entries(e))typeof r==`string`&&r!==``&&(t[n]=r);return t}function _i(e,t){if(e&&typeof e==`object`){let n=e,r=hi(n.zuordnung),i=gi(n.felder);return{titel:typeof n.titel==`string`?n.titel:pi(t),feld:typeof n.feld==`string`?n.feld:``,art:typeof n.art==`string`?n.art:W,...r.length>0?{zuordnung:r}:{},...Object.keys(i).length>0?{felder:i}:{}}}return typeof e==`string`?{...G(t),titel:e}:G(t)}function vi(e){let t;if(Array.isArray(e))t=e.map((e,t)=>_i(e,t));else if(typeof e==`number`&&Number.isFinite(e)||typeof e==`string`&&/^\d+$/.test(e)){let n=Math.max(1,Math.floor(Number(e)));t=[...Array(n).keys()].map(e=>G(e))}else t=mi();return t.length>8&&(t=t.slice(0,8)),t.length<1&&(t=[G(0)]),t}function yi(e){try{return vi(JSON.parse(e))}catch{return mi()}}var bi={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},xi=e=>(...t)=>({_$litDirective$:e,values:t}),Si=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},Ci=`important`,wi=` !important`,Ti=xi(class extends Si{constructor(e){if(super(e),e.type!==bi.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(wi);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?Ci:``):n[e]=r}}return y}}),Ei=`Keine Datensätze.`;function Di(){return{attributeName:`leerText`,name:`Text ohne Datensätze`,description:`Steht in der Maske dort, wo sonst die Zeilen stehen — wenn die Datenquelle keine liefert. Leer lassen: dann steht dort gar nichts.`,kind:`text`,requiresDataSource:!0}}function Oi(e,t=!1){return e.trim()===``?b:v`<div class="leer${t?` leer--tafel`:``}">
    ${qn()}
    <span>${e}</span>
  </div>`}var ki=o`
  .leer {
...
`;function Ai(e,t){if(!e.hasAttribute(`fuellt`))return null;let n=e.renderRoot.querySelector(`.koerper`),r=e.renderRoot.querySelector(`.kopf`);return!(n instanceof HTMLElement)||!(r instanceof HTMLElement)?null:$r(n.clientHeight,r.offsetHeight,t)}function ji(e,t){if(typeof ResizeObserver>`u`)return null;let n=e.renderRoot.querySelector(`.koerper`);if(!n)return null;let r=new ResizeObserver(t);return r.observe(n),r}function Mi(e){return{rohzeilen:e.map(e=>e.rohzeile),datenzeilen:e.map(e=>[...e.zellen]),zusatzzeilen:e.map(e=>(e.zusatz??[]).map(e=>({...e})))}}function Ni(e,t,n){return t===``||n===``?[...e]:e.filter(e=>er(j(e,t))===n)}function Pi(e){return yi(e.getAttribute(`spalten`)??``)}function Fi(e,t,n){let r={};for(let i of li(e.art).zusatzFelder??[]){let a=e.felder?.[i.key]??``;a!==``&&(r[i.key]=n(t,a))}return r}function Ii(e){let t=()=>{e.datenzeilen=[],e.zusatzzeilen=[]},n=e.getAttribute(`source`)??``;if(n===``){t();return}let r=A(V().FF_DATA_SOURCES,n);if(!r){t();return}let i=Pi(e),{rows:a,gefiltert:o}=zt(e,Ni(N(V().SEDATA,r.name,r.tableId),e.getAttribute(`tagfield`)??``,ar())),s=Nt(F(e),a,e=>e)[0]??-1,c=Mr(e);e.datenGeliefert=!0,e.rohzeilen=a,e.auswahlIndex=s,e.durchAuswahlGefiltert=o,e.datenzeilen=a.map(e=>i.map(t=>t.feld===``?``:c(e,t.feld))),e.zusatzzeilen=a.map(e=>i.map(t=>Fi(t,e,c)))}var Li=Dr({hydriere:Ii}),Ri=Li.connect,zi=Li.disconnect;function Bi(e){return e.trim().toLowerCase().split(/\s+/).filter(e=>e!==``)}function Vi(e,t){let n=Bi(t);if(n.length===0)return!0;let r=e.join(` `).toLowerCase();return n.every(e=>r.includes(e))}function Hi(e,t){let n=[];return e.forEach((e,r)=>{Vi(e,t)&&n.push(r)}),n}function Ui(e,t){return!e&&t.trim()!==``}function Wi(e,t,n){return e&&t&&n===0}function Gi(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}function Ki(e,t,n){return v`<div class="steuerung">
    <button
    ...
    <div class="seiten-nav">
  ...
  </div>`}var ma=`—`;function ha(e){return e.linealTakte===0?b:v`<div class="lineal" role="presentation" style=${Ti(e.linealTakte===null?e.cols:{...e.cols,flex:`0 1 auto`,height:`calc(var(--zeilen-hoehe) * ${e.linealTakte})`})}>
          ${e.spalten.map(()=>v`<div></div>`)}
        </div>`}function ga(e,t){return v`
      ...
      <div class="kopf" role="row" style=${Ti(e.cols)}>
        ${e.spalten.map((n,r)=>v`<div
            class=${li(n.art).klasse}
            role="columnheader"
            data-ff-editable
        ...
        ${e.zeilen.map((n,r)=>{let i=n!==null&&!e.imEditor;return v`<div
          ...
          >
            ${``}
            ${e.spalten.map((t,r)=>{let i=li(t.art),a=n===null?ma:e.datenzeilen[n]?.[r]??``,o=n===null?{}:e.zusatzzeilen[n]?.[r]??{};return v`<div class=${i.klasse} role="cell">${i.zelle(a,t.zuordnung??[],o)}</div>`})}
          </div>`})}
        ${ha(e)}`}
      </div>
    `}var _a=o`
...
`,va=`ff-zeile-aktiviert`,ya=`data-ff-roh`;function ba(e,t){e.dispatchEvent(new CustomEvent(va,{detail:t,bubbles:!0,composed:!0}))}function xa(e){let t=e?.activeElement;if(!(t instanceof HTMLElement))return;let n=t.closest(`.zeile`);if(!n)return;let r=n.getAttribute(ya);return r===null||r===``?null:Number(r)}function Sa(e,t){e&&((t===null?null:e.querySelector(`.zeile[data-ff-roh="${t}"]`))??e.querySelector(`.zeile[data-ff-roh]`)??e.querySelector(`.koerper`))?.focus()}var K=class e extends D{constructor(...e){super(...e),this.spalten=mi(),this.source=``,this.suche=`ja`,this.leerText=Ei,this._suchtext=``,this.datenzeilen=[],this.zusatzzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this.datenGeliefert=!1,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._beobachter=null,this._taktGemessen=0,this._fokusZeile=null,this._fokusHolen=!1,this._besitz=`softengine`}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.listenBindung=$i}static{this.defaultProps={width:`fill`,source:``,spalten:mi(),suche:`ja`,tagField:``,leerText:Ei}}static{this.customProperties=fa}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get besitz(){return this._besitz}set besitz(e){e!==this._besitz&&(this._besitz=e,this.setzeAbgeleitetesZurueck(),this.isConnected&&(e===`provided`?zi(this):Ri(this)),this.requestUpdate())}set bereitgestellteZeilen(e){let t=Mi(e);this.rohzeilen=t.rohzeilen,this.datenzeilen=t.datenzeilen,this.zusatzzeilen=t.zusatzzeilen,this.datenGeliefert=!0,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._seite=0,this._mass=null,this._taktGemessen=0,this.requestUpdate()}setzeAbgeleitetesZurueck(){this.rohzeilen=[],this.datenzeilen=[],this.zusatzzeilen=[],this.datenGeliefert=!1,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._suchtext=``,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._taktGemessen=0,this._fokusZeile=null,this._fokusHolen=!1}fokussiereSuche(){let e=this.shadowRoot?.querySelector(`.suchzeile input`);return e?(e.focus(),!0):!1}get hatQuelle(){return this._besitz===`provided`||Ui(this.hasAttribute(`data-ff-editor`),this.source)}merkeZeilenFokus(){let e=xa(this.shadowRoot);this._fokusHolen=e!==void 0,this._fokusZeile=e??null}messeRumpf(){let e=this.zeilenHoehe;this._taktGemessen=e;let t=Ai(this,e);t?.passen===this._mass?.passen&&t?.zeilenHoehe===this._mass?.zeilenHoehe||(this._mass=t,this.requestUpdate())}spaltenListe(){return vi(this.spalten)}get zeilenHoehe(){return ci(this.spaltenListe())}aktiviereZeile(e,t){if(e===null||this.hasAttribute(`data-ff-editor`))return;let n=this.rohzeilen[e];n!==void 0&&(ba(this,{rohzeile:n,rohIndex:e,ansichtIndex:t}),this.toggleAuswahl(n))}toggleAuswahl(e){let t=F(this);t!==``&&Pt(t,e)}setzeSuchtext(e){this.merkeZeilenFokus(),this._suchtext=e,this._seite=0,this.requestUpdate()}klickSortiere(e){this.editable||(this.merkeZeilenFokus(),this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.requestUpdate())}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}beobachte(){this._beobachter||(this._beobachter=ji(this,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}connectedCallback(){super.connectedCallback(),this._besitz===`softengine`&&Ri(this),this.beobachte()}firstUpdated(){this.beobachte()}updated(){this._taktGemessen!==this.zeilenHoehe&&this.messeRumpf(),this._fokusHolen&&(this._fokusHolen=!1,Sa(this.shadowRoot,this._fokusZeile))}disconnectedCallback(){super.disconnectedCallback(),Zi(this),this._beobachter?.disconnect(),this._beobachter=null,zi(this)}static{this.styles=[D.styles,Gn,ki,_a]}render(){let t=this.spaltenListe(),n=e=>e.stopPropagation(),r=da({spalten:t,hatQuelle:this.hatQuelle,datenGeliefert:this.datenGeliefert,datenzeilen:this.datenzeilen,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,wunschSeite:this._seite,gemessen:this._mass});return v`<div class="tabelle" style=${Ti({"--takt":`${r.takt}px`,"--zeilen-hoehe":`${r.zeilenHoehe}px`})}>
      ${Ki(()=>this.spaltenListe(),e=>this.aendere(e),n)}
      ${ga({spalten:t,cols:r.cols,editable:this.editable,imEditor:this.hasAttribute(`data-ff-editor`),auswahlSemantik:F(this)!==``,zeigeSuche:this.suche===`ja`,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,zeilen:r.zeilen,linealTakte:r.linealTakte,datenzeilen:this.datenzeilen,zusatzzeilen:this.zusatzzeilen,hatQuelle:r.hatQuelle,auswahlIndex:this.auswahlIndex,leer:r.leer,leerText:this.leerText},{setzeSuchtext:e=>this.setzeSuchtext(e),dblklickKopf:(e,t)=>{this.editable&&(Zi(this),Ji(e,t,()=>this.spaltenListe(),e=>this.aendere(e)))},klickKopf:(t,n)=>{this.editable&&Qi(this,t,e.listenBindung.prop,n,()=>this.spaltenListe()),this.klickSortiere(n)},aktiviereZeile:(e,t)=>this.aktiviereZeile(e,t),stop:n})}
      ${``}
      ${r.leer?b:pa({hatQuelle:r.hatQuelle,sichtbar:r.gesamt,gesamt:this.datenzeilen.length,suchtAktiv:this._suchtext.trim()!==``,auswahlAktiv:this.durchAuswahlGefiltert,seite:r.seite,seiten:r.seiten},{blaettere:e=>{this.merkeZeilenFokus(),this._seite=e,this.requestUpdate()},stop:n})}
    </div>`}};E([w({converter:{fromAttribute:e=>e?yi(e):mi(),toAttribute:e=>JSON.stringify(e)}})],K.prototype,`spalten`,void 0),E([w()],K.prototype,`source`,void 0),E([w()],K.prototype,`suche`,void 0),E([w()],K.prototype,`leerText`,void 0),E([w({attribute:!1})],K.prototype,`datenzeilen`,void 0),E([w({attribute:!1})],K.prototype,`zusatzzeilen`,void 0),E([w({attribute:!1})],K.prototype,`rohzeilen`,void 0),E([w({attribute:!1})],K.prototype,`auswahlIndex`,void 0),E([w({attribute:!1})],K.prototype,`durchAuswahlGefiltert`,void 0),E([w({attribute:!1})],K.prototype,`datenGeliefert`,void 0),D.defineAndRegister(K);function Ca(e){return v`<div class="nachschlag">
    <input
      class="ctrl"
      type="text"
      .value=${e.wert}
  ...
  </div>`}var wa={prop:`nachschlagSpalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:fi,quelleProp:`nachschlagQuelle`};function Ta(e){if(typeof e==`string`)try{e=JSON.parse(e)}catch{return[]}return Array.isArray(e)&&e.length>0?vi(e):[]}function Ea(e,t){let n=e.trim();return n===``||n===t.trim()}function Da(e,t,n){let r=t.trim(),i=[],a=Ea(t,n),o=new Set;for(let t of e){let e=j(t,n).trim(),s=r===``?e:j(t,r).trim();if(!(s===``&&e===``)){if(a){if(o.has(e))continue;o.add(e)}i.push({anzeige:s,wert:e,satz:t})}}return i}function Oa(e,t,n,r){return Da(zt(e,t).rows,n,r)}function ka(e){if(e.quelleId===``||e.speicherFeld===``)return{ok:!1,grund:`unvollstaendig`};let t=A(V().FF_DATA_SOURCES,e.quelleId);if(!t)return{ok:!1,grund:`quelleFehlt`};let n=N(V().SEDATA,t.name,t.tableId);return{ok:!0,eintraege:Oa(e.el,n,e.anzeigeFeld,e.speicherFeld)}}function Aa(e,t){return t&&e.length===1?e[0]:null}function ja(e,t){let{rows:n,gefiltert:r}=zt(e,[t]);return!r||n.length>0}function Ma(e,t,n){return e===``?t===``&&n===``?`nichts`:`leeren`:e===t?`nichts`:`zurueck`}var Na=null,Pa=null,Fa=null;function Ia(e){return e.shadowRoot?.querySelector(`.lupe`)??null}function La(e=!0){let t=e?Fa:null;Fa=null,Na?.remove(),Na=null,Pa=null,t?.focus()}function Ra(e){Pa===e&&La(!1)}function za(e){let t={titel:e.speicherTitel===``?e.anzeigeTitel===``?`Wert`:e.anzeigeTitel:e.speicherTitel,feld:e.speicherFeld,art:W};return Ea(e.anzeigeFeld,e.speicherFeld)?[t]:[{titel:e.anzeigeTitel===``?`Angezeigt`:e.anzeigeTitel,feld:e.anzeigeFeld,art:W},t]}function Ba(e,t){let n=document.createElement(K.tagName),r=Ea(e.anzeigeFeld,e.speicherFeld),i=Ta([...e.spalten]);return n.besitz=`provided`,n.spalten=i.length>0?i:za(e),n.suche=`ja`,n.leerText=`Diese Quelle hat keine Sätze.`,n.bereitgestellteZeilen=t.map(e=>({rohzeile:e.satz,zellen:i.length>0?i.map(t=>t.feld===``?``:j(e.satz,t.feld)):r?[e.wert]:[e.anzeige,e.wert]})),n.toggleAttribute(`fuellt`,!0),n.style.setProperty(`--se-r-lg`,`0px`),n}function Va(e){let t=ka(e);if(!t.ok){B(t.grund===`unvollstaendig`?`Nachschlagen braucht an diesem Feld eine Quelle und „Gespeichert wird".`:`Die Nachschlage-Quelle dieses Feldes ist in der Maske nicht vorhanden.`);return}let n=t.eintraege;La(!1);let r=document.createElement(Vt);r.setAttribute(`data-ff-nachschlagen`,``),r.viewport=!0,r.escapeSchliesst=!0,r.ohneModal=!0,r.inhaltFest=!0,r.titel=e.titel===``?`Nachschlagen`:e.titel,r.breite=520,r.hoehe=380,r.addEventListener(Ht,()=>La()),r.addEventListener(`click`,e=>e.stopPropagation());let i=Ba(e,n);i.addEventListener(va,t=>{let r=t.detail,i=n[r.rohIndex];i&&(La(),e.onUebernehmen(i.anzeige,i.wert,i.satz))}),r.appendChild(i),Fa=Ia(e.el),document.body.appendChild(r),Na=r,Pa=e.el,Promise.all([r.updateComplete,i.updateComplete]).then(()=>{r.isConnected&&i.fokussiereSuche()})}function Ha(e){let t=e=>e.stopPropagation();return v`<ff-dialog-rahmen
    viewport
    escape-schliesst
    ohne-modal
    inhalt-fest
  ...
  >
    ...
    ></ff-tabelle>
  </ff-dialog-rahmen>`}var q=class extends D{constructor(...e){super(...e),this.fieldType=`text`,this.placeholder=`Feldname`,this.options=``,this.source=``,this.value=``,this.valueField=``,this.nachschlagQuelle=``,this.anzeigeFeld=``,this.anzeigeTitel=``,this.speicherFeld=``,this.speicherTitel=``,this.nachschlagSpalten=[],this.einzigerTreffer=`nein`,this.spaltenDialog=!1,this.anzeige=``,this.getippt=null,this.satz=void 0,this.angehakt=!1,this.imSteuerelement=!1}static{this.blockType=`formfeld`}static{this.tagName=`ff-formfeld`}static{this.displayName=`Formularfeld`}static{this.category=`eingabe`}static{this.acceptsDataSource={wenn:{attributeName:`fieldType`,notEquals:`nachschlagen`}}}static{this.kannAuswahlFolgen=!0}static{this.satzWahl={quelleProp:`nachschlagQuelle`,wenn:{attributeName:`fieldType`,equals:`nachschlagen`}}}static{this.listenBindung=wa}static{this.bindableSpots=[{prop:`value`,label:`Wert`,wenn:{attributeName:`fieldType`,keinesVon:[`checkbox`,`nachschlagen`]},vorschauProp:`placeholder`}]}static{this.actionValueSpots=[{prop:`value`,label:`Wert`}]}static{this.blockEvents=[{key:`onChange`,name:`Wert geändert`}]}static{this.defaultProps={width:240,fieldType:`text`,placeholder:`Feldname`,options:``,source:``,value:``,valueField:``,nachschlagQuelle:``,anzeigeFeld:``,anzeigeTitel:``,speicherFeld:``,speicherTitel:``,nachschlagSpalten:[],einzigerTreffer:`nein`}}static{this.raster={startW:6,startH:2,minW:2,minH:2}}static{this.customProperties=dr}static{this.styles=[D.styles,Gr]}onInput(e){let t=e.target;this.value=qr(this.fieldType)===`date`?Lr(t.value):t.value}onChange(){this.dispatchEvent(new Event(`change`))}textTpl(e,t=!1){return v`<span
      class=${e}
      ?hidden=${t}
      data-ff-editable
    ...
    >${this.placeholder}</span>`}onTextClick(){this.hasAttribute(`data-ff-editor`)||this.setzeHaken(!this.angehakt)}setzeHaken(e){this.angehakt!==e&&(this.angehakt=e,this.dispatchEvent(new Event(`change`)))}controlTpl(e){switch(e){case`textarea`:return v`<textarea class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}></textarea>`;case`select`:{let e=this.options.split(`,`).map(e=>e.trim()).filter(e=>e!==``),t=this.value!==``&&!e.includes(this.value);return v`<select class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}>
        ...
        </select>`}case`nachschlagen`:return Ca({wert:this.getippt??this.anzeige,onTippen:e=>{this.getippt=e},onVerlassen:()=>this.onNachschlagVerlassen(),onLupe:()=>this.onLupe()});default:return v`<input
          class="ctrl"
          type=${e}
        ...
        />`}}onLupe(){if(this.hasAttribute(`data-ff-editor`)){this.spaltenDialog=!0;return}Va({el:this,quelleId:this.nachschlagQuelle,anzeigeFeld:this.anzeigeFeld,speicherFeld:this.speicherFeld,anzeigeTitel:this.anzeigeTitel,speicherTitel:this.speicherTitel,spalten:this.nachschlagSpalten,titel:this.placeholder,onUebernehmen:(e,t,n)=>{this.uebernimmSatz(e,t,n),this.dispatchEvent(new Event(`change`))}})}spaltenEffektiv(){let e=Ta(this.nachschlagSpalten);return e.length>0?e:za({anzeigeFeld:this.anzeigeFeld,speicherFeld:this.speicherFeld,anzeigeTitel:this.anzeigeTitel,speicherTitel:this.speicherTitel})}spaltenDialogTpl(){return Ha({titel:this.placeholder,spalten:this.spaltenEffektiv(),onAendern:e=>{this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`nachschlagSpalten`,value:e},bubbles:!0,composed:!0}))},onFeldWahl:e=>{this.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:`nachschlagSpalten`,...e},bubbles:!0,composed:!0}))},onSchliessen:()=>{this.spaltenDialog=!1}})}willUpdate(e){super.willUpdate(e),e.has(`fieldType`)&&qr(this.fieldType)!==`nachschlagen`&&(this.spaltenDialog=!1)}leereNachschlagen(){this.satz=void 0,this.anzeige=``,this.value=``,It(F(this))}uebernimmSatz(e,t,n){this.anzeige=e===``?t:e,this.value=t,this.satz=n,Ft(F(this),n)}onNachschlagVerlassen(){if(this.hasAttribute(`data-ff-editor`))return;let e=Ma(this.getippt??this.anzeige,this.anzeige,this.value);this.getippt=null,e===`leeren`&&(this.leereNachschlagen(),this.dispatchEvent(new Event(`change`)))}pruefeEigenenWert(){qr(this.fieldType)===`nachschlagen`&&(this.satz!==void 0&&!ja(this,this.satz)&&this.leereNachschlagen(),this.uebernimmEinzigenTreffer())}uebernimmEinzigenTreffer(){if(this.einzigerTreffer!==`ja`)return;let e=ka({el:this,quelleId:this.nachschlagQuelle,anzeigeFeld:this.anzeigeFeld,speicherFeld:this.speicherFeld});if(!e.ok)return;let t=Aa(e.eintraege,this.satz===void 0);t&&this.uebernimmSatz(t.anzeige,t.wert,t.satz)}render(){let e=qr(this.fieldType);if(e===`checkbox`)return v`<div class="feld">
        <div class="zeile">
          <input
            class="ctrl"
            type="checkbox"
      ...
      >
        ${this.controlTpl(e)}
        ${Jr.includes(e)?this.textTpl(`ph ${Yr[e]??``}`.trim(),!n):b}
      </div>
      ${this.spaltenDialog&&this.hasAttribute(`data-ff-editor`)?this.spaltenDialogTpl():b}
    </div>`}connectedCallback(){super.connectedCallback(),Ur(this)}disconnectedCallback(){super.disconnectedCallback(),Wr(this),Ra(this)}};E([w()],q.prototype,`fieldType`,void 0),E([w()],q.prototype,`placeholder`,void 0),E([w()],q.prototype,`options`,void 0),E([w()],q.prototype,`source`,void 0),E([w()],q.prototype,`value`,void 0),E([w()],q.prototype,`valueField`,void 0),E([w()],q.prototype,`nachschlagQuelle`,void 0),E([w()],q.prototype,`anzeigeFeld`,void 0),E([w()],q.prototype,`anzeigeTitel`,void 0),E([w()],q.prototype,`speicherFeld`,void 0),E([w()],q.prototype,`speicherTitel`,void 0),E([w({converter:{fromAttribute:e=>Ta(e??``),toAttribute:e=>JSON.stringify(e)}})],q.prototype,`nachschlagSpalten`,void 0),E([w()],q.prototype,`einzigerTreffer`,void 0),E([T()],q.prototype,`spaltenDialog`,void 0),E([T()],q.prototype,`anzeige`,void 0),E([T()],q.prototype,`getippt`,void 0),E([T()],q.prototype,`angehakt`,void 0),E([T()],q.prototype,`imSteuerelement`,void 0),D.defineAndRegister(q);var Ua=`ziel`,Wa=o`
...
`,Ka=`frei · hierher ziehen`,qa=`ff-zimmer-inhalt`,J=class extends D{constructor(...e){super(...e),this.heading=`Neues Zimmer`,this.leerHinweis=``}static{this.blockType=`kanban-zimmer`}static{this.tagName=`ff-kanban-zimmer`}static{this.displayName=`Kanban-Zimmer`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[U.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban-spalte`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={heading:`Neues Zimmer`}}static{this.styles=[D.styles,ki,Ga,Wa,o`
    ...
    `]}onSlotChange(){this.dispatchEvent(new CustomEvent(qa,{bubbles:!0,composed:!0}))}render(){return v`<div class="zimmer ${Ua}">
      <div
        class="kopf"
        data-ff-editable
    ...
    `]}constructor(){super(),this.variant=`info`,this.heading=`Neue Spalte`,this.leerHinweis=``,this._count=0,this.addEventListener(qa,()=>this.zaehle())}zaehle(){this._count=Array.from(this.querySelectorAll(U.tagName)).filter(e=>!e.hasAttribute(`data-ff-editor-helper`)).length}render(){return v`<div class="col ${Ua} v-${Hn(this.variant)}">
      <div class="head">
        <span class="dot"></span>
        <span
          class="title"
    ...
    </div>`}};E([w()],Y.prototype,`variant`,void 0),E([w()],Y.prototype,`heading`,void 0),E([w({attribute:!1})],Y.prototype,`leerHinweis`,void 0),E([T()],Y.prototype,`_count`,void 0),D.defineAndRegister(Y);function Ja(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function Ya(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var Xa=new WeakMap,Za=Y.tagName,Qa=J.tagName,$a=U.tagName;function eo(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Za)}function to(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===$a)}function no(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Qa)}function ro(e){return[e,...no(e)]}function io(e,t){let n=e.getAttribute(`leertext`)??`Keine Datensätze.`,r=(e,t)=>{e.leerHinweis=t};for(let e of t){let t=no(e);for(let e of t)r(e,to(e).length===0?Ka:``);r(e,t.length===0&&to(e).length===0?n:``)}}function ao(e){return Je().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function oo(e,t){let n=no(e);if(n.length===0)return null;let r=e.getAttribute(`zimmerfield`)??``;if(r===``)return n[0];let i=n.map(e=>e.getAttribute(`heading`)??J.defaultProps.heading),a=Ja(j(t,r),i);return a>=0?n[a]:n[0]}function so(e){Z?.board===e&&mo();let t=e.getAttribute(`source`)??``,n=e.getAttribute(`statusfield`)??``;if(t===``)return;let r=A(V().FF_DATA_SOURCES,t);if(!r)return;let i=eo(e);if(i.length===0)return;let a=Xa.get(e);if(!a){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector($a);t&&(a=t.cloneNode(!0),Xa.set(e,a))}if(!a)return;let o=Ni(N(V().SEDATA,r.name,r.tableId),e.getAttribute(`tagfield`)??``,ar()),s=i.map(e=>e.getAttribute(`heading`)??Y.defaultProps.heading),c=ao(a.tagName),l=Ya(i.map(e=>e.getAttribute(`auffang`))),u=Mr(e);for(let e of i)for(let t of ro(e))to(t).forEach(e=>e.remove());for(let e of o){let t=a.cloneNode(!0),o=n===``?-1:Ja(j(e,n),s),d=o>=0?i[o]:l>=0?i[l]:i[0];(oo(d,e)??d).appendChild(t);for(let n of c){let r=t.getAttribute(fr(n.prop))??``;r!==``&&(t[n.prop]=u(e,r))}let ee=r.indexField===``?``:j(e,r.indexField);X.set(t,{row:e,pindex:ee}),t.draggable=!0}io(e,i);let d=i.flatMap(e=>ro(e).flatMap(to)),ee=Nt(F(e),d,e=>X.get(e)?.row);for(let e of ee)d[e].setAttribute(`data-ff-auswahl`,``)}var X=new WeakMap,Z=null,co=new WeakSet,lo=`data-ff-zieht`,uo=`data-ff-ziel`,fo=null;function po(e){fo!==e&&(fo?.removeAttribute(uo),fo=e,fo?.setAttribute(uo,``))}function mo(){Z?.card.removeAttribute(lo),Z=null,po(null)}function ho(e,t,n){for(let r of t.composedPath())if(r instanceof HTMLElement&&r.tagName.toLowerCase()===n&&e.contains(r))return r;return null}function go(e,t){return ho(e,t,Za)}function _o(e,t,n){if(!Z||Z.board!==e)return;let r=X.get(Z.card);if(!r)return;let i=t.getAttribute(`heading`)??``,a=n?.getAttribute(`heading`)??``;Ln(e,`onCardDrop`,{PINDEX:r.pindex,VALUE:i,ZIMMER:a}).catch(In)}function vo(e){co.has(e)||(co.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;if(!n)return;let r=X.get(n);r&&Pt(F(e),r.row),Ln(e,`onCardClick`,{PINDEX:r?.pindex??``}).catch(In)}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;n&&(Z={card:n,board:e},t.dataTransfer?.setData(`text/plain`,X.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`),setTimeout(()=>{Z?.card===n&&n.setAttribute(lo,``)},0))}),e.addEventListener(`dragend`,mo),e.addEventListener(`dragover`,t=>{let n=go(e,t);if(Z?.board!==e||!n){po(null);return}t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`),po(ho(e,t,Qa)??n)}),e.addEventListener(`dragleave`,t=>{let n=t.relatedTarget;(!(n instanceof Node)||!e.contains(n))&&po(null)}),e.addEventListener(`drop`,t=>{let n=go(e,t);n&&(t.preventDefault(),_o(e,n,ho(e,t,Qa)),mo())}))}var yo=Dr({hydriere:so,verdrahte:vo}),bo=yo.connect,xo=yo.disconnect,So=Y.blockType,Co=class extends D{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[So]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:So}}static{this.templateChild={type:U.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``,tagField:``,leerText:Ei}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Optional: Feld der Datenquelle, dessen Inhalt bestimmt, in welche Spalte ein Eintrag kommt. Leer = alle Einträge in der Auffang-Spalte.`,kind:`field`},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt das Board nur Einträge des Tages, den der Tageswähler zeigt. Leer = alle Einträge.`,kind:`field`},Di()]}static{this.defaultChildren=[{type:So,props:{heading:`Offen`,variant:`warning`},children:[{type:U.blockType}]},{type:So,props:{heading:`In Arbeit`,variant:`info`}},{type:So,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[D.styles,o`
    ...
    `]}render(){return v`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),bo(this)}disconnectedCallback(){super.disconnectedCallback(),xo(this)}};D.defineAndRegister(Co);var wo={breite:56,breiteOffen:224},To=`ff-seiten-wechsel`,Eo=[{wert:`sonne`,name:`Sonnengelb`},{wert:`salbei`,name:`Salbeigrün`},{wert:`himmel`,name:`Himmelblau`},{wert:`flieder`,name:`Flieder`},{wert:`koralle`,name:`Koralle`}],Q=class extends D{static{this.blockType=`navi-eintrag`}static{this.tagName=`ff-navi-eintrag`}static{this.displayName=`Navi-Eintrag`}static{this.category=`layout`}static{this.acceptsChildren=!1}static{this.showInPalette=!1}static{this.allowedParentTypes=[`navi`]}static{this.resizableWidth=!1}static{this.defaultProps={seite:``,seitename:``,ton:`sonne`}}static{this.customProperties=[{attributeName:`seite`,name:`Seite`,description:`Welche Seite dieser Maske der Eintrag zeigt.`,kind:`seite`,klarnameProp:`seitename`,nurImEditor:!0},{attributeName:`ton`,name:`Farbe`,description:`Farbe des Zeichens vor dem Namen.`,kind:`select`,options:Eo.map(e=>({value:e.wert,label:e.name}))}]}static{this.styles=[D.styles,o`
      :host {
        --ton: var(--se-amber);
        display: flex;
        align-items: center;
    ...
    `]}constructor(){super(),this.seite=``,this.seitename=``,this.ton=`sonne`,this.addEventListener(`click`,()=>this.melde())}melde(){let e={ansicht:this.seitename};this.dispatchEvent(new CustomEvent(To,{detail:e,bubbles:!0,composed:!0}))}render(){return v`<span class="zeichen"></span>
      <span class="name">${this.seitename===``?`—`:this.seitename}</span>`}};E([w()],Q.prototype,`seite`,void 0),E([w()],Q.prototype,`seitename`,void 0),E([w({reflect:!0})],Q.prototype,`ton`,void 0),D.defineAndRegister(Q);var Do=`aktiv`;function Oo(e){return Array.from(e.querySelectorAll(Q.tagName))}function ko(e,t){let n=Oo(e),r=t??n.find(e=>e.hasAttribute(Do))??n[0];for(let e of n)e===r?e.setAttribute(Do,``):e.removeAttribute(Do)}function Ao(e){let t=e.hasAttribute(`offen`);for(let n of Oo(e))n.toggleAttribute(`breit`,t)}function jo(e){return e.getAttribute(`name`)??String(ot.defaultProps.name)}function Mo(e,t){let n=e;for(;n&&n.parentElement!==t;)n=n.parentElement;return n}function No(e,t){let n=e.ownerDocument,r=Array.from(n.querySelectorAll(ot.tagName)),i=r[0]?.parentElement??null;if(!i)return;let a=Mo(e,i);if(!a)return;let o=r.find(e=>jo(e)===t)??null;for(let e of Array.from(i.children))e!==a&&((r.includes(e)?e===o:o===null)?e.removeAttribute(`hidden`):e.setAttribute(`hidden`,``))}var Po=new WeakMap,Fo=new WeakSet;function Io(e){let t=t=>{let n=t.detail;n&&(ko(e,t.target instanceof Element?t.target:void 0),e.removeAttribute(`offen`),Ao(e),!e.hasAttribute(`data-ff-editor`)&&No(e,n.ansicht))};e.addEventListener(To,t),Po.set(e,t)}function Lo(e){let t=Po.get(e);t&&(e.removeEventListener(To,t),Po.delete(e))}function Ro(e){if(ko(e),Ao(e),e.hasAttribute(`data-ff-editor`)||Fo.has(e))return;let t=Oo(e)[0];if(!t)return;Fo.add(e);let n=()=>No(e,t.seitename);e.ownerDocument.readyState===`loading`?e.ownerDocument.addEventListener(`DOMContentLoaded`,n,{once:!0}):queueMicrotask(n)}var zo=Q.blockType,Bo=class extends D{static{this.blockType=`navi`}static{this.tagName=`ff-navi`}static{this.displayName=`Navi`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[zo]}static{this.addChildButton={label:`Eintrag`,childType:zo}}static{this.containerHint=!1}static{this.defaultProps={}}static{this.customProperties=[]}static{this.maskenRand=!0}static{this.allowedParentTypes=[at]}static{this.raster={startW:5,startH:24,minW:3,minH:3}}static{this.styles=[D.styles,o`
      :host {
        height: 100%;
        width: ${wo.breite}px;
        transition: width var(--se-move);
      }
      :host([offen]) { width: ${wo.breiteOffen}px; }
      .leiste {
        box-sizing: border-box;
        height: 100%;
        width: 100%;
    ...
    `]}connectedCallback(){super.connectedCallback(),Io(this)}disconnectedCallback(){super.disconnectedCallback(),Lo(this)}klappen(){this.toggleAttribute(`offen`),Ao(this)}render(){return v`<div class="leiste">
        <div class="kopf">
          <button
            class="schalter"
            type="button"
        ...
        <div class="eintraege">
          <slot @slotchange=${()=>Ro(this)}></slot>
        </div>
      </div>`}};D.defineAndRegister(Bo);var Vo=fr(`text`);function Ho(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(Vo)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function Uo(e){let t=Nr(e,Vo);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function Wo(e){Ho(e)&&(e.text=``)}var Go=Dr({hydriere:Uo,verdrahte:Wo}),Ko=Go.connect,qo=Go.disconnect,Jo=6,Yo=96,Xo=14,Zo={duenn:`300`,normal:`400`,fett:`700`},Qo={links:`left`,mitte:`center`,rechts:`right`},$o={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},es=`standard`;function ts(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(Yo,Math.max(Jo,t)):Xo}function ns(e){return typeof e==`string`&&e in Zo?e:`normal`}function rs(e){return typeof e==`string`&&e in Qo?e:`links`}function is(e){return typeof e==`string`&&e in $o?e:es}var $=class extends D{constructor(...e){super(...e),this.groesse=Xo,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=es,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:Xo,gewicht:`normal`,ausrichtung:`links`,farbe:es,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:Jo,max:Yo,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[D.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return v`<div
      class="text"
      style=${Ti({fontSize:`${ts(this.groesse)}px`,fontWeight:Zo[ns(this.gewicht)],textAlign:Qo[rs(this.ausrichtung)],color:$o[is(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),Ko(this)}disconnectedCallback(){super.disconnectedCallback(),qo(this)}};E([w({type:Number})],$.prototype,`groesse`,void 0),E([w()],$.prototype,`gewicht`,void 0),E([w()],$.prototype,`ausrichtung`,void 0),E([w()],$.prototype,`farbe`,void 0),E([w()],$.prototype,`text`,void 0),E([w()],$.prototype,`source`,void 0),E([w()],$.prototype,`textField`,void 0),D.defineAndRegister($);var as=[`waagerecht`,`senkrecht`],os=`waagerecht`;function ss(e){return as.includes(e)?e:os}var cs=class extends D{constructor(...e){super(...e),this.richtung=os}static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`,richtung:os}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1,varianten:[{wenn:{attributeName:`richtung`,equals:`senkrecht`},startW:1,startH:6,breiteZiehbar:!1}]}}static{this.customProperties=[{attributeName:`richtung`,name:`Richtung`,description:`Waagerecht trennt oben von unten, senkrecht links von rechts.`,kind:`select`,options:[{value:`waagerecht`,label:`Waagerecht`},{value:`senkrecht`,label:`Senkrecht`}]}]}static{this.styles=[D.styles,o`
    ...
    `]}render(){return v`<div class="flaeche ${ss(this.richtung)}"><div class="linie"></div></div>`}};E([w()],cs.prototype,`richtung`,void 0),D.defineAndRegister(cs),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;B(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();
...
\f\r]`,v=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,be=/-->/g,xe=/>/g,y=RegExp(`>|${ye}(?:([^\\s"'>=/]+)(${ye}*=${ye}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,`g`),Se=/'/g,Ce=/"/g,we=/^(?:script|style|textarea|title)$/i,Te=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),b=Te(1),x=Te(2),S=Symbol.for(`lit-noChange`),C=Symbol.for(`lit-nothing`),Ee=new WeakMap,w=h.createTreeWalker(h,129);function De(e,t){if(!_e(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return pe===void 0?t:pe.createHTML(t)}var Oe=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:t===3?`<math>`:``,o=v;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===v?c[1]===`!--`?o=be:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=y):(we.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=y):o=xe:o===y?c[0]===`>`?(o=i??v,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?y:c[3]===`"`?Ce:Se):o===Ce||o===Se?o=y:o===be||o===xe?o=v:(o=y,i=void 0);let d=o===y&&e[t+1].startsWith(`/>`)?` `:``;a+=o===v?n+ge:l>=0?(r.push(s),n.slice(0,l)+me+n.slice(l)+m+d):n+m+(l===-2?t:d)}return[De(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:t===3?`</math>`:``)),r]},ke=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=Oe(t,n);if(this.el=e.createElement(l,r),w.currentNode=this.el.content,n===2||n===3){let e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;(i=w.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes())for(let e of i.getAttributeNames())if(e.endsWith(me)){let t=u[o++],n=i.getAttribute(e).split(m),r=/([.?@])?(.*)/.exec(t);c.push({type:1,index:a,name:r[2],strings:n,ctor:r[1]===`.`?Ne:r[1]===`?`?Pe:r[1]===`@`?Fe:Me}),i.removeAttribute(e)}else e.startsWith(m)&&(c.push({type:6,index:a}),i.removeAttribute(e));if(we.test(i.tagName)){let e=i.textContent.split(m),t=e.length-1;if(t>0){i.textContent=fe?fe.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],g()),w.nextNode(),c.push({type:2,index:++a});i.append(e[t],g())}}}else if(i.nodeType===8)if(i.data===he)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(m,e+1))!==-1;)c.push({type:7,index:a}),e+=m.length-1}a++}}static createElement(e,t){let n=h.createElement(`template`);return n.innerHTML=e,n}};function T(e,t,n=e,r){if(t===S)return t;let i=r===void 0?n._$Cl:n._$Co?.[r],a=_(t)?void 0:t._$litDirective$;return i?.constructor!==a&&(i?._$AO?.(!1),a===void 0?i=void 0:(i=new a(e),i._$AT(e,n,r)),r===void 0?n._$Cl=i:(n._$Co??=[])[r]=i),i!==void 0&&(t=T(e,i._$AS(e,t.values),i,r)),t}var Ae=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??h).importNode(t,!0);w.currentNode=r;let i=w.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new je(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new Ie(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=w.nextNode(),a++)}return w.currentNode=h,r}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},je=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,r){this.type=2,this._$AH=C,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=T(this,e,t),_(e)?e===C||e==null||e===``?(this._$AH!==C&&this._$AR(),this._$AH=C):e!==this._$AH&&e!==S&&this._(e):e._$litType$===void 0?e.nodeType===void 0?ve(e)?this.k(e):this._(e):this.T(e):this.$(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==C&&_(this._$AH)?this._$AA.nextSibling.data=e:this.T(h.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=ke.createElement(De(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.p(t);else{let e=new Ae(r,this),n=e.u(this.options);e.p(t),this.T(n),this._$AH=e}}_$AC(e){let t=Ee.get(e.strings);return t===void 0&&Ee.set(e.strings,t=new ke(e)),t}k(t){_e(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.O(g()),this.O(g()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let t=de(e).nextSibling;de(e).remove(),e=t}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},Me=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,r,i){this.type=1,this._$AH=C,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=C}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=T(this,e,t,0),a=!_(e)||e!==this._$AH&&e!==S,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=T(this,r[n+o],t,o),s===S&&(s=this._$AH[o]),a||=!_(s)||s!==this._$AH[o],s===C?e=C:e!==C&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===C?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},Ne=class extends Me{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===C?void 0:e}},Pe=class extends Me{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==C)}},Fe=class extends Me{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=T(this,e,t,0)??C)===S)return;let n=this._$AH,r=e===C&&n!==C||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==C&&(n===C||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Ie=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){T(this,e)}},Le=ue.litHtmlPolyfillSupport;Le?.(ke,je),(ue.litHtmlVersions??=[]).push(`3.3.3`);var Re=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new je(t.insertBefore(g(),e),e,void 0,n??{})}return i._$AI(e),i},ze=globalThis,E=class extends p{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Re(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return S}};E._$litElement$=!0,E.finalized=!0,ze.litElementHydrateSupport?.({LitElement:E});var Be=ze.litElementPolyfillSupport;Be?.({LitElement:E}),(ze.litElementVersions??=[]).push(`4.2.2`);var Ve={attribute:!0,type:String,converter:se,reflect:!1,hasChanged:ce},He=(e=Ve,t,n)=>{let{kind:r,metadata:i}=n,a=globalThis.litPropertyMetadata.get(i);if(a===void 0&&globalThis.litPropertyMetadata.set(i,a=new Map),r===`setter`&&((e=Object.create(e)).wrapped=!0),a.set(n.name,e),r===`accessor`){let{name:r}=n;return{set(n){let i=t.get.call(this);t.set.call(this,n),this.requestUpdate(r,i,e,!0,n)},init(t){return t!==void 0&&this.C(r,void 0,e,t),t}}}if(r===`setter`){let{name:r}=n;return function(n){let i=this[r];t.call(this,n),this.requestUpdate(r,i,e,!0,n)}}throw Error(`Unsupported decorator location: `+r)};function D(e){return(t,n)=>typeof n==`object`?He(e,t,n):((e,t,n)=>{let r=t.hasOwnProperty(n);return t.constructor.createProperty(n,e),r?Object.getOwnPropertyDescriptor(t,n):void 0})(e,t,n)}function Ue(e){return D({...e,state:!0,attribute:!1})}var We=new Map;function Ge(e){We.has(e.type)&&console.warn(`Block-Typ "${e.type}" wird ueberschrieben.`),We.set(e.type,e)}function Ke(){return Array.from(We.values())}var qe={width:`auto`},Je={rasterX:0,rasterY:0,rasterW:{spalten:24,spaltePx:40,zeilePx:12,gapPx:8}.spalten,rasterH:1};function O(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var k=class extends E{constructor(...e){super(...e),this.editable=!1}static{this.styles=o`
  ...
  `}static{this.customProperties=[]}get customProperties(){return this.constructor.customProperties}inlineEdit(e,t){if(!this.editable)return;let n=e.currentTarget;if(!n||n.hasAttribute(`data-ff-bound`))return;e.stopPropagation(),e.preventDefault();let r=n.textContent??``,i=Array.from(n.childNodes),a=i.map(e=>e.textContent??``);n.setAttribute(`contenteditable`,`plaintext-only`),n.focus();let o=window.getSelection(),s=document.createRange();s.selectNodeContents(n),o?.removeAllRanges(),o?.addRange(s);let c=!1,l=e=>{if(!c)if(c=!0,n.removeAttribute(`contenteditable`),n.removeEventListener(`blur`,u),n.removeEventListener(`keydown`,d),e){let e=(n.textContent??``).trim();e!==r&&this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:t,value:e},bubbles:!0,composed:!0}))}else n.replaceChildren(...i),i.forEach((e,t)=>{e.textContent!==a[t]&&(e.textContent=a[t])})},u=()=>l(!0),d=e=>{e.key===`Enter`?(e.preventDefault(),n.blur()):e.key===`Escape`&&(e.preventDefault(),l(!1))};n.addEventListener(`blur`,u),n.addEventListener(`keydown`,d)}static defineAndRegister(e){customElements.get(e.tagName)||customElements.define(e.tagName,e),Ge({type:e.blockType,tagName:e.tagName,displayName:e.displayName,category:e.category,defaultProps:{...qe,...Je,...e.defaultProps},customProperties:e.customProperties,acceptsChildren:e.acceptsChildren??!1,resizableWidth:e.resizableWidth??!0,resizableHeight:e.resizableHeight??!1,allowedChildTypes:e.allowedChildTypes,allowedParentTypes:e.allowedParentTypes,lockedWidth:e.lockedWidth,defaultChildren:e.defaultChildren,childDirection:e.childDirection,showInPalette:e.showInPalette,templateChild:e.templateChild,containerHint:e.containerHint,addChildButton:e.addChildButton,acceptsDataSource:e.acceptsDataSource,bindableSpots:e.bindableSpots,actionValueSpots:e.actionValueSpots,listenBindung:e.listenBindung,bindingRoute:e.bindingRoute,blockEvents:e.blockEvents,pageBlock:e.pageBlock,raster:e.raster})}};O([D({type:Boolean,reflect:!0,attribute:`data-editable`})],k.prototype,`editable`,void 0);var Ye=[`GET_RELATION`,`PUT_RELATION`,`PUTADD_RELATION`];function Xe(e){return`${String(e.getDate()).padStart(2,`0`)}.${String(e.getMonth()+1).padStart(2,`0`)}.${e.getFullYear()}`}function Ze(e,t){return e.params.map(e=>e.replace(/\{([A-Za-z0-9_]+)\}/g,(e,n)=>String(t[n]??``)))}var Qe=`data-ff-block-id`,$e=[`fixed`,`context`,`data_field`,`block_value`,`previous_result`,`step_result`,`se_variable`];function et(e){return!!e&&typeof e==`object`&&!Array.isArray(e)}function tt(e){return!et(e)||typeof e.source!=`string`||!$e.includes(e.source)||typeof e.value!=`string`||e.dataSourceId!==void 0&&typeof e.dataSourceId!=`string`||e.blockId!==void 0&&typeof e.blockId!=`string`?null:{source:e.source,value:e.value,...typeof e.dataSourceId==`string`?{dataSourceId:e.dataSourceId}:{},...typeof e.blockId==`string`?{blockId:e.blockId}:{}}}function nt(e){if(!et(e)||typeof e.type!=`string`||typeof e.resultKey!=`string`)return null;if(e.type===`START_TOOL`)return typeof e.toolNr!=`string`||!Array.isArray(e.toolParams)||e.toolParams.some(e=>typeof e!=`string`)?null:{type:`START_TOOL`,resultKey:e.resultKey,toolNr:e.toolNr,toolParams:[...e.toolParams]};if(e.type===`POPUP_OPEN`||e.type===`POPUP_CLOSE`){let t=typeof e.popupId==`string`?e.popupId:void 0,n=typeof e.popup==`string`?e.popup:void 0;return t===void 0&&n===void 0?null:{type:e.type,resultKey:e.resultKey,...t===void 0?{}:{popupId:t},...n===void 0?{}:{popup:n}}}if(e.type===`RELATION`){if(typeof e.relationId!=`string`||!Array.isArray(e.extraParams)||!Array.isArray(e.params)&&!et(e.bindings))return null;let t=[];if(Array.isArray(e.params))for(let n of e.params){let e=tt(n);if(!e)return null;t.push(e)}let n=[];for(let t of e.extraParams){let e=tt(t);if(!e)return null;n.push(e)}return{type:`RELATION`,resultKey:e.resultKey,relationId:e.relationId,params:t,extraParams:n}}return null}function rt(e){if(!e)return{};let t;try{t=JSON.parse(e)}catch{return{}}if(!et(t))return{};let n={};for(let[e,r]of Object.entries(t)){if(!Array.isArray(r)||r.length===0)continue;let t=[],i=!1;for(let e of r){let n=nt(e);if(!n){i=!0;break}t.push(n)}!i&&t.length>0&&(n[e]=t)}return n}var it=`root`;function at(e,t){let n=Number(e);return Number.isFinite(n)&&n>0?n:t}var A=class extends k{constructor(...e){super(...e),this.name=`Popup`,this.breite=520,this.hoehe=380}static{this.blockType=`popup`}static{this.tagName=`ff-popup`}static{this.displayName=`Popup`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.showInPalette=!1}static{this.allowedParentTypes=[it]}static{this.pageBlock=!0}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.defaultProps={name:`Popup`,breite:520,hoehe:380}}static{this.styles=[k.styles,o`
    ...
    `]}onClose(){this.hasAttribute(`data-ff-editor`)||this.removeAttribute(`offen`)}render(){return b`<div class="abdunklung"></div>
      ...
      </div>`}};O([D()],A.prototype,`name`,void 0),O([D()],A.prototype,`breite`,void 0),O([D()],A.prototype,`hoehe`,void 0),k.defineAndRegister(A);function j(e){return typeof e==`object`&&!!e}function ot(e,t){if(!(!Array.isArray(e)||t===``)){for(let n of e)if(!(!j(n)||n.id!==t)&&!(typeof n.name!=`string`||typeof n.tableId!=`string`))return{id:t,name:n.name,tableId:n.tableId,indexField:typeof n.indexField==`string`?n.indexField:``}}}function st(e){return e==null?``:String(e).trim()}function M(e,t){if(!j(e)||t===``)return``;let n=t.trim(),r=st(e[n]);if(r!==``)return r;for(let t of Object.keys(e))if(t===n||t.startsWith(`${n}_`)||t.endsWith(`_${n}`)){let n=st(e[t]);if(n!==``)return n}let i=/^(\d+)_(\d+)$/.exec(n);if(!i)return``;let a=st(e.SATZNEU??e.SATZ??e.satzneu??e.satz??e.RAW??e.raw);if(a===``)return``;let o=Number(i[1]),s=Number(i[2]);return s<=0?``:a.substring(o,o+s).trim()}function ct(e,t,n){if(!j(e)||t===``)return!1;let r=t.trim(),i=!1;for(let t of Object.keys(e))(t===r||t.startsWith(`${r}_`)||t.endsWith(`_${r}`))&&(e[t]=n,i=!0);let a=/^(\d+)_(\d+)$/.exec(r);if(a){let t=[`SATZNEU`,`SATZ`,`satzneu`,`satz`,`RAW`,`raw`].find(t=>typeof e[t]==`string`);if(t){let r=e[t],o=Number(a[1]),s=Number(a[2]);if(s>0){let a=n.length>s?n.slice(0,s):n.padEnd(s,` `),c=r.length<o?r.padEnd(o,` `):r;e[t]=c.slice(0,o)+a+c.slice(o+s),i=!0}}}return i}function lt(e){if(!j(e))return Array.isArray(e)?e:[];let t=[e.Zeilen,e.zeilen,e.Saetze,e.saetze,e.Rows,e.rows,e.Daten,e.daten];for(let e of t){if(Array.isArray(e))return e;if(typeof e==`string`)try{let t=JSON.parse(e);if(Array.isArray(t))return t}catch{}}return[]}function N(e,t){return st(e).toLowerCase()===t.trim().toLowerCase()}function ut(e,t,n){if(!j(e)||!j(e.Daten))return[];let r=e.Daten,i=r.SEFileLoop;if(Array.isArray(i)){for(let e of i)if(j(e)&&(N(e.ALIAS,t)||N(e.alias,t))){let t=lt(e);if(t.length>0)return t}}else if(j(i))for(let e of Object.keys(i)){let n=i[e];if(N(e,t)||j(n)&&(N(n.ALIAS,t)||N(n.alias,t))){let e=lt(n);if(e.length>0)return e}}let a=r.Tabellen;if(j(a)){let e=[t,t.toUpperCase(),t.toLowerCase(),n];for(let t of e)if(t!==``&&t in a){let e=lt(a[t]);if(e.length>0)return e}for(let e of Object.keys(a))if(N(e,t)){let t=lt(a[e]);if(t.length>0)return t}}return[]}function dt(e){let t=e;if(typeof t==`string`)try{t=JSON.parse(t)}catch{return}if(!j(t)||!j(t.Daten))return;let n=t.Daten;if(!(!n.SEFileLoop&&!n.Tabellen&&!n.ErpApiCall))return n}function ft(e){let t=e;if(typeof t==`string`)try{t=JSON.parse(t)}catch{return}if(!(!j(t)||!j(t.MSG)))return t.MSG.DATA}function P(){return globalThis}function F(){let e=P();return j(e.SEDATA)&&j(e.SEDATA.Daten)}function pt(){let e=P();try{e.selib?.Json?.InitializeERPConnection?.()}catch{}try{typeof e.InitialisiereSchnittstelle==`function`&&e.InitialisiereSchnittstelle()}catch{}}function mt(){let e=P();try{typeof e.ResetDataBasis==`function`&&e.ResetDataBasis()}catch{}try{typeof e.InitialisiereDatenBasis==`function`&&e.InitialisiereDatenBasis()}catch{}}var ht=new Set,gt=new Set;function _t(e){ht.add(e)}function vt(e){return gt.add(e),()=>{gt.delete(e)}}function yt(){ht.forEach(e=>e())}function bt(e){gt.forEach(t=>{try{t(e)}catch{}})}var I=new Map,xt=``,St=0;function Ct(){try{let e=document.getElementById(`ff-se-diagnose`);return!e&&document.body&&(e=document.createElement(`textarea`),e.id=`ff-se-diagnose`,e.readOnly=!0,e.style.cssText=`display:none;position:fixed;left:8px;right:8px;bottom:8px;height:40vh;z-index:99999;font:11px monospace;`,document.body.appendChild(e)),e}catch{return null}}function wt(){let e=Ct();e&&(e.value=Array.from(I,([e,t])=>`${e}: ${t}`).join(`
`)+(xt===``?``:`\n\nERSTES PAKET\n${xt}`))}function L(e,t){I.set(e,t),wt()}function R(){let e=P();I.set(`basisHTML_REGISTER`,typeof e.basisHTML_REGISTER==`function`?`vorhanden`:`fehlt`),I.set(`basisHTML_SND_MSG`,typeof e.basisHTML_SND_MSG==`function`?`vorhanden`:`fehlt`),I.set(`body.pid`,document.body?.getAttribute(`pid`)?`gesetzt`:`fehlt`),I.set(`body.REGMSG`,document.body?.getAttribute(`REGMSG`)?`gesetzt`:`fehlt`),I.set(`Empfangene Pakete`,String(St)),I.set(`SEDATA.Daten`,F()?`vorhanden`:`fehlt`),wt()}function Tt(e){if(xt===``)try{xt=typeof e==`string`?e:JSON.stringify(e)??``,wt()}catch{}}function Et(e){St+=1,Tt(e),L(`Empfangene Pakete`,String(St));let t=dt(e);if(!t){L(`Letztes Paket`,`Antwort ohne Daten`),bt(e);return}let n=P();j(n.SEDATA)||(n.SEDATA={}),n.SEDATA.Daten=t,L(`Letztes Paket`,`Daten-Push angenommen`),L(`SEDATA.Daten`,`vorhanden`),mt(),yt()}function Dt(e=0){let t=P();if(typeof t.basisHTML_REGISTER==`function`){R();try{t.basisHTML_SetConsoleLog?.(!0,!0)}catch{}try{t.basisHTML_REGISTER(e=>{Et(e)},document.title,`1.0`),L(`Registrierung`,`ausgeführt`)}catch(e){L(`Registrierung`,`Fehler: ${e instanceof Error?e.message:String(e)}`)}return}e<400?(e===0&&L(`Registrierung`,`wartet auf Interface`),setTimeout(()=>{Dt(e+1)},25)):(R(),L(`Registrierung`,`nach 10s kein Interface`))}var Ot=!1;function z(){if(Ot)return;Ot=!0,L(`Runtime`,`gestartet`),L(`Registrierung`,`noch nicht ausgeführt`),R(),pt();let e=P();e.Erstellen=()=>{mt(),yt()},e.initData=e.Erstellen,e.ReloadData=()=>{yt()},Dt(),window.addEventListener(`message`,e=>{if(typeof P().basisHTML_REGISTER==`function`)return;let t=ft(e.data);t!==void 0&&Et(t)},!0),document.addEventListener(`keydown`,e=>{if(e.ctrlKey&&e.altKey&&e.key.toLowerCase()===`d`){R();let e=document.getElementById(`ff-se-diagnose`);e&&(e.style.display=e.style.display===`none`?`block`:`none`)}});let t=0,n=setInterval(()=>{t+=1,F()?(clearInterval(n),L(`SEDATA.Daten`,`vorhanden`),mt(),yt()):t>100&&(clearInterval(n),L(`Daten-Wartezeit`,`nach 30s ohne Daten`))},300)}function kt(e,t){if(!(!Array.isArray(e)||t===``)){for(let n of e)if(!(!j(n)||n.id!==t)&&!(typeof n.verb!=`string`||!Ye.includes(n.verb))&&!(typeof n.nr!=`string`||n.nr===``)&&!(!Array.isArray(n.params)||n.params.some(e=>typeof e!=`string`)))return{id:t,verb:n.verb,nr:n.nr,params:n.params}}}var At=[`RESULT`,`result`,`PINDEX`,`pindex`,`INDEX`,`index`,`0_10`,`KEY`,`key`,`ID`,`id`,`VALUE`,`value`];function jt(e){if(typeof e!=`string`)return e;try{return JSON.parse(e)}catch{return}}function Mt(e){if(typeof e==`string`)return e.trim()===``?void 0:e.trim();if(typeof e==`number`||typeof e==`boolean`)return String(e)}function Nt(e,t){if(t>12)return;let n=Mt(e);if(n!==void 0)return n;if(Array.isArray(e)){for(let n of e){let e=Nt(n,t+1);if(e!==void 0)return e}return}if(j(e)){for(let n of At){if(!(n in e))continue;let r=Nt(e[n],t+1);if(r!==void 0)return r}for(let n of Object.values(e)){let e=Nt(n,t+1);if(e!==void 0)return e}}}function Pt(e){let t=jt(e);if(j(t)){for(let e of At){if(!(e in t))continue;let n=Nt(t[e],0);if(n!==void 0)return n}for(let e of Object.values(t))if(Array.isArray(e))for(let t of e){let e=Pt(t);if(e!==void 0)return e}else if(j(e)){let t=Pt(e);if(t!==void 0)return t}}}function Ft(e){return j(e)?Object.keys(e).filter(e=>/^Message\d+$/.test(e)):[]}function It(e,t){if(!j(e))return;let n=Ft(e).filter(e=>!t.has(e)).sort((e,t)=>Number(t.slice(7))-Number(e.slice(7)));for(let t of n){let n=Pt(e[t]);if(n!==void 0)return n}}var Lt=[],Rt=!1,zt=6e3,Bt=100;function Vt(){if(Rt||Lt.length===0)return;Rt=!0;let e=Lt.shift(),t=P(),n=new Set(Ft(t.SEDATA)),r=!1,i=t=>{r||(r=!0,a(),clearInterval(o),clearTimeout(s),Rt=!1,e.resolve(t),Vt())},a=vt(e=>{let t=Pt(e);t!==void 0&&i(t)}),o=setInterval(()=>{let e=It(P().SEDATA,n);e!==void 0&&i(e)},Bt),s=setTimeout(()=>{i(``)},zt);if(typeof t.basisHTML_SND_MSG!=`function`){i(``);return}try{t.basisHTML_SND_MSG(`GET_RELATION`,{NR:e.template.nr,PARAMS:e.params})}catch{i(``)}}function Ht(e,t){z();let n=P();if(e.verb!==`GET_RELATION`){if(typeof n.basisHTML_SND_MSG==`function`)try{n.basisHTML_SND_MSG(e.verb,{NR:e.nr,PARAMS:[...t]})}catch{}return Promise.resolve(``)}return new Promise(n=>{Lt.push({template:e,params:[...t],resolve:n}),Vt()})}function Ut(e,t){if(!j(t))return``;let n=t.document;if(!n||typeof n.querySelectorAll!=`function`)return``;let r=Array.from(n.querySelectorAll(`[${Qe}]`)).find(t=>t.getAttribute(Qe)===e.blockId);if(!r)return``;let i=r[e.value];return i==null?``:String(i)}function Wt(e,t,n=P()){if(e.source===`fixed`)return e.value;if(e.source===`context`)return t.context[e.value]??``;if(e.source===`previous_result`)return t.previousResult;if(e.source===`step_result`){let n=Number(e.value);return Number.isInteger(n)&&n>=0?t.stepResults?.[n]??``:``}if(e.source===`block_value`)return Ut(e,n);if(!j(n))return``;if(e.source===`se_variable`){let t=n.SEDATA;if(!j(t)||!j(t.Daten)||!j(t.Daten.VARArrays))return``;let r=t.Daten.VARArrays[e.value];return r==null?``:String(r)}let r=ot(n.FF_DATA_SOURCES,e.dataSourceId??``);if(!r)return``;let i=ut(n.SEDATA,r.name,r.tableId),a=t.context.PINDEX??``,o=a!==``&&r.indexField!==``?i.find(e=>M(e,r.indexField)===a):i[0];return o?M(o,e.value):``}function Gt(e,t){let n=`0,START_TOOL,`+e;return t.length>0&&(n+=`,`+t.map(e=>encodeURIComponent(e)).join(`,`)),n}function Kt(e,t){if(e.trim()===``)return;let n=P();try{if(typeof n.sendBWLinkIntern==`function`){n.sendBWLinkIntern(Gt(e,t));return}}catch{}try{if(typeof n.basisHTML_SND_MSG==`function`){let r={NR:e};t.length>0&&(r.PARAMS=[...t]),n.basisHTML_SND_MSG(`START_TOOL`,r)}}catch{}}function qt(e,t,n){if(t.trim()!==``)for(let r of Array.from(e.querySelectorAll(A.tagName)))(r.getAttribute(`name`)??``)===t&&(n?r.setAttribute(`offen`,``):r.removeAttribute(`offen`))}var Jt=new WeakMap;async function Yt(e,t,n){if(e.hasAttribute(`data-ff-editor`))return;let r=rt(e.getAttribute(`data-ff-aktionen`))[t];if(!r||r.length===0)return;let i=Jt.get(e);if(i||(i=new Set,Jt.set(e,i)),!i.has(t)){i.add(t);try{let t={...n,NOW_DATE:Xe(new Date)},i=``,a=[];for(let n of r){if(n.type===`START_TOOL`){Kt(n.toolNr,Ze({params:n.toolParams},t)),a.push(``);continue}if(n.type===`POPUP_OPEN`||n.type===`POPUP_CLOSE`){qt(e.ownerDocument??document,n.popup??``,n.type===`POPUP_OPEN`),a.push(``);continue}let r=kt(P().FF_RELATIONS,n.relationId);if(!r){a.push(``);continue}let o={context:t,previousResult:i,stepResults:a},s=await Ht(r,[...n.params,...n.extraParams].map(e=>Wt(e,o)));a.push(s),r.verb===`GET_RELATION`&&(i=s),n.resultKey!==``&&(t[n.resultKey]=s)}}finally{i.delete(t)}}}var Xt=new WeakSet;function Zt(e,t){if(e.hasAttribute(`data-ff-editor`)||!e.hasAttribute(`data-ff-aktionen`)||Xt.has(e))return;Xt.add(e);let n=rt(e.getAttribute(`data-ff-aktionen`));Object.values(n).some(e=>e.some(e=>e.type===`RELATION`))&&z(),e.addEventListener(`click`,()=>{Yt(e,t,{})})}var Qt=class extends k{constructor(...e){super(...e),this.label=`Klick mich`}static{this.blockType=`button`}static{this.tagName=`ff-button`}static{this.displayName=`Schaltfläche`}static{this.category=`eingabe`}static{this.defaultProps={label:`Klick mich`}}static{this.resizableWidth=!1}static{this.blockEvents=[{key:`onClick`,name:`Klick`}]}static{this.raster={startW:4,startH:2,minW:2,minH:2}}static{this.customProperties=[]}static{this.styles=[k.styles,o`
      button {
        box-sizing: border-box;
        padding: 7px 16px;
        cursor: pointer;
...
`,rn={dog:x`<ellipse cx="12" cy="13.5" rx="6.3" ry="7"></ellipse><ellipse cx="5.2" cy="11.5" rx="2.4" ry="5.2" transform="rotate(14 5.2 11.5)"></ellipse><ellipse cx="18.8" cy="11.5" rx="2.4" ry="5.2" transform="rotate(-14 18.8 11.5)"></ellipse>`,cat:x`<path d="M5.2 10.5 L3.6 3.2 L10 6.4 Z"></path><path d="M18.8 10.5 L20.4 3.2 L14 6.4 Z"></path><circle cx="12" cy="13.5" r="7"></circle>`,rabbit:x`<ellipse cx="8.8" cy="6.5" rx="2.3" ry="5.6" transform="rotate(-10 8.8 6.5)"></ellipse><ellipse cx="15.2" cy="6.5" rx="2.3" ry="5.6" transform="rotate(10 15.2 6.5)"></ellipse><circle cx="12" cy="16" r="6.2"></circle>`,hamster:x`<circle cx="7.6" cy="8.8" r="2"></circle><ellipse cx="12" cy="14" rx="8.3" ry="6"></ellipse>`,bird:x`<circle cx="9.2" cy="8.8" r="4.6"></circle><ellipse cx="12.5" cy="14.8" rx="5.2" ry="5.4"></ellipse><path d="M5.2 7.6 L2 9.2 L5.4 10.6 Z"></path><path d="M15.5 16.5 L22 20.5 L17.6 13.8 Z"></path>`,reptile:x`<path d="M4.5 14.8 Q4.5 7.2 12 7.2 Q19.5 7.2 19.5 14.8 Z"></path><circle cx="20.6" cy="13.9" r="2.1"></circle><rect x="6.2" y="14.6" width="2.6" height="3" rx="1.2"></rect><rect x="13.4" y="14.6" width="2.6" height="3" rx="1.2"></rect>`,paw:x`<circle cx="6.8" cy="9.6" r="1.9"></circle><circle cx="10.4" cy="7.2" r="1.9"></circle><circle cx="14.6" cy="7.2" r="1.9"></circle><circle cx="18.2" cy="9.6" r="1.9"></circle><path d="M12.5 11.2c-2.9 0-5.3 2.1-5.3 4.4 0 1.7 1.3 2.9 3.1 2.9.9 0 1.5-.3 2.2-.3s1.3.3 2.2.3c1.8 0 3.1-1.2 3.1-2.9 0-2.3-2.4-4.4-5.3-4.4z"></path>`},an=[[`welpe`,`dog`],[`hund`,`dog`],[`kater`,`cat`],[`katze`,`cat`],[`kaninchen`,`rabbit`],[`hase`,`rabbit`],[`meerschweinchen`,`hamster`],[`hamster`,`hamster`],[`ratte`,`hamster`],[`maus`,`hamster`],[`wellensittich`,`bird`],[`sittich`,`bird`],[`papagei`,`bird`],[`vogel`,`bird`],[`schildkr`,`reptile`],[`echse`,`reptile`],[`schlange`,`reptile`],[`gecko`,`reptile`],[`reptil`,`reptile`]];function on(e){let t=e.toLowerCase(),n=`paw`;for(let[e,r]of an)if(t.includes(e)){n=r;break}return b`<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">${rn[n]}</svg>`}var B=class extends k{constructor(...e){super(...e),this.chipVariant=`info`,this.heading=``,this.heading2=``,this.time=``,this.date=``,this.avatar=``,this.meta=``,this.text=``,this.chipText=``,this.headingField=``,this.heading2Field=``,this.timeField=``,this.dateField=``,this.avatarField=``,this.metaField=``,this.textField=``,this.chipTextField=``}static{this.blockType=`card`}static{this.tagName=`ff-card`}static{this.displayName=`Karte`}static{this.category=`anzeige`}static{this.allowedParentTypes=[`kanban-spalte`]}static{this.showInPalette=!1}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={chipVariant:`info`,heading:``,heading2:``,time:``,date:``,avatar:``,meta:``,text:``,chipText:``,headingField:``,heading2Field:``,timeField:``,dateField:``,avatarField:``,metaField:``,textField:``,chipTextField:``}}static{this.bindableSpots=[{prop:`time`,label:`Zeit`},{prop:`date`,label:`Datum`},{prop:`avatar`,label:`Avatar`},{prop:`heading`,label:`Titel`},{prop:`heading2`,label:`Titel 2`},{prop:`meta`,label:`Unterzeile`},{prop:`text`,label:`Textzeile`},{prop:`chipText`,label:`Chip`}]}static{this.customProperties=[tn(`chipVariant`,`Bedeutung des Chips auf der Karte — bestimmt die Chip-Farbe.`)]}static{this.styles=[k.styles,nn,o`
      .card {
        box-sizing: border-box;
        display: flex;
        flex-direction: column;
    ...
    >${this[e]}</span>`}render(){let e=en(this.chipVariant),t=this.hasAttribute(`data-ff-editor`),n=e=>t||e.trim()!==``,r=n(this.heading)||n(this.heading2),i=n(this.time)||n(this.date);return b`<div class="card">
      ${n(this.avatar)||r||n(this.meta)||i?b`<div class="main">
            ${n(this.avatar)?b`<span
                  class="avatar"
                  data-ff-spot="avatar"
                  ?data-ff-bound=${this.avatarField!==``}
                >${this.avatar.trim()===``?C:on(this.avatar)}</span>`:C}
            <div class="titles">
              ${r?b`<div class="trow">
    ...
    </div>`}};O([D()],B.prototype,`chipVariant`,void 0),O([D()],B.prototype,`heading`,void 0),O([D()],B.prototype,`heading2`,void 0),O([D()],B.prototype,`time`,void 0),O([D()],B.prototype,`date`,void 0),O([D()],B.prototype,`avatar`,void 0),O([D()],B.prototype,`meta`,void 0),O([D()],B.prototype,`text`,void 0),O([D()],B.prototype,`chipText`,void 0),O([D()],B.prototype,`headingField`,void 0),O([D()],B.prototype,`heading2Field`,void 0),O([D()],B.prototype,`timeField`,void 0),O([D()],B.prototype,`dateField`,void 0),O([D()],B.prototype,`avatarField`,void 0),O([D()],B.prototype,`metaField`,void 0),O([D()],B.prototype,`textField`,void 0),O([D()],B.prototype,`chipTextField`,void 0),k.defineAndRegister(B);function sn(e){return`${e.toLowerCase()}field`}var cn=new Set,V=new WeakMap,ln=new WeakSet;function un(e){let t=/^(\d{2})\.(\d{2})\.(\d{4})$/.exec(e);return t?`${t[3]}-${t[2]}-${t[1]}`:e}function dn(e){let t=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);return t?`${t[3]}.${t[2]}.${t[1]}`:e}function fn(e){return typeof e.value==`string`?e.value:``}function pn(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(sn(`value`))??``;if(t===``||n===``){V.delete(e);return}let r=ot(P().FF_DATA_SOURCES,t);if(!r){V.delete(e);return}let i=ut(P().SEDATA,r.name,r.tableId)[0];if(i===void 0){V.delete(e),e.value=``;return}let a=r.indexField===``?``:M(i,r.indexField);V.set(e,{row:i,code:n,pindex:a}),e.value=M(i,n)}function mn(e){let t=V.get(e);return t&&ct(t.row,t.code,fn(e)),t}function hn(e){ln.has(e)||(ln.add(e),e.addEventListener(`input`,()=>{mn(e)}),e.addEventListener(`change`,()=>{let t=mn(e);Yt(e,`onChange`,{VALUE:fn(e),PINDEX:t?.pindex??``})}))}function gn(){F()&&cn.forEach(pn)}var _n=!1;function vn(e){e.hasAttribute(`data-ff-editor`)||(cn.add(e),hn(e),_n||(_n=!0,_t(gn)),z(),F()&&pn(e))}function yn(e){cn.delete(e)}var bn=[`date`,`time`,`datetime`];function xn(e){return bn.includes(e)?e:`date`}function Sn(e){return`${String(e.getHours()).padStart(2,`0`)}:${String(e.getMinutes()).padStart(2,`0`)}`}function Cn(e,t){let n=xn(e);return n===`time`?{haupt:Sn(t)}:n===`date`?{haupt:Xe(t)}:{haupt:Sn(t),neben:Xe(t)}}var H=class extends k{constructor(...e){super(...e),this.zeigt=`date`,this.source=``,this.value=``,this.valueField=``}static{this.blockType=`datum`}static{this.tagName=`ff-datum`}static{this.displayName=`Datum`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.bindingRoute={fieldProp:`valueField`}}static{this.bindableSpots=[{prop:`value`,label:`Wert`}]}static{this.defaultProps={zeigt:`date`,source:``,value:``,valueField:``}}static{this.raster={startW:4,startH:3,minW:2,minH:2}}static{this.customProperties=[{attributeName:`zeigt`,name:`Zeigt`,description:`Welche Zeitangabe ohne Datenbindung angezeigt wird.`,kind:`select`,options:[{value:`date`,label:`Datum`},{value:`time`,label:`Zeit`},{value:`datetime`,label:`Datum + Zeit`}]},{attributeName:`valueField`,name:`Feld`,description:`Feld der angeschlossenen Datenquelle, dessen Wert angezeigt wird.`,kind:`field`,hiddenInInspector:!0}]}static{this.styles=[k.styles,o`
      .vuhr {
        display: flex;
        flex-direction: column;
        line-height: 1.25;
    ...
    `]}render(){let e=this.valueField===``?Cn(this.zeigt,new Date):{haupt:this.value};return b`<div class="vuhr">
      <span
        class="haupt"
        data-ff-spot="value"
        ?data-ff-bound=${this.valueField!==``}
      >${e.haupt}</span>
      ${e.neben?b`<span class="neben">${e.neben}</span>`:C}
    </div>`}connectedCallback(){super.connectedCallback(),vn(this)}disconnectedCallback(){super.disconnectedCallback(),yn(this)}};O([D()],H.prototype,`zeigt`,void 0),O([D()],H.prototype,`source`,void 0),O([D()],H.prototype,`value`,void 0),O([D()],H.prototype,`valueField`,void 0),k.defineAndRegister(H);var wn=[`text`,`number`,`textarea`,`select`,`date`,`checkbox`];function Tn(e){return wn.includes(e)?e:`text`}var En=[`text`,`number`,`textarea`,`select`],U=class extends k{constructor(...e){super(...e),this.fieldType=`text`,this.placeholder=`Feldname`,this.options=``,this.source=``,this.value=``,this.valueField=``}static{this.blockType=`formfeld`}static{this.tagName=`ff-formfeld`}static{this.displayName=`Formularfeld`}static{this.category=`eingabe`}static{this.acceptsDataSource=!0}static{this.bindingRoute={fieldProp:`valueField`}}static{this.bindableSpots=[{prop:`value`,label:`Wert`}]}static{this.actionValueSpots=[{prop:`value`,label:`Wert`}]}static{this.blockEvents=[{key:`onChange`,name:`Wert geändert`}]}static{this.defaultProps={width:240,fieldType:`text`,placeholder:`Feldname`,options:``,source:``,value:``,valueField:``}}static{this.raster={startW:6,startH:2,minW:2,minH:2}}static{this.customProperties=[{attributeName:`fieldType`,name:`Feldtyp`,description:`Welche Art Eingabe das Feld annimmt.`,kind:`select`,options:[{value:`text`,label:`Text`},{value:`number`,label:`Zahl`},{value:`textarea`,label:`Mehrzeilig`},{value:`select`,label:`Auswahl`},{value:`date`,label:`Datum`},{value:`checkbox`,label:`Ankreuzfeld`}]},{attributeName:`options`,name:`Auswahl-Optionen`,description:`Nur bei Feldtyp "Auswahl": Einträge durch Komma getrennt (z. B. "Zimmer 1, Zimmer 2") — jeder Eintrag wird eine Dropdown-Zeile.`,kind:`text`,visibleWhen:{attributeName:`fieldType`,equals:`select`}},{attributeName:`valueField`,name:`Feld`,description:`Feld der angeschlossenen Datenquelle, dessen Wert angezeigt und lokal aktualisiert wird.`,kind:`field`,hiddenInInspector:!0}]}static{this.styles=[k.styles,o`
      .feld {
        font-family: var(--se-font);
    ...
    `]}onInput(e){let t=e.target;this.value=Tn(this.fieldType)===`date`?dn(t.value):t.value}onChange(){this.dispatchEvent(new Event(`change`))}textTpl(e,t=!1){return b`<span
      class=${e}
      ?hidden=${t}
      data-ff-editable
    ...
    >${this.placeholder}</span>`}onTextClick(){if(this.hasAttribute(`data-ff-editor`))return;let e=this.renderRoot.querySelector(`input[type="checkbox"]`);e&&(e.checked=!e.checked)}controlTpl(e){switch(e){case`textarea`:return b`<textarea class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}></textarea>`;case`select`:{let e=this.options.split(`,`).map(e=>e.trim()).filter(e=>e!==``),t=this.value!==``&&!e.includes(this.value);return b`<select class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}>
        ...
        />`}}render(){let e=Tn(this.fieldType);return e===`checkbox`?b`<div class="feld">
        <div class="zeile">
    ...
    `]}onSlotChange(e){let t=e.target;this._count=t.assignedElements().filter(e=>!e.hasAttribute(`data-ff-editor-helper`)&&e.tagName.toLowerCase()!==`template`).length}render(){return b`<div class="col v-${en(this.variant)}">
      <div class="head">
        <span class="dot"></span>
        <span
          class="title"
    ...
    </div>`}};O([D()],W.prototype,`variant`,void 0),O([D()],W.prototype,`heading`,void 0),O([Ue()],W.prototype,`_count`,void 0),k.defineAndRegister(W);function On(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function kn(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var An=new Set,jn=new WeakMap,Mn=W.tagName,Nn=B.tagName,G=`data-ff-nicht-zugeordnet`,Pn=`Nicht zugeordnet`;function Fn(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Mn&&!e.hasAttribute(G))}function In(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Nn)}function Ln(e){return Ke().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function Rn(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(`statusfield`)??``;if(t===``)return;let r=ot(P().FF_DATA_SOURCES,t);if(!r)return;let i=Fn(e);if(i.length===0)return;let a=jn.get(e);if(!a){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(Nn);t&&(a=t.cloneNode(!0),jn.set(e,a))}if(!a)return;let o=ut(P().SEDATA,r.name,r.tableId),s=i.map(e=>e.getAttribute(`heading`)??``),c=Ln(a.tagName),l=kn(i.map(e=>e.getAttribute(`auffang`)));e.querySelectorAll(`[`+G+`]`).forEach(e=>e.remove());let u=null,d=()=>(u||(u=document.createElement(Mn),u.setAttribute(`heading`,Pn),u.setAttribute(G,``),u.setAttribute(`style`,i[0].getAttribute(`style`)??`flex-grow:1;flex-basis:0;min-width:0`),e.appendChild(u)),u);for(let e of i)In(e).forEach(e=>e.remove());for(let e of o){let t=a.cloneNode(!0),o=n===``?-1:On(M(e,n),s);(o>=0?i[o]:l>=0?i[l]:d()).appendChild(t);for(let n of c){let r=t.getAttribute(sn(n.prop))??``;r!==``&&(t[n.prop]=M(e,r))}let u=r.indexField===``?``:M(e,r.indexField);K.set(t,{row:e,pindex:u}),t.draggable=!0}}var K=new WeakMap,q=null,zn=new WeakSet;function Bn(e,t){for(let n of t.composedPath())if(n instanceof HTMLElement&&n.tagName.toLowerCase()===Mn&&e.contains(n))return n;return null}function Vn(e,t){if(!q||q.board!==e)return;let n=K.get(q.card);if(!n)return;let r=t.getAttribute(`heading`)??``;Yt(e,`onCardDrop`,{PINDEX:n.pindex,VALUE:r})}function Hn(e){zn.has(e)||(zn.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&K.has(e))??null;n&&Yt(e,`onCardClick`,{PINDEX:K.get(n)?.pindex??``})}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&K.has(e))??null;n&&(q={card:n,board:e},t.dataTransfer?.setData(`text/plain`,K.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`))}),e.addEventListener(`dragend`,()=>{q=null}),e.addEventListener(`dragover`,t=>{let n=Bn(e,t);q?.board===e&&n&&!n.hasAttribute(G)&&(t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`))}),e.addEventListener(`drop`,t=>{let n=Bn(e,t);!n||n.hasAttribute(G)||(t.preventDefault(),Vn(e,n),q=null)}))}function Un(){F()&&An.forEach(Rn)}var Wn=!1;function Gn(e){e.hasAttribute(`data-ff-editor`)||(An.add(e),Hn(e),Wn||(Wn=!0,_t(Un)),z(),F()&&Rn(e))}function Kn(e){An.delete(e)}var J=W.blockType,qn=class extends k{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[J]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:J}}static{this.templateChild={type:B.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.bindingRoute={fieldProp:`statusField`}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Optional: Feld der Datenquelle, dessen Inhalt bestimmt, in welche Spalte ein Eintrag kommt. Leer = alle Einträge in der Auffang-Spalte.`,kind:`field`,hiddenInInspector:!0}]}static{this.defaultChildren=[{type:J,props:{heading:`Offen`,variant:`warning`},children:[{type:B.blockType}]},{type:J,props:{heading:`In Arbeit`,variant:`info`}},{type:J,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[k.styles,o`
    ...
    `]}render(){return b`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),Gn(this)}disconnectedCallback(){super.disconnectedCallback(),Kn(this)}};k.defineAndRegister(qn);var Jn={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Yn=e=>(...t)=>({_$litDirective$:e,values:t}),Xn=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},Zn=`important`,Qn=` !`+Zn,$n=Yn(class extends Xn{constructor(e){if(super(e),e.type!==Jn.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(Qn);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?Zn:``):n[e]=r}}return S}}),er=new Set;function tr(e){let t=e.getAttribute(`spalten`)??``;if(t===``)return[];try{let e=JSON.parse(t);return Array.isArray(e)?e.map(e=>e&&typeof e==`object`&&typeof e.feld==`string`?e.feld:``):[]}catch{return[]}}function nr(e){let t=e.getAttribute(`source`)??``;if(t===``){e.datenzeilen=[];return}let n=ot(P().FF_DATA_SOURCES,t);if(!n){e.datenzeilen=[];return}let r=tr(e);e.datenzeilen=ut(P().SEDATA,n.name,n.tableId).map(e=>r.map(t=>t===``?``:M(e,t)))}function rr(){F()&&er.forEach(nr)}var ir=!1;function ar(e){e.hasAttribute(`data-ff-editor`)||(er.add(e),ir||(ir=!0,_t(rr)),z(),F()&&nr(e))}function or(e){er.delete(e)}var sr=1,cr=/^-?\d{1,3}(\.\d{3})*(,\d+)?$|^-?\d+(,\d+)?$|^-?\d+(\.\d+)?$/,lr=/^(\d{1,2})\.(\d{1,2})\.(\d{2}|\d{4})$/,ur=/^(\d{4})-(\d{2})-(\d{2})$/;function dr(e){let t=e.trim();if(t===``||!cr.test(t))return null;let n=t.includes(`,`)?t.replace(/\./g,``).replace(`,`,`.`):/^-?\d{1,3}(\.\d{3})+$/.test(t)?t.replace(/\./g,``):t,r=Number(n);return Number.isFinite(r)?r:null}function fr(e){let t=e.trim();if(t===``)return null;let n=ur.exec(t);if(n){let[,e,t,r]=n;return pr(Number(e),Number(t),Number(r))}let r=lr.exec(t);if(r){let[,e,t,n]=r,i=Number(n);return pr(n.length===2?i<=69?2e3+i:1900+i:i,Number(t),Number(e))}return null}function pr(e,t,n){if(t<1||t>12||n<1||n>31)return null;let r=new Date(e,t-1,n);return r.getFullYear()!==e||r.getMonth()!==t-1||r.getDate()!==n?null:r.getTime()}function mr(e){let t=0,n=0,r=0;for(let i of e)i.trim()!==``&&(t++,dr(i)!==null&&n++,fr(i)!==null&&r++);return t===0?`text`:r===t?`datum`:n===t?`zahl`:`text`}var hr=new Intl.Collator(`de`,{numeric:!0,sensitivity:`base`});function gr(e,t,n){if(t<0||e.length===0)return e.map(e=>[...e]);let r=e=>e[t]??``,i=mr(e.map(r)),a=n?1:-1;return e.map((e,t)=>({zeile:e,i:t})).sort((e,t)=>{let n=r(e.zeile).trim(),o=r(t.zeile).trim();if(n===``&&o===``)return e.i-t.i;if(n===``)return sr;if(o===``)return-sr;let s=i===`zahl`?(dr(n)??0)-(dr(o)??0):i===`datum`?(fr(n)??0)-(fr(o)??0):hr.compare(n,o);return s===0?e.i-t.i:s*a}).map(e=>[...e.zeile])}var _r=`Spalte {n}`;function Y(e){return _r.replace(`{n}`,String(e+1))}function X(){return[0,1,2].map(e=>({titel:Y(e),feld:``}))}function vr(e,t){if(e&&typeof e==`object`){let n=e;return{titel:typeof n.titel==`string`?n.titel:Y(t),feld:typeof n.feld==`string`?n.feld:``}}return typeof e==`string`?{titel:e,feld:``}:{titel:Y(t),feld:``}}function yr(e){let t;if(Array.isArray(e))t=e.map((e,t)=>vr(e,t));else if(typeof e==`number`&&Number.isFinite(e)||typeof e==`string`&&/^\d+$/.test(e)){let n=Math.max(1,Math.floor(Number(e)));t=[...Array(n).keys()].map(e=>({titel:Y(e),feld:``}))}else t=X();return t.length>8&&(t=t.slice(0,8)),t.length<1&&(t=[{titel:Y(0),feld:``}]),t}function br(e){try{return yr(JSON.parse(e))}catch{return X()}}var xr=4,Z=[10,25,50],Sr=220,Q=class e extends k{constructor(...e){super(...e),this.spalten=X(),this.source=``,this.proSeite=String(Z[0]),this.datenzeilen=[],this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._proSeiteWahl=null,this._klickTimer=null}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.listenBindung={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:_r}}static{this.defaultProps={width:`fill`,source:``,spalten:X(),proSeite:String(Z[0])}}static{this.customProperties=[{attributeName:`proSeite`,name:`Zeilen pro Seite`,description:`Wie viele Datensaetze eine Seite der Tabelle zeigt.`,kind:`select`,options:Z.map(e=>({value:String(e),label:String(e)})),requiresDataSource:!0}]}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get proSeiteAktuell(){if(this._proSeiteWahl!==null)return this._proSeiteWahl;let e=Number(this.proSeite);return Number.isFinite(e)&&e>0?Math.floor(e):Z[0]}spaltenListe(){return yr(this.spalten)}sortierteZeilen(){return this._sortSpalte<0?this.datenzeilen.map(e=>[...e]):gr(this.datenzeilen,this._sortSpalte,this._sortAuf)}klickSortiere(e){this.editable||(this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.requestUpdate())}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}klickSpaltenkopf(t,n){if(!this.editable)return;t.stopPropagation();let r=t.currentTarget.getBoundingClientRect();this.klickTimerAus(),this._klickTimer=setTimeout(()=>{this._klickTimer=null,this.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:e.listenBindung.prop,index:n,top:r.bottom+4,left:r.left},bubbles:!0,composed:!0}))},Sr)}klickTimerAus(){this._klickTimer!==null&&(clearTimeout(this._klickTimer),this._klickTimer=null)}bearbeiteTitel(e,t){if(!this.editable)return;let n=e.currentTarget;if(!n)return;e.stopPropagation(),e.preventDefault();let r=Array.from(n.childNodes),i=n.textContent??``;n.setAttribute(`contenteditable`,`plaintext-only`),n.focus();let a=window.getSelection(),o=document.createRange();o.selectNodeContents(n),a?.removeAllRanges(),a?.addRange(o);let s=!1,c=e=>{if(s)return;s=!0,n.removeAttribute(`contenteditable`),n.removeEventListener(`blur`,l),n.removeEventListener(`keydown`,u);let a=(n.textContent??``).trim(),o=this.spaltenListe();e&&a&&a!==i.trim()&&t<o.length?(o[t]={...o[t],titel:a},this.aendere(o)):n.replaceChildren(...r)},l=()=>c(!0),u=e=>{e.key===`Enter`?(e.preventDefault(),n.blur()):e.key===`Escape`&&(e.preventDefault(),c(!1))};n.addEventListener(`blur`,l),n.addEventListener(`keydown`,u)}connectedCallback(){super.connectedCallback(),ar(this)}disconnectedCallback(){super.disconnectedCallback(),this.klickTimerAus(),or(this)}static{this.styles=[k.styles,o`
      :host { min-width: 0; height: 100%; }
      .tabelle {
        position: relative;
        box-sizing: border-box;
    ...
    `]}render(){let e=this.spaltenListe(),t={gridTemplateColumns:`repeat(${e.length}, minmax(0, 1fr))`},n=e=>e.stopPropagation(),r=this.sortierteZeilen(),i=r.length>0,a=r.length,o=this.proSeiteAktuell,s=i?Math.max(1,Math.ceil(a/o)):1,c=Math.min(Math.max(this._seite,0),s-1),l=i?r.slice(c*o,(c+1)*o):[],u=i?o:xr,d=i?``:`—`,ee=[...l,...Array.from({length:Math.max(0,u-l.length)},()=>null)];return b`<div class="tabelle">
      <div class="steuerung">
        <button
    ...
    `]}render(){return b`<div class="zeile"><slot></slot></div>`}};k.defineAndRegister(Mr)})();
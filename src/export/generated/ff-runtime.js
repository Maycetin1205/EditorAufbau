...
`,lr=`ff-dialog-rahmen`,ur=`ff-dialog-schliessen`;function dr(e,t){let n=Number(e);return Number.isFinite(n)&&n>0?n:t}var q=class extends Ie{constructor(...e){super(...e),this.titel=`Dialog`,this.breite=520,this.hoehe=380,this.viewport=!1,this.mitWerkzeug=!1,this.escapeSchliesst=!1,this.escapeRegistriert=!1,this.aufTaste=e=>{e.key===`Escape`&&(e.stopPropagation(),this.schliesse())}}static{this.styles=o`
  ...
  `}aktualisiereEscape(){let e=this.isConnected&&this.escapeSchliesst;e!==this.escapeRegistriert&&(e?document.addEventListener(`keydown`,this.aufTaste,!0):document.removeEventListener(`keydown`,this.aufTaste,!0),this.escapeRegistriert=e)}schliesse(){this.dispatchEvent(new CustomEvent(ur,{bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this.aktualisiereEscape()}updated(e){e.has(`escapeSchliesst`)&&this.aktualisiereEscape()}disconnectedCallback(){this.escapeRegistriert&&=(document.removeEventListener(`keydown`,this.aufTaste,!0),!1),super.disconnectedCallback()}render(){return w`
    ...
    >${this.placeholder}</span>`}onTextClick(){this.hasAttribute(`data-ff-editor`)||this.setzeHaken(!this.angehakt)}setzeHaken(e){this.angehakt!==e&&(this.angehakt=e,this.dispatchEvent(new Event(`change`)))}controlTpl(e){switch(e){case`textarea`:return w`<textarea class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}></textarea>`;case`select`:{let e=this.options.split(`,`).map(e=>e.trim()).filter(e=>e!==``),t=this.value!==``&&!e.includes(this.value);return w`<select class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}>
      ...
      >
        ${this.controlTpl(e)}
        ${Or.includes(e)?this.textTpl(e===`select`?`ph ph-select`:`ph`,this.value!==``):D}
      </div>
    ...
    `]}render(){return w`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),Gr(this)}disconnectedCallback(){super.disconnectedCallback(),Kr(this)}};M.defineAndRegister(Jr);var Yr={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Xr=e=>(...t)=>({_$litDirective$:e,values:t}),Zr=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},Qr=`important`,$r=` !important`,ei=Xr(class extends Zr{constructor(e){if(super(e),e.type!==Yr.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith($r);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?Qr:``):n[e]=r}}return E}}),ti=[10,25,50],ni=`passend`,ri=ti[0];function ii(e){let t=Number(e);return ti.some(e=>e===t)?t:null}function ai(e,t){return Math.max(1,Math.floor((e-t)/32))}function oi({sichtbar:e,hatQuelle:t,proSeite:n,wunschSeite:r,platzhalterZeilen:i}){let a=t?Math.max(1,Math.ceil(e.length/n)):1,o=Math.min(Math.max(r,0),a-1);return t?{seiten:a,seite:o,zeilen:[...e.slice(o*n,(o+1)*n)]}:{seiten:a,seite:o,zeilen:Array.from({length:i},()=>null)}}function si(e){if(!e.hasAttribute(`fuellt`))return null;let t=e.renderRoot.querySelector(`.koerper`),n=e.renderRoot.querySelector(`.kopf`);return!(t instanceof HTMLElement)||!(n instanceof HTMLElement)?null:ai(t.clientHeight,n.offsetHeight)}function ci(e,t){if(typeof ResizeObserver>`u`)return null;let n=e.renderRoot.querySelector(`.koerper`);if(!n)return null;let r=new ResizeObserver(t);return r.observe(n),r}var li=`text`,ui=[{wert:li,name:`Text`,spur:`minmax(0, 1fr)`,klasse:``,zelle:e=>e},{wert:`zahl`,name:`Zahl`,spur:`90px`,klasse:`zahl`,zelle:e=>e},{wert:`datum`,name:`Datum`,spur:`100px`,klasse:`zahl`,zelle:e=>e},{wert:`status`,name:`Status`,spur:`120px`,klasse:`status`,zelle:e=>w`<span class="chip">${e}</span>`}];function di(e){return ui.find(t=>t.wert===e)??ui[0]}var fi=ui.map(e=>({wert:e.wert,name:e.name})),pi=`Spalte {n}`;function mi(e){return pi.replace(`{n}`,String(e+1))}function hi(e){return{titel:mi(e),feld:``,art:li}}function gi(){return[0,1,2].map(e=>hi(e))}function _i(e,t){if(e&&typeof e==`object`){let n=e;return{titel:typeof n.titel==`string`?n.titel:mi(t),feld:typeof n.feld==`string`?n.feld:``,art:typeof n.art==`string`?n.art:li}}return typeof e==`string`?{...hi(t),titel:e}:hi(t)}function vi(e){let t;if(Array.isArray(e))t=e.map((e,t)=>_i(e,t));else if(typeof e==`number`&&Number.isFinite(e)||typeof e==`string`&&/^\d+$/.test(e)){let n=Math.max(1,Math.floor(Number(e)));t=[...Array(n).keys()].map(e=>hi(e))}else t=gi();return t.length>8&&(t=t.slice(0,8)),t.length<1&&(t=[hi(0)]),t}function yi(e){try{return vi(JSON.parse(e))}catch{return gi()}}function bi(e){return yi(e.getAttribute(`spalten`)??``).map(e=>e.feld)}function xi(e){let t=e.getAttribute(`source`)??``;if(t===``){e.datenzeilen=[];return}let n=P(U().FF_DATA_SOURCES,t);if(!n){e.datenzeilen=[];return}let r=bi(e),{rows:i,gefiltert:a}=xt(e,Ar(L(U().SEDATA,n.name,n.tableId),e.getAttribute(`tagfield`)??``,In())),o=ht(z(e),i,e=>e)[0]??-1,s=Yn(e);e.rohzeilen=i,e.auswahlIndex=o,e.durchAuswahlGefiltert=a,e.datenzeilen=i.map(e=>r.map(t=>t===``?``:s(e,t)))}var Si=Wn({hydriere:xi}),Ci=Si.connect,wi=Si.disconnect,Ti=1,Ei=/^-?\d{1,3}(\.\d{3})*(,\d+)?$|^-?\d+(,\d+)?$|^-?\d+(\.\d+)?$/,Di=/^(\d{1,2})\.(\d{1,2})\.(\d{2}|\d{4})$/,Oi=/^(\d{4})-(\d{2})-(\d{2})$/;function ki(e){let t=e.trim();if(t===``||!Ei.test(t))return null;let n=t.includes(`,`)?t.replace(/\./g,``).replace(`,`,`.`):/^-?\d{1,3}(\.\d{3})+$/.test(t)?t.replace(/\./g,``):t,r=Number(n);return Number.isFinite(r)?r:null}function Ai(e){let t=e.trim();if(t===``)return null;let n=Oi.exec(t);if(n){let[,e,t,r]=n;return ji(Number(e),Number(t),Number(r))}let r=Di.exec(t);if(r){let[,e,t,n]=r,i=Number(n);return ji(n.length===2?i<=69?2e3+i:1900+i:i,Number(t),Number(e))}return null}function ji(e,t,n){if(t<1||t>12||n<1||n>31)return null;let r=new Date(e,t-1,n);return r.getFullYear()!==e||r.getMonth()!==t-1||r.getDate()!==n?null:r.getTime()}function Mi(e){let t=0,n=0,r=0;for(let i of e)i.trim()!==``&&(t++,ki(i)!==null&&n++,Ai(i)!==null&&r++);return t===0?`text`:r===t?`datum`:n===t?`zahl`:`text`}var Ni=new Intl.Collator(`de`,{numeric:!0,sensitivity:`base`});function Pi(e,t,n){if(t<0||e.length===0)return e.map((e,t)=>t);let r=n=>e[n][t]??``,i=Mi(e.map(e=>e[t]??``)),a=n?1:-1;return e.map((e,t)=>t).sort((e,t)=>{let n=r(e).trim(),o=r(t).trim();if(n===``&&o===``)return e-t;if(n===``)return Ti;if(o===``)return-1;let s=i===`zahl`?(ki(n)??0)-(ki(o)??0):i===`datum`?(Ai(n)??0)-(Ai(o)??0):Ni.compare(n,o);return s===0?e-t:s*a})}function Fi(e,t,n){return w`<div class="steuerung">
    <button
    ...
    <button
      ...
      @pointerdown=${n}
      @click=${r=>{n(r);let i=e();i.length<8&&(i.push(hi(i.length)),t(i))}}
    >+</button>
  </div>`}function Ii(e,t){let n=e.currentTarget;if(!n)return;e.stopPropagation(),e.preventDefault();let r=Array.from(n.childNodes),i=n.textContent??``;n.setAttribute(`contenteditable`,`plaintext-only`),n.focus();let a=window.getSelection(),o=document.createRange();o.selectNodeContents(n),a?.removeAllRanges(),a?.addRange(o);let s=!1,c=e=>{if(s)return;s=!0,n.removeAttribute(`contenteditable`),n.removeEventListener(`blur`,l),n.removeEventListener(`keydown`,u);let a=(n.textContent??``).trim();e&&a&&a!==i.trim()?t(a):n.replaceChildren(...r)},l=()=>c(!0),u=e=>{e.key===`Enter`?(e.preventDefault(),n.blur()):e.key===`Escape`&&(e.preventDefault(),c(!1))};n.addEventListener(`blur`,l),n.addEventListener(`keydown`,u)}function Li(e,t,n,r){Ii(e,e=>{let i=n();t>=i.length||(i[t]={...i[t],titel:e},r(i))})}var Ri=220,zi=new WeakMap;function Bi(e){let t=zi.get(e);t!==void 0&&(clearTimeout(t),zi.delete(e))}function Vi(e,t,n,r){t.stopPropagation();let i=t.currentTarget.getBoundingClientRect();Bi(e),zi.set(e,setTimeout(()=>{zi.delete(e),e.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:n,index:r,top:i.bottom+4,left:i.left},bubbles:!0,composed:!0}))},Ri))}function Hi(e,t){let n=[];return e.forEach((e,r)=>{pr(e,t)&&n.push(r)}),n}function Ui(e,t){return!e&&t.trim()!==``}function Wi(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}var Gi=[{value:`ja`,label:`Ja`},{value:`nein`,label:`Nein`}],Ki=[{attributeName:`suche`,name:`Suchzeile`,description:`Zeigt ueber der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,kind:`segment`,options:Gi,requiresDataSource:!0},{attributeName:`zeilenWaehler`,name:`Zeilen-Wähler`,description:`Zeigt dem Bediener unten in der Maske den Wähler „Zeilen pro Seite" — er darf die Einstellung dann für seine Sitzung übersteuern. Nein: es gilt unveränderlich, was hier im Editor eingestellt ist.`,kind:`segment`,options:Gi,requiresDataSource:!0},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt die Tabelle nur Saetze des Tages, den der Tageswaehler zeigt. Leer = alle Saetze.`,kind:`field`}];function qi(e,t){return w`<div class="fusszeile">
    ...
    <div class="seiten-nav">
      ...
      >
        ...
        ${ti.map(t=>w`<option value=${t} ?selected=${e.einstellung===String(t)}>${t} pro Seite</option>`)}
      </select>`:D}
      <button
  ...
  </div>`}var Ji=`—`;function Yi(e,t){return w`
      ...
      <div class="kopf" style=${ei(e.cols)}>
        ...
        ${e.zeilen.map(n=>w`<div
          ...
          >
            ${``}
            ${e.spalten.map((t,r)=>{let i=di(t.art),a=n===null?Ji:e.datenzeilen[n]?.[r]??``;return w`<div class=${i.klasse}>${i.zelle(a)}</div>`})}
          </div>`)}
        ${``}
        <div class="lineal" style=${ei(e.cols)}>
...
`,Zi=4,Q=class e extends M{constructor(...e){super(...e),this.spalten=gi(),this.source=``,this.suche=`ja`,this.proSeite=ni,this.zeilenWaehler=`nein`,this._suchtext=``,this.datenzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._proSeiteWahl=null,this._proSeiteGemessen=null,this._beobachter=null}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.listenBindung={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:pi,eintragsWahl:{key:`art`,label:`Darstellung`,optionen:fi,standard:li}}}static{this.defaultProps={width:`fill`,source:``,spalten:gi(),suche:`ja`,tagField:``,proSeite:ni,zeilenWaehler:`nein`}}static{this.customProperties=Ki}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get einstellung(){return this._proSeiteWahl??this.proSeite}get proSeiteAktuell(){return ii(this.einstellung)??this._proSeiteGemessen??ri}waehleProSeite(e){this.hasAttribute(`data-ff-editor`)?this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`proSeite`,value:e},bubbles:!0,composed:!0})):this._proSeiteWahl=e,this._seite=0,this.requestUpdate()}messeRumpf(){let e=si(this);e!==this._proSeiteGemessen&&(this._proSeiteGemessen=e,this.requestUpdate())}spaltenListe(){return vi(this.spalten)}sichtbareIndizes(){let e=Hi(this.datenzeilen,this._suchtext);return this._sortSpalte<0?e:Pi(e.map(e=>this.datenzeilen[e]),this._sortSpalte,this._sortAuf).map(t=>e[t])}klickZeile(e){if(e===null||this.hasAttribute(`data-ff-editor`))return;let t=z(this),n=this.rohzeilen[e];t===``||n===void 0||gt(t,n)}setzeSuchtext(e){this._suchtext=e,this._seite=0,this.requestUpdate()}klickSortiere(e){this.editable||(this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.requestUpdate())}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}beobachte(){this._beobachter||(this._beobachter=ci(this,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}connectedCallback(){super.connectedCallback(),Ci(this),this.beobachte()}firstUpdated(){this.beobachte()}disconnectedCallback(){super.disconnectedCallback(),Bi(this),this._beobachter?.disconnect(),this._beobachter=null,wi(this)}static{this.styles=[M.styles,Dn,Xi]}render(){let t=this.spaltenListe(),n={gridTemplateColumns:t.map(e=>di(e.art).spur).join(` `)},r=e=>e.stopPropagation(),i=this.sichtbareIndizes(),a=Ui(this.hasAttribute(`data-ff-editor`),this.source),o=i.length,s=this.proSeiteAktuell,{seiten:c,seite:l,zeilen:u}=oi({sichtbar:i,hatQuelle:a,proSeite:s,wunschSeite:this._seite,platzhalterZeilen:Zi});return w`<div class="tabelle" style=${ei({"--zeilen-hoehe":`32px`})}>
      ${Fi(()=>this.spaltenListe(),e=>this.aendere(e),r)}
      ${Yi({spalten:t,cols:n,editable:this.editable,zeigeSuche:this.suche===`ja`,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,zeilen:u,datenzeilen:this.datenzeilen,hatQuelle:a,auswahlIndex:this.auswahlIndex},{setzeSuchtext:e=>this.setzeSuchtext(e),dblklickKopf:(e,t)=>{this.editable&&(Bi(this),Li(e,t,()=>this.spaltenListe(),e=>this.aendere(e)))},klickKopf:(t,n)=>{this.editable&&Vi(this,t,e.listenBindung.prop,n),this.klickSortiere(n)},klickZeile:e=>this.klickZeile(e),stop:r})}
      ${qi({hatQuelle:a,sichtbar:o,gesamt:this.datenzeilen.length,suchtAktiv:this._suchtext.trim()!==``,auswahlAktiv:this.durchAuswahlGefiltert,zeigeWaehler:this.hasAttribute(`data-ff-editor`)||this.zeilenWaehler===`ja`,einstellung:this.einstellung,seite:l,seiten:c},{waehleProSeite:e=>this.waehleProSeite(e),blaettere:e=>{this._seite=e,this.requestUpdate()},stop:r})}
    </div>`}};j([A({converter:{fromAttribute:e=>e?yi(e):gi(),toAttribute:e=>JSON.stringify(e)}})],Q.prototype,`spalten`,void 0),j([A()],Q.prototype,`source`,void 0),j([A()],Q.prototype,`suche`,void 0),j([A()],Q.prototype,`proSeite`,void 0),j([A()],Q.prototype,`zeilenWaehler`,void 0),j([A({attribute:!1})],Q.prototype,`datenzeilen`,void 0),j([A({attribute:!1})],Q.prototype,`rohzeilen`,void 0),j([A({attribute:!1})],Q.prototype,`auswahlIndex`,void 0),j([A({attribute:!1})],Q.prototype,`durchAuswahlGefiltert`,void 0),M.defineAndRegister(Q);var Qi=Hn(`text`);function $i(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(Qi)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function ea(e){let t=Xn(e,Qi);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function ta(e){$i(e)&&(e.text=``)}var na=Wn({hydriere:ea,verdrahte:ta}),ra=na.connect,ia=na.disconnect,aa=6,oa=96,sa=14,ca={duenn:`300`,normal:`400`,fett:`700`},la={links:`left`,mitte:`center`,rechts:`right`},ua={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},da=`standard`;function fa(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(oa,Math.max(aa,t)):sa}function pa(e){return typeof e==`string`&&e in ca?e:`normal`}function ma(e){return typeof e==`string`&&e in la?e:`links`}function ha(e){return typeof e==`string`&&e in ua?e:da}var $=class extends M{constructor(...e){super(...e),this.groesse=sa,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=da,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:sa,gewicht:`normal`,ausrichtung:`links`,farbe:da,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:aa,max:oa,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[M.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return w`<div
      class="text"
      style=${ei({fontSize:`${fa(this.groesse)}px`,fontWeight:ca[pa(this.gewicht)],textAlign:la[ma(this.ausrichtung)],color:ua[ha(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),ra(this)}disconnectedCallback(){super.disconnectedCallback(),ia(this)}};j([A({type:Number})],$.prototype,`groesse`,void 0),j([A()],$.prototype,`gewicht`,void 0),j([A()],$.prototype,`ausrichtung`,void 0),j([A()],$.prototype,`farbe`,void 0),j([A()],$.prototype,`text`,void 0),j([A()],$.prototype,`source`,void 0),j([A()],$.prototype,`textField`,void 0),M.defineAndRegister($);var ga=[`waagerecht`,`senkrecht`],_a=`waagerecht`;function va(e){return ga.includes(e)?e:_a}var ya=class extends M{constructor(...e){super(...e),this.richtung=_a}static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`,richtung:_a}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1,varianten:[{wenn:{attributeName:`richtung`,equals:`senkrecht`},startW:1,startH:6,breiteZiehbar:!1}]}}static{this.customProperties=[{attributeName:`richtung`,name:`Richtung`,description:`Waagerecht trennt oben von unten, senkrecht links von rechts.`,kind:`select`,options:[{value:`waagerecht`,label:`Waagerecht`},{value:`senkrecht`,label:`Senkrecht`}]}]}static{this.styles=[M.styles,o`
    ...
    `]}render(){return w`<div class="zeile"><slot></slot></div>`}};M.defineAndRegister(ba),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;H(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();
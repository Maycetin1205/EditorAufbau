...
`,K=class extends M{constructor(...e){super(...e),this.chipVariant=`info`,this.heading=``,this.heading2=``,this.time=``,this.date=``,this.avatar=``,this.meta=``,this.text=``,this.chipText=``,this.headingField=``,this.heading2Field=``,this.timeField=``,this.dateField=``,this.avatarField=``,this.metaField=``,this.textField=``,this.chipTextField=``}static{this.blockType=`card`}static{this.tagName=`ff-card`}static{this.displayName=`Karte`}static{this.category=`anzeige`}static{this.allowedParentTypes=[`kanban-spalte`]}static{this.showInPalette=!1}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={chipVariant:`info`,heading:``,heading2:``,time:``,date:``,avatar:``,meta:``,text:``,chipText:``,headingField:``,heading2Field:``,timeField:``,dateField:``,avatarField:``,metaField:``,textField:``,chipTextField:``}}static{this.bindableSpots=[{prop:`time`,label:`Zeit`},{prop:`date`,label:`Datum`},{prop:`avatar`,label:`Avatar`},{prop:`heading`,label:`Titel`},{prop:`heading2`,label:`Titel 2`},{prop:`meta`,label:`Unterzeile`},{prop:`text`,label:`Textzeile`},{prop:`chipText`,label:`Chip`}]}static{this.customProperties=[On(`chipVariant`,`Bedeutung des Chips auf der Karte — bestimmt die Chip-Farbe.`)]}static{this.styles=[M.styles,kn,Ln]}stelle(e,t){return w`<span
    ...
    >${this[e]}</span>`}hatReiter(){return this.hasAttribute(`data-ff-editor`)||this.date.trim()!==``||this.time.trim()!==``}updated(e){super.updated(e),this.toggleAttribute(`hat-reiter`,this.hatReiter())}render(){let e=En(this.chipVariant),t=this.hasAttribute(`data-ff-editor`),n=e=>t||e.trim()!==``,r=this.hatReiter(),i=n(this.avatar)||n(this.heading)||n(this.meta),a=n(this.heading2)||n(this.chipText);return w`<div class="card v-${e}${r?``:` ohne-reiter`}">
      ...
      ${i?w`<div class="kopf">
            ${n(this.avatar)?w`<span
                ...
                >${this.avatar.trim()===``?E:In(this.avatar)}</span>`:E}
            <div class="namen">
    ...
    `]}setzeTag(e){Wn(e),this.tag=Un()}render(){return w`<div class="waehler">
      <div class="riegel">
        <button class="pfeil" title="Vortag" @click=${()=>this.setzeTag(Bn(this.tag,-1))}>‹</button>
        <input
          class="feld"
          type="date"
          .value=${this.tag}
        ...
        />
        <button class="pfeil" title="Folgetag" @click=${()=>this.setzeTag(Bn(this.tag,1))}>›</button>
      </div>
      <button class="heute" @click=${()=>this.setzeTag(zn(new Date))}>Heute</button>
    </div>`}connectedCallback(){super.connectedCallback(),this.tag=Un()||zn(new Date),!this.hasAttribute(`data-ff-editor`)&&(this.setzeTag(this.tag),this.tagAbmelden?.(),this.tagAbmelden=Gn(()=>{this.tag=Un()}))}disconnectedCallback(){super.disconnectedCallback(),this.tagAbmelden?.(),this.tagAbmelden=null}};j([Be()],Kn.prototype,`tag`,void 0),M.defineAndRegister(Kn);var qn={attributeName:`fieldType`,equals:`nachschlagen`},Jn=[{attributeName:`fieldType`,name:`Feldtyp`,description:`Welche Art Eingabe das Feld annimmt.`,kind:`select`,options:[{value:`text`,label:`Text`},{value:`number`,label:`Zahl`},{value:`textarea`,label:`Mehrzeilig`},{value:`select`,label:`Auswahl`},{value:`date`,label:`Datum`},{value:`checkbox`,label:`Ankreuzfeld`},{value:`nachschlagen`,label:`Nachschlagen`}]},{attributeName:`options`,name:`Auswahl-Optionen`,description:`Nur bei Feldtyp "Auswahl": Einträge durch Komma getrennt (z. B. "Zimmer 1, Zimmer 2") — jeder Eintrag wird eine Dropdown-Zeile.`,kind:`text`,visibleWhen:{attributeName:`fieldType`,equals:`select`}},{attributeName:`nachschlagQuelle`,name:`Quelle`,description:`Nur bei Feldtyp "Nachschlagen": aus dieser Datenquelle wählt der Bediener eine Zeile.`,kind:`quelle`,visibleWhen:qn},{attributeName:`anzeigeFeld`,name:`Angezeigt wird`,description:`Feld der Nachschlage-Quelle, dessen Wert der Bediener sieht (z. B. der Name).`,kind:`field`,quelleProp:`nachschlagQuelle`,klarnameProp:`anzeigeTitel`,visibleWhen:qn},{attributeName:`speicherFeld`,name:`Gespeichert wird`,description:`Feld der Nachschlage-Quelle, dessen Wert die Maske sich merkt und die Kette "Wert geändert" weitergibt (z. B. die Nummer).`,kind:`field`,quelleProp:`nachschlagQuelle`,klarnameProp:`speicherTitel`,visibleWhen:qn},{attributeName:`einzigerTreffer`,name:`Einzigen Treffer übernehmen`,description:`Bleibt in der Maske genau EIN Satz übrig (weil das Feld der Auswahl eines anderen folgt), übernimmt es diesen von selbst — ohne dass der Bediener die Lupe drückt. Nur in ein leeres Feld; die Lupe bleibt daneben bedienbar.`,kind:`segment`,options:[{value:`ja`,label:`Ja`},{value:`nein`,label:`Nein`}],visibleWhen:qn},{attributeName:`valueField`,name:`Feld`,description:`Feld der angeschlossenen Datenquelle, dessen Wert angezeigt und lokal aktualisiert wird.`,kind:`field`,visibleWhen:{attributeName:`fieldType`,notEquals:`nachschlagen`}}];function Yn(e){return`${e.toLowerCase()}field`}function Xn(e){let t=e.split(`::`);if(t.length!==2)return{quelleId:``,code:e};let[n,r]=t;return n===``||r===``?{quelleId:``,code:e}:{quelleId:n,code:r}}function Zn(e){let t=new Set,n=!1,r=()=>{Mt()&&t.forEach(e.hydriere)};return{connect:i=>{i.hasAttribute(`data-ff-editor`)||(t.add(i),e.verdrahte?.(i),n||(n=!0,Lt(r),Gn(r),ft(r)),Xt(),Mt()&&e.hydriere(i))},disconnect:e=>{t.delete(e)}}}var Qn=Ke.toLowerCase(),$n=``;function er(e){if(e.length===0)return``;let t=[];for(let n of e){let e=n.trim();if(e===``)return``;t.push(e)}return t.join($n)}function tr(e){let t=e.getAttribute(Qn)??``;if(t===``)return[];try{let e=JSON.parse(t);if(!Array.isArray(e))return[];let n=[];for(let t of e){if(!t||typeof t!=`object`)continue;let e=t;if(typeof e.quelleId!=`string`||e.quelleId===``)continue;let r=[];for(let t of Array.isArray(e.keyPairs)?e.keyPairs:[]){if(!t||typeof t!=`object`)continue;let e=t;typeof e.fromField!=`string`||typeof e.toField!=`string`||e.fromField.trim()===``||e.toField.trim()===``||r.push({fromField:e.fromField,toField:e.toField})}r.length!==0&&n.push({quelleId:e.quelleId,keyPairs:r})}return n}catch{return[]}}function nr(e){let t=tr(e);if(t.length===0)return(e,t)=>F(e,Xn(t).code);let n=U().SEDATA,r=U().FF_DATA_SOURCES,i=new Map;for(let e of t){let t=P(r,e.quelleId);if(!t)continue;let a=L(n,t.name,t.tableId),o=new Map;for(let t of a){let n=er(e.keyPairs.map(e=>F(t,e.toField)));n!==``&&!o.has(n)&&o.set(n,t)}i.set(e.quelleId,{nachSchluessel:o,hierFelder:e.keyPairs.map(e=>e.fromField)})}return(e,t)=>{let{quelleId:n,code:r}=Xn(t);if(n===``)return F(e,r);let a=i.get(n);if(!a)return``;let o=er(a.hierFelder.map(t=>F(e,t)));if(o===``)return``;let s=a.nachSchluessel.get(o);return s===void 0?``:F(s,r)}}function rr(e,t){let n=e.getAttribute(`source`)??``,r=e.getAttribute(t)??``;if(n===``||r===``)return{art:`ungebunden`};let i=P(U().FF_DATA_SOURCES,n);if(!i)return{art:`ohneQuelle`};let a=St(e,L(U().SEDATA,i.name,i.tableId));if(a===void 0)return{art:`ohneZeile`};let{quelleId:o,code:s}=Xn(r);return{art:`wert`,wert:o===``?F(a,s):nr(e)(a,r),zeile:a,quelle:i,quelleId:o,reinerCode:s}}var ir=new WeakMap,ar=new WeakSet;function or(e){let t=/^(\d{2})\.(\d{2})\.(\d{4})$/.exec(e);return t?`${t[3]}-${t[2]}-${t[1]}`:e}function sr(e){let t=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e);return t?`${t[3]}.${t[2]}.${t[1]}`:e}function cr(e){return typeof e.value==`string`?e.value:``}function lr(e){if(e.pruefeEigenenWert?.(),e.getAttribute(`fieldtype`)===`nachschlagen`){ir.delete(e);return}let t=rr(e,Yn(`value`));if(t.art!==`wert`){ir.delete(e),t.art===`ohneZeile`&&(e.value=``);return}let{zeile:n,quelle:r,quelleId:i,reinerCode:a,wert:o}=t,s=r.indexField===``?``:F(n,r.indexField);i===``?ir.set(e,{row:n,code:a,pindex:s}):ir.delete(e),e.value=o}function ur(e){let t=ir.get(e);return t&&rt(t.row,t.code,cr(e)),t}function dr(e){ar.has(e)||(ar.add(e),e.addEventListener(`input`,()=>{ur(e)}),e.addEventListener(`change`,()=>{let t=ur(e);xn(e,`onChange`,{VALUE:cr(e),PINDEX:t?.pindex??``}).catch(bn)}))}var fr=Zn({hydriere:lr,verdrahte:dr}),pr=fr.connect,mr=fr.disconnect,hr=o`
  .feld {
    font-family: var(--se-font);
...
`,gr=`ff-dialog-rahmen`,_r=`ff-dialog-schliessen`;function vr(e,t){let n=Number(e);return Number.isFinite(n)&&n>0?n:t}var q=class extends k{constructor(...e){super(...e),this.titel=`Dialog`,this.breite=520,this.hoehe=380,this.viewport=!1,this.mitWerkzeug=!1,this.escapeSchliesst=!1,this.escapeRegistriert=!1,this.aufTaste=e=>{e.key===`Escape`&&(e.stopPropagation(),this.schliesse())}}static{this.styles=o`
  ...
  `}aktualisiereEscape(){let e=this.isConnected&&this.escapeSchliesst;e!==this.escapeRegistriert&&(e?document.addEventListener(`keydown`,this.aufTaste,!0):document.removeEventListener(`keydown`,this.aufTaste,!0),this.escapeRegistriert=e)}schliesse(){this.dispatchEvent(new CustomEvent(_r,{bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this.aktualisiereEscape()}updated(e){e.has(`escapeSchliesst`)&&this.aktualisiereEscape()}disconnectedCallback(){this.escapeRegistriert&&=(document.removeEventListener(`keydown`,this.aufTaste,!0),!1),super.disconnectedCallback()}render(){return w`
      ...
      <div class="buehne">
        <section
          ...
          role="dialog"
          aria-modal="true"
          style="width:${vr(this.breite,520)}px;height:${vr(this.hoehe,380)}px"
        >
          <header class="kopf">
    ...
    >${this.placeholder}</span>`}onTextClick(){this.hasAttribute(`data-ff-editor`)||this.setzeHaken(!this.angehakt)}setzeHaken(e){this.angehakt!==e&&(this.angehakt=e,this.dispatchEvent(new Event(`change`)))}controlTpl(e){switch(e){case`textarea`:return w`<textarea class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}></textarea>`;case`select`:{let e=this.options.split(`,`).map(e=>e.trim()).filter(e=>e!==``),t=this.value!==``&&!e.includes(this.value);return w`<select class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}>
          ...
          class="ctrl"
          type=${e}
          .value=${e===`date`?or(this.value):this.value}
          @input=${this.onInput}
          @change=${this.onChange}
        />`}}onLupe(){this.hasAttribute(`data-ff-editor`)||Nr({el:this,quelleId:this.nachschlagQuelle,anzeigeFeld:this.anzeigeFeld,speicherFeld:this.speicherFeld,anzeigeTitel:this.anzeigeTitel,speicherTitel:this.speicherTitel,titel:this.placeholder,onUebernehmen:(e,t,n)=>{this.uebernimmSatz(e,t,n),this.dispatchEvent(new Event(`change`))}})}leereNachschlagen(){this.satz=void 0,this.anzeige=``,this.value=``,vt(z(this))}uebernimmSatz(e,t,n){this.anzeige=e===``?t:e,this.value=t,this.satz=n,_t(z(this),n)}onNachschlagVerlassen(){if(this.hasAttribute(`data-ff-editor`))return;let e=Or(this.getippt??this.anzeige,this.anzeige,this.value);this.getippt=null,e===`leeren`&&(this.leereNachschlagen(),this.dispatchEvent(new Event(`change`)))}pruefeEigenenWert(){Fr(this.fieldType)===`nachschlagen`&&(this.satz!==void 0&&!Dr(this,this.satz)&&this.leereNachschlagen(),this.uebernimmEinzigenTreffer())}uebernimmEinzigenTreffer(){if(this.einzigerTreffer!==`ja`)return;let e=Tr({el:this,quelleId:this.nachschlagQuelle,anzeigeFeld:this.anzeigeFeld,speicherFeld:this.speicherFeld});if(!e.ok)return;let t=Er(e.eintraege,this.satz===void 0);t&&this.uebernimmSatz(t.anzeige,t.wert,t.satz)}render(){let e=Fr(this.fieldType);if(e===`checkbox`)return w`<div class="feld">
        <div class="zeile">
          <input
            class="ctrl"
            type="checkbox"
...
`;function Vr(e,t,n,r){return{attributeName:e,name:t,description:n,kind:`select`,options:[{value:`nein`,label:`Nein`},{value:`ja`,label:`Ja`}],...r}}var Y=class extends M{constructor(...e){super(...e),this.variant=`info`,this.heading=`Neue Spalte`,this.leerHinweis=``,this._count=0}static{this.blockType=`kanban-spalte`}static{this.tagName=`ff-kanban-spalte`}static{this.displayName=`Kanban-Spalte`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[K.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={variant:`info`,heading:`Neue Spalte`,auffang:`nein`}}static{this.customProperties=[On(`variant`,`Bedeutung der Spalte — bestimmt ihre Farbwelt (Kopf, Fläche, Rahmen).`),Vr(`auffang`,`Auffangspalte`,`Einträge ohne passenden Spaltentitel landen hier. Ohne Auffangspalte landen sie in der ersten Spalte.`,{requiresDataSource:!0,exclusiveAmongSiblings:!0})]}static{this.styles=[M.styles,Br,o`
    ...
    </div>`}};j([A()],Y.prototype,`variant`,void 0),j([A()],Y.prototype,`heading`,void 0),j([A({attribute:!1})],Y.prototype,`leerHinweis`,void 0),j([Be()],Y.prototype,`_count`,void 0),M.defineAndRegister(Y);function Hr(e,t,n){return t===``||n===``?[...e]:e.filter(e=>Rn(F(e,t))===n)}function Ur(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function Wr(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var Gr=new WeakMap,Kr=Y.tagName,qr=K.tagName;function Jr(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Kr)}function Yr(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===qr)}function Xr(e,t){let n=e.getAttribute(`leertext`)??`Keine Datensätze.`;for(let e of t)e.leerHinweis=Yr(e).length===0?n:``}function Zr(e){return Ue().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function Qr(e){Z?.board===e&&(Z=null);let t=e.getAttribute(`source`)??``,n=e.getAttribute(`statusfield`)??``;if(t===``)return;let r=P(U().FF_DATA_SOURCES,t);if(!r)return;let i=Jr(e);if(i.length===0)return;let a=Gr.get(e);if(!a){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(qr);t&&(a=t.cloneNode(!0),Gr.set(e,a))}if(!a)return;let o=Hr(L(U().SEDATA,r.name,r.tableId),e.getAttribute(`tagfield`)??``,Un()),s=i.map(e=>e.getAttribute(`heading`)??Y.defaultProps.heading),c=Zr(a.tagName),l=Wr(i.map(e=>e.getAttribute(`auffang`))),u=nr(e);for(let e of i)Yr(e).forEach(e=>e.remove());for(let e of o){let t=a.cloneNode(!0),o=n===``?-1:Ur(F(e,n),s);(o>=0?i[o]:l>=0?i[l]:i[0]).appendChild(t);for(let n of c){let r=t.getAttribute(Yn(n.prop))??``;r!==``&&(t[n.prop]=u(e,r))}let d=r.indexField===``?``:F(e,r.indexField);X.set(t,{row:e,pindex:d}),t.draggable=!0}Xr(e,i);let d=i.flatMap(Yr),f=ht(z(e),d,e=>X.get(e)?.row);for(let e of f)d[e].setAttribute(`data-ff-auswahl`,``)}var X=new WeakMap,Z=null,$r=new WeakSet;function ei(e,t){for(let n of t.composedPath())if(n instanceof HTMLElement&&n.tagName.toLowerCase()===Kr&&e.contains(n))return n;return null}function ti(e,t){if(!Z||Z.board!==e)return;let n=X.get(Z.card);if(!n)return;let r=t.getAttribute(`heading`)??``;xn(e,`onCardDrop`,{PINDEX:n.pindex,VALUE:r}).catch(bn)}function ni(e){$r.has(e)||($r.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;if(!n)return;let r=X.get(n);r&&gt(z(e),r.row),xn(e,`onCardClick`,{PINDEX:r?.pindex??``}).catch(bn)}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;n&&(Z={card:n,board:e},t.dataTransfer?.setData(`text/plain`,X.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`))}),e.addEventListener(`dragend`,()=>{Z=null}),e.addEventListener(`dragover`,t=>{let n=ei(e,t);Z?.board===e&&n&&(t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`))}),e.addEventListener(`drop`,t=>{let n=ei(e,t);n&&(t.preventDefault(),ti(e,n),Z=null)}))}var ri=Zn({hydriere:Qr,verdrahte:ni}),ii=ri.connect,ai=ri.disconnect,oi=Y.blockType,si=class extends M{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[oi]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:oi}}static{this.templateChild={type:K.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``,tagField:``,leerText:Lr}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Optional: Feld der Datenquelle, dessen Inhalt bestimmt, in welche Spalte ein Eintrag kommt. Leer = alle Einträge in der Auffang-Spalte.`,kind:`field`},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt das Board nur Einträge des Tages, den der Tageswähler zeigt. Leer = alle Einträge.`,kind:`field`},Rr()]}static{this.defaultChildren=[{type:oi,props:{heading:`Offen`,variant:`warning`},children:[{type:K.blockType}]},{type:oi,props:{heading:`In Arbeit`,variant:`info`}},{type:oi,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[M.styles,o`
    ...
    `]}render(){return w`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),ii(this)}disconnectedCallback(){super.disconnectedCallback(),ai(this)}};M.defineAndRegister(si);var ci={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},li=e=>(...t)=>({_$litDirective$:e,values:t}),ui=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},di=`important`,fi=` !important`,pi=li(class extends ui{constructor(e){if(super(e),e.type!==ci.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(fi);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?di:``):n[e]=r}}return T}}),mi=[10,25,50],hi=`passend`,gi=mi[0],_i=4;function vi(e,t){return yi(e)??t??_i}function yi(e){let t=Number(e);return mi.some(e=>e===t)?t:null}function bi(e,t,n){return Math.max(1,Math.floor((e-t)/n))}function xi(e,t){return e===null?null:Math.max(0,e-t)}function Si({sichtbar:e,hatQuelle:t,proSeite:n,wunschSeite:r,platzhalterZeilen:i}){let a=t?Math.max(1,Math.ceil(e.length/n)):1,o=Math.min(Math.max(r,0),a-1);return t?{seiten:a,seite:o,zeilen:[...e.slice(o*n,(o+1)*n)]}:{seiten:a,seite:o,zeilen:Array.from({length:i},()=>null)}}function Ci(e,t){if(!e.hasAttribute(`fuellt`))return null;let n=e.renderRoot.querySelector(`.koerper`),r=e.renderRoot.querySelector(`.kopf`);return!(n instanceof HTMLElement)||!(r instanceof HTMLElement)?null:bi(n.clientHeight,r.offsetHeight,t)}function wi(e,t){if(typeof ResizeObserver>`u`)return null;let n=e.renderRoot.querySelector(`.koerper`);if(!n)return null;let r=new ResizeObserver(t);return r.observe(n),r}function Ti(e,t){let n=t.trim().toLowerCase();return e.find(e=>e.wert.trim().toLowerCase()===n)}var Ei=`text`,Di=`status`,Oi=`bild`,ki=`bild`,Ai=`unter`,ji=[{wert:Ei,name:`Text`,spur:`minmax(0, 1fr)`,klasse:``,zelle:e=>e},{wert:`zahl`,name:`Zahl`,spur:`90px`,klasse:`zahl`,zelle:e=>e},{wert:`datum`,name:`Datum`,spur:`100px`,klasse:`zahl`,zelle:e=>e},{wert:Di,name:`Status`,spur:`120px`,klasse:`status`,zelle:(e,t)=>{let n=Ti(t,e);return n?w`<span class="chip v-${En(n.bedeutung)}">${n.name.trim()===``?e:n.name}</span>`:w`<span class="chip">${e}</span>`}},{wert:Oi,name:`Bild + Name`,spur:`minmax(0, 1fr)`,klasse:`bild`,zusatzFelder:[{key:ki,label:`Bild`},{key:Ai,label:`Unterzeile`}],hoehe:e=>(e[ki]??``)!==``||(e[Ai]??``)!==``?44:32,zelle:(e,t,n)=>{let r=Fn(n[ki]??``),i=n[Ai]??``;return w`<div class="bild-name">
        ${r===void 0?E:w`<span class="bild-zeichen">${r}</span>`}
        <div class="bild-text">
          <div class="bild-titel">${e}</div>
          ${i===``?E:w`<div class="bild-unter">${i}</div>`}
        </div>
      </div>`}}];function Mi(e){return e.reduce((e,t)=>{let n=Ni(t.art);return Math.max(e,n.hoehe?.(t.felder??{})??32)},32)}function Ni(e){return ji.find(t=>t.wert===e)??ji[0]}var Pi=ji.map(e=>({wert:e.wert,name:e.name,...e.zusatzFelder?{felder:e.zusatzFelder}:{}})),Fi=`felder`,Ii=`Spalte {n}`;function Li(e){return Ii.replace(`{n}`,String(e+1))}function Ri(e){return{titel:Li(e),feld:``,art:Ei}}function zi(){return[0,1,2].map(e=>Ri(e))}function Bi(e){return Array.isArray(e)?e.filter(e=>!!e&&typeof e==`object`).map(e=>({wert:typeof e.wert==`string`?e.wert:``,name:typeof e.name==`string`?e.name:``,bedeutung:typeof e.bedeutung==`string`?e.bedeutung:``})).filter(e=>e.wert.trim()!==``):[]}function Vi(e){if(!e||typeof e!=`object`||Array.isArray(e))return{};let t={};for(let[n,r]of Object.entries(e))typeof r==`string`&&r!==``&&(t[n]=r);return t}function Hi(e,t){if(e&&typeof e==`object`){let n=e,r=Bi(n.zuordnung),i=Vi(n.felder);return{titel:typeof n.titel==`string`?n.titel:Li(t),feld:typeof n.feld==`string`?n.feld:``,art:typeof n.art==`string`?n.art:Ei,...r.length>0?{zuordnung:r}:{},...Object.keys(i).length>0?{felder:i}:{}}}return typeof e==`string`?{...Ri(t),titel:e}:Ri(t)}function Ui(e){let t;if(Array.isArray(e))t=e.map((e,t)=>Hi(e,t));else if(typeof e==`number`&&Number.isFinite(e)||typeof e==`string`&&/^\d+$/.test(e)){let n=Math.max(1,Math.floor(Number(e)));t=[...Array(n).keys()].map(e=>Ri(e))}else t=zi();return t.length>8&&(t=t.slice(0,8)),t.length<1&&(t=[Ri(0)]),t}function Wi(e){try{return Ui(JSON.parse(e))}catch{return zi()}}function Gi(e){return Wi(e.getAttribute(`spalten`)??``)}function Ki(e,t,n){let r={};for(let i of Ni(e.art).zusatzFelder??[]){let a=e.felder?.[i.key]??``;a!==``&&(r[i.key]=n(t,a))}return r}function qi(e){let t=()=>{e.datenzeilen=[],e.zusatzzeilen=[]},n=e.getAttribute(`source`)??``;if(n===``){t();return}let r=P(U().FF_DATA_SOURCES,n);if(!r){t();return}let i=Gi(e),{rows:a,gefiltert:o}=xt(e,Hr(L(U().SEDATA,r.name,r.tableId),e.getAttribute(`tagfield`)??``,Un())),s=ht(z(e),a,e=>e)[0]??-1,c=nr(e);e.datenGeliefert=!0,e.rohzeilen=a,e.auswahlIndex=s,e.durchAuswahlGefiltert=o,e.datenzeilen=a.map(e=>i.map(t=>t.feld===``?``:c(e,t.feld))),e.zusatzzeilen=a.map(e=>i.map(t=>Ki(t,e,c)))}var Ji=Zn({hydriere:qi}),Yi=Ji.connect,Xi=Ji.disconnect;function Zi(e,t,n){return w`<div class="steuerung">
    <button
    ...
    <button
      ...
      @pointerdown=${n}
      @click=${r=>{n(r);let i=e();i.length<8&&(i.push(Ri(i.length)),t(i))}}
    >+</button>
  </div>`}function Qi(e,t){let n=e.currentTarget;if(!n)return;e.stopPropagation(),e.preventDefault();let r=Array.from(n.childNodes),i=n.textContent??``;n.setAttribute(`contenteditable`,`plaintext-only`),n.focus();let a=window.getSelection(),o=document.createRange();o.selectNodeContents(n),a?.removeAllRanges(),a?.addRange(o);let s=!1,c=e=>{if(s)return;s=!0,n.removeAttribute(`contenteditable`),n.removeEventListener(`blur`,l),n.removeEventListener(`keydown`,u);let a=(n.textContent??``).trim();e&&a&&a!==i.trim()?t(a):n.replaceChildren(...r)},l=()=>c(!0),u=e=>{e.key===`Enter`?(e.preventDefault(),n.blur()):e.key===`Escape`&&(e.preventDefault(),c(!1))};n.addEventListener(`blur`,l),n.addEventListener(`keydown`,u)}function $i(e,t,n,r){Qi(e,e=>{let i=n();t>=i.length||(i[t]={...i[t],titel:e},r(i))})}var ea=220,ta=new WeakMap;function na(e){let t=ta.get(e);t!==void 0&&(clearTimeout(t),ta.delete(e))}function ra(e,t,n,r){t.stopPropagation();let i=t.currentTarget.getBoundingClientRect();na(e),ta.set(e,setTimeout(()=>{ta.delete(e),e.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:n,index:r,top:i.bottom+4,left:i.left},bubbles:!0,composed:!0}))},ea))}var ia={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:Ii,eintragsWahl:{key:`art`,label:`Darstellung`,optionen:Pi,standard:Ei,felderKey:Fi},eintragsZuordnung:{key:`zuordnung`,label:`Status-Zuordnung`,nurBeiWahl:Di,wertLabel:`Datenwert`,nameLabel:`Klarname`,bedeutungLabel:`Bedeutung`,bedeutungen:Dn}},aa=1,oa=/^-?\d{1,3}(\.\d{3})*(,\d+)?$|^-?\d+(,\d+)?$|^-?\d+(\.\d+)?$/,sa=/^(\d{1,2})\.(\d{1,2})\.(\d{2}|\d{4})$/,ca=/^(\d{4})-(\d{2})-(\d{2})$/;function la(e){let t=e.trim();if(t===``||!oa.test(t))return null;let n=t.includes(`,`)?t.replace(/\./g,``).replace(`,`,`.`):/^-?\d{1,3}(\.\d{3})+$/.test(t)?t.replace(/\./g,``):t,r=Number(n);return Number.isFinite(r)?r:null}function ua(e){let t=e.trim();if(t===``)return null;let n=ca.exec(t);if(n){let[,e,t,r]=n;return da(Number(e),Number(t),Number(r))}let r=sa.exec(t);if(r){let[,e,t,n]=r,i=Number(n);return da(n.length===2?i<=69?2e3+i:1900+i:i,Number(t),Number(e))}return null}function da(e,t,n){if(t<1||t>12||n<1||n>31)return null;let r=new Date(e,t-1,n);return r.getFullYear()!==e||r.getMonth()!==t-1||r.getDate()!==n?null:r.getTime()}function fa(e){let t=0,n=0,r=0;for(let i of e)i.trim()!==``&&(t++,la(i)!==null&&n++,ua(i)!==null&&r++);return t===0?`text`:r===t?`datum`:n===t?`zahl`:`text`}var pa=new Intl.Collator(`de`,{numeric:!0,sensitivity:`base`});function ma(e,t,n){if(t<0||e.length===0)return e.map((e,t)=>t);let r=n=>e[n][t]??``,i=fa(e.map(e=>e[t]??``)),a=n?1:-1;return e.map((e,t)=>t).sort((e,t)=>{let n=r(e).trim(),o=r(t).trim();if(n===``&&o===``)return e-t;if(n===``)return aa;if(o===``)return-1;let s=i===`zahl`?(la(n)??0)-(la(o)??0):i===`datum`?(ua(n)??0)-(ua(o)??0):pa.compare(n,o);return s===0?e-t:s*a})}function ha(e,t){let n=[];return e.forEach((e,r)=>{br(e,t)&&n.push(r)}),n}function ga(e,t){return!e&&t.trim()!==``}function _a(e,t,n){return e&&t&&n===0}function va(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}function ya(e){let t=ha(e.datenzeilen,e.suchtext);return e.sortSpalte<0?t:ma(t.map(t=>e.datenzeilen[t]),e.sortSpalte,e.sortAuf).map(e=>t[e])}function ba(e){let t={gridTemplateColumns:e.spalten.map(e=>Ni(e.art).spur).join(` `)},n=Mi(e.spalten),r=ga(e.imEditor,e.source),i=_a(r,e.datenGeliefert,e.datenzeilen.length),a=ya(e),{seiten:o,seite:s,zeilen:c}=Si({sichtbar:a,hatQuelle:r,proSeite:yi(e.einstellung)??e.gemessen??gi,wunschSeite:e.wunschSeite,platzhalterZeilen:vi(e.einstellung,e.gemessen)});return{cols:t,zeilenHoehe:n,hatQuelle:r,leer:i,gesamt:a.length,seiten:o,seite:s,zeilen:c,linealTakte:xi(e.gemessen,c.length)}}var xa=[{value:`ja`,label:`Ja`},{value:`nein`,label:`Nein`}],Sa=[{attributeName:`suche`,name:`Suchzeile`,description:`Zeigt über der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,kind:`segment`,options:xa,requiresDataSource:!0},{attributeName:`zeilenWaehler`,name:`Zeilen-Wähler`,description:`Zeigt dem Bediener unten in der Maske den Wähler „Zeilen pro Seite" — er darf die Einstellung dann für seine Sitzung übersteuern. Nein: es gilt unveränderlich, was hier im Editor eingestellt ist.`,kind:`segment`,options:xa,requiresDataSource:!0},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt die Tabelle nur Sätze des Tages, den der Tageswähler zeigt. Leer = alle Sätze.`,kind:`field`},Rr()];function Ca(e,t){return w`<div class="fusszeile">
    <div class="seiten-info">${va({hatQuelle:e.hatQuelle,sichtbar:e.sichtbar,gesamt:e.gesamt,suchtAktiv:e.suchtAktiv,auswahlAktiv:e.auswahlAktiv})}</div>
    <div class="seiten-nav">
  ...
  </div>`}var wa=`—`;function Ta(e){return e.linealTakte===0?E:w`<div class="lineal" style=${pi(e.linealTakte===null?e.cols:{...e.cols,flex:`0 1 auto`,height:`calc(var(--zeilen-hoehe) * ${e.linealTakte})`})}>
          ${e.spalten.map(()=>w`<div></div>`)}
        </div>`}function Ea(e,t){return w`
      ...
      <div class="kopf" style=${pi(e.cols)}>
        ...
        ${e.zeilen.map(n=>w`<div
          ...
          >
            ${``}
            ${e.spalten.map((t,r)=>{let i=Ni(t.art),a=n===null?wa:e.datenzeilen[n]?.[r]??``,o=n===null?{}:e.zusatzzeilen[n]?.[r]??{};return w`<div class=${i.klasse}>${i.zelle(a,t.zuordnung??[],o)}</div>`})}
          </div>`)}
        ${Ta(e)}`}
      </div>
    `}var Da=o`
...
`,Q=class e extends M{constructor(...e){super(...e),this.spalten=zi(),this.source=``,this.suche=`ja`,this.proSeite=hi,this.zeilenWaehler=`nein`,this.leerText=Lr,this._suchtext=``,this.datenzeilen=[],this.zusatzzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this.datenGeliefert=!1,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._proSeiteWahl=null,this._proSeiteGemessen=null,this._beobachter=null,this._taktGemessen=0}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.listenBindung=ia}static{this.defaultProps={width:`fill`,source:``,spalten:zi(),suche:`ja`,tagField:``,proSeite:hi,zeilenWaehler:`nein`,leerText:Lr}}static{this.customProperties=Sa}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get einstellung(){return this._proSeiteWahl??this.proSeite}waehleProSeite(e){this.hasAttribute(`data-ff-editor`)?this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`proSeite`,value:e},bubbles:!0,composed:!0})):this._proSeiteWahl=e,this._seite=0,this.requestUpdate()}messeRumpf(){let e=this.zeilenHoehe;this._taktGemessen=e;let t=Ci(this,e);t!==this._proSeiteGemessen&&(this._proSeiteGemessen=t,this.requestUpdate())}spaltenListe(){return Ui(this.spalten)}get zeilenHoehe(){return Mi(this.spaltenListe())}klickZeile(e){if(e===null||this.hasAttribute(`data-ff-editor`))return;let t=z(this),n=this.rohzeilen[e];t===``||n===void 0||gt(t,n)}setzeSuchtext(e){this._suchtext=e,this._seite=0,this.requestUpdate()}klickSortiere(e){this.editable||(this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.requestUpdate())}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}beobachte(){this._beobachter||(this._beobachter=wi(this,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}connectedCallback(){super.connectedCallback(),Yi(this),this.beobachte()}firstUpdated(){this.beobachte()}updated(){this._taktGemessen!==this.zeilenHoehe&&this.messeRumpf()}disconnectedCallback(){super.disconnectedCallback(),na(this),this._beobachter?.disconnect(),this._beobachter=null,Xi(this)}static{this.styles=[M.styles,kn,Br,Da]}render(){let t=this.spaltenListe(),n=e=>e.stopPropagation(),r=ba({spalten:t,imEditor:this.hasAttribute(`data-ff-editor`),source:this.source,datenGeliefert:this.datenGeliefert,datenzeilen:this.datenzeilen,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,wunschSeite:this._seite,einstellung:this.einstellung,gemessen:this._proSeiteGemessen});return w`<div class="tabelle" style=${pi({"--zeilen-hoehe":`${r.zeilenHoehe}px`})}>
      ${Zi(()=>this.spaltenListe(),e=>this.aendere(e),n)}
      ${Ea({spalten:t,cols:r.cols,editable:this.editable,zeigeSuche:this.suche===`ja`,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,zeilen:r.zeilen,linealTakte:r.linealTakte,datenzeilen:this.datenzeilen,zusatzzeilen:this.zusatzzeilen,hatQuelle:r.hatQuelle,auswahlIndex:this.auswahlIndex,leer:r.leer,leerText:this.leerText},{setzeSuchtext:e=>this.setzeSuchtext(e),dblklickKopf:(e,t)=>{this.editable&&(na(this),$i(e,t,()=>this.spaltenListe(),e=>this.aendere(e)))},klickKopf:(t,n)=>{this.editable&&ra(this,t,e.listenBindung.prop,n),this.klickSortiere(n)},klickZeile:e=>this.klickZeile(e),stop:n})}
      ${``}
      ${r.leer?E:Ca({hatQuelle:r.hatQuelle,sichtbar:r.gesamt,gesamt:this.datenzeilen.length,suchtAktiv:this._suchtext.trim()!==``,auswahlAktiv:this.durchAuswahlGefiltert,zeigeWaehler:this.hasAttribute(`data-ff-editor`)||this.zeilenWaehler===`ja`,einstellung:this.einstellung,seite:r.seite,seiten:r.seiten},{waehleProSeite:e=>this.waehleProSeite(e),blaettere:e=>{this._seite=e,this.requestUpdate()},stop:n})}
    </div>`}};j([A({converter:{fromAttribute:e=>e?Wi(e):zi(),toAttribute:e=>JSON.stringify(e)}})],Q.prototype,`spalten`,void 0),j([A()],Q.prototype,`source`,void 0),j([A()],Q.prototype,`suche`,void 0),j([A()],Q.prototype,`proSeite`,void 0),j([A()],Q.prototype,`zeilenWaehler`,void 0),j([A()],Q.prototype,`leerText`,void 0),j([A({attribute:!1})],Q.prototype,`datenzeilen`,void 0),j([A({attribute:!1})],Q.prototype,`zusatzzeilen`,void 0),j([A({attribute:!1})],Q.prototype,`rohzeilen`,void 0),j([A({attribute:!1})],Q.prototype,`auswahlIndex`,void 0),j([A({attribute:!1})],Q.prototype,`durchAuswahlGefiltert`,void 0),j([A({attribute:!1})],Q.prototype,`datenGeliefert`,void 0),M.defineAndRegister(Q);var Oa=Yn(`text`);function ka(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(Oa)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function Aa(e){let t=rr(e,Oa);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function ja(e){ka(e)&&(e.text=``)}var Ma=Zn({hydriere:Aa,verdrahte:ja}),Na=Ma.connect,Pa=Ma.disconnect,Fa=6,Ia=96,La=14,Ra={duenn:`300`,normal:`400`,fett:`700`},za={links:`left`,mitte:`center`,rechts:`right`},Ba={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},Va=`standard`;function Ha(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(Ia,Math.max(Fa,t)):La}function Ua(e){return typeof e==`string`&&e in Ra?e:`normal`}function Wa(e){return typeof e==`string`&&e in za?e:`links`}function Ga(e){return typeof e==`string`&&e in Ba?e:Va}var $=class extends M{constructor(...e){super(...e),this.groesse=La,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=Va,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:La,gewicht:`normal`,ausrichtung:`links`,farbe:Va,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:Fa,max:Ia,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[M.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return w`<div
      class="text"
      style=${pi({fontSize:`${Ha(this.groesse)}px`,fontWeight:Ra[Ua(this.gewicht)],textAlign:za[Wa(this.ausrichtung)],color:Ba[Ga(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),Na(this)}disconnectedCallback(){super.disconnectedCallback(),Pa(this)}};j([A({type:Number})],$.prototype,`groesse`,void 0),j([A()],$.prototype,`gewicht`,void 0),j([A()],$.prototype,`ausrichtung`,void 0),j([A()],$.prototype,`farbe`,void 0),j([A()],$.prototype,`text`,void 0),j([A()],$.prototype,`source`,void 0),j([A()],$.prototype,`textField`,void 0),M.defineAndRegister($);var Ka=[`waagerecht`,`senkrecht`],qa=`waagerecht`;function Ja(e){return Ka.includes(e)?e:qa}var Ya=class extends M{constructor(...e){super(...e),this.richtung=qa}static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`,richtung:qa}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1,varianten:[{wenn:{attributeName:`richtung`,equals:`senkrecht`},startW:1,startH:6,breiteZiehbar:!1}]}}static{this.customProperties=[{attributeName:`richtung`,name:`Richtung`,description:`Waagerecht trennt oben von unten, senkrecht links von rechts.`,kind:`select`,options:[{value:`waagerecht`,label:`Waagerecht`},{value:`senkrecht`,label:`Senkrecht`}]}]}static{this.styles=[M.styles,o`
    ...
    `]}render(){return w`<div class="zeile"><slot></slot></div>`}};M.defineAndRegister(Xa),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;H(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();
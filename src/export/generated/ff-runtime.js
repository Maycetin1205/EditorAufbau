...
`,Vr=[`text`,`number`,`textarea`,`select`,`date`,`checkbox`,`nachschlagen`];function Hr(e){return Vr.includes(e)?e:`text`}var Ur=[`text`,`number`,`textarea`,`select`,`nachschlagen`,`date`],Wr={select:`ph-select`,date:`ph-datum`};function Gr(e){return e.trim().toLowerCase().split(/\s+/).filter(e=>e!==``)}function Kr(e,t){let n=Gr(t);if(n.length===0)return!0;let r=e.join(` `).toLowerCase();return n.every(e=>r.includes(e))}function qr(e){return C`<div class="nachschlag">
    <input
      class="ctrl"
      type="text"
      .value=${e.wert}

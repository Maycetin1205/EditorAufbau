...
`,ur=`ff-dialog-rahmen`,dr=`ff-dialog-schliessen`;function fr(e,t){let n=Number(e);return Number.isFinite(n)&&n>0?n:t}var q=class extends Ie{constructor(...e){super(...e),this.titel=`Dialog`,this.breite=520,this.hoehe=380,this.viewport=!1,this.mitWerkzeug=!1,this.escapeSchliesst=!1,this.escapeRegistriert=!1,this.aufTaste=e=>{e.key===`Escape`&&(e.stopPropagation(),this.schliesse())}}static{this.styles=o`
    :host {
      position: absolute;
      inset: 0;
      display: block;
  ...
  `}aktualisiereEscape(){let e=this.isConnected&&this.escapeSchliesst;e!==this.escapeRegistriert&&(e?document.addEventListener(`keydown`,this.aufTaste,!0):document.removeEventListener(`keydown`,this.aufTaste,!0),this.escapeRegistriert=e)}schliesse(){this.dispatchEvent(new CustomEvent(dr,{bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this.aktualisiereEscape()}updated(e){e.has(`escapeSchliesst`)&&this.aktualisiereEscape()}disconnectedCallback(){this.escapeRegistriert&&=(document.removeEventListener(`keydown`,this.aufTaste,!0),!1),super.disconnectedCallback()}render(){return w`
    ...
    </div>`}};j([A()],Y.prototype,`variant`,void 0),j([A()],Y.prototype,`heading`,void 0),j([Be()],Y.prototype,`_count`,void 0),M.defineAndRegister(Y);function jr(e,t,n){return t===``||n===``?[...e]:e.filter(e=>Mn(F(e,t))===n)}function Mr(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function Nr(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var Pr=new WeakMap,Fr=Y.tagName,Ir=K.tagName;function Lr(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Fr)}function Rr(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Ir)}function zr(e){return Ue().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function Br(e){Z?.board===e&&(Z=null);let t=e.getAttribute(`source`)??``,n=e.getAttribute(`statusfield`)??``;if(t===``)return;let r=P(U().FF_DATA_SOURCES,t);if(!r)return;let i=Lr(e);if(i.length===0)return;let a=Pr.get(e);if(!a){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(Ir);t&&(a=t.cloneNode(!0),Pr.set(e,a))}if(!a)return;let o=jr(L(U().SEDATA,r.name,r.tableId),e.getAttribute(`tagfield`)??``,Ln()),s=i.map(e=>e.getAttribute(`heading`)??Y.defaultProps.heading),c=zr(a.tagName),l=Nr(i.map(e=>e.getAttribute(`auffang`))),u=Xn(e);for(let e of i)Rr(e).forEach(e=>e.remove());for(let e of o){let t=a.cloneNode(!0),o=n===``?-1:Mr(F(e,n),s);(o>=0?i[o]:l>=0?i[l]:i[0]).appendChild(t);for(let n of c){let r=t.getAttribute(Un(n.prop))??``;r!==``&&(t[n.prop]=u(e,r))}let d=r.indexField===``?``:F(e,r.indexField);X.set(t,{row:e,pindex:d}),t.draggable=!0}let d=i.flatMap(Rr),f=ht(z(e),d,e=>X.get(e)?.row);for(let e of f)d[e].setAttribute(`data-ff-auswahl`,``)}var X=new WeakMap,Z=null,Vr=new WeakSet;function Hr(e,t){for(let n of t.composedPath())if(n instanceof HTMLElement&&n.tagName.toLowerCase()===Fr&&e.contains(n))return n;return null}function Ur(e,t){if(!Z||Z.board!==e)return;let n=X.get(Z.card);if(!n)return;let r=t.getAttribute(`heading`)??``;bn(e,`onCardDrop`,{PINDEX:n.pindex,VALUE:r}).catch(yn)}function Wr(e){Vr.has(e)||(Vr.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;if(!n)return;let r=X.get(n);r&&gt(z(e),r.row),bn(e,`onCardClick`,{PINDEX:r?.pindex??``}).catch(yn)}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;n&&(Z={card:n,board:e},t.dataTransfer?.setData(`text/plain`,X.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`))}),e.addEventListener(`dragend`,()=>{Z=null}),e.addEventListener(`dragover`,t=>{let n=Hr(e,t);Z?.board===e&&n&&(t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`))}),e.addEventListener(`drop`,t=>{let n=Hr(e,t);n&&(t.preventDefault(),Ur(e,n),Z=null)}))}var Gr=Gn({hydriere:Br,verdrahte:Wr}),Kr=Gr.connect,qr=Gr.disconnect,Jr=Y.blockType,Yr=class extends M{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[Jr]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:Jr}}static{this.templateChild={type:K.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``,tagField:``}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Optional: Feld der Datenquelle, dessen Inhalt bestimmt, in welche Spalte ein Eintrag kommt. Leer = alle Einträge in der Auffang-Spalte.`,kind:`field`},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt das Board nur Einträge des Tages, den der Tageswähler zeigt. Leer = alle Einträge.`,kind:`field`}]}static{this.defaultChildren=[{type:Jr,props:{heading:`Offen`,variant:`warning`},children:[{type:K.blockType}]},{type:Jr,props:{heading:`In Arbeit`,variant:`info`}},{type:Jr,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[M.styles,o`
    ...
    `]}render(){return w`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),Kr(this)}disconnectedCallback(){super.disconnectedCallback(),qr(this)}};M.defineAndRegister(Yr);var Xr={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Zr=e=>(...t)=>({_$litDirective$:e,values:t}),Qr=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},$r=`important`,ei=` !important`,ti=Zr(class extends Qr{constructor(e){if(super(e),e.type!==Xr.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(ei);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?$r:``):n[e]=r}}return E}}),ni=[10,25,50],ri=`passend`,ii=ni[0];function ai(e){let t=Number(e);return ni.some(e=>e===t)?t:null}function oi(e,t){return Math.max(1,Math.floor((e-t)/32))}function si({sichtbar:e,hatQuelle:t,proSeite:n,wunschSeite:r,platzhalterZeilen:i}){let a=t?Math.max(1,Math.ceil(e.length/n)):1,o=Math.min(Math.max(r,0),a-1);return t?{seiten:a,seite:o,zeilen:[...e.slice(o*n,(o+1)*n)]}:{seiten:a,seite:o,zeilen:Array.from({length:i},()=>null)}}function ci(e){if(!e.hasAttribute(`fuellt`))return null;let t=e.renderRoot.querySelector(`.koerper`),n=e.renderRoot.querySelector(`.kopf`);return!(t instanceof HTMLElement)||!(n instanceof HTMLElement)?null:oi(t.clientHeight,n.offsetHeight)}function li(e,t){if(typeof ResizeObserver>`u`)return null;let n=e.renderRoot.querySelector(`.koerper`);if(!n)return null;let r=new ResizeObserver(t);return r.observe(n),r}function ui(e,t){let n=t.trim().toLowerCase();return e.find(e=>e.wert.trim().toLowerCase()===n)}var di=`text`,fi=`status`,pi=[{wert:di,name:`Text`,spur:`minmax(0, 1fr)`,klasse:``,zelle:e=>e},{wert:`zahl`,name:`Zahl`,spur:`90px`,klasse:`zahl`,zelle:e=>e},{wert:`datum`,name:`Datum`,spur:`100px`,klasse:`zahl`,zelle:e=>e},{wert:fi,name:`Status`,spur:`120px`,klasse:`status`,zelle:(e,t)=>{let n=ui(t,e);return n?w`<span class="chip v-${Tn(n.bedeutung)}">${n.name.trim()===``?e:n.name}</span>`:w`<span class="chip">${e}</span>`}}];function mi(e){return pi.find(t=>t.wert===e)??pi[0]}var hi=pi.map(e=>({wert:e.wert,name:e.name})),gi=`Spalte {n}`;function _i(e){return gi.replace(`{n}`,String(e+1))}function vi(e){return{titel:_i(e),feld:``,art:di}}function yi(){return[0,1,2].map(e=>vi(e))}function bi(e){return Array.isArray(e)?e.filter(e=>!!e&&typeof e==`object`).map(e=>({wert:typeof e.wert==`string`?e.wert:``,name:typeof e.name==`string`?e.name:``,bedeutung:typeof e.bedeutung==`string`?e.bedeutung:``})).filter(e=>e.wert.trim()!==``):[]}function xi(e,t){if(e&&typeof e==`object`){let n=e,r=bi(n.zuordnung);return{titel:typeof n.titel==`string`?n.titel:_i(t),feld:typeof n.feld==`string`?n.feld:``,art:typeof n.art==`string`?n.art:di,...r.length>0?{zuordnung:r}:{}}}return typeof e==`string`?{...vi(t),titel:e}:vi(t)}function Si(e){let t;if(Array.isArray(e))t=e.map((e,t)=>xi(e,t));else if(typeof e==`number`&&Number.isFinite(e)||typeof e==`string`&&/^\d+$/.test(e)){let n=Math.max(1,Math.floor(Number(e)));t=[...Array(n).keys()].map(e=>vi(e))}else t=yi();return t.length>8&&(t=t.slice(0,8)),t.length<1&&(t=[vi(0)]),t}function Ci(e){try{return Si(JSON.parse(e))}catch{return yi()}}function wi(e){return Ci(e.getAttribute(`spalten`)??``).map(e=>e.feld)}function Ti(e){let t=e.getAttribute(`source`)??``;if(t===``){e.datenzeilen=[];return}let n=P(U().FF_DATA_SOURCES,t);if(!n){e.datenzeilen=[];return}let r=wi(e),{rows:i,gefiltert:a}=xt(e,jr(L(U().SEDATA,n.name,n.tableId),e.getAttribute(`tagfield`)??``,Ln())),o=ht(z(e),i,e=>e)[0]??-1,s=Xn(e);e.rohzeilen=i,e.auswahlIndex=o,e.durchAuswahlGefiltert=a,e.datenzeilen=i.map(e=>r.map(t=>t===``?``:s(e,t)))}var Ei=Gn({hydriere:Ti}),Di=Ei.connect,Oi=Ei.disconnect,ki=1,Ai=/^-?\d{1,3}(\.\d{3})*(,\d+)?$|^-?\d+(,\d+)?$|^-?\d+(\.\d+)?$/,ji=/^(\d{1,2})\.(\d{1,2})\.(\d{2}|\d{4})$/,Mi=/^(\d{4})-(\d{2})-(\d{2})$/;function Ni(e){let t=e.trim();if(t===``||!Ai.test(t))return null;let n=t.includes(`,`)?t.replace(/\./g,``).replace(`,`,`.`):/^-?\d{1,3}(\.\d{3})+$/.test(t)?t.replace(/\./g,``):t,r=Number(n);return Number.isFinite(r)?r:null}function Pi(e){let t=e.trim();if(t===``)return null;let n=Mi.exec(t);if(n){let[,e,t,r]=n;return Fi(Number(e),Number(t),Number(r))}let r=ji.exec(t);if(r){let[,e,t,n]=r,i=Number(n);return Fi(n.length===2?i<=69?2e3+i:1900+i:i,Number(t),Number(e))}return null}function Fi(e,t,n){if(t<1||t>12||n<1||n>31)return null;let r=new Date(e,t-1,n);return r.getFullYear()!==e||r.getMonth()!==t-1||r.getDate()!==n?null:r.getTime()}function Ii(e){let t=0,n=0,r=0;for(let i of e)i.trim()!==``&&(t++,Ni(i)!==null&&n++,Pi(i)!==null&&r++);return t===0?`text`:r===t?`datum`:n===t?`zahl`:`text`}var Li=new Intl.Collator(`de`,{numeric:!0,sensitivity:`base`});function Ri(e,t,n){if(t<0||e.length===0)return e.map((e,t)=>t);let r=n=>e[n][t]??``,i=Ii(e.map(e=>e[t]??``)),a=n?1:-1;return e.map((e,t)=>t).sort((e,t)=>{let n=r(e).trim(),o=r(t).trim();if(n===``&&o===``)return e-t;if(n===``)return ki;if(o===``)return-1;let s=i===`zahl`?(Ni(n)??0)-(Ni(o)??0):i===`datum`?(Pi(n)??0)-(Pi(o)??0):Li.compare(n,o);return s===0?e-t:s*a})}function zi(e,t,n){return w`<div class="steuerung">
    <button
    ...
    <button
      ...
      @pointerdown=${n}
      @click=${r=>{n(r);let i=e();i.length<8&&(i.push(vi(i.length)),t(i))}}
    >+</button>
  </div>`}function Bi(e,t){let n=e.currentTarget;if(!n)return;e.stopPropagation(),e.preventDefault();let r=Array.from(n.childNodes),i=n.textContent??``;n.setAttribute(`contenteditable`,`plaintext-only`),n.focus();let a=window.getSelection(),o=document.createRange();o.selectNodeContents(n),a?.removeAllRanges(),a?.addRange(o);let s=!1,c=e=>{if(s)return;s=!0,n.removeAttribute(`contenteditable`),n.removeEventListener(`blur`,l),n.removeEventListener(`keydown`,u);let a=(n.textContent??``).trim();e&&a&&a!==i.trim()?t(a):n.replaceChildren(...r)},l=()=>c(!0),u=e=>{e.key===`Enter`?(e.preventDefault(),n.blur()):e.key===`Escape`&&(e.preventDefault(),c(!1))};n.addEventListener(`blur`,l),n.addEventListener(`keydown`,u)}function Vi(e,t,n,r){Bi(e,e=>{let i=n();t>=i.length||(i[t]={...i[t],titel:e},r(i))})}var Hi=220,Ui=new WeakMap;function Wi(e){let t=Ui.get(e);t!==void 0&&(clearTimeout(t),Ui.delete(e))}function Gi(e,t,n,r){t.stopPropagation();let i=t.currentTarget.getBoundingClientRect();Wi(e),Ui.set(e,setTimeout(()=>{Ui.delete(e),e.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:n,index:r,top:i.bottom+4,left:i.left},bubbles:!0,composed:!0}))},Hi))}function Ki(e,t){let n=[];return e.forEach((e,r)=>{mr(e,t)&&n.push(r)}),n}function qi(e,t){return!e&&t.trim()!==``}function Ji(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}var Yi=[{value:`ja`,label:`Ja`},{value:`nein`,label:`Nein`}],Xi=[{attributeName:`suche`,name:`Suchzeile`,description:`Zeigt ueber der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,kind:`segment`,options:Yi,requiresDataSource:!0},{attributeName:`zeilenWaehler`,name:`Zeilen-Wähler`,description:`Zeigt dem Bediener unten in der Maske den Wähler „Zeilen pro Seite" — er darf die Einstellung dann für seine Sitzung übersteuern. Nein: es gilt unveränderlich, was hier im Editor eingestellt ist.`,kind:`segment`,options:Yi,requiresDataSource:!0},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt die Tabelle nur Saetze des Tages, den der Tageswaehler zeigt. Leer = alle Saetze.`,kind:`field`}];function Zi(e,t){return w`<div class="fusszeile">
    ...
    <div class="seiten-nav">
  ...
  </div>`}var Qi=`—`;function $i(e,t){return w`
      ...
      <div class="koerper">
      <div class="kopf" style=${ti(e.cols)}>
        ${e.spalten.map((n,r)=>w`<div
            class=${mi(n.art).klasse}
            data-ff-editable
        ...
        ${e.zeilen.map(n=>w`<div
          ...
          >
            ${``}
            ${e.spalten.map((t,r)=>{let i=mi(t.art),a=n===null?Qi:e.datenzeilen[n]?.[r]??``;return w`<div class=${i.klasse}>${i.zelle(a,t.zuordnung??[])}</div>`})}
          </div>`)}
        ${``}
        <div class="lineal" style=${ti(e.cols)}>
...
`,ta=4,Q=class e extends M{constructor(...e){super(...e),this.spalten=yi(),this.source=``,this.suche=`ja`,this.proSeite=ri,this.zeilenWaehler=`nein`,this._suchtext=``,this.datenzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._proSeiteWahl=null,this._proSeiteGemessen=null,this._beobachter=null}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.listenBindung={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:gi,eintragsWahl:{key:`art`,label:`Darstellung`,optionen:hi,standard:di},eintragsZuordnung:{key:`zuordnung`,label:`Status-Zuordnung`,nurBeiWahl:fi,wertLabel:`Datenwert`,nameLabel:`Klarname`,bedeutungLabel:`Bedeutung`,bedeutungen:En}}}static{this.defaultProps={width:`fill`,source:``,spalten:yi(),suche:`ja`,tagField:``,proSeite:ri,zeilenWaehler:`nein`}}static{this.customProperties=Xi}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get einstellung(){return this._proSeiteWahl??this.proSeite}get proSeiteAktuell(){return ai(this.einstellung)??this._proSeiteGemessen??ii}waehleProSeite(e){this.hasAttribute(`data-ff-editor`)?this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`proSeite`,value:e},bubbles:!0,composed:!0})):this._proSeiteWahl=e,this._seite=0,this.requestUpdate()}messeRumpf(){let e=ci(this);e!==this._proSeiteGemessen&&(this._proSeiteGemessen=e,this.requestUpdate())}spaltenListe(){return Si(this.spalten)}sichtbareIndizes(){let e=Ki(this.datenzeilen,this._suchtext);return this._sortSpalte<0?e:Ri(e.map(e=>this.datenzeilen[e]),this._sortSpalte,this._sortAuf).map(t=>e[t])}klickZeile(e){if(e===null||this.hasAttribute(`data-ff-editor`))return;let t=z(this),n=this.rohzeilen[e];t===``||n===void 0||gt(t,n)}setzeSuchtext(e){this._suchtext=e,this._seite=0,this.requestUpdate()}klickSortiere(e){this.editable||(this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.requestUpdate())}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}beobachte(){this._beobachter||(this._beobachter=li(this,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}connectedCallback(){super.connectedCallback(),Di(this),this.beobachte()}firstUpdated(){this.beobachte()}disconnectedCallback(){super.disconnectedCallback(),Wi(this),this._beobachter?.disconnect(),this._beobachter=null,Oi(this)}static{this.styles=[M.styles,On,ea]}render(){let t=this.spaltenListe(),n={gridTemplateColumns:t.map(e=>mi(e.art).spur).join(` `)},r=e=>e.stopPropagation(),i=this.sichtbareIndizes(),a=qi(this.hasAttribute(`data-ff-editor`),this.source),o=i.length,s=this.proSeiteAktuell,{seiten:c,seite:l,zeilen:u}=si({sichtbar:i,hatQuelle:a,proSeite:s,wunschSeite:this._seite,platzhalterZeilen:ta});return w`<div class="tabelle" style=${ti({"--zeilen-hoehe":`32px`})}>
      ${zi(()=>this.spaltenListe(),e=>this.aendere(e),r)}
      ${$i({spalten:t,cols:n,editable:this.editable,zeigeSuche:this.suche===`ja`,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,zeilen:u,datenzeilen:this.datenzeilen,hatQuelle:a,auswahlIndex:this.auswahlIndex},{setzeSuchtext:e=>this.setzeSuchtext(e),dblklickKopf:(e,t)=>{this.editable&&(Wi(this),Vi(e,t,()=>this.spaltenListe(),e=>this.aendere(e)))},klickKopf:(t,n)=>{this.editable&&Gi(this,t,e.listenBindung.prop,n),this.klickSortiere(n)},klickZeile:e=>this.klickZeile(e),stop:r})}
      ${Zi({hatQuelle:a,sichtbar:o,gesamt:this.datenzeilen.length,suchtAktiv:this._suchtext.trim()!==``,auswahlAktiv:this.durchAuswahlGefiltert,zeigeWaehler:this.hasAttribute(`data-ff-editor`)||this.zeilenWaehler===`ja`,einstellung:this.einstellung,seite:l,seiten:c},{waehleProSeite:e=>this.waehleProSeite(e),blaettere:e=>{this._seite=e,this.requestUpdate()},stop:r})}
    </div>`}};j([A({converter:{fromAttribute:e=>e?Ci(e):yi(),toAttribute:e=>JSON.stringify(e)}})],Q.prototype,`spalten`,void 0),j([A()],Q.prototype,`source`,void 0),j([A()],Q.prototype,`suche`,void 0),j([A()],Q.prototype,`proSeite`,void 0),j([A()],Q.prototype,`zeilenWaehler`,void 0),j([A({attribute:!1})],Q.prototype,`datenzeilen`,void 0),j([A({attribute:!1})],Q.prototype,`rohzeilen`,void 0),j([A({attribute:!1})],Q.prototype,`auswahlIndex`,void 0),j([A({attribute:!1})],Q.prototype,`durchAuswahlGefiltert`,void 0),M.defineAndRegister(Q);var na=Un(`text`);function ra(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(na)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function ia(e){let t=Zn(e,na);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function aa(e){ra(e)&&(e.text=``)}var oa=Gn({hydriere:ia,verdrahte:aa}),sa=oa.connect,ca=oa.disconnect,la=6,ua=96,da=14,fa={duenn:`300`,normal:`400`,fett:`700`},pa={links:`left`,mitte:`center`,rechts:`right`},ma={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},ha=`standard`;function ga(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(ua,Math.max(la,t)):da}function _a(e){return typeof e==`string`&&e in fa?e:`normal`}function va(e){return typeof e==`string`&&e in pa?e:`links`}function ya(e){return typeof e==`string`&&e in ma?e:ha}var $=class extends M{constructor(...e){super(...e),this.groesse=da,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=ha,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:da,gewicht:`normal`,ausrichtung:`links`,farbe:ha,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:la,max:ua,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[M.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return w`<div
      class="text"
      style=${ti({fontSize:`${ga(this.groesse)}px`,fontWeight:fa[_a(this.gewicht)],textAlign:pa[va(this.ausrichtung)],color:ma[ya(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),sa(this)}disconnectedCallback(){super.disconnectedCallback(),ca(this)}};j([A({type:Number})],$.prototype,`groesse`,void 0),j([A()],$.prototype,`gewicht`,void 0),j([A()],$.prototype,`ausrichtung`,void 0),j([A()],$.prototype,`farbe`,void 0),j([A()],$.prototype,`text`,void 0),j([A()],$.prototype,`source`,void 0),j([A()],$.prototype,`textField`,void 0),M.defineAndRegister($);var ba=[`waagerecht`,`senkrecht`],xa=`waagerecht`;function Sa(e){return ba.includes(e)?e:xa}var Ca=class extends M{constructor(...e){super(...e),this.richtung=xa}static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`,richtung:xa}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1,varianten:[{wenn:{attributeName:`richtung`,equals:`senkrecht`},startW:1,startH:6,breiteZiehbar:!1}]}}static{this.customProperties=[{attributeName:`richtung`,name:`Richtung`,description:`Waagerecht trennt oben von unten, senkrecht links von rechts.`,kind:`select`,options:[{value:`waagerecht`,label:`Waagerecht`},{value:`senkrecht`,label:`Senkrecht`}]}]}static{this.styles=[M.styles,o`
    ...
    `]}render(){return w`<div class="zeile"><slot></slot></div>`}};M.defineAndRegister(wa),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;H(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();
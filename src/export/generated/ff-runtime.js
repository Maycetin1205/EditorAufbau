...
`,Ve=class extends I{constructor(...e){super(...e),this.variant=`info`,this.text=`Hinweis`}static{this.blockType=`badge`}static{this.tagName=`ff-badge`}static{this.displayName=`Status-Chip`}static{this.category=`anzeige`}static{this.resizableWidth=!1}static{this.defaultProps={variant:`info`,text:`Hinweis`}}static{this.customProperties=[R(`variant`,`Bedeutung des Chips — bestimmt die Farbe.`)]}static{this.styles=[I.styles,Be]}render(){return T`<span
      class="chip v-${L(this.variant)}"
      data-ff-editable
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</span>`}};F([N()],Ve.prototype,`variant`,void 0),F([N()],Ve.prototype,`text`,void 0),I.defineAndRegister(Ve);var He=[{key:`START_TOOL`,name:`Werkzeug starten (START_TOOL)`}];function Ue(e){if(!e||typeof e!=`object`)return null;let t=e;return typeof t.type!=`string`||!He.some(e=>e.key===t.type)||typeof t.resultKey!=`string`||typeof t.toolNr!=`string`||!Array.isArray(t.toolParams)||t.toolParams.some(e=>typeof e!=`string`)?null:{type:t.type,resultKey:t.resultKey,toolNr:t.toolNr,toolParams:[...t.toolParams]}}function We(e){if(!e)return{};let t;try{t=JSON.parse(e)}catch{return{}}if(!t||typeof t!=`object`||Array.isArray(t))return{};let n={};for(let[e,r]of Object.entries(t)){if(!Array.isArray(r)||r.length===0)continue;let t=[],i=!1;for(let e of r){let n=Ue(e);if(!n){i=!0;break}t.push(n)}!i&&t.length>0&&(n[e]=t)}return n}var Ge=[`GET_RELATION`,`PUT_RELATION`,`PUTADD_RELATION`];function Ke(e){return e.replace(/^IDB/,``)}function qe(e){return`${String(e.getDate()).padStart(2,`0`)}.${String(e.getMonth()+1).padStart(2,`0`)}.${e.getFullYear()}`}function Je(e){let t=/^(\d+)_(\d+)$/.exec(e);return t?{pos:t[1],len:t[2]}:null}function Ye(e,t){return e.params.map(e=>e.replace(/\{([A-Z_]+)\}/g,(e,n)=>String(t[n]??``)))}function Xe(e,t){let n=`0,START_TOOL,`+e;return t.length>0&&(n+=`,`+t.map(e=>encodeURIComponent(e)).join(`,`)),n}function Ze(){return globalThis}function Qe(e,t){if(e.trim()===``)return;let n=Ze();try{if(typeof n.sendBWLinkIntern==`function`){n.sendBWLinkIntern(Xe(e,t));return}}catch{}try{if(typeof n.basisHTML_SND_MSG==`function`){let r={NR:e};t.length>0&&(r.PARAMS=[...t]),n.basisHTML_SND_MSG(`START_TOOL`,r)}}catch{}}var $e=new WeakMap;function et(e,t,n){if(e.hasAttribute(`data-ff-editor`))return;let r=We(e.getAttribute(`data-ff-aktionen`))[t];if(!r||r.length===0)return;let i=$e.get(e);if(i||(i=new Set,$e.set(e,i)),!i.has(t)){i.add(t);try{let e={...n,NOW_DATE:qe(new Date)};for(let t of r)t.type===`START_TOOL`&&Qe(t.toolNr,Ye({params:t.toolParams},e))}finally{i.delete(t)}}}var tt=new WeakSet;function nt(e,t){e.hasAttribute(`data-ff-editor`)||e.hasAttribute(`data-ff-aktionen`)&&(tt.has(e)||(tt.add(e),e.addEventListener(`click`,()=>{et(e,t,{})})))}var rt=class extends I{constructor(...e){super(...e),this.label=`Klick mich`}static{this.blockType=`button`}static{this.tagName=`ff-button`}static{this.displayName=`Schaltfläche`}static{this.category=`eingabe`}static{this.defaultProps={label:`Klick mich`}}static{this.resizableWidth=!1}static{this.blockEvents=[{key:`onClick`,name:`Klick`}]}static{this.customProperties=[]}static{this.styles=[I.styles,o`
      button {
    ...
    `]}render(){let e=L(this.chipVariant);return T`<div class="card">
      <div class="row">
        <span
          class="heading"
          data-ff-editable
    ...
    `]}get optionList(){return this.options.split(`,`).map(e=>e.trim()).filter(e=>e!==``)}render(){let e=at(this.fieldType),t=this.required===`ja`,n=this.readonly===`ja`;switch(e){case`textarea`:return T`<textarea
        ...
        />`;default:return T`<input
          ...
          ?required=${t}
          ?readonly=${n}
        />`}}};F([N()],V.prototype,`fieldType`,void 0),F([N()],V.prototype,`placeholder`,void 0),F([N()],V.prototype,`required`,void 0),F([N()],V.prototype,`readonly`,void 0),F([N()],V.prototype,`options`,void 0),I.defineAndRegister(V);var H=class extends I{constructor(...e){super(...e),this.variant=`info`,this.heading=`Hinweis`,this.message=`Das ist ein Hinweistext.`}static{this.blockType=`infobox`}static{this.tagName=`ff-infobox`}static{this.displayName=`Infobox`}static{this.category=`anzeige`}static{this.defaultProps={variant:`info`,heading:`Hinweis`,message:`Das ist ein Hinweistext.`}}static{this.customProperties=[R(`variant`,`Bedeutung der Box — bestimmt die Farbe.`)]}static{this.styles=[I.styles,o`
      .box {
        box-sizing: border-box;
        border: 1px solid var(--se-line);
    ...
    `]}render(){return T`<div class="box v-${L(this.variant)}">
      <p
        class="heading"
        data-ff-editable
        @dblclick=${e=>this.inlineEdit(e,`heading`)}
      ...
      >${this.message}</p>
    </div>`}};F([N()],H.prototype,`variant`,void 0),F([N()],H.prototype,`heading`,void 0),F([N()],H.prototype,`message`,void 0),I.defineAndRegister(H);var U=class extends I{constructor(...e){super(...e),this.variant=`info`,this.heading=`Neue Spalte`,this._count=0}static{this.blockType=`kanban-spalte`}static{this.tagName=`ff-kanban-spalte`}static{this.displayName=`Kanban-Spalte`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[z.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={variant:`info`,heading:`Neue Spalte`,statusValues:[]}}static{this.customProperties=[R(`variant`,`Bedeutung der Spalte — bestimmt ihre Farbwelt (Kopf, Fläche, Rahmen).`),{attributeName:`statusValues`,name:`Wert dieser Spalte`,description:`Einträge, bei denen dieser Wert im Sortier-Feld steht, landen hier; beim Ablegen einer Karte wird er zurückgeschrieben. Leer = der Spaltentitel zählt als Wert. Passt ein Eintrag nirgends, landet er in der ersten Spalte.`,isArray:!0,maxLength:60,kind:`text`,requiresDataSource:!0}]}static{this.styles=[I.styles,o`
      ...
      slot { display: contents; }
    `]}onSlotChange(e){let t=e.target;this._count=t.assignedElements().filter(e=>!e.hasAttribute(`data-ff-editor-helper`)&&e.tagName.toLowerCase()!==`template`).length}render(){return T`<div class="col v-${L(this.variant)}">
      <div class="head">
        <span class="dot"></span>
        <span
          class="title"
    ...
    </div>`}};F([N()],U.prototype,`variant`,void 0),F([N()],U.prototype,`heading`,void 0),F([Fe()],U.prototype,`_count`,void 0),I.defineAndRegister(U);function W(e){return typeof e==`object`&&!!e}function st(e,t){if(!(!Array.isArray(e)||t===``)){for(let n of e)if(!(!W(n)||n.id!==t)&&!(typeof n.name!=`string`||typeof n.tableId!=`string`))return{id:t,name:n.name,tableId:n.tableId,indexField:typeof n.indexField==`string`?n.indexField:``}}}function ct(e,t){if(!(!Array.isArray(e)||t===``)){for(let n of e)if(!(!W(n)||n.id!==t)&&!(typeof n.verb!=`string`||!Ge.includes(n.verb))&&!(typeof n.nr!=`string`||n.nr===``)&&!(!Array.isArray(n.params)||n.params.some(e=>typeof e!=`string`)))return{id:t,verb:n.verb,nr:n.nr,params:n.params}}}function G(e){return e==null?``:String(e).trim()}function K(e,t){if(!W(e)||t===``)return``;let n=t.trim(),r=G(e[n]);if(r!==``)return r;for(let t of Object.keys(e))if(t===n||t.startsWith(`${n}_`)||t.endsWith(`_${n}`)){let n=G(e[t]);if(n!==``)return n}let i=/^(\d+)_(\d+)$/.exec(n);if(!i)return``;let a=G(e.SATZNEU??e.SATZ??e.satzneu??e.satz??e.RAW??e.raw);if(a===``)return``;let o=Number(i[1]),s=Number(i[2]);return s<=0?``:a.substring(o,o+s).trim()}function lt(e,t,n){if(!W(e)||t===``)return!1;let r=t.trim(),i=!1;for(let t of Object.keys(e))(t===r||t.startsWith(`${r}_`)||t.endsWith(`_${r}`))&&(e[t]=n,i=!0);let a=/^(\d+)_(\d+)$/.exec(r);if(a){let t=[`SATZNEU`,`SATZ`,`satzneu`,`satz`,`RAW`,`raw`].find(t=>typeof e[t]==`string`);if(t){let r=e[t],o=Number(a[1]),s=Number(a[2]);if(s>0){let a=n.length>s?n.slice(0,s):n.padEnd(s,` `),c=r.length<o?r.padEnd(o,` `):r;e[t]=c.slice(0,o)+a+c.slice(o+s),i=!0}}}return i}function q(e){if(!W(e))return Array.isArray(e)?e:[];let t=[e.Zeilen,e.zeilen,e.Saetze,e.saetze,e.Rows,e.rows,e.Daten,e.daten];for(let e of t){if(Array.isArray(e))return e;if(typeof e==`string`)try{let t=JSON.parse(e);if(Array.isArray(t))return t}catch{}}return[]}function J(e,t){return G(e).toLowerCase()===t.trim().toLowerCase()}function ut(e,t,n){if(!W(e)||!W(e.Daten))return[];let r=e.Daten,i=r.SEFileLoop;if(Array.isArray(i)){for(let e of i)if(W(e)&&(J(e.ALIAS,t)||J(e.alias,t))){let t=q(e);if(t.length>0)return t}}else if(W(i))for(let e of Object.keys(i)){let n=i[e];if(J(e,t)||W(n)&&(J(n.ALIAS,t)||J(n.alias,t))){let e=q(n);if(e.length>0)return e}}let a=r.Tabellen;if(W(a)){let e=[t,t.toUpperCase(),t.toLowerCase(),n];for(let t of e)if(t!==``&&t in a){let e=q(a[t]);if(e.length>0)return e}for(let e of Object.keys(a))if(J(e,t)){let t=q(a[e]);if(t.length>0)return t}}return[]}function dt(e){let t=e;if(typeof t==`string`)try{t=JSON.parse(t)}catch{return}if(!W(t)||!W(t.Daten))return;let n=t.Daten;if(!(!n.SEFileLoop&&!n.Tabellen&&!n.ErpApiCall))return n}function ft(e){let t=e;if(typeof t==`string`)try{t=JSON.parse(t)}catch{return}if(!(!W(t)||!W(t.MSG)))return t.MSG.DATA}function pt(e){if(typeof e!=`string`||e===``)return[];try{let t=JSON.parse(e);return Array.isArray(t)?t.filter(e=>typeof e==`string`):[]}catch{return[]}}function mt(e,t){let n=pt(e).filter(e=>e.trim()!==``);if(n.length>0)return n;let r=(t??``).trim();return r===``?[]:[r]}function ht(e,t){let n=e.trim().toLowerCase();if(n!==``){for(let e=0;e<t.length;e++)if(t[e].some(e=>e.trim().toLowerCase()===n))return e}return 0}function Y(){return globalThis}function gt(){let e=Y();return W(e.SEDATA)&&W(e.SEDATA.Daten)}function _t(){let e=Y();try{e.selib?.Json?.InitializeERPConnection?.()}catch{}try{typeof e.InitialisiereSchnittstelle==`function`&&e.InitialisiereSchnittstelle()}catch{}}function vt(){let e=Y();try{typeof e.ResetDataBasis==`function`&&e.ResetDataBasis()}catch{}try{typeof e.InitialisiereDatenBasis==`function`&&e.InitialisiereDatenBasis()}catch{}}var yt=new Set,bt=new WeakMap,xt=!1,St=U.tagName,Ct=z.tagName;function wt(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===St)}function Tt(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Ct)}function Et(e){return Le().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function Dt(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(`statusfield`)??``;if(t===``||n===``)return;let r=st(Y().FF_DATA_SOURCES,t);if(!r)return;let i=wt(e);if(i.length===0)return;let a=bt.get(e);if(!a){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(Ct);t&&(a=t.cloneNode(!0),bt.set(e,a))}if(!a)return;let o=ut(Y().SEDATA,r.name,r.tableId),s=i.map(e=>mt(e.getAttribute(`statusvalues`),e.getAttribute(`heading`))),c=Et(a.tagName);for(let e of i)Tt(e).forEach(e=>e.remove());for(let e of o){let t=a.cloneNode(!0);i[ht(K(e,n),s)].appendChild(t);for(let n of c){let r=t.getAttribute(`${n.prop.toLowerCase()}field`)??``;r!==``&&(t[n.prop]=K(e,r))}let o=K(e,r.indexField);o!==``&&(X.set(t,{row:e,pindex:o}),t.draggable=!0)}}var X=new WeakMap,Z=null,Ot=new WeakSet;function kt(e,t){for(let n of t.composedPath())if(n instanceof HTMLElement&&n.tagName.toLowerCase()===St&&e.contains(n))return n;return null}function At(e){let t=Y(),n=ct(t.FF_RELATIONS,e.getAttribute(`putrelation`)??``),r=st(t.FF_DATA_SOURCES,e.getAttribute(`source`)??``);if(!(!n||!r))return{template:n,relId:Ke(r.tableId)}}function jt(e,t,n,r){let i=Y();if(typeof i.basisHTML_SND_MSG!=`function`)return;let a=Je(t);a&&i.basisHTML_SND_MSG(e.template.verb,{NR:e.template.nr,PARAMS:Ye(e.template,{FELD_POS:a.pos,FELD_LEN:a.len,PINDEX:n,DROP_PINDEX:n,RELID:e.relId,VALUE:r,NOW_DATE:qe(new Date)})})}function Mt(e,t){if(!Z||Z.board!==e)return;let n=X.get(Z.card);if(!n)return;let r=e.getAttribute(`statusfield`)??``,i=mt(t.getAttribute(`statusvalues`),t.getAttribute(`heading`)),a=i[0]??``;if(r===``||a.trim()===``)return;let o=K(n.row,r).trim().toLowerCase();if(i.some(e=>e.trim().toLowerCase()===o))return;let s=At(e);s&&(jt(s,r,n.pindex,a),lt(n.row,r,a),Dt(e),et(e,`onCardDrop`,{PINDEX:n.pindex,VALUE:a}))}function Nt(e){Ot.has(e)||(Ot.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;n&&et(e,`onCardClick`,{PINDEX:X.get(n)?.pindex??``})}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;n&&(Z={card:n,board:e},t.dataTransfer?.setData(`text/plain`,X.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`))}),e.addEventListener(`dragend`,()=>{Z=null}),e.addEventListener(`dragover`,t=>{Z?.board===e&&kt(e,t)&&(t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`))}),e.addEventListener(`drop`,t=>{let n=kt(e,t);n&&(t.preventDefault(),Mt(e,n),Z=null)}))}function Q(){gt()&&yt.forEach(Dt)}var Pt=!1;function Ft(e){if(!Pt){Pt=!0;try{let t=typeof e==`string`?e:JSON.stringify(e),n=document.createElement(`textarea`);n.id=`ff-se-diagnose`,n.readOnly=!0,n.value=t??``,n.style.cssText=`display:none;position:fixed;left:8px;right:8px;bottom:8px;height:40vh;z-index:99999;font:11px monospace;`,document.body.appendChild(n)}catch{}}}function It(e){let t=dt(e);if(!t)return;let n=Y();W(n.SEDATA)||(n.SEDATA={}),n.SEDATA.Daten=t,Ft(e),vt(),Q()}function Lt(e=0){let t=Y();if(typeof t.basisHTML_REGISTER==`function`){try{t.basisHTML_SetConsoleLog?.(!0,!0)}catch{}try{t.basisHTML_REGISTER(e=>{It(e)},document.title,`1.0`)}catch{}return}e<400&&setTimeout(()=>{Lt(e+1)},25)}function Rt(){if(xt)return;xt=!0,_t();let e=Y();e.Erstellen=()=>{vt(),Q()},e.initData=e.Erstellen,e.ReloadData=()=>Q(),Lt(),window.addEventListener(`message`,e=>{if(typeof Y().basisHTML_REGISTER==`function`)return;let t=ft(e.data);t!==void 0&&It(t)},!0),document.addEventListener(`keydown`,e=>{if(e.ctrlKey&&e.altKey&&e.key.toLowerCase()===`d`){let e=document.getElementById(`ff-se-diagnose`);e&&(e.style.display=e.style.display===`none`?`block`:`none`)}});let t=0,n=setInterval(()=>{t+=1,gt()?(clearInterval(n),vt(),Q()):t>100&&clearInterval(n)},300)}function zt(e){e.hasAttribute(`data-ff-editor`)||(yt.add(e),Nt(e),Rt(),gt()&&Dt(e))}function Bt(e){yt.delete(e)}var $=U.blockType,Vt=class extends I{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[$]}static{this.childDirection=`row`}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:$}}static{this.templateChild={type:z.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`auto`,source:``,statusField:``,putRelation:`standard-put`}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Das Feld der Datenquelle, dessen Inhalt bestimmt, in welche Spalte ein Eintrag kommt (z. B. Behandlungszimmer).`,isArray:!1,maxLength:0,kind:`field`},{attributeName:`putRelation`,name:`Beim Verschieben zurückschreiben über`,description:`Relation-Vorlage, über die eine verschobene Karte den Wert ihrer neuen Spalte ins Sortier-Feld zurückschreibt.`,isArray:!1,maxLength:0,kind:`relation`,requiresDataSource:!0}]}static{this.defaultChildren=[{type:$,props:{heading:`Offen`,variant:`warning`},children:[{type:z.blockType}]},{type:$,props:{heading:`In Arbeit`,variant:`info`}},{type:$,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[I.styles,o`
    ...
    `]}render(){return T`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),zt(this)}disconnectedCallback(){super.disconnectedCallback(),Bt(this)}};I.defineAndRegister(Vt);var Ht=class extends I{constructor(...e){super(...e),this.text=`Neuer Text`}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Textblock`}static{this.category=`anzeige`}static{this.defaultProps={text:`Neuer Text`}}static{this.customProperties=[]}static{this.styles=[I.styles,o`
      span {
        display: block;
        min-width: 1ch;
        color: var(--se-ink);
    ...
    `]}render(){return T`<span
      data-ff-editable
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</span>`}};F([N()],Ht.prototype,`text`,void 0),I.defineAndRegister(Ht)})();
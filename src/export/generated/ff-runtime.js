...
\f\r]`,Ce=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,we=/-->/g,Te=/>/g,h=RegExp(`>|${Se}(?:([^\\s"'>=/]+)(${Se}*=${Se}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,`g`),Ee=/'/g,De=/"/g,Oe=/^(?:script|style|textarea|title)$/i,ke=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),g=ke(1),Ae=ke(2),_=Symbol.for(`lit-noChange`),v=Symbol.for(`lit-nothing`),je=new WeakMap,y=m.createTreeWalker(m,129);function Me(e,t){if(!be(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return me===void 0?t:me.createHTML(t)}var Ne=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:t===3?`<math>`:``,o=Ce;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===Ce?c[1]===`!--`?o=we:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=h):(Oe.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=h):o=Te:o===h?c[0]===`>`?(o=i??Ce,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?h:c[3]===`"`?De:Ee):o===De||o===Ee?o=h:o===we||o===Te?o=Ce:(o=h,i=void 0);let d=o===h&&e[t+1].startsWith(`/>`)?` `:``;a+=o===Ce?n+_e:l>=0?(r.push(s),n.slice(0,l)+he+n.slice(l)+p+d):n+p+(l===-2?t:d)}return[Me(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:t===3?`</math>`:``)),r]},Pe=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=Ne(t,n);if(this.el=e.createElement(l,r),y.currentNode=this.el.content,n===2||n===3){let e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;(i=y.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes())for(let e of i.getAttributeNames())if(e.endsWith(he)){let t=u[o++],n=i.getAttribute(e).split(p),r=/([.?@])?(.*)/.exec(t);c.push({type:1,index:a,name:r[2],strings:n,ctor:r[1]===`.`?Re:r[1]===`?`?ze:r[1]===`@`?Be:Le}),i.removeAttribute(e)}else e.startsWith(p)&&(c.push({type:6,index:a}),i.removeAttribute(e));if(Oe.test(i.tagName)){let e=i.textContent.split(p),t=e.length-1;if(t>0){i.textContent=pe?pe.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],ve()),y.nextNode(),c.push({type:2,index:++a});i.append(e[t],ve())}}}else if(i.nodeType===8)if(i.data===ge)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(p,e+1))!==-1;)c.push({type:7,index:a}),e+=p.length-1}a++}}static createElement(e,t){let n=m.createElement(`template`);return n.innerHTML=e,n}};function b(e,t,n=e,r){if(t===_)return t;let i=r===void 0?n._$Cl:n._$Co?.[r],a=ye(t)?void 0:t._$litDirective$;return i?.constructor!==a&&(i?._$AO?.(!1),a===void 0?i=void 0:(i=new a(e),i._$AT(e,n,r)),r===void 0?n._$Cl=i:(n._$Co??=[])[r]=i),i!==void 0&&(t=b(e,i._$AS(e,t.values),i,r)),t}var Fe=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??m).importNode(t,!0);y.currentNode=r;let i=y.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new Ie(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new Ve(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=y.nextNode(),a++)}return y.currentNode=m,r}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},Ie=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,r){this.type=2,this._$AH=v,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=b(this,e,t),ye(e)?e===v||e==null||e===``?(this._$AH!==v&&this._$AR(),this._$AH=v):e!==this._$AH&&e!==_&&this._(e):e._$litType$===void 0?e.nodeType===void 0?xe(e)?this.k(e):this._(e):this.T(e):this.$(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==v&&ye(this._$AH)?this._$AA.nextSibling.data=e:this.T(m.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=Pe.createElement(Me(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.p(t);else{let e=new Fe(r,this),n=e.u(this.options);e.p(t),this.T(n),this._$AH=e}}_$AC(e){let t=je.get(e.strings);return t===void 0&&je.set(e.strings,t=new Pe(e)),t}k(t){be(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.O(ve()),this.O(ve()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let t=fe(e).nextSibling;fe(e).remove(),e=t}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},Le=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,r,i){this.type=1,this._$AH=v,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=v}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=b(this,e,t,0),a=!ye(e)||e!==this._$AH&&e!==_,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=b(this,r[n+o],t,o),s===_&&(s=this._$AH[o]),a||=!ye(s)||s!==this._$AH[o],s===v?e=v:e!==v&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===v?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},Re=class extends Le{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===v?void 0:e}},ze=class extends Le{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==v)}},Be=class extends Le{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=b(this,e,t,0)??v)===_)return;let n=this._$AH,r=e===v&&n!==v||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==v&&(n===v||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Ve=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){b(this,e)}},He=de.litHtmlPolyfillSupport;He?.(Pe,Ie),(de.litHtmlVersions??=[]).push(`3.3.3`);var Ue=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new Ie(t.insertBefore(ve(),e),e,void 0,n??{})}return i._$AI(e),i},We=globalThis,x=class extends f{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Ue(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return _}};x._$litElement$=!0,x.finalized=!0,We.litElementHydrateSupport?.({LitElement:x});var Ge=We.litElementPolyfillSupport;Ge?.({LitElement:x}),(We.litElementVersions??=[]).push(`4.2.2`);var Ke={attribute:!0,type:String,converter:ce,reflect:!1,hasChanged:le},qe=(e=Ke,t,n)=>{let{kind:r,metadata:i}=n,a=globalThis.litPropertyMetadata.get(i);if(a===void 0&&globalThis.litPropertyMetadata.set(i,a=new Map),r===`setter`&&((e=Object.create(e)).wrapped=!0),a.set(n.name,e),r===`accessor`){let{name:r}=n;return{set(n){let i=t.get.call(this);t.set.call(this,n),this.requestUpdate(r,i,e,!0,n)},init(t){return t!==void 0&&this.C(r,void 0,e,t),t}}}if(r===`setter`){let{name:r}=n;return function(n){let i=this[r];t.call(this,n),this.requestUpdate(r,i,e,!0,n)}}throw Error(`Unsupported decorator location: `+r)};function S(e){return(t,n)=>typeof n==`object`?qe(e,t,n):((e,t,n)=>{let r=t.hasOwnProperty(n);return t.constructor.createProperty(n,e),r?Object.getOwnPropertyDescriptor(t,n):void 0})(e,t,n)}function C(e){return S({...e,state:!0,attribute:!1})}var Je=new Map;function Ye(e){Je.has(e.type)&&console.warn(`Block-Typ "${e.type}" wird ueberschrieben.`),Je.set(e.type,e)}function Xe(){return Array.from(Je.values())}var Ze={width:`auto`};function Qe(e){return Object.entries(e).map(([e,t])=>`${e.replace(/[A-Z]/g,e=>`-`+e.toLowerCase())}:${t}`).join(`;`)}var $e={spalten:24,spaltePx:40,zeilePx:12,gapPx:8},et={rasterX:0,rasterY:0,rasterW:$e.spalten,rasterH:1};function tt(){return{display:`grid`,gridTemplateColumns:`repeat(${$e.spalten}, 1fr)`,gridAutoRows:`${$e.zeilePx}px`,gap:`${$e.gapPx}px`,alignContent:`start`}}function nt(){return Qe(tt())}var rt=`weitereQuellen`,it={[rt]:[]},at=`folgtAuswahl`,ot={[at]:[]};function st(e,t){let n=e.textContent??``,r=Array.from(e.childNodes),i=r.map(e=>e.textContent??``);e.setAttribute(`contenteditable`,`plaintext-only`),e.focus();let a=window.getSelection(),o=document.createRange();o.selectNodeContents(e),a?.removeAllRanges(),a?.addRange(o);let s=()=>{e.replaceChildren(...r),r.forEach((e,t)=>{e.textContent!==i[t]&&(e.textContent=i[t])})},c=!1,l=r=>{c||(c=!0,e.removeAttribute(`contenteditable`),e.removeEventListener(`blur`,u),e.removeEventListener(`keydown`,d),r&&t((e.textContent??``).trim(),n)||s())},u=()=>l(!0),d=t=>{t.key===`Enter`?(t.preventDefault(),e.blur()):t.key===`Escape`&&(t.preventDefault(),l(!1))};e.addEventListener(`blur`,u),e.addEventListener(`keydown`,d)}function w(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var T=class extends x{constructor(...e){super(...e),this.editable=!1}static{this.styles=o`
  ...
  `}aktualisiereEscape(){let e=this.isConnected&&this.escapeSchliesst;e!==this.escapeRegistriert&&(e?document.addEventListener(`keydown`,this.aufTaste,!0):document.removeEventListener(`keydown`,this.aufTaste,!0),this.escapeRegistriert=e)}ziehe(e,t){if(!this.ziehbar)return;e.preventDefault(),e.stopPropagation();let n=t===`breite`?Qt(this.breite,520):Qt(this.hoehe,380),r=t===`breite`?240:160,i=t===`breite`?e.clientX:e.clientY,a=Math.max(r,Math.round(n)),o=!1,s=(e,n)=>{this.dispatchEvent(new CustomEvent(Zt,{detail:{achse:t,wert:e,geste:n},bubbles:!0,composed:!0}))},c=e=>{let c=t===`breite`?e.clientX:e.clientY,l=Math.max(r,Math.round(n+(c-i)*2));l!==a&&(a=l,s(l,o?`laeuft`:`beginn`),o=!0)},l=()=>{window.removeEventListener(`pointermove`,c),window.removeEventListener(`pointerup`,l),window.removeEventListener(`pointercancel`,l),window.removeEventListener(`blur`,l),o&&s(a,`ende`)};window.addEventListener(`pointermove`,c),window.addEventListener(`pointerup`,l),window.addEventListener(`pointercancel`,l),window.addEventListener(`blur`,l)}aufStandard(e,t){this.ziehbar&&(e.stopPropagation(),this.dispatchEvent(new CustomEvent(Zt,{detail:{achse:t,wert:0,geste:`standard`},bubbles:!0,composed:!0})))}schliesse(){this.dispatchEvent(new CustomEvent(Xt,{bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this.aktualisiereEscape()}updated(e){e.has(`escapeSchliesst`)&&this.aktualisiereEscape()}disconnectedCallback(){this.escapeRegistriert&&=(document.removeEventListener(`keydown`,this.aufTaste,!0),!1),super.disconnectedCallback()}render(){let e=Qt(this.breite,520),t=Qt(this.hoehe,380);return g`
    ...
    `}};w([S()],P.prototype,`titel`,void 0),w([S({type:Number})],P.prototype,`breite`,void 0),w([S({type:Number})],P.prototype,`hoehe`,void 0),w([S({type:Boolean,reflect:!0})],P.prototype,`viewport`,void 0),w([S({type:Boolean,attribute:`escape-schliesst`})],P.prototype,`escapeSchliesst`,void 0),w([S({type:Boolean,attribute:`ohne-modal`})],P.prototype,`ohneModal`,void 0),w([S({type:Boolean,reflect:!0,attribute:`inhalt-fest`})],P.prototype,`inhaltFest`,void 0),w([S({type:Boolean,reflect:!0})],P.prototype,`ziehbar`,void 0),customElements.get(`ff-dialog-rahmen`)||customElements.define(Yt,P);var $t=`input,select,textarea,button,a[href],[tabindex]:not([tabindex="-1"])`;function en(e){for(let t of Array.from(e.querySelectorAll(`*`))){if(t instanceof HTMLElement&&t.matches($t)&&!t.hasAttribute(`disabled`))return t;let e=t.shadowRoot?en(t.shadowRoot):null;if(e)return e}return null}var F=class extends T{constructor(...e){super(...e),this.name=`Popup`,this.breite=520,this.hoehe=380,this.offen=!1}static{this.blockType=`popup`}static{this.tagName=`ff-popup`}static{this.displayName=`Popup`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.showInPalette=!1}static{this.allowedParentTypes=[ct]}static{this.pageBlock=!0}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.defaultProps={name:`Popup`,breite:520,hoehe:380}}static{this.styles=[T.styles,o`
    ...
    `]}onClose(){this.hasAttribute(`data-ff-editor`)||this.removeAttribute(`offen`)}updated(e){super.updated(e),!(!e.has(`offen`)||!this.offen)&&(this.hasAttribute(`data-ff-editor`)||this.updateComplete.then(()=>{!this.offen||!this.isConnected||(en(this)??(this.shadowRoot?en(this.shadowRoot):null))?.focus()}))}render(){return g`<ff-dialog-rahmen
        .breite=${this.breite}
        .hoehe=${this.hoehe}
        ohne-modal
        inhalt-fest
...
`,B=class extends T{constructor(...e){super(...e),this.chipVariant=`info`,this.heading=``,this.heading2=``,this.time=``,this.date=``,this.avatar=``,this.meta=``,this.text=``,this.chipText=``,this.headingField=``,this.heading2Field=``,this.timeField=``,this.dateField=``,this.avatarField=``,this.metaField=``,this.textField=``,this.chipTextField=``}static{this.blockType=`card`}static{this.tagName=`ff-card`}static{this.displayName=`Karte`}static{this.category=`anzeige`}static{this.allowedParentTypes=[`kanban-spalte`,`kanban-zimmer`]}static{this.showInPalette=!1}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={chipVariant:`info`,heading:``,heading2:``,time:``,date:``,avatar:``,meta:``,text:``,chipText:``,headingField:``,heading2Field:``,timeField:``,dateField:``,avatarField:``,metaField:``,textField:``,chipTextField:``}}static{this.bindableSpots=[{prop:`time`,label:`Zeit`},{prop:`date`,label:`Datum`},{prop:`avatar`,label:`Avatar`},{prop:`heading`,label:`Titel`},{prop:`heading2`,label:`Titel 2`},{prop:`meta`,label:`Unterzeile`},{prop:`text`,label:`Textzeile`},{prop:`chipText`,label:`Chip`}]}static{this.customProperties=[er(`chipVariant`,`Bedeutung des Chips auf der Karte — bestimmt die Chip-Farbe.`)]}static{this.styles=[T.styles,tr,lr]}stelle(e,t){return g`<span
    ...
    >${this[e]}</span>`}hatReiter(){return this.hasAttribute(`data-ff-editor`)||this.date.trim()!==``||this.time.trim()!==``}updated(e){super.updated(e),this.toggleAttribute(`hat-reiter`,this.hatReiter())}render(){let e=Qn(this.chipVariant),t=this.hasAttribute(`data-ff-editor`),n=e=>t||e.trim()!==``,r=this.hatReiter(),i=n(this.avatar)||n(this.heading)||n(this.meta),a=n(this.heading2)||n(this.chipText);return g`<div class="card v-${e}${r?``:` ohne-reiter`}">
      ...
      ${i?g`<div class="kopf">
            ${n(this.avatar)?g`<span
                ...
                >${this.avatar.trim()===``?v:cr(this.avatar)}</span>`:v}
            <div class="namen">
    ...
    `]}setzeTag(e){gr(e),this.tag=hr()}render(){return g`<div class="waehler">
      <div class="riegel">
  ...
  >${e.eintraege.map((t,n)=>g`<li
    ...
    ><span class="vorschlag-anzeige">${t.anzeige===``?t.wert:t.anzeige}</span>${t.wert!==``&&t.wert!==t.anzeige?g`<span class="vorschlag-wert">${t.wert}</span>`:v}</li>`)}</ul>`}var Er=o`
  .vorschlaege {
    position: absolute;
    top: 100%;
    left: 0;
...
`;function qi(e,t){if(!e.hasAttribute(`fuellt`))return null;let n=e.renderRoot.querySelector(`.koerper`),r=e.renderRoot.querySelector(`.kopf`);return!(n instanceof HTMLElement)||!(r instanceof HTMLElement)?null:vi(n.clientHeight,r.offsetHeight,t)}function Ji(e,t){if(typeof ResizeObserver>`u`)return null;let n=e.renderRoot.querySelector(`.koerper`);if(!n)return null;let r=new ResizeObserver(t);return r.observe(n),r}function Yi(e,t){let n=(e?.feld??``).trim();if(n===``)return{art:`frei`,quelleId:``,code:``};let{quelleId:r,code:i}=jr(n);return r===``?{art:`eigen`,quelleId:t,code:i}:{art:`verknuepft`,quelleId:r,code:i}}function G(e,t){return Yi(e.spalten[t],e.quelleId)}function Xi(e){let t=[];for(let n of e.spalten){let r=Yi(n,e.quelleId);r.art!==`verknuepft`||r.quelleId===``||t.includes(r.quelleId)||t.push(r.quelleId)}return t}function Zi(e,t){let n=G(e,t);if(!(n.quelleId===``||n.code===``))for(let r=0;r<e.spalten.length;r++){if(r===t)continue;let i=e.spalten[r],a=Yi(i,e.quelleId);if(a.quelleId===n.quelleId&&!(a.code===``||a.code===n.code))return{titel:i.titel,code:a.code}}}function Qi(e,t){let n=e.spalten[t],r=Zi(e,t);return n===void 0||r===void 0?[]:[{titel:r.titel,feld:r.code,art:V},{titel:n.titel,feld:G(e,t).code,art:V}]}function $i(e,t,n){return t===void 0||e.length===0?[...n]:n.filter(n=>e.every(e=>{let r=k(t,e.fromField);return r!==``&&r===k(n,e.toField)}))}function ea(e,t,n){return g`<input
    ...
    @blur=${()=>t.verlassen(n)}
  />`}function ta(e,t,n,r){if(r)return ea(e,t,n);let i=e.tippSpalte===n&&e.vorschlaege.length>0;return g`<div class=${e.listeNachOben?`erf-halter nach-oben`:`erf-halter`}>
    ${ea(e,t,n)}
    ${i?Tr({eintraege:e.vorschlaege,marke:e.marke,onWaehlen:e=>t.waehleVorschlag(e),onMarke:e=>t.setzeMarke(e)}):v}
  </div>`}function na(e,t){return g`<div class="zeile erfassung" role="row" style=${W(e.cols)}>
    ${e.spalten.map((n,r)=>{let i=H(n.art).klasse;return e.imEditor?g`<div class=${i} role="cell">${`—`}</div>`:g`<div class=${i} role="cell">${ta(e,t,r,Yi(n,e.quelleId).art===`frei`)}</div>`})}
  </div>`}function ra(e,t,n){let r=e.lauf.vorschlaege[n];r!==void 0&&(e.lauf.uebernimm(e.umfeld(),t,r.satz),e.melde())}function ia(e,t){let n=e.umfeld(),r=n.spalten[t],i=G(n,t);r===void 0||i.quelleId===``||i.code===``||xo({el:e.baustein,quelleId:i.quelleId,speicherFeld:i.code,speicherTitel:r.titel,spalten:Qi(n,t),titel:r.titel,breite:520,hoehe:380,eintraege:e.lauf.eintraege(n,t),rueckFokus:null,onUebernehmen:(n,r,i)=>{e.lauf.uebernimm(e.umfeld(),t,i),e.melde()}})}function aa(e,t,n){let r=e.lauf.entscheideTaste(e.umfeld(),t,n.key);if(r===`nichts`){n.key===`Enter`&&n.preventDefault();return}n.preventDefault(),r===`uebernehmen`?ra(e,t,e.lauf.marke):r===`fenster`&&ia(e,t),e.melde()}function oa(e,t,n){let r=e.umfeld();return na({spalten:r.spalten,quelleId:r.quelleId,cols:t,imEditor:e.baustein.hasAttribute(`data-ff-editor`),wert:t=>e.lauf.wertVon(r,t),tippSpalte:e.lauf.tippSpalte,vorschlaege:e.lauf.vorschlaege,marke:e.lauf.marke,listeNachOben:n},{tippen:(t,n)=>{e.lauf.tippe(t,n),e.melde()},taste:(t,n)=>aa(e,t,n),verlassen:t=>{e.lauf.verlasse(t),e.melde()},waehleVorschlag:t=>ra(e,e.lauf.tippSpalte,t),setzeMarke:t=>{e.lauf.setzeMarke(t),e.melde()}})}var sa=class{constructor(){this.getippt=new Map,this.gewaehlt=new Map,this._tippSpalte=-1,this._marke=0,this._listeZu=!1,this._vorschlaege=[]}get tippSpalte(){return this._tippSpalte}get marke(){return this._marke}get vorschlaege(){return this._vorschlaege}wertVon(e,t){let n=this.getippt.get(t);if(n!==void 0)return n;let r=G(e,t);if(r.quelleId===``||r.code===``)return``;let i=this.gewaehlt.get(r.quelleId);return i===void 0?``:k(i,r.code)}tippe(e,t){this.getippt.set(e,t),this._tippSpalte=e,this._marke=0,this._listeZu=!1}verlasse(e){this._tippSpalte===e&&(this._tippSpalte=-1,this._listeZu=!1,this._marke=0)}entscheideTaste(e,t,n){if(G(e,t).art===`frei`)return`nichts`;let r=wr(n,{listeOffen:this._tippSpalte===t&&this._vorschlaege.length>0,feldLeer:this.wertVon(e,t)===``});return r===`marke-hoch`?this._marke=Sr(this._marke,this._vorschlaege.length,-1):r===`marke-runter`?this._marke=Sr(this._marke,this._vorschlaege.length,1):r===`liste-zu`&&(this._listeZu=!0),r}setzeMarke(e){this._marke=e}uebernimm(e,t,n){let r=G(e,t);if(r.quelleId!==``){if(this.setze(e,r.quelleId,n),r.art===`eigen`){for(let t of[...this.gewaehlt.keys()])t!==r.quelleId&&this.setze(e,t,void 0);this.fuelleVerknuepfte(e)}this._tippSpalte=-1,this._marke=0,this._listeZu=!1}}setze(e,t,n){n===void 0?this.gewaehlt.delete(t):this.gewaehlt.set(t,n);for(let n=0;n<e.spalten.length;n++)Yi(e.spalten[n],e.quelleId).quelleId===t&&this.getippt.delete(n)}fuelleVerknuepfte(e){let t=this.gewaehlt.get(e.quelleId);if(t!==void 0)for(let n of Xi(e)){if(this.gewaehlt.has(n))continue;let r=oo(n);if(r===null)continue;let i=$i(e.paareZu(n),t,r);i.length===1&&this.setze(e,n,i[0])}}zuruecksetzen(){this.getippt.clear(),this.gewaehlt.clear(),this._tippSpalte=-1,this._marke=0,this._listeZu=!1,this._vorschlaege=[]}aktualisiereVorschlaege(e){this._vorschlaege=this.berechne(e),this._marke=Cr(this._marke,this._vorschlaege.length)}berechne(e){let t=this._tippSpalte;if(this._listeZu||G(e,t).art===`frei`)return[];let n=this.getippt.get(t)??``;return n===``?[]:xr(this.eintraege(e,t),n)}eintraege(e,t){let n=G(e,t);if(n.quelleId===``||n.code===``)return[];let r=oo(n.quelleId);return r===null?[]:io(n.art===`verknuepft`?$i(e.paareZu(n.quelleId),this.gewaehlt.get(e.quelleId),r):r,Zi(e,t)?.code??``,n.code)}},ca=o`
      .zeile.erfassung {
        flex: none;
        background: var(--se-panel-2);
...
`;function la(e){return{rohzeilen:e.map(e=>e.rohzeile),datenzeilen:e.map(e=>[...e.zellen]),zusatzzeilen:e.map(e=>(e.zusatz??[]).map(e=>({...e})))}}function ua(e,t,n){return t===``||n===``?[...e]:e.filter(e=>ur(k(e,t))===n)}function da(e){let t=e.getAttribute(`source`)??``;if(t===``)return null;let n=O(R().FF_DATA_SOURCES,t);return n?{quelle:n,zeilen:ua(j(R().SEDATA,n.name,n.tableId),e.getAttribute(`tagfield`)??``,hr()),lies:Xr(e)}:null}function fa(e){return Li(e.getAttribute(`spalten`)??``)}function pa(e,t,n){let r={};for(let i of H(e.art).zusatzFelder??[]){let a=e.felder?.[i.key]??``;a!==``&&(r[i.key]=n(t,a))}return r}function ma(e,t){let n=O(R().FF_DATA_SOURCES,e.getAttribute(`source`)??``);return n?Ct(n,t):``}function ha(e){let t=da(e);if(!t){e.datenzeilen=[],e.zusatzzeilen=[];return}let n=fa(e),{rows:r,gefiltert:i}=qt(e,t.zeilen),a=Bt(N(e),r,e=>e)[0]??-1,o=t.lies;e.datenGeliefert=!0,e.rohzeilen=r,e.auswahlIndex=a,e.durchAuswahlGefiltert=i,e.datenzeilen=r.map(e=>n.map(t=>t.feld===``?``:o(e,t.feld))),e.zusatzzeilen=r.map(e=>n.map(t=>pa(t,e,o)))}var ga=Gr({hydriere:ha}),_a=ga.connect,va=ga.disconnect;function ya(e,t){let n=[];return e.forEach((e,r)=>{br(e,t)&&n.push(r)}),n}function ba(e,t){return!e&&t.trim()!==``}function xa(e,t,n){return e&&t&&n===0}function Sa(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}function Ca(e,t,n){return g`<div class="steuerung">
    <button
    ...
    >+</button>
  </div>`}function wa(e,t){let n=e.currentTarget;n&&(e.stopPropagation(),e.preventDefault(),st(n,(e,n)=>e===``||e===n.trim()?!1:(t(e),!0)))}function Ta(e,t,n,r){wa(e,e=>{let i=n();t>=i.length||(i[t]={...i[t],titel:e},r(i))})}var Ea=220,Da=new WeakMap;function Oa(e){let t=Da.get(e);t!==void 0&&(clearTimeout(t),Da.delete(e))}function ka(e,t,n){t.stopPropagation();let r=t.currentTarget.getBoundingClientRect();Oa(e),Da.set(e,setTimeout(()=>{Da.delete(e),e.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:n.prop,index:n.index,top:r.bottom+4,left:r.left,...n.liste?{liste:n.liste()}:{}},bubbles:!0,composed:!0}))},Ea))}var Aa={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:Ai,eintragsWahl:{key:`art`,label:`Darstellung`,optionen:Oi,standard:V,felderKey:ki},eintragsZuordnung:{key:`zuordnung`,label:`Status-Zuordnung`,nurBeiWahl:Si,wertLabel:`Datenwert`,nameLabel:`Klarname`,bedeutungLabel:`Bedeutung`,bedeutungen:$n}},ja=1,Ma=/^-?\d{1,3}(\.\d{3})*(,\d+)?$|^-?\d+(,\d+)?$|^-?\d+(\.\d+)?$/,Na=/^(\d{1,2})\.(\d{1,2})\.(\d{2}|\d{4})$/,Pa=/^(\d{4})-(\d{2})-(\d{2})$/;function Fa(e){let t=e.trim();if(t===``||!Ma.test(t))return null;let n=t.includes(`,`)?t.replace(/\./g,``).replace(`,`,`.`):/^-?\d{1,3}(\.\d{3})+$/.test(t)?t.replace(/\./g,``):t,r=Number(n);return Number.isFinite(r)?r:null}function Ia(e){let t=e.trim();if(t===``)return null;let n=Pa.exec(t);if(n){let[,e,t,r]=n;return La(Number(e),Number(t),Number(r))}let r=Na.exec(t);if(r){let[,e,t,n]=r,i=Number(n);return La(n.length===2?i<=69?2e3+i:1900+i:i,Number(t),Number(e))}return null}function La(e,t,n){if(t<1||t>12||n<1||n>31)return null;let r=new Date(e,t-1,n);return r.getFullYear()!==e||r.getMonth()!==t-1||r.getDate()!==n?null:r.getTime()}function Ra(e){let t=0,n=0,r=0;for(let i of e)i.trim()!==``&&(t++,Fa(i)!==null&&n++,Ia(i)!==null&&r++);return t===0?`text`:r===t?`datum`:n===t?`zahl`:`text`}var za=new Intl.Collator(`de`,{numeric:!0,sensitivity:`base`});function Ba(e,t,n){if(t<0||e.length===0)return e.map((e,t)=>t);let r=n=>e[n][t]??``,i=Ra(e.map(e=>e[t]??``)),a=n?1:-1;return e.map((e,t)=>t).sort((e,t)=>{let n=r(e).trim(),o=r(t).trim();if(n===``&&o===``)return e-t;if(n===``)return ja;if(o===``)return-1;let s=i===`zahl`?(Fa(n)??0)-(Fa(o)??0):i===`datum`?(Ia(n)??0)-(Ia(o)??0):za.compare(n,o);return s===0?e-t:s*a})}function Va(e){let t=ya(e.datenzeilen,e.suchtext);return e.sortSpalte<0?t:Ba(t.map(t=>e.datenzeilen[t]),e.sortSpalte,e.sortAuf).map(e=>t[e])}function Ha(e){let t={gridTemplateColumns:e.spalten.map(e=>H(e.art).spur).join(` `)},n=Di(e.spalten),r=e.gemessen?.zeilenHoehe??n,i=e.hatQuelle,a=!e.erfassungAn&&xa(i,e.datenGeliefert,e.datenzeilen.length),o=Va(e),s=+!!e.erfassungAn,c=e.gemessen===null?null:Math.max(1,e.gemessen.passen-s),{seiten:l,seite:u,zeilen:d}=bi({sichtbar:o,hatQuelle:i,proSeite:c??Math.max(1,10-s),wunschSeite:e.wunschSeite,platzhalterZeilen:gi(c)});return{cols:t,takt:n,zeilenHoehe:r,hatQuelle:i,leer:a,gesamt:o.length,seiten:l,seite:u,zeilen:d,linealTakte:yi(c,d.length)}}var Ua=[Dr(`suche`,`Suchzeile`,`Zeigt über der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,{requiresDataSource:!0}),Dr(`erfassung`,`Erfassungszeile`,`Zeigt als nächste freie Zeile eine leere Zeile, in der der Bediener eine neue Position tippt. Was eine Zelle dort tut, wird an ihr eingestellt: Klick auf die Zelle wählt die Rolle (Frei, Nachschlagen, Folgt) und bei den nachschlagenden ihre eigene Quelle samt Feld; Doppelklick auf eine Frei-Zelle tippt ihre Vorbelegung.`),{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt die Tabelle nur Sätze des Tages, den der Tageswähler zeigt. Leer = alle Sätze.`,kind:`field`},Wi()];function Wa(e,t){return g`<div class="fusszeile">
    <div class="seiten-info">${Sa({hatQuelle:e.hatQuelle,sichtbar:e.sichtbar,gesamt:e.gesamt,suchtAktiv:e.suchtAktiv,auswahlAktiv:e.auswahlAktiv})}</div>
    <div class="seiten-nav">
  ...
  </div>`}function Ga(e){return e.linealTakte===0?v:g`<div class="lineal" role="presentation" style=${W(e.linealTakte===null?e.cols:{...e.cols,flex:`0 1 auto`,height:`calc(var(--zeilen-hoehe) * ${e.linealTakte})`})}>
          ${e.spalten.map(()=>g`<div></div>`)}
        </div>`}function Ka(e,t){return g`
      ...
      <div class="kopf" role="row" style=${W(e.cols)}>
        ...
        ${e.zeilen.map((n,r)=>{let i=n!==null&&!e.imEditor;return g`<div
          ...
          >
            ${``}
            ${e.spalten.map((t,r)=>{let i=H(t.art),a=n===null?`—`:e.datenzeilen[n]?.[r]??``,o=n===null?{}:e.zusatzzeilen[n]?.[r]??{};return g`<div class=${i.klasse} role="cell">${i.zelle(a,t.zuordnung??[],o)}</div>`})}
          </div>`})}
...
`,Ja=`ff-zeile-aktiviert`,Ya=`data-ff-roh`;function Xa(e,t){e.dispatchEvent(new CustomEvent(Ja,{detail:t,bubbles:!0,composed:!0}))}function Za(e){let t=e?.activeElement;if(!(t instanceof HTMLElement))return;let n=t.closest(`.zeile`);if(!n)return;let r=n.getAttribute(Ya);return r===null||r===``?null:Number(r)}function Qa(e,t){e&&((t===null?null:e.querySelector(`.zeile[data-ff-roh="${t}"]`))??e.querySelector(`.zeile[data-ff-roh]`)??e.querySelector(`.koerper`))?.focus()}var K=class e extends T{constructor(...e){super(...e),this.spalten=Mi(),this.source=``,this.suche=`ja`,this.erfassung=`nein`,this.leerText=Ui,this._suchtext=``,this.datenzeilen=[],this.zusatzzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this.datenGeliefert=!1,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._beobachter=null,this._taktGemessen=0,this._fokusZeile=null,this._fokusHolen=!1,this._besitz=`softengine`,this._lauf=new sa}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.blockEvents=[{key:`onRowClick`,name:`Zeile gewählt`}]}static{this.listenBindung=Aa}static{this.defaultProps={width:`fill`,source:``,spalten:Mi(),suche:`ja`,erfassung:`nein`,tagField:``,leerText:Ui}}static{this.customProperties=Ua}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get besitz(){return this._besitz}set besitz(e){e!==this._besitz&&(this._besitz=e,this.setzeAbgeleitetesZurueck(),this.isConnected&&(e===`provided`?va(this):_a(this)),this.requestUpdate())}set bereitgestellteZeilen(e){let t=la(e);this.rohzeilen=t.rohzeilen,this.datenzeilen=t.datenzeilen,this.zusatzzeilen=t.zusatzzeilen,this.datenGeliefert=!0,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._seite=0,this._mass=null,this._taktGemessen=0,this.requestUpdate()}setzeAbgeleitetesZurueck(){this.rohzeilen=[],this.datenzeilen=[],this.zusatzzeilen=[],this.datenGeliefert=!1,this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._suchtext=``,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._mass=null,this._taktGemessen=0,this._fokusZeile=null,this._fokusHolen=!1,this._lauf.zuruecksetzen()}fokussiereSuche(){let e=this.shadowRoot?.querySelector(`.suchzeile input`);return e?(e.focus(),!0):!1}get hatQuelle(){return this._besitz===`provided`||ba(this.hasAttribute(`data-ff-editor`),this.source)}merkeZeilenFokus(){let e=Za(this.shadowRoot);this._fokusHolen=e!==void 0,this._fokusZeile=e??null}messeRumpf(){let e=this.zeilenHoehe;this._taktGemessen=e;let t=qi(this,e);t?.passen===this._mass?.passen&&t?.zeilenHoehe===this._mass?.zeilenHoehe||(this._mass=t,this.requestUpdate())}spaltenListe(){return Ii(this.spalten)}get zeilenHoehe(){return Di(this.spaltenListe())}aktiviereZeile(e,t){if(e===null||this.hasAttribute(`data-ff-editor`))return;let n=this.rohzeilen[e];n!==void 0&&(Xa(this,{rohzeile:n,rohIndex:e,ansichtIndex:t}),this.toggleAuswahl(n),qn(this,`onRowClick`,{PINDEX:ma(this,n)}).catch(z))}toggleAuswahl(e){let t=N(this);t!==``&&Vt(t,e)}setzeSuchtext(e){this.merkeZeilenFokus(),this._suchtext=e,this._seite=0,this.requestUpdate()}klickSortiere(e){this.editable||(this.merkeZeilenFokus(),this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.requestUpdate())}get erfassungAn(){return this.erfassung===`ja`}erfassungsWirt(){return{baustein:this,lauf:this._lauf,umfeld:()=>this.erfassungsUmfeld(),melde:()=>this.requestUpdate()}}erfassungsUmfeld(){let e=Yr(this);return{spalten:this.spaltenListe(),quelleId:this.source,paareZu:t=>e.find(e=>e.quelleId===t)?.keyPairs??[]}}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}beobachte(){this._beobachter||(this._beobachter=Ji(this,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}connectedCallback(){super.connectedCallback(),this._besitz===`softengine`&&_a(this),this.beobachte()}firstUpdated(){this.beobachte()}willUpdate(e){super.willUpdate(e),!(!this.erfassungAn||this.hasAttribute(`data-ff-editor`))&&this._lauf.aktualisiereVorschlaege(this.erfassungsUmfeld())}updated(){this._taktGemessen!==this.zeilenHoehe&&this.messeRumpf(),this._fokusHolen&&(this._fokusHolen=!1,Qa(this.shadowRoot,this._fokusZeile))}disconnectedCallback(){super.disconnectedCallback(),Oa(this),this._beobachter?.disconnect(),this._beobachter=null,_o(this),va(this)}static{this.styles=[T.styles,tr,Ki,qa,Er,ca]}render(){let t=this.spaltenListe(),n=e=>e.stopPropagation(),r=Ha({spalten:t,hatQuelle:this.hatQuelle,datenGeliefert:this.datenGeliefert,datenzeilen:this.datenzeilen,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,wunschSeite:this._seite,gemessen:this._mass,erfassungAn:this.erfassungAn});return g`<div class="tabelle" style=${W({"--takt":`${r.takt}px`,"--zeilen-hoehe":`${r.zeilenHoehe}px`})}>
      ${Ca(()=>this.spaltenListe(),e=>this.aendere(e),n)}
      ${Ka({spalten:t,cols:r.cols,editable:this.editable,imEditor:this.hasAttribute(`data-ff-editor`),auswahlSemantik:N(this)!==``,zeigeSuche:this.suche===`ja`,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,zeilen:r.zeilen,linealTakte:r.linealTakte,datenzeilen:this.datenzeilen,zusatzzeilen:this.zusatzzeilen,hatQuelle:r.hatQuelle,auswahlIndex:this.auswahlIndex,leer:r.leer,leerText:this.leerText,erfassung:this.erfassungAn?oa(this.erfassungsWirt(),r.cols,(r.linealTakte??1)<=0):v},{setzeSuchtext:e=>this.setzeSuchtext(e),dblklickKopf:(e,t)=>{this.editable&&(Oa(this),Ta(e,t,()=>this.spaltenListe(),e=>this.aendere(e)))},klickKopf:(t,n)=>{this.editable&&ka(this,t,{prop:e.listenBindung.prop,index:n,liste:()=>this.spaltenListe()}),this.klickSortiere(n)},aktiviereZeile:(e,t)=>this.aktiviereZeile(e,t)})}
      ${``}
      ${r.leer?v:Wa({hatQuelle:r.hatQuelle,sichtbar:r.gesamt,gesamt:this.datenzeilen.length,suchtAktiv:this._suchtext.trim()!==``,auswahlAktiv:this.durchAuswahlGefiltert,seite:r.seite,seiten:r.seiten},{blaettere:e=>{this.merkeZeilenFokus(),this._seite=e,this.requestUpdate()}})}
    </div>`}};w([S({converter:{fromAttribute:e=>e?Li(e):Mi(),toAttribute:e=>JSON.stringify(e)}})],K.prototype,`spalten`,void 0),w([S()],K.prototype,`source`,void 0),w([S()],K.prototype,`suche`,void 0),w([S()],K.prototype,`erfassung`,void 0),w([S()],K.prototype,`leerText`,void 0),w([S({attribute:!1})],K.prototype,`datenzeilen`,void 0),w([S({attribute:!1})],K.prototype,`zusatzzeilen`,void 0),w([S({attribute:!1})],K.prototype,`rohzeilen`,void 0),w([S({attribute:!1})],K.prototype,`auswahlIndex`,void 0),w([S({attribute:!1})],K.prototype,`durchAuswahlGefiltert`,void 0),w([S({attribute:!1})],K.prototype,`datenGeliefert`,void 0),T.defineAndRegister(K);function $a(e){return g`<div class="nachschlag">
    <input
      class="ctrl"
      type="text"
      .value=${e.wert}
    ...
    >${mi()}</button>
    ${e.liste}
  </div>`}var eo={prop:`nachschlagSpalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:Ai,quelleProp:`nachschlagQuelle`};function to(e){if(typeof e==`string`)try{e=JSON.parse(e)}catch{return[]}return Array.isArray(e)&&e.length>0?Ii(e):[]}function no(e,t){let n=e[0];return n===void 0?t:n.feld}function ro(e,t){let n=e.trim();return n===``||n===t.trim()}function io(e,t,n){let r=t.trim(),i=[],a=ro(t,n),o=new Set;for(let t of e){let e=k(t,n).trim(),s=r===``?e:k(t,r).trim();if(!(s===``&&e===``)){if(a){if(o.has(e))continue;o.add(e)}i.push({anzeige:s,wert:e,satz:t})}}return i}function ao(e,t,n,r){return io(qt(e,t).rows,n,r)}function oo(e){let t=O(R().FF_DATA_SOURCES,e);return t?j(R().SEDATA,t.name,t.tableId):null}function so(e){if(e.quelleId===``||e.speicherFeld===``)return{ok:!1,grund:`unvollstaendig`};let t=oo(e.quelleId);if(t===null)return{ok:!1,grund:`quelleFehlt`};let n=no(to([...e.spalten]),e.speicherFeld);return{ok:!0,eintraege:ao(e.el,t,n,e.speicherFeld)}}function co(e,t){return t&&e.length===1?e[0]:null}function lo(e,t){let{rows:n,gefiltert:r}=qt(e,[t]);return!r||n.length>0}function uo(e,t,n){return e===``?t===``&&n===``?`nichts`:`leeren`:e===t?`nichts`:`zurueck`}var fo=null,po=null,mo=null;function ho(e){return e.shadowRoot?.querySelector(`.lupe`)??null}function go(e=!0){let t=e?mo:null;mo=null,fo?.remove(),fo=null,po=null,t?.focus()}function _o(e){po===e&&go(!1)}function vo(e){return[{titel:e.speicherTitel===``?`Wert`:e.speicherTitel,feld:e.speicherFeld,art:V}]}function yo(e){let t=e=>e.stopPropagation(),n=e.editor;return g`<ff-dialog-rahmen
    viewport
    escape-schliesst
    ohne-modal
    inhalt-fest
  ...
  >${e.inhalt}</ff-dialog-rahmen>`}function bo(e,t){let n=to([...e.spalten]),r=ro(no(n,e.speicherFeld),e.speicherFeld);return g`<ff-tabelle
    fuellt
    suche="ja"
    style="--se-r-lg:0px"
    .besitz=${`provided`}
  ...
  ></ff-tabelle>`}function xo(e){let t=e.eintraege;if(t===void 0){let n=so(e);if(!n.ok){L(n.grund===`unvollstaendig`?`Nachschlagen braucht an diesem Feld eine Quelle und „Gespeichert wird".`:`Die Nachschlage-Quelle dieses Feldes ist in der Maske nicht vorhanden.`);return}t=n.eintraege}go(!1);let n=document.createElement(`div`);n.style.display=`contents`,Ue(yo({titel:e.titel,breite:e.breite,hoehe:e.hoehe,inhalt:bo(e,t),onSchliessen:()=>go()}),n);let r=n.querySelector(Yt),i=n.querySelector(K.tagName);i?.addEventListener(Ja,n=>{let r=n.detail,i=t[r.rohIndex];i&&(go(),e.onUebernehmen(i.anzeige,i.wert,i.satz))}),mo=e.rueckFokus??ho(e.el),document.body.appendChild(n),fo=n,po=e.el,r&&i&&Promise.all([r.updateComplete,i.updateComplete]).then(()=>{r.isConnected&&i.fokussiereSuche()})}function So(e){return yo({titel:e.titel,breite:e.breite,hoehe:e.hoehe,onSchliessen:e.onSchliessen,editor:{onGroesse:e.onGroesse},inhalt:g`<ff-tabelle
      data-ff-editor
      fuellt
      suche="ja"
      style="--se-r-lg:0px"
    ...
    >${this.placeholder}</span>`}onTextClick(){this.hasAttribute(`data-ff-editor`)||this.setzeHaken(!this.angehakt)}setzeHaken(e){this.angehakt!==e&&(this.angehakt=e,this.dispatchEvent(new Event(`change`)))}controlTpl(e){switch(e){case`textarea`:return g`<textarea class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}></textarea>`;case`select`:{let e=this.options.split(`,`).map(e=>e.trim()).filter(e=>e!==``),t=this.value!==``&&!e.includes(this.value);return g`<select class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}>
        ...
        </select>`}case`nachschlagen`:return $a({wert:this.getippt??this.anzeige,onTippen:e=>{this.getippt=e,this.marke=0,this.listeZu=!1},onTaste:e=>this.onNachschlagTaste(e),onVerlassen:()=>this.onNachschlagVerlassen(),onLupe:()=>this.onLupe(),liste:this.vorschlaege.length===0?v:Tr({eintraege:this.vorschlaege,marke:this.marke,onWaehlen:e=>this.uebernimmVorschlag(e),onMarke:e=>{this.marke=e}})});default:return g`<input
          class="ctrl"
          type=${e}
      ...
      >
        ${this.controlTpl(e)}
        ${fi.includes(e)?this.textTpl(`ph ${pi[e]??``}`.trim(),!n):v}
      </div>
      ${this.spaltenDialog&&this.hasAttribute(`data-ff-editor`)?this.spaltenDialogTpl():v}
    </div>`}connectedCallback(){super.connectedCallback(),si(this)}disconnectedCallback(){super.disconnectedCallback(),ci(this),_o(this)}};w([S()],q.prototype,`fieldType`,void 0),w([S()],q.prototype,`placeholder`,void 0),w([S()],q.prototype,`options`,void 0),w([S()],q.prototype,`source`,void 0),w([S()],q.prototype,`value`,void 0),w([S()],q.prototype,`valueField`,void 0),w([S()],q.prototype,`nachschlagQuelle`,void 0),w([S()],q.prototype,`speicherFeld`,void 0),w([S()],q.prototype,`speicherTitel`,void 0),w([S({converter:{fromAttribute:e=>to(e??``),toAttribute:e=>JSON.stringify(e)}})],q.prototype,`nachschlagSpalten`,void 0),w([S({type:Number})],q.prototype,`fensterBreite`,void 0),w([S({type:Number})],q.prototype,`fensterHoehe`,void 0),w([S()],q.prototype,`einzigerTreffer`,void 0),w([C()],q.prototype,`spaltenDialog`,void 0),w([C()],q.prototype,`anzeige`,void 0),w([C()],q.prototype,`getippt`,void 0),w([C()],q.prototype,`marke`,void 0),w([C()],q.prototype,`listeZu`,void 0),w([C()],q.prototype,`angehakt`,void 0),w([C()],q.prototype,`imSteuerelement`,void 0),T.defineAndRegister(q);var Co=`ziel`,wo=o`
...
`,Eo=`frei · hierher ziehen`,Do=`ff-zimmer-inhalt`,J=class extends T{constructor(...e){super(...e),this.heading=`Neues Zimmer`,this.leerHinweis=``}static{this.blockType=`kanban-zimmer`}static{this.tagName=`ff-kanban-zimmer`}static{this.displayName=`Kanban-Zimmer`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[B.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban-spalte`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={heading:`Neues Zimmer`}}static{this.styles=[T.styles,Ki,To,wo,o`
    ...
    `]}onSlotChange(){this.dispatchEvent(new CustomEvent(Do,{bubbles:!0,composed:!0}))}render(){return g`<div class="zimmer ${Co}">
      <div
        class="kopf"
        data-ff-editable
    ...
    `]}constructor(){super(),this.variant=`info`,this.heading=`Neue Spalte`,this.leerHinweis=``,this._count=0,this.addEventListener(Do,()=>this.zaehle())}zaehle(){this._count=Array.from(this.querySelectorAll(B.tagName)).filter(e=>!e.hasAttribute(`data-ff-editor-helper`)).length}render(){return g`<div class="col ${Co} v-${Qn(this.variant)}">
      <div class="head">
        <span class="dot"></span>
        <span
          class="title"
    ...
    </div>`}};w([S()],Y.prototype,`variant`,void 0),w([S()],Y.prototype,`heading`,void 0),w([S({attribute:!1})],Y.prototype,`leerHinweis`,void 0),w([C()],Y.prototype,`_count`,void 0),T.defineAndRegister(Y);function Oo(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function ko(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var Ao=new WeakMap,jo=Y.tagName,Mo=J.tagName,No=B.tagName;function Po(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===jo)}function Fo(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===No)}function Io(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Mo)}function Lo(e){return[e,...Io(e)]}function Ro(e,t){let n=e.getAttribute(`leertext`)??`Keine Datensätze.`,r=(e,t)=>{e.leerHinweis=t};for(let e of t){let t=Io(e);for(let e of t)r(e,Fo(e).length===0?Eo:``);r(e,t.length===0&&Fo(e).length===0?n:``)}}function zo(e){return Xe().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function Bo(e,t){let n=Io(e);if(n.length===0)return null;let r=e.getAttribute(`zimmerfield`)??``;if(r===``)return n[0];let i=n.map(e=>e.getAttribute(`heading`)??J.defaultProps.heading),a=Oo(k(t,r),i);return a>=0?n[a]:n[0]}function Vo(e){Z?.board===e&&qo();let t=e.getAttribute(`statusfield`)??``,n=da(e);if(!n)return;let r=Po(e);if(r.length===0)return;let i=Ao.get(e);if(!i){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(No);t&&(i=t.cloneNode(!0),Ao.set(e,i))}if(!i)return;let a=n.zeilen,o=r.map(e=>e.getAttribute(`heading`)??Y.defaultProps.heading),s=zo(i.tagName),c=ko(r.map(e=>e.getAttribute(`auffang`))),l=n.lies;for(let e of r)for(let t of Lo(e))Fo(t).forEach(e=>e.remove());for(let e of a){let a=i.cloneNode(!0),u=t===``?-1:Oo(k(e,t),o),d=u>=0?r[u]:c>=0?r[c]:r[0];(Bo(d,e)??d).appendChild(a);for(let t of s){let n=a.getAttribute(Ar(t.prop))??``;n!==``&&(a[t.prop]=l(e,n))}let ee=Ct(n.quelle,e);X.set(a,{row:e,pindex:ee}),a.draggable=!0}Ro(e,r);let u=r.flatMap(e=>Lo(e).flatMap(Fo)),d=Bt(N(e),u,e=>X.get(e)?.row);for(let e of d)u[e].setAttribute(`data-ff-auswahl`,``)}var X=new WeakMap,Z=null,Ho=new WeakSet,Uo=`data-ff-zieht`,Wo=`data-ff-ziel`,Go=null;function Ko(e){Go!==e&&(Go?.removeAttribute(Wo),Go=e,Go?.setAttribute(Wo,``))}function qo(){Z?.card.removeAttribute(Uo),Z=null,Ko(null)}function Jo(e,t,n){for(let r of t.composedPath())if(r instanceof HTMLElement&&r.tagName.toLowerCase()===n&&e.contains(r))return r;return null}function Yo(e,t){return Jo(e,t,jo)}function Xo(e,t,n){if(!Z||Z.board!==e)return;let r=X.get(Z.card);if(!r)return;let i=t.getAttribute(`heading`)??``,a=n?.getAttribute(`heading`)??``;qn(e,`onCardDrop`,{PINDEX:r.pindex,VALUE:i,ZIMMER:a}).catch(z)}function Zo(e){Ho.has(e)||(Ho.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;if(!n)return;let r=X.get(n);r&&Vt(N(e),r.row),qn(e,`onCardClick`,{PINDEX:r?.pindex??``}).catch(z)}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;n&&(Z={card:n,board:e},t.dataTransfer?.setData(`text/plain`,X.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`),setTimeout(()=>{Z?.card===n&&n.setAttribute(Uo,``)},0))}),e.addEventListener(`dragend`,qo),e.addEventListener(`dragover`,t=>{let n=Yo(e,t);if(Z?.board!==e||!n){Ko(null);return}t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`),Ko(Jo(e,t,Mo)??n)}),e.addEventListener(`dragleave`,t=>{let n=t.relatedTarget;(!(n instanceof Node)||!e.contains(n))&&Ko(null)}),e.addEventListener(`drop`,t=>{let n=Yo(e,t);n&&(t.preventDefault(),Xo(e,n,Jo(e,t,Mo)),qo())}))}var Qo=Gr({hydriere:Vo,verdrahte:Zo}),$o=Qo.connect,es=Qo.disconnect,ts=Y.blockType,ns=class extends T{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[ts]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:ts}}static{this.templateChild={type:B.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``,tagField:``,leerText:Ui}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Optional: Feld der Datenquelle, dessen Inhalt bestimmt, in welche Spalte ein Eintrag kommt. Leer = alle Einträge in der Auffang-Spalte.`,kind:`field`},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt das Board nur Einträge des Tages, den der Tageswähler zeigt. Leer = alle Einträge.`,kind:`field`},Wi()]}static{this.defaultChildren=[{type:ts,props:{heading:`Offen`,variant:`warning`},children:[{type:B.blockType}]},{type:ts,props:{heading:`In Arbeit`,variant:`info`}},{type:ts,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[T.styles,o`
    ...
    `]}render(){return g`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),$o(this)}disconnectedCallback(){super.disconnectedCallback(),es(this)}};T.defineAndRegister(ns);var rs={breite:56,breiteOffen:224},is=`ff-seiten-wechsel`,as=[{wert:`sonne`,name:`Sonnengelb`},{wert:`salbei`,name:`Salbeigrün`},{wert:`himmel`,name:`Himmelblau`},{wert:`flieder`,name:`Flieder`},{wert:`koralle`,name:`Koralle`}],Q=class extends T{static{this.blockType=`navi-eintrag`}static{this.tagName=`ff-navi-eintrag`}static{this.displayName=`Navi-Eintrag`}static{this.category=`layout`}static{this.acceptsChildren=!1}static{this.showInPalette=!1}static{this.allowedParentTypes=[`navi`]}static{this.resizableWidth=!1}static{this.defaultProps={seite:``,seitename:``,ton:`sonne`}}static{this.customProperties=[{attributeName:`seite`,name:`Seite`,description:`Welche Seite dieser Maske der Eintrag zeigt.`,kind:`seite`,klarnameProp:`seitename`,nurImEditor:!0},{attributeName:`ton`,name:`Farbe`,description:`Farbe des Zeichens vor dem Namen.`,kind:`select`,options:as.map(e=>({value:e.wert,label:e.name}))}]}static{this.styles=[T.styles,o`
      :host {
        --ton: var(--se-amber);
        display: flex;
        align-items: center;
    ...
    `]}constructor(){super(),this.seite=``,this.seitename=``,this.ton=`sonne`,this.addEventListener(`click`,()=>this.melde())}melde(){let e={ansicht:this.seitename};this.dispatchEvent(new CustomEvent(is,{detail:e,bubbles:!0,composed:!0}))}render(){return g`<span class="zeichen"></span>
      <span class="name">${this.seitename===``?`—`:this.seitename}</span>`}};w([S()],Q.prototype,`seite`,void 0),w([S()],Q.prototype,`seitename`,void 0),w([S({reflect:!0})],Q.prototype,`ton`,void 0),T.defineAndRegister(Q);var os=`aktiv`;function ss(e){return Array.from(e.querySelectorAll(Q.tagName))}function cs(e,t){let n=ss(e),r=t??n.find(e=>e.hasAttribute(os))??n[0];for(let e of n)e===r?e.setAttribute(os,``):e.removeAttribute(os)}function ls(e){let t=e.hasAttribute(`offen`);for(let n of ss(e))n.toggleAttribute(`breit`,t)}function us(e){return e.getAttribute(`name`)??String(lt.defaultProps.name)}function ds(e,t){let n=e;for(;n&&n.parentElement!==t;)n=n.parentElement;return n}function fs(e,t){let n=e.ownerDocument,r=Array.from(n.querySelectorAll(lt.tagName)),i=r[0]?.parentElement??null;if(!i)return;let a=ds(e,i);if(!a)return;let o=r.find(e=>us(e)===t)??null;for(let e of Array.from(i.children))e!==a&&((r.includes(e)?e===o:o===null)?e.removeAttribute(`hidden`):e.setAttribute(`hidden`,``))}var ps=new WeakMap,ms=new WeakSet;function hs(e){let t=t=>{let n=t.detail;n&&(cs(e,t.target instanceof Element?t.target:void 0),e.removeAttribute(`offen`),ls(e),!e.hasAttribute(`data-ff-editor`)&&fs(e,n.ansicht))};e.addEventListener(is,t),ps.set(e,t)}function gs(e){let t=ps.get(e);t&&(e.removeEventListener(is,t),ps.delete(e))}function _s(e){if(cs(e),ls(e),e.hasAttribute(`data-ff-editor`)||ms.has(e))return;let t=ss(e)[0];if(!t)return;ms.add(e);let n=()=>fs(e,t.seitename);e.ownerDocument.readyState===`loading`?e.ownerDocument.addEventListener(`DOMContentLoaded`,n,{once:!0}):queueMicrotask(n)}var vs=Q.blockType,ys=class extends T{static{this.blockType=`navi`}static{this.tagName=`ff-navi`}static{this.displayName=`Navi`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[vs]}static{this.addChildButton={label:`Eintrag`,childType:vs}}static{this.containerHint=!1}static{this.defaultProps={}}static{this.customProperties=[]}static{this.maskenRand=!0}static{this.allowedParentTypes=[ct]}static{this.raster={startW:5,startH:24,minW:3,minH:3}}static{this.styles=[T.styles,o`
      :host {
        height: 100%;
        width: ${rs.breite}px;
    ...
    `]}connectedCallback(){super.connectedCallback(),hs(this)}disconnectedCallback(){super.disconnectedCallback(),gs(this)}klappen(){this.toggleAttribute(`offen`),ls(this)}render(){return g`<div class="leiste">
        <div class="kopf">
          <button
            class="schalter"
            type="button"
        ...
        <div class="eintraege">
          <slot @slotchange=${()=>_s(this)}></slot>
        </div>
      </div>`}};T.defineAndRegister(ys);var bs=Ar(`text`);function xs(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(bs)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function Ss(e){let t=Zr(e,bs);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function Cs(e){xs(e)&&(e.text=``)}var ws=Gr({hydriere:Ss,verdrahte:Cs}),Ts=ws.connect,Es=ws.disconnect,Ds=6,Os=96,ks=14,As={duenn:`300`,normal:`400`,fett:`700`},js={links:`left`,mitte:`center`,rechts:`right`},Ms={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},Ns=`standard`;function Ps(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(Os,Math.max(Ds,t)):ks}function Fs(e){return typeof e==`string`&&e in As?e:`normal`}function Is(e){return typeof e==`string`&&e in js?e:`links`}function Ls(e){return typeof e==`string`&&e in Ms?e:Ns}var $=class extends T{constructor(...e){super(...e),this.groesse=ks,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=Ns,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:ks,gewicht:`normal`,ausrichtung:`links`,farbe:Ns,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:Ds,max:Os,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[T.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return g`<div
      class="text"
      style=${W({fontSize:`${Ps(this.groesse)}px`,fontWeight:As[Fs(this.gewicht)],textAlign:js[Is(this.ausrichtung)],color:Ms[Ls(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),Ts(this)}disconnectedCallback(){super.disconnectedCallback(),Es(this)}};w([S({type:Number})],$.prototype,`groesse`,void 0),w([S()],$.prototype,`gewicht`,void 0),w([S()],$.prototype,`ausrichtung`,void 0),w([S()],$.prototype,`farbe`,void 0),w([S()],$.prototype,`text`,void 0),w([S()],$.prototype,`source`,void 0),w([S()],$.prototype,`textField`,void 0),T.defineAndRegister($);var Rs=[`waagerecht`,`senkrecht`],zs=`waagerecht`;function Bs(e){return Rs.includes(e)?e:zs}var Vs=class extends T{constructor(...e){super(...e),this.richtung=zs}static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`,richtung:zs}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1,varianten:[{wenn:{attributeName:`richtung`,equals:`senkrecht`},startW:1,startH:6,breiteZiehbar:!1}]}}static{this.customProperties=[{attributeName:`richtung`,name:`Richtung`,description:`Waagerecht trennt oben von unten, senkrecht links von rechts.`,kind:`select`,options:[{value:`waagerecht`,label:`Waagerecht`},{value:`senkrecht`,label:`Senkrecht`}]}]}static{this.styles=[T.styles,o`
    ...
    `]}render(){return g`<div class="flaeche ${Bs(this.richtung)}"><div class="linie"></div></div>`}};w([S()],Vs.prototype,`richtung`,void 0),T.defineAndRegister(Vs),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;L(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();
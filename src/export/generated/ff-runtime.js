...
`,z=class extends I{constructor(...e){super(...e),this.variant=`info`,this.text=`Hinweis`}static{this.blockType=`badge`}static{this.tagName=`ff-badge`}static{this.displayName=`Status-Chip`}static{this.category=`anzeige`}static{this.resizableWidth=!1}static{this.defaultProps={variant:`info`,text:`Hinweis`}}static{this.customProperties=[R(`variant`,`Bedeutung des Chips — bestimmt die Farbe.`)]}static{this.styles=[I.styles,Be]}render(){return w`<span
    ...
    >${this.label}</button>`}};F([N()],Ve.prototype,`label`,void 0),I.defineAndRegister(Ve);var B=class extends I{constructor(...e){super(...e),this.chipVariant=`info`,this.heading=`Rückruf Fr. Wagner`,this.text=`Befund Minka besprechen`,this.chipText=`Heute`,this.headingField=``,this.textField=``,this.chipTextField=``}static{this.blockType=`card`}static{this.tagName=`ff-card`}static{this.displayName=`Karte`}static{this.category=`anzeige`}static{this.allowedParentTypes=[`kanban-spalte`]}static{this.defaultProps={chipVariant:`info`,heading:`Rückruf Fr. Wagner`,text:`Befund Minka besprechen`,chipText:`Heute`,headingField:``,textField:``,chipTextField:``}}static{this.bindableSpots=[{prop:`heading`,label:`Titel`},{prop:`text`,label:`Textzeile`},{prop:`chipText`,label:`Chip`}]}static{this.customProperties=[R(`chipVariant`,`Bedeutung des Chips auf der Karte — bestimmt die Chip-Farbe.`)]}static{this.styles=[I.styles,Be,o`
      .card {
        box-sizing: border-box;
    ...
    `]}render(){let e=L(this.chipVariant);return w`<div class="card">
      ...
      >${this.chipText}</span>
    </div>`}};F([N()],B.prototype,`chipVariant`,void 0),F([N()],B.prototype,`heading`,void 0),F([N()],B.prototype,`text`,void 0),F([N()],B.prototype,`chipText`,void 0),F([N()],B.prototype,`headingField`,void 0),F([N()],B.prototype,`textField`,void 0),F([N()],B.prototype,`chipTextField`,void 0),I.defineAndRegister(B);var V=class extends I{constructor(...e){super(...e),this.direction=`column`,this.gap=`md`,this.padding=`none`}static{this.blockType=`container`}static{this.tagName=`ff-container`}static{this.displayName=`Bereich`}static{this.category=`layout`}static{this.acceptsChildren=!0}static{this.defaultProps={direction:`column`,gap:`md`,padding:`none`,width:`fill`}}static{this.customProperties=[]}static{this.styles=[I.styles,o`
      .wrap {
        display: flex;
    ...
    `]}get optionList(){return this.options.split(`,`).map(e=>e.trim()).filter(e=>e!==``)}render(){let e=Ue(this.fieldType),t=this.required===`ja`,n=this.readonly===`ja`;switch(e){case`textarea`:return w`<textarea
          class="control"
        ...
        />`;default:return w`<input
          ...
          ?required=${t}
          ?readonly=${n}
        />`}}};F([N()],H.prototype,`fieldType`,void 0),F([N()],H.prototype,`placeholder`,void 0),F([N()],H.prototype,`required`,void 0),F([N()],H.prototype,`readonly`,void 0),F([N()],H.prototype,`options`,void 0),I.defineAndRegister(H);var U=class extends I{constructor(...e){super(...e),this.variant=`info`,this.heading=`Hinweis`,this.message=`Das ist ein Hinweistext.`}static{this.blockType=`infobox`}static{this.tagName=`ff-infobox`}static{this.displayName=`Infobox`}static{this.category=`anzeige`}static{this.defaultProps={variant:`info`,heading:`Hinweis`,message:`Das ist ein Hinweistext.`}}static{this.customProperties=[R(`variant`,`Bedeutung der Box — bestimmt die Farbe.`)]}static{this.styles=[I.styles,o`
      .box {
        box-sizing: border-box;
        border: 1px solid var(--se-line);
    ...
    `]}render(){return w`<div class="box v-${L(this.variant)}">
      ...
      >${this.message}</p>
    </div>`}};F([N()],U.prototype,`variant`,void 0),F([N()],U.prototype,`heading`,void 0),F([N()],U.prototype,`message`,void 0),I.defineAndRegister(U);var W=class extends I{constructor(...e){super(...e),this.variant=`info`,this.heading=`Neue Spalte`,this._count=0}static{this.blockType=`kanban-spalte`}static{this.tagName=`ff-kanban-spalte`}static{this.displayName=`Kanban-Spalte`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[B.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Karte`,childType:B.blockType}}static{this.allowedParentTypes=[`kanban`]}static{this.fillMinWidth=260}static{this.resizableWidth=!1}static{this.defaultProps={variant:`info`,heading:`Neue Spalte`,statusValue:``}}static{this.customProperties=[R(`variant`,`Bedeutung der Spalte — bestimmt die Farbe der Oberlinie.`),{attributeName:`statusValue`,name:`Datenwert dieser Spalte`,description:`Zeilen, deren Spalten-Feld genau diesen Wert hat, landen hier. Kein Treffer irgendwo → erste Spalte. Der sichtbare Titel bleibt unabhängig davon.`,isArray:!1,maxLength:60,kind:`text`,requiresDataSource:!0}]}static{this.styles=[I.styles,o`
      .col {
        box-sizing: border-box;
    ...
    `]}onSlotChange(e){let t=e.target;this._count=t.assignedElements().filter(e=>!e.hasAttribute(`data-ff-editor-helper`)).length}render(){return w`<div class="col v-${L(this.variant)}">
      ...
      <div class="body">
        ${this._count===0?w`<div class="drop">Karte hierher ziehen</div>`:null}
        <slot @slotchange=${this.onSlotChange}></slot>
      </div>
    </div>`}};F([N()],W.prototype,`variant`,void 0),F([N()],W.prototype,`heading`,void 0),F([Fe()],W.prototype,`_count`,void 0),I.defineAndRegister(W);var Ge=[`GET_RELATION`,`PUT_RELATION`,`PUTADD_RELATION`];function Ke(e){return e.replace(/^IDB/,``)}function qe(e){let t=/^(\d+)_(\d+)$/.exec(e);return t?{pos:t[1],len:t[2]}:null}function Je(e,t){return e.params.map(e=>e.replace(/\{([A-Z_]+)\}/g,(e,n)=>String(t[n]??``)))}function G(e){return typeof e==`object`&&!!e}function Ye(e,t){if(!(!Array.isArray(e)||t===``)){for(let n of e)if(!(!G(n)||n.id!==t)&&!(typeof n.name!=`string`||typeof n.tableId!=`string`))return{id:t,name:n.name,tableId:n.tableId,indexField:typeof n.indexField==`string`?n.indexField:``}}}function Xe(e,t){if(!(!Array.isArray(e)||t===``)){for(let n of e)if(!(!G(n)||n.id!==t)&&!(typeof n.verb!=`string`||!Ge.includes(n.verb))&&!(typeof n.nr!=`string`||n.nr===``)&&!(!Array.isArray(n.params)||n.params.some(e=>typeof e!=`string`)))return{id:t,verb:n.verb,nr:n.nr,params:n.params}}}function Ze(e){return`${String(e.getDate()).padStart(2,`0`)}.${String(e.getMonth()+1).padStart(2,`0`)}.${e.getFullYear()}`}function Qe(e){return e==null?``:String(e).trim()}function K(e,t){if(!G(e)||t===``)return``;let n=Qe(e[t]);if(n!==``)return n;let r=/^(\d+)_(\d+)$/.exec(t);if(!r)return``;let i=Qe(e.SATZNEU??e.SATZ??e.satzneu??e.satz??e.RAW??e.raw);if(i===``)return``;let a=Number(r[1]),o=Number(r[2]);return o<=0?``:i.substring(a,a+o).trim()}function $e(e,t,n){if(!G(e)||t===``)return!1;let r=!1;Object.prototype.hasOwnProperty.call(e,t)&&(e[t]=n,r=!0);let i=/^(\d+)_(\d+)$/.exec(t);if(i){let t=[`SATZNEU`,`SATZ`,`satzneu`,`satz`,`RAW`,`raw`].find(t=>typeof e[t]==`string`);if(t){let a=e[t],o=Number(i[1]),s=Number(i[2]);if(s>0){let i=n.length>s?n.slice(0,s):n.padEnd(s,` `),c=a.length<o?a.padEnd(o,` `):a;e[t]=c.slice(0,o)+i+c.slice(o+s),r=!0}}}return r}function q(e){if(!G(e))return Array.isArray(e)?e:[];let t=[e.Zeilen,e.zeilen,e.Saetze,e.saetze,e.Rows,e.rows,e.Daten,e.daten];for(let e of t){if(Array.isArray(e))return e;if(typeof e==`string`)try{let t=JSON.parse(e);if(Array.isArray(t))return t}catch{}}return[]}function J(e,t){return Qe(e).toLowerCase()===t.trim().toLowerCase()}function et(e,t,n){if(!G(e)||!G(e.Daten))return[];let r=e.Daten,i=r.SEFileLoop;if(Array.isArray(i)){for(let e of i)if(G(e)&&(J(e.ALIAS,t)||J(e.alias,t))){let t=q(e);if(t.length>0)return t}}else if(G(i))for(let e of Object.keys(i)){let n=i[e];if(J(e,t)||G(n)&&(J(n.ALIAS,t)||J(n.alias,t))){let e=q(n);if(e.length>0)return e}}let a=r.Tabellen;if(G(a)){let e=[t,t.toUpperCase(),t.toLowerCase(),n];for(let t of e)if(t!==``&&t in a){let e=q(a[t]);if(e.length>0)return e}for(let e of Object.keys(a))if(J(e,t)){let t=q(a[e]);if(t.length>0)return t}}return[]}function tt(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return 0}function Y(){return globalThis}function nt(){let e=Y();return G(e.SEDATA)&&G(e.SEDATA.Daten)}function rt(){let e=Y();try{e.selib?.Json?.InitializeERPConnection?.()}catch{}try{typeof e.InitialisiereSchnittstelle==`function`&&e.InitialisiereSchnittstelle()}catch{}}function it(){let e=Y();try{typeof e.ResetDataBasis==`function`&&e.ResetDataBasis()}catch{}try{typeof e.InitialisiereDatenBasis==`function`&&e.InitialisiereDatenBasis()}catch{}}var at=new Set,ot=new WeakMap,st=!1,ct=W.tagName,lt=B.tagName;function ut(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===ct)}function dt(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===lt)}function ft(e){return Le().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function pt(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(`statusfield`)??``;if(t===``||n===``)return;let r=Ye(Y().FF_DATA_SOURCES,t);if(!r)return;let i=ut(e);if(i.length===0)return;let a=ot.get(e);if(!a)for(let t of i){let n=dt(t)[0];if(n){a=n.cloneNode(!0),ot.set(e,a);break}}if(!a)return;let o=et(Y().SEDATA,r.name,r.tableId),s=i.map(e=>e.getAttribute(`statusvalue`)??``),c=ft(a.tagName);for(let e of i)dt(e).forEach(e=>e.remove());for(let e of o){let t=a.cloneNode(!0);i[tt(K(e,n),s)].appendChild(t);for(let n of c){let r=t.getAttribute(`${n.prop.toLowerCase()}field`)??``;r!==``&&(t[n.prop]=K(e,r))}let o=K(e,r.indexField);o!==``&&(X.set(t,{row:e,pindex:o}),t.draggable=!0)}}var X=new WeakMap,Z=null,mt=new WeakSet;function ht(e,t){for(let n of t.composedPath())if(n instanceof HTMLElement&&n.tagName.toLowerCase()===ct&&e.contains(n))return n;return null}function gt(e){let t=Y(),n=Xe(t.FF_RELATIONS,e.getAttribute(`putrelation`)??``),r=Ye(t.FF_DATA_SOURCES,e.getAttribute(`source`)??``);if(!(!n||!r))return{template:n,relId:Ke(r.tableId)}}function _t(e,t,n,r){let i=Y();if(typeof i.basisHTML_SND_MSG!=`function`)return;let a=qe(t);a&&i.basisHTML_SND_MSG(e.template.verb,{NR:e.template.nr,PARAMS:Je(e.template,{FELD_POS:a.pos,FELD_LEN:a.len,PINDEX:n,DROP_PINDEX:n,RELID:e.relId,VALUE:r,NOW_DATE:Ze(new Date)})})}function vt(e,t){if(!Z||Z.board!==e)return;let n=X.get(Z.card);if(!n)return;let r=e.getAttribute(`statusfield`)??``,i=t.getAttribute(`statusvalue`)??``;if(r===``||i.trim()===``||K(n.row,r).trim().toLowerCase()===i.trim().toLowerCase())return;let a=gt(e);a&&(_t(a,r,n.pindex,i),$e(n.row,r,i),pt(e))}function yt(e){mt.has(e)||(mt.add(e),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;n&&(Z={card:n,board:e},t.dataTransfer?.setData(`text/plain`,X.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`))}),e.addEventListener(`dragend`,()=>{Z=null}),e.addEventListener(`dragover`,t=>{Z?.board===e&&ht(e,t)&&(t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`))}),e.addEventListener(`drop`,t=>{let n=ht(e,t);n&&(t.preventDefault(),vt(e,n),Z=null)}))}function bt(){nt()&&at.forEach(pt)}function xt(){if(st)return;st=!0,rt();let e=Y();e.Erstellen=()=>{it(),bt()},e.initData=e.Erstellen,e.ReloadData=()=>bt();let t=0,n=setInterval(()=>{t+=1,nt()?(clearInterval(n),it(),bt()):t>100&&clearInterval(n)},300)}function St(e){e.hasAttribute(`data-ff-editor`)||(at.add(e),yt(e),xt(),nt()&&pt(e))}function Ct(e){at.delete(e)}var Q=W.blockType,$=B.blockType,wt=class extends I{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[Q]}static{this.childDirection=`row`}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:Q}}static{this.acceptsDataSource=!0}static{this.defaultProps={width:`fill`,source:``,statusField:``,putRelation:`standard-put`}}static{this.customProperties=[{attributeName:`statusField`,name:`Spalten aus Feld`,description:`Feld der Datenquelle, dessen Wert bestimmt, in welcher Spalte eine Zeile landet.`,isArray:!1,maxLength:0,kind:`field`},{attributeName:`putRelation`,name:`Schreiben über`,description:`Relation-Vorlage, mit der eine gezogene Karte ihren neuen Spaltenwert zurückschreibt.`,isArray:!1,maxLength:0,kind:`relation`,requiresDataSource:!0}]}static{this.defaultChildren=[{type:Q,props:{heading:`Offen`,variant:`warning`},children:[{type:$,props:{heading:`Rückruf Fr. Wagner`,text:`Befund Minka besprechen`,chipVariant:`warning`,chipText:`Wartet seit 2 Tagen`}},{type:$,props:{heading:`Rechnung Nr. 5012 prüfen`,text:`Position Narkose fehlt`,chipVariant:`danger`,chipText:`Überfällig`}},{type:$,props:{heading:`Impfpass nachtragen`,text:`Buddy · Golden Retriever`,chipVariant:`info`,chipText:`Heute`}}]},{type:Q,props:{heading:`In Arbeit`,variant:`info`},children:[{type:$,props:{heading:`Röntgenbilder anfordern`,text:`Klinik Dr. Steiner, Fall Rocky`,chipVariant:`info`,chipText:`Angefragt`}}]},{type:Q,props:{heading:`Fertig`,variant:`success`},children:[{type:$,props:{heading:`Laborprobe versendet`,text:`Nala · Blutbild groß`,chipVariant:`success`,chipText:`Erledigt`}},{type:$,props:{heading:`Bestellung Verbandsmaterial`,text:`Lieferung bestätigt für Montag`,chipVariant:`success`,chipText:`Erledigt`}}]}]}static{this.styles=[I.styles,o`
      ...
      slot { display: contents; }
    `]}render(){return w`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),St(this)}disconnectedCallback(){super.disconnectedCallback(),Ct(this)}};I.defineAndRegister(wt);var Tt=class extends I{constructor(...e){super(...e),this.text=`Neuer Text`}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Textblock`}static{this.category=`anzeige`}static{this.defaultProps={text:`Neuer Text`}}static{this.customProperties=[]}static{this.styles=[I.styles,o`
      span {
        display: block;
        min-width: 1ch;
        color: var(--se-ink);
    ...
    `]}render(){return w`<span
      data-ff-editable
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</span>`}};F([N()],Tt.prototype,`text`,void 0),I.defineAndRegister(Tt)})();
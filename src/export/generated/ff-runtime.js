...
`,pr=`ff-dialog-rahmen`,mr=`ff-dialog-schliessen`;function hr(e,t){let n=Number(e);return Number.isFinite(n)&&n>0?n:t}var q=class extends k{constructor(...e){super(...e),this.titel=`Dialog`,this.breite=520,this.hoehe=380,this.viewport=!1,this.mitWerkzeug=!1,this.escapeSchliesst=!1,this.escapeRegistriert=!1,this.aufTaste=e=>{e.key===`Escape`&&(e.stopPropagation(),this.schliesse())}}static{this.styles=o`
  ...
  `}aktualisiereEscape(){let e=this.isConnected&&this.escapeSchliesst;e!==this.escapeRegistriert&&(e?document.addEventListener(`keydown`,this.aufTaste,!0):document.removeEventListener(`keydown`,this.aufTaste,!0),this.escapeRegistriert=e)}schliesse(){this.dispatchEvent(new CustomEvent(mr,{bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this.aktualisiereEscape()}updated(e){e.has(`escapeSchliesst`)&&this.aktualisiereEscape()}disconnectedCallback(){this.escapeRegistriert&&=(document.removeEventListener(`keydown`,this.aufTaste,!0),!1),super.disconnectedCallback()}render(){return w`
    ...
    </div>`}};j([A()],Y.prototype,`variant`,void 0),j([A()],Y.prototype,`heading`,void 0),j([Be()],Y.prototype,`_count`,void 0),M.defineAndRegister(Y);function Pr(e,t,n){return t===``||n===``?[...e]:e.filter(e=>Fn(F(e,t))===n)}function Fr(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function Ir(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var Lr=new WeakMap,Rr=Y.tagName,zr=K.tagName;function Br(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Rr)}function Vr(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===zr)}function Hr(e){return Ue().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function Ur(e){Z?.board===e&&(Z=null);let t=e.getAttribute(`source`)??``,n=e.getAttribute(`statusfield`)??``;if(t===``)return;let r=P(U().FF_DATA_SOURCES,t);if(!r)return;let i=Br(e);if(i.length===0)return;let a=Lr.get(e);if(!a){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(zr);t&&(a=t.cloneNode(!0),Lr.set(e,a))}if(!a)return;let o=Pr(L(U().SEDATA,r.name,r.tableId),e.getAttribute(`tagfield`)??``,Bn()),s=i.map(e=>e.getAttribute(`heading`)??Y.defaultProps.heading),c=Hr(a.tagName),l=Ir(i.map(e=>e.getAttribute(`auffang`))),u=$n(e);for(let e of i)Vr(e).forEach(e=>e.remove());for(let e of o){let t=a.cloneNode(!0),o=n===``?-1:Fr(F(e,n),s);(o>=0?i[o]:l>=0?i[l]:i[0]).appendChild(t);for(let n of c){let r=t.getAttribute(Kn(n.prop))??``;r!==``&&(t[n.prop]=u(e,r))}let d=r.indexField===``?``:F(e,r.indexField);X.set(t,{row:e,pindex:d}),t.draggable=!0}let d=i.flatMap(Vr),f=ht(z(e),d,e=>X.get(e)?.row);for(let e of f)d[e].setAttribute(`data-ff-auswahl`,``)}var X=new WeakMap,Z=null,Wr=new WeakSet;function Gr(e,t){for(let n of t.composedPath())if(n instanceof HTMLElement&&n.tagName.toLowerCase()===Rr&&e.contains(n))return n;return null}function Kr(e,t){if(!Z||Z.board!==e)return;let n=X.get(Z.card);if(!n)return;let r=t.getAttribute(`heading`)??``;bn(e,`onCardDrop`,{PINDEX:n.pindex,VALUE:r}).catch(yn)}function qr(e){Wr.has(e)||(Wr.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;if(!n)return;let r=X.get(n);r&&gt(z(e),r.row),bn(e,`onCardClick`,{PINDEX:r?.pindex??``}).catch(yn)}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;n&&(Z={card:n,board:e},t.dataTransfer?.setData(`text/plain`,X.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`))}),e.addEventListener(`dragend`,()=>{Z=null}),e.addEventListener(`dragover`,t=>{let n=Gr(e,t);Z?.board===e&&n&&(t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`))}),e.addEventListener(`drop`,t=>{let n=Gr(e,t);n&&(t.preventDefault(),Kr(e,n),Z=null)}))}var Jr=Jn({hydriere:Ur,verdrahte:qr}),Yr=Jr.connect,Xr=Jr.disconnect,Zr=Y.blockType,Qr=class extends M{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[Zr]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:Zr}}static{this.templateChild={type:K.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``,tagField:``}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Optional: Feld der Datenquelle, dessen Inhalt bestimmt, in welche Spalte ein Eintrag kommt. Leer = alle Einträge in der Auffang-Spalte.`,kind:`field`},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt das Board nur Einträge des Tages, den der Tageswähler zeigt. Leer = alle Einträge.`,kind:`field`}]}static{this.defaultChildren=[{type:Zr,props:{heading:`Offen`,variant:`warning`},children:[{type:K.blockType}]},{type:Zr,props:{heading:`In Arbeit`,variant:`info`}},{type:Zr,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[M.styles,o`
    ...
    `]}render(){return w`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),Yr(this)}disconnectedCallback(){super.disconnectedCallback(),Xr(this)}};M.defineAndRegister(Qr);var $r={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},ei=e=>(...t)=>({_$litDirective$:e,values:t}),ti=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},ni=`important`,ri=` !important`,ii=ei(class extends ti{constructor(e){if(super(e),e.type!==$r.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(ri);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?ni:``):n[e]=r}}return T}}),ai=[10,25,50],oi=`passend`,si=ai[0];function ci(e){let t=Number(e);return ai.some(e=>e===t)?t:null}function li(e,t,n){return Math.max(1,Math.floor((e-t)/n))}function ui({sichtbar:e,hatQuelle:t,proSeite:n,wunschSeite:r,platzhalterZeilen:i}){let a=t?Math.max(1,Math.ceil(e.length/n)):1,o=Math.min(Math.max(r,0),a-1);return t?{seiten:a,seite:o,zeilen:[...e.slice(o*n,(o+1)*n)]}:{seiten:a,seite:o,zeilen:Array.from({length:i},()=>null)}}function di(e,t){if(!e.hasAttribute(`fuellt`))return null;let n=e.renderRoot.querySelector(`.koerper`),r=e.renderRoot.querySelector(`.kopf`);return!(n instanceof HTMLElement)||!(r instanceof HTMLElement)?null:li(n.clientHeight,r.offsetHeight,t)}function fi(e,t){if(typeof ResizeObserver>`u`)return null;let n=e.renderRoot.querySelector(`.koerper`);if(!n)return null;let r=new ResizeObserver(t);return r.observe(n),r}function pi(e,t){let n=t.trim().toLowerCase();return e.find(e=>e.wert.trim().toLowerCase()===n)}var mi=`text`,hi=`status`,gi=`bild`,_i=`bild`,vi=`unter`,yi=[{wert:mi,name:`Text`,spur:`minmax(0, 1fr)`,klasse:``,zelle:e=>e},{wert:`zahl`,name:`Zahl`,spur:`90px`,klasse:`zahl`,zelle:e=>e},{wert:`datum`,name:`Datum`,spur:`100px`,klasse:`zahl`,zelle:e=>e},{wert:hi,name:`Status`,spur:`120px`,klasse:`status`,zelle:(e,t)=>{let n=pi(t,e);return n?w`<span class="chip v-${Tn(n.bedeutung)}">${n.name.trim()===``?e:n.name}</span>`:w`<span class="chip">${e}</span>`}},{wert:gi,name:`Bild + Name`,spur:`minmax(0, 1fr)`,klasse:`bild`,zusatzFelder:[{key:_i,label:`Bild`},{key:vi,label:`Unterzeile`}],hoehe:e=>(e[_i]??``)!==``||(e[vi]??``)!==``?44:32,zelle:(e,t,n)=>{let r=Nn(n[_i]??``),i=n[vi]??``;return w`<div class="bild-name">
        ${r===void 0?E:w`<span class="bild-zeichen">${r}</span>`}
        <div class="bild-text">
          <div class="bild-titel">${e}</div>
          ${i===``?E:w`<div class="bild-unter">${i}</div>`}
        </div>
      </div>`}}];function bi(e){return e.reduce((e,t)=>{let n=xi(t.art);return Math.max(e,n.hoehe?.(t.felder??{})??32)},32)}function xi(e){return yi.find(t=>t.wert===e)??yi[0]}var Si=yi.map(e=>({wert:e.wert,name:e.name,...e.zusatzFelder?{felder:e.zusatzFelder}:{}})),Ci=`felder`,wi=`Spalte {n}`;function Ti(e){return wi.replace(`{n}`,String(e+1))}function Ei(e){return{titel:Ti(e),feld:``,art:mi}}function Di(){return[0,1,2].map(e=>Ei(e))}function Oi(e){return Array.isArray(e)?e.filter(e=>!!e&&typeof e==`object`).map(e=>({wert:typeof e.wert==`string`?e.wert:``,name:typeof e.name==`string`?e.name:``,bedeutung:typeof e.bedeutung==`string`?e.bedeutung:``})).filter(e=>e.wert.trim()!==``):[]}function ki(e){if(!e||typeof e!=`object`||Array.isArray(e))return{};let t={};for(let[n,r]of Object.entries(e))typeof r==`string`&&r!==``&&(t[n]=r);return t}function Ai(e,t){if(e&&typeof e==`object`){let n=e,r=Oi(n.zuordnung),i=ki(n.felder);return{titel:typeof n.titel==`string`?n.titel:Ti(t),feld:typeof n.feld==`string`?n.feld:``,art:typeof n.art==`string`?n.art:mi,...r.length>0?{zuordnung:r}:{},...Object.keys(i).length>0?{felder:i}:{}}}return typeof e==`string`?{...Ei(t),titel:e}:Ei(t)}function ji(e){let t;if(Array.isArray(e))t=e.map((e,t)=>Ai(e,t));else if(typeof e==`number`&&Number.isFinite(e)||typeof e==`string`&&/^\d+$/.test(e)){let n=Math.max(1,Math.floor(Number(e)));t=[...Array(n).keys()].map(e=>Ei(e))}else t=Di();return t.length>8&&(t=t.slice(0,8)),t.length<1&&(t=[Ei(0)]),t}function Mi(e){try{return ji(JSON.parse(e))}catch{return Di()}}function Ni(e){return Mi(e.getAttribute(`spalten`)??``)}function Pi(e,t,n){let r={};for(let i of xi(e.art).zusatzFelder??[]){let a=e.felder?.[i.key]??``;a!==``&&(r[i.key]=n(t,a))}return r}function Fi(e){let t=()=>{e.datenzeilen=[],e.zusatzzeilen=[]},n=e.getAttribute(`source`)??``;if(n===``){t();return}let r=P(U().FF_DATA_SOURCES,n);if(!r){t();return}let i=Ni(e),{rows:a,gefiltert:o}=xt(e,Pr(L(U().SEDATA,r.name,r.tableId),e.getAttribute(`tagfield`)??``,Bn())),s=ht(z(e),a,e=>e)[0]??-1,c=$n(e);e.rohzeilen=a,e.auswahlIndex=s,e.durchAuswahlGefiltert=o,e.datenzeilen=a.map(e=>i.map(t=>t.feld===``?``:c(e,t.feld))),e.zusatzzeilen=a.map(e=>i.map(t=>Pi(t,e,c)))}var Ii=Jn({hydriere:Fi}),Li=Ii.connect,Ri=Ii.disconnect,zi=1,Bi=/^-?\d{1,3}(\.\d{3})*(,\d+)?$|^-?\d+(,\d+)?$|^-?\d+(\.\d+)?$/,Vi=/^(\d{1,2})\.(\d{1,2})\.(\d{2}|\d{4})$/,Hi=/^(\d{4})-(\d{2})-(\d{2})$/;function Ui(e){let t=e.trim();if(t===``||!Bi.test(t))return null;let n=t.includes(`,`)?t.replace(/\./g,``).replace(`,`,`.`):/^-?\d{1,3}(\.\d{3})+$/.test(t)?t.replace(/\./g,``):t,r=Number(n);return Number.isFinite(r)?r:null}function Wi(e){let t=e.trim();if(t===``)return null;let n=Hi.exec(t);if(n){let[,e,t,r]=n;return Gi(Number(e),Number(t),Number(r))}let r=Vi.exec(t);if(r){let[,e,t,n]=r,i=Number(n);return Gi(n.length===2?i<=69?2e3+i:1900+i:i,Number(t),Number(e))}return null}function Gi(e,t,n){if(t<1||t>12||n<1||n>31)return null;let r=new Date(e,t-1,n);return r.getFullYear()!==e||r.getMonth()!==t-1||r.getDate()!==n?null:r.getTime()}function Ki(e){let t=0,n=0,r=0;for(let i of e)i.trim()!==``&&(t++,Ui(i)!==null&&n++,Wi(i)!==null&&r++);return t===0?`text`:r===t?`datum`:n===t?`zahl`:`text`}var qi=new Intl.Collator(`de`,{numeric:!0,sensitivity:`base`});function Ji(e,t,n){if(t<0||e.length===0)return e.map((e,t)=>t);let r=n=>e[n][t]??``,i=Ki(e.map(e=>e[t]??``)),a=n?1:-1;return e.map((e,t)=>t).sort((e,t)=>{let n=r(e).trim(),o=r(t).trim();if(n===``&&o===``)return e-t;if(n===``)return zi;if(o===``)return-1;let s=i===`zahl`?(Ui(n)??0)-(Ui(o)??0):i===`datum`?(Wi(n)??0)-(Wi(o)??0):qi.compare(n,o);return s===0?e-t:s*a})}function Yi(e,t,n){return w`<div class="steuerung">
    <button
    ...
    <button
      ...
      @pointerdown=${n}
      @click=${r=>{n(r);let i=e();i.length<8&&(i.push(Ei(i.length)),t(i))}}
    >+</button>
  </div>`}function Xi(e,t){let n=e.currentTarget;if(!n)return;e.stopPropagation(),e.preventDefault();let r=Array.from(n.childNodes),i=n.textContent??``;n.setAttribute(`contenteditable`,`plaintext-only`),n.focus();let a=window.getSelection(),o=document.createRange();o.selectNodeContents(n),a?.removeAllRanges(),a?.addRange(o);let s=!1,c=e=>{if(s)return;s=!0,n.removeAttribute(`contenteditable`),n.removeEventListener(`blur`,l),n.removeEventListener(`keydown`,u);let a=(n.textContent??``).trim();e&&a&&a!==i.trim()?t(a):n.replaceChildren(...r)},l=()=>c(!0),u=e=>{e.key===`Enter`?(e.preventDefault(),n.blur()):e.key===`Escape`&&(e.preventDefault(),c(!1))};n.addEventListener(`blur`,l),n.addEventListener(`keydown`,u)}function Zi(e,t,n,r){Xi(e,e=>{let i=n();t>=i.length||(i[t]={...i[t],titel:e},r(i))})}var Qi=220,$i=new WeakMap;function ea(e){let t=$i.get(e);t!==void 0&&(clearTimeout(t),$i.delete(e))}function ta(e,t,n,r){t.stopPropagation();let i=t.currentTarget.getBoundingClientRect();ea(e),$i.set(e,setTimeout(()=>{$i.delete(e),e.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:n,index:r,top:i.bottom+4,left:i.left},bubbles:!0,composed:!0}))},Qi))}var na={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:wi,eintragsWahl:{key:`art`,label:`Darstellung`,optionen:Si,standard:mi,felderKey:Ci},eintragsZuordnung:{key:`zuordnung`,label:`Status-Zuordnung`,nurBeiWahl:hi,wertLabel:`Datenwert`,nameLabel:`Klarname`,bedeutungLabel:`Bedeutung`,bedeutungen:En}};function ra(e,t){let n=[];return e.forEach((e,r)=>{_r(e,t)&&n.push(r)}),n}function ia(e,t){return!e&&t.trim()!==``}function aa(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}var oa=[{value:`ja`,label:`Ja`},{value:`nein`,label:`Nein`}],sa=[{attributeName:`suche`,name:`Suchzeile`,description:`Zeigt ueber der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,kind:`segment`,options:oa,requiresDataSource:!0},{attributeName:`zeilenWaehler`,name:`Zeilen-Wähler`,description:`Zeigt dem Bediener unten in der Maske den Wähler „Zeilen pro Seite" — er darf die Einstellung dann für seine Sitzung übersteuern. Nein: es gilt unveränderlich, was hier im Editor eingestellt ist.`,kind:`segment`,options:oa,requiresDataSource:!0},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt die Tabelle nur Saetze des Tages, den der Tageswaehler zeigt. Leer = alle Saetze.`,kind:`field`}];function ca(e,t){return w`<div class="fusszeile">
    ...
    <div class="seiten-nav">
  ...
  </div>`}var la=`—`;function ua(e,t){return w`
      ...
      <div class="kopf" style=${ii(e.cols)}>
        ...
        ${e.zeilen.map(n=>w`<div
          ...
          >
            ${``}
            ${e.spalten.map((t,r)=>{let i=xi(t.art),a=n===null?la:e.datenzeilen[n]?.[r]??``,o=n===null?{}:e.zusatzzeilen[n]?.[r]??{};return w`<div class=${i.klasse}>${i.zelle(a,t.zuordnung??[],o)}</div>`})}
          </div>`)}
        ${``}
...
`,fa=4,Q=class e extends M{constructor(...e){super(...e),this.spalten=Di(),this.source=``,this.suche=`ja`,this.proSeite=oi,this.zeilenWaehler=`nein`,this._suchtext=``,this.datenzeilen=[],this.zusatzzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._proSeiteWahl=null,this._proSeiteGemessen=null,this._beobachter=null,this._taktGemessen=0}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.listenBindung=na}static{this.defaultProps={width:`fill`,source:``,spalten:Di(),suche:`ja`,tagField:``,proSeite:oi,zeilenWaehler:`nein`}}static{this.customProperties=sa}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get einstellung(){return this._proSeiteWahl??this.proSeite}get proSeiteAktuell(){return ci(this.einstellung)??this._proSeiteGemessen??si}waehleProSeite(e){this.hasAttribute(`data-ff-editor`)?this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`proSeite`,value:e},bubbles:!0,composed:!0})):this._proSeiteWahl=e,this._seite=0,this.requestUpdate()}messeRumpf(){let e=this.zeilenHoehe;this._taktGemessen=e;let t=di(this,e);t!==this._proSeiteGemessen&&(this._proSeiteGemessen=t,this.requestUpdate())}spaltenListe(){return ji(this.spalten)}get zeilenHoehe(){return bi(this.spaltenListe())}sichtbareIndizes(){let e=ra(this.datenzeilen,this._suchtext);return this._sortSpalte<0?e:Ji(e.map(e=>this.datenzeilen[e]),this._sortSpalte,this._sortAuf).map(t=>e[t])}klickZeile(e){if(e===null||this.hasAttribute(`data-ff-editor`))return;let t=z(this),n=this.rohzeilen[e];t===``||n===void 0||gt(t,n)}setzeSuchtext(e){this._suchtext=e,this._seite=0,this.requestUpdate()}klickSortiere(e){this.editable||(this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.requestUpdate())}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}beobachte(){this._beobachter||(this._beobachter=fi(this,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}connectedCallback(){super.connectedCallback(),Li(this),this.beobachte()}firstUpdated(){this.beobachte()}updated(){this._taktGemessen!==this.zeilenHoehe&&this.messeRumpf()}disconnectedCallback(){super.disconnectedCallback(),ea(this),this._beobachter?.disconnect(),this._beobachter=null,Ri(this)}static{this.styles=[M.styles,On,da]}render(){let t=this.spaltenListe(),n={gridTemplateColumns:t.map(e=>xi(e.art).spur).join(` `)},r=e=>e.stopPropagation(),i=this.sichtbareIndizes(),a=ia(this.hasAttribute(`data-ff-editor`),this.source),o=i.length,s=this.proSeiteAktuell,{seiten:c,seite:l,zeilen:u}=ui({sichtbar:i,hatQuelle:a,proSeite:s,wunschSeite:this._seite,platzhalterZeilen:fa});return w`<div class="tabelle" style=${ii({"--zeilen-hoehe":`${this.zeilenHoehe}px`})}>
      ${Yi(()=>this.spaltenListe(),e=>this.aendere(e),r)}
      ${ua({spalten:t,cols:n,editable:this.editable,zeigeSuche:this.suche===`ja`,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,zeilen:u,datenzeilen:this.datenzeilen,zusatzzeilen:this.zusatzzeilen,hatQuelle:a,auswahlIndex:this.auswahlIndex},{setzeSuchtext:e=>this.setzeSuchtext(e),dblklickKopf:(e,t)=>{this.editable&&(ea(this),Zi(e,t,()=>this.spaltenListe(),e=>this.aendere(e)))},klickKopf:(t,n)=>{this.editable&&ta(this,t,e.listenBindung.prop,n),this.klickSortiere(n)},klickZeile:e=>this.klickZeile(e),stop:r})}
      ${ca({hatQuelle:a,sichtbar:o,gesamt:this.datenzeilen.length,suchtAktiv:this._suchtext.trim()!==``,auswahlAktiv:this.durchAuswahlGefiltert,zeigeWaehler:this.hasAttribute(`data-ff-editor`)||this.zeilenWaehler===`ja`,einstellung:this.einstellung,seite:l,seiten:c},{waehleProSeite:e=>this.waehleProSeite(e),blaettere:e=>{this._seite=e,this.requestUpdate()},stop:r})}
    </div>`}};j([A({converter:{fromAttribute:e=>e?Mi(e):Di(),toAttribute:e=>JSON.stringify(e)}})],Q.prototype,`spalten`,void 0),j([A()],Q.prototype,`source`,void 0),j([A()],Q.prototype,`suche`,void 0),j([A()],Q.prototype,`proSeite`,void 0),j([A()],Q.prototype,`zeilenWaehler`,void 0),j([A({attribute:!1})],Q.prototype,`datenzeilen`,void 0),j([A({attribute:!1})],Q.prototype,`zusatzzeilen`,void 0),j([A({attribute:!1})],Q.prototype,`rohzeilen`,void 0),j([A({attribute:!1})],Q.prototype,`auswahlIndex`,void 0),j([A({attribute:!1})],Q.prototype,`durchAuswahlGefiltert`,void 0),M.defineAndRegister(Q);var pa=Kn(`text`);function ma(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(pa)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function ha(e){let t=er(e,pa);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function ga(e){ma(e)&&(e.text=``)}var _a=Jn({hydriere:ha,verdrahte:ga}),va=_a.connect,ya=_a.disconnect,ba=6,xa=96,Sa=14,Ca={duenn:`300`,normal:`400`,fett:`700`},wa={links:`left`,mitte:`center`,rechts:`right`},Ta={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},Ea=`standard`;function Da(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(xa,Math.max(ba,t)):Sa}function Oa(e){return typeof e==`string`&&e in Ca?e:`normal`}function ka(e){return typeof e==`string`&&e in wa?e:`links`}function Aa(e){return typeof e==`string`&&e in Ta?e:Ea}var $=class extends M{constructor(...e){super(...e),this.groesse=Sa,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=Ea,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:Sa,gewicht:`normal`,ausrichtung:`links`,farbe:Ea,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:ba,max:xa,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[M.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return w`<div
      class="text"
      style=${ii({fontSize:`${Da(this.groesse)}px`,fontWeight:Ca[Oa(this.gewicht)],textAlign:wa[ka(this.ausrichtung)],color:Ta[Aa(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),va(this)}disconnectedCallback(){super.disconnectedCallback(),ya(this)}};j([A({type:Number})],$.prototype,`groesse`,void 0),j([A()],$.prototype,`gewicht`,void 0),j([A()],$.prototype,`ausrichtung`,void 0),j([A()],$.prototype,`farbe`,void 0),j([A()],$.prototype,`text`,void 0),j([A()],$.prototype,`source`,void 0),j([A()],$.prototype,`textField`,void 0),M.defineAndRegister($);var ja=[`waagerecht`,`senkrecht`],Ma=`waagerecht`;function Na(e){return ja.includes(e)?e:Ma}var Pa=class extends M{constructor(...e){super(...e),this.richtung=Ma}static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`,richtung:Ma}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1,varianten:[{wenn:{attributeName:`richtung`,equals:`senkrecht`},startW:1,startH:6,breiteZiehbar:!1}]}}static{this.customProperties=[{attributeName:`richtung`,name:`Richtung`,description:`Waagerecht trennt oben von unten, senkrecht links von rechts.`,kind:`select`,options:[{value:`waagerecht`,label:`Waagerecht`},{value:`senkrecht`,label:`Senkrecht`}]}]}static{this.styles=[M.styles,o`
    ...
    `]}render(){return w`<div class="zeile"><slot></slot></div>`}};M.defineAndRegister(Fa),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;H(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();
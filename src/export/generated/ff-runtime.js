...
`,gr=`ff-dialog-rahmen`,_r=`ff-dialog-schliessen`;function vr(e,t){let n=Number(e);return Number.isFinite(n)&&n>0?n:t}var q=class extends k{constructor(...e){super(...e),this.titel=`Dialog`,this.breite=520,this.hoehe=380,this.viewport=!1,this.mitWerkzeug=!1,this.escapeSchliesst=!1,this.escapeRegistriert=!1,this.aufTaste=e=>{e.key===`Escape`&&(e.stopPropagation(),this.schliesse())}}static{this.styles=o`
  ...
  `}aktualisiereEscape(){let e=this.isConnected&&this.escapeSchliesst;e!==this.escapeRegistriert&&(e?document.addEventListener(`keydown`,this.aufTaste,!0):document.removeEventListener(`keydown`,this.aufTaste,!0),this.escapeRegistriert=e)}schliesse(){this.dispatchEvent(new CustomEvent(_r,{bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),this.aktualisiereEscape()}updated(e){e.has(`escapeSchliesst`)&&this.aktualisiereEscape()}disconnectedCallback(){this.escapeRegistriert&&=(document.removeEventListener(`keydown`,this.aufTaste,!0),!1),super.disconnectedCallback()}render(){return w`
    ...
    >${this.placeholder}</span>`}onTextClick(){this.hasAttribute(`data-ff-editor`)||this.setzeHaken(!this.angehakt)}setzeHaken(e){this.angehakt!==e&&(this.angehakt=e,this.dispatchEvent(new Event(`change`)))}controlTpl(e){switch(e){case`textarea`:return w`<textarea class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}></textarea>`;case`select`:{let e=this.options.split(`,`).map(e=>e.trim()).filter(e=>e!==``),t=this.value!==``&&!e.includes(this.value);return w`<select class="ctrl" .value=${this.value} @input=${this.onInput} @change=${this.onChange}>
        ...
        />`}}onLupe(){this.hasAttribute(`data-ff-editor`)||Mr({el:this,quelleId:this.nachschlagQuelle,anzeigeFeld:this.anzeigeFeld,speicherFeld:this.speicherFeld,anzeigeTitel:this.anzeigeTitel,speicherTitel:this.speicherTitel,titel:this.placeholder,onUebernehmen:(e,t,n)=>{this.uebernimmSatz(e,t,n),this.dispatchEvent(new Event(`change`))}})}leereNachschlagen(){this.satz=void 0,this.anzeige=``,this.value=``,vt(z(this))}uebernimmSatz(e,t,n){this.anzeige=e===``?t:e,this.value=t,this.satz=n,_t(z(this),n)}onLoeschen(){this.hasAttribute(`data-ff-editor`)||(this.leereNachschlagen(),this.dispatchEvent(new Event(`change`)))}pruefeEigenenWert(){Pr(this.fieldType)===`nachschlagen`&&(this.satz!==void 0&&!Dr(this,this.satz)&&this.leereNachschlagen(),this.uebernimmEinzigenTreffer())}uebernimmEinzigenTreffer(){if(this.einzigerTreffer!==`ja`)return;let e=Tr({el:this,quelleId:this.nachschlagQuelle,anzeigeFeld:this.anzeigeFeld,speicherFeld:this.speicherFeld});if(!e.ok)return;let t=Er(e.eintraege,this.satz===void 0);t&&this.uebernimmSatz(t.anzeige,t.wert,t.satz)}render(){let e=Pr(this.fieldType);if(e===`checkbox`)return w`<div class="feld">
        <div class="zeile">
          <input
            class="ctrl"
            type="checkbox"
...
`;function Br(e,t,n,r){return{attributeName:e,name:t,description:n,kind:`select`,options:[{value:`nein`,label:`Nein`},{value:`ja`,label:`Ja`}],...r}}var Y=class extends M{constructor(...e){super(...e),this.variant=`info`,this.heading=`Neue Spalte`,this.leerHinweis=``,this._count=0}static{this.blockType=`kanban-spalte`}static{this.tagName=`ff-kanban-spalte`}static{this.displayName=`Kanban-Spalte`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[K.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={variant:`info`,heading:`Neue Spalte`,auffang:`nein`}}static{this.customProperties=[On(`variant`,`Bedeutung der Spalte — bestimmt ihre Farbwelt (Kopf, Fläche, Rahmen).`),Br(`auffang`,`Auffangspalte`,`Einträge ohne passenden Spaltentitel landen hier. Ohne Auffangspalte landen sie in der ersten Spalte.`,{requiresDataSource:!0,exclusiveAmongSiblings:!0})]}static{this.styles=[M.styles,zr,o`
    ...
    </div>`}};j([A()],Y.prototype,`variant`,void 0),j([A()],Y.prototype,`heading`,void 0),j([A({attribute:!1})],Y.prototype,`leerHinweis`,void 0),j([Be()],Y.prototype,`_count`,void 0),M.defineAndRegister(Y);function Vr(e,t,n){return t===``||n===``?[...e]:e.filter(e=>Rn(F(e,t))===n)}function Hr(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function Ur(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var Wr=new WeakMap,Gr=Y.tagName,Kr=K.tagName;function qr(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Gr)}function Jr(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Kr)}function Yr(e,t){let n=e.getAttribute(`leertext`)??`Keine Einträge.`;for(let e of t)e.leerHinweis=Jr(e).length===0?n:``}function Xr(e){return Ue().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function Zr(e){Z?.board===e&&(Z=null);let t=e.getAttribute(`source`)??``,n=e.getAttribute(`statusfield`)??``;if(t===``)return;let r=P(U().FF_DATA_SOURCES,t);if(!r)return;let i=qr(e);if(i.length===0)return;let a=Wr.get(e);if(!a){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(Kr);t&&(a=t.cloneNode(!0),Wr.set(e,a))}if(!a)return;let o=Vr(L(U().SEDATA,r.name,r.tableId),e.getAttribute(`tagfield`)??``,Un()),s=i.map(e=>e.getAttribute(`heading`)??Y.defaultProps.heading),c=Xr(a.tagName),l=Ur(i.map(e=>e.getAttribute(`auffang`))),u=nr(e);for(let e of i)Jr(e).forEach(e=>e.remove());for(let e of o){let t=a.cloneNode(!0),o=n===``?-1:Hr(F(e,n),s);(o>=0?i[o]:l>=0?i[l]:i[0]).appendChild(t);for(let n of c){let r=t.getAttribute(Yn(n.prop))??``;r!==``&&(t[n.prop]=u(e,r))}let d=r.indexField===``?``:F(e,r.indexField);X.set(t,{row:e,pindex:d}),t.draggable=!0}Yr(e,i);let d=i.flatMap(Jr),f=ht(z(e),d,e=>X.get(e)?.row);for(let e of f)d[e].setAttribute(`data-ff-auswahl`,``)}var X=new WeakMap,Z=null,Qr=new WeakSet;function $r(e,t){for(let n of t.composedPath())if(n instanceof HTMLElement&&n.tagName.toLowerCase()===Gr&&e.contains(n))return n;return null}function ei(e,t){if(!Z||Z.board!==e)return;let n=X.get(Z.card);if(!n)return;let r=t.getAttribute(`heading`)??``;xn(e,`onCardDrop`,{PINDEX:n.pindex,VALUE:r}).catch(bn)}function ti(e){Qr.has(e)||(Qr.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;if(!n)return;let r=X.get(n);r&&gt(z(e),r.row),xn(e,`onCardClick`,{PINDEX:r?.pindex??``}).catch(bn)}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;n&&(Z={card:n,board:e},t.dataTransfer?.setData(`text/plain`,X.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`))}),e.addEventListener(`dragend`,()=>{Z=null}),e.addEventListener(`dragover`,t=>{let n=$r(e,t);Z?.board===e&&n&&(t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`))}),e.addEventListener(`drop`,t=>{let n=$r(e,t);n&&(t.preventDefault(),ei(e,n),Z=null)}))}var ni=Zn({hydriere:Zr,verdrahte:ti}),ri=ni.connect,ii=ni.disconnect,ai=Y.blockType,oi=class extends M{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[ai]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:ai}}static{this.templateChild={type:K.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``,tagField:``,leerText:Ir}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Optional: Feld der Datenquelle, dessen Inhalt bestimmt, in welche Spalte ein Eintrag kommt. Leer = alle Einträge in der Auffang-Spalte.`,kind:`field`},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt das Board nur Einträge des Tages, den der Tageswähler zeigt. Leer = alle Einträge.`,kind:`field`},Lr()]}static{this.defaultChildren=[{type:ai,props:{heading:`Offen`,variant:`warning`},children:[{type:K.blockType}]},{type:ai,props:{heading:`In Arbeit`,variant:`info`}},{type:ai,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[M.styles,o`
    ...
    `]}render(){return w`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),ri(this)}disconnectedCallback(){super.disconnectedCallback(),ii(this)}};M.defineAndRegister(oi);var si={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},ci=e=>(...t)=>({_$litDirective$:e,values:t}),li=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},ui=`important`,di=` !important`,fi=ci(class extends li{constructor(e){if(super(e),e.type!==si.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(di);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?ui:``):n[e]=r}}return T}}),pi=[10,25,50],mi=`passend`,hi=pi[0];function gi(e){let t=Number(e);return pi.some(e=>e===t)?t:null}function _i(e,t,n){return Math.max(1,Math.floor((e-t)/n))}function vi({sichtbar:e,hatQuelle:t,proSeite:n,wunschSeite:r,platzhalterZeilen:i}){let a=t?Math.max(1,Math.ceil(e.length/n)):1,o=Math.min(Math.max(r,0),a-1);return t?{seiten:a,seite:o,zeilen:[...e.slice(o*n,(o+1)*n)]}:{seiten:a,seite:o,zeilen:Array.from({length:i},()=>null)}}function yi(e,t){if(!e.hasAttribute(`fuellt`))return null;let n=e.renderRoot.querySelector(`.koerper`),r=e.renderRoot.querySelector(`.kopf`);return!(n instanceof HTMLElement)||!(r instanceof HTMLElement)?null:_i(n.clientHeight,r.offsetHeight,t)}function bi(e,t){if(typeof ResizeObserver>`u`)return null;let n=e.renderRoot.querySelector(`.koerper`);if(!n)return null;let r=new ResizeObserver(t);return r.observe(n),r}function xi(e,t){let n=t.trim().toLowerCase();return e.find(e=>e.wert.trim().toLowerCase()===n)}var Si=`text`,Ci=`status`,wi=`bild`,Ti=`bild`,Ei=`unter`,Di=[{wert:Si,name:`Text`,spur:`minmax(0, 1fr)`,klasse:``,zelle:e=>e},{wert:`zahl`,name:`Zahl`,spur:`90px`,klasse:`zahl`,zelle:e=>e},{wert:`datum`,name:`Datum`,spur:`100px`,klasse:`zahl`,zelle:e=>e},{wert:Ci,name:`Status`,spur:`120px`,klasse:`status`,zelle:(e,t)=>{let n=xi(t,e);return n?w`<span class="chip v-${En(n.bedeutung)}">${n.name.trim()===``?e:n.name}</span>`:w`<span class="chip">${e}</span>`}},{wert:wi,name:`Bild + Name`,spur:`minmax(0, 1fr)`,klasse:`bild`,zusatzFelder:[{key:Ti,label:`Bild`},{key:Ei,label:`Unterzeile`}],hoehe:e=>(e[Ti]??``)!==``||(e[Ei]??``)!==``?44:32,zelle:(e,t,n)=>{let r=Fn(n[Ti]??``),i=n[Ei]??``;return w`<div class="bild-name">
        ${r===void 0?E:w`<span class="bild-zeichen">${r}</span>`}
        <div class="bild-text">
          <div class="bild-titel">${e}</div>
          ${i===``?E:w`<div class="bild-unter">${i}</div>`}
        </div>
      </div>`}}];function Oi(e){return e.reduce((e,t)=>{let n=ki(t.art);return Math.max(e,n.hoehe?.(t.felder??{})??32)},32)}function ki(e){return Di.find(t=>t.wert===e)??Di[0]}var Ai=Di.map(e=>({wert:e.wert,name:e.name,...e.zusatzFelder?{felder:e.zusatzFelder}:{}})),ji=`felder`,Mi=`Spalte {n}`;function Ni(e){return Mi.replace(`{n}`,String(e+1))}function Pi(e){return{titel:Ni(e),feld:``,art:Si}}function Fi(){return[0,1,2].map(e=>Pi(e))}function Ii(e){return Array.isArray(e)?e.filter(e=>!!e&&typeof e==`object`).map(e=>({wert:typeof e.wert==`string`?e.wert:``,name:typeof e.name==`string`?e.name:``,bedeutung:typeof e.bedeutung==`string`?e.bedeutung:``})).filter(e=>e.wert.trim()!==``):[]}function Li(e){if(!e||typeof e!=`object`||Array.isArray(e))return{};let t={};for(let[n,r]of Object.entries(e))typeof r==`string`&&r!==``&&(t[n]=r);return t}function Ri(e,t){if(e&&typeof e==`object`){let n=e,r=Ii(n.zuordnung),i=Li(n.felder);return{titel:typeof n.titel==`string`?n.titel:Ni(t),feld:typeof n.feld==`string`?n.feld:``,art:typeof n.art==`string`?n.art:Si,...r.length>0?{zuordnung:r}:{},...Object.keys(i).length>0?{felder:i}:{}}}return typeof e==`string`?{...Pi(t),titel:e}:Pi(t)}function zi(e){let t;if(Array.isArray(e))t=e.map((e,t)=>Ri(e,t));else if(typeof e==`number`&&Number.isFinite(e)||typeof e==`string`&&/^\d+$/.test(e)){let n=Math.max(1,Math.floor(Number(e)));t=[...Array(n).keys()].map(e=>Pi(e))}else t=Fi();return t.length>8&&(t=t.slice(0,8)),t.length<1&&(t=[Pi(0)]),t}function Bi(e){try{return zi(JSON.parse(e))}catch{return Fi()}}function Vi(e){return Bi(e.getAttribute(`spalten`)??``)}function Hi(e,t,n){let r={};for(let i of ki(e.art).zusatzFelder??[]){let a=e.felder?.[i.key]??``;a!==``&&(r[i.key]=n(t,a))}return r}function Ui(e){let t=()=>{e.datenzeilen=[],e.zusatzzeilen=[]},n=e.getAttribute(`source`)??``;if(n===``){t();return}let r=P(U().FF_DATA_SOURCES,n);if(!r){t();return}let i=Vi(e),{rows:a,gefiltert:o}=xt(e,Vr(L(U().SEDATA,r.name,r.tableId),e.getAttribute(`tagfield`)??``,Un())),s=ht(z(e),a,e=>e)[0]??-1,c=nr(e);e.rohzeilen=a,e.auswahlIndex=s,e.durchAuswahlGefiltert=o,e.datenzeilen=a.map(e=>i.map(t=>t.feld===``?``:c(e,t.feld))),e.zusatzzeilen=a.map(e=>i.map(t=>Hi(t,e,c)))}var Wi=Zn({hydriere:Ui}),Gi=Wi.connect,Ki=Wi.disconnect,qi=1,Ji=/^-?\d{1,3}(\.\d{3})*(,\d+)?$|^-?\d+(,\d+)?$|^-?\d+(\.\d+)?$/,Yi=/^(\d{1,2})\.(\d{1,2})\.(\d{2}|\d{4})$/,Xi=/^(\d{4})-(\d{2})-(\d{2})$/;function Zi(e){let t=e.trim();if(t===``||!Ji.test(t))return null;let n=t.includes(`,`)?t.replace(/\./g,``).replace(`,`,`.`):/^-?\d{1,3}(\.\d{3})+$/.test(t)?t.replace(/\./g,``):t,r=Number(n);return Number.isFinite(r)?r:null}function Qi(e){let t=e.trim();if(t===``)return null;let n=Xi.exec(t);if(n){let[,e,t,r]=n;return $i(Number(e),Number(t),Number(r))}let r=Yi.exec(t);if(r){let[,e,t,n]=r,i=Number(n);return $i(n.length===2?i<=69?2e3+i:1900+i:i,Number(t),Number(e))}return null}function $i(e,t,n){if(t<1||t>12||n<1||n>31)return null;let r=new Date(e,t-1,n);return r.getFullYear()!==e||r.getMonth()!==t-1||r.getDate()!==n?null:r.getTime()}function ea(e){let t=0,n=0,r=0;for(let i of e)i.trim()!==``&&(t++,Zi(i)!==null&&n++,Qi(i)!==null&&r++);return t===0?`text`:r===t?`datum`:n===t?`zahl`:`text`}var ta=new Intl.Collator(`de`,{numeric:!0,sensitivity:`base`});function na(e,t,n){if(t<0||e.length===0)return e.map((e,t)=>t);let r=n=>e[n][t]??``,i=ea(e.map(e=>e[t]??``)),a=n?1:-1;return e.map((e,t)=>t).sort((e,t)=>{let n=r(e).trim(),o=r(t).trim();if(n===``&&o===``)return e-t;if(n===``)return qi;if(o===``)return-1;let s=i===`zahl`?(Zi(n)??0)-(Zi(o)??0):i===`datum`?(Qi(n)??0)-(Qi(o)??0):ta.compare(n,o);return s===0?e-t:s*a})}function ra(e,t,n){return w`<div class="steuerung">
    <button
    ...
    <button
      ...
      @pointerdown=${n}
      @click=${r=>{n(r);let i=e();i.length<8&&(i.push(Pi(i.length)),t(i))}}
    >+</button>
  </div>`}function ia(e,t){let n=e.currentTarget;if(!n)return;e.stopPropagation(),e.preventDefault();let r=Array.from(n.childNodes),i=n.textContent??``;n.setAttribute(`contenteditable`,`plaintext-only`),n.focus();let a=window.getSelection(),o=document.createRange();o.selectNodeContents(n),a?.removeAllRanges(),a?.addRange(o);let s=!1,c=e=>{if(s)return;s=!0,n.removeAttribute(`contenteditable`),n.removeEventListener(`blur`,l),n.removeEventListener(`keydown`,u);let a=(n.textContent??``).trim();e&&a&&a!==i.trim()?t(a):n.replaceChildren(...r)},l=()=>c(!0),u=e=>{e.key===`Enter`?(e.preventDefault(),n.blur()):e.key===`Escape`&&(e.preventDefault(),c(!1))};n.addEventListener(`blur`,l),n.addEventListener(`keydown`,u)}function aa(e,t,n,r){ia(e,e=>{let i=n();t>=i.length||(i[t]={...i[t],titel:e},r(i))})}var oa=220,sa=new WeakMap;function ca(e){let t=sa.get(e);t!==void 0&&(clearTimeout(t),sa.delete(e))}function la(e,t,n,r){t.stopPropagation();let i=t.currentTarget.getBoundingClientRect();ca(e),sa.set(e,setTimeout(()=>{sa.delete(e),e.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:n,index:r,top:i.bottom+4,left:i.left},bubbles:!0,composed:!0}))},oa))}var ua={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:Mi,eintragsWahl:{key:`art`,label:`Darstellung`,optionen:Ai,standard:Si,felderKey:ji},eintragsZuordnung:{key:`zuordnung`,label:`Status-Zuordnung`,nurBeiWahl:Ci,wertLabel:`Datenwert`,nameLabel:`Klarname`,bedeutungLabel:`Bedeutung`,bedeutungen:Dn}};function da(e,t){let n=[];return e.forEach((e,r)=>{br(e,t)&&n.push(r)}),n}function fa(e,t){return!e&&t.trim()!==``}function pa(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}var ma=[{value:`ja`,label:`Ja`},{value:`nein`,label:`Nein`}],ha=[{attributeName:`suche`,name:`Suchzeile`,description:`Zeigt ueber der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,kind:`segment`,options:ma,requiresDataSource:!0},{attributeName:`zeilenWaehler`,name:`Zeilen-Wähler`,description:`Zeigt dem Bediener unten in der Maske den Wähler „Zeilen pro Seite" — er darf die Einstellung dann für seine Sitzung übersteuern. Nein: es gilt unveränderlich, was hier im Editor eingestellt ist.`,kind:`segment`,options:ma,requiresDataSource:!0},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt die Tabelle nur Saetze des Tages, den der Tageswaehler zeigt. Leer = alle Saetze.`,kind:`field`},Lr()];function ga(e,t){return w`<div class="fusszeile">
    ...
    <div class="seiten-nav">
      ...
      >
        ...
        <option value=${mi} ?selected=${e.einstellung===mi}>passend zur Höhe</option>
        ${pi.map(t=>w`<option value=${t} ?selected=${e.einstellung===String(t)}>${t} pro Seite</option>`)}
      </select>`:E}
      <button
  ...
  </div>`}var _a=`—`;function va(e,t){return w`
      ...
      <div class="kopf" style=${fi(e.cols)}>
        ...
        ${e.zeilen.map(n=>w`<div
          ...
          >
            ${``}
            ${e.spalten.map((t,r)=>{let i=ki(t.art),a=n===null?_a:e.datenzeilen[n]?.[r]??``,o=n===null?{}:e.zusatzzeilen[n]?.[r]??{};return w`<div class=${i.klasse}>${i.zelle(a,t.zuordnung??[],o)}</div>`})}
          </div>`)}
        ${``}
        <div class="lineal" style=${fi(e.cols)}>
...
`,ba=4,Q=class e extends M{constructor(...e){super(...e),this.spalten=Fi(),this.source=``,this.suche=`ja`,this.proSeite=mi,this.zeilenWaehler=`nein`,this.leerText=Ir,this._suchtext=``,this.datenzeilen=[],this.zusatzzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._proSeiteWahl=null,this._proSeiteGemessen=null,this._beobachter=null,this._taktGemessen=0}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.listenBindung=ua}static{this.defaultProps={width:`fill`,source:``,spalten:Fi(),suche:`ja`,tagField:``,proSeite:mi,zeilenWaehler:`nein`,leerText:Ir}}static{this.customProperties=ha}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get einstellung(){return this._proSeiteWahl??this.proSeite}get proSeiteAktuell(){return gi(this.einstellung)??this._proSeiteGemessen??hi}waehleProSeite(e){this.hasAttribute(`data-ff-editor`)?this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`proSeite`,value:e},bubbles:!0,composed:!0})):this._proSeiteWahl=e,this._seite=0,this.requestUpdate()}messeRumpf(){let e=this.zeilenHoehe;this._taktGemessen=e;let t=yi(this,e);t!==this._proSeiteGemessen&&(this._proSeiteGemessen=t,this.requestUpdate())}spaltenListe(){return zi(this.spalten)}get zeilenHoehe(){return Oi(this.spaltenListe())}sichtbareIndizes(){let e=da(this.datenzeilen,this._suchtext);return this._sortSpalte<0?e:na(e.map(e=>this.datenzeilen[e]),this._sortSpalte,this._sortAuf).map(t=>e[t])}klickZeile(e){if(e===null||this.hasAttribute(`data-ff-editor`))return;let t=z(this),n=this.rohzeilen[e];t===``||n===void 0||gt(t,n)}setzeSuchtext(e){this._suchtext=e,this._seite=0,this.requestUpdate()}klickSortiere(e){this.editable||(this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.requestUpdate())}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}beobachte(){this._beobachter||(this._beobachter=bi(this,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}connectedCallback(){super.connectedCallback(),Gi(this),this.beobachte()}firstUpdated(){this.beobachte()}updated(){this._taktGemessen!==this.zeilenHoehe&&this.messeRumpf()}disconnectedCallback(){super.disconnectedCallback(),ca(this),this._beobachter?.disconnect(),this._beobachter=null,Ki(this)}static{this.styles=[M.styles,kn,zr,ya]}render(){let t=this.spaltenListe(),n={gridTemplateColumns:t.map(e=>ki(e.art).spur).join(` `)},r=e=>e.stopPropagation(),i=this.sichtbareIndizes(),a=fa(this.hasAttribute(`data-ff-editor`),this.source),o=a&&this.datenzeilen.length===0,s=i.length,c=this.proSeiteAktuell,{seiten:l,seite:u,zeilen:d}=vi({sichtbar:i,hatQuelle:a,proSeite:c,wunschSeite:this._seite,platzhalterZeilen:ba});return w`<div class="tabelle" style=${fi({"--zeilen-hoehe":`${this.zeilenHoehe}px`})}>
      ...
      ${``}
      ${o?E:ga({hatQuelle:a,sichtbar:s,gesamt:this.datenzeilen.length,suchtAktiv:this._suchtext.trim()!==``,auswahlAktiv:this.durchAuswahlGefiltert,zeigeWaehler:this.hasAttribute(`data-ff-editor`)||this.zeilenWaehler===`ja`,einstellung:this.einstellung,seite:u,seiten:l},{waehleProSeite:e=>this.waehleProSeite(e),blaettere:e=>{this._seite=e,this.requestUpdate()},stop:r})}
    </div>`}};j([A({converter:{fromAttribute:e=>e?Bi(e):Fi(),toAttribute:e=>JSON.stringify(e)}})],Q.prototype,`spalten`,void 0),j([A()],Q.prototype,`source`,void 0),j([A()],Q.prototype,`suche`,void 0),j([A()],Q.prototype,`proSeite`,void 0),j([A()],Q.prototype,`zeilenWaehler`,void 0),j([A()],Q.prototype,`leerText`,void 0),j([A({attribute:!1})],Q.prototype,`datenzeilen`,void 0),j([A({attribute:!1})],Q.prototype,`zusatzzeilen`,void 0),j([A({attribute:!1})],Q.prototype,`rohzeilen`,void 0),j([A({attribute:!1})],Q.prototype,`auswahlIndex`,void 0),j([A({attribute:!1})],Q.prototype,`durchAuswahlGefiltert`,void 0),M.defineAndRegister(Q);var xa=Yn(`text`);function Sa(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(xa)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function Ca(e){let t=rr(e,xa);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function wa(e){Sa(e)&&(e.text=``)}var Ta=Zn({hydriere:Ca,verdrahte:wa}),Ea=Ta.connect,Da=Ta.disconnect,Oa=6,ka=96,Aa=14,ja={duenn:`300`,normal:`400`,fett:`700`},Ma={links:`left`,mitte:`center`,rechts:`right`},Na={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},Pa=`standard`;function Fa(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(ka,Math.max(Oa,t)):Aa}function Ia(e){return typeof e==`string`&&e in ja?e:`normal`}function La(e){return typeof e==`string`&&e in Ma?e:`links`}function Ra(e){return typeof e==`string`&&e in Na?e:Pa}var $=class extends M{constructor(...e){super(...e),this.groesse=Aa,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=Pa,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:Aa,gewicht:`normal`,ausrichtung:`links`,farbe:Pa,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:Oa,max:ka,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[M.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return w`<div
      class="text"
      style=${fi({fontSize:`${Fa(this.groesse)}px`,fontWeight:ja[Ia(this.gewicht)],textAlign:Ma[La(this.ausrichtung)],color:Na[Ra(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),Ea(this)}disconnectedCallback(){super.disconnectedCallback(),Da(this)}};j([A({type:Number})],$.prototype,`groesse`,void 0),j([A()],$.prototype,`gewicht`,void 0),j([A()],$.prototype,`ausrichtung`,void 0),j([A()],$.prototype,`farbe`,void 0),j([A()],$.prototype,`text`,void 0),j([A()],$.prototype,`source`,void 0),j([A()],$.prototype,`textField`,void 0),M.defineAndRegister($);var za=[`waagerecht`,`senkrecht`],Ba=`waagerecht`;function Va(e){return za.includes(e)?e:Ba}var Ha=class extends M{constructor(...e){super(...e),this.richtung=Ba}static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`,richtung:Ba}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1,varianten:[{wenn:{attributeName:`richtung`,equals:`senkrecht`},startW:1,startH:6,breiteZiehbar:!1}]}}static{this.customProperties=[{attributeName:`richtung`,name:`Richtung`,description:`Waagerecht trennt oben von unten, senkrecht links von rechts.`,kind:`select`,options:[{value:`waagerecht`,label:`Waagerecht`},{value:`senkrecht`,label:`Senkrecht`}]}]}static{this.styles=[M.styles,o`
    ...
    `]}render(){return w`<div class="zeile"><slot></slot></div>`}};M.defineAndRegister(Ua),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;H(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();
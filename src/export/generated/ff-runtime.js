...
`)+(Vt===``?``:`\n\nERSTES PAKET\n${Vt}`))}function G(e,t){W.set(e,t),Wt()}function Gt(){let e=U();W.set(`basisHTML_REGISTER`,typeof e.basisHTML_REGISTER==`function`?`vorhanden`:`fehlt`),W.set(`basisHTML_SND_MSG`,typeof e.basisHTML_SND_MSG==`function`?`vorhanden`:`fehlt`),W.set(`body.pid`,document.body?.getAttribute(`pid`)?`gesetzt`:`fehlt`),W.set(`body.REGMSG`,document.body?.getAttribute(`REGMSG`)?`gesetzt`:`fehlt`),W.set(`Empfangene Pakete`,String(Ht)),W.set(`SEDATA.Daten`,Mt()?`vorhanden`:`fehlt`),Wt()}function Kt(e){if(Vt===``)try{Vt=typeof e==`string`?e:JSON.stringify(e)??``,Wt()}catch{}}function qt(e){Ht+=1,Kt(e),G(`Empfangene Pakete`,String(Ht));let t=at(e);if(!t){G(`Letztes Paket`,`Antwort ohne Daten`),Bt(e);return}let n=U();N(n.SEDATA)||(n.SEDATA={}),n.SEDATA.Daten=t,G(`Letztes Paket`,`Daten-Push angenommen`),G(`SEDATA.Daten`,`vorhanden`),Pt(),zt()}function Jt(e=0){let t=U();if(typeof t.basisHTML_REGISTER==`function`){Gt();try{t.basisHTML_SetConsoleLog?.(!0,!0)}catch{}try{t.basisHTML_REGISTER(e=>{qt(e)},document.title,`1.0`),G(`Registrierung`,`ausgeführt`)}catch(e){G(`Registrierung`,`Fehler: ${e instanceof Error?e.message:String(e)}`)}return}e<400?(e===0&&G(`Registrierung`,`wartet auf Interface`),setTimeout(()=>{Jt(e+1)},25)):(Gt(),G(`Registrierung`,`nach 10s kein Interface`),H(`SoftEngine-Anschluss nicht gefunden — die Maske bleibt ohne Daten (Strg+Alt+D für Details).`))}var Yt=!1;function Xt(){if(Yt)return;Yt=!0,G(`Runtime`,`gestartet`),G(`Registrierung`,`noch nicht ausgeführt`),Gt(),Nt();let e=U();e.Erstellen=()=>{Pt(),zt()},e.initData=e.Erstellen,e.ReloadData=()=>{zt()},Jt(),window.addEventListener(`message`,e=>{if(typeof U().basisHTML_REGISTER==`function`)return;let t=ot(e.data);t!==void 0&&qt(t)},!0),document.addEventListener(`keydown`,e=>{if(e.ctrlKey&&e.altKey&&e.key.toLowerCase()===`d`){Gt();let e=document.getElementById(`ff-se-diagnose`);e&&(e.style.display=e.style.display===`none`?`block`:`none`)}});let t=0,n=setInterval(()=>{t+=1,Mt()?(clearInterval(n),G(`SEDATA.Daten`,`vorhanden`),Pt(),zt()):t>100&&(clearInterval(n),G(`Daten-Wartezeit`,`nach 30s ohne Daten`),H(`Keine Daten von SoftEngine empfangen — die Maske zeigt nichts an (Strg+Alt+D für Details).`))},300)}function Zt(e){return e instanceof Error?e.message:String(e)}function Qt(e,t){if(!(!Array.isArray(e)||t===``)){for(let n of e)if(!(!N(n)||n.id!==t)&&!(typeof n.verb!=`string`||!Tt.includes(n.verb))&&!(typeof n.nr!=`string`||n.nr===``)&&!(!Array.isArray(n.params)||n.params.some(e=>typeof e!=`string`)))return{id:t,verb:n.verb,nr:n.nr,params:n.params}}}var $t=[`RESULT`,`result`,`PINDEX`,`pindex`,`INDEX`,`index`,`0_10`,`KEY`,`key`,`ID`,`id`,`VALUE`,`value`];function en(e){if(typeof e!=`string`)return e;try{return JSON.parse(e)}catch{return}}function tn(e){if(typeof e==`string`)return e.trim()===``?void 0:e.trim();if(typeof e==`number`||typeof e==`boolean`)return String(e)}function nn(e,t){if(t>12)return;let n=tn(e);if(n!==void 0)return n;if(Array.isArray(e)){for(let n of e){let e=nn(n,t+1);if(e!==void 0)return e}return}if(N(e)){for(let n of $t){if(!(n in e))continue;let r=nn(e[n],t+1);if(r!==void 0)return r}for(let n of Object.values(e)){let e=nn(n,t+1);if(e!==void 0)return e}}}function rn(e){let t=en(e);if(N(t)){for(let e of $t){if(!(e in t))continue;let n=nn(t[e],0);if(n!==void 0)return n}for(let e of Object.values(t))if(Array.isArray(e))for(let t of e){let e=rn(t);if(e!==void 0)return e}else if(N(e)){let t=rn(e);if(t!==void 0)return t}}}function an(e){return N(e)?Object.keys(e).filter(e=>/^Message\d+$/.test(e)):[]}function on(e,t){if(!N(e))return;let n=an(e).filter(e=>!t.has(e)).sort((e,t)=>Number(t.slice(7))-Number(e.slice(7)));for(let t of n){let n=rn(e[t]);if(n!==void 0)return n}}var sn=[],cn=!1,ln=6e3,un=100;function dn(){if(cn||sn.length===0)return;cn=!0;let e=sn.shift(),t=U(),n=new Set(an(t.SEDATA)),r=!1,i=t=>{r||(r=!0,a(),clearInterval(o),clearTimeout(s),cn=!1,e.resolve(t),dn())},a=Rt(e=>{let t=rn(e);t!==void 0&&i(t)}),o=setInterval(()=>{let e=on(U().SEDATA,n);e!==void 0&&i(e)},un),s=setTimeout(()=>{H(`Daten laden: SoftEngine hat nicht geantwortet (Relation Nr. ${e.template.nr}).`),i(``)},ln);if(typeof t.basisHTML_SND_MSG!=`function`){H(`Daten laden nicht moeglich: keine Verbindung zu SoftEngine.`),i(``);return}try{t.basisHTML_SND_MSG(`GET_RELATION`,{NR:e.template.nr,PARAMS:e.params})}catch(t){H(`Daten laden fehlgeschlagen (Relation Nr. ${e.template.nr}): ${Zt(t)}`),i(``)}}function fn(e,t){Xt();let n=U();if(e.verb!==`GET_RELATION`){if(typeof n.basisHTML_SND_MSG!=`function`)return H(`Speichern nicht moeglich: keine Verbindung zu SoftEngine. Die Eingabe wurde NICHT uebernommen.`),Promise.resolve(``);try{n.basisHTML_SND_MSG(e.verb,{NR:e.nr,PARAMS:[...t]})}catch(t){H(`Speichern fehlgeschlagen (Relation Nr. ${e.nr}): ${Zt(t)}`)}return Promise.resolve(``)}return new Promise(n=>{sn.push({template:e,params:[...t],resolve:n}),dn()})}function pn(e,t){if(!N(t))return``;let n=t.document;if(!n||typeof n.querySelectorAll!=`function`)return``;let r=Array.from(n.querySelectorAll(`[${Xe}]`)).find(t=>t.getAttribute(Xe)===e.blockId);if(!r)return``;let i=r[e.value];return i==null?``:String(i)}function mn(e,t,n=U()){if(e.source===`aus`)return``;if(e.source===`fixed`)return e.value;if(e.source===`context`)return t.context[e.value]??``;if(e.source===`previous_result`)return t.previousResult;if(e.source===`step_result`){let n=Number(e.value);return Number.isInteger(n)&&n>=0?t.stepResults?.[n]??``:``}if(e.source===`block_value`)return pn(e,n);if(e.source===`gewaehlte_zeile`){let n=t.gewaehlteZeile?.(e.blockId??``);return n===void 0?``:F(n,e.value)}if(!N(n))return``;if(e.source===`se_variable`){let t=n.SEDATA;if(!N(t)||!N(t.Daten)||!N(t.Daten.VARArrays))return``;let r=t.Daten.VARArrays[e.value];return r==null?``:String(r)}let r=P(n.FF_DATA_SOURCES,e.dataSourceId??``);if(!r)return``;let i=L(n.SEDATA,r.name,r.tableId),a=t.context.PINDEX??``,o=a!==``&&r.indexField!==``?i.find(e=>F(e,r.indexField)===a):i[0];return o?F(o,e.value):``}function hn(e,t){let n=`0,START_TOOL,`+e;return t.length>0&&(n+=`,`+t.map(e=>encodeURIComponent(e)).join(`,`)),n}function gn(e,t){if(e.trim()===``)return;let n=U();try{if(typeof n.sendBWLinkIntern==`function`){n.sendBWLinkIntern(hn(e,t));return}}catch{}try{if(typeof n.basisHTML_SND_MSG==`function`){let r={NR:e};t.length>0&&(r.PARAMS=[...t]),n.basisHTML_SND_MSG(`START_TOOL`,r)}}catch{}}function _n(e,t,n){if(t.trim()!==``)for(let r of Array.from(e.querySelectorAll(B.tagName)))(r.getAttribute(`name`)??B.defaultProps.name)===t&&(n?r.setAttribute(`offen`,``):r.removeAttribute(`offen`))}var vn=new WeakMap;function yn(e){H(`Aktionskette fehlgeschlagen: `+(e instanceof Error?e.message:String(e)))}async function bn(e,t,n){if(e.hasAttribute(`data-ff-editor`))return;let r=tt(e.getAttribute(`data-ff-aktionen`))[t];if(!r||r.length===0)return;let i=vn.get(e);if(i||(i=new Set,vn.set(e,i)),!i.has(t)){i.add(t);try{let t={...n,NOW_DATE:Et(new Date)},i=``,a=[];for(let n of r){if(n.type===`START_TOOL`){gn(n.toolNr,Dt({params:n.toolParams},t)),a.push(``);continue}if(n.type===`POPUP_OPEN`||n.type===`POPUP_CLOSE`){_n(e.ownerDocument??document,n.popup??``,n.type===`POPUP_OPEN`),a.push(``);continue}let r=Qt(U().FF_RELATIONS,n.relationId);if(!r){a.push(``);continue}let o={context:t,previousResult:i,stepResults:a,gewaehlteZeile:pt},s=await fn(r,[...n.params,...n.extraParams].map(e=>mn(e,o)));a.push(s),r.verb===`GET_RELATION`&&(i=s),n.resultKey!==``&&(t[n.resultKey]=s)}}finally{i.delete(t)}}}var xn=new WeakSet;function Sn(e,t){if(e.hasAttribute(`data-ff-editor`)||!e.hasAttribute(`data-ff-aktionen`)||xn.has(e))return;xn.add(e);let n=tt(e.getAttribute(`data-ff-aktionen`));Object.values(n).some(e=>e.some(e=>e.type===`RELATION`))&&Xt(),e.addEventListener(`click`,()=>{bn(e,t,{}).catch(yn)})}var Cn=class extends M{constructor(...e){super(...e),this.label=`Klick mich`}static{this.blockType=`button`}static{this.tagName=`ff-button`}static{this.displayName=`Schaltfläche`}static{this.category=`eingabe`}static{this.defaultProps={label:`Klick mich`}}static{this.resizableWidth=!1}static{this.blockEvents=[{key:`onClick`,name:`Klick`}]}static{this.raster={startW:4,startH:2,minW:2,minH:2}}static{this.customProperties=[]}static{this.styles=[M.styles,o`
    ...
    >${this.label}</button>`}connectedCallback(){super.connectedCallback(),Sn(this,`onClick`)}};j([A()],Cn.prototype,`label`,void 0),M.defineAndRegister(Cn);var wn=[`info`,`success`,`warning`,`danger`];function Tn(e){return wn.includes(e)?e:`info`}var En=[{wert:`info`,name:`Hinweis`},{wert:`success`,name:`Erfolg`},{wert:`warning`,name:`Warnung`},{wert:`danger`,name:`Fehler`}];function Dn(e,t){return{attributeName:e,name:`Farbe`,description:t,kind:`select`,options:En.map(e=>({value:e.wert,label:e.name}))}}var On=o`
  .chip {
    display: inline-flex;
    align-items: center;
    gap: 5px;
...
`;function zr(e,t,n,r){return{attributeName:e,name:t,description:n,kind:`select`,options:[{value:`nein`,label:`Nein`},{value:`ja`,label:`Ja`}],...r}}var Y=class extends M{constructor(...e){super(...e),this.variant=`info`,this.heading=`Neue Spalte`,this.leerHinweis=``,this._count=0}static{this.blockType=`kanban-spalte`}static{this.tagName=`ff-kanban-spalte`}static{this.displayName=`Kanban-Spalte`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[K.blockType]}static{this.childDirection=`column`}static{this.showInPalette=!1}static{this.containerHint=!1}static{this.allowedParentTypes=[`kanban`]}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.defaultProps={variant:`info`,heading:`Neue Spalte`,auffang:`nein`}}static{this.customProperties=[Dn(`variant`,`Bedeutung der Spalte — bestimmt ihre Farbwelt (Kopf, Fläche, Rahmen).`),zr(`auffang`,`Auffangspalte`,`Einträge ohne passenden Spaltentitel landen hier. Ohne Auffangspalte landen sie in der ersten Spalte.`,{requiresDataSource:!0,exclusiveAmongSiblings:!0})]}static{this.styles=[M.styles,Rr,o`
    ...
    </div>`}};j([A()],Y.prototype,`variant`,void 0),j([A()],Y.prototype,`heading`,void 0),j([A({attribute:!1})],Y.prototype,`leerHinweis`,void 0),j([Be()],Y.prototype,`_count`,void 0),M.defineAndRegister(Y);function Br(e,t,n){return t===``||n===``?[...e]:e.filter(e=>Ln(F(e,t))===n)}function Vr(e,t){let n=e.trim().toLowerCase();if(n!==``)for(let e=0;e<t.length;e++){let r=t[e].trim().toLowerCase();if(r!==``&&r===n)return e}return-1}function Hr(e){return e.findIndex(e=>(e??``).trim()===`ja`)}var Ur=new WeakMap,Wr=Y.tagName,Gr=K.tagName;function Kr(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Wr)}function qr(e){return Array.from(e.children).filter(e=>e.tagName.toLowerCase()===Gr)}function Jr(e,t){let n=e.getAttribute(`leertext`)??`Keine Einträge.`;for(let e of t)e.leerHinweis=qr(e).length===0?n:``}function Yr(e){return Ue().find(t=>t.tagName===e.toLowerCase())?.bindableSpots??[]}function Xr(e){Z?.board===e&&(Z=null);let t=e.getAttribute(`source`)??``,n=e.getAttribute(`statusfield`)??``;if(t===``)return;let r=P(U().FF_DATA_SOURCES,t);if(!r)return;let i=Kr(e);if(i.length===0)return;let a=Ur.get(e);if(!a){let t=e.querySelector(`template[data-ff-template]`)?.content.firstElementChild??e.querySelector(Gr);t&&(a=t.cloneNode(!0),Ur.set(e,a))}if(!a)return;let o=Br(L(U().SEDATA,r.name,r.tableId),e.getAttribute(`tagfield`)??``,Hn()),s=i.map(e=>e.getAttribute(`heading`)??Y.defaultProps.heading),c=Yr(a.tagName),l=Hr(i.map(e=>e.getAttribute(`auffang`))),u=tr(e);for(let e of i)qr(e).forEach(e=>e.remove());for(let e of o){let t=a.cloneNode(!0),o=n===``?-1:Vr(F(e,n),s);(o>=0?i[o]:l>=0?i[l]:i[0]).appendChild(t);for(let n of c){let r=t.getAttribute(Jn(n.prop))??``;r!==``&&(t[n.prop]=u(e,r))}let d=r.indexField===``?``:F(e,r.indexField);X.set(t,{row:e,pindex:d}),t.draggable=!0}Jr(e,i);let d=i.flatMap(qr),f=ht(z(e),d,e=>X.get(e)?.row);for(let e of f)d[e].setAttribute(`data-ff-auswahl`,``)}var X=new WeakMap,Z=null,Zr=new WeakSet;function Qr(e,t){for(let n of t.composedPath())if(n instanceof HTMLElement&&n.tagName.toLowerCase()===Wr&&e.contains(n))return n;return null}function $r(e,t){if(!Z||Z.board!==e)return;let n=X.get(Z.card);if(!n)return;let r=t.getAttribute(`heading`)??``;bn(e,`onCardDrop`,{PINDEX:n.pindex,VALUE:r}).catch(yn)}function ei(e){Zr.has(e)||(Zr.add(e),e.addEventListener(`click`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;if(!n)return;let r=X.get(n);r&&gt(z(e),r.row),bn(e,`onCardClick`,{PINDEX:r?.pindex??``}).catch(yn)}),e.addEventListener(`dragstart`,t=>{let n=t.composedPath().find(e=>e instanceof HTMLElement&&X.has(e))??null;n&&(Z={card:n,board:e},t.dataTransfer?.setData(`text/plain`,X.get(n)?.pindex??``),t.dataTransfer&&(t.dataTransfer.effectAllowed=`move`))}),e.addEventListener(`dragend`,()=>{Z=null}),e.addEventListener(`dragover`,t=>{let n=Qr(e,t);Z?.board===e&&n&&(t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`move`))}),e.addEventListener(`drop`,t=>{let n=Qr(e,t);n&&(t.preventDefault(),$r(e,n),Z=null)}))}var ti=Xn({hydriere:Xr,verdrahte:ei}),ni=ti.connect,ri=ti.disconnect,ii=Y.blockType,ai=class extends M{static{this.blockType=`kanban`}static{this.tagName=`ff-kanban`}static{this.displayName=`Kanban`}static{this.category=`anzeige`}static{this.acceptsChildren=!0}static{this.allowedChildTypes=[ii]}static{this.childDirection=`row`}static{this.lockedWidth=`fill`}static{this.resizableWidth=!1}static{this.containerHint=!1}static{this.addChildButton={label:`Spalte`,childType:ii}}static{this.templateChild={type:K.blockType,label:`Muster`}}static{this.resizableHeight=!0}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.blockEvents=[{key:`onCardClick`,name:`Karte angeklickt`},{key:`onCardDrop`,name:`Karte verschoben`}]}static{this.defaultProps={width:`fill`,height:`fill`,source:``,statusField:``,tagField:``,leerText:Fr}}static{this.raster={startW:24,startH:20,minW:6,minH:8}}static{this.customProperties=[{attributeName:`statusField`,name:`Einsortieren nach`,description:`Optional: Feld der Datenquelle, dessen Inhalt bestimmt, in welche Spalte ein Eintrag kommt. Leer = alle Einträge in der Auffang-Spalte.`,kind:`field`},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt das Board nur Einträge des Tages, den der Tageswähler zeigt. Leer = alle Einträge.`,kind:`field`},Ir()]}static{this.defaultChildren=[{type:ii,props:{heading:`Offen`,variant:`warning`},children:[{type:K.blockType}]},{type:ii,props:{heading:`In Arbeit`,variant:`info`}},{type:ii,props:{heading:`Fertig`,variant:`success`}}]}static{this.styles=[M.styles,o`
    ...
    `]}render(){return w`<div class="board"><slot></slot></div>`}connectedCallback(){super.connectedCallback(),ni(this)}disconnectedCallback(){super.disconnectedCallback(),ri(this)}};M.defineAndRegister(ai);var oi={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},si=e=>(...t)=>({_$litDirective$:e,values:t}),ci=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},li=`important`,ui=` !important`,di=si(class extends ci{constructor(e){if(super(e),e.type!==oi.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(ui);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?li:``):n[e]=r}}return T}}),fi=[10,25,50],pi=`passend`,mi=fi[0];function hi(e){let t=Number(e);return fi.some(e=>e===t)?t:null}function gi(e,t,n){return Math.max(1,Math.floor((e-t)/n))}function _i({sichtbar:e,hatQuelle:t,proSeite:n,wunschSeite:r,platzhalterZeilen:i}){let a=t?Math.max(1,Math.ceil(e.length/n)):1,o=Math.min(Math.max(r,0),a-1);return t?{seiten:a,seite:o,zeilen:[...e.slice(o*n,(o+1)*n)]}:{seiten:a,seite:o,zeilen:Array.from({length:i},()=>null)}}function vi(e,t){if(!e.hasAttribute(`fuellt`))return null;let n=e.renderRoot.querySelector(`.koerper`),r=e.renderRoot.querySelector(`.kopf`);return!(n instanceof HTMLElement)||!(r instanceof HTMLElement)?null:gi(n.clientHeight,r.offsetHeight,t)}function yi(e,t){if(typeof ResizeObserver>`u`)return null;let n=e.renderRoot.querySelector(`.koerper`);if(!n)return null;let r=new ResizeObserver(t);return r.observe(n),r}function bi(e,t){let n=t.trim().toLowerCase();return e.find(e=>e.wert.trim().toLowerCase()===n)}var xi=`text`,Si=`status`,Ci=`bild`,wi=`bild`,Ti=`unter`,Ei=[{wert:xi,name:`Text`,spur:`minmax(0, 1fr)`,klasse:``,zelle:e=>e},{wert:`zahl`,name:`Zahl`,spur:`90px`,klasse:`zahl`,zelle:e=>e},{wert:`datum`,name:`Datum`,spur:`100px`,klasse:`zahl`,zelle:e=>e},{wert:Si,name:`Status`,spur:`120px`,klasse:`status`,zelle:(e,t)=>{let n=bi(t,e);return n?w`<span class="chip v-${Tn(n.bedeutung)}">${n.name.trim()===``?e:n.name}</span>`:w`<span class="chip">${e}</span>`}},{wert:Ci,name:`Bild + Name`,spur:`minmax(0, 1fr)`,klasse:`bild`,zusatzFelder:[{key:wi,label:`Bild`},{key:Ti,label:`Unterzeile`}],hoehe:e=>(e[wi]??``)!==``||(e[Ti]??``)!==``?44:32,zelle:(e,t,n)=>{let r=Pn(n[wi]??``),i=n[Ti]??``;return w`<div class="bild-name">
        ${r===void 0?E:w`<span class="bild-zeichen">${r}</span>`}
        <div class="bild-text">
          <div class="bild-titel">${e}</div>
          ${i===``?E:w`<div class="bild-unter">${i}</div>`}
        </div>
      </div>`}}];function Di(e){return e.reduce((e,t)=>{let n=Oi(t.art);return Math.max(e,n.hoehe?.(t.felder??{})??32)},32)}function Oi(e){return Ei.find(t=>t.wert===e)??Ei[0]}var ki=Ei.map(e=>({wert:e.wert,name:e.name,...e.zusatzFelder?{felder:e.zusatzFelder}:{}})),Ai=`felder`,ji=`Spalte {n}`;function Mi(e){return ji.replace(`{n}`,String(e+1))}function Ni(e){return{titel:Mi(e),feld:``,art:xi}}function Pi(){return[0,1,2].map(e=>Ni(e))}function Fi(e){return Array.isArray(e)?e.filter(e=>!!e&&typeof e==`object`).map(e=>({wert:typeof e.wert==`string`?e.wert:``,name:typeof e.name==`string`?e.name:``,bedeutung:typeof e.bedeutung==`string`?e.bedeutung:``})).filter(e=>e.wert.trim()!==``):[]}function Ii(e){if(!e||typeof e!=`object`||Array.isArray(e))return{};let t={};for(let[n,r]of Object.entries(e))typeof r==`string`&&r!==``&&(t[n]=r);return t}function Li(e,t){if(e&&typeof e==`object`){let n=e,r=Fi(n.zuordnung),i=Ii(n.felder);return{titel:typeof n.titel==`string`?n.titel:Mi(t),feld:typeof n.feld==`string`?n.feld:``,art:typeof n.art==`string`?n.art:xi,...r.length>0?{zuordnung:r}:{},...Object.keys(i).length>0?{felder:i}:{}}}return typeof e==`string`?{...Ni(t),titel:e}:Ni(t)}function Ri(e){let t;if(Array.isArray(e))t=e.map((e,t)=>Li(e,t));else if(typeof e==`number`&&Number.isFinite(e)||typeof e==`string`&&/^\d+$/.test(e)){let n=Math.max(1,Math.floor(Number(e)));t=[...Array(n).keys()].map(e=>Ni(e))}else t=Pi();return t.length>8&&(t=t.slice(0,8)),t.length<1&&(t=[Ni(0)]),t}function zi(e){try{return Ri(JSON.parse(e))}catch{return Pi()}}function Bi(e){return zi(e.getAttribute(`spalten`)??``)}function Vi(e,t,n){let r={};for(let i of Oi(e.art).zusatzFelder??[]){let a=e.felder?.[i.key]??``;a!==``&&(r[i.key]=n(t,a))}return r}function Hi(e){let t=()=>{e.datenzeilen=[],e.zusatzzeilen=[]},n=e.getAttribute(`source`)??``;if(n===``){t();return}let r=P(U().FF_DATA_SOURCES,n);if(!r){t();return}let i=Bi(e),{rows:a,gefiltert:o}=xt(e,Br(L(U().SEDATA,r.name,r.tableId),e.getAttribute(`tagfield`)??``,Hn())),s=ht(z(e),a,e=>e)[0]??-1,c=tr(e);e.rohzeilen=a,e.auswahlIndex=s,e.durchAuswahlGefiltert=o,e.datenzeilen=a.map(e=>i.map(t=>t.feld===``?``:c(e,t.feld))),e.zusatzzeilen=a.map(e=>i.map(t=>Vi(t,e,c)))}var Ui=Xn({hydriere:Hi}),Wi=Ui.connect,Gi=Ui.disconnect,Ki=1,qi=/^-?\d{1,3}(\.\d{3})*(,\d+)?$|^-?\d+(,\d+)?$|^-?\d+(\.\d+)?$/,Ji=/^(\d{1,2})\.(\d{1,2})\.(\d{2}|\d{4})$/,Yi=/^(\d{4})-(\d{2})-(\d{2})$/;function Xi(e){let t=e.trim();if(t===``||!qi.test(t))return null;let n=t.includes(`,`)?t.replace(/\./g,``).replace(`,`,`.`):/^-?\d{1,3}(\.\d{3})+$/.test(t)?t.replace(/\./g,``):t,r=Number(n);return Number.isFinite(r)?r:null}function Zi(e){let t=e.trim();if(t===``)return null;let n=Yi.exec(t);if(n){let[,e,t,r]=n;return Qi(Number(e),Number(t),Number(r))}let r=Ji.exec(t);if(r){let[,e,t,n]=r,i=Number(n);return Qi(n.length===2?i<=69?2e3+i:1900+i:i,Number(t),Number(e))}return null}function Qi(e,t,n){if(t<1||t>12||n<1||n>31)return null;let r=new Date(e,t-1,n);return r.getFullYear()!==e||r.getMonth()!==t-1||r.getDate()!==n?null:r.getTime()}function $i(e){let t=0,n=0,r=0;for(let i of e)i.trim()!==``&&(t++,Xi(i)!==null&&n++,Zi(i)!==null&&r++);return t===0?`text`:r===t?`datum`:n===t?`zahl`:`text`}var ea=new Intl.Collator(`de`,{numeric:!0,sensitivity:`base`});function ta(e,t,n){if(t<0||e.length===0)return e.map((e,t)=>t);let r=n=>e[n][t]??``,i=$i(e.map(e=>e[t]??``)),a=n?1:-1;return e.map((e,t)=>t).sort((e,t)=>{let n=r(e).trim(),o=r(t).trim();if(n===``&&o===``)return e-t;if(n===``)return Ki;if(o===``)return-1;let s=i===`zahl`?(Xi(n)??0)-(Xi(o)??0):i===`datum`?(Zi(n)??0)-(Zi(o)??0):ea.compare(n,o);return s===0?e-t:s*a})}function na(e,t,n){return w`<div class="steuerung">
    <button
    ...
    <button
      ...
      @pointerdown=${n}
      @click=${r=>{n(r);let i=e();i.length<8&&(i.push(Ni(i.length)),t(i))}}
    >+</button>
  </div>`}function ra(e,t){let n=e.currentTarget;if(!n)return;e.stopPropagation(),e.preventDefault();let r=Array.from(n.childNodes),i=n.textContent??``;n.setAttribute(`contenteditable`,`plaintext-only`),n.focus();let a=window.getSelection(),o=document.createRange();o.selectNodeContents(n),a?.removeAllRanges(),a?.addRange(o);let s=!1,c=e=>{if(s)return;s=!0,n.removeAttribute(`contenteditable`),n.removeEventListener(`blur`,l),n.removeEventListener(`keydown`,u);let a=(n.textContent??``).trim();e&&a&&a!==i.trim()?t(a):n.replaceChildren(...r)},l=()=>c(!0),u=e=>{e.key===`Enter`?(e.preventDefault(),n.blur()):e.key===`Escape`&&(e.preventDefault(),c(!1))};n.addEventListener(`blur`,l),n.addEventListener(`keydown`,u)}function ia(e,t,n,r){ra(e,e=>{let i=n();t>=i.length||(i[t]={...i[t],titel:e},r(i))})}var aa=220,oa=new WeakMap;function sa(e){let t=oa.get(e);t!==void 0&&(clearTimeout(t),oa.delete(e))}function ca(e,t,n,r){t.stopPropagation();let i=t.currentTarget.getBoundingClientRect();sa(e),oa.set(e,setTimeout(()=>{oa.delete(e),e.dispatchEvent(new CustomEvent(`ff-listen-bind`,{detail:{prop:n,index:r,top:i.bottom+4,left:i.left},bubbles:!0,composed:!0}))},aa))}var la={prop:`spalten`,titelKey:`titel`,feldKey:`feld`,standardTitel:ji,eintragsWahl:{key:`art`,label:`Darstellung`,optionen:ki,standard:xi,felderKey:Ai},eintragsZuordnung:{key:`zuordnung`,label:`Status-Zuordnung`,nurBeiWahl:Si,wertLabel:`Datenwert`,nameLabel:`Klarname`,bedeutungLabel:`Bedeutung`,bedeutungen:En}};function ua(e,t){let n=[];return e.forEach((e,r)=>{yr(e,t)&&n.push(r)}),n}function da(e,t){return!e&&t.trim()!==``}function fa(e){if(!e.hatQuelle)return`— Datensätze`;let t=e.auswahlAktiv?` · durch Auswahl gefiltert`:``,n=e=>e===1?`Datensatz`:`Datensätze`,r=e=>e===1?`Datensatz`:`Datensätzen`;return e.suchtAktiv?e.sichtbar===0?`Kein Treffer von ${e.gesamt} ${r(e.gesamt)}`+t:`${e.sichtbar} von ${e.gesamt} ${r(e.gesamt)}`+t:(e.gesamt===0?`Keine Datensätze`:`${e.gesamt} ${n(e.gesamt)}`)+t}var pa=[{value:`ja`,label:`Ja`},{value:`nein`,label:`Nein`}],ma=[{attributeName:`suche`,name:`Suchzeile`,description:`Zeigt ueber der Tabelle ein Feld, mit dem der Bediener den Inhalt durchsucht.`,kind:`segment`,options:pa,requiresDataSource:!0},{attributeName:`zeilenWaehler`,name:`Zeilen-Wähler`,description:`Zeigt dem Bediener unten in der Maske den Wähler „Zeilen pro Seite" — er darf die Einstellung dann für seine Sitzung übersteuern. Nein: es gilt unveränderlich, was hier im Editor eingestellt ist.`,kind:`segment`,options:pa,requiresDataSource:!0},{attributeName:`tagField`,name:`Tag filtern nach`,description:`Optional: Feld der Datenquelle, in dem das Datum steht. Gesetzt zeigt die Tabelle nur Saetze des Tages, den der Tageswaehler zeigt. Leer = alle Saetze.`,kind:`field`},Ir()];function ha(e,t){return w`<div class="fusszeile">
    ...
    <div class="seiten-nav">
      ...
      >
        ...
        <option value=${pi} ?selected=${e.einstellung===pi}>passend zur Höhe</option>
        ${fi.map(t=>w`<option value=${t} ?selected=${e.einstellung===String(t)}>${t} pro Seite</option>`)}
      </select>`:E}
      <button
  ...
  </div>`}var ga=`—`;function _a(e,t){return w`
      ...
      <div class="koerper">
      <div class="kopf" style=${di(e.cols)}>
        ${e.spalten.map((n,r)=>w`<div
            class=${Oi(n.art).klasse}
            data-ff-editable
        ...
        ${e.zeilen.map(n=>w`<div
          ...
          >
            ${``}
            ${e.spalten.map((t,r)=>{let i=Oi(t.art),a=n===null?ga:e.datenzeilen[n]?.[r]??``,o=n===null?{}:e.zusatzzeilen[n]?.[r]??{};return w`<div class=${i.klasse}>${i.zelle(a,t.zuordnung??[],o)}</div>`})}
          </div>`)}
        ${``}
        <div class="lineal" style=${di(e.cols)}>
...
`,ya=4,Q=class e extends M{constructor(...e){super(...e),this.spalten=Pi(),this.source=``,this.suche=`ja`,this.proSeite=pi,this.zeilenWaehler=`nein`,this.leerText=Fr,this._suchtext=``,this.datenzeilen=[],this.zusatzzeilen=[],this.rohzeilen=[],this.auswahlIndex=-1,this.durchAuswahlGefiltert=!1,this._sortSpalte=-1,this._sortAuf=!0,this._seite=0,this._proSeiteWahl=null,this._proSeiteGemessen=null,this._beobachter=null,this._taktGemessen=0}static{this.blockType=`tabelle`}static{this.tagName=`ff-tabelle`}static{this.displayName=`Tabelle`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.satzWahl={}}static{this.kannAuswahlFolgen=!0}static{this.listenBindung=la}static{this.defaultProps={width:`fill`,source:``,spalten:Pi(),suche:`ja`,tagField:``,proSeite:pi,zeilenWaehler:`nein`,leerText:Fr}}static{this.customProperties=ma}static{this.raster={startW:14,startH:8,minW:6,minH:4}}get einstellung(){return this._proSeiteWahl??this.proSeite}get proSeiteAktuell(){return hi(this.einstellung)??this._proSeiteGemessen??mi}waehleProSeite(e){this.hasAttribute(`data-ff-editor`)?this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`proSeite`,value:e},bubbles:!0,composed:!0})):this._proSeiteWahl=e,this._seite=0,this.requestUpdate()}messeRumpf(){let e=this.zeilenHoehe;this._taktGemessen=e;let t=vi(this,e);t!==this._proSeiteGemessen&&(this._proSeiteGemessen=t,this.requestUpdate())}spaltenListe(){return Ri(this.spalten)}get zeilenHoehe(){return Di(this.spaltenListe())}sichtbareIndizes(){let e=ua(this.datenzeilen,this._suchtext);return this._sortSpalte<0?e:ta(e.map(e=>this.datenzeilen[e]),this._sortSpalte,this._sortAuf).map(t=>e[t])}klickZeile(e){if(e===null||this.hasAttribute(`data-ff-editor`))return;let t=z(this),n=this.rohzeilen[e];t===``||n===void 0||gt(t,n)}setzeSuchtext(e){this._suchtext=e,this._seite=0,this.requestUpdate()}klickSortiere(e){this.editable||(this._sortSpalte===e?this._sortAuf=!this._sortAuf:(this._sortSpalte=e,this._sortAuf=!0),this._seite=0,this.requestUpdate())}aendere(e){this.dispatchEvent(new CustomEvent(`ff-prop-change`,{detail:{attr:`spalten`,value:e},bubbles:!0,composed:!0}))}beobachte(){this._beobachter||(this._beobachter=yi(this,()=>this.messeRumpf()),this._beobachter&&this.messeRumpf())}connectedCallback(){super.connectedCallback(),Wi(this),this.beobachte()}firstUpdated(){this.beobachte()}updated(){this._taktGemessen!==this.zeilenHoehe&&this.messeRumpf()}disconnectedCallback(){super.disconnectedCallback(),sa(this),this._beobachter?.disconnect(),this._beobachter=null,Gi(this)}static{this.styles=[M.styles,On,Rr,va]}render(){let t=this.spaltenListe(),n={gridTemplateColumns:t.map(e=>Oi(e.art).spur).join(` `)},r=e=>e.stopPropagation(),i=this.sichtbareIndizes(),a=da(this.hasAttribute(`data-ff-editor`),this.source),o=a&&this.datenzeilen.length===0,s=i.length,c=this.proSeiteAktuell,{seiten:l,seite:u,zeilen:d}=_i({sichtbar:i,hatQuelle:a,proSeite:c,wunschSeite:this._seite,platzhalterZeilen:ya});return w`<div class="tabelle" style=${di({"--zeilen-hoehe":`${this.zeilenHoehe}px`})}>
      ${na(()=>this.spaltenListe(),e=>this.aendere(e),r)}
      ${_a({spalten:t,cols:n,editable:this.editable,zeigeSuche:this.suche===`ja`,suchtext:this._suchtext,sortSpalte:this._sortSpalte,sortAuf:this._sortAuf,zeilen:d,datenzeilen:this.datenzeilen,zusatzzeilen:this.zusatzzeilen,hatQuelle:a,auswahlIndex:this.auswahlIndex,leer:o,leerText:this.leerText},{setzeSuchtext:e=>this.setzeSuchtext(e),dblklickKopf:(e,t)=>{this.editable&&(sa(this),ia(e,t,()=>this.spaltenListe(),e=>this.aendere(e)))},klickKopf:(t,n)=>{this.editable&&ca(this,t,e.listenBindung.prop,n),this.klickSortiere(n)},klickZeile:e=>this.klickZeile(e),stop:r})}
      ${``}
      ${o?E:ha({hatQuelle:a,sichtbar:s,gesamt:this.datenzeilen.length,suchtAktiv:this._suchtext.trim()!==``,auswahlAktiv:this.durchAuswahlGefiltert,zeigeWaehler:this.hasAttribute(`data-ff-editor`)||this.zeilenWaehler===`ja`,einstellung:this.einstellung,seite:u,seiten:l},{waehleProSeite:e=>this.waehleProSeite(e),blaettere:e=>{this._seite=e,this.requestUpdate()},stop:r})}
    </div>`}};j([A({converter:{fromAttribute:e=>e?zi(e):Pi(),toAttribute:e=>JSON.stringify(e)}})],Q.prototype,`spalten`,void 0),j([A()],Q.prototype,`source`,void 0),j([A()],Q.prototype,`suche`,void 0),j([A()],Q.prototype,`proSeite`,void 0),j([A()],Q.prototype,`zeilenWaehler`,void 0),j([A()],Q.prototype,`leerText`,void 0),j([A({attribute:!1})],Q.prototype,`datenzeilen`,void 0),j([A({attribute:!1})],Q.prototype,`zusatzzeilen`,void 0),j([A({attribute:!1})],Q.prototype,`rohzeilen`,void 0),j([A({attribute:!1})],Q.prototype,`auswahlIndex`,void 0),j([A({attribute:!1})],Q.prototype,`durchAuswahlGefiltert`,void 0),M.defineAndRegister(Q);var ba=Jn(`text`);function xa(e){let t=e.getAttribute(`source`)??``,n=e.getAttribute(ba)??``;return t===``||n===``?void 0:{sourceId:t,code:n}}function Sa(e){let t=nr(e,ba);t.art!==`ungebunden`&&(e.text=t.art===`wert`?t.wert:``)}function Ca(e){xa(e)&&(e.text=``)}var wa=Xn({hydriere:Sa,verdrahte:Ca}),Ta=wa.connect,Ea=wa.disconnect,Da=6,Oa=96,ka=14,Aa={duenn:`300`,normal:`400`,fett:`700`},ja={links:`left`,mitte:`center`,rechts:`right`},Ma={standard:`var(--se-ink)`,gedaempft:`var(--se-muted)`,akzent:`var(--se-accent)`,erfolg:`var(--se-green)`,warnung:`var(--se-amber)`,fehler:`var(--se-red)`},Na=`standard`;function Pa(e){if(e===`ueberschrift`)return 15;if(e===`klein`)return 12;let t=typeof e==`number`?e:Number.parseFloat(String(e??``));return Number.isFinite(t)?Math.min(Oa,Math.max(Da,t)):ka}function Fa(e){return typeof e==`string`&&e in Aa?e:`normal`}function Ia(e){return typeof e==`string`&&e in ja?e:`links`}function La(e){return typeof e==`string`&&e in Ma?e:Na}var $=class extends M{constructor(...e){super(...e),this.groesse=ka,this.gewicht=`normal`,this.ausrichtung=`links`,this.farbe=Na,this.text=`Text`,this.source=``,this.textField=``}static{this.blockType=`text`}static{this.tagName=`ff-text`}static{this.displayName=`Text`}static{this.category=`anzeige`}static{this.acceptsDataSource=!0}static{this.kannAuswahlFolgen=!0}static{this.bindableSpots=[{prop:`text`,label:`Text`}]}static{this.defaultProps={width:`fill`,groesse:ka,gewicht:`normal`,ausrichtung:`links`,farbe:Na,text:`Text`,source:``,textField:``}}static{this.raster={startW:6,startH:2,minW:1,minH:1}}static{this.customProperties=[{attributeName:`groesse`,name:`Größe`,description:`Schriftgröße in Pixeln.`,kind:`number`,unit:`px`,min:Da,max:Oa,inspectorRow:`Text-Stil`},{attributeName:`gewicht`,name:`Gewicht`,description:`Strichstärke der Schrift.`,kind:`segment`,options:[{value:`duenn`,label:`Dünn`},{value:`normal`,label:`Normal`},{value:`fett`,label:`Fett`}],inspectorRow:`Text-Stil`},{attributeName:`ausrichtung`,name:`Ausrichtung`,description:`Wo der Text in seiner Breite sitzt.`,kind:`segment`,options:[{value:`links`,label:`Links`},{value:`mitte`,label:`Mitte`},{value:`rechts`,label:`Rechts`}],inspectorRow:`Text-Stil`},{attributeName:`farbe`,name:`Farbe`,description:`Textfarbe aus den Farben der Maske.`,kind:`select`,options:[{value:`standard`,label:`Standard`},{value:`gedaempft`,label:`Gedämpft`},{value:`akzent`,label:`Akzent`},{value:`erfolg`,label:`Erfolg`},{value:`warnung`,label:`Warnung`},{value:`fehler`,label:`Fehler`}]}]}static{this.styles=[M.styles,o`
      .text {
        font-family: var(--se-font);
    ...
    `]}render(){return w`<div
      class="text"
      style=${di({fontSize:`${Pa(this.groesse)}px`,fontWeight:Aa[Fa(this.gewicht)],textAlign:ja[Ia(this.ausrichtung)],color:Ma[La(this.farbe)]})}
      data-ff-editable
      data-ff-spot="text"
      ?data-ff-bound=${this.textField!==``}
      @dblclick=${e=>this.inlineEdit(e,`text`)}
    >${this.text}</div>`}connectedCallback(){super.connectedCallback(),Ta(this)}disconnectedCallback(){super.disconnectedCallback(),Ea(this)}};j([A({type:Number})],$.prototype,`groesse`,void 0),j([A()],$.prototype,`gewicht`,void 0),j([A()],$.prototype,`ausrichtung`,void 0),j([A()],$.prototype,`farbe`,void 0),j([A()],$.prototype,`text`,void 0),j([A()],$.prototype,`source`,void 0),j([A()],$.prototype,`textField`,void 0),M.defineAndRegister($);var Ra=[`waagerecht`,`senkrecht`],za=`waagerecht`;function Ba(e){return Ra.includes(e)?e:za}var Va=class extends M{constructor(...e){super(...e),this.richtung=za}static{this.blockType=`trenner`}static{this.tagName=`ff-trenner`}static{this.displayName=`Trennlinie`}static{this.category=`layout`}static{this.defaultProps={width:`fill`,richtung:za}}static{this.resizableWidth=!1}static{this.raster={startW:24,startH:1,minW:1,minH:1,varianten:[{wenn:{attributeName:`richtung`,equals:`senkrecht`},startW:1,startH:6,breiteZiehbar:!1}]}}static{this.customProperties=[{attributeName:`richtung`,name:`Richtung`,description:`Waagerecht trennt oben von unten, senkrecht links von rechts.`,kind:`select`,options:[{value:`waagerecht`,label:`Waagerecht`},{value:`senkrecht`,label:`Senkrecht`}]}]}static{this.styles=[M.styles,o`
    ...
    `]}render(){return w`<div class="zeile"><slot></slot></div>`}};M.defineAndRegister(Ha),typeof window<`u`&&window.addEventListener(`unhandledrejection`,e=>{let t=e.reason;H(`Unerwarteter Fehler in der Maske: `+(t instanceof Error?t.message:String(t)))})})();
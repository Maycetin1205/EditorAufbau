# Archiv: CLAUDE.md-Neuschnitt 2026-07-20 — ausgelagerte Historie

> **Wortgleich übernommen** beim Doku-Neuschnitt am 2026-07-20 (Nutzer-Go).
> Diese Abschnitte beschreiben den Stand IHRER Zeit — sie werden nicht
> gepflegt. Was seither gilt, steht in `CLAUDE.md`. Wichtige spätere
> Änderungen gegenüber dem Text unten: „Quelle speichern" (`f9a5af9`),
> „Neuen Satz anlegen"/CREATE_RECORD (`24fbe54`), Projektkarte (`fc5d786`)
> und die dashboard/-Klickmodelle (`2c2d944`) wurden am 2026-07-20 restlos
> entfernt; der Aufräum-Plan A1–A7 (`Aufräum.md`) war vollständig erledigt
> und wurde gelöscht (Wortlaut in der git-Historie).
...
## Wichtige Stellen (Original-Wortlaut vor dem Neuschnitt)

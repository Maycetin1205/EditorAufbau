...
5. NIMM den nächsten offenen Roadmap-Punkt aus CLAUDE.md. Nur diesen.
...
6. SPIELE den Schritt erst aus Bedienersicht durch (Was sieht der Nutzer?
...
7. BAUE klein. Nach JEDER Aenderung: tsc + eslint + npm test.
   Nach Block-Aenderungen zusaetzlich: npm run build:runtime.
8. VERIFIZIERE im Browser (Screenshot fuer den Nutzer), nicht nur per Tests.
9. AKTUALISIERE die Roadmap in CLAUDE.md (Haken + Datum + 2 Saetze was/wie).
10. COMMITTE das fertige Kapitel mit ausfuehrlicher Message, pushe SOFORT
